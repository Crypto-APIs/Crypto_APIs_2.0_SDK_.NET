...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40361 : IEquatable<InlineResponse40361>, IValidatableObject
    {
        ...
        public InlineResponse40361(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedTokensTransactionsE403 error = default(NewConfirmedTokensTransactionsE403))
        {
