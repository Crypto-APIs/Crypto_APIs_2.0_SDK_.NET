...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40361
    /// </summary>
    [DataContract(Name = "inline_response_403_61")]
    public partial class InlineResponse40361 : IEquatable<InlineResponse40361>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40361" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40361() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40361" /> class.
        /// </summary>
        ...
        public InlineResponse40361(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListConfirmedTransactionsByAddressAndTimeRangeE403 error = default(ListConfirmedTransactionsByAddressAndTimeRangeE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40361 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40361 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40361 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40361 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40361);
        }

        /// <summary>
        /// Returns true if InlineResponse40361 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40361 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40361 input)
        {
            if (input == null)
            {
                return false;
