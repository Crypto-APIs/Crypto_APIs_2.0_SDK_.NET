...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40162 : IEquatable<InlineResponse40162>, IValidatableObject
    {
        ...
        public InlineResponse40162(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedTokensTransactionsAndEachConfirmationE401 error = default(NewConfirmedTokensTransactionsAndEachConfirmationE401))
        {
