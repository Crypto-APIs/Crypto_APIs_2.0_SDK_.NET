...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40162
    /// </summary>
    [DataContract(Name = "inline_response_401_62")]
    public partial class InlineResponse40162 : IEquatable<InlineResponse40162>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40162" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40162() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40162" /> class.
        /// </summary>
        ...
        public InlineResponse40162(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListConfirmedTokensTransfersByAddressAndTimeRangeE401 error = default(ListConfirmedTokensTransfersByAddressAndTimeRangeE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40162 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40162 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40162 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40162 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40162);
        }

        /// <summary>
        /// Returns true if InlineResponse40162 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40162 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40162 input)
        {
            if (input == null)
            {
                return false;
