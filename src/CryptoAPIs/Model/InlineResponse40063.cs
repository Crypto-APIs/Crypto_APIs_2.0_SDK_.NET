...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40063 : IEquatable<InlineResponse40063>, IValidatableObject
    {
        ...
        public InlineResponse40063(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListInternalTransactionsByAddressAndTimeRangeE400 error = default(ListInternalTransactionsByAddressAndTimeRangeE400))
        {
