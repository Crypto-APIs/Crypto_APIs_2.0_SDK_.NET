...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40319
    /// </summary>
    [DataContract(Name = "inline_response_403_19")]
    public partial class InlineResponse40319 : IEquatable<InlineResponse40319>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40319" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40319() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40319" /> class.
        /// </summary>
        ...
        public InlineResponse40319(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetUnconfirmedOmniTransactionByTransactionIDTxidE403 error = default(GetUnconfirmedOmniTransactionByTransactionIDTxidE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40319 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40319 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40319 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40319 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40319);
        }

        /// <summary>
        /// Returns true if InlineResponse40319 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40319 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40319 input)
        {
            if (input == null)
            {
                return false;
