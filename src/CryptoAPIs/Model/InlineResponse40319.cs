...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40319 : IEquatable<InlineResponse40319>, IValidatableObject
    {
        ...
        public InlineResponse40319(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListXRPRippleTransactionsByBlockHashE403 error = default(ListXRPRippleTransactionsByBlockHashE403))
        {
