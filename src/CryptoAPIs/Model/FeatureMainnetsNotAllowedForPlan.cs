...
namespace CryptoAPIs.Model
{
    ...
    public partial class FeatureMainnetsNotAllowedForPlan : IEquatable<FeatureMainnetsNotAllowedForPlan>, IValidatableObject
    {
        ...
        public FeatureMainnetsNotAllowedForPlan(string code = default(string), string message = default(string), List<BannedIpAddressDetailsInner> details = default(List<BannedIpAddressDetailsInner>))
        {
