...
namespace CryptoAPIs.Model
{
    ...
    public partial class FeatureMainnetsNotAllowedForPlan : IEquatable<FeatureMainnetsNotAllowedForPlan>, IValidatableObject
    {
        ...
        public FeatureMainnetsNotAllowedForPlan(string apiVersion = default(string), string requestId = default(string), string context = default(string), FeatureMainnetsNotAllowedForPlanError error = default(FeatureMainnetsNotAllowedForPlanError))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for FeatureMainnetsNotAllowedForPlan and cannot be null");
            // to ensure "requestId" is required (not null)
            this.RequestId = requestId ?? throw new ArgumentNullException("requestId is a required property for FeatureMainnetsNotAllowedForPlan and cannot be null");
            // to ensure "error" is required (not null)
            this.Error = error ?? throw new ArgumentNullException("error is a required property for FeatureMainnetsNotAllowedForPlan and cannot be null");
        ...
        public FeatureMainnetsNotAllowedForPlanError Error { get; set; }
