...
namespace CryptoAPIs.Model
{
    ...
    /// Zcash
    /// </summary>
    [DataContract(Name = "GetBlockDetailsByBlockHashFromCallbackRIBSZ2")]
    public partial class GetBlockDetailsByBlockHashFromCallbackRIBSZ2 : IEquatable<GetBlockDetailsByBlockHashFromCallbackRIBSZ2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHashFromCallbackRIBSZ2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetBlockDetailsByBlockHashFromCallbackRIBSZ2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHashFromCallbackRIBSZ2" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetBlockDetailsByBlockHashFromCallbackRIBSZ2 {\n");
        ...
        {
            return this.Equals(input as GetBlockDetailsByBlockHashFromCallbackRIBSZ2);
        }

        /// <summary>
        /// Returns true if GetBlockDetailsByBlockHashFromCallbackRIBSZ2 instances are equal
        /// </summary>
        /// <param name="input">Instance of GetBlockDetailsByBlockHashFromCallbackRIBSZ2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetBlockDetailsByBlockHashFromCallbackRIBSZ2 input)
        {
            if (input == null)
            {
                return false;
