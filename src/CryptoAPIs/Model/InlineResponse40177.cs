...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40177 : IEquatable<InlineResponse40177>, IValidatableObject
    {
        ...
        public InlineResponse40177(string apiVersion = default(string), string requestId = default(string), string context = default(string), MinedTransactionE401 error = default(MinedTransactionE401))
        {
