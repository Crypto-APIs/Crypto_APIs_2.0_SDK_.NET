...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40177
    /// </summary>
    [DataContract(Name = "inline_response_401_77")]
    public partial class InlineResponse40177 : IEquatable<InlineResponse40177>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40177" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40177() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40177" /> class.
        /// </summary>
        ...
        public InlineResponse40177(string apiVersion = default(string), string requestId = default(string), string context = default(string), DeleteAutomaticCoinsForwardingE401 error = default(DeleteAutomaticCoinsForwardingE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40177 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40177 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40177 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40177 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40177);
        }

        /// <summary>
        /// Returns true if InlineResponse40177 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40177 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40177 input)
        {
            if (input == null)
            {
                return false;
