...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4031
    /// </summary>
    [DataContract(Name = "inline_response_403_1")]
    public partial class InlineResponse4031 : IEquatable<InlineResponse4031>, IValidatableObject
    {
        ...
        public InlineResponse4031(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListOmniTokensByAddressE403 error = default(ListOmniTokensByAddressE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4031 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4031 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse4031 and cannot be null");
            }
            this.Error = error;
