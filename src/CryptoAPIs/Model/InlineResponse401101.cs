...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_401_101")]
    public partial class InlineResponse401101 : IEquatable<InlineResponse401101>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse401101" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse401101() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse401101" /> class.
        /// </summary>
        ...
        public InlineResponse401101(string apiVersion = default(string), string requestId = default(string), string context = default(string), EstimateTokenGasLimitE401 error = default(EstimateTokenGasLimitE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse401101 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse401101 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse401101 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse401101 {\n");
        ...
        {
            return this.Equals(input as InlineResponse401101);
        }

        /// <summary>
        /// Returns true if InlineResponse401101 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse401101 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse401101 input)
        {
            if (input == null)
            {
                return false;
