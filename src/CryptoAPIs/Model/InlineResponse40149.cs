...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40149
    /// </summary>
    [DataContract(Name = "inline_response_401_49")]
    public partial class InlineResponse40149 : IEquatable<InlineResponse40149>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40149" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40149() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40149" /> class.
        /// </summary>
        ...
        public InlineResponse40149(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetWalletTransactionDetailsByTransactionIDE401 error = default(GetWalletTransactionDetailsByTransactionIDE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40149 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40149 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40149 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40149 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40149);
        }

        /// <summary>
        /// Returns true if InlineResponse40149 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40149 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40149 input)
        {
            if (input == null)
            {
                return false;
