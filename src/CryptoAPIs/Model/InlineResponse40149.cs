...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40149 : IEquatable<InlineResponse40149>, IValidatableObject
    {
        ...
        public InlineResponse40149(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListHDWalletXPubYPubZPubTransactionsE401 error = default(ListHDWalletXPubYPubZPubTransactionsE401))
        {
