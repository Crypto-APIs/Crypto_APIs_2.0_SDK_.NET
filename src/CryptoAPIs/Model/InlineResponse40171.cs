...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40171
    /// </summary>
    [DataContract(Name = "inline_response_401_71")]
    public partial class InlineResponse40171 : IEquatable<InlineResponse40171>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40171" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40171() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40171" /> class.
        /// </summary>
        ...
        public InlineResponse40171(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetBlockDetailsByBlockHashFromCallbackE401 error = default(GetBlockDetailsByBlockHashFromCallbackE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40171 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40171 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40171 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40171 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40171);
        }

        /// <summary>
        /// Returns true if InlineResponse40171 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40171 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40171 input)
        {
            if (input == null)
            {
                return false;
