...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40171 : IEquatable<InlineResponse40171>, IValidatableObject
    {
        ...
        public InlineResponse40171(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewUnconfirmedCoinsTransactionsE401 error = default(NewUnconfirmedCoinsTransactionsE401))
        {
