...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListSupportedAssetsR_data")]
    public partial class ListSupportedAssetsRData : IEquatable<ListSupportedAssetsRData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListSupportedAssetsRData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListSupportedAssetsRData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListSupportedAssetsRData" /> class.
        /// </summary>
        ...
        public ListSupportedAssetsRData(int offset = default(int), int limit = default(int), int total = default(int), List<ListSupportedAssetsRI> items = default(List<ListSupportedAssetsRI>))
        {
            this.Offset = offset;
            this.Limit = limit;
            this.Total = total;
            // to ensure "items" is required (not null)
            this.Items = items ?? throw new ArgumentNullException("items is a required property for ListSupportedAssetsRData and cannot be null");
        }
        ...
        public List<ListSupportedAssetsRI> Items { get; set; }
        ...
        {
            return this.Equals(input as ListSupportedAssetsRData);
        }

        /// <summary>
        /// Returns true if ListSupportedAssetsRData instances are equal
        /// </summary>
        /// <param name="input">Instance of ListSupportedAssetsRData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListSupportedAssetsRData input)
        {
            if (input == null)
                return false;
