...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListSupportedAssetsRData : IEquatable<ListSupportedAssetsRData>, IValidatableObject
    {
        ...
        public ListSupportedAssetsRData(int limit = default(int), int offset = default(int), int total = default(int), List<ListSupportedAssetsRI> items = default(List<ListSupportedAssetsRI>))
        {
            this.Limit = limit;
            this.Offset = offset;
            this.Total = total;
            ...
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for ListSupportedAssetsRData and cannot be null");
            }
            this.Items = items;
        }
