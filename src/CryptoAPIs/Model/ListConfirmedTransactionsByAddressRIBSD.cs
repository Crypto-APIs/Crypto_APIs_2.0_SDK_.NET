...
namespace CryptoAPIs.Model
{
    ...
    /// Dogecoin
    /// </summary>
    [DataContract(Name = "ListConfirmedTransactionsByAddressRIBSD")]
    public partial class ListConfirmedTransactionsByAddressRIBSD : IEquatable<ListConfirmedTransactionsByAddressRIBSD>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressRIBSD" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListConfirmedTransactionsByAddressRIBSD() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressRIBSD" /> class.
        /// </summary>
        ...
        public ListConfirmedTransactionsByAddressRIBSD(long locktime = default(long), int size = default(int), int version = default(int), List<ListConfirmedTransactionsByAddressRIBSDVinInner> vin = default(List<ListConfirmedTransactionsByAddressRIBSDVinInner>), List<GetTransactionDetailsByTransactionIDRIBSDVoutInner> vout = default(List<GetTransactionDetailsByTransactionIDRIBSDVoutInner>))
        {
            ...
            if (vin == null)
            {
                throw new ArgumentNullException("vin is a required property for ListConfirmedTransactionsByAddressRIBSD and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null)
            {
                throw new ArgumentNullException("vout is a required property for ListConfirmedTransactionsByAddressRIBSD and cannot be null");
            }
            this.Vout = vout;
        }
        ...
        {
            return this.Equals(input as ListConfirmedTransactionsByAddressRIBSD);
        }

        /// <summary>
        /// Returns true if ListConfirmedTransactionsByAddressRIBSD instances are equal
        /// </summary>
        /// <param name="input">Instance of ListConfirmedTransactionsByAddressRIBSD to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListConfirmedTransactionsByAddressRIBSD input)
        {
            if (input == null)
            {
                return false;
