...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Get_Address_Details_422_response")]
    public partial class GetAddressDetails422Response : IEquatable<GetAddressDetails422Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressDetails422Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetAddressDetails422Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressDetails422Response" /> class.
        /// </summary>
        ...
        public GetAddressDetails422Response(string apiVersion = default(string), string requestId = default(string), string context = default(string), InvalidRequestBodyStructure error = default(InvalidRequestBodyStructure))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for GetAddressDetails422Response and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for GetAddressDetails422Response and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for GetAddressDetails422Response and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAddressDetails422Response {\n");
        ...
        {
            return this.Equals(input as GetAddressDetails422Response);
        }

        /// <summary>
        /// Returns true if GetAddressDetails422Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAddressDetails422Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAddressDetails422Response input)
        {
            if (input == null)
            {
                return false;
