...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListTokensTransfersByTransactionHashRI : IEquatable<ListTokensTransfersByTransactionHashRI>, IValidatableObject
    {
        ...
        public ListTokensTransfersByTransactionHashRI(string contractAddress = default(string), long minedInBlockHeight = default(long), string recipientAddress = default(string), string senderAddress = default(string), int tokenDecimals = default(int), string tokenName = default(string), string tokenSymbol = default(string), string tokenType = default(string), string tokensAmount = default(string), string transactionHash = default(string), int transactionTimestamp = default(int), ListTokensTransfersByTransactionHashRITransactionFee transactionFee = default(ListTokensTransfersByTransactionHashRITransactionFee))
        {
