...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListUnconfirmedOmniTransactionsByAddressRI")]
    public partial class ListUnconfirmedOmniTransactionsByAddressRI : IEquatable<ListUnconfirmedOmniTransactionsByAddressRI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnconfirmedOmniTransactionsByAddressRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListUnconfirmedOmniTransactionsByAddressRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnconfirmedOmniTransactionsByAddressRI" /> class.
        /// </summary>
        ...
        public ListUnconfirmedOmniTransactionsByAddressRI(string amount = default(string), bool divisible = default(bool), bool mined = default(bool), int propertyId = default(int), List<ListOmniTransactionsByAddressRIRecipients> recipients = default(List<ListOmniTransactionsByAddressRIRecipients>), List<ListUnconfirmedOmniTransactionsByAddressRISenders> senders = default(List<ListUnconfirmedOmniTransactionsByAddressRISenders>), bool sent = default(bool), int timestamp = default(int), string transactionId = default(string), string type = default(string), int typeInt = default(int), int version = default(int), ListUnconfirmedOmniTransactionsByAddressRIFee fee = default(ListUnconfirmedOmniTransactionsByAddressRIFee))
        {
            ...
            this.Amount = amount ?? throw new ArgumentNullException("amount is a required property for ListUnconfirmedOmniTransactionsByAddressRI and cannot be null");
            this.Divisible = divisible;
            this.Mined = mined;
            this.PropertyId = propertyId;
            // to ensure "recipients" is required (not null)
            this.Recipients = recipients ?? throw new ArgumentNullException("recipients is a required property for ListUnconfirmedOmniTransactionsByAddressRI and cannot be null");
            // to ensure "senders" is required (not null)
            this.Senders = senders ?? throw new ArgumentNullException("senders is a required property for ListUnconfirmedOmniTransactionsByAddressRI and cannot be null");
            this.Sent = sent;
            this.Timestamp = timestamp;
            // to ensure "transactionId" is required (not null)
            this.TransactionId = transactionId ?? throw new ArgumentNullException("transactionId is a required property for ListUnconfirmedOmniTransactionsByAddressRI and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for ListUnconfirmedOmniTransactionsByAddressRI and cannot be null");
            this.TypeInt = typeInt;
            this.Version = version;
            // to ensure "fee" is required (not null)
            this.Fee = fee ?? throw new ArgumentNullException("fee is a required property for ListUnconfirmedOmniTransactionsByAddressRI and cannot be null");
        }
        ...
        {
            return this.Equals(input as ListUnconfirmedOmniTransactionsByAddressRI);
        }

        /// <summary>
        /// Returns true if ListUnconfirmedOmniTransactionsByAddressRI instances are equal
        /// </summary>
        /// <param name="input">Instance of ListUnconfirmedOmniTransactionsByAddressRI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListUnconfirmedOmniTransactionsByAddressRI input)
        {
            if (input == null)
                return false;
