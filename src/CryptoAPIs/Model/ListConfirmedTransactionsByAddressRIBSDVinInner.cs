...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListConfirmedTransactionsByAddressRIBSD_vin_inner")]
    public partial class ListConfirmedTransactionsByAddressRIBSDVinInner : IEquatable<ListConfirmedTransactionsByAddressRIBSDVinInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressRIBSDVinInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListConfirmedTransactionsByAddressRIBSDVinInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressRIBSDVinInner" /> class.
        /// </summary>
        ...
        public ListConfirmedTransactionsByAddressRIBSDVinInner(List<string> addresses = default(List<string>), string coinbase = default(string), ListConfirmedTransactionsByAddressRIBSDVinInnerScriptSig scriptSig = default(ListConfirmedTransactionsByAddressRIBSDVinInnerScriptSig), string sequence = default(string), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            if (addresses == null)
            {
                throw new ArgumentNullException("addresses is a required property for ListConfirmedTransactionsByAddressRIBSDVinInner and cannot be null");
            }
            this.Addresses = addresses;
            // to ensure "coinbase" is required (not null)
            if (coinbase == null)
            {
                throw new ArgumentNullException("coinbase is a required property for ListConfirmedTransactionsByAddressRIBSDVinInner and cannot be null");
            }
            this.Coinbase = coinbase;
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null)
            {
                throw new ArgumentNullException("scriptSig is a required property for ListConfirmedTransactionsByAddressRIBSDVinInner and cannot be null");
            }
            this.ScriptSig = scriptSig;
            // to ensure "sequence" is required (not null)
            if (sequence == null)
            {
                throw new ArgumentNullException("sequence is a required property for ListConfirmedTransactionsByAddressRIBSDVinInner and cannot be null");
            }
            this.Sequence = sequence;
            // to ensure "txinwitness" is required (not null)
            if (txinwitness == null)
            {
                throw new ArgumentNullException("txinwitness is a required property for ListConfirmedTransactionsByAddressRIBSDVinInner and cannot be null");
            }
            this.Txinwitness = txinwitness;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for ListConfirmedTransactionsByAddressRIBSDVinInner and cannot be null");
            }
            this.Value = value;
            this.Txid = txid;
            this.Vout = vout;
        ...
        public ListConfirmedTransactionsByAddressRIBSDVinInnerScriptSig ScriptSig { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListConfirmedTransactionsByAddressRIBSDVinInner {\n");
        ...
        {
            return this.Equals(input as ListConfirmedTransactionsByAddressRIBSDVinInner);
        }

        /// <summary>
        /// Returns true if ListConfirmedTransactionsByAddressRIBSDVinInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ListConfirmedTransactionsByAddressRIBSDVinInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListConfirmedTransactionsByAddressRIBSDVinInner input)
        {
            if (input == null)
            {
                return false;
