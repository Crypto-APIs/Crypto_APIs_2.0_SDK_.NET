...
namespace CryptoAPIs.Model
{
    ...
    /// Tron
    /// </summary>
    [DataContract(Name = "GetBlockDetailsByBlockHashFromCallbackRIBST")]
    public partial class GetBlockDetailsByBlockHashFromCallbackRIBST : IEquatable<GetBlockDetailsByBlockHashFromCallbackRIBST>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHashFromCallbackRIBST" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetBlockDetailsByBlockHashFromCallbackRIBST() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHashFromCallbackRIBST" /> class.
        /// </summary>
        ...
        public GetBlockDetailsByBlockHashFromCallbackRIBST(string bandwidthUsed = default(string), string burnedTrx = default(string), string energyUsed = default(string), int size = default(int))
        {
            // to ensure "bandwidthUsed" is required (not null)
            if (bandwidthUsed == null)
            {
                throw new ArgumentNullException("bandwidthUsed is a required property for GetBlockDetailsByBlockHashFromCallbackRIBST and cannot be null");
            }
            this.BandwidthUsed = bandwidthUsed;
            // to ensure "burnedTrx" is required (not null)
            if (burnedTrx == null)
            {
                throw new ArgumentNullException("burnedTrx is a required property for GetBlockDetailsByBlockHashFromCallbackRIBST and cannot be null");
            }
            this.BurnedTrx = burnedTrx;
            // to ensure "energyUsed" is required (not null)
            if (energyUsed == null)
            {
                throw new ArgumentNullException("energyUsed is a required property for GetBlockDetailsByBlockHashFromCallbackRIBST and cannot be null");
            }
        ...
        {
            return this.Equals(input as GetBlockDetailsByBlockHashFromCallbackRIBST);
        }

        /// <summary>
        /// Returns true if GetBlockDetailsByBlockHashFromCallbackRIBST instances are equal
        /// </summary>
        /// <param name="input">Instance of GetBlockDetailsByBlockHashFromCallbackRIBST to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetBlockDetailsByBlockHashFromCallbackRIBST input)
        {
            if (input == null)
            {
                return false;
