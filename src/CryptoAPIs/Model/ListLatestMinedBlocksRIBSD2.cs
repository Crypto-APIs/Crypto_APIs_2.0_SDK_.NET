...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListLatestMinedBlocksRIBSD2 : IEquatable<ListLatestMinedBlocksRIBSD2>, IValidatableObject
    {
        ...
        public ListLatestMinedBlocksRIBSD2(string bits = default(string), string chainwork = default(string), string difficulty = default(string), string merkleRoot = default(string), long nonce = default(long), int size = default(int), int strippedSize = default(int), int version = default(int), int weight = default(int))
        {
