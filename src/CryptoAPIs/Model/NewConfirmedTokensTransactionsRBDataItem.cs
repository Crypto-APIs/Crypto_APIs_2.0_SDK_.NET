...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewConfirmedTokensTransactionsRB_data_item")]
    public partial class NewConfirmedTokensTransactionsRBDataItem : IEquatable<NewConfirmedTokensTransactionsRBDataItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewConfirmedTokensTransactionsRBDataItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewConfirmedTokensTransactionsRBDataItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewConfirmedTokensTransactionsRBDataItem" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as NewConfirmedTokensTransactionsRBDataItem);
        }

        /// <summary>
        /// Returns true if NewConfirmedTokensTransactionsRBDataItem instances are equal
        /// </summary>
        /// <param name="input">Instance of NewConfirmedTokensTransactionsRBDataItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewConfirmedTokensTransactionsRBDataItem input)
        {
            if (input == null)
            {
                return false;
