...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4016
    /// </summary>
    [DataContract(Name = "inline_response_401_6")]
    public partial class InlineResponse4016 : IEquatable<InlineResponse4016>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4016" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse4016() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4016" /> class.
        /// </summary>
        ...
        public InlineResponse4016(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetXRPRippleTransactionDetailsByTransactionIDE401 error = default(GetXRPRippleTransactionDetailsByTransactionIDE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4016 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4016 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse4016 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse4016 {\n");
        ...
        {
            return this.Equals(input as InlineResponse4016);
        }

        /// <summary>
        /// Returns true if InlineResponse4016 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4016 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4016 input)
        {
            if (input == null)
            {
                return false;
