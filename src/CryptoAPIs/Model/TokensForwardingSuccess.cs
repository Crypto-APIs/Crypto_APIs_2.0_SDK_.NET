...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TokensForwardingSuccess")]
    public partial class TokensForwardingSuccess : IEquatable<TokensForwardingSuccess>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokensForwardingSuccess" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TokensForwardingSuccess() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TokensForwardingSuccess" /> class.
        /// </summary>
        ...
        public TokensForwardingSuccess(string apiVersion = default(string), string referenceId = default(string), string idempotencyKey = default(string), TokensForwardingSuccessData data = default(TokensForwardingSuccessData))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for TokensForwardingSuccess and cannot be null");
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for TokensForwardingSuccess and cannot be null");
            // to ensure "idempotencyKey" is required (not null)
            this.IdempotencyKey = idempotencyKey ?? throw new ArgumentNullException("idempotencyKey is a required property for TokensForwardingSuccess and cannot be null");
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for TokensForwardingSuccess and cannot be null");
        }
        ...
        public TokensForwardingSuccessData Data { get; set; }
        ...
        {
            return this.Equals(input as TokensForwardingSuccess);
        }

        /// <summary>
        /// Returns true if TokensForwardingSuccess instances are equal
        /// </summary>
        /// <param name="input">Instance of TokensForwardingSuccess to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokensForwardingSuccess input)
        {
            if (input == null)
                return false;
