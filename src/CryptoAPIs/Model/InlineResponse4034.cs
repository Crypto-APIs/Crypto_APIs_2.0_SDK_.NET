...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse4034 : IEquatable<InlineResponse4034>, IValidatableObject
    {
        ...
        public InlineResponse4034(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetTransactionDetailsByTransactionIDE403 error = default(GetTransactionDetailsByTransactionIDE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4034 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4034 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse4034 and cannot be null");
            }
            this.Error = error;
