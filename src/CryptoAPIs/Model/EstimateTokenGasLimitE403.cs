...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(EstimateTokenGasLimitE403JsonConverter))]
    [DataContract(Name = "EstimateTokenGasLimitE403")]
    public partial class EstimateTokenGasLimitE403 : AbstractOpenAPISchema, IEquatable<EstimateTokenGasLimitE403>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EstimateTokenGasLimitE403" /> class
        /// with the <see cref="BannedIpAddress" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BannedIpAddress.</param>
        public EstimateTokenGasLimitE403(BannedIpAddress actualInstance)
        {
        ...
        public EstimateTokenGasLimitE403(EndpointNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public EstimateTokenGasLimitE403(EndpointNotAllowedForApiKey actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public EstimateTokenGasLimitE403(FeatureMainnetsNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EstimateTokenGasLimitE403 {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, EstimateTokenGasLimitE403.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of EstimateTokenGasLimitE403
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of EstimateTokenGasLimitE403</returns>
        public static EstimateTokenGasLimitE403 FromJson(string jsonString)
        {
            EstimateTokenGasLimitE403 newEstimateTokenGasLimitE403 = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newEstimateTokenGasLimitE403;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newEstimateTokenGasLimitE403 = new EstimateTokenGasLimitE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, EstimateTokenGasLimitE403.SerializerSettings));
                }
                else
                {
                    newEstimateTokenGasLimitE403 = new EstimateTokenGasLimitE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, EstimateTokenGasLimitE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newEstimateTokenGasLimitE403 = new EstimateTokenGasLimitE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, EstimateTokenGasLimitE403.SerializerSettings));
                }
                else
                {
                    newEstimateTokenGasLimitE403 = new EstimateTokenGasLimitE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, EstimateTokenGasLimitE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newEstimateTokenGasLimitE403 = new EstimateTokenGasLimitE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, EstimateTokenGasLimitE403.SerializerSettings));
                }
                else
                {
                    newEstimateTokenGasLimitE403 = new EstimateTokenGasLimitE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, EstimateTokenGasLimitE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newEstimateTokenGasLimitE403 = new EstimateTokenGasLimitE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, EstimateTokenGasLimitE403.SerializerSettings));
                }
                else
                {
                    newEstimateTokenGasLimitE403 = new EstimateTokenGasLimitE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, EstimateTokenGasLimitE403.AdditionalPropertiesSerializerSettings));
                }
        ...
        {
            return this.Equals(input as EstimateTokenGasLimitE403);
        }

        /// <summary>
        /// Returns true if EstimateTokenGasLimitE403 instances are equal
        /// </summary>
        /// <param name="input">Instance of EstimateTokenGasLimitE403 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EstimateTokenGasLimitE403 input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for EstimateTokenGasLimitE403
    /// </summary>
    public class EstimateTokenGasLimitE403JsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(EstimateTokenGasLimitE403).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return EstimateTokenGasLimitE403.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
