...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40156 : IEquatable<InlineResponse40156>, IValidatableObject
    {
        ...
        public InlineResponse40156(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTokensByAddressE401 error = default(ListTokensByAddressE401))
        {
