...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40156
    /// </summary>
    [DataContract(Name = "inline_response_401_56")]
    public partial class InlineResponse40156 : IEquatable<InlineResponse40156>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40156" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40156() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40156" /> class.
        /// </summary>
        ...
        public InlineResponse40156(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListInternalTransactionsByAddressE401 error = default(ListInternalTransactionsByAddressE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40156 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40156 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40156 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40156 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40156);
        }

        /// <summary>
        /// Returns true if InlineResponse40156 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40156 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40156 input)
        {
            if (input == null)
            {
                return false;
