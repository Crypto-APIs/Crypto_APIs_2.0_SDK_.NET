...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40359
    /// </summary>
    [DataContract(Name = "inline_response_403_59")]
    public partial class InlineResponse40359 : IEquatable<InlineResponse40359>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40359" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40359() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40359" /> class.
        /// </summary>
        ...
        public InlineResponse40359(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListUnspentTransactionOutputsByAddressE403 error = default(ListUnspentTransactionOutputsByAddressE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40359 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40359 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40359 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40359 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40359);
        }

        /// <summary>
        /// Returns true if InlineResponse40359 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40359 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40359 input)
        {
            if (input == null)
            {
                return false;
