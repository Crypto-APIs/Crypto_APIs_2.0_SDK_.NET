...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40359 : IEquatable<InlineResponse40359>, IValidatableObject
    {
        ...
        public InlineResponse40359(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewUnconfirmedTokensTransactionsE403 error = default(NewUnconfirmedTokensTransactionsE403))
        {
