...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListConfirmedTransactionsByAddressRIBSD2_vin_inner")]
    public partial class ListConfirmedTransactionsByAddressRIBSD2VinInner : IEquatable<ListConfirmedTransactionsByAddressRIBSD2VinInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressRIBSD2VinInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListConfirmedTransactionsByAddressRIBSD2VinInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressRIBSD2VinInner" /> class.
        /// </summary>
        ...
        public ListConfirmedTransactionsByAddressRIBSD2VinInner(List<string> addresses = default(List<string>), string coinbase = default(string), ListConfirmedTransactionsByAddressRIBSD2VinInnerScriptSig scriptSig = default(ListConfirmedTransactionsByAddressRIBSD2VinInnerScriptSig), string sequence = default(string), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            if (addresses == null)
            {
                throw new ArgumentNullException("addresses is a required property for ListConfirmedTransactionsByAddressRIBSD2VinInner and cannot be null");
            }
            this.Addresses = addresses;
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null)
            {
                throw new ArgumentNullException("scriptSig is a required property for ListConfirmedTransactionsByAddressRIBSD2VinInner and cannot be null");
            }
            this.ScriptSig = scriptSig;
            // to ensure "sequence" is required (not null)
            if (sequence == null)
            {
                throw new ArgumentNullException("sequence is a required property for ListConfirmedTransactionsByAddressRIBSD2VinInner and cannot be null");
            }
            this.Sequence = sequence;
            // to ensure "txinwitness" is required (not null)
            if (txinwitness == null)
            {
                throw new ArgumentNullException("txinwitness is a required property for ListConfirmedTransactionsByAddressRIBSD2VinInner and cannot be null");
            }
        ...
        {
            return this.Equals(input as ListConfirmedTransactionsByAddressRIBSD2VinInner);
        }

        /// <summary>
        /// Returns true if ListConfirmedTransactionsByAddressRIBSD2VinInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ListConfirmedTransactionsByAddressRIBSD2VinInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListConfirmedTransactionsByAddressRIBSD2VinInner input)
        {
            if (input == null)
            {
                return false;
