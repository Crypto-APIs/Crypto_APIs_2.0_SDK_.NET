...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListOmniTransactionsByBlockHeightRIRecipients : IEquatable<ListOmniTransactionsByBlockHeightRIRecipients>, IValidatableObject
    {
        ...
        public ListOmniTransactionsByBlockHeightRIRecipients(string address = default(string), string amount = default(string))
        {
            ...
            this.Address = address ?? throw new ArgumentNullException("address is a required property for ListOmniTransactionsByBlockHeightRIRecipients and cannot be null");
            // to ensure "amount" is required (not null)
            this.Amount = amount ?? throw new ArgumentNullException("amount is a required property for ListOmniTransactionsByBlockHeightRIRecipients and cannot be null");
        }
