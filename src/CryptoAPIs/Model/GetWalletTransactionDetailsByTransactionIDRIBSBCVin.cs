...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetWalletTransactionDetailsByTransactionIDRIBSBCVin : IEquatable<GetWalletTransactionDetailsByTransactionIDRIBSBCVin>, IValidatableObject
    {
        ...
        public GetWalletTransactionDetailsByTransactionIDRIBSBCVin(List<string> addresses = default(List<string>), string coinbase = default(string), GetWalletTransactionDetailsByTransactionIDRIBSBCScriptSig scriptSig = default(GetWalletTransactionDetailsByTransactionIDRIBSBCScriptSig), int sequence = default(int), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
