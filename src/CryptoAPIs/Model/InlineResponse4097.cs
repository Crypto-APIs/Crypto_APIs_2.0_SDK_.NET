...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4097
    /// </summary>
    [DataContract(Name = "inline_response_409_7")]
    public partial class InlineResponse4097 : IEquatable<InlineResponse4097>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4097" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse4097() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4097" /> class.
        /// </summary>
        ...
        public InlineResponse4097(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewUnconfirmedTokensTransactionsE409 error = default(NewUnconfirmedTokensTransactionsE409))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4097 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4097 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse4097 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse4097);
        }

        /// <summary>
        /// Returns true if InlineResponse4097 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4097 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4097 input)
        {
            if (input == null)
            {
                return false;
