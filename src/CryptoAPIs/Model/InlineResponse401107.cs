...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_401_107")]
    public partial class InlineResponse401107 : IEquatable<InlineResponse401107>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse401107" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse401107() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse401107" /> class.
        /// </summary>
        ...
        public InlineResponse401107(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetExchangeRateByAssetsIDsE401 error = default(GetExchangeRateByAssetsIDsE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse401107 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse401107 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse401107 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse401107 {\n");
        ...
        {
            return this.Equals(input as InlineResponse401107);
        }

        /// <summary>
        /// Returns true if InlineResponse401107 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse401107 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse401107 input)
        {
            if (input == null)
            {
                return false;
