...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListHDWalletXPubYPubZPubTransactionsRI_senders_inner")]
    public partial class ListHDWalletXPubYPubZPubTransactionsRISendersInner : IEquatable<ListHDWalletXPubYPubZPubTransactionsRISendersInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListHDWalletXPubYPubZPubTransactionsRISendersInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListHDWalletXPubYPubZPubTransactionsRISendersInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListHDWalletXPubYPubZPubTransactionsRISendersInner" /> class.
        /// </summary>
        ...
        public ListHDWalletXPubYPubZPubTransactionsRISendersInner(string address = default(string), string amount = default(string), bool isMember = default(bool))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for ListHDWalletXPubYPubZPubTransactionsRISendersInner and cannot be null");
            }
            this.Address = address;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for ListHDWalletXPubYPubZPubTransactionsRISendersInner and cannot be null");
            }
            this.Amount = amount;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListHDWalletXPubYPubZPubTransactionsRISendersInner {\n");
        ...
        {
            return this.Equals(input as ListHDWalletXPubYPubZPubTransactionsRISendersInner);
        }

        /// <summary>
        /// Returns true if ListHDWalletXPubYPubZPubTransactionsRISendersInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ListHDWalletXPubYPubZPubTransactionsRISendersInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListHDWalletXPubYPubZPubTransactionsRISendersInner input)
        {
            if (input == null)
            {
                return false;
