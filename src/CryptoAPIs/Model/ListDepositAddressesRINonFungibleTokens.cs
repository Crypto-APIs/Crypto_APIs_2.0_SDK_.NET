...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListDepositAddressesRI_nonFungibleTokens")]
    public partial class ListDepositAddressesRINonFungibleTokens : IEquatable<ListDepositAddressesRINonFungibleTokens>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListDepositAddressesRINonFungibleTokens" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListDepositAddressesRINonFungibleTokens() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListDepositAddressesRINonFungibleTokens" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ListDepositAddressesRINonFungibleTokens);
        }

        /// <summary>
        /// Returns true if ListDepositAddressesRINonFungibleTokens instances are equal
        /// </summary>
        /// <param name="input">Instance of ListDepositAddressesRINonFungibleTokens to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListDepositAddressesRINonFungibleTokens input)
        {
            if (input == null)
            {
                return false;
