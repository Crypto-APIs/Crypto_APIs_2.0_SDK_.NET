...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40160
    /// </summary>
    [DataContract(Name = "inline_response_401_60")]
    public partial class InlineResponse40160 : IEquatable<InlineResponse40160>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40160" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40160() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40160" /> class.
        /// </summary>
        ...
        public InlineResponse40160(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTokensTransfersByTransactionHashE401 error = default(ListTokensTransfersByTransactionHashE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40160 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40160 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40160 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40160 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40160);
        }

        /// <summary>
        /// Returns true if InlineResponse40160 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40160 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40160 input)
        {
            if (input == null)
            {
                return false;
