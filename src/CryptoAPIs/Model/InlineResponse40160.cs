...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40160 : IEquatable<InlineResponse40160>, IValidatableObject
    {
        ...
        public InlineResponse40160(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedCoinsTransactionsE401 error = default(NewConfirmedCoinsTransactionsE401))
        {
