...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40329 : IEquatable<InlineResponse40329>, IValidatableObject
    {
        ...
        public InlineResponse40329(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetZilliqaBlockDetailsByBlockHeightE403 error = default(GetZilliqaBlockDetailsByBlockHeightE403))
        {
