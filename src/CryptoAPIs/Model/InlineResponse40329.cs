...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40329
    /// </summary>
    [DataContract(Name = "inline_response_403_29")]
    public partial class InlineResponse40329 : IEquatable<InlineResponse40329>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40329" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40329() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40329" /> class.
        /// </summary>
        ...
        public InlineResponse40329(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListUnconfirmedOmniTransactionsByPropertyIDE403 error = default(ListUnconfirmedOmniTransactionsByPropertyIDE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40329 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40329 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40329 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40329 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40329);
        }

        /// <summary>
        /// Returns true if InlineResponse40329 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40329 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40329 input)
        {
            if (input == null)
            {
                return false;
