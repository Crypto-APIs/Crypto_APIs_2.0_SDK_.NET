...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40029 : IEquatable<InlineResponse40029>, IValidatableObject
    {
        ...
        public InlineResponse40029(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetZilliqaBlockDetailsByBlockHeightE400 error = default(GetZilliqaBlockDetailsByBlockHeightE400))
        {
