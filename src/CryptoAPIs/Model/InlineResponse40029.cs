...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40029
    /// </summary>
    [DataContract(Name = "inline_response_400_29")]
    public partial class InlineResponse40029 : IEquatable<InlineResponse40029>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40029" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40029() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40029" /> class.
        /// </summary>
        ...
        public InlineResponse40029(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListUnconfirmedOmniTransactionsByPropertyIDE400 error = default(ListUnconfirmedOmniTransactionsByPropertyIDE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40029 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40029 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40029 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40029 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40029);
        }

        /// <summary>
        /// Returns true if InlineResponse40029 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40029 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40029 input)
        {
            if (input == null)
            {
                return false;
