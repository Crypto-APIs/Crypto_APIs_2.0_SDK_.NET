...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40127 : IEquatable<InlineResponse40127>, IValidatableObject
    {
        ...
        public InlineResponse40127(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetBlockDetailsByBlockHeightE401 error = default(GetBlockDetailsByBlockHeightE401))
        {
