...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40127
    /// </summary>
    [DataContract(Name = "inline_response_401_27")]
    public partial class InlineResponse40127 : IEquatable<InlineResponse40127>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40127" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40127() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40127" /> class.
        /// </summary>
        ...
        public InlineResponse40127(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetXRPRippleBlockDetailsByBlockHeightE401 error = default(GetXRPRippleBlockDetailsByBlockHeightE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40127 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40127 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40127 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40127 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40127);
        }

        /// <summary>
        /// Returns true if InlineResponse40127 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40127 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40127 input)
        {
            if (input == null)
            {
                return false;
