...
namespace CryptoAPIs.Model
{
    ...
    /// Zcash
    /// </summary>
    [DataContract(Name = "GetTransactionDetailsByTransactionIDRIBSZ")]
    public partial class GetTransactionDetailsByTransactionIDRIBSZ : IEquatable<GetTransactionDetailsByTransactionIDRIBSZ>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDRIBSZ" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetTransactionDetailsByTransactionIDRIBSZ() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDRIBSZ" /> class.
        /// </summary>
        ...
        public GetTransactionDetailsByTransactionIDRIBSZ(string bindingSig = default(string), int expiryHeight = default(int), string joinSplitPubKey = default(string), string joinSplitSig = default(string), long locktime = default(long), bool overwintered = default(bool), int size = default(int), List<GetTransactionDetailsByTransactionIDRIBSZVJoinSplitInner> vJoinSplit = default(List<GetTransactionDetailsByTransactionIDRIBSZVJoinSplitInner>), List<GetTransactionDetailsByTransactionIDRIBSZVShieldedOutputInner> vShieldedOutput = default(List<GetTransactionDetailsByTransactionIDRIBSZVShieldedOutputInner>), List<GetTransactionDetailsByTransactionIDRIBSZVShieldedSpendInner> vShieldedSpend = default(List<GetTransactionDetailsByTransactionIDRIBSZVShieldedSpendInner>), string valueBalance = default(string), int version = default(int), string versionGroupId = default(string), List<GetTransactionDetailsByTransactionIDRIBSZVinInner> vin = default(List<GetTransactionDetailsByTransactionIDRIBSZVinInner>), List<GetTransactionDetailsByTransactionIDRIBSZVoutInner> vout = default(List<GetTransactionDetailsByTransactionIDRIBSZVoutInner>))
        {
            ...
            if (bindingSig == null)
            {
                throw new ArgumentNullException("bindingSig is a required property for GetTransactionDetailsByTransactionIDRIBSZ and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("joinSplitPubKey is a required property for GetTransactionDetailsByTransactionIDRIBSZ and cannot be null");
            }
            this.JoinSplitPubKey = joinSplitPubKey;
            // to ensure "joinSplitSig" is required (not null)
            if (joinSplitSig == null)
            {
                throw new ArgumentNullException("joinSplitSig is a required property for GetTransactionDetailsByTransactionIDRIBSZ and cannot be null");
            }
            ...
            if (vJoinSplit == null)
            {
                throw new ArgumentNullException("vJoinSplit is a required property for GetTransactionDetailsByTransactionIDRIBSZ and cannot be null");
            }
            this.VJoinSplit = vJoinSplit;
            // to ensure "vShieldedOutput" is required (not null)
            if (vShieldedOutput == null)
            {
                throw new ArgumentNullException("vShieldedOutput is a required property for GetTransactionDetailsByTransactionIDRIBSZ and cannot be null");
            }
            this.VShieldedOutput = vShieldedOutput;
            // to ensure "vShieldedSpend" is required (not null)
            if (vShieldedSpend == null)
            {
                throw new ArgumentNullException("vShieldedSpend is a required property for GetTransactionDetailsByTransactionIDRIBSZ and cannot be null");
            }
            this.VShieldedSpend = vShieldedSpend;
            // to ensure "valueBalance" is required (not null)
            if (valueBalance == null)
            {
                throw new ArgumentNullException("valueBalance is a required property for GetTransactionDetailsByTransactionIDRIBSZ and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("versionGroupId is a required property for GetTransactionDetailsByTransactionIDRIBSZ and cannot be null");
            }
            this.VersionGroupId = versionGroupId;
            // to ensure "vin" is required (not null)
            if (vin == null)
            {
                throw new ArgumentNullException("vin is a required property for GetTransactionDetailsByTransactionIDRIBSZ and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null)
            {
                throw new ArgumentNullException("vout is a required property for GetTransactionDetailsByTransactionIDRIBSZ and cannot be null");
            }
            this.Vout = vout;
        }
        ...
        {
            return this.Equals(input as GetTransactionDetailsByTransactionIDRIBSZ);
        }

        /// <summary>
        /// Returns true if GetTransactionDetailsByTransactionIDRIBSZ instances are equal
        /// </summary>
        /// <param name="input">Instance of GetTransactionDetailsByTransactionIDRIBSZ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetTransactionDetailsByTransactionIDRIBSZ input)
        {
            if (input == null)
            {
                return false;
