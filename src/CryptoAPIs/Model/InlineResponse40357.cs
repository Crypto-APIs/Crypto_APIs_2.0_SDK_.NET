...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40357 : IEquatable<InlineResponse40357>, IValidatableObject
    {
        ...
        public InlineResponse40357(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetFeeRecommendationsE403 error = default(GetFeeRecommendationsE403))
        {
