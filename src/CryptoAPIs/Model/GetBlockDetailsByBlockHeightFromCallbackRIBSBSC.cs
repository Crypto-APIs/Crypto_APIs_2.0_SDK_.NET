...
namespace CryptoAPIs.Model
{
    ...
    /// Binance Smart Chain
    /// </summary>
    [DataContract(Name = "GetBlockDetailsByBlockHeightFromCallbackRIBSBSC")]
    public partial class GetBlockDetailsByBlockHeightFromCallbackRIBSBSC : IEquatable<GetBlockDetailsByBlockHeightFromCallbackRIBSBSC>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHeightFromCallbackRIBSBSC" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetBlockDetailsByBlockHeightFromCallbackRIBSBSC() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHeightFromCallbackRIBSBSC" /> class.
        /// </summary>
        ...
        public GetBlockDetailsByBlockHeightFromCallbackRIBSBSC(string difficulty = default(string), string extraData = default(string), string gasLimit = default(string), string gasUsed = default(string), int minedInSeconds = default(int), string nonce = default(string), string sha3Uncles = default(string), int size = default(int), string totalDifficulty = default(string), List<string> uncles = default(List<string>))
        {
            ...
            if (difficulty == null)
            {
                throw new ArgumentNullException("difficulty is a required property for GetBlockDetailsByBlockHeightFromCallbackRIBSBSC and cannot be null");
            }
            this.Difficulty = difficulty;
            // to ensure "extraData" is required (not null)
            if (extraData == null)
            {
                throw new ArgumentNullException("extraData is a required property for GetBlockDetailsByBlockHeightFromCallbackRIBSBSC and cannot be null");
            }
            this.ExtraData = extraData;
            // to ensure "gasLimit" is required (not null)
            if (gasLimit == null)
            {
                throw new ArgumentNullException("gasLimit is a required property for GetBlockDetailsByBlockHeightFromCallbackRIBSBSC and cannot be null");
            }
            this.GasLimit = gasLimit;
            // to ensure "gasUsed" is required (not null)
            if (gasUsed == null)
            {
                throw new ArgumentNullException("gasUsed is a required property for GetBlockDetailsByBlockHeightFromCallbackRIBSBSC and cannot be null");
            }
            ...
            if (nonce == null)
            {
                throw new ArgumentNullException("nonce is a required property for GetBlockDetailsByBlockHeightFromCallbackRIBSBSC and cannot be null");
            }
            this.Nonce = nonce;
            // to ensure "sha3Uncles" is required (not null)
            if (sha3Uncles == null)
            {
                throw new ArgumentNullException("sha3Uncles is a required property for GetBlockDetailsByBlockHeightFromCallbackRIBSBSC and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("totalDifficulty is a required property for GetBlockDetailsByBlockHeightFromCallbackRIBSBSC and cannot be null");
            }
        ...
        {
            return this.Equals(input as GetBlockDetailsByBlockHeightFromCallbackRIBSBSC);
        }

        /// <summary>
        /// Returns true if GetBlockDetailsByBlockHeightFromCallbackRIBSBSC instances are equal
        /// </summary>
        /// <param name="input">Instance of GetBlockDetailsByBlockHeightFromCallbackRIBSBSC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetBlockDetailsByBlockHeightFromCallbackRIBSBSC input)
        {
            if (input == null)
            {
                return false;
