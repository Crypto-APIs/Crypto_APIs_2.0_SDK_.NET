...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetTransactionDetailsByTransactionIDFromCallbackRIBSBC : IEquatable<GetTransactionDetailsByTransactionIDFromCallbackRIBSBC>, IValidatableObject
    {
        ...
        public GetTransactionDetailsByTransactionIDFromCallbackRIBSBC(long locktime = default(long), int size = default(int), int version = default(int), List<GetTransactionDetailsByTransactionIDRIBSBCVinInner> vin = default(List<GetTransactionDetailsByTransactionIDRIBSBCVinInner>), List<GetTransactionDetailsByTransactionIDFromCallbackRIBSBCVoutInner> vout = default(List<GetTransactionDetailsByTransactionIDFromCallbackRIBSBCVoutInner>))
        {
        ...
        public List<GetTransactionDetailsByTransactionIDFromCallbackRIBSBCVoutInner> Vout { get; set; }
