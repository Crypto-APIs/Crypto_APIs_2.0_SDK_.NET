...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListUnconfirmedTransactionsByAddressRIBSB_vin")]
    public partial class ListUnconfirmedTransactionsByAddressRIBSBVin : IEquatable<ListUnconfirmedTransactionsByAddressRIBSBVin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnconfirmedTransactionsByAddressRIBSBVin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListUnconfirmedTransactionsByAddressRIBSBVin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnconfirmedTransactionsByAddressRIBSBVin" /> class.
        /// </summary>
        ...
        public ListUnconfirmedTransactionsByAddressRIBSBVin(List<string> addresses = default(List<string>), ListUnconfirmedTransactionsByAddressRIBSBScriptSig scriptSig = default(ListUnconfirmedTransactionsByAddressRIBSBScriptSig), string sequence = default(string), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            if (addresses == null)
            {
                throw new ArgumentNullException("addresses is a required property for ListUnconfirmedTransactionsByAddressRIBSBVin and cannot be null");
            }
            this.Addresses = addresses;
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null)
            {
                throw new ArgumentNullException("scriptSig is a required property for ListUnconfirmedTransactionsByAddressRIBSBVin and cannot be null");
            }
            this.ScriptSig = scriptSig;
            // to ensure "sequence" is required (not null)
            if (sequence == null)
            {
                throw new ArgumentNullException("sequence is a required property for ListUnconfirmedTransactionsByAddressRIBSBVin and cannot be null");
            }
        ...
        public ListUnconfirmedTransactionsByAddressRIBSBScriptSig ScriptSig { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListUnconfirmedTransactionsByAddressRIBSBVin {\n");
        ...
        {
            return this.Equals(input as ListUnconfirmedTransactionsByAddressRIBSBVin);
        }

        /// <summary>
        /// Returns true if ListUnconfirmedTransactionsByAddressRIBSBVin instances are equal
        /// </summary>
        /// <param name="input">Instance of ListUnconfirmedTransactionsByAddressRIBSBVin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListUnconfirmedTransactionsByAddressRIBSBVin input)
        {
            if (input == null)
            {
                return false;
