...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListTransactionsByBlockHeightRIBSL : IEquatable<ListTransactionsByBlockHeightRIBSL>, IValidatableObject
    {
        ...
        public ListTransactionsByBlockHeightRIBSL(int locktime = default(int), int size = default(int), int version = default(int), List<ListTransactionsByBlockHeightRIBSLVin> vin = default(List<ListTransactionsByBlockHeightRIBSLVin>), List<ListTransactionsByBlockHeightRIBSLVout> vout = default(List<ListTransactionsByBlockHeightRIBSLVout>), int vsize = default(int))
        {
            this.Locktime = locktime;
            this.Size = size;
            this.Version = version;
            // to ensure "vin" is required (not null)
            this.Vin = vin ?? throw new ArgumentNullException("vin is a required property for ListTransactionsByBlockHeightRIBSL and cannot be null");
            // to ensure "vout" is required (not null)
            this.Vout = vout ?? throw new ArgumentNullException("vout is a required property for ListTransactionsByBlockHeightRIBSL and cannot be null");
            this.Vsize = vsize;
        }
