...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_401_102")]
    public partial class InlineResponse401102 : IEquatable<InlineResponse401102>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse401102" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse401102() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse401102" /> class.
        /// </summary>
        ...
        public InlineResponse401102(string apiVersion = default(string), string requestId = default(string), string context = default(string), DecodeRawTransactionHexE401 error = default(DecodeRawTransactionHexE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse401102 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse401102 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse401102 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse401102 {\n");
        ...
        {
            return this.Equals(input as InlineResponse401102);
        }

        /// <summary>
        /// Returns true if InlineResponse401102 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse401102 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse401102 input)
        {
            if (input == null)
            {
                return false;
