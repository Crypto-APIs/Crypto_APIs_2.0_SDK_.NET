...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40315
    /// </summary>
    [DataContract(Name = "inline_response_403_15")]
    public partial class InlineResponse40315 : IEquatable<InlineResponse40315>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40315" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40315() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40315" /> class.
        /// </summary>
        ...
        public InlineResponse40315(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListUnconfirmedTransactionsByAddressE403 error = default(ListUnconfirmedTransactionsByAddressE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40315 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40315 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40315 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40315 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40315);
        }

        /// <summary>
        /// Returns true if InlineResponse40315 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40315 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40315 input)
        {
            if (input == null)
            {
                return false;
