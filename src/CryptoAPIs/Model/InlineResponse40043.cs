...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40043
    /// </summary>
    [DataContract(Name = "inline_response_400_43")]
    public partial class InlineResponse40043 : IEquatable<InlineResponse40043>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40043" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40043() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40043" /> class.
        /// </summary>
        ...
        public InlineResponse40043(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetLatestMinedZilliqaBlockE400 error = default(GetLatestMinedZilliqaBlockE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40043 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40043 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40043 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40043 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40043);
        }

        /// <summary>
        /// Returns true if InlineResponse40043 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40043 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40043 input)
        {
            if (input == null)
            {
                return false;
