...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40043 : IEquatable<InlineResponse40043>, IValidatableObject
    {
        ...
        public InlineResponse40043(string apiVersion = default(string), string requestId = default(string), string context = default(string), SyncHDWalletXPubYPubZPubE400 error = default(SyncHDWalletXPubYPubZPubE400))
        {
