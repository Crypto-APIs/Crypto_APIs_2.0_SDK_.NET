...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetBlockDetailsByBlockHeightFromCallbackRIBSL : IEquatable<GetBlockDetailsByBlockHeightFromCallbackRIBSL>, IValidatableObject
    {
        ...
        public GetBlockDetailsByBlockHeightFromCallbackRIBSL(string bits = default(string), string chainwork = default(string), string difficulty = default(string), string merkleRoot = default(string), int nonce = default(int), int size = default(int), int strippedsize = default(int), int version = default(int), string versionHex = default(string), int weight = default(int))
        {
