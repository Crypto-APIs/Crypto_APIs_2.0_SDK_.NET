...
namespace CryptoAPIs.Model
{
    ...
    /// DecodeXAddressE403
    /// </summary>
    [JsonConverter(typeof(DecodeXAddressE403JsonConverter))]
    [DataContract(Name = "DecodeX-AddressE403")]
    public partial class DecodeXAddressE403 : AbstractOpenAPISchema, IEquatable<DecodeXAddressE403>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeXAddressE403" /> class
        /// with the <see cref="BannedIpAddress" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BannedIpAddress.</param>
        public DecodeXAddressE403(BannedIpAddress actualInstance)
        {
        ...
        public DecodeXAddressE403(EndpointNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public DecodeXAddressE403(EndpointNotAllowedForApiKey actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public DecodeXAddressE403(FeatureMainnetsNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DecodeXAddressE403 {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, DecodeXAddressE403.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of DecodeXAddressE403
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of DecodeXAddressE403</returns>
        public static DecodeXAddressE403 FromJson(string jsonString)
        {
            DecodeXAddressE403 newDecodeXAddressE403 = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newDecodeXAddressE403;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newDecodeXAddressE403 = new DecodeXAddressE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, DecodeXAddressE403.SerializerSettings));
                }
                else
                {
                    newDecodeXAddressE403 = new DecodeXAddressE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, DecodeXAddressE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newDecodeXAddressE403 = new DecodeXAddressE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, DecodeXAddressE403.SerializerSettings));
                }
                else
                {
                    newDecodeXAddressE403 = new DecodeXAddressE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, DecodeXAddressE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newDecodeXAddressE403 = new DecodeXAddressE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, DecodeXAddressE403.SerializerSettings));
                }
                else
                {
                    newDecodeXAddressE403 = new DecodeXAddressE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, DecodeXAddressE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newDecodeXAddressE403 = new DecodeXAddressE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, DecodeXAddressE403.SerializerSettings));
                }
                else
                {
                    newDecodeXAddressE403 = new DecodeXAddressE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, DecodeXAddressE403.AdditionalPropertiesSerializerSettings));
                }
        ...
        {
            return this.Equals(input as DecodeXAddressE403);
        }

        /// <summary>
        /// Returns true if DecodeXAddressE403 instances are equal
        /// </summary>
        /// <param name="input">Instance of DecodeXAddressE403 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecodeXAddressE403 input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for DecodeXAddressE403
    /// </summary>
    public class DecodeXAddressE403JsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(DecodeXAddressE403).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return DecodeXAddressE403.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
