...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DecodeRawTransactionHexRISD2_scriptSig")]
    public partial class DecodeRawTransactionHexRISD2ScriptSig : IEquatable<DecodeRawTransactionHexRISD2ScriptSig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISD2ScriptSig" /> class.
        /// </summary>
        ...
        public DecodeRawTransactionHexRISD2ScriptSig(string asm = default(string), string hex = default(string), string type = default(string))
        {
            this.Asm = asm;
            this.Hex = hex;
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DecodeRawTransactionHexRISD2ScriptSig {\n");
        ...
        {
            return this.Equals(input as DecodeRawTransactionHexRISD2ScriptSig);
        }

        /// <summary>
        /// Returns true if DecodeRawTransactionHexRISD2ScriptSig instances are equal
        /// </summary>
        /// <param name="input">Instance of DecodeRawTransactionHexRISD2ScriptSig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecodeRawTransactionHexRISD2ScriptSig input)
        {
            if (input == null)
            {
                return false;
