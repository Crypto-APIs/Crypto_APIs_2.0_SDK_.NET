...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DecodeRawTransactionHexRISZ_vin")]
    public partial class DecodeRawTransactionHexRISZVin : IEquatable<DecodeRawTransactionHexRISZVin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISZVin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DecodeRawTransactionHexRISZVin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISZVin" /> class.
        /// </summary>
        ...
        public DecodeRawTransactionHexRISZVin(string address = default(string), string inputHash = default(string), string outputIndex = default(string), DecodeRawTransactionHexRISZScriptSig scriptSig = default(DecodeRawTransactionHexRISZScriptSig), string sequence = default(string))
        {
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null)
            {
                throw new ArgumentNullException("scriptSig is a required property for DecodeRawTransactionHexRISZVin and cannot be null");
            }
        ...
        public DecodeRawTransactionHexRISZScriptSig ScriptSig { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DecodeRawTransactionHexRISZVin {\n");
        ...
        {
            return this.Equals(input as DecodeRawTransactionHexRISZVin);
        }

        /// <summary>
        /// Returns true if DecodeRawTransactionHexRISZVin instances are equal
        /// </summary>
        /// <param name="input">Instance of DecodeRawTransactionHexRISZVin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecodeRawTransactionHexRISZVin input)
        {
            if (input == null)
            {
                return false;
