...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40130
    /// </summary>
    [DataContract(Name = "inline_response_401_30")]
    public partial class InlineResponse40130 : IEquatable<InlineResponse40130>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40130" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40130() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40130" /> class.
        /// </summary>
        ...
        public InlineResponse40130(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetZilliqaBlockDetailsByBlockHeightE401 error = default(GetZilliqaBlockDetailsByBlockHeightE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40130 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40130 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40130 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40130 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40130);
        }

        /// <summary>
        /// Returns true if InlineResponse40130 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40130 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40130 input)
        {
            if (input == null)
            {
                return false;
