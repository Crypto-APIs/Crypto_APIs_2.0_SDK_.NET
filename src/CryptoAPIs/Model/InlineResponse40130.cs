...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40130 : IEquatable<InlineResponse40130>, IValidatableObject
    {
        ...
        public InlineResponse40130(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetBlockDetailsByBlockHashE401 error = default(GetBlockDetailsByBlockHashE401))
        {
