...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40174
    /// </summary>
    [DataContract(Name = "inline_response_401_74")]
    public partial class InlineResponse40174 : IEquatable<InlineResponse40174>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40174" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40174() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40174" /> class.
        /// </summary>
        ...
        public InlineResponse40174(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedInternalTransactionsAndEachConfirmationE401 error = default(NewConfirmedInternalTransactionsAndEachConfirmationE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40174 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40174 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40174 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40174 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40174);
        }

        /// <summary>
        /// Returns true if InlineResponse40174 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40174 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40174 input)
        {
            if (input == null)
            {
                return false;
