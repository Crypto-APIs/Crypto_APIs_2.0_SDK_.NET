...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40174 : IEquatable<InlineResponse40174>, IValidatableObject
    {
        ...
        public InlineResponse40174(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedTokensTransactionsE401 error = default(NewConfirmedTokensTransactionsE401))
        {
