...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40151
    /// </summary>
    [DataContract(Name = "inline_response_401_51")]
    public partial class InlineResponse40151 : IEquatable<InlineResponse40151>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40151" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40151() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40151" /> class.
        /// </summary>
        ...
        public InlineResponse40151(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListInternalTransactionsByAddressE401 error = default(ListInternalTransactionsByAddressE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40151 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40151 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40151 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40151 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40151);
        }

        /// <summary>
        /// Returns true if InlineResponse40151 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40151 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40151 input)
        {
            if (input == null)
            {
                return false;
