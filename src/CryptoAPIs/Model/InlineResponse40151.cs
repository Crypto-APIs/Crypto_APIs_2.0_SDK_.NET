...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40151 : IEquatable<InlineResponse40151>, IValidatableObject
    {
        ...
        public InlineResponse40151(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetHDWalletXPubYPubZPubDetailsE401 error = default(GetHDWalletXPubYPubZPubDetailsE401))
        {
