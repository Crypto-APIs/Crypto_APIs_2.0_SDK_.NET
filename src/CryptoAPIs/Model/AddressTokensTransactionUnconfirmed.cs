...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AddressTokensTransactionUnconfirmed")]
    public partial class AddressTokensTransactionUnconfirmed : IEquatable<AddressTokensTransactionUnconfirmed>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressTokensTransactionUnconfirmed" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AddressTokensTransactionUnconfirmed() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressTokensTransactionUnconfirmed" /> class.
        /// </summary>
        ...
        public AddressTokensTransactionUnconfirmed(string apiVersion = default(string), string referenceId = default(string), string idempotencyKey = default(string), AddressTokensTransactionUnconfirmedData data = default(AddressTokensTransactionUnconfirmedData))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for AddressTokensTransactionUnconfirmed and cannot be null");
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for AddressTokensTransactionUnconfirmed and cannot be null");
            // to ensure "idempotencyKey" is required (not null)
            this.IdempotencyKey = idempotencyKey ?? throw new ArgumentNullException("idempotencyKey is a required property for AddressTokensTransactionUnconfirmed and cannot be null");
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for AddressTokensTransactionUnconfirmed and cannot be null");
        }
        ...
        public AddressTokensTransactionUnconfirmedData Data { get; set; }
        ...
        {
            return this.Equals(input as AddressTokensTransactionUnconfirmed);
        }

        /// <summary>
        /// Returns true if AddressTokensTransactionUnconfirmed instances are equal
        /// </summary>
        /// <param name="input">Instance of AddressTokensTransactionUnconfirmed to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddressTokensTransactionUnconfirmed input)
        {
            if (input == null)
                return false;
