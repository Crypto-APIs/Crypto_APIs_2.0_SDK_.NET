...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40025 : IEquatable<InlineResponse40025>, IValidatableObject
    {
        ...
        public InlineResponse40025(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTransactionsByBlockHeightE400 error = default(ListTransactionsByBlockHeightE400))
        {
