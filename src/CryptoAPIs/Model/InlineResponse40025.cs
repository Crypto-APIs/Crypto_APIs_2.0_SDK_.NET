...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40025
    /// </summary>
    [DataContract(Name = "inline_response_400_25")]
    public partial class InlineResponse40025 : IEquatable<InlineResponse40025>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40025" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40025() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40025" /> class.
        /// </summary>
        ...
        public InlineResponse40025(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateCoinsTransactionFromAddressForWholeAmountE400 error = default(CreateCoinsTransactionFromAddressForWholeAmountE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40025 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40025 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40025 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40025 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40025);
        }

        /// <summary>
        /// Returns true if InlineResponse40025 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40025 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40025 input)
        {
            if (input == null)
            {
                return false;
