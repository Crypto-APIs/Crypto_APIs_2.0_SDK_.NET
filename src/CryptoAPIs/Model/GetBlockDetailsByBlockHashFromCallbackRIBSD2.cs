...
namespace CryptoAPIs.Model
{
    ...
    /// Dogecoin
    /// </summary>
    [DataContract(Name = "GetBlockDetailsByBlockHashFromCallbackRIBSD2")]
    public partial class GetBlockDetailsByBlockHashFromCallbackRIBSD2 : IEquatable<GetBlockDetailsByBlockHashFromCallbackRIBSD2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHashFromCallbackRIBSD2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetBlockDetailsByBlockHashFromCallbackRIBSD2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHashFromCallbackRIBSD2" /> class.
        /// </summary>
        ...
        public GetBlockDetailsByBlockHashFromCallbackRIBSD2(string bits = default(string), string chainwork = default(string), string difficulty = default(string), string merkleRoot = default(string), long nonce = default(long), int size = default(int), int strippedSize = default(int), int version = default(int), int weight = default(int))
        {
            // to ensure "bits" is required (not null)
            if (bits == null)
            {
                throw new ArgumentNullException("bits is a required property for GetBlockDetailsByBlockHashFromCallbackRIBSD2 and cannot be null");
            }
            this.Bits = bits;
            // to ensure "chainwork" is required (not null)
            if (chainwork == null)
            {
                throw new ArgumentNullException("chainwork is a required property for GetBlockDetailsByBlockHashFromCallbackRIBSD2 and cannot be null");
            }
            this.Chainwork = chainwork;
            // to ensure "difficulty" is required (not null)
            if (difficulty == null)
            {
                throw new ArgumentNullException("difficulty is a required property for GetBlockDetailsByBlockHashFromCallbackRIBSD2 and cannot be null");
            }
            this.Difficulty = difficulty;
            // to ensure "merkleRoot" is required (not null)
            if (merkleRoot == null)
            {
                throw new ArgumentNullException("merkleRoot is a required property for GetBlockDetailsByBlockHashFromCallbackRIBSD2 and cannot be null");
            }
        ...
        {
            return this.Equals(input as GetBlockDetailsByBlockHashFromCallbackRIBSD2);
        }

        /// <summary>
        /// Returns true if GetBlockDetailsByBlockHashFromCallbackRIBSD2 instances are equal
        /// </summary>
        /// <param name="input">Instance of GetBlockDetailsByBlockHashFromCallbackRIBSD2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetBlockDetailsByBlockHashFromCallbackRIBSD2 input)
        {
            if (input == null)
            {
                return false;
