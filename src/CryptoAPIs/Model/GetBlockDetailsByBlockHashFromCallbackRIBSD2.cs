...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetBlockDetailsByBlockHashFromCallbackRIBSD2 : IEquatable<GetBlockDetailsByBlockHashFromCallbackRIBSD2>, IValidatableObject
    {
        ...
        public GetBlockDetailsByBlockHashFromCallbackRIBSD2(string bits = default(string), string chainwork = default(string), string difficulty = default(string), string merkleRoot = default(string), int nonce = default(int), int size = default(int), int strippedSize = default(int), int version = default(int), int weight = default(int))
        {
