...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40389 : IEquatable<InlineResponse40389>, IValidatableObject
    {
        ...
        public InlineResponse40389(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListAssetsDetailsE403 error = default(ListAssetsDetailsE403))
        {
