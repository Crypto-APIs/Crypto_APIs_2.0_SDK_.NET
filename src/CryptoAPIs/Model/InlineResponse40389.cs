...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40389
    /// </summary>
    [DataContract(Name = "inline_response_403_89")]
    public partial class InlineResponse40389 : IEquatable<InlineResponse40389>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40389" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40389() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40389" /> class.
        /// </summary>
        ...
        public InlineResponse40389(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListCoinsForwardingAutomationsE403 error = default(ListCoinsForwardingAutomationsE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40389 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40389 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40389 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40389 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40389);
        }

        /// <summary>
        /// Returns true if InlineResponse40389 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40389 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40389 input)
        {
            if (input == null)
            {
                return false;
