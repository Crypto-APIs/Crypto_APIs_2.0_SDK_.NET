...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4227
    /// </summary>
    [DataContract(Name = "inline_response_422_7")]
    public partial class InlineResponse4227 : IEquatable<InlineResponse4227>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4227" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse4227() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4227" /> class.
        /// </summary>
        ...
        public InlineResponse4227(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetExchangeRateByAssetsIDsE422 error = default(GetExchangeRateByAssetsIDsE422))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4227 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4227 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse4227 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse4227 {\n");
        ...
        {
            return this.Equals(input as InlineResponse4227);
        }

        /// <summary>
        /// Returns true if InlineResponse4227 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4227 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4227 input)
        {
            if (input == null)
            {
                return false;
