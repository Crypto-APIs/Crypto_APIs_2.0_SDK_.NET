...
namespace CryptoAPIs.Model
{
    ...
    public partial class BlockchainDataTransactionNotFound : IEquatable<BlockchainDataTransactionNotFound>, IValidatableObject
    {
        ...
        public BlockchainDataTransactionNotFound(string apiVersion = default(string), string requestId = default(string), string context = default(string), BlockchainDataTransactionNotFoundError error = default(BlockchainDataTransactionNotFoundError))
        {
            ...
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for BlockchainDataTransactionNotFound and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for BlockchainDataTransactionNotFound and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for BlockchainDataTransactionNotFound and cannot be null");
            }
            this.Error = error;
