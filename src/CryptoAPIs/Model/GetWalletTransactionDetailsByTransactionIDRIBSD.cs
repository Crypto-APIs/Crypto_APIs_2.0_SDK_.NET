...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetWalletTransactionDetailsByTransactionIDRIBSD : IEquatable<GetWalletTransactionDetailsByTransactionIDRIBSD>, IValidatableObject
    {
        ...
        public GetWalletTransactionDetailsByTransactionIDRIBSD(int locktime = default(int), int size = default(int), int version = default(int), List<GetWalletTransactionDetailsByTransactionIDRIBSDVin> vin = default(List<GetWalletTransactionDetailsByTransactionIDRIBSDVin>), List<GetTransactionDetailsByTransactionIDRIBSDVout> vout = default(List<GetTransactionDetailsByTransactionIDRIBSDVout>))
        {
