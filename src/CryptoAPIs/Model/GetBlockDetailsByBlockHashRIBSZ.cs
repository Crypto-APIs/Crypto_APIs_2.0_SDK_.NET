...
namespace CryptoAPIs.Model
{
    ...
    /// Zcash
    /// </summary>
    [DataContract(Name = "GetBlockDetailsByBlockHashRIBSZ")]
    public partial class GetBlockDetailsByBlockHashRIBSZ : IEquatable<GetBlockDetailsByBlockHashRIBSZ>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHashRIBSZ" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetBlockDetailsByBlockHashRIBSZ() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHashRIBSZ" /> class.
        /// </summary>
        ...
        public GetBlockDetailsByBlockHashRIBSZ(string difficulty = default(string), string bits = default(string), string chainwork = default(string), string merkleRoot = default(string), string nonce = default(string), int size = default(int), int version = default(int))
        {
        ...
        {
            return this.Equals(input as GetBlockDetailsByBlockHashRIBSZ);
        }

        /// <summary>
        /// Returns true if GetBlockDetailsByBlockHashRIBSZ instances are equal
        /// </summary>
        /// <param name="input">Instance of GetBlockDetailsByBlockHashRIBSZ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetBlockDetailsByBlockHashRIBSZ input)
        {
            if (input == null)
            {
                return false;
