...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40013
    /// </summary>
    [DataContract(Name = "inline_response_400_13")]
    public partial class InlineResponse40013 : IEquatable<InlineResponse40013>, IValidatableObject
    {
        ...
        public InlineResponse40013(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateCoinsTransactionRequestFromWalletE400 error = default(CreateCoinsTransactionRequestFromWalletE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40013 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40013 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40013 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse40013);
        }

        /// <summary>
        /// Returns true if InlineResponse40013 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40013 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40013 input)
        {
            if (input == null)
            {
                return false;
