...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40387 : IEquatable<InlineResponse40387>, IValidatableObject
    {
        ...
        public InlineResponse40387(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetExchangeRateByAssetSymbolsE403 error = default(GetExchangeRateByAssetSymbolsE403))
        {
