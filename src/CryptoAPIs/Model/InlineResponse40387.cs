...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40387
    /// </summary>
    [DataContract(Name = "inline_response_403_87")]
    public partial class InlineResponse40387 : IEquatable<InlineResponse40387>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40387" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40387() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40387" /> class.
        /// </summary>
        ...
        public InlineResponse40387(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedInternalTransactionsE403 error = default(NewConfirmedInternalTransactionsE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40387 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40387 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40387 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40387 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40387);
        }

        /// <summary>
        /// Returns true if InlineResponse40387 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40387 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40387 input)
        {
            if (input == null)
            {
                return false;
