...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DecodeRawTransactionHexRISL_vin_inner_scriptSig")]
    public partial class DecodeRawTransactionHexRISLVinInnerScriptSig : IEquatable<DecodeRawTransactionHexRISLVinInnerScriptSig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISLVinInnerScriptSig" /> class.
        /// </summary>
        ...
        public DecodeRawTransactionHexRISLVinInnerScriptSig(string asm = default(string), string hex = default(string), string type = default(string))
        {
            this.Asm = asm;
            this.Hex = hex;
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DecodeRawTransactionHexRISLVinInnerScriptSig {\n");
        ...
        {
            return this.Equals(input as DecodeRawTransactionHexRISLVinInnerScriptSig);
        }

        /// <summary>
        /// Returns true if DecodeRawTransactionHexRISLVinInnerScriptSig instances are equal
        /// </summary>
        /// <param name="input">Instance of DecodeRawTransactionHexRISLVinInnerScriptSig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecodeRawTransactionHexRISLVinInnerScriptSig input)
        {
            if (input == null)
            {
                return false;
