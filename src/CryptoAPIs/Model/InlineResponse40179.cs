...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40179
    /// </summary>
    [DataContract(Name = "inline_response_401_79")]
    public partial class InlineResponse40179 : IEquatable<InlineResponse40179>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40179" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40179() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40179" /> class.
        /// </summary>
        ...
        public InlineResponse40179(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListBlockchainEventsSubscriptionsE401 error = default(ListBlockchainEventsSubscriptionsE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40179 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40179 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40179 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40179 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40179);
        }

        /// <summary>
        /// Returns true if InlineResponse40179 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40179 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40179 input)
        {
            if (input == null)
            {
                return false;
