...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40179 : IEquatable<InlineResponse40179>, IValidatableObject
    {
        ...
        public InlineResponse40179(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateAutomaticTokensForwardingE401 error = default(CreateAutomaticTokensForwardingE401))
        {
