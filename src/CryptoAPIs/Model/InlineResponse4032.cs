...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4032
    /// </summary>
    [DataContract(Name = "inline_response_403_2")]
    public partial class InlineResponse4032 : IEquatable<InlineResponse4032>, IValidatableObject
    {
        ...
        public InlineResponse4032(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetXRPRippleAddressDetailsE403 error = default(GetXRPRippleAddressDetailsE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4032 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4032 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse4032 and cannot be null");
            }
            this.Error = error;
