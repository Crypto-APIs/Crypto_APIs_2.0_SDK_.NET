...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40186 : IEquatable<InlineResponse40186>, IValidatableObject
    {
        ...
        public InlineResponse40186(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListSupportedAssetsE401 error = default(ListSupportedAssetsE401))
        {
