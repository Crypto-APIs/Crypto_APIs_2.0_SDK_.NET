...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40186
    /// </summary>
    [DataContract(Name = "inline_response_401_86")]
    public partial class InlineResponse40186 : IEquatable<InlineResponse40186>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40186" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40186() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40186" /> class.
        /// </summary>
        ...
        public InlineResponse40186(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetBlockDetailsByBlockHeightFromCallbackE401 error = default(GetBlockDetailsByBlockHeightFromCallbackE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40186 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40186 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40186 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40186 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40186);
        }

        /// <summary>
        /// Returns true if InlineResponse40186 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40186 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40186 input)
        {
            if (input == null)
            {
                return false;
