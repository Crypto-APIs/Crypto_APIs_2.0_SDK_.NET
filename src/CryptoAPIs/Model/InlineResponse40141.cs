...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40141 : IEquatable<InlineResponse40141>, IValidatableObject
    {
        ...
        public InlineResponse40141(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetTransactionRequestDetailsE401 error = default(GetTransactionRequestDetailsE401))
        {
