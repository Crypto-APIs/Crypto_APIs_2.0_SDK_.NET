...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40141
    /// </summary>
    [DataContract(Name = "inline_response_401_41")]
    public partial class InlineResponse40141 : IEquatable<InlineResponse40141>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40141" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40141() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40141" /> class.
        /// </summary>
        ...
        public InlineResponse40141(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListOmniTransactionsByBlockHeightE401 error = default(ListOmniTransactionsByBlockHeightE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40141 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40141 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40141 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40141 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40141);
        }

        /// <summary>
        /// Returns true if InlineResponse40141 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40141 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40141 input)
        {
            if (input == null)
            {
                return false;
