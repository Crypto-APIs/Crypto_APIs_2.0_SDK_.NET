...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetBlockDetailsByBlockHashRIBSD : IEquatable<GetBlockDetailsByBlockHashRIBSD>, IValidatableObject
    {
        ...
        public GetBlockDetailsByBlockHashRIBSD(string difficulty = default(string), string bits = default(string), string chainwork = default(string), string merkleRoot = default(string), string nonce = default(string), int size = default(int), int strippedSize = default(int), int version = default(int), int weight = default(int))
        {
