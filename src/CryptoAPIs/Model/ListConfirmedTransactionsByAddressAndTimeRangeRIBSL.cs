...
namespace CryptoAPIs.Model
{
    ...
    /// Litecoin
    /// </summary>
    [DataContract(Name = "ListConfirmedTransactionsByAddressAndTimeRangeRIBSL")]
    public partial class ListConfirmedTransactionsByAddressAndTimeRangeRIBSL : IEquatable<ListConfirmedTransactionsByAddressAndTimeRangeRIBSL>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressAndTimeRangeRIBSL" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListConfirmedTransactionsByAddressAndTimeRangeRIBSL() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressAndTimeRangeRIBSL" /> class.
        /// </summary>
        ...
        public ListConfirmedTransactionsByAddressAndTimeRangeRIBSL(long locktime = default(long), int size = default(int), int vSize = default(int), int version = default(int), List<ListConfirmedTransactionsByAddressRIBSLVinInner> vin = default(List<ListConfirmedTransactionsByAddressRIBSLVinInner>), List<GetTransactionDetailsByTransactionIDRIBSLVoutInner> vout = default(List<GetTransactionDetailsByTransactionIDRIBSLVoutInner>))
        {
            ...
            if (vin == null)
            {
                throw new ArgumentNullException("vin is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRIBSL and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null)
            {
                throw new ArgumentNullException("vout is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRIBSL and cannot be null");
            }
            this.Vout = vout;
        }
        ...
        public List<ListConfirmedTransactionsByAddressRIBSLVinInner> Vin { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListConfirmedTransactionsByAddressAndTimeRangeRIBSL {\n");
        ...
        {
            return this.Equals(input as ListConfirmedTransactionsByAddressAndTimeRangeRIBSL);
        }

        /// <summary>
        /// Returns true if ListConfirmedTransactionsByAddressAndTimeRangeRIBSL instances are equal
        /// </summary>
        /// <param name="input">Instance of ListConfirmedTransactionsByAddressAndTimeRangeRIBSL to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListConfirmedTransactionsByAddressAndTimeRangeRIBSL input)
        {
            if (input == null)
            {
                return false;
