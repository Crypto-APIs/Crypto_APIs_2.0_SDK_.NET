...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40398
    /// </summary>
    [DataContract(Name = "inline_response_403_98")]
    public partial class InlineResponse40398 : IEquatable<InlineResponse40398>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40398" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40398() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40398" /> class.
        /// </summary>
        ...
        public InlineResponse40398(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetEIP1559FeeRecommendationsE403 error = default(GetEIP1559FeeRecommendationsE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40398 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40398 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40398 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40398 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40398);
        }

        /// <summary>
        /// Returns true if InlineResponse40398 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40398 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40398 input)
        {
            if (input == null)
            {
                return false;
