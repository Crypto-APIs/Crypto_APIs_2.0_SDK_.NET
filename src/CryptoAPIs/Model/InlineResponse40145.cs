...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40145 : IEquatable<InlineResponse40145>, IValidatableObject
    {
        ...
        public InlineResponse40145(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListLatestMinedBlocksE401 error = default(ListLatestMinedBlocksE401))
        {
