...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40145
    /// </summary>
    [DataContract(Name = "inline_response_401_45")]
    public partial class InlineResponse40145 : IEquatable<InlineResponse40145>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40145" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40145() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40145" /> class.
        /// </summary>
        ...
        public InlineResponse40145(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListWalletTransactionsE401 error = default(ListWalletTransactionsE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40145 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40145 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40145 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40145 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40145);
        }

        /// <summary>
        /// Returns true if InlineResponse40145 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40145 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40145 input)
        {
            if (input == null)
            {
                return false;
