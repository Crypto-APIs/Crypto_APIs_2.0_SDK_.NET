...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_403_108")]
    public partial class InlineResponse403108 : IEquatable<InlineResponse403108>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse403108" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse403108() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse403108" /> class.
        /// </summary>
        ...
        public InlineResponse403108(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListAssetsDetailsE403 error = default(ListAssetsDetailsE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse403108 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse403108 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse403108 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse403108 {\n");
        ...
        {
            return this.Equals(input as InlineResponse403108);
        }

        /// <summary>
        /// Returns true if InlineResponse403108 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse403108 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse403108 input)
        {
            if (input == null)
            {
                return false;
