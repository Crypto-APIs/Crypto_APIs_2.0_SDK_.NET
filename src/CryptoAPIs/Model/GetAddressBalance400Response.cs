...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Get_Address_Balance_400_response")]
    public partial class GetAddressBalance400Response : IEquatable<GetAddressBalance400Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressBalance400Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetAddressBalance400Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressBalance400Response" /> class.
        /// </summary>
        ...
        public GetAddressBalance400Response(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetAddressBalanceE400 error = default(GetAddressBalanceE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for GetAddressBalance400Response and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for GetAddressBalance400Response and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for GetAddressBalance400Response and cannot be null");
            }
            this.Error = error;
        ...
        public GetAddressBalanceE400 Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAddressBalance400Response {\n");
        ...
        {
            return this.Equals(input as GetAddressBalance400Response);
        }

        /// <summary>
        /// Returns true if GetAddressBalance400Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAddressBalance400Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAddressBalance400Response input)
        {
            if (input == null)
            {
                return false;
