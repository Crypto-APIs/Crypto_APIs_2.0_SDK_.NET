...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4001
    /// </summary>
    [DataContract(Name = "inline_response_400_1")]
    public partial class InlineResponse4001 : IEquatable<InlineResponse4001>, IValidatableObject
    {
        ...
        public InlineResponse4001(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListOmniTokensByAddressE400 error = default(ListOmniTokensByAddressE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4001 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4001 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse4001 and cannot be null");
            }
            this.Error = error;
