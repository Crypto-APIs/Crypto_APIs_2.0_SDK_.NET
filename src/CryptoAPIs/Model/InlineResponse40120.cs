...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40120
    /// </summary>
    [DataContract(Name = "inline_response_401_20")]
    public partial class InlineResponse40120 : IEquatable<InlineResponse40120>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40120" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40120() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40120" /> class.
        /// </summary>
        ...
        public InlineResponse40120(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetUnconfirmedOmniTransactionByTransactionIDTxidE401 error = default(GetUnconfirmedOmniTransactionByTransactionIDTxidE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40120 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40120 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40120 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40120 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40120);
        }

        /// <summary>
        /// Returns true if InlineResponse40120 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40120 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40120 input)
        {
            if (input == null)
            {
                return false;
