...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40120 : IEquatable<InlineResponse40120>, IValidatableObject
    {
        ...
        public InlineResponse40120(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateCoinsTransactionRequestFromAddressE401 error = default(CreateCoinsTransactionRequestFromAddressE401))
        {
