...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Get_Address_Balance_401_response")]
    public partial class GetAddressBalance401Response : IEquatable<GetAddressBalance401Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressBalance401Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetAddressBalance401Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressBalance401Response" /> class.
        /// </summary>
        ...
        public GetAddressBalance401Response(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetAddressBalanceE401 error = default(GetAddressBalanceE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for GetAddressBalance401Response and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for GetAddressBalance401Response and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for GetAddressBalance401Response and cannot be null");
            }
            this.Error = error;
        ...
        public GetAddressBalanceE401 Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAddressBalance401Response {\n");
        ...
        {
            return this.Equals(input as GetAddressBalance401Response);
        }

        /// <summary>
        /// Returns true if GetAddressBalance401Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAddressBalance401Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAddressBalance401Response input)
        {
            if (input == null)
            {
                return false;
