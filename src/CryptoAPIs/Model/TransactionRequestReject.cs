...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransactionRequestReject")]
    public partial class TransactionRequestReject : IEquatable<TransactionRequestReject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionRequestReject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionRequestReject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionRequestReject" /> class.
        /// </summary>
        ...
        public TransactionRequestReject(string apiVersion = default(string), string referenceId = default(string), string idempotencyKey = default(string), TransactionRequestRejectData data = default(TransactionRequestRejectData))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for TransactionRequestReject and cannot be null");
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for TransactionRequestReject and cannot be null");
            // to ensure "idempotencyKey" is required (not null)
            this.IdempotencyKey = idempotencyKey ?? throw new ArgumentNullException("idempotencyKey is a required property for TransactionRequestReject and cannot be null");
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for TransactionRequestReject and cannot be null");
        }
        ...
        public TransactionRequestRejectData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionRequestReject {\n");
        ...
        {
            return this.Equals(input as TransactionRequestReject);
        }

        /// <summary>
        /// Returns true if TransactionRequestReject instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionRequestReject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionRequestReject input)
        {
            if (input == null)
                return false;
