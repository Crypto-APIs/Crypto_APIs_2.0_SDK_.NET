...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse4223 : IEquatable<InlineResponse4223>, IValidatableObject
    {
        ...
        public InlineResponse4223(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetHDWalletXPubYPubZPubDetailsE422 error = default(GetHDWalletXPubYPubZPubDetailsE422))
        {
