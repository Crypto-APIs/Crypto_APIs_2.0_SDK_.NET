...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4223
    /// </summary>
    [DataContract(Name = "inline_response_422_3")]
    public partial class InlineResponse4223 : IEquatable<InlineResponse4223>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4223" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse4223() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4223" /> class.
        /// </summary>
        ...
        public InlineResponse4223(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListHDWalletXPubYPubZPubTransactionsE422 error = default(ListHDWalletXPubYPubZPubTransactionsE422))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4223 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4223 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse4223 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse4223 {\n");
        ...
        {
            return this.Equals(input as InlineResponse4223);
        }

        /// <summary>
        /// Returns true if InlineResponse4223 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4223 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4223 input)
        {
            if (input == null)
            {
                return false;
