...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4018
    /// </summary>
    [DataContract(Name = "inline_response_401_8")]
    public partial class InlineResponse4018 : IEquatable<InlineResponse4018>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4018" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse4018() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4018" /> class.
        /// </summary>
        ...
        public InlineResponse4018(string apiVersion = default(string), string requestId = default(string), string context = default(string), GenerateDepositAddressE401 error = default(GenerateDepositAddressE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4018 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4018 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse4018 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse4018 {\n");
        ...
        {
            return this.Equals(input as InlineResponse4018);
        }

        /// <summary>
        /// Returns true if InlineResponse4018 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4018 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4018 input)
        {
            if (input == null)
            {
                return false;
