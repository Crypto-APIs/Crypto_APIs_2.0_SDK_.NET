...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40066
    /// </summary>
    [DataContract(Name = "inline_response_400_66")]
    public partial class InlineResponse40066 : IEquatable<InlineResponse40066>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40066" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40066() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40066" /> class.
        /// </summary>
        ...
        public InlineResponse40066(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListUnconfirmedTokensTransfersByAddressE400 error = default(ListUnconfirmedTokensTransfersByAddressE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40066 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40066 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40066 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40066 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40066);
        }

        /// <summary>
        /// Returns true if InlineResponse40066 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40066 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40066 input)
        {
            if (input == null)
            {
                return false;
