...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40066 : IEquatable<InlineResponse40066>, IValidatableObject
    {
        ...
        public InlineResponse40066(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListBlockchainEventsSubscriptionsE400 error = default(ListBlockchainEventsSubscriptionsE400))
        {
