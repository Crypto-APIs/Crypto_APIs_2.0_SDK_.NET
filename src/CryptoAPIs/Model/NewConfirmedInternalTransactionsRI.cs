...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewConfirmedInternalTransactionsRI")]
    public partial class NewConfirmedInternalTransactionsRI : IEquatable<NewConfirmedInternalTransactionsRI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewConfirmedInternalTransactionsRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewConfirmedInternalTransactionsRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewConfirmedInternalTransactionsRI" /> class.
        /// </summary>
        ...
        public NewConfirmedInternalTransactionsRI(string address = default(string), string callbackSecretKey = default(string), string callbackUrl = default(string), int createdTimestamp = default(int), string eventType = default(string), bool isActive = default(bool), int receiveCallbackOn = default(int), string referenceId = default(string))
        {
        ...
        {
            return this.Equals(input as NewConfirmedInternalTransactionsRI);
        }

        /// <summary>
        /// Returns true if NewConfirmedInternalTransactionsRI instances are equal
        /// </summary>
        /// <param name="input">Instance of NewConfirmedInternalTransactionsRI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewConfirmedInternalTransactionsRI input)
        {
            if (input == null)
            {
                return false;
