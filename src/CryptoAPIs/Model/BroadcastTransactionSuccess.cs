...
namespace CryptoAPIs.Model
{
    ...
    public partial class BroadcastTransactionSuccess : IEquatable<BroadcastTransactionSuccess>, IValidatableObject
    {
        ...
        public BroadcastTransactionSuccess(string apiVersion = default(string), string referenceId = default(string), string idempotencyKey = default(string), BroadcastTransactionSuccessData data = default(BroadcastTransactionSuccessData))
        {
            ...
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for BroadcastTransactionSuccess and cannot be null");
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for BroadcastTransactionSuccess and cannot be null");
            // to ensure "idempotencyKey" is required (not null)
            this.IdempotencyKey = idempotencyKey ?? throw new ArgumentNullException("idempotencyKey is a required property for BroadcastTransactionSuccess and cannot be null");
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for BroadcastTransactionSuccess and cannot be null");
        }
