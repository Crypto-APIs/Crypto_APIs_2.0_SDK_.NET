...
namespace CryptoAPIs.Model
{
    ...
    public partial class NewUnconfirmedCoinsTransactionsRI : IEquatable<NewUnconfirmedCoinsTransactionsRI>, IValidatableObject
    {
        ...
        public NewUnconfirmedCoinsTransactionsRI(string address = default(string), string callbackSecretKey = default(string), string callbackUrl = default(string), int createdTimestamp = default(int), string eventType = default(string), bool isActive = default(bool), string referenceId = default(string))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for NewUnconfirmedCoinsTransactionsRI and cannot be null");
            }
