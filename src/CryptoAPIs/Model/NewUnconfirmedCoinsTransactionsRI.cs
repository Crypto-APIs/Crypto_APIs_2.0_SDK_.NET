...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewUnconfirmedCoinsTransactionsRI")]
    public partial class NewUnconfirmedCoinsTransactionsRI : IEquatable<NewUnconfirmedCoinsTransactionsRI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewUnconfirmedCoinsTransactionsRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewUnconfirmedCoinsTransactionsRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewUnconfirmedCoinsTransactionsRI" /> class.
        /// </summary>
        ...
        public NewUnconfirmedCoinsTransactionsRI(string callbackSecretKey = default(string), string callbackUrl = default(string), int confirmationsCount = default(int), int createdTimestamp = default(int), string eventType = default(string), bool isActive = default(bool), string referenceId = default(string), string transactionId = default(string))
        {
            // to ensure "callbackSecretKey" is required (not null)
            this.CallbackSecretKey = callbackSecretKey ?? throw new ArgumentNullException("callbackSecretKey is a required property for NewUnconfirmedCoinsTransactionsRI and cannot be null");
            // to ensure "callbackUrl" is required (not null)
            this.CallbackUrl = callbackUrl ?? throw new ArgumentNullException("callbackUrl is a required property for NewUnconfirmedCoinsTransactionsRI and cannot be null");
            this.ConfirmationsCount = confirmationsCount;
            this.CreatedTimestamp = createdTimestamp;
            // to ensure "eventType" is required (not null)
            this.EventType = eventType ?? throw new ArgumentNullException("eventType is a required property for NewUnconfirmedCoinsTransactionsRI and cannot be null");
            this.IsActive = isActive;
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for NewUnconfirmedCoinsTransactionsRI and cannot be null");
            // to ensure "transactionId" is required (not null)
            this.TransactionId = transactionId ?? throw new ArgumentNullException("transactionId is a required property for NewUnconfirmedCoinsTransactionsRI and cannot be null");
        }
        ...
        {
            return this.Equals(input as NewUnconfirmedCoinsTransactionsRI);
        }

        /// <summary>
        /// Returns true if NewUnconfirmedCoinsTransactionsRI instances are equal
        /// </summary>
        /// <param name="input">Instance of NewUnconfirmedCoinsTransactionsRI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewUnconfirmedCoinsTransactionsRI input)
        {
            if (input == null)
                return false;
