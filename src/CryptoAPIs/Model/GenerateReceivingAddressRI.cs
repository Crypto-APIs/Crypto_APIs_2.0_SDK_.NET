...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GenerateReceivingAddressRI")]
    public partial class GenerateReceivingAddressRI : IEquatable<GenerateReceivingAddressRI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateReceivingAddressRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GenerateReceivingAddressRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateReceivingAddressRI" /> class.
        /// </summary>
        ...
        public GenerateReceivingAddressRI(string address = default(string), int createdTimestamp = default(int), string label = default(string))
        {
            // to ensure "address" is required (not null)
            this.Address = address ?? throw new ArgumentNullException("address is a required property for GenerateReceivingAddressRI and cannot be null");
            this.CreatedTimestamp = createdTimestamp;
            // to ensure "label" is required (not null)
            this.Label = label ?? throw new ArgumentNullException("label is a required property for GenerateReceivingAddressRI and cannot be null");
        }
        ...
        {
            return this.Equals(input as GenerateReceivingAddressRI);
        }

        /// <summary>
        /// Returns true if GenerateReceivingAddressRI instances are equal
        /// </summary>
        /// <param name="input">Instance of GenerateReceivingAddressRI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenerateReceivingAddressRI input)
        {
            if (input == null)
                return false;
