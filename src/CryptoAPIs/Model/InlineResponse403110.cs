...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_403_110")]
    public partial class InlineResponse403110 : IEquatable<InlineResponse403110>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse403110" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse403110() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse403110" /> class.
        /// </summary>
        ...
        public InlineResponse403110(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetAssetDetailsByAssetSymbolE403 error = default(GetAssetDetailsByAssetSymbolE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse403110 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse403110 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse403110 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse403110 {\n");
        ...
        {
            return this.Equals(input as InlineResponse403110);
        }

        /// <summary>
        /// Returns true if InlineResponse403110 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse403110 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse403110 input)
        {
            if (input == null)
            {
                return false;
