...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse4224 : IEquatable<InlineResponse4224>, IValidatableObject
    {
        ...
        public InlineResponse4224(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetExchangeRateByAssetSymbolsE422 error = default(GetExchangeRateByAssetSymbolsE422))
        {
