...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4224
    /// </summary>
    [DataContract(Name = "inline_response_422_4")]
    public partial class InlineResponse4224 : IEquatable<InlineResponse4224>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4224" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse4224() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4224" /> class.
        /// </summary>
        ...
        public InlineResponse4224(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListHDWalletXPubYPubZPubTransactionsE422 error = default(ListHDWalletXPubYPubZPubTransactionsE422))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4224 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4224 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse4224 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse4224 {\n");
        ...
        {
            return this.Equals(input as InlineResponse4224);
        }

        /// <summary>
        /// Returns true if InlineResponse4224 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4224 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4224 input)
        {
            if (input == null)
            {
                return false;
