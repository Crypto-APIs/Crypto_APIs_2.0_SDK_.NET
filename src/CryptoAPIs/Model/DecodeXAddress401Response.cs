...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Decode_X_Address_401_response")]
    public partial class DecodeXAddress401Response : IEquatable<DecodeXAddress401Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeXAddress401Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DecodeXAddress401Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeXAddress401Response" /> class.
        /// </summary>
        ...
        public DecodeXAddress401Response(string apiVersion = default(string), string requestId = default(string), string context = default(string), DecodeXAddressE401 error = default(DecodeXAddressE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for DecodeXAddress401Response and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for DecodeXAddress401Response and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for DecodeXAddress401Response and cannot be null");
            }
            this.Error = error;
        ...
        public DecodeXAddressE401 Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DecodeXAddress401Response {\n");
        ...
        {
            return this.Equals(input as DecodeXAddress401Response);
        }

        /// <summary>
        /// Returns true if DecodeXAddress401Response instances are equal
        /// </summary>
        /// <param name="input">Instance of DecodeXAddress401Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecodeXAddress401Response input)
        {
            if (input == null)
            {
                return false;
