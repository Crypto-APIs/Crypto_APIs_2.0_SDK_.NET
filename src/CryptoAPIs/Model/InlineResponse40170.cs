...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40170
    /// </summary>
    [DataContract(Name = "inline_response_401_70")]
    public partial class InlineResponse40170 : IEquatable<InlineResponse40170>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40170" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40170() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40170" /> class.
        /// </summary>
        ...
        public InlineResponse40170(string apiVersion = default(string), string requestId = default(string), string context = default(string), DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401 error = default(DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40170 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40170 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40170 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40170 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40170);
        }

        /// <summary>
        /// Returns true if InlineResponse40170 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40170 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40170 input)
        {
            if (input == null)
            {
                return false;
