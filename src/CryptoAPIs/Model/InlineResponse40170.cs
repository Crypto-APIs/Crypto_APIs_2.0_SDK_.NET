...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40170 : IEquatable<InlineResponse40170>, IValidatableObject
    {
        ...
        public InlineResponse40170(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetTransactionDetailsByTransactionIDFromCallbackE401 error = default(GetTransactionDetailsByTransactionIDFromCallbackE401))
        {
