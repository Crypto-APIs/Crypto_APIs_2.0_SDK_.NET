...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40327
    /// </summary>
    [DataContract(Name = "inline_response_403_27")]
    public partial class InlineResponse40327 : IEquatable<InlineResponse40327>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40327" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40327() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40327" /> class.
        /// </summary>
        ...
        public InlineResponse40327(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetXRPRippleBlockDetailsByBlockHeightE403 error = default(GetXRPRippleBlockDetailsByBlockHeightE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40327 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40327 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40327 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40327 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40327);
        }

        /// <summary>
        /// Returns true if InlineResponse40327 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40327 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40327 input)
        {
            if (input == null)
            {
                return false;
