...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40327 : IEquatable<InlineResponse40327>, IValidatableObject
    {
        ...
        public InlineResponse40327(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetBlockDetailsByBlockHeightE403 error = default(GetBlockDetailsByBlockHeightE403))
        {
