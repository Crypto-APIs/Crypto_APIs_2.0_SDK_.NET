...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListUnspentTransactionOutputsByAddressRI_vin")]
    public partial class ListUnspentTransactionOutputsByAddressRIVin : IEquatable<ListUnspentTransactionOutputsByAddressRIVin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnspentTransactionOutputsByAddressRIVin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListUnspentTransactionOutputsByAddressRIVin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnspentTransactionOutputsByAddressRIVin" /> class.
        /// </summary>
        ...
        public ListUnspentTransactionOutputsByAddressRIVin(List<string> addresses = default(List<string>), string coinbase = default(string), GetTransactionDetailsByTransactionIDRIBSBScriptSig scriptSig = default(GetTransactionDetailsByTransactionIDRIBSBScriptSig), string sequence = default(string), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            if (addresses == null) {
                throw new ArgumentNullException("addresses is a required property for ListUnspentTransactionOutputsByAddressRIVin and cannot be null");
            }
            this.Addresses = addresses;
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null) {
                throw new ArgumentNullException("scriptSig is a required property for ListUnspentTransactionOutputsByAddressRIVin and cannot be null");
            }
            this.ScriptSig = scriptSig;
            // to ensure "sequence" is required (not null)
            if (sequence == null) {
                throw new ArgumentNullException("sequence is a required property for ListUnspentTransactionOutputsByAddressRIVin and cannot be null");
            }
            this.Sequence = sequence;
            // to ensure "txid" is required (not null)
            if (txid == null) {
                throw new ArgumentNullException("txid is a required property for ListUnspentTransactionOutputsByAddressRIVin and cannot be null");
            }
            this.Txid = txid;
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for ListUnspentTransactionOutputsByAddressRIVin and cannot be null");
            }
            this.Value = value;
        ...
        {
            return this.Equals(input as ListUnspentTransactionOutputsByAddressRIVin);
        }

        /// <summary>
        /// Returns true if ListUnspentTransactionOutputsByAddressRIVin instances are equal
        /// </summary>
        /// <param name="input">Instance of ListUnspentTransactionOutputsByAddressRIVin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListUnspentTransactionOutputsByAddressRIVin input)
        {
            if (input == null)
            {
                return false;
