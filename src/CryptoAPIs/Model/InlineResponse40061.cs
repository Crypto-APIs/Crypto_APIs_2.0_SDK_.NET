...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40061 : IEquatable<InlineResponse40061>, IValidatableObject
    {
        ...
        public InlineResponse40061(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedTokensTransactionsE400 error = default(NewConfirmedTokensTransactionsE400))
        {
