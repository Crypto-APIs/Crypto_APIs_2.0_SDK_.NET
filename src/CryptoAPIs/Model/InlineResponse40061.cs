...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40061
    /// </summary>
    [DataContract(Name = "inline_response_400_61")]
    public partial class InlineResponse40061 : IEquatable<InlineResponse40061>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40061" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40061() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40061" /> class.
        /// </summary>
        ...
        public InlineResponse40061(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListConfirmedTransactionsByAddressAndTimeRangeE400 error = default(ListConfirmedTransactionsByAddressAndTimeRangeE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40061 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40061 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40061 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40061 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40061);
        }

        /// <summary>
        /// Returns true if InlineResponse40061 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40061 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40061 input)
        {
            if (input == null)
            {
                return false;
