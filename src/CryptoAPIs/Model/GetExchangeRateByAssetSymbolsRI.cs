...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetExchangeRateByAssetSymbolsRI : IEquatable<GetExchangeRateByAssetSymbolsRI>, IValidatableObject
    {
        ...
        public GetExchangeRateByAssetSymbolsRI(int calculationTimestamp = default(int), string fromAssetId = default(string), string fromAssetSymbol = default(string), string rate = default(string), string toAssetId = default(string), string toAssetSymbol = default(string))
        {
            ...
            this.FromAssetId = fromAssetId ?? throw new ArgumentNullException("fromAssetId is a required property for GetExchangeRateByAssetSymbolsRI and cannot be null");
            // to ensure "fromAssetSymbol" is required (not null)
            this.FromAssetSymbol = fromAssetSymbol ?? throw new ArgumentNullException("fromAssetSymbol is a required property for GetExchangeRateByAssetSymbolsRI and cannot be null");
            // to ensure "rate" is required (not null)
            this.Rate = rate ?? throw new ArgumentNullException("rate is a required property for GetExchangeRateByAssetSymbolsRI and cannot be null");
            // to ensure "toAssetId" is required (not null)
            this.ToAssetId = toAssetId ?? throw new ArgumentNullException("toAssetId is a required property for GetExchangeRateByAssetSymbolsRI and cannot be null");
            // to ensure "toAssetSymbol" is required (not null)
            this.ToAssetSymbol = toAssetSymbol ?? throw new ArgumentNullException("toAssetSymbol is a required property for GetExchangeRateByAssetSymbolsRI and cannot be null");
        }
