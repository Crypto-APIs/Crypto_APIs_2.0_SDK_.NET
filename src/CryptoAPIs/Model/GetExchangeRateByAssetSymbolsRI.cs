...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetExchangeRateByAssetSymbolsRI : IEquatable<GetExchangeRateByAssetSymbolsRI>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="GetExchangeRateByAssetSymbolsRI" /> class.
        /// </summary>
        /// <param name="calculationTimestamp">Defines the time of the market data used to calculate the exchange rate in UNIX Timestamp. Oldest possible timestamp is 30 days. (required).</param>
        ...
        /// </summary>
        /// <value>Defines the time of the market data used to calculate the exchange rate in UNIX Timestamp. Oldest possible timestamp is 30 days.</value>
