...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40085 : IEquatable<InlineResponse40085>, IValidatableObject
    {
        ...
        public InlineResponse40085(string apiVersion = default(string), string requestId = default(string), string context = default(string), BroadcastLocallySignedTransactionE400 error = default(BroadcastLocallySignedTransactionE400))
        {
