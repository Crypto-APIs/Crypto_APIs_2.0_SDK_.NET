...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40321
    /// </summary>
    [DataContract(Name = "inline_response_403_21")]
    public partial class InlineResponse40321 : IEquatable<InlineResponse40321>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40321" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40321() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40321" /> class.
        /// </summary>
        ...
        public InlineResponse40321(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateCoinsTransactionRequestFromAddressE403 error = default(CreateCoinsTransactionRequestFromAddressE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40321 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40321 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40321 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40321 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40321);
        }

        /// <summary>
        /// Returns true if InlineResponse40321 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40321 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40321 input)
        {
            if (input == null)
            {
                return false;
