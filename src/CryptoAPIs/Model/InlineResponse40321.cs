...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40321 : IEquatable<InlineResponse40321>, IValidatableObject
    {
        ...
        public InlineResponse40321(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListZilliqaTransactionsByBlockHashE403 error = default(ListZilliqaTransactionsByBlockHashE403))
        {
