...
namespace CryptoAPIs.Model
{
    ...
    public partial class TransactionRequestFailData : IEquatable<TransactionRequestFailData>, IValidatableObject
    {
        ...
        public TransactionRequestFailData(string product = default(string), string _event = default(string), TransactionRequestFailDataItem item = default(TransactionRequestFailDataItem))
        {
            ...
            this.Product = product ?? throw new ArgumentNullException("product is a required property for TransactionRequestFailData and cannot be null");
            // to ensure "_event" is required (not null)
            this.Event = _event ?? throw new ArgumentNullException("_event is a required property for TransactionRequestFailData and cannot be null");
            // to ensure "item" is required (not null)
            this.Item = item ?? throw new ArgumentNullException("item is a required property for TransactionRequestFailData and cannot be null");
        }
