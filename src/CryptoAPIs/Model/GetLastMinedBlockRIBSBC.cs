...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetLastMinedBlockRIBSBC : IEquatable<GetLastMinedBlockRIBSBC>, IValidatableObject
    {
        ...
        public GetLastMinedBlockRIBSBC(string difficulty = default(string), string bits = default(string), string chainwork = default(string), string merkleRoot = default(string), string nonce = default(string), int size = default(int), int version = default(int), string versionHex = default(string))
        {
