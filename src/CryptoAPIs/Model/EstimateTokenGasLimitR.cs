...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EstimateTokenGasLimitR")]
    public partial class EstimateTokenGasLimitR : IEquatable<EstimateTokenGasLimitR>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EstimateTokenGasLimitR" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EstimateTokenGasLimitR() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EstimateTokenGasLimitR" /> class.
        /// </summary>
        ...
        public EstimateTokenGasLimitR(string apiVersion = default(string), string requestId = default(string), string context = default(string), EstimateTokenGasLimitRData data = default(EstimateTokenGasLimitRData))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for EstimateTokenGasLimitR and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for EstimateTokenGasLimitR and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for EstimateTokenGasLimitR and cannot be null");
            }
            this.Data = data;
        ...
        public EstimateTokenGasLimitRData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EstimateTokenGasLimitR {\n");
        ...
        {
            return this.Equals(input as EstimateTokenGasLimitR);
        }

        /// <summary>
        /// Returns true if EstimateTokenGasLimitR instances are equal
        /// </summary>
        /// <param name="input">Instance of EstimateTokenGasLimitR to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EstimateTokenGasLimitR input)
        {
            if (input == null)
            {
                return false;
