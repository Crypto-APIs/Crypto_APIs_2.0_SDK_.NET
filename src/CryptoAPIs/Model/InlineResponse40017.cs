...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40017 : IEquatable<InlineResponse40017>, IValidatableObject
    {
        ...
        public InlineResponse40017(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTransactionsByBlockHashE400 error = default(ListTransactionsByBlockHashE400))
        {
