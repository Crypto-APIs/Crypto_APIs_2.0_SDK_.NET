...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40017
    /// </summary>
    [DataContract(Name = "inline_response_400_17")]
    public partial class InlineResponse40017 : IEquatable<InlineResponse40017>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40017" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40017() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40017" /> class.
        /// </summary>
        ...
        public InlineResponse40017(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListAllUnconfirmedTransactionsE400 error = default(ListAllUnconfirmedTransactionsE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40017 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40017 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40017 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40017 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40017);
        }

        /// <summary>
        /// Returns true if InlineResponse40017 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40017 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40017 input)
        {
            if (input == null)
            {
                return false;
