...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40360 : IEquatable<InlineResponse40360>, IValidatableObject
    {
        ...
        public InlineResponse40360(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedCoinsTransactionsE403 error = default(NewConfirmedCoinsTransactionsE403))
        {
