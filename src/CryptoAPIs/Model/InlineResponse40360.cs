...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40360
    /// </summary>
    [DataContract(Name = "inline_response_403_60")]
    public partial class InlineResponse40360 : IEquatable<InlineResponse40360>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40360" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40360() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40360" /> class.
        /// </summary>
        ...
        public InlineResponse40360(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTokensTransfersByTransactionHashE403 error = default(ListTokensTransfersByTransactionHashE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40360 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40360 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40360 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40360 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40360);
        }

        /// <summary>
        /// Returns true if InlineResponse40360 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40360 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40360 input)
        {
            if (input == null)
            {
                return false;
