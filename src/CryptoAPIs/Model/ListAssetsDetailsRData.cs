...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListAssetsDetailsR_data")]
    public partial class ListAssetsDetailsRData : IEquatable<ListAssetsDetailsRData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAssetsDetailsRData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListAssetsDetailsRData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAssetsDetailsRData" /> class.
        /// </summary>
        ...
        public ListAssetsDetailsRData(int offset = default(int), int limit = default(int), int total = default(int), List<ListAssetsDetailsRI> items = default(List<ListAssetsDetailsRI>))
        {
            this.Offset = offset;
            this.Limit = limit;
            this.Total = total;
            // to ensure "items" is required (not null)
            this.Items = items ?? throw new ArgumentNullException("items is a required property for ListAssetsDetailsRData and cannot be null");
        }
        ...
        public List<ListAssetsDetailsRI> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListAssetsDetailsRData {\n");
        ...
        {
            return this.Equals(input as ListAssetsDetailsRData);
        }

        /// <summary>
        /// Returns true if ListAssetsDetailsRData instances are equal
        /// </summary>
        /// <param name="input">Instance of ListAssetsDetailsRData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListAssetsDetailsRData input)
        {
            if (input == null)
                return false;
