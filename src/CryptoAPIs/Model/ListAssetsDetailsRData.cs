...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListAssetsDetailsRData : IEquatable<ListAssetsDetailsRData>, IValidatableObject
    {
        ...
        public ListAssetsDetailsRData(int limit = default(int), int offset = default(int), int total = default(int), List<ListAssetsDetailsRI> items = default(List<ListAssetsDetailsRI>))
        {
            this.Limit = limit;
            this.Offset = offset;
            this.Total = total;
