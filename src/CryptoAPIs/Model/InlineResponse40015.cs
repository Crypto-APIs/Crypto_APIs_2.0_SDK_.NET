...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40015
    /// </summary>
    [DataContract(Name = "inline_response_400_15")]
    public partial class InlineResponse40015 : IEquatable<InlineResponse40015>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40015" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40015() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40015" /> class.
        /// </summary>
        ...
        public InlineResponse40015(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListUnconfirmedTransactionsByAddressE400 error = default(ListUnconfirmedTransactionsByAddressE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40015 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40015 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40015 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40015 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40015);
        }

        /// <summary>
        /// Returns true if InlineResponse40015 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40015 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40015 input)
        {
            if (input == null)
            {
                return false;
