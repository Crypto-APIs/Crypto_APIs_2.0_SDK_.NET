...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListXRPRippleTransactionsByAddressR_data")]
    public partial class ListXRPRippleTransactionsByAddressRData : IEquatable<ListXRPRippleTransactionsByAddressRData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListXRPRippleTransactionsByAddressRData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListXRPRippleTransactionsByAddressRData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListXRPRippleTransactionsByAddressRData" /> class.
        /// </summary>
        ...
        public ListXRPRippleTransactionsByAddressRData(int offset = default(int), int limit = default(int), int total = default(int), List<ListXRPRippleTransactionsByAddressRI> items = default(List<ListXRPRippleTransactionsByAddressRI>))
        {
            this.Offset = offset;
            this.Limit = limit;
            this.Total = total;
        ...
        public List<ListXRPRippleTransactionsByAddressRI> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListXRPRippleTransactionsByAddressRData {\n");
        ...
        {
            return this.Equals(input as ListXRPRippleTransactionsByAddressRData);
        }

        /// <summary>
        /// Returns true if ListXRPRippleTransactionsByAddressRData instances are equal
        /// </summary>
        /// <param name="input">Instance of ListXRPRippleTransactionsByAddressRData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListXRPRippleTransactionsByAddressRData input)
        {
            if (input == null)
                return false;
