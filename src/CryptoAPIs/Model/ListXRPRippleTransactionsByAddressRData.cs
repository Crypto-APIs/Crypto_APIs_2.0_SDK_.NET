...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListXRPRippleTransactionsByAddressRData : IEquatable<ListXRPRippleTransactionsByAddressRData>, IValidatableObject
    {
        ...
        public ListXRPRippleTransactionsByAddressRData(int limit = default(int), int offset = default(int), int total = default(int), List<ListXRPRippleTransactionsByAddressRI> items = default(List<ListXRPRippleTransactionsByAddressRI>))
        {
            this.Limit = limit;
            this.Offset = offset;
            this.Total = total;
