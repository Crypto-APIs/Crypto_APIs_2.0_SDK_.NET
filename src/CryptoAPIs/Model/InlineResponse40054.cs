...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40054 : IEquatable<InlineResponse40054>, IValidatableObject
    {
        ...
        public InlineResponse40054(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTokensTransfersByTransactionHashE400 error = default(ListTokensTransfersByTransactionHashE400))
        {
