...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40054
    /// </summary>
    [DataContract(Name = "inline_response_400_54")]
    public partial class InlineResponse40054 : IEquatable<InlineResponse40054>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40054" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40054() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40054" /> class.
        /// </summary>
        ...
        public InlineResponse40054(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetInternalTransactionByTransactionHashAndOperationIdE400 error = default(GetInternalTransactionByTransactionHashAndOperationIdE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40054 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40054 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40054 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40054 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40054);
        }

        /// <summary>
        /// Returns true if InlineResponse40054 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40054 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40054 input)
        {
            if (input == null)
            {
                return false;
