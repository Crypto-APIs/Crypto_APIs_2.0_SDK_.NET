...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40116 : IEquatable<InlineResponse40116>, IValidatableObject
    {
        ...
        public InlineResponse40116(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListAllUnconfirmedTransactionsE401 error = default(ListAllUnconfirmedTransactionsE401))
        {
