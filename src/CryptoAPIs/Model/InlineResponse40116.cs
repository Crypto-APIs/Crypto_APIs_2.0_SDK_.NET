...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40116
    /// </summary>
    [DataContract(Name = "inline_response_401_16")]
    public partial class InlineResponse40116 : IEquatable<InlineResponse40116>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40116" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40116() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40116" /> class.
        /// </summary>
        ...
        public InlineResponse40116(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListXRPRippleTransactionsByAddressAndTimeRangeE401 error = default(ListXRPRippleTransactionsByAddressAndTimeRangeE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40116 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40116 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40116 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40116 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40116);
        }

        /// <summary>
        /// Returns true if InlineResponse40116 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40116 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40116 input)
        {
            if (input == null)
            {
                return false;
