...
namespace CryptoAPIs.Model
{
    ...
    /// Bitcoin Cash
    /// </summary>
    [DataContract(Name = "ListTransactionsByAddressRIBSBC")]
    public partial class ListTransactionsByAddressRIBSBC : IEquatable<ListTransactionsByAddressRIBSBC>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressRIBSBC" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByAddressRIBSBC() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressRIBSBC" /> class.
        /// </summary>
        ...
        public ListTransactionsByAddressRIBSBC(int locktime = default(int), int size = default(int), int version = default(int), List<ListTransactionsByAddressRIBSBCVin> vin = default(List<ListTransactionsByAddressRIBSBCVin>), List<GetTransactionDetailsByTransactionIDRIBSBCVout> vout = default(List<GetTransactionDetailsByTransactionIDRIBSBCVout>))
        {
            this.Locktime = locktime;
            this.Size = size;
            this.Version = version;
            // to ensure "vin" is required (not null)
            this.Vin = vin ?? throw new ArgumentNullException("vin is a required property for ListTransactionsByAddressRIBSBC and cannot be null");
            // to ensure "vout" is required (not null)
            this.Vout = vout ?? throw new ArgumentNullException("vout is a required property for ListTransactionsByAddressRIBSBC and cannot be null");
        }
        ...
        public List<ListTransactionsByAddressRIBSBCVin> Vin { get; set; }
        ...
        {
            return this.Equals(input as ListTransactionsByAddressRIBSBC);
        }

        /// <summary>
        /// Returns true if ListTransactionsByAddressRIBSBC instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByAddressRIBSBC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByAddressRIBSBC input)
        {
            if (input == null)
                return false;
