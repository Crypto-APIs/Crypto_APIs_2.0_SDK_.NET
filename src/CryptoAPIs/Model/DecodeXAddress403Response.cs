...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Decode_X_Address_403_response")]
    public partial class DecodeXAddress403Response : IEquatable<DecodeXAddress403Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeXAddress403Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DecodeXAddress403Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeXAddress403Response" /> class.
        /// </summary>
        ...
        public DecodeXAddress403Response(string apiVersion = default(string), string requestId = default(string), string context = default(string), DecodeXAddressE403 error = default(DecodeXAddressE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for DecodeXAddress403Response and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for DecodeXAddress403Response and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for DecodeXAddress403Response and cannot be null");
            }
            this.Error = error;
        ...
        public DecodeXAddressE403 Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DecodeXAddress403Response {\n");
        ...
        {
            return this.Equals(input as DecodeXAddress403Response);
        }

        /// <summary>
        /// Returns true if DecodeXAddress403Response instances are equal
        /// </summary>
        /// <param name="input">Instance of DecodeXAddress403Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecodeXAddress403Response input)
        {
            if (input == null)
            {
                return false;
