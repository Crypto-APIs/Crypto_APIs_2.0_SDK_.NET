...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40026 : IEquatable<InlineResponse40026>, IValidatableObject
    {
        ...
        public InlineResponse40026(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetBlockDetailsByBlockHeightE400 error = default(GetBlockDetailsByBlockHeightE400))
        {
