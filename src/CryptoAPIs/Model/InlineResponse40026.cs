...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40026
    /// </summary>
    [DataContract(Name = "inline_response_400_26")]
    public partial class InlineResponse40026 : IEquatable<InlineResponse40026>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40026" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40026() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40026" /> class.
        /// </summary>
        ...
        public InlineResponse40026(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateCoinsTransactionFromAddressForWholeAmountE400 error = default(CreateCoinsTransactionFromAddressForWholeAmountE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40026 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40026 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40026 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40026 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40026);
        }

        /// <summary>
        /// Returns true if InlineResponse40026 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40026 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40026 input)
        {
            if (input == null)
            {
                return false;
