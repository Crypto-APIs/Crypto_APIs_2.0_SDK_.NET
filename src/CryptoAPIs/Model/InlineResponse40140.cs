...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40140 : IEquatable<InlineResponse40140>, IValidatableObject
    {
        ...
        public InlineResponse40140(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetLastMinedBlockE401 error = default(GetLastMinedBlockE401))
        {
