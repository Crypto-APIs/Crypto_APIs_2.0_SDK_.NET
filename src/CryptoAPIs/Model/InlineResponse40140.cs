...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40140
    /// </summary>
    [DataContract(Name = "inline_response_401_40")]
    public partial class InlineResponse40140 : IEquatable<InlineResponse40140>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40140" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40140() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40140" /> class.
        /// </summary>
        ...
        public InlineResponse40140(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetLatestMinedZilliqaBlockE401 error = default(GetLatestMinedZilliqaBlockE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40140 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40140 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40140 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40140 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40140);
        }

        /// <summary>
        /// Returns true if InlineResponse40140 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40140 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40140 input)
        {
            if (input == null)
            {
                return false;
