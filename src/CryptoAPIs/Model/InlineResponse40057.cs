...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40057
    /// </summary>
    [DataContract(Name = "inline_response_400_57")]
    public partial class InlineResponse40057 : IEquatable<InlineResponse40057>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40057" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40057() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40057" /> class.
        /// </summary>
        ...
        public InlineResponse40057(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetTokenDetailsByContractAddressE400 error = default(GetTokenDetailsByContractAddressE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40057 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40057 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40057 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40057 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40057);
        }

        /// <summary>
        /// Returns true if InlineResponse40057 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40057 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40057 input)
        {
            if (input == null)
            {
                return false;
