...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40057 : IEquatable<InlineResponse40057>, IValidatableObject
    {
        ...
        public InlineResponse40057(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetFeeRecommendationsE400 error = default(GetFeeRecommendationsE400))
        {
