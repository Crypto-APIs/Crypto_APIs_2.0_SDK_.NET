...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListUnconfirmedTransactionsByAddressRIBSD_vin_inner")]
    public partial class ListUnconfirmedTransactionsByAddressRIBSDVinInner : IEquatable<ListUnconfirmedTransactionsByAddressRIBSDVinInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnconfirmedTransactionsByAddressRIBSDVinInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListUnconfirmedTransactionsByAddressRIBSDVinInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnconfirmedTransactionsByAddressRIBSDVinInner" /> class.
        /// </summary>
        ...
        public ListUnconfirmedTransactionsByAddressRIBSDVinInner(List<string> addresses = default(List<string>), ListConfirmedTransactionsByAddressRIBSDVinInnerScriptSig scriptSig = default(ListConfirmedTransactionsByAddressRIBSDVinInnerScriptSig), long sequence = default(long), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            if (addresses == null)
            {
                throw new ArgumentNullException("addresses is a required property for ListUnconfirmedTransactionsByAddressRIBSDVinInner and cannot be null");
            }
            this.Addresses = addresses;
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null)
            {
                throw new ArgumentNullException("scriptSig is a required property for ListUnconfirmedTransactionsByAddressRIBSDVinInner and cannot be null");
            }
            ...
            if (txinwitness == null)
            {
                throw new ArgumentNullException("txinwitness is a required property for ListUnconfirmedTransactionsByAddressRIBSDVinInner and cannot be null");
            }
            this.Txinwitness = txinwitness;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for ListUnconfirmedTransactionsByAddressRIBSDVinInner and cannot be null");
            }
            this.Value = value;
            this.Txid = txid;
            this.Vout = vout;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListUnconfirmedTransactionsByAddressRIBSDVinInner {\n");
        ...
        {
            return this.Equals(input as ListUnconfirmedTransactionsByAddressRIBSDVinInner);
        }

        /// <summary>
        /// Returns true if ListUnconfirmedTransactionsByAddressRIBSDVinInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ListUnconfirmedTransactionsByAddressRIBSDVinInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListUnconfirmedTransactionsByAddressRIBSDVinInner input)
        {
            if (input == null)
            {
                return false;
