...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40190
    /// </summary>
    [DataContract(Name = "inline_response_401_90")]
    public partial class InlineResponse40190 : IEquatable<InlineResponse40190>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40190" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40190() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40190" /> class.
        /// </summary>
        ...
        public InlineResponse40190(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateAutomaticCoinsForwardingE401 error = default(CreateAutomaticCoinsForwardingE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40190 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40190 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40190 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40190 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40190);
        }

        /// <summary>
        /// Returns true if InlineResponse40190 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40190 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40190 input)
        {
            if (input == null)
            {
                return false;
