...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40190 : IEquatable<InlineResponse40190>, IValidatableObject
    {
        ...
        public InlineResponse40190(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetAssetDetailsByAssetIDE401 error = default(GetAssetDetailsByAssetIDE401))
        {
