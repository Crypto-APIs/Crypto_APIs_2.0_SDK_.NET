...
namespace CryptoAPIs.Model
{
    ...
    /// Ethereum
    /// </summary>
    [DataContract(Name = "ListTransactionsByAddressRIBSE")]
    public partial class ListTransactionsByAddressRIBSE : IEquatable<ListTransactionsByAddressRIBSE>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressRIBSE" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByAddressRIBSE() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressRIBSE" /> class.
        /// </summary>
        ...
        public ListTransactionsByAddressRIBSE(string contract = default(string), string gasLimit = default(string), ListTransactionsByAddressRIBSEGasPrice gasPrice = default(ListTransactionsByAddressRIBSEGasPrice), string gasUsed = default(string), string inputData = default(string), int nonce = default(int))
        {
            ...
            this.GasLimit = gasLimit ?? throw new ArgumentNullException("gasLimit is a required property for ListTransactionsByAddressRIBSE and cannot be null");
            // to ensure "gasPrice" is required (not null)
            this.GasPrice = gasPrice ?? throw new ArgumentNullException("gasPrice is a required property for ListTransactionsByAddressRIBSE and cannot be null");
            // to ensure "gasUsed" is required (not null)
            this.GasUsed = gasUsed ?? throw new ArgumentNullException("gasUsed is a required property for ListTransactionsByAddressRIBSE and cannot be null");
        ...
        public ListTransactionsByAddressRIBSEGasPrice GasPrice { get; set; }
        ...
        {
            return this.Equals(input as ListTransactionsByAddressRIBSE);
        }

        /// <summary>
        /// Returns true if ListTransactionsByAddressRIBSE instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByAddressRIBSE to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByAddressRIBSE input)
        {
            if (input == null)
                return false;
