...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListAllUnconfirmedTransactionsRI")]
    public partial class ListAllUnconfirmedTransactionsRI : IEquatable<ListAllUnconfirmedTransactionsRI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllUnconfirmedTransactionsRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListAllUnconfirmedTransactionsRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllUnconfirmedTransactionsRI" /> class.
        /// </summary>
        ...
        public ListAllUnconfirmedTransactionsRI(List<ListUnconfirmedTransactionsByAddressRIRecipients> recipients = default(List<ListUnconfirmedTransactionsByAddressRIRecipients>), List<ListUnconfirmedTransactionsByAddressRISenders> senders = default(List<ListUnconfirmedTransactionsByAddressRISenders>), int timestamp = default(int), string transactionHash = default(string), string transactionId = default(string), ListAllUnconfirmedTransactionsRIBS blockchainSpecific = default(ListAllUnconfirmedTransactionsRIBS))
        {
            ...
            if (recipients == null)
            {
                throw new ArgumentNullException("recipients is a required property for ListAllUnconfirmedTransactionsRI and cannot be null");
            }
            this.Recipients = recipients;
            // to ensure "senders" is required (not null)
            if (senders == null)
            {
                throw new ArgumentNullException("senders is a required property for ListAllUnconfirmedTransactionsRI and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("blockchainSpecific is a required property for ListAllUnconfirmedTransactionsRI and cannot be null");
            }
        ...
        public ListAllUnconfirmedTransactionsRIBS BlockchainSpecific { get; set; }
        ...
        {
            return this.Equals(input as ListAllUnconfirmedTransactionsRI);
        }

        /// <summary>
        /// Returns true if ListAllUnconfirmedTransactionsRI instances are equal
        /// </summary>
        /// <param name="input">Instance of ListAllUnconfirmedTransactionsRI to be compared</param>
        /// <returns>Boolean</returns>
