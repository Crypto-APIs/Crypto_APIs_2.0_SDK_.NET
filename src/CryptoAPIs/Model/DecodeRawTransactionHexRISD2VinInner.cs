...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DecodeRawTransactionHexRISD2_vin_inner")]
    public partial class DecodeRawTransactionHexRISD2VinInner : IEquatable<DecodeRawTransactionHexRISD2VinInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISD2VinInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DecodeRawTransactionHexRISD2VinInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISD2VinInner" /> class.
        /// </summary>
        ...
        public DecodeRawTransactionHexRISD2VinInner(string address = default(string), string inputHash = default(string), string outputIndex = default(string), DecodeRawTransactionHexRISD2VinInnerScriptSig scriptSig = default(DecodeRawTransactionHexRISD2VinInnerScriptSig), string sequence = default(string), List<string> txinwitness = default(List<string>))
        {
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null)
            {
                throw new ArgumentNullException("scriptSig is a required property for DecodeRawTransactionHexRISD2VinInner and cannot be null");
            }
        ...
        public DecodeRawTransactionHexRISD2VinInnerScriptSig ScriptSig { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DecodeRawTransactionHexRISD2VinInner {\n");
        ...
        {
            return this.Equals(input as DecodeRawTransactionHexRISD2VinInner);
        }

        /// <summary>
        /// Returns true if DecodeRawTransactionHexRISD2VinInner instances are equal
        /// </summary>
        /// <param name="input">Instance of DecodeRawTransactionHexRISD2VinInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecodeRawTransactionHexRISD2VinInner input)
        {
            if (input == null)
            {
                return false;
