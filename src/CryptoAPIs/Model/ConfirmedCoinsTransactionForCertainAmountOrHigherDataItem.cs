...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConfirmedCoinsTransactionForCertainAmountOrHigher_data_item")]
    public partial class ConfirmedCoinsTransactionForCertainAmountOrHigherDataItem : IEquatable<ConfirmedCoinsTransactionForCertainAmountOrHigherDataItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfirmedCoinsTransactionForCertainAmountOrHigherDataItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConfirmedCoinsTransactionForCertainAmountOrHigherDataItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfirmedCoinsTransactionForCertainAmountOrHigherDataItem" /> class.
        /// </summary>
        ...
        public ConfirmedCoinsTransactionForCertainAmountOrHigherDataItem(string blockchain = default(string), string network = default(string), string transactionId = default(string), AddressCoinsTransactionConfirmedDataItemMinedInBlock minedInBlock = default(AddressCoinsTransactionConfirmedDataItemMinedInBlock), string amount = default(string), string unit = default(string))
        {
            // to ensure "blockchain" is required (not null)
            if (blockchain == null)
            {
                throw new ArgumentNullException("blockchain is a required property for ConfirmedCoinsTransactionForCertainAmountOrHigherDataItem and cannot be null");
            }
            this.Blockchain = blockchain;
            // to ensure "network" is required (not null)
            if (network == null)
            {
                throw new ArgumentNullException("network is a required property for ConfirmedCoinsTransactionForCertainAmountOrHigherDataItem and cannot be null");
            }
            this.Network = network;
            // to ensure "transactionId" is required (not null)
            if (transactionId == null)
            {
                throw new ArgumentNullException("transactionId is a required property for ConfirmedCoinsTransactionForCertainAmountOrHigherDataItem and cannot be null");
            }
            this.TransactionId = transactionId;
            // to ensure "minedInBlock" is required (not null)
            if (minedInBlock == null)
            {
                throw new ArgumentNullException("minedInBlock is a required property for ConfirmedCoinsTransactionForCertainAmountOrHigherDataItem and cannot be null");
            }
            this.MinedInBlock = minedInBlock;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for ConfirmedCoinsTransactionForCertainAmountOrHigherDataItem and cannot be null");
            }
            this.Amount = amount;
            // to ensure "unit" is required (not null)
            if (unit == null)
            {
                throw new ArgumentNullException("unit is a required property for ConfirmedCoinsTransactionForCertainAmountOrHigherDataItem and cannot be null");
            }
            this.Unit = unit;
        }
        ...
        {
            return this.Equals(input as ConfirmedCoinsTransactionForCertainAmountOrHigherDataItem);
        }

        /// <summary>
        /// Returns true if ConfirmedCoinsTransactionForCertainAmountOrHigherDataItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ConfirmedCoinsTransactionForCertainAmountOrHigherDataItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConfirmedCoinsTransactionForCertainAmountOrHigherDataItem input)
        {
            if (input == null)
            {
                return false;
