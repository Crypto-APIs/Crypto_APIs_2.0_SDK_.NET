...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40091
    /// </summary>
    [DataContract(Name = "inline_response_400_91")]
    public partial class InlineResponse40091 : IEquatable<InlineResponse40091>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40091" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40091() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40091" /> class.
        /// </summary>
        ...
        public InlineResponse40091(string apiVersion = default(string), string requestId = default(string), string context = default(string), DeleteAutomaticCoinsForwardingE400 error = default(DeleteAutomaticCoinsForwardingE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40091 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40091 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40091 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40091 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40091);
        }

        /// <summary>
        /// Returns true if InlineResponse40091 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40091 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40091 input)
        {
            if (input == null)
            {
                return false;
