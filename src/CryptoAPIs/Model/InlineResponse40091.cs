...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40091 : IEquatable<InlineResponse40091>, IValidatableObject
    {
        ...
        public InlineResponse40091(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetAssetDetailsByAssetSymbolE400 error = default(GetAssetDetailsByAssetSymbolE400))
        {
