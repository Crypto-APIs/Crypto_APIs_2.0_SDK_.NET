...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4035
    /// </summary>
    [DataContract(Name = "inline_response_403_5")]
    public partial class InlineResponse4035 : IEquatable<InlineResponse4035>, IValidatableObject
    {
        ...
        public InlineResponse4035(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListOmniTransactionsByAddressE403 error = default(ListOmniTransactionsByAddressE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4035 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4035 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse4035 and cannot be null");
            }
            this.Error = error;
