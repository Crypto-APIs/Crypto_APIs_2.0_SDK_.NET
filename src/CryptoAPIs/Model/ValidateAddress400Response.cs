...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Validate_Address_400_response")]
    public partial class ValidateAddress400Response : IEquatable<ValidateAddress400Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidateAddress400Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ValidateAddress400Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidateAddress400Response" /> class.
        /// </summary>
        ...
        public ValidateAddress400Response(string apiVersion = default(string), string requestId = default(string), string context = default(string), ValidateAddressE400 error = default(ValidateAddressE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for ValidateAddress400Response and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for ValidateAddress400Response and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for ValidateAddress400Response and cannot be null");
            }
            this.Error = error;
        ...
        public ValidateAddressE400 Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ValidateAddress400Response {\n");
        ...
        {
            return this.Equals(input as ValidateAddress400Response);
        }

        /// <summary>
        /// Returns true if ValidateAddress400Response instances are equal
        /// </summary>
        /// <param name="input">Instance of ValidateAddress400Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValidateAddress400Response input)
        {
            if (input == null)
            {
                return false;
