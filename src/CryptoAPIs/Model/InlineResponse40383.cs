...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40383
    /// </summary>
    [DataContract(Name = "inline_response_403_83")]
    public partial class InlineResponse40383 : IEquatable<InlineResponse40383>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40383" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40383() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40383" /> class.
        /// </summary>
        ...
        public InlineResponse40383(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetAddressDetailsFromCallbackE403 error = default(GetAddressDetailsFromCallbackE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40383 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40383 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40383 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40383 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40383);
        }

        /// <summary>
        /// Returns true if InlineResponse40383 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40383 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40383 input)
        {
            if (input == null)
            {
                return false;
