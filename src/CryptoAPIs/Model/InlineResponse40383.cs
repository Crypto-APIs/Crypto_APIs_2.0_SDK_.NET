...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40383 : IEquatable<InlineResponse40383>, IValidatableObject
    {
        ...
        public InlineResponse40383(string apiVersion = default(string), string requestId = default(string), string context = default(string), ValidateAddressE403 error = default(ValidateAddressE403))
        {
