...
namespace CryptoAPIs.Model
{
    ...
    /// Dogecoin
    /// </summary>
    [DataContract(Name = "GetBlockDetailsByBlockHeightRIBSD")]
    public partial class GetBlockDetailsByBlockHeightRIBSD : IEquatable<GetBlockDetailsByBlockHeightRIBSD>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHeightRIBSD" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetBlockDetailsByBlockHeightRIBSD() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHeightRIBSD" /> class.
        /// </summary>
        ...
        public GetBlockDetailsByBlockHeightRIBSD(string difficulty = default(string), string bits = default(string), string chainwork = default(string), string merkleRoot = default(string), string nonce = default(string), int size = default(int), int strippedSize = default(int), int version = default(int), int weight = default(int))
        {
        ...
        {
            return this.Equals(input as GetBlockDetailsByBlockHeightRIBSD);
        }

        /// <summary>
        /// Returns true if GetBlockDetailsByBlockHeightRIBSD instances are equal
        /// </summary>
        /// <param name="input">Instance of GetBlockDetailsByBlockHeightRIBSD to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetBlockDetailsByBlockHeightRIBSD input)
        {
            if (input == null)
            {
                return false;
