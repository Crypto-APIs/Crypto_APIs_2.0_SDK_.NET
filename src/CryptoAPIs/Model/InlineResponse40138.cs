...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40138
    /// </summary>
    [DataContract(Name = "inline_response_401_38")]
    public partial class InlineResponse40138 : IEquatable<InlineResponse40138>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40138" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40138() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40138" /> class.
        /// </summary>
        ...
        public InlineResponse40138(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListOmniTransactionsByBlockHeightE401 error = default(ListOmniTransactionsByBlockHeightE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40138 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40138 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40138 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40138 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40138);
        }

        /// <summary>
        /// Returns true if InlineResponse40138 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40138 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40138 input)
        {
            if (input == null)
            {
                return false;
