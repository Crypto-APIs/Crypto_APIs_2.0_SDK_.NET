...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40138 : IEquatable<InlineResponse40138>, IValidatableObject
    {
        ...
        public InlineResponse40138(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListAllAssetsFromAllWalletsE401 error = default(ListAllAssetsFromAllWalletsE401))
        {
