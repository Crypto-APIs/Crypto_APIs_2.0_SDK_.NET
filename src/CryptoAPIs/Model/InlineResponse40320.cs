...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40320 : IEquatable<InlineResponse40320>, IValidatableObject
    {
        ...
        public InlineResponse40320(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateCoinsTransactionRequestFromAddressE403 error = default(CreateCoinsTransactionRequestFromAddressE403))
        {
