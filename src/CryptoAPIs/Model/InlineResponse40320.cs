...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40320
    /// </summary>
    [DataContract(Name = "inline_response_403_20")]
    public partial class InlineResponse40320 : IEquatable<InlineResponse40320>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40320" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40320() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40320" /> class.
        /// </summary>
        ...
        public InlineResponse40320(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetUnconfirmedOmniTransactionByTransactionIDTxidE403 error = default(GetUnconfirmedOmniTransactionByTransactionIDTxidE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40320 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40320 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40320 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40320 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40320);
        }

        /// <summary>
        /// Returns true if InlineResponse40320 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40320 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40320 input)
        {
            if (input == null)
            {
                return false;
