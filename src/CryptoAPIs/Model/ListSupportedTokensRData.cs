...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListSupportedTokensR_data")]
    public partial class ListSupportedTokensRData : IEquatable<ListSupportedTokensRData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListSupportedTokensRData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListSupportedTokensRData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListSupportedTokensRData" /> class.
        /// </summary>
        ...
        public ListSupportedTokensRData(int offset = default(int), int limit = default(int), int total = default(int), List<ListSupportedTokensRI> items = default(List<ListSupportedTokensRI>))
        {
            ...
            this.Items = items ?? throw new ArgumentNullException("items is a required property for ListSupportedTokensRData and cannot be null");
        }
        ...
        public List<ListSupportedTokensRI> Items { get; set; }
        ...
        {
            return this.Equals(input as ListSupportedTokensRData);
        }

        /// <summary>
        /// Returns true if ListSupportedTokensRData instances are equal
        /// </summary>
        /// <param name="input">Instance of ListSupportedTokensRData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListSupportedTokensRData input)
        {
            if (input == null)
                return false;
