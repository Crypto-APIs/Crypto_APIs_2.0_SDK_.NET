...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListCoinsForwardingAutomationsRData : IEquatable<ListCoinsForwardingAutomationsRData>, IValidatableObject
    {
        ...
        public ListCoinsForwardingAutomationsRData(int offset = default(int), int limit = default(int), int total = default(int), List<ListCoinsForwardingAutomationsRI> items = default(List<ListCoinsForwardingAutomationsRI>))
        {
            this.Offset = offset;
            this.Limit = limit;
            this.Total = total;
            // to ensure "items" is required (not null)
            this.Items = items ?? throw new ArgumentNullException("items is a required property for ListCoinsForwardingAutomationsRData and cannot be null");
        }
