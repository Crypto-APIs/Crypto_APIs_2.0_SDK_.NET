...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40146 : IEquatable<InlineResponse40146>, IValidatableObject
    {
        ...
        public InlineResponse40146(string apiVersion = default(string), string requestId = default(string), string context = default(string), SyncHDWalletXPubYPubZPubE401 error = default(SyncHDWalletXPubYPubZPubE401))
        {
