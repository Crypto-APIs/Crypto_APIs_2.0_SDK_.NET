...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40146
    /// </summary>
    [DataContract(Name = "inline_response_401_46")]
    public partial class InlineResponse40146 : IEquatable<InlineResponse40146>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40146" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40146() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40146" /> class.
        /// </summary>
        ...
        public InlineResponse40146(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetWalletTransactionDetailsByTransactionIDE401 error = default(GetWalletTransactionDetailsByTransactionIDE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40146 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40146 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40146 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40146 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40146);
        }

        /// <summary>
        /// Returns true if InlineResponse40146 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40146 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40146 input)
        {
            if (input == null)
            {
                return false;
