...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40117
    /// </summary>
    [DataContract(Name = "inline_response_401_17")]
    public partial class InlineResponse40117 : IEquatable<InlineResponse40117>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40117" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40117() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40117" /> class.
        /// </summary>
        ...
        public InlineResponse40117(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListAllUnconfirmedTransactionsE401 error = default(ListAllUnconfirmedTransactionsE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40117 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40117 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40117 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40117 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40117);
        }

        /// <summary>
        /// Returns true if InlineResponse40117 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40117 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40117 input)
        {
            if (input == null)
            {
                return false;
