...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40117 : IEquatable<InlineResponse40117>, IValidatableObject
    {
        ...
        public InlineResponse40117(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTransactionsByBlockHashE401 error = default(ListTransactionsByBlockHashE401))
        {
