...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Get_Address_Details_403_response")]
    public partial class GetAddressDetails403Response : IEquatable<GetAddressDetails403Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressDetails403Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetAddressDetails403Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressDetails403Response" /> class.
        /// </summary>
        ...
        public GetAddressDetails403Response(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetAddressDetailsE403 error = default(GetAddressDetailsE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for GetAddressDetails403Response and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for GetAddressDetails403Response and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for GetAddressDetails403Response and cannot be null");
            }
            this.Error = error;
        ...
        public GetAddressDetailsE403 Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAddressDetails403Response {\n");
        ...
        {
            return this.Equals(input as GetAddressDetails403Response);
        }

        /// <summary>
        /// Returns true if GetAddressDetails403Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAddressDetails403Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAddressDetails403Response input)
        {
            if (input == null)
            {
                return false;
