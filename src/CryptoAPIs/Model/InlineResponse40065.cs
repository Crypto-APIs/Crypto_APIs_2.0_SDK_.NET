...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40065
    /// </summary>
    [DataContract(Name = "inline_response_400_65")]
    public partial class InlineResponse40065 : IEquatable<InlineResponse40065>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40065" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40065() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40065" /> class.
        /// </summary>
        ...
        public InlineResponse40065(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetRawTransactionDataE400 error = default(GetRawTransactionDataE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40065 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40065 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40065 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse40065);
        }

        /// <summary>
        /// Returns true if InlineResponse40065 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40065 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40065 input)
        {
            if (input == null)
            {
                return false;
