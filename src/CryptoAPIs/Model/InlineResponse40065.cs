...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40065 : IEquatable<InlineResponse40065>, IValidatableObject
    {
        ...
        public InlineResponse40065(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewBlockE400 error = default(NewBlockE400))
        {
