...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewConfirmedCoinsTransactionsAndEachConfirmationR")]
    public partial class NewConfirmedCoinsTransactionsAndEachConfirmationR : IEquatable<NewConfirmedCoinsTransactionsAndEachConfirmationR>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewConfirmedCoinsTransactionsAndEachConfirmationR" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewConfirmedCoinsTransactionsAndEachConfirmationR() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewConfirmedCoinsTransactionsAndEachConfirmationR" /> class.
        /// </summary>
        ...
        public NewConfirmedCoinsTransactionsAndEachConfirmationR(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedCoinsTransactionsAndEachConfirmationRData data = default(NewConfirmedCoinsTransactionsAndEachConfirmationRData))
        {
            ...
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for NewConfirmedCoinsTransactionsAndEachConfirmationR and cannot be null");
            // to ensure "requestId" is required (not null)
            this.RequestId = requestId ?? throw new ArgumentNullException("requestId is a required property for NewConfirmedCoinsTransactionsAndEachConfirmationR and cannot be null");
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for NewConfirmedCoinsTransactionsAndEachConfirmationR and cannot be null");
        ...
        public NewConfirmedCoinsTransactionsAndEachConfirmationRData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewConfirmedCoinsTransactionsAndEachConfirmationR {\n");
        ...
        {
            return this.Equals(input as NewConfirmedCoinsTransactionsAndEachConfirmationR);
        }

        /// <summary>
        /// Returns true if NewConfirmedCoinsTransactionsAndEachConfirmationR instances are equal
        /// </summary>
        /// <param name="input">Instance of NewConfirmedCoinsTransactionsAndEachConfirmationR to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewConfirmedCoinsTransactionsAndEachConfirmationR input)
        {
            if (input == null)
                return false;
