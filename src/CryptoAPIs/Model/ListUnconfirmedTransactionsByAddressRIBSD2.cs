...
namespace CryptoAPIs.Model
{
    ...
    /// Dash
    /// </summary>
    [DataContract(Name = "ListUnconfirmedTransactionsByAddressRIBSD2")]
    public partial class ListUnconfirmedTransactionsByAddressRIBSD2 : IEquatable<ListUnconfirmedTransactionsByAddressRIBSD2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnconfirmedTransactionsByAddressRIBSD2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListUnconfirmedTransactionsByAddressRIBSD2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnconfirmedTransactionsByAddressRIBSD2" /> class.
        /// </summary>
        ...
        public ListUnconfirmedTransactionsByAddressRIBSD2(int locktime = default(int), int size = default(int), int version = default(int), List<ListUnconfirmedTransactionsByAddressRIBSD2Vin> vin = default(List<ListUnconfirmedTransactionsByAddressRIBSD2Vin>), List<ListUnconfirmedTransactionsByAddressRIBSD2Vout> vout = default(List<ListUnconfirmedTransactionsByAddressRIBSD2Vout>))
        {
            ...
            if (vin == null) {
                throw new ArgumentNullException("vin is a required property for ListUnconfirmedTransactionsByAddressRIBSD2 and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null) {
                throw new ArgumentNullException("vout is a required property for ListUnconfirmedTransactionsByAddressRIBSD2 and cannot be null");
            }
            this.Vout = vout;
        }
        ...
        public List<ListUnconfirmedTransactionsByAddressRIBSD2Vin> Vin { get; set; }
        ...
        public List<ListUnconfirmedTransactionsByAddressRIBSD2Vout> Vout { get; set; }
        ...
        {
            return this.Equals(input as ListUnconfirmedTransactionsByAddressRIBSD2);
        }

        /// <summary>
        /// Returns true if ListUnconfirmedTransactionsByAddressRIBSD2 instances are equal
        /// </summary>
        /// <param name="input">Instance of ListUnconfirmedTransactionsByAddressRIBSD2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListUnconfirmedTransactionsByAddressRIBSD2 input)
        {
            if (input == null)
                return false;
