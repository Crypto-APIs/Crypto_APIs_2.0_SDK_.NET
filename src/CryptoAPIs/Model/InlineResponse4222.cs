...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4222
    /// </summary>
    [DataContract(Name = "inline_response_422_2")]
    public partial class InlineResponse4222 : IEquatable<InlineResponse4222>, IValidatableObject
    {
        ...
        public InlineResponse4222(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetHDWalletXPubYPubZPubDetailsE422 error = default(GetHDWalletXPubYPubZPubDetailsE422))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4222 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4222 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse4222 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse4222);
        }

        /// <summary>
        /// Returns true if InlineResponse4222 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4222 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4222 input)
        {
            if (input == null)
            {
                return false;
