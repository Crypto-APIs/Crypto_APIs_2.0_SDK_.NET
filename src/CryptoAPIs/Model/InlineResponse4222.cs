...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse4222 : IEquatable<InlineResponse4222>, IValidatableObject
    {
        ...
        public InlineResponse4222(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetHDWalletXPubYPubZPubAssetsE422 error = default(GetHDWalletXPubYPubZPubAssetsE422))
        {
