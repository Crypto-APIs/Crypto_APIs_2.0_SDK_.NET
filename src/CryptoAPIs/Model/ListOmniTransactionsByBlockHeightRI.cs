...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListOmniTransactionsByBlockHeightRI")]
    public partial class ListOmniTransactionsByBlockHeightRI : IEquatable<ListOmniTransactionsByBlockHeightRI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListOmniTransactionsByBlockHeightRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListOmniTransactionsByBlockHeightRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListOmniTransactionsByBlockHeightRI" /> class.
        /// </summary>
        ...
        public ListOmniTransactionsByBlockHeightRI(string amount = default(string), bool divisible = default(bool), string minedInBlockHash = default(string), int minedInBlockHeight = default(int), int positionInBlock = default(int), int propertyId = default(int), List<ListOmniTransactionsByBlockHeightRIRecipients> recipients = default(List<ListOmniTransactionsByBlockHeightRIRecipients>), List<ListOmniTransactionsByBlockHeightRISenders> senders = default(List<ListOmniTransactionsByBlockHeightRISenders>), int timestamp = default(int), string transactionId = default(string), string type = default(string), int typeInt = default(int), bool valid = default(bool), int version = default(int), ListOmniTransactionsByBlockHeightRIFee fee = default(ListOmniTransactionsByBlockHeightRIFee))
        {
            ...
            this.Amount = amount ?? throw new ArgumentNullException("amount is a required property for ListOmniTransactionsByBlockHeightRI and cannot be null");
            this.Divisible = divisible;
            // to ensure "minedInBlockHash" is required (not null)
            this.MinedInBlockHash = minedInBlockHash ?? throw new ArgumentNullException("minedInBlockHash is a required property for ListOmniTransactionsByBlockHeightRI and cannot be null");
            this.MinedInBlockHeight = minedInBlockHeight;
            this.PositionInBlock = positionInBlock;
            this.PropertyId = propertyId;
            // to ensure "recipients" is required (not null)
            this.Recipients = recipients ?? throw new ArgumentNullException("recipients is a required property for ListOmniTransactionsByBlockHeightRI and cannot be null");
            // to ensure "senders" is required (not null)
            this.Senders = senders ?? throw new ArgumentNullException("senders is a required property for ListOmniTransactionsByBlockHeightRI and cannot be null");
            this.Timestamp = timestamp;
            // to ensure "transactionId" is required (not null)
            this.TransactionId = transactionId ?? throw new ArgumentNullException("transactionId is a required property for ListOmniTransactionsByBlockHeightRI and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for ListOmniTransactionsByBlockHeightRI and cannot be null");
            this.TypeInt = typeInt;
            this.Valid = valid;
            this.Version = version;
            // to ensure "fee" is required (not null)
            this.Fee = fee ?? throw new ArgumentNullException("fee is a required property for ListOmniTransactionsByBlockHeightRI and cannot be null");
        }
        ...
        public ListOmniTransactionsByBlockHeightRIFee Fee { get; set; }
        ...
        {
            return this.Equals(input as ListOmniTransactionsByBlockHeightRI);
        }

        /// <summary>
        /// Returns true if ListOmniTransactionsByBlockHeightRI instances are equal
        /// </summary>
        /// <param name="input">Instance of ListOmniTransactionsByBlockHeightRI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListOmniTransactionsByBlockHeightRI input)
        {
            if (input == null)
                return false;
