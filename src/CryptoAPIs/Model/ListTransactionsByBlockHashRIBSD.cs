...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListTransactionsByBlockHashRIBSD : IEquatable<ListTransactionsByBlockHashRIBSD>, IValidatableObject
    {
        ...
        public ListTransactionsByBlockHashRIBSD(long locktime = default(long), int size = default(int), int version = default(int), List<ListTransactionsByBlockHashRIBSDVinInner> vin = default(List<ListTransactionsByBlockHashRIBSDVinInner>), List<ListTransactionsByBlockHashRIBSDVoutInner> vout = default(List<ListTransactionsByBlockHashRIBSDVoutInner>))
        {
            ...
            if (vin == null)
            {
                throw new ArgumentNullException("vin is a required property for ListTransactionsByBlockHashRIBSD and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null)
            {
                throw new ArgumentNullException("vout is a required property for ListTransactionsByBlockHashRIBSD and cannot be null");
            }
            this.Vout = vout;
        }
        ...
        public List<ListTransactionsByBlockHashRIBSDVinInner> Vin { get; set; }
