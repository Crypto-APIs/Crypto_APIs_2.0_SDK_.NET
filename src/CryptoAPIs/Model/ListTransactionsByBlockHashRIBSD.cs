...
namespace CryptoAPIs.Model
{
    ...
    /// Dogecoin
    /// </summary>
    [DataContract(Name = "ListTransactionsByBlockHashRIBSD")]
    public partial class ListTransactionsByBlockHashRIBSD : IEquatable<ListTransactionsByBlockHashRIBSD>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashRIBSD" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByBlockHashRIBSD() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashRIBSD" /> class.
        /// </summary>
        ...
        public ListTransactionsByBlockHashRIBSD(int locktime = default(int), int size = default(int), int version = default(int), List<ListTransactionsByBlockHashRIBSDVin> vin = default(List<ListTransactionsByBlockHashRIBSDVin>), List<ListTransactionsByBlockHashRIBSDVout> vout = default(List<ListTransactionsByBlockHashRIBSDVout>))
        {
            this.Locktime = locktime;
            this.Size = size;
            this.Version = version;
            // to ensure "vin" is required (not null)
            this.Vin = vin ?? throw new ArgumentNullException("vin is a required property for ListTransactionsByBlockHashRIBSD and cannot be null");
            // to ensure "vout" is required (not null)
            this.Vout = vout ?? throw new ArgumentNullException("vout is a required property for ListTransactionsByBlockHashRIBSD and cannot be null");
        }
        ...
        public List<ListTransactionsByBlockHashRIBSDVin> Vin { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListTransactionsByBlockHashRIBSD {\n");
        ...
        {
            return this.Equals(input as ListTransactionsByBlockHashRIBSD);
        }

        /// <summary>
        /// Returns true if ListTransactionsByBlockHashRIBSD instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByBlockHashRIBSD to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByBlockHashRIBSD input)
        {
            if (input == null)
                return false;
