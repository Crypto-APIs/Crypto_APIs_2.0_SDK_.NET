...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40022
    /// </summary>
    [DataContract(Name = "inline_response_400_22")]
    public partial class InlineResponse40022 : IEquatable<InlineResponse40022>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40022" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40022() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40022" /> class.
        /// </summary>
        ...
        public InlineResponse40022(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListZilliqaTransactionsByBlockHeightE400 error = default(ListZilliqaTransactionsByBlockHeightE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40022 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40022 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40022 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40022 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40022);
        }

        /// <summary>
        /// Returns true if InlineResponse40022 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40022 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40022 input)
        {
            if (input == null)
            {
                return false;
