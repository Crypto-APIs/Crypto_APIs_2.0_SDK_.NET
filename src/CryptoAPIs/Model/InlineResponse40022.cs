...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40022 : IEquatable<InlineResponse40022>, IValidatableObject
    {
        ...
        public InlineResponse40022(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListZilliqaTransactionsByBlockHashE400 error = default(ListZilliqaTransactionsByBlockHashE400))
        {
