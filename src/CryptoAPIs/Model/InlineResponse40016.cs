...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40016
    /// </summary>
    [DataContract(Name = "inline_response_400_16")]
    public partial class InlineResponse40016 : IEquatable<InlineResponse40016>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40016" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40016() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40016" /> class.
        /// </summary>
        ...
        public InlineResponse40016(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListXRPRippleTransactionsByAddressAndTimeRangeE400 error = default(ListXRPRippleTransactionsByAddressAndTimeRangeE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40016 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40016 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40016 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse40016);
        }

        /// <summary>
        /// Returns true if InlineResponse40016 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40016 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40016 input)
        {
            if (input == null)
            {
                return false;
