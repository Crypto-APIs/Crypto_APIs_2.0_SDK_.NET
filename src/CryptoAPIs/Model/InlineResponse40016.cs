...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40016 : IEquatable<InlineResponse40016>, IValidatableObject
    {
        ...
        public InlineResponse40016(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListAllUnconfirmedTransactionsE400 error = default(ListAllUnconfirmedTransactionsE400))
        {
