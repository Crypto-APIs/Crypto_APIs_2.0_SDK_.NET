...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListDepositAddressesRIFungibleTokensInner : IEquatable<ListDepositAddressesRIFungibleTokensInner>, IValidatableObject
    {
        ...
        public ListDepositAddressesRIFungibleTokensInner(string amount = default(string), string identifier = default(string), string name = default(string), string symbol = default(string), int tokenDecimals = default(int), string type = default(string))
        {
