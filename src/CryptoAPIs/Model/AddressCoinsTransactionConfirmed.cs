...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AddressCoinsTransactionConfirmed")]
    public partial class AddressCoinsTransactionConfirmed : IEquatable<AddressCoinsTransactionConfirmed>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressCoinsTransactionConfirmed" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AddressCoinsTransactionConfirmed() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressCoinsTransactionConfirmed" /> class.
        /// </summary>
        ...
        public AddressCoinsTransactionConfirmed(string apiVersion = default(string), string referenceId = default(string), string idempotencyKey = default(string), AddressCoinsTransactionConfirmedData data = default(AddressCoinsTransactionConfirmedData))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for AddressCoinsTransactionConfirmed and cannot be null");
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for AddressCoinsTransactionConfirmed and cannot be null");
            // to ensure "idempotencyKey" is required (not null)
            this.IdempotencyKey = idempotencyKey ?? throw new ArgumentNullException("idempotencyKey is a required property for AddressCoinsTransactionConfirmed and cannot be null");
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for AddressCoinsTransactionConfirmed and cannot be null");
        }
        ...
        public AddressCoinsTransactionConfirmedData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddressCoinsTransactionConfirmed {\n");
        ...
        {
            return this.Equals(input as AddressCoinsTransactionConfirmed);
        }

        /// <summary>
        /// Returns true if AddressCoinsTransactionConfirmed instances are equal
        /// </summary>
        /// <param name="input">Instance of AddressCoinsTransactionConfirmed to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddressCoinsTransactionConfirmed input)
        {
            if (input == null)
                return false;
