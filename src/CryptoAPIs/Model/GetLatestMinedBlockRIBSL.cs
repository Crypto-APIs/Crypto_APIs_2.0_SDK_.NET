...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetLatestMinedBlockRIBSL : IEquatable<GetLatestMinedBlockRIBSL>, IValidatableObject
    {
        ...
        public GetLatestMinedBlockRIBSL(string difficulty = default(string), int nonce = default(int), int size = default(int), string bits = default(string), string chainwork = default(string), string merkleRoot = default(string), int strippedSize = default(int), int version = default(int), string versionHex = default(string), int weight = default(int))
        {
