...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40194
    /// </summary>
    [DataContract(Name = "inline_response_401_94")]
    public partial class InlineResponse40194 : IEquatable<InlineResponse40194>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40194" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40194() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40194" /> class.
        /// </summary>
        ...
        public InlineResponse40194(string apiVersion = default(string), string requestId = default(string), string context = default(string), AddTokensToExistingFromAddressE401 error = default(AddTokensToExistingFromAddressE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40194 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40194 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40194 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40194 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40194);
        }

        /// <summary>
        /// Returns true if InlineResponse40194 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40194 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40194 input)
        {
            if (input == null)
            {
                return false;
