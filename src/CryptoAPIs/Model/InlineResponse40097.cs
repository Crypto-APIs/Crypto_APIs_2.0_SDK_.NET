...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40097
    /// </summary>
    [DataContract(Name = "inline_response_400_97")]
    public partial class InlineResponse40097 : IEquatable<InlineResponse40097>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40097" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40097() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40097" /> class.
        /// </summary>
        ...
        public InlineResponse40097(string apiVersion = default(string), string requestId = default(string), string context = default(string), ValidateAddressE400 error = default(ValidateAddressE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40097 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40097 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40097 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40097 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40097);
        }

        /// <summary>
        /// Returns true if InlineResponse40097 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40097 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40097 input)
        {
            if (input == null)
            {
                return false;
