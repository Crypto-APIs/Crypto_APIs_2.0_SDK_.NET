...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40035
    /// </summary>
    [DataContract(Name = "inline_response_400_35")]
    public partial class InlineResponse40035 : IEquatable<InlineResponse40035>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40035" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40035() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40035" /> class.
        /// </summary>
        ...
        public InlineResponse40035(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetWalletAssetDetailsE400 error = default(GetWalletAssetDetailsE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40035 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40035 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40035 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40035 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40035);
        }

        /// <summary>
        /// Returns true if InlineResponse40035 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40035 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40035 input)
        {
            if (input == null)
            {
                return false;
