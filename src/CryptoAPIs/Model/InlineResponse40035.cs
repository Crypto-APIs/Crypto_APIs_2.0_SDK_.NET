...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40035 : IEquatable<InlineResponse40035>, IValidatableObject
    {
        ...
        public InlineResponse40035(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListSupportedTokensE400 error = default(ListSupportedTokensE400))
        {
