...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40199
    /// </summary>
    [DataContract(Name = "inline_response_401_99")]
    public partial class InlineResponse40199 : IEquatable<InlineResponse40199>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40199" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40199() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40199" /> class.
        /// </summary>
        ...
        public InlineResponse40199(string apiVersion = default(string), string requestId = default(string), string context = default(string), BroadcastLocallySignedTransactionE401 error = default(BroadcastLocallySignedTransactionE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40199 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40199 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40199 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40199 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40199);
        }

        /// <summary>
        /// Returns true if InlineResponse40199 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40199 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40199 input)
        {
            if (input == null)
            {
                return false;
