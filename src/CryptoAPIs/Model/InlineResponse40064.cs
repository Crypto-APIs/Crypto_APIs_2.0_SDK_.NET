...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40064 : IEquatable<InlineResponse40064>, IValidatableObject
    {
        ...
        public InlineResponse40064(string apiVersion = default(string), string requestId = default(string), string context = default(string), MinedTransactionE400 error = default(MinedTransactionE400))
        {
