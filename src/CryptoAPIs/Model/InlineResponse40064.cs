...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40064
    /// </summary>
    [DataContract(Name = "inline_response_400_64")]
    public partial class InlineResponse40064 : IEquatable<InlineResponse40064>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40064" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40064() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40064" /> class.
        /// </summary>
        ...
        public InlineResponse40064(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListConfirmedTokensTransfersByAddressE400 error = default(ListConfirmedTokensTransfersByAddressE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40064 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40064 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40064 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40064 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40064);
        }

        /// <summary>
        /// Returns true if InlineResponse40064 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40064 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40064 input)
        {
            if (input == null)
            {
                return false;
