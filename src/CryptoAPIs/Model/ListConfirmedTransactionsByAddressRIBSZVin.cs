...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListConfirmedTransactionsByAddressRIBSZ_vin")]
    public partial class ListConfirmedTransactionsByAddressRIBSZVin : IEquatable<ListConfirmedTransactionsByAddressRIBSZVin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressRIBSZVin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListConfirmedTransactionsByAddressRIBSZVin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressRIBSZVin" /> class.
        /// </summary>
        ...
        public ListConfirmedTransactionsByAddressRIBSZVin(List<string> addresses = default(List<string>), string coinbase = default(string), ListConfirmedTransactionsByAddressRIBSZScriptSig scriptSig = default(ListConfirmedTransactionsByAddressRIBSZScriptSig), int sequence = default(int), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            if (addresses == null) {
                throw new ArgumentNullException("addresses is a required property for ListConfirmedTransactionsByAddressRIBSZVin and cannot be null");
            }
            this.Addresses = addresses;
            // to ensure "coinbase" is required (not null)
            if (coinbase == null) {
                throw new ArgumentNullException("coinbase is a required property for ListConfirmedTransactionsByAddressRIBSZVin and cannot be null");
            }
            this.Coinbase = coinbase;
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null) {
                throw new ArgumentNullException("scriptSig is a required property for ListConfirmedTransactionsByAddressRIBSZVin and cannot be null");
            }
            this.ScriptSig = scriptSig;
            this.Sequence = sequence;
            // to ensure "txid" is required (not null)
            if (txid == null) {
                throw new ArgumentNullException("txid is a required property for ListConfirmedTransactionsByAddressRIBSZVin and cannot be null");
            }
            this.Txid = txid;
            // to ensure "txinwitness" is required (not null)
            if (txinwitness == null) {
                throw new ArgumentNullException("txinwitness is a required property for ListConfirmedTransactionsByAddressRIBSZVin and cannot be null");
            }
            this.Txinwitness = txinwitness;
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for ListConfirmedTransactionsByAddressRIBSZVin and cannot be null");
            }
            this.Value = value;
            this.Vout = vout;
        }
        ...
        public ListConfirmedTransactionsByAddressRIBSZScriptSig ScriptSig { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListConfirmedTransactionsByAddressRIBSZVin {\n");
        ...
        {
            return this.Equals(input as ListConfirmedTransactionsByAddressRIBSZVin);
        }

        /// <summary>
        /// Returns true if ListConfirmedTransactionsByAddressRIBSZVin instances are equal
        /// </summary>
        /// <param name="input">Instance of ListConfirmedTransactionsByAddressRIBSZVin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListConfirmedTransactionsByAddressRIBSZVin input)
        {
            if (input == null)
                return false;
