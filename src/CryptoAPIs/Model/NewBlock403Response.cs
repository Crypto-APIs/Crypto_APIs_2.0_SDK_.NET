...
namespace CryptoAPIs.Model
{
    ...
    /// NewBlock403Response
    /// </summary>
    [DataContract(Name = "New_Block_403_response")]
    public partial class NewBlock403Response : IEquatable<NewBlock403Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewBlock403Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewBlock403Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewBlock403Response" /> class.
        /// </summary>
        ...
        public NewBlock403Response(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewBlockE403 error = default(NewBlockE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for NewBlock403Response and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for NewBlock403Response and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for NewBlock403Response and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewBlock403Response {\n");
        ...
        {
            return this.Equals(input as NewBlock403Response);
        }

        /// <summary>
        /// Returns true if NewBlock403Response instances are equal
        /// </summary>
        /// <param name="input">Instance of NewBlock403Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewBlock403Response input)
        {
            if (input == null)
            {
                return false;
