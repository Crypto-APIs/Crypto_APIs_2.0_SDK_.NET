...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetLastMinedBlockRIBSL : IEquatable<GetLastMinedBlockRIBSL>, IValidatableObject
    {
        ...
        public GetLastMinedBlockRIBSL(string difficulty = default(string), string bits = default(string), string chainwork = default(string), string merkleRoot = default(string), string nonce = default(string), int size = default(int), int strippedSize = default(int), int version = default(int), string versionHex = default(string), int weight = default(int))
        {
