...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListUnconfirmedTransactionsByAddressRIBSD_vin")]
    public partial class ListUnconfirmedTransactionsByAddressRIBSDVin : IEquatable<ListUnconfirmedTransactionsByAddressRIBSDVin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnconfirmedTransactionsByAddressRIBSDVin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListUnconfirmedTransactionsByAddressRIBSDVin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnconfirmedTransactionsByAddressRIBSDVin" /> class.
        /// </summary>
        ...
        public ListUnconfirmedTransactionsByAddressRIBSDVin(List<string> addresses = default(List<string>), ListConfirmedTransactionsByAddressRIBSDScriptSig scriptSig = default(ListConfirmedTransactionsByAddressRIBSDScriptSig), long sequence = default(long), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            if (addresses == null)
            {
                throw new ArgumentNullException("addresses is a required property for ListUnconfirmedTransactionsByAddressRIBSDVin and cannot be null");
            }
            this.Addresses = addresses;
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null)
            {
                throw new ArgumentNullException("scriptSig is a required property for ListUnconfirmedTransactionsByAddressRIBSDVin and cannot be null");
            }
            ...
            if (txinwitness == null)
            {
                throw new ArgumentNullException("txinwitness is a required property for ListUnconfirmedTransactionsByAddressRIBSDVin and cannot be null");
            }
            this.Txinwitness = txinwitness;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for ListUnconfirmedTransactionsByAddressRIBSDVin and cannot be null");
            }
            this.Value = value;
            this.Txid = txid;
            this.Vout = vout;
        ...
        {
            return this.Equals(input as ListUnconfirmedTransactionsByAddressRIBSDVin);
        }

        /// <summary>
        /// Returns true if ListUnconfirmedTransactionsByAddressRIBSDVin instances are equal
        /// </summary>
        /// <param name="input">Instance of ListUnconfirmedTransactionsByAddressRIBSDVin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListUnconfirmedTransactionsByAddressRIBSDVin input)
        {
            if (input == null)
            {
                return false;
