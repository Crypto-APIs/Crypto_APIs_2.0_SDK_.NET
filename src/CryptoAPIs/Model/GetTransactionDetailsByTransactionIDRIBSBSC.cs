...
namespace CryptoAPIs.Model
{
    ...
    /// Binance Smart Chain
    /// </summary>
    [DataContract(Name = "GetTransactionDetailsByTransactionIDRIBSBSC")]
    public partial class GetTransactionDetailsByTransactionIDRIBSBSC : IEquatable<GetTransactionDetailsByTransactionIDRIBSBSC>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDRIBSBSC" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetTransactionDetailsByTransactionIDRIBSBSC() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDRIBSBSC" /> class.
        /// </summary>
        ...
        public GetTransactionDetailsByTransactionIDRIBSBSC(string contract = default(string), string gasLimit = default(string), GetTransactionDetailsByTransactionIDRIBSBSCGasPrice gasPrice = default(GetTransactionDetailsByTransactionIDRIBSBSCGasPrice), string gasUsed = default(string), string inputData = default(string), int nonce = default(int))
        {
            ...
            if (gasPrice == null)
            {
                throw new ArgumentNullException("gasPrice is a required property for GetTransactionDetailsByTransactionIDRIBSBSC and cannot be null");
            }
            this.GasPrice = gasPrice;
            // to ensure "gasUsed" is required (not null)
            if (gasUsed == null)
            {
                throw new ArgumentNullException("gasUsed is a required property for GetTransactionDetailsByTransactionIDRIBSBSC and cannot be null");
            }
            this.GasUsed = gasUsed;
            // to ensure "inputData" is required (not null)
            if (inputData == null)
            {
                throw new ArgumentNullException("inputData is a required property for GetTransactionDetailsByTransactionIDRIBSBSC and cannot be null");
            }
        ...
        {
            return this.Equals(input as GetTransactionDetailsByTransactionIDRIBSBSC);
        }

        /// <summary>
        /// Returns true if GetTransactionDetailsByTransactionIDRIBSBSC instances are equal
        /// </summary>
        /// <param name="input">Instance of GetTransactionDetailsByTransactionIDRIBSBSC to be compared</param>
        /// <returns>Boolean</returns>
