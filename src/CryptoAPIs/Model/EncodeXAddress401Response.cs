...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Encode_X_Address_401_response")]
    public partial class EncodeXAddress401Response : IEquatable<EncodeXAddress401Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EncodeXAddress401Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EncodeXAddress401Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EncodeXAddress401Response" /> class.
        /// </summary>
        ...
        public EncodeXAddress401Response(string apiVersion = default(string), string requestId = default(string), string context = default(string), EncodeXAddressE401 error = default(EncodeXAddressE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for EncodeXAddress401Response and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for EncodeXAddress401Response and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for EncodeXAddress401Response and cannot be null");
            }
            this.Error = error;
        ...
        public EncodeXAddressE401 Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EncodeXAddress401Response {\n");
        ...
        {
            return this.Equals(input as EncodeXAddress401Response);
        }

        /// <summary>
        /// Returns true if EncodeXAddress401Response instances are equal
        /// </summary>
        /// <param name="input">Instance of EncodeXAddress401Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EncodeXAddress401Response input)
        {
            if (input == null)
            {
                return false;
