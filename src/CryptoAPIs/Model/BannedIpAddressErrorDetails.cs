...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BannedIpAddress_error_details")]
    public partial class BannedIpAddressErrorDetails : IEquatable<BannedIpAddressErrorDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BannedIpAddressErrorDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BannedIpAddressErrorDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BannedIpAddressErrorDetails" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as BannedIpAddressErrorDetails);
        }

        /// <summary>
        /// Returns true if BannedIpAddressErrorDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of BannedIpAddressErrorDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BannedIpAddressErrorDetails input)
        {
            if (input == null)
                return false;
