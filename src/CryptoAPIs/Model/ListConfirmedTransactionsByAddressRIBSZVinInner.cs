...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListConfirmedTransactionsByAddressRIBSZ_vin_inner")]
    public partial class ListConfirmedTransactionsByAddressRIBSZVinInner : IEquatable<ListConfirmedTransactionsByAddressRIBSZVinInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressRIBSZVinInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListConfirmedTransactionsByAddressRIBSZVinInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressRIBSZVinInner" /> class.
        /// </summary>
        ...
        public ListConfirmedTransactionsByAddressRIBSZVinInner(List<string> addresses = default(List<string>), string coinbase = default(string), GetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig scriptSig = default(GetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig), long sequence = default(long), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            if (addresses == null)
            {
                throw new ArgumentNullException("addresses is a required property for ListConfirmedTransactionsByAddressRIBSZVinInner and cannot be null");
            }
            this.Addresses = addresses;
            // to ensure "coinbase" is required (not null)
            if (coinbase == null)
            {
                throw new ArgumentNullException("coinbase is a required property for ListConfirmedTransactionsByAddressRIBSZVinInner and cannot be null");
            }
            this.Coinbase = coinbase;
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null)
            {
                throw new ArgumentNullException("scriptSig is a required property for ListConfirmedTransactionsByAddressRIBSZVinInner and cannot be null");
            }
            ...
            if (txid == null)
            {
                throw new ArgumentNullException("txid is a required property for ListConfirmedTransactionsByAddressRIBSZVinInner and cannot be null");
            }
            this.Txid = txid;
            // to ensure "txinwitness" is required (not null)
            if (txinwitness == null)
            {
                throw new ArgumentNullException("txinwitness is a required property for ListConfirmedTransactionsByAddressRIBSZVinInner and cannot be null");
            }
            this.Txinwitness = txinwitness;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for ListConfirmedTransactionsByAddressRIBSZVinInner and cannot be null");
            }
            this.Value = value;
            this.Vout = vout;
        }
        ...
        public GetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig ScriptSig { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListConfirmedTransactionsByAddressRIBSZVinInner {\n");
        ...
        {
            return this.Equals(input as ListConfirmedTransactionsByAddressRIBSZVinInner);
        }

        /// <summary>
        /// Returns true if ListConfirmedTransactionsByAddressRIBSZVinInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ListConfirmedTransactionsByAddressRIBSZVinInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListConfirmedTransactionsByAddressRIBSZVinInner input)
        {
            if (input == null)
            {
                return false;
