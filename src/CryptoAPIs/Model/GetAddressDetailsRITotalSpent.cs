...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetAddressDetailsRITotalSpent : IEquatable<GetAddressDetailsRITotalSpent>, IValidatableObject
    {
        ...
        public GetAddressDetailsRITotalSpent(string amount = default(string), string unit = default(string))
        {
            ...
            this.Amount = amount ?? throw new ArgumentNullException("amount is a required property for GetAddressDetailsRITotalSpent and cannot be null");
            // to ensure "unit" is required (not null)
            this.Unit = unit ?? throw new ArgumentNullException("unit is a required property for GetAddressDetailsRITotalSpent and cannot be null");
        }
