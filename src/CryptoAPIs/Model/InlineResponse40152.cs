...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40152
    /// </summary>
    [DataContract(Name = "inline_response_401_52")]
    public partial class InlineResponse40152 : IEquatable<InlineResponse40152>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40152" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40152() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40152" /> class.
        /// </summary>
        ...
        public InlineResponse40152(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListInternalTransactionDetailsByTransactionHashE401 error = default(ListInternalTransactionDetailsByTransactionHashE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40152 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40152 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40152 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40152 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40152);
        }

        /// <summary>
        /// Returns true if InlineResponse40152 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40152 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40152 input)
        {
            if (input == null)
            {
                return false;
