...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40152 : IEquatable<InlineResponse40152>, IValidatableObject
    {
        ...
        public InlineResponse40152(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListUnspentTransactionOutputsByAddressE401 error = default(ListUnspentTransactionOutputsByAddressE401))
        {
