...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40326
    /// </summary>
    [DataContract(Name = "inline_response_403_26")]
    public partial class InlineResponse40326 : IEquatable<InlineResponse40326>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40326" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40326() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40326" /> class.
        /// </summary>
        ...
        public InlineResponse40326(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateCoinsTransactionFromAddressForWholeAmountE403 error = default(CreateCoinsTransactionFromAddressForWholeAmountE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40326 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40326 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40326 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40326 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40326);
        }

        /// <summary>
        /// Returns true if InlineResponse40326 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40326 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40326 input)
        {
            if (input == null)
            {
                return false;
