...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40326 : IEquatable<InlineResponse40326>, IValidatableObject
    {
        ...
        public InlineResponse40326(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetBlockDetailsByBlockHeightE403 error = default(GetBlockDetailsByBlockHeightE403))
        {
