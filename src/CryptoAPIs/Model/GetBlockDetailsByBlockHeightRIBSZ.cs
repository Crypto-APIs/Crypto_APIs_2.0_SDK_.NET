...
namespace CryptoAPIs.Model
{
    ...
    /// Zcash
    /// </summary>
    [DataContract(Name = "GetBlockDetailsByBlockHeightRIBSZ")]
    public partial class GetBlockDetailsByBlockHeightRIBSZ : IEquatable<GetBlockDetailsByBlockHeightRIBSZ>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHeightRIBSZ" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetBlockDetailsByBlockHeightRIBSZ() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHeightRIBSZ" /> class.
        /// </summary>
        ...
        /// <param name="version">Represents the block version number. (required).</param>
        public GetBlockDetailsByBlockHeightRIBSZ(string difficulty = default(string), string bits = default(string), string chainwork = default(string), string merkleRoot = default(string), string nonce = default(string), int size = default(int), int version = default(int))
        {
            // to ensure "difficulty" is required (not null)
            if (difficulty == null)
            {
                throw new ArgumentNullException("difficulty is a required property for GetBlockDetailsByBlockHeightRIBSZ and cannot be null");
            }
            this.Difficulty = difficulty;
            // to ensure "bits" is required (not null)
            if (bits == null)
            {
                throw new ArgumentNullException("bits is a required property for GetBlockDetailsByBlockHeightRIBSZ and cannot be null");
            }
            this.Bits = bits;
            // to ensure "chainwork" is required (not null)
            if (chainwork == null)
            {
                throw new ArgumentNullException("chainwork is a required property for GetBlockDetailsByBlockHeightRIBSZ and cannot be null");
            }
            this.Chainwork = chainwork;
            // to ensure "merkleRoot" is required (not null)
            if (merkleRoot == null)
            {
                throw new ArgumentNullException("merkleRoot is a required property for GetBlockDetailsByBlockHeightRIBSZ and cannot be null");
            }
            this.MerkleRoot = merkleRoot;
            // to ensure "nonce" is required (not null)
            if (nonce == null)
            {
                throw new ArgumentNullException("nonce is a required property for GetBlockDetailsByBlockHeightRIBSZ and cannot be null");
            }
            this.Nonce = nonce;
            this.Size = size;
        ...
        /// </summary>
        /// <value>Represents the block version number.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetBlockDetailsByBlockHeightRIBSZ {\n");
        ...
        {
            return this.Equals(input as GetBlockDetailsByBlockHeightRIBSZ);
        }

        /// <summary>
        /// Returns true if GetBlockDetailsByBlockHeightRIBSZ instances are equal
        /// </summary>
        /// <param name="input">Instance of GetBlockDetailsByBlockHeightRIBSZ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetBlockDetailsByBlockHeightRIBSZ input)
        {
            if (input == null)
            {
                return false;
