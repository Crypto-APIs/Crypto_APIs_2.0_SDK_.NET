...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListConfirmedTransactionsByAddressRIBSB_vin_inner")]
    public partial class ListConfirmedTransactionsByAddressRIBSBVinInner : IEquatable<ListConfirmedTransactionsByAddressRIBSBVinInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressRIBSBVinInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListConfirmedTransactionsByAddressRIBSBVinInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressRIBSBVinInner" /> class.
        /// </summary>
        ...
        public ListConfirmedTransactionsByAddressRIBSBVinInner(List<string> addresses = default(List<string>), string coinbase = default(string), GetTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig scriptSig = default(GetTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig), string sequence = default(string), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            ...
            if (addresses == null)
            {
                throw new ArgumentNullException("addresses is a required property for ListConfirmedTransactionsByAddressRIBSBVinInner and cannot be null");
            }
            this.Addresses = addresses;
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null)
            {
                throw new ArgumentNullException("scriptSig is a required property for ListConfirmedTransactionsByAddressRIBSBVinInner and cannot be null");
            }
            this.ScriptSig = scriptSig;
            // to ensure "sequence" is required (not null)
            if (sequence == null)
            {
                throw new ArgumentNullException("sequence is a required property for ListConfirmedTransactionsByAddressRIBSBVinInner and cannot be null");
            }
        ...
        {
            return this.Equals(input as ListConfirmedTransactionsByAddressRIBSBVinInner);
        }

        /// <summary>
        /// Returns true if ListConfirmedTransactionsByAddressRIBSBVinInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ListConfirmedTransactionsByAddressRIBSBVinInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListConfirmedTransactionsByAddressRIBSBVinInner input)
        {
            if (input == null)
            {
                return false;
