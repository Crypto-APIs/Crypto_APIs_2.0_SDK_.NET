...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40176
    /// </summary>
    [DataContract(Name = "inline_response_401_76")]
    public partial class InlineResponse40176 : IEquatable<InlineResponse40176>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40176" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40176() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40176" /> class.
        /// </summary>
        ...
        public InlineResponse40176(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedCoinsTransactionsAndEachConfirmationE401 error = default(NewConfirmedCoinsTransactionsAndEachConfirmationE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40176 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40176 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40176 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40176 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40176);
        }

        /// <summary>
        /// Returns true if InlineResponse40176 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40176 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40176 input)
        {
            if (input == null)
            {
                return false;
