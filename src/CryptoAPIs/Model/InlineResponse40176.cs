...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40176 : IEquatable<InlineResponse40176>, IValidatableObject
    {
        ...
        public InlineResponse40176(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateAutomaticCoinsForwardingE401 error = default(CreateAutomaticCoinsForwardingE401))
        {
