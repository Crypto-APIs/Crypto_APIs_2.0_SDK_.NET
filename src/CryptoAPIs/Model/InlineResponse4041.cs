...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4041
    /// </summary>
    [DataContract(Name = "inline_response_404_1")]
    public partial class InlineResponse4041 : IEquatable<InlineResponse4041>, IValidatableObject
    {
        ...
        public InlineResponse4041(string apiVersion = default(string), string requestId = default(string), string context = default(string), ResourceNotFound error = default(ResourceNotFound))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4041 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4041 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse4041 and cannot be null");
            }
            this.Error = error;
