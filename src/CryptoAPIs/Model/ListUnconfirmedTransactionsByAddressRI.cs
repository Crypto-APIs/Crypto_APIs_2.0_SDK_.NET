...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListUnconfirmedTransactionsByAddressRI : IEquatable<ListUnconfirmedTransactionsByAddressRI>, IValidatableObject
    {
        ...
        public ListUnconfirmedTransactionsByAddressRI(List<ListUnconfirmedTransactionsByAddressRIRecipientsInner> recipients = default(List<ListUnconfirmedTransactionsByAddressRIRecipientsInner>), List<ListUnconfirmedTransactionsByAddressRISendersInner> senders = default(List<ListUnconfirmedTransactionsByAddressRISendersInner>), int timestamp = default(int), string transactionHash = default(string), string transactionId = default(string), ListUnconfirmedTransactionsByAddressRIBS blockchainSpecific = default(ListUnconfirmedTransactionsByAddressRIBS))
        {
