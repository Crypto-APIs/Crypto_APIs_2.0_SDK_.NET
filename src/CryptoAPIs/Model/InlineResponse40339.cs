...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40339 : IEquatable<InlineResponse40339>, IValidatableObject
    {
        ...
        public InlineResponse40339(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListAllAssetsByWalletIDE403 error = default(ListAllAssetsByWalletIDE403))
        {
