...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40339
    /// </summary>
    [DataContract(Name = "inline_response_403_39")]
    public partial class InlineResponse40339 : IEquatable<InlineResponse40339>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40339" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40339() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40339" /> class.
        /// </summary>
        ...
        public InlineResponse40339(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetLatestMinedXRPRippleBlockE403 error = default(GetLatestMinedXRPRippleBlockE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40339 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40339 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40339 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40339 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40339);
        }

        /// <summary>
        /// Returns true if InlineResponse40339 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40339 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40339 input)
        {
            if (input == null)
            {
                return false;
