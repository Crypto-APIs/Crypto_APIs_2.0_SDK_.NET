...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40154
    /// </summary>
    [DataContract(Name = "inline_response_401_54")]
    public partial class InlineResponse40154 : IEquatable<InlineResponse40154>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40154" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40154() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40154" /> class.
        /// </summary>
        ...
        public InlineResponse40154(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetInternalTransactionByTransactionHashAndOperationIdE401 error = default(GetInternalTransactionByTransactionHashAndOperationIdE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40154 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40154 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40154 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40154 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40154);
        }

        /// <summary>
        /// Returns true if InlineResponse40154 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40154 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40154 input)
        {
            if (input == null)
            {
                return false;
