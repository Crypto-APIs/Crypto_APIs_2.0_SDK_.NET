...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40154 : IEquatable<InlineResponse40154>, IValidatableObject
    {
        ...
        public InlineResponse40154(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTokensTransfersByTransactionHashE401 error = default(ListTokensTransfersByTransactionHashE401))
        {
