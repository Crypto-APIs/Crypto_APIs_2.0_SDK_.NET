...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListWalletTransactionsR")]
    public partial class ListWalletTransactionsR : IEquatable<ListWalletTransactionsR>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListWalletTransactionsR" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListWalletTransactionsR() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListWalletTransactionsR" /> class.
        /// </summary>
        ...
        public ListWalletTransactionsR(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListWalletTransactionsRData data = default(ListWalletTransactionsRData))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for ListWalletTransactionsR and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for ListWalletTransactionsR and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ListWalletTransactionsR and cannot be null");
            }
            this.Data = data;
        ...
        public ListWalletTransactionsRData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListWalletTransactionsR {\n");
        ...
        {
            return this.Equals(input as ListWalletTransactionsR);
        }

        /// <summary>
        /// Returns true if ListWalletTransactionsR instances are equal
        /// </summary>
        /// <param name="input">Instance of ListWalletTransactionsR to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListWalletTransactionsR input)
        {
            if (input == null)
            {
                return false;
