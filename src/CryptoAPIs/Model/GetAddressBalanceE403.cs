...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(GetAddressBalanceE403JsonConverter))]
    [DataContract(Name = "GetAddressBalanceE403")]
    public partial class GetAddressBalanceE403 : AbstractOpenAPISchema, IEquatable<GetAddressBalanceE403>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressBalanceE403" /> class
        /// with the <see cref="BannedIpAddress" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BannedIpAddress.</param>
        public GetAddressBalanceE403(BannedIpAddress actualInstance)
        {
        ...
        public GetAddressBalanceE403(EndpointNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public GetAddressBalanceE403(EndpointNotAllowedForApiKey actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public GetAddressBalanceE403(FeatureMainnetsNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAddressBalanceE403 {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, GetAddressBalanceE403.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of GetAddressBalanceE403
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of GetAddressBalanceE403</returns>
        public static GetAddressBalanceE403 FromJson(string jsonString)
        {
            GetAddressBalanceE403 newGetAddressBalanceE403 = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newGetAddressBalanceE403;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newGetAddressBalanceE403 = new GetAddressBalanceE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, GetAddressBalanceE403.SerializerSettings));
                }
                else
                {
                    newGetAddressBalanceE403 = new GetAddressBalanceE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, GetAddressBalanceE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newGetAddressBalanceE403 = new GetAddressBalanceE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, GetAddressBalanceE403.SerializerSettings));
                }
                else
                {
                    newGetAddressBalanceE403 = new GetAddressBalanceE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, GetAddressBalanceE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newGetAddressBalanceE403 = new GetAddressBalanceE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, GetAddressBalanceE403.SerializerSettings));
                }
                else
                {
                    newGetAddressBalanceE403 = new GetAddressBalanceE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, GetAddressBalanceE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newGetAddressBalanceE403 = new GetAddressBalanceE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, GetAddressBalanceE403.SerializerSettings));
                }
                else
                {
                    newGetAddressBalanceE403 = new GetAddressBalanceE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, GetAddressBalanceE403.AdditionalPropertiesSerializerSettings));
                }
        ...
        {
            return this.Equals(input as GetAddressBalanceE403);
        }

        /// <summary>
        /// Returns true if GetAddressBalanceE403 instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAddressBalanceE403 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAddressBalanceE403 input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for GetAddressBalanceE403
    /// </summary>
    public class GetAddressBalanceE403JsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(GetAddressBalanceE403).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return GetAddressBalanceE403.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
