...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40053
    /// </summary>
    [DataContract(Name = "inline_response_400_53")]
    public partial class InlineResponse40053 : IEquatable<InlineResponse40053>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40053" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40053() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40053" /> class.
        /// </summary>
        ...
        public InlineResponse40053(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListHDWalletXPubYPubZPubTransactionsE400 error = default(ListHDWalletXPubYPubZPubTransactionsE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40053 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40053 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40053 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40053 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40053);
        }

        /// <summary>
        /// Returns true if InlineResponse40053 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40053 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40053 input)
        {
            if (input == null)
            {
                return false;
