...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40349 : IEquatable<InlineResponse40349>, IValidatableObject
    {
        ...
        public InlineResponse40349(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListHDWalletXPubYPubZPubTransactionsE403 error = default(ListHDWalletXPubYPubZPubTransactionsE403))
        {
