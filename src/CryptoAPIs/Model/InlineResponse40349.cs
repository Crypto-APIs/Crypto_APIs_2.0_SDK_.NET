...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40349
    /// </summary>
    [DataContract(Name = "inline_response_403_49")]
    public partial class InlineResponse40349 : IEquatable<InlineResponse40349>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40349" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40349() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40349" /> class.
        /// </summary>
        ...
        public InlineResponse40349(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetWalletTransactionDetailsByTransactionIDE403 error = default(GetWalletTransactionDetailsByTransactionIDE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40349 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40349 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40349 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40349 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40349);
        }

        /// <summary>
        /// Returns true if InlineResponse40349 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40349 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40349 input)
        {
            if (input == null)
            {
                return false;
