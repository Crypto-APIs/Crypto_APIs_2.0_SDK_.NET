...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4012
    /// </summary>
    [DataContract(Name = "inline_response_401_2")]
    public partial class InlineResponse4012 : IEquatable<InlineResponse4012>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4012" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse4012() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4012" /> class.
        /// </summary>
        ...
        public InlineResponse4012(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetXRPRippleAddressDetailsE401 error = default(GetXRPRippleAddressDetailsE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4012 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4012 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse4012 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse4012);
        }

        /// <summary>
        /// Returns true if InlineResponse4012 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4012 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4012 input)
        {
            if (input == null)
            {
                return false;
