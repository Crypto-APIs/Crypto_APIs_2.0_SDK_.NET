...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListTransactionsByBlockHashRIBSD2 : IEquatable<ListTransactionsByBlockHashRIBSD2>, IValidatableObject
    {
        ...
        public ListTransactionsByBlockHashRIBSD2(long locktime = default(long), int size = default(int), int version = default(int), List<ListTransactionsByBlockHashRIBSD2VinInner> vin = default(List<ListTransactionsByBlockHashRIBSD2VinInner>), List<ListTransactionsByBlockHashRIBSD2VoutInner> vout = default(List<ListTransactionsByBlockHashRIBSD2VoutInner>))
        {
            ...
            if (vin == null)
            {
                throw new ArgumentNullException("vin is a required property for ListTransactionsByBlockHashRIBSD2 and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null)
            {
                throw new ArgumentNullException("vout is a required property for ListTransactionsByBlockHashRIBSD2 and cannot be null");
            }
            this.Vout = vout;
        }
        ...
        public List<ListTransactionsByBlockHashRIBSD2VinInner> Vin { get; set; }
        ...
        public List<ListTransactionsByBlockHashRIBSD2VoutInner> Vout { get; set; }
