...
namespace CryptoAPIs.Model
{
    ...
    /// Dash
    /// </summary>
    [DataContract(Name = "ListTransactionsByBlockHashRIBSD2")]
    public partial class ListTransactionsByBlockHashRIBSD2 : IEquatable<ListTransactionsByBlockHashRIBSD2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashRIBSD2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByBlockHashRIBSD2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashRIBSD2" /> class.
        /// </summary>
        ...
        public ListTransactionsByBlockHashRIBSD2(int locktime = default(int), int size = default(int), int version = default(int), List<ListTransactionsByBlockHashRIBSD2Vin> vin = default(List<ListTransactionsByBlockHashRIBSD2Vin>), List<ListTransactionsByBlockHashRIBSD2Vout> vout = default(List<ListTransactionsByBlockHashRIBSD2Vout>))
        {
            this.Locktime = locktime;
            this.Size = size;
            this.Version = version;
            // to ensure "vin" is required (not null)
            this.Vin = vin ?? throw new ArgumentNullException("vin is a required property for ListTransactionsByBlockHashRIBSD2 and cannot be null");
            // to ensure "vout" is required (not null)
            this.Vout = vout ?? throw new ArgumentNullException("vout is a required property for ListTransactionsByBlockHashRIBSD2 and cannot be null");
        }
        ...
        public List<ListTransactionsByBlockHashRIBSD2Vin> Vin { get; set; }
        ...
        public List<ListTransactionsByBlockHashRIBSD2Vout> Vout { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListTransactionsByBlockHashRIBSD2 {\n");
        ...
        {
            return this.Equals(input as ListTransactionsByBlockHashRIBSD2);
        }

        /// <summary>
        /// Returns true if ListTransactionsByBlockHashRIBSD2 instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByBlockHashRIBSD2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByBlockHashRIBSD2 input)
        {
            if (input == null)
                return false;
