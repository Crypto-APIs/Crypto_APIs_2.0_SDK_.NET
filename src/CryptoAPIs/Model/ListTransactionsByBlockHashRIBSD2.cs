...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListTransactionsByBlockHashRIBSD2 : IEquatable<ListTransactionsByBlockHashRIBSD2>, IValidatableObject
    {
        ...
        public ListTransactionsByBlockHashRIBSD2(long locktime = default(long), int size = default(int), int version = default(int), List<ListTransactionsByBlockHashRIBSD2Vin> vin = default(List<ListTransactionsByBlockHashRIBSD2Vin>), List<ListTransactionsByBlockHashRIBSD2Vout> vout = default(List<ListTransactionsByBlockHashRIBSD2Vout>))
        {
