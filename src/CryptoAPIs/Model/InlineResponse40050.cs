...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40050 : IEquatable<InlineResponse40050>, IValidatableObject
    {
        ...
        public InlineResponse40050(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetHDWalletXPubYPubZPubAssetsE400 error = default(GetHDWalletXPubYPubZPubAssetsE400))
        {
