...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40050
    /// </summary>
    [DataContract(Name = "inline_response_400_50")]
    public partial class InlineResponse40050 : IEquatable<InlineResponse40050>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40050" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40050() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40050" /> class.
        /// </summary>
        ...
        public InlineResponse40050(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetInternalTransactionByTransactionHashAndOperationIdE400 error = default(GetInternalTransactionByTransactionHashAndOperationIdE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40050 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40050 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40050 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40050 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40050);
        }

        /// <summary>
        /// Returns true if InlineResponse40050 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40050 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40050 input)
        {
            if (input == null)
            {
                return false;
