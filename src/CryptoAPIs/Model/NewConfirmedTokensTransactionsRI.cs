...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewConfirmedTokensTransactionsRI")]
    public partial class NewConfirmedTokensTransactionsRI : IEquatable<NewConfirmedTokensTransactionsRI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewConfirmedTokensTransactionsRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewConfirmedTokensTransactionsRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewConfirmedTokensTransactionsRI" /> class.
        /// </summary>
        ...
        public NewConfirmedTokensTransactionsRI(string address = default(string), string callbackSecretKey = default(string), string callbackUrl = default(string), string confirmationsCount = default(string), int createdTimestamp = default(int), string eventType = default(string), bool isActive = default(bool), string referenceId = default(string), string transactionId = default(string))
        {
            ...
            this.Address = address ?? throw new ArgumentNullException("address is a required property for NewConfirmedTokensTransactionsRI and cannot be null");
            // to ensure "callbackSecretKey" is required (not null)
            this.CallbackSecretKey = callbackSecretKey ?? throw new ArgumentNullException("callbackSecretKey is a required property for NewConfirmedTokensTransactionsRI and cannot be null");
            // to ensure "callbackUrl" is required (not null)
            this.CallbackUrl = callbackUrl ?? throw new ArgumentNullException("callbackUrl is a required property for NewConfirmedTokensTransactionsRI and cannot be null");
            // to ensure "confirmationsCount" is required (not null)
            this.ConfirmationsCount = confirmationsCount ?? throw new ArgumentNullException("confirmationsCount is a required property for NewConfirmedTokensTransactionsRI and cannot be null");
            this.CreatedTimestamp = createdTimestamp;
            // to ensure "eventType" is required (not null)
            this.EventType = eventType ?? throw new ArgumentNullException("eventType is a required property for NewConfirmedTokensTransactionsRI and cannot be null");
            this.IsActive = isActive;
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for NewConfirmedTokensTransactionsRI and cannot be null");
            // to ensure "transactionId" is required (not null)
            this.TransactionId = transactionId ?? throw new ArgumentNullException("transactionId is a required property for NewConfirmedTokensTransactionsRI and cannot be null");
        }
        ...
        {
            return this.Equals(input as NewConfirmedTokensTransactionsRI);
        }

        /// <summary>
        /// Returns true if NewConfirmedTokensTransactionsRI instances are equal
        /// </summary>
        /// <param name="input">Instance of NewConfirmedTokensTransactionsRI to be compared</param>
        /// <returns>Boolean</returns>
