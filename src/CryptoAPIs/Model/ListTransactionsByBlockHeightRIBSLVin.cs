...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListTransactionsByBlockHeightRIBSL_vin")]
    public partial class ListTransactionsByBlockHeightRIBSLVin : IEquatable<ListTransactionsByBlockHeightRIBSLVin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHeightRIBSLVin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByBlockHeightRIBSLVin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHeightRIBSLVin" /> class.
        /// </summary>
        ...
        public ListTransactionsByBlockHeightRIBSLVin(List<string> addresses = default(List<string>), string coinbase = default(string), ListTransactionsByBlockHeightRIBSLScriptSig scriptSig = default(ListTransactionsByBlockHeightRIBSLScriptSig), string sequence = default(string), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            this.Addresses = addresses ?? throw new ArgumentNullException("addresses is a required property for ListTransactionsByBlockHeightRIBSLVin and cannot be null");
            // to ensure "scriptSig" is required (not null)
            this.ScriptSig = scriptSig ?? throw new ArgumentNullException("scriptSig is a required property for ListTransactionsByBlockHeightRIBSLVin and cannot be null");
            // to ensure "sequence" is required (not null)
            this.Sequence = sequence ?? throw new ArgumentNullException("sequence is a required property for ListTransactionsByBlockHeightRIBSLVin and cannot be null");
            // to ensure "txid" is required (not null)
            this.Txid = txid ?? throw new ArgumentNullException("txid is a required property for ListTransactionsByBlockHeightRIBSLVin and cannot be null");
            // to ensure "txinwitness" is required (not null)
            this.Txinwitness = txinwitness ?? throw new ArgumentNullException("txinwitness is a required property for ListTransactionsByBlockHeightRIBSLVin and cannot be null");
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for ListTransactionsByBlockHeightRIBSLVin and cannot be null");
            this.Vout = vout;
        ...
        public ListTransactionsByBlockHeightRIBSLScriptSig ScriptSig { get; set; }
        ...
        {
            return this.Equals(input as ListTransactionsByBlockHeightRIBSLVin);
        }

        /// <summary>
        /// Returns true if ListTransactionsByBlockHeightRIBSLVin instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByBlockHeightRIBSLVin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByBlockHeightRIBSLVin input)
        {
            if (input == null)
                return false;
