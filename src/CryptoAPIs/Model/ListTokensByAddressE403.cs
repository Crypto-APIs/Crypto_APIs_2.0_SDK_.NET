...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(ListTokensByAddressE403JsonConverter))]
    [DataContract(Name = "ListTokensByAddressE403")]
    public partial class ListTokensByAddressE403 : AbstractOpenAPISchema, IEquatable<ListTokensByAddressE403>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTokensByAddressE403" /> class
        /// with the <see cref="BannedIpAddress" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BannedIpAddress.</param>
        public ListTokensByAddressE403(BannedIpAddress actualInstance)
        {
        ...
        public ListTokensByAddressE403(EndpointNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public ListTokensByAddressE403(EndpointNotAllowedForApiKey actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public ListTokensByAddressE403(FeatureMainnetsNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListTokensByAddressE403 {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, ListTokensByAddressE403.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of ListTokensByAddressE403
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of ListTokensByAddressE403</returns>
        public static ListTokensByAddressE403 FromJson(string jsonString)
        {
            ListTokensByAddressE403 newListTokensByAddressE403 = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newListTokensByAddressE403;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newListTokensByAddressE403 = new ListTokensByAddressE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, ListTokensByAddressE403.SerializerSettings));
                }
                else
                {
                    newListTokensByAddressE403 = new ListTokensByAddressE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, ListTokensByAddressE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newListTokensByAddressE403 = new ListTokensByAddressE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, ListTokensByAddressE403.SerializerSettings));
                }
                else
                {
                    newListTokensByAddressE403 = new ListTokensByAddressE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, ListTokensByAddressE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newListTokensByAddressE403 = new ListTokensByAddressE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, ListTokensByAddressE403.SerializerSettings));
                }
                else
                {
                    newListTokensByAddressE403 = new ListTokensByAddressE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, ListTokensByAddressE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newListTokensByAddressE403 = new ListTokensByAddressE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, ListTokensByAddressE403.SerializerSettings));
                }
                else
                {
                    newListTokensByAddressE403 = new ListTokensByAddressE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, ListTokensByAddressE403.AdditionalPropertiesSerializerSettings));
                }
        ...
        {
            return this.Equals(input as ListTokensByAddressE403);
        }

        /// <summary>
        /// Returns true if ListTokensByAddressE403 instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTokensByAddressE403 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTokensByAddressE403 input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for ListTokensByAddressE403
    /// </summary>
    public class ListTokensByAddressE403JsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(ListTokensByAddressE403).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return ListTokensByAddressE403.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
