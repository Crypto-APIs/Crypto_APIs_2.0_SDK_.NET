...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DecodeRawTransactionHexRISB_scriptSig")]
    public partial class DecodeRawTransactionHexRISBScriptSig : IEquatable<DecodeRawTransactionHexRISBScriptSig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISBScriptSig" /> class.
        /// </summary>
        ...
        public DecodeRawTransactionHexRISBScriptSig(string asm = default(string), string hex = default(string), string type = default(string))
        {
            this.Asm = asm;
            this.Hex = hex;
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DecodeRawTransactionHexRISBScriptSig {\n");
        ...
        {
            return this.Equals(input as DecodeRawTransactionHexRISBScriptSig);
        }

        /// <summary>
        /// Returns true if DecodeRawTransactionHexRISBScriptSig instances are equal
        /// </summary>
        /// <param name="input">Instance of DecodeRawTransactionHexRISBScriptSig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecodeRawTransactionHexRISBScriptSig input)
        {
            if (input == null)
            {
                return false;
