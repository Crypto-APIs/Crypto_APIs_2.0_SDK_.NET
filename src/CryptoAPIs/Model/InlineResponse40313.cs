...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40313
    /// </summary>
    [DataContract(Name = "inline_response_403_13")]
    public partial class InlineResponse40313 : IEquatable<InlineResponse40313>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40313" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40313() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40313" /> class.
        /// </summary>
        ...
        public InlineResponse40313(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateCoinsTransactionRequestFromWalletE403 error = default(CreateCoinsTransactionRequestFromWalletE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40313 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40313 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40313 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40313 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40313);
        }

        /// <summary>
        /// Returns true if InlineResponse40313 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40313 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40313 input)
        {
            if (input == null)
            {
                return false;
