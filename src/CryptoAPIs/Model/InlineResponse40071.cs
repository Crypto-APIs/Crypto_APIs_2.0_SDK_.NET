...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40071
    /// </summary>
    [DataContract(Name = "inline_response_400_71")]
    public partial class InlineResponse40071 : IEquatable<InlineResponse40071>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40071" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40071() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40071" /> class.
        /// </summary>
        ...
        public InlineResponse40071(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetBlockDetailsByBlockHashFromCallbackE400 error = default(GetBlockDetailsByBlockHashFromCallbackE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40071 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40071 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40071 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40071 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40071);
        }

        /// <summary>
        /// Returns true if InlineResponse40071 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40071 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40071 input)
        {
            if (input == null)
            {
                return false;
