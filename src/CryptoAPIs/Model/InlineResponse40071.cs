...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40071 : IEquatable<InlineResponse40071>, IValidatableObject
    {
        ...
        public InlineResponse40071(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewUnconfirmedCoinsTransactionsE400 error = default(NewUnconfirmedCoinsTransactionsE400))
        {
