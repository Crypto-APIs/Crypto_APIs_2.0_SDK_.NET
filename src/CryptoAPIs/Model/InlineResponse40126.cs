...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40126
    /// </summary>
    [DataContract(Name = "inline_response_401_26")]
    public partial class InlineResponse40126 : IEquatable<InlineResponse40126>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40126" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40126() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40126" /> class.
        /// </summary>
        ...
        public InlineResponse40126(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateCoinsTransactionFromAddressForWholeAmountE401 error = default(CreateCoinsTransactionFromAddressForWholeAmountE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40126 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40126 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40126 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40126 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40126);
        }

        /// <summary>
        /// Returns true if InlineResponse40126 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40126 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40126 input)
        {
            if (input == null)
            {
                return false;
