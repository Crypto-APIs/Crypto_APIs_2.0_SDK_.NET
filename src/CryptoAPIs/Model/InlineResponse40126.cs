...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40126 : IEquatable<InlineResponse40126>, IValidatableObject
    {
        ...
        public InlineResponse40126(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetBlockDetailsByBlockHeightE401 error = default(GetBlockDetailsByBlockHeightE401))
        {
