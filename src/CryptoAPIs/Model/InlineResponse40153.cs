...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40153 : IEquatable<InlineResponse40153>, IValidatableObject
    {
        ...
        public InlineResponse40153(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetFeeRecommendationsE401 error = default(GetFeeRecommendationsE401))
        {
