...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40153
    /// </summary>
    [DataContract(Name = "inline_response_401_53")]
    public partial class InlineResponse40153 : IEquatable<InlineResponse40153>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40153" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40153() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40153" /> class.
        /// </summary>
        ...
        public InlineResponse40153(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListHDWalletXPubYPubZPubTransactionsE401 error = default(ListHDWalletXPubYPubZPubTransactionsE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40153 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40153 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40153 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40153 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40153);
        }

        /// <summary>
        /// Returns true if InlineResponse40153 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40153 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40153 input)
        {
            if (input == null)
            {
                return false;
