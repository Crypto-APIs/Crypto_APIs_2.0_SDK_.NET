...
namespace CryptoAPIs.Model
{
    ...
    /// GetAddressBalanceR
    /// </summary>
    [DataContract(Name = "GetAddressBalanceR")]
    public partial class GetAddressBalanceR : IEquatable<GetAddressBalanceR>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressBalanceR" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetAddressBalanceR() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressBalanceR" /> class.
        /// </summary>
        ...
        public GetAddressBalanceR(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetAddressBalanceRData data = default(GetAddressBalanceRData))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for GetAddressBalanceR and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for GetAddressBalanceR and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for GetAddressBalanceR and cannot be null");
            }
            this.Data = data;
        ...
        public GetAddressBalanceRData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAddressBalanceR {\n");
        ...
        {
            return this.Equals(input as GetAddressBalanceR);
        }

        /// <summary>
        /// Returns true if GetAddressBalanceR instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAddressBalanceR to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAddressBalanceR input)
        {
            if (input == null)
            {
                return false;
