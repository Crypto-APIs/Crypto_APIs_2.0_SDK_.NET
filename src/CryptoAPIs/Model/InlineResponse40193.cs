...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40193
    /// </summary>
    [DataContract(Name = "inline_response_401_93")]
    public partial class InlineResponse40193 : IEquatable<InlineResponse40193>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40193" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40193() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40193" /> class.
        /// </summary>
        ...
        public InlineResponse40193(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateAutomaticTokensForwardingE401 error = default(CreateAutomaticTokensForwardingE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40193 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40193 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40193 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40193 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40193);
        }

        /// <summary>
        /// Returns true if InlineResponse40193 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40193 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40193 input)
        {
            if (input == null)
            {
                return false;
