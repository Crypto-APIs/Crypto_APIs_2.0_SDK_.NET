...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListTransactionsByBlockHeightRI")]
    public partial class ListTransactionsByBlockHeightRI : IEquatable<ListTransactionsByBlockHeightRI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHeightRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByBlockHeightRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHeightRI" /> class.
        /// </summary>
        ...
        public ListTransactionsByBlockHeightRI(int index = default(int), string minedInBlockHash = default(string), int minedInBlockHeight = default(int), List<GetTransactionDetailsByTransactionIDRIRecipients> recipients = default(List<GetTransactionDetailsByTransactionIDRIRecipients>), List<GetTransactionDetailsByTransactionIDRISenders> senders = default(List<GetTransactionDetailsByTransactionIDRISenders>), int timestamp = default(int), string transactionHash = default(string), string transactionId = default(string), ListTransactionsByBlockHeightRIFee fee = default(ListTransactionsByBlockHeightRIFee), ListTransactionsByBlockHeightRIBS blockchainSpecific = default(ListTransactionsByBlockHeightRIBS))
        {
            this.Index = index;
            // to ensure "minedInBlockHash" is required (not null)
            this.MinedInBlockHash = minedInBlockHash ?? throw new ArgumentNullException("minedInBlockHash is a required property for ListTransactionsByBlockHeightRI and cannot be null");
            this.MinedInBlockHeight = minedInBlockHeight;
            // to ensure "recipients" is required (not null)
            this.Recipients = recipients ?? throw new ArgumentNullException("recipients is a required property for ListTransactionsByBlockHeightRI and cannot be null");
            // to ensure "senders" is required (not null)
            this.Senders = senders ?? throw new ArgumentNullException("senders is a required property for ListTransactionsByBlockHeightRI and cannot be null");
            this.Timestamp = timestamp;
            // to ensure "transactionHash" is required (not null)
            this.TransactionHash = transactionHash ?? throw new ArgumentNullException("transactionHash is a required property for ListTransactionsByBlockHeightRI and cannot be null");
            // to ensure "transactionId" is required (not null)
            this.TransactionId = transactionId ?? throw new ArgumentNullException("transactionId is a required property for ListTransactionsByBlockHeightRI and cannot be null");
            // to ensure "fee" is required (not null)
            this.Fee = fee ?? throw new ArgumentNullException("fee is a required property for ListTransactionsByBlockHeightRI and cannot be null");
            // to ensure "blockchainSpecific" is required (not null)
            this.BlockchainSpecific = blockchainSpecific ?? throw new ArgumentNullException("blockchainSpecific is a required property for ListTransactionsByBlockHeightRI and cannot be null");
        }
        ...
        public ListTransactionsByBlockHeightRIFee Fee { get; set; }

        /// <summary>
        /// Gets or Sets BlockchainSpecific
        /// </summary>
        [DataMember(Name = "blockchainSpecific", IsRequired = true, EmitDefaultValue = false)]
        public ListTransactionsByBlockHeightRIBS BlockchainSpecific { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListTransactionsByBlockHeightRI {\n");
        ...
        {
            return this.Equals(input as ListTransactionsByBlockHeightRI);
        }

        /// <summary>
        /// Returns true if ListTransactionsByBlockHeightRI instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByBlockHeightRI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByBlockHeightRI input)
        {
            if (input == null)
                return false;
