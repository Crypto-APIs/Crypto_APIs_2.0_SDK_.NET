...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListUnspentTransactionOutputsByAddressRI_blockchainSpecific_vShieldedSpend")]
    public partial class ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVShieldedSpend : IEquatable<ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVShieldedSpend>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVShieldedSpend" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVShieldedSpend() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVShieldedSpend" /> class.
        /// </summary>
        ...
        public ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVShieldedSpend(string anchor = default(string), string cv = default(string), string nullifier = default(string), string proof = default(string), string rk = default(string), string spendAuthSig = default(string))
        {
            // to ensure "anchor" is required (not null)
            if (anchor == null) {
                throw new ArgumentNullException("anchor is a required property for ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVShieldedSpend and cannot be null");
            }
            this.Anchor = anchor;
            // to ensure "cv" is required (not null)
            if (cv == null) {
                throw new ArgumentNullException("cv is a required property for ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVShieldedSpend and cannot be null");
            }
            this.Cv = cv;
            // to ensure "nullifier" is required (not null)
            if (nullifier == null) {
                throw new ArgumentNullException("nullifier is a required property for ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVShieldedSpend and cannot be null");
            }
            this.Nullifier = nullifier;
            // to ensure "proof" is required (not null)
            if (proof == null) {
                throw new ArgumentNullException("proof is a required property for ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVShieldedSpend and cannot be null");
            }
            this.Proof = proof;
            // to ensure "rk" is required (not null)
            if (rk == null) {
                throw new ArgumentNullException("rk is a required property for ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVShieldedSpend and cannot be null");
            }
            this.Rk = rk;
            // to ensure "spendAuthSig" is required (not null)
            if (spendAuthSig == null) {
                throw new ArgumentNullException("spendAuthSig is a required property for ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVShieldedSpend and cannot be null");
            }
        ...
        {
            return this.Equals(input as ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVShieldedSpend);
        }

        /// <summary>
        /// Returns true if ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVShieldedSpend instances are equal
        /// </summary>
        /// <param name="input">Instance of ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVShieldedSpend to be compared</param>
        /// <returns>Boolean</returns>
