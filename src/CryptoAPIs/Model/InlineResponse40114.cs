...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40114
    /// </summary>
    [DataContract(Name = "inline_response_401_14")]
    public partial class InlineResponse40114 : IEquatable<InlineResponse40114>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40114" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40114() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40114" /> class.
        /// </summary>
        ...
        public InlineResponse40114(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListZilliqaTransactionsByAddressE401 error = default(ListZilliqaTransactionsByAddressE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40114 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40114 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40114 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40114 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40114);
        }

        /// <summary>
        /// Returns true if InlineResponse40114 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40114 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40114 input)
        {
            if (input == null)
            {
                return false;
