...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40346
    /// </summary>
    [DataContract(Name = "inline_response_403_46")]
    public partial class InlineResponse40346 : IEquatable<InlineResponse40346>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40346" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40346() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40346" /> class.
        /// </summary>
        ...
        public InlineResponse40346(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetWalletTransactionDetailsByTransactionIDE403 error = default(GetWalletTransactionDetailsByTransactionIDE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40346 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40346 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40346 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40346 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40346);
        }

        /// <summary>
        /// Returns true if InlineResponse40346 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40346 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40346 input)
        {
            if (input == null)
            {
                return false;
