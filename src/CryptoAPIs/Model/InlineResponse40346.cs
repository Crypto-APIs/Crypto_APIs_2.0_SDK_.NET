...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40346 : IEquatable<InlineResponse40346>, IValidatableObject
    {
        ...
        public InlineResponse40346(string apiVersion = default(string), string requestId = default(string), string context = default(string), SyncHDWalletXPubYPubZPubE403 error = default(SyncHDWalletXPubYPubZPubE403))
        {
