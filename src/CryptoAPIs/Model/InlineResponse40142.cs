...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40142 : IEquatable<InlineResponse40142>, IValidatableObject
    {
        ...
        public InlineResponse40142(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListLatestMinedBlocksE401 error = default(ListLatestMinedBlocksE401))
        {
