...
namespace CryptoAPIs.Model
{
    ...
    /// Litecoin
    /// </summary>
    [DataContract(Name = "ListTransactionsByAddressRIBSL")]
    public partial class ListTransactionsByAddressRIBSL : IEquatable<ListTransactionsByAddressRIBSL>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressRIBSL" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByAddressRIBSL() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressRIBSL" /> class.
        /// </summary>
        ...
        public ListTransactionsByAddressRIBSL(int locktime = default(int), int size = default(int), int vSize = default(int), int version = default(int), List<ListTransactionsByAddressRIBSLVin> vin = default(List<ListTransactionsByAddressRIBSLVin>), List<GetTransactionDetailsByTransactionIDRIBSLVout> vout = default(List<GetTransactionDetailsByTransactionIDRIBSLVout>))
        {
            ...
            this.Vin = vin ?? throw new ArgumentNullException("vin is a required property for ListTransactionsByAddressRIBSL and cannot be null");
            // to ensure "vout" is required (not null)
            this.Vout = vout ?? throw new ArgumentNullException("vout is a required property for ListTransactionsByAddressRIBSL and cannot be null");
        }
        ...
        public List<ListTransactionsByAddressRIBSLVin> Vin { get; set; }
        ...
        {
            return this.Equals(input as ListTransactionsByAddressRIBSL);
        }

        /// <summary>
        /// Returns true if ListTransactionsByAddressRIBSL instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByAddressRIBSL to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByAddressRIBSL input)
        {
            if (input == null)
                return false;
