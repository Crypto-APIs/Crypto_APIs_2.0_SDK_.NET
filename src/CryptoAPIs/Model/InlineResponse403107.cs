...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_403_107")]
    public partial class InlineResponse403107 : IEquatable<InlineResponse403107>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse403107" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse403107() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse403107" /> class.
        /// </summary>
        ...
        public InlineResponse403107(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetExchangeRateByAssetsIDsE403 error = default(GetExchangeRateByAssetsIDsE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse403107 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse403107 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse403107 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse403107 {\n");
        ...
        {
            return this.Equals(input as InlineResponse403107);
        }

        /// <summary>
        /// Returns true if InlineResponse403107 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse403107 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse403107 input)
        {
            if (input == null)
            {
                return false;
