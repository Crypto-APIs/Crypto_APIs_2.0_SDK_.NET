...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse402
    /// </summary>
    [DataContract(Name = "inline_response_402")]
    public partial class InlineResponse402 : IEquatable<InlineResponse402>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse402" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse402() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse402" /> class.
        /// </summary>
        ...
        public InlineResponse402(string apiVersion = default(string), string requestId = default(string), string context = default(string), InsufficientCredits error = default(InsufficientCredits))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse402 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse402 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse402 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse402);
        }

        /// <summary>
        /// Returns true if InlineResponse402 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse402 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse402 input)
        {
            if (input == null)
            {
                return false;
