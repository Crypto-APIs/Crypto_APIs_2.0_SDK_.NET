...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransactionRequestFail")]
    public partial class TransactionRequestFail : IEquatable<TransactionRequestFail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionRequestFail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionRequestFail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionRequestFail" /> class.
        /// </summary>
        ...
        public TransactionRequestFail(string apiVersion = default(string), string referenceId = default(string), string idempotencyKey = default(string), TransactionRequestFailData data = default(TransactionRequestFailData))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for TransactionRequestFail and cannot be null");
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for TransactionRequestFail and cannot be null");
            // to ensure "idempotencyKey" is required (not null)
            this.IdempotencyKey = idempotencyKey ?? throw new ArgumentNullException("idempotencyKey is a required property for TransactionRequestFail and cannot be null");
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for TransactionRequestFail and cannot be null");
        }
        ...
        public TransactionRequestFailData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionRequestFail {\n");
        ...
        {
            return this.Equals(input as TransactionRequestFail);
        }

        /// <summary>
        /// Returns true if TransactionRequestFail instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionRequestFail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionRequestFail input)
        {
            if (input == null)
                return false;
