...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Encode_X_Address_400_response")]
    public partial class EncodeXAddress400Response : IEquatable<EncodeXAddress400Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EncodeXAddress400Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EncodeXAddress400Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EncodeXAddress400Response" /> class.
        /// </summary>
        ...
        public EncodeXAddress400Response(string apiVersion = default(string), string requestId = default(string), string context = default(string), EncodeXAddressE400 error = default(EncodeXAddressE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for EncodeXAddress400Response and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for EncodeXAddress400Response and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for EncodeXAddress400Response and cannot be null");
            }
            this.Error = error;
        ...
        public EncodeXAddressE400 Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EncodeXAddress400Response {\n");
        ...
        {
            return this.Equals(input as EncodeXAddress400Response);
        }

        /// <summary>
        /// Returns true if EncodeXAddress400Response instances are equal
        /// </summary>
        /// <param name="input">Instance of EncodeXAddress400Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EncodeXAddress400Response input)
        {
            if (input == null)
            {
                return false;
