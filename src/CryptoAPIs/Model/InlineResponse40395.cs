...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40395
    /// </summary>
    [DataContract(Name = "inline_response_403_95")]
    public partial class InlineResponse40395 : IEquatable<InlineResponse40395>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40395" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40395() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40395" /> class.
        /// </summary>
        ...
        public InlineResponse40395(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetFeeAddressDetailsE403 error = default(GetFeeAddressDetailsE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40395 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40395 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40395 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40395 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40395);
        }

        /// <summary>
        /// Returns true if InlineResponse40395 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40395 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40395 input)
        {
            if (input == null)
            {
                return false;
