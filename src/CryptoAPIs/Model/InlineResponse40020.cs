...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40020 : IEquatable<InlineResponse40020>, IValidatableObject
    {
        ...
        public InlineResponse40020(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetUnconfirmedOmniTransactionByTransactionIDTxidE400 error = default(GetUnconfirmedOmniTransactionByTransactionIDTxidE400))
        {
