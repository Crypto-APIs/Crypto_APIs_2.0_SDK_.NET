...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DecodeRawTransactionHexRISZ_vin_inner_scriptSig")]
    public partial class DecodeRawTransactionHexRISZVinInnerScriptSig : IEquatable<DecodeRawTransactionHexRISZVinInnerScriptSig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISZVinInnerScriptSig" /> class.
        /// </summary>
        ...
        public DecodeRawTransactionHexRISZVinInnerScriptSig(string asm = default(string), string hex = default(string), string type = default(string))
        {
            this.Asm = asm;
            this.Hex = hex;
            this.Type = type;
        ...
        {
            return this.Equals(input as DecodeRawTransactionHexRISZVinInnerScriptSig);
        }

        /// <summary>
        /// Returns true if DecodeRawTransactionHexRISZVinInnerScriptSig instances are equal
        /// </summary>
        /// <param name="input">Instance of DecodeRawTransactionHexRISZVinInnerScriptSig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecodeRawTransactionHexRISZVinInnerScriptSig input)
        {
            if (input == null)
            {
                return false;
