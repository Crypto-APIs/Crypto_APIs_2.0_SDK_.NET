...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40083 : IEquatable<InlineResponse40083>, IValidatableObject
    {
        ...
        public InlineResponse40083(string apiVersion = default(string), string requestId = default(string), string context = default(string), ValidateAddressE400 error = default(ValidateAddressE400))
        {
