...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40083
    /// </summary>
    [DataContract(Name = "inline_response_400_83")]
    public partial class InlineResponse40083 : IEquatable<InlineResponse40083>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40083" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40083() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40083" /> class.
        /// </summary>
        ...
        public InlineResponse40083(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetAddressDetailsFromCallbackE400 error = default(GetAddressDetailsFromCallbackE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40083 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40083 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40083 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40083 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40083);
        }

        /// <summary>
        /// Returns true if InlineResponse40083 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40083 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40083 input)
        {
            if (input == null)
            {
                return false;
