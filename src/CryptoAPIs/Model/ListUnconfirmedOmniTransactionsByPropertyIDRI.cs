...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListUnconfirmedOmniTransactionsByPropertyIDRI : IEquatable<ListUnconfirmedOmniTransactionsByPropertyIDRI>, IValidatableObject
    {
        ...
        public ListUnconfirmedOmniTransactionsByPropertyIDRI(string amount = default(string), bool divisible = default(bool), bool mined = default(bool), int propertyId = default(int), List<ListOmniTransactionsByAddressRIRecipientsInner> recipients = default(List<ListOmniTransactionsByAddressRIRecipientsInner>), List<GetUnconfirmedOmniTransactionByTransactionIDTxidRISendersInner> senders = default(List<GetUnconfirmedOmniTransactionByTransactionIDTxidRISendersInner>), bool sent = default(bool), int timestamp = default(int), string transactionId = default(string), string type = default(string), int typeIint = default(int), int version = default(int), ListUnconfirmedOmniTransactionsByAddressRIFee fee = default(ListUnconfirmedOmniTransactionsByAddressRIFee))
        {
