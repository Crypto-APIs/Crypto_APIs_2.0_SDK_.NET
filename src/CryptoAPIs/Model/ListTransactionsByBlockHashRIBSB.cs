...
namespace CryptoAPIs.Model
{
    ...
    /// Bitcoin
    /// </summary>
    [DataContract(Name = "ListTransactionsByBlockHashRIBSB")]
    public partial class ListTransactionsByBlockHashRIBSB : IEquatable<ListTransactionsByBlockHashRIBSB>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashRIBSB" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByBlockHashRIBSB() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashRIBSB" /> class.
        /// </summary>
        ...
        public ListTransactionsByBlockHashRIBSB(long locktime = default(long), int size = default(int), int vSize = default(int), int version = default(int), List<ListTransactionsByBlockHashRIBSBVinInner> vin = default(List<ListTransactionsByBlockHashRIBSBVinInner>), List<ListTransactionsByBlockHashRIBSBVoutInner> vout = default(List<ListTransactionsByBlockHashRIBSBVoutInner>))
        {
            ...
            if (vin == null)
            {
                throw new ArgumentNullException("vin is a required property for ListTransactionsByBlockHashRIBSB and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null)
            {
                throw new ArgumentNullException("vout is a required property for ListTransactionsByBlockHashRIBSB and cannot be null");
            }
            this.Vout = vout;
        }
        ...
        public List<ListTransactionsByBlockHashRIBSBVinInner> Vin { get; set; }
        ...
        public List<ListTransactionsByBlockHashRIBSBVoutInner> Vout { get; set; }
        ...
        {
            return this.Equals(input as ListTransactionsByBlockHashRIBSB);
        }

        /// <summary>
        /// Returns true if ListTransactionsByBlockHashRIBSB instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByBlockHashRIBSB to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByBlockHashRIBSB input)
        {
            if (input == null)
            {
                return false;
