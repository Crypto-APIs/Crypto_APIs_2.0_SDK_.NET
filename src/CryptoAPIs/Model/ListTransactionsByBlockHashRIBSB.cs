...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListTransactionsByBlockHashRIBSB : IEquatable<ListTransactionsByBlockHashRIBSB>, IValidatableObject
    {
        ...
        public ListTransactionsByBlockHashRIBSB(int locktime = default(int), int size = default(int), int vSize = default(int), int version = default(int), List<ListTransactionsByBlockHashRIBSBVin> vin = default(List<ListTransactionsByBlockHashRIBSBVin>), List<GetTransactionDetailsByTransactionIDRIBSBVout> vout = default(List<GetTransactionDetailsByTransactionIDRIBSBVout>))
        {
            ...
            this.Vin = vin ?? throw new ArgumentNullException("vin is a required property for ListTransactionsByBlockHashRIBSB and cannot be null");
            // to ensure "vout" is required (not null)
            this.Vout = vout ?? throw new ArgumentNullException("vout is a required property for ListTransactionsByBlockHashRIBSB and cannot be null");
        }
