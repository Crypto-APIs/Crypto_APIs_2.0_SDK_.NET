...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListSyncedAddressesR_data")]
    public partial class ListSyncedAddressesRData : IEquatable<ListSyncedAddressesRData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListSyncedAddressesRData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListSyncedAddressesRData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListSyncedAddressesRData" /> class.
        /// </summary>
        ...
        public ListSyncedAddressesRData(int limit = default(int), int offset = default(int), int total = default(int), List<ListSyncedAddressesRI> items = default(List<ListSyncedAddressesRI>))
        {
            this.Limit = limit;
            this.Offset = offset;
            this.Total = total;
            ...
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for ListSyncedAddressesRData and cannot be null");
            }
            this.Items = items;
        }
        ...
        public List<ListSyncedAddressesRI> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListSyncedAddressesRData {\n");
        ...
        {
            return this.Equals(input as ListSyncedAddressesRData);
        }

        /// <summary>
        /// Returns true if ListSyncedAddressesRData instances are equal
        /// </summary>
        /// <param name="input">Instance of ListSyncedAddressesRData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListSyncedAddressesRData input)
        {
            if (input == null)
            {
                return false;
