...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40024 : IEquatable<InlineResponse40024>, IValidatableObject
    {
        ...
        public InlineResponse40024(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTransactionsByBlockHeightE400 error = default(ListTransactionsByBlockHeightE400))
        {
