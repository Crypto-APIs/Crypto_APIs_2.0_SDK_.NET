...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40024
    /// </summary>
    [DataContract(Name = "inline_response_400_24")]
    public partial class InlineResponse40024 : IEquatable<InlineResponse40024>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40024" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40024() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40024" /> class.
        /// </summary>
        ...
        public InlineResponse40024(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListXRPRippleTransactionsByBlockHeightE400 error = default(ListXRPRippleTransactionsByBlockHeightE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40024 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40024 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40024 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40024 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40024);
        }

        /// <summary>
        /// Returns true if InlineResponse40024 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40024 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40024 input)
        {
            if (input == null)
            {
                return false;
