...
namespace CryptoAPIs.Model
{
    ...
    /// MissingApiKey
    /// </summary>
    [DataContract(Name = "MissingApiKey")]
    public partial class MissingApiKey : IEquatable<MissingApiKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MissingApiKey" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MissingApiKey() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MissingApiKey" /> class.
        /// </summary>
        ...
        public MissingApiKey(string apiVersion = default(string), string requestId = default(string), string context = default(string), MissingApiKeyError error = default(MissingApiKeyError))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for MissingApiKey and cannot be null");
            // to ensure "requestId" is required (not null)
            this.RequestId = requestId ?? throw new ArgumentNullException("requestId is a required property for MissingApiKey and cannot be null");
            // to ensure "error" is required (not null)
            this.Error = error ?? throw new ArgumentNullException("error is a required property for MissingApiKey and cannot be null");
        ...
        public MissingApiKeyError Error { get; set; }
        ...
        {
            return this.Equals(input as MissingApiKey);
        }

        /// <summary>
        /// Returns true if MissingApiKey instances are equal
        /// </summary>
        /// <param name="input">Instance of MissingApiKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MissingApiKey input)
        {
            if (input == null)
                return false;
