...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BannedIpAddress_details")]
    public partial class BannedIpAddressDetails : IEquatable<BannedIpAddressDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BannedIpAddressDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BannedIpAddressDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BannedIpAddressDetails" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BannedIpAddressDetails {\n");
        ...
        {
            return this.Equals(input as BannedIpAddressDetails);
        }

        /// <summary>
        /// Returns true if BannedIpAddressDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of BannedIpAddressDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BannedIpAddressDetails input)
        {
            if (input == null)
            {
                return false;
