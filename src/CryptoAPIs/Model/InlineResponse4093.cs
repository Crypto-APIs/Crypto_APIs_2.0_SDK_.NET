...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4093
    /// </summary>
    [DataContract(Name = "inline_response_409_3")]
    public partial class InlineResponse4093 : IEquatable<InlineResponse4093>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4093" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse4093() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4093" /> class.
        /// </summary>
        ...
        public InlineResponse4093(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateCoinsTransactionFromAddressForWholeAmountE409 error = default(CreateCoinsTransactionFromAddressForWholeAmountE409))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4093 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4093 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse4093 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse4093);
        }

        /// <summary>
        /// Returns true if InlineResponse4093 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4093 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4093 input)
        {
            if (input == null)
            {
                return false;
