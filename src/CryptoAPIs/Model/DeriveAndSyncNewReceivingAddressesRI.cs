...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeriveAndSyncNewReceivingAddressesRI")]
    public partial class DeriveAndSyncNewReceivingAddressesRI : IEquatable<DeriveAndSyncNewReceivingAddressesRI>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeriveAndSyncNewReceivingAddressesRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeriveAndSyncNewReceivingAddressesRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeriveAndSyncNewReceivingAddressesRI" /> class.
        /// </summary>
        ...
        public DeriveAndSyncNewReceivingAddressesRI(string address = default(string), string addressFormat = default(string), AddressTypeEnum addressType = default(AddressTypeEnum), DerivationTypeEnum derivationType = default(DerivationTypeEnum), string index = default(string))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for DeriveAndSyncNewReceivingAddressesRI and cannot be null");
            }
            this.Address = address;
            // to ensure "addressFormat" is required (not null)
            if (addressFormat == null)
            {
                throw new ArgumentNullException("addressFormat is a required property for DeriveAndSyncNewReceivingAddressesRI and cannot be null");
            }
            ...
            if (index == null)
            {
                throw new ArgumentNullException("index is a required property for DeriveAndSyncNewReceivingAddressesRI and cannot be null");
            }
            this.Index = index;
        }
        ...
        {
            return this.Equals(input as DeriveAndSyncNewReceivingAddressesRI);
        }

        /// <summary>
        /// Returns true if DeriveAndSyncNewReceivingAddressesRI instances are equal
        /// </summary>
        /// <param name="input">Instance of DeriveAndSyncNewReceivingAddressesRI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeriveAndSyncNewReceivingAddressesRI input)
        {
            if (input == null)
            {
                return false;
