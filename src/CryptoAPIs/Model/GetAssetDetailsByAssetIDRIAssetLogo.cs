...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetAssetDetailsByAssetIDRI_assetLogo")]
    public partial class GetAssetDetailsByAssetIDRIAssetLogo : IEquatable<GetAssetDetailsByAssetIDRIAssetLogo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAssetDetailsByAssetIDRIAssetLogo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetAssetDetailsByAssetIDRIAssetLogo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAssetDetailsByAssetIDRIAssetLogo" /> class.
        /// </summary>
        ...
        public GetAssetDetailsByAssetIDRIAssetLogo(string encoding = default(string), string imageData = default(string), string mimeType = default(string))
        {
            // to ensure "encoding" is required (not null)
            if (encoding == null) {
                throw new ArgumentNullException("encoding is a required property for GetAssetDetailsByAssetIDRIAssetLogo and cannot be null");
            }
            this.Encoding = encoding;
            // to ensure "imageData" is required (not null)
            if (imageData == null) {
                throw new ArgumentNullException("imageData is a required property for GetAssetDetailsByAssetIDRIAssetLogo and cannot be null");
            }
            this.ImageData = imageData;
            // to ensure "mimeType" is required (not null)
            if (mimeType == null) {
                throw new ArgumentNullException("mimeType is a required property for GetAssetDetailsByAssetIDRIAssetLogo and cannot be null");
            }
        ...
        {
            return this.Equals(input as GetAssetDetailsByAssetIDRIAssetLogo);
        }

        /// <summary>
        /// Returns true if GetAssetDetailsByAssetIDRIAssetLogo instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAssetDetailsByAssetIDRIAssetLogo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAssetDetailsByAssetIDRIAssetLogo input)
        {
            if (input == null)
            {
                return false;
