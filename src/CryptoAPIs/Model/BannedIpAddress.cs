...
namespace CryptoAPIs.Model
{
    ...
    public partial class BannedIpAddress : IEquatable<BannedIpAddress>, IValidatableObject
    {
        ...
        public BannedIpAddress(string apiVersion = default(string), string requestId = default(string), string context = default(string), BannedIpAddressError error = default(BannedIpAddressError))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for BannedIpAddress and cannot be null");
            // to ensure "requestId" is required (not null)
            this.RequestId = requestId ?? throw new ArgumentNullException("requestId is a required property for BannedIpAddress and cannot be null");
            // to ensure "error" is required (not null)
            this.Error = error ?? throw new ArgumentNullException("error is a required property for BannedIpAddress and cannot be null");
        ...
        public BannedIpAddressError Error { get; set; }
