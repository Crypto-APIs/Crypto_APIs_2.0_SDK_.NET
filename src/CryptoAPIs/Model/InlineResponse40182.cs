...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40182 : IEquatable<InlineResponse40182>, IValidatableObject
    {
        ...
        public InlineResponse40182(string apiVersion = default(string), string requestId = default(string), string context = default(string), DeleteAutomaticTokensForwardingE401 error = default(DeleteAutomaticTokensForwardingE401))
        {
