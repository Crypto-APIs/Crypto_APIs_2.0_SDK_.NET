...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40182
    /// </summary>
    [DataContract(Name = "inline_response_401_82")]
    public partial class InlineResponse40182 : IEquatable<InlineResponse40182>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40182" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40182() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40182" /> class.
        /// </summary>
        ...
        public InlineResponse40182(string apiVersion = default(string), string requestId = default(string), string context = default(string), DeleteBlockchainEventSubscriptionE401 error = default(DeleteBlockchainEventSubscriptionE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40182 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40182 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40182 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40182 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40182);
        }

        /// <summary>
        /// Returns true if InlineResponse40182 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40182 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40182 input)
        {
            if (input == null)
            {
                return false;
