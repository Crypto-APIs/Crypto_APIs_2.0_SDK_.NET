...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40358
    /// </summary>
    [DataContract(Name = "inline_response_403_58")]
    public partial class InlineResponse40358 : IEquatable<InlineResponse40358>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40358" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40358() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40358" /> class.
        /// </summary>
        ...
        public InlineResponse40358(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewUnconfirmedCoinsTransactionsE403 error = default(NewUnconfirmedCoinsTransactionsE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40358 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40358 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40358 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40358 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40358);
        }

        /// <summary>
        /// Returns true if InlineResponse40358 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40358 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40358 input)
        {
            if (input == null)
            {
                return false;
