...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40358 : IEquatable<InlineResponse40358>, IValidatableObject
    {
        ...
        public InlineResponse40358(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetNextAvailableNonceE403 error = default(GetNextAvailableNonceE403))
        {
