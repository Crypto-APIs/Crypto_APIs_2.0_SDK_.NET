...
namespace CryptoAPIs.Model
{
    ...
    /// DecodeXAddressR
    /// </summary>
    [DataContract(Name = "DecodeX-AddressR")]
    public partial class DecodeXAddressR : IEquatable<DecodeXAddressR>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeXAddressR" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DecodeXAddressR() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeXAddressR" /> class.
        /// </summary>
        ...
        public DecodeXAddressR(string apiVersion = default(string), string requestId = default(string), string context = default(string), DecodeXAddressRData data = default(DecodeXAddressRData))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for DecodeXAddressR and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for DecodeXAddressR and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for DecodeXAddressR and cannot be null");
            }
            this.Data = data;
        ...
        public DecodeXAddressRData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DecodeXAddressR {\n");
        ...
        {
            return this.Equals(input as DecodeXAddressR);
        }

        /// <summary>
        /// Returns true if DecodeXAddressR instances are equal
        /// </summary>
        /// <param name="input">Instance of DecodeXAddressR to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecodeXAddressR input)
        {
            if (input == null)
            {
                return false;
