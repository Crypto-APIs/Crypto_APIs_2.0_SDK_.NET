...
namespace CryptoAPIs.Model
{
    ...
    public partial class InvalidXpub : IEquatable<InvalidXpub>, IValidatableObject
    {
        ...
        public InvalidXpub(string apiVersion = default(string), string requestId = default(string), string context = default(string), InvalidXpubError error = default(InvalidXpubError))
        {
            ...
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InvalidXpub and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InvalidXpub and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InvalidXpub and cannot be null");
            }
            this.Error = error;
