...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40331
    /// </summary>
    [DataContract(Name = "inline_response_403_31")]
    public partial class InlineResponse40331 : IEquatable<InlineResponse40331>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40331" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40331() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40331" /> class.
        /// </summary>
        ...
        public InlineResponse40331(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetXRPRippleBlockDetailsByBlockHashE403 error = default(GetXRPRippleBlockDetailsByBlockHashE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40331 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40331 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40331 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40331 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40331);
        }

        /// <summary>
        /// Returns true if InlineResponse40331 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40331 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40331 input)
        {
            if (input == null)
            {
                return false;
