...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40331 : IEquatable<InlineResponse40331>, IValidatableObject
    {
        ...
        public InlineResponse40331(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetBlockDetailsByBlockHashE403 error = default(GetBlockDetailsByBlockHashE403))
        {
