...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40393
    /// </summary>
    [DataContract(Name = "inline_response_403_93")]
    public partial class InlineResponse40393 : IEquatable<InlineResponse40393>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40393" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40393() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40393" /> class.
        /// </summary>
        ...
        public InlineResponse40393(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateAutomaticTokensForwardingE403 error = default(CreateAutomaticTokensForwardingE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40393 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40393 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40393 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40393 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40393);
        }

        /// <summary>
        /// Returns true if InlineResponse40393 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40393 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40393 input)
        {
            if (input == null)
            {
                return false;
