...
namespace CryptoAPIs.Model
{
    ...
    /// Bitcoin Cash
    /// </summary>
    [DataContract(Name = "ListAllUnconfirmedTransactionsRIBSBC")]
    public partial class ListAllUnconfirmedTransactionsRIBSBC : IEquatable<ListAllUnconfirmedTransactionsRIBSBC>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllUnconfirmedTransactionsRIBSBC" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListAllUnconfirmedTransactionsRIBSBC() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllUnconfirmedTransactionsRIBSBC" /> class.
        /// </summary>
        ...
        public ListAllUnconfirmedTransactionsRIBSBC(int locktime = default(int), int size = default(int), int version = default(int), List<ListAllUnconfirmedTransactionsRIBSBCVin> vin = default(List<ListAllUnconfirmedTransactionsRIBSBCVin>), List<ListAllUnconfirmedTransactionsRIBSBCVout> vout = default(List<ListAllUnconfirmedTransactionsRIBSBCVout>))
        {
            ...
            if (vin == null) {
                throw new ArgumentNullException("vin is a required property for ListAllUnconfirmedTransactionsRIBSBC and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null) {
                throw new ArgumentNullException("vout is a required property for ListAllUnconfirmedTransactionsRIBSBC and cannot be null");
            }
            this.Vout = vout;
        }
        ...
        {
            return this.Equals(input as ListAllUnconfirmedTransactionsRIBSBC);
        }

        /// <summary>
        /// Returns true if ListAllUnconfirmedTransactionsRIBSBC instances are equal
        /// </summary>
        /// <param name="input">Instance of ListAllUnconfirmedTransactionsRIBSBC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListAllUnconfirmedTransactionsRIBSBC input)
        {
            if (input == null)
                return false;
