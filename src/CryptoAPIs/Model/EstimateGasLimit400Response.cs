...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Estimate_Gas_Limit_400_response")]
    public partial class EstimateGasLimit400Response : IEquatable<EstimateGasLimit400Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EstimateGasLimit400Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EstimateGasLimit400Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EstimateGasLimit400Response" /> class.
        /// </summary>
        ...
        public EstimateGasLimit400Response(string apiVersion = default(string), string requestId = default(string), string context = default(string), EstimateGasLimitE400 error = default(EstimateGasLimitE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for EstimateGasLimit400Response and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for EstimateGasLimit400Response and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for EstimateGasLimit400Response and cannot be null");
            }
            this.Error = error;
        ...
        public EstimateGasLimitE400 Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EstimateGasLimit400Response {\n");
        ...
        {
            return this.Equals(input as EstimateGasLimit400Response);
        }

        /// <summary>
        /// Returns true if EstimateGasLimit400Response instances are equal
        /// </summary>
        /// <param name="input">Instance of EstimateGasLimit400Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EstimateGasLimit400Response input)
        {
            if (input == null)
            {
                return false;
