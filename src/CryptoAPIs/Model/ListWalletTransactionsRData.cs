...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListWalletTransactionsR_data")]
    public partial class ListWalletTransactionsRData : IEquatable<ListWalletTransactionsRData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListWalletTransactionsRData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListWalletTransactionsRData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListWalletTransactionsRData" /> class.
        /// </summary>
        ...
        public ListWalletTransactionsRData(int offset = default(int), int limit = default(int), int total = default(int), List<ListWalletTransactionsRI> items = default(List<ListWalletTransactionsRI>))
        {
            this.Offset = offset;
            this.Limit = limit;
            this.Total = total;
            ...
            if (items == null) {
                throw new ArgumentNullException("items is a required property for ListWalletTransactionsRData and cannot be null");
            }
            this.Items = items;
        }
        ...
        public List<ListWalletTransactionsRI> Items { get; set; }
        ...
        {
            return this.Equals(input as ListWalletTransactionsRData);
        }

        /// <summary>
        /// Returns true if ListWalletTransactionsRData instances are equal
        /// </summary>
        /// <param name="input">Instance of ListWalletTransactionsRData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListWalletTransactionsRData input)
        {
            if (input == null)
                return false;
