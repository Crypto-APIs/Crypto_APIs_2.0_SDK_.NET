...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListWalletTransactionsRData : IEquatable<ListWalletTransactionsRData>, IValidatableObject
    {
        ...
        public ListWalletTransactionsRData(int limit = default(int), int offset = default(int), int total = default(int), List<ListWalletTransactionsRI> items = default(List<ListWalletTransactionsRI>))
        {
            this.Limit = limit;
            this.Offset = offset;
            this.Total = total;
