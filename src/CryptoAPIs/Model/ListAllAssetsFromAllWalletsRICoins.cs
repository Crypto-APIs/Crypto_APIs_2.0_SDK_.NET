...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListAllAssetsFromAllWalletsRI_coins")]
    public partial class ListAllAssetsFromAllWalletsRICoins : IEquatable<ListAllAssetsFromAllWalletsRICoins>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllAssetsFromAllWalletsRICoins" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListAllAssetsFromAllWalletsRICoins() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllAssetsFromAllWalletsRICoins" /> class.
        /// </summary>
        ...
        public ListAllAssetsFromAllWalletsRICoins(string blockchain = default(string), string confirmedBalance = default(string), string network = default(string), string totalReceived = default(string), string totalSpent = default(string), string unit = default(string))
        {
            // to ensure "blockchain" is required (not null)
            if (blockchain == null)
            {
                throw new ArgumentNullException("blockchain is a required property for ListAllAssetsFromAllWalletsRICoins and cannot be null");
            }
            this.Blockchain = blockchain;
            // to ensure "confirmedBalance" is required (not null)
            if (confirmedBalance == null)
            {
                throw new ArgumentNullException("confirmedBalance is a required property for ListAllAssetsFromAllWalletsRICoins and cannot be null");
            }
            this.ConfirmedBalance = confirmedBalance;
            // to ensure "network" is required (not null)
            if (network == null)
            {
                throw new ArgumentNullException("network is a required property for ListAllAssetsFromAllWalletsRICoins and cannot be null");
            }
            this.Network = network;
            // to ensure "totalReceived" is required (not null)
            if (totalReceived == null)
            {
                throw new ArgumentNullException("totalReceived is a required property for ListAllAssetsFromAllWalletsRICoins and cannot be null");
            }
            this.TotalReceived = totalReceived;
            // to ensure "totalSpent" is required (not null)
            if (totalSpent == null)
            {
                throw new ArgumentNullException("totalSpent is a required property for ListAllAssetsFromAllWalletsRICoins and cannot be null");
            }
            this.TotalSpent = totalSpent;
            // to ensure "unit" is required (not null)
            if (unit == null)
            {
                throw new ArgumentNullException("unit is a required property for ListAllAssetsFromAllWalletsRICoins and cannot be null");
            }
            this.Unit = unit;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListAllAssetsFromAllWalletsRICoins {\n");
        ...
        {
            return this.Equals(input as ListAllAssetsFromAllWalletsRICoins);
        }

        /// <summary>
        /// Returns true if ListAllAssetsFromAllWalletsRICoins instances are equal
        /// </summary>
        /// <param name="input">Instance of ListAllAssetsFromAllWalletsRICoins to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListAllAssetsFromAllWalletsRICoins input)
        {
            if (input == null)
            {
                return false;
