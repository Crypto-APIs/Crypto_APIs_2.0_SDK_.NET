...
namespace CryptoAPIs.Model
{
    ...
    /// Ethereum Classic
    /// </summary>
    [DataContract(Name = "GetLastMinedBlockRIBSEC")]
    public partial class GetLastMinedBlockRIBSEC : IEquatable<GetLastMinedBlockRIBSEC>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLastMinedBlockRIBSEC" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetLastMinedBlockRIBSEC() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLastMinedBlockRIBSEC" /> class.
        /// </summary>
        ...
        public GetLastMinedBlockRIBSEC(string difficulty = default(string), string extraData = default(string), string gasLimit = default(string), string gasUsed = default(string), int minedInSeconds = default(int), string nonce = default(string), string sha3Uncles = default(string), int size = default(int), string totalDifficulty = default(string), List<string> uncles = default(List<string>))
        {
            // to ensure "difficulty" is required (not null)
            if (difficulty == null)
            {
                throw new ArgumentNullException("difficulty is a required property for GetLastMinedBlockRIBSEC and cannot be null");
            }
            this.Difficulty = difficulty;
            // to ensure "extraData" is required (not null)
            if (extraData == null)
            {
                throw new ArgumentNullException("extraData is a required property for GetLastMinedBlockRIBSEC and cannot be null");
            }
            this.ExtraData = extraData;
            // to ensure "gasLimit" is required (not null)
            if (gasLimit == null)
            {
                throw new ArgumentNullException("gasLimit is a required property for GetLastMinedBlockRIBSEC and cannot be null");
            }
            this.GasLimit = gasLimit;
            // to ensure "gasUsed" is required (not null)
            if (gasUsed == null)
            {
                throw new ArgumentNullException("gasUsed is a required property for GetLastMinedBlockRIBSEC and cannot be null");
            }
            ...
            if (nonce == null)
            {
                throw new ArgumentNullException("nonce is a required property for GetLastMinedBlockRIBSEC and cannot be null");
            }
            this.Nonce = nonce;
            // to ensure "sha3Uncles" is required (not null)
            if (sha3Uncles == null)
            {
                throw new ArgumentNullException("sha3Uncles is a required property for GetLastMinedBlockRIBSEC and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("totalDifficulty is a required property for GetLastMinedBlockRIBSEC and cannot be null");
            }
            this.TotalDifficulty = totalDifficulty;
            // to ensure "uncles" is required (not null)
            if (uncles == null)
            {
                throw new ArgumentNullException("uncles is a required property for GetLastMinedBlockRIBSEC and cannot be null");
            }
            this.Uncles = uncles;
        }
        ...
        {
            return this.Equals(input as GetLastMinedBlockRIBSEC);
        }

        /// <summary>
        /// Returns true if GetLastMinedBlockRIBSEC instances are equal
        /// </summary>
        /// <param name="input">Instance of GetLastMinedBlockRIBSEC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetLastMinedBlockRIBSEC input)
        {
            if (input == null)
            {
                return false;
