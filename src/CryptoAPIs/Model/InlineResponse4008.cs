...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4008
    /// </summary>
    [DataContract(Name = "inline_response_400_8")]
    public partial class InlineResponse4008 : IEquatable<InlineResponse4008>, IValidatableObject
    {
        ...
        public InlineResponse4008(string apiVersion = default(string), string requestId = default(string), string context = default(string), GenerateDepositAddressE400 error = default(GenerateDepositAddressE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4008 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4008 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse4008 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse4008);
        }

        /// <summary>
        /// Returns true if InlineResponse4008 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4008 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4008 input)
        {
            if (input == null)
            {
                return false;
