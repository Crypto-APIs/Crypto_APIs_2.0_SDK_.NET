...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(ListSupportedTokensE403JsonConverter))]
    [DataContract(Name = "ListSupportedTokensE403")]
    public partial class ListSupportedTokensE403 : AbstractOpenAPISchema, IEquatable<ListSupportedTokensE403>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListSupportedTokensE403" /> class
        /// with the <see cref="BannedIpAddress" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BannedIpAddress.</param>
        public ListSupportedTokensE403(BannedIpAddress actualInstance)
        {
        ...
        public ListSupportedTokensE403(EndpointNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public ListSupportedTokensE403(EndpointNotAllowedForApiKey actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public ListSupportedTokensE403(FeatureMainnetsNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListSupportedTokensE403 {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, ListSupportedTokensE403.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of ListSupportedTokensE403
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of ListSupportedTokensE403</returns>
        public static ListSupportedTokensE403 FromJson(string jsonString)
        {
            ListSupportedTokensE403 newListSupportedTokensE403 = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newListSupportedTokensE403;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newListSupportedTokensE403 = new ListSupportedTokensE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, ListSupportedTokensE403.SerializerSettings));
                }
                else
                {
                    newListSupportedTokensE403 = new ListSupportedTokensE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, ListSupportedTokensE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newListSupportedTokensE403 = new ListSupportedTokensE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, ListSupportedTokensE403.SerializerSettings));
                }
                else
                {
                    newListSupportedTokensE403 = new ListSupportedTokensE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, ListSupportedTokensE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newListSupportedTokensE403 = new ListSupportedTokensE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, ListSupportedTokensE403.SerializerSettings));
                }
                else
                {
                    newListSupportedTokensE403 = new ListSupportedTokensE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, ListSupportedTokensE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newListSupportedTokensE403 = new ListSupportedTokensE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, ListSupportedTokensE403.SerializerSettings));
                }
                else
                {
                    newListSupportedTokensE403 = new ListSupportedTokensE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, ListSupportedTokensE403.AdditionalPropertiesSerializerSettings));
                }
        ...
        {
            return this.Equals(input as ListSupportedTokensE403);
        }

        /// <summary>
        /// Returns true if ListSupportedTokensE403 instances are equal
        /// </summary>
        /// <param name="input">Instance of ListSupportedTokensE403 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListSupportedTokensE403 input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for ListSupportedTokensE403
    /// </summary>
    public class ListSupportedTokensE403JsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(ListSupportedTokensE403).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return ListSupportedTokensE403.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
