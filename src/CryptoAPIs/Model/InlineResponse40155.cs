...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40155
    /// </summary>
    [DataContract(Name = "inline_response_401_55")]
    public partial class InlineResponse40155 : IEquatable<InlineResponse40155>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40155" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40155() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40155" /> class.
        /// </summary>
        ...
        public InlineResponse40155(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListConfirmedTokensTransfersByAddressE401 error = default(ListConfirmedTokensTransfersByAddressE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40155 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40155 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40155 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40155 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40155);
        }

        /// <summary>
        /// Returns true if InlineResponse40155 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40155 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40155 input)
        {
            if (input == null)
            {
                return false;
