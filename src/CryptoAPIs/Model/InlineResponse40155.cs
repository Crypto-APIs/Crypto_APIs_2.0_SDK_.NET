...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40155 : IEquatable<InlineResponse40155>, IValidatableObject
    {
        ...
        public InlineResponse40155(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListHDWalletXPubYPubZPubUTXOsE401 error = default(ListHDWalletXPubYPubZPubUTXOsE401))
        {
