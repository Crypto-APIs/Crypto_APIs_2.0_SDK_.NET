...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(GetLastMinedBlockE403JsonConverter))]
    [DataContract(Name = "GetLastMinedBlockE403")]
    public partial class GetLastMinedBlockE403 : AbstractOpenAPISchema, IEquatable<GetLastMinedBlockE403>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLastMinedBlockE403" /> class
        /// with the <see cref="BannedIpAddress" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BannedIpAddress.</param>
        public GetLastMinedBlockE403(BannedIpAddress actualInstance)
        {
        ...
        public GetLastMinedBlockE403(EndpointNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public GetLastMinedBlockE403(EndpointNotAllowedForApiKey actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public GetLastMinedBlockE403(FeatureMainnetsNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetLastMinedBlockE403 {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, GetLastMinedBlockE403.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of GetLastMinedBlockE403
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of GetLastMinedBlockE403</returns>
        public static GetLastMinedBlockE403 FromJson(string jsonString)
        {
            GetLastMinedBlockE403 newGetLastMinedBlockE403 = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newGetLastMinedBlockE403;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newGetLastMinedBlockE403 = new GetLastMinedBlockE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, GetLastMinedBlockE403.SerializerSettings));
                }
                else
                {
                    newGetLastMinedBlockE403 = new GetLastMinedBlockE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, GetLastMinedBlockE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newGetLastMinedBlockE403 = new GetLastMinedBlockE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, GetLastMinedBlockE403.SerializerSettings));
                }
                else
                {
                    newGetLastMinedBlockE403 = new GetLastMinedBlockE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, GetLastMinedBlockE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newGetLastMinedBlockE403 = new GetLastMinedBlockE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, GetLastMinedBlockE403.SerializerSettings));
                }
                else
                {
                    newGetLastMinedBlockE403 = new GetLastMinedBlockE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, GetLastMinedBlockE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newGetLastMinedBlockE403 = new GetLastMinedBlockE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, GetLastMinedBlockE403.SerializerSettings));
                }
                else
                {
                    newGetLastMinedBlockE403 = new GetLastMinedBlockE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, GetLastMinedBlockE403.AdditionalPropertiesSerializerSettings));
                }
        ...
        {
            return this.Equals(input as GetLastMinedBlockE403);
        }

        /// <summary>
        /// Returns true if GetLastMinedBlockE403 instances are equal
        /// </summary>
        /// <param name="input">Instance of GetLastMinedBlockE403 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetLastMinedBlockE403 input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for GetLastMinedBlockE403
    /// </summary>
    public class GetLastMinedBlockE403JsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(GetLastMinedBlockE403).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return GetLastMinedBlockE403.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
