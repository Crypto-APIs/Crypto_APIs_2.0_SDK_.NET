...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Get_Address_Details_415_response")]
    public partial class GetAddressDetails415Response : IEquatable<GetAddressDetails415Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressDetails415Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetAddressDetails415Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressDetails415Response" /> class.
        /// </summary>
        ...
        public GetAddressDetails415Response(string apiVersion = default(string), string requestId = default(string), string context = default(string), UnsupportedMediaType error = default(UnsupportedMediaType))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for GetAddressDetails415Response and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for GetAddressDetails415Response and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for GetAddressDetails415Response and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAddressDetails415Response {\n");
        ...
        {
            return this.Equals(input as GetAddressDetails415Response);
        }

        /// <summary>
        /// Returns true if GetAddressDetails415Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAddressDetails415Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAddressDetails415Response input)
        {
            if (input == null)
            {
                return false;
