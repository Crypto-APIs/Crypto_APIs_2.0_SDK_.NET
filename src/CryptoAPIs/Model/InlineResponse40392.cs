...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40392
    /// </summary>
    [DataContract(Name = "inline_response_403_92")]
    public partial class InlineResponse40392 : IEquatable<InlineResponse40392>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40392" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40392() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40392" /> class.
        /// </summary>
        ...
        public InlineResponse40392(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTokensForwardingAutomationsE403 error = default(ListTokensForwardingAutomationsE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40392 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40392 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40392 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40392 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40392);
        }

        /// <summary>
        /// Returns true if InlineResponse40392 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40392 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40392 input)
        {
            if (input == null)
            {
                return false;
