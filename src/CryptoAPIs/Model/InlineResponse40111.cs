...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40111
    /// </summary>
    [DataContract(Name = "inline_response_401_11")]
    public partial class InlineResponse40111 : IEquatable<InlineResponse40111>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40111" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40111() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40111" /> class.
        /// </summary>
        ...
        public InlineResponse40111(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListXRPRippleTransactionsByAddressE401 error = default(ListXRPRippleTransactionsByAddressE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40111 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40111 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40111 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40111 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40111);
        }

        /// <summary>
        /// Returns true if InlineResponse40111 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40111 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40111 input)
        {
            if (input == null)
            {
                return false;
