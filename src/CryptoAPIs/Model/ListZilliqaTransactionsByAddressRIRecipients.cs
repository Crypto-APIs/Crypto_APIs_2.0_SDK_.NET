...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListZilliqaTransactionsByAddressRIRecipients : IEquatable<ListZilliqaTransactionsByAddressRIRecipients>, IValidatableObject
    {
        ...
        public ListZilliqaTransactionsByAddressRIRecipients(string address = default(string), string amount = default(string))
        {
            ...
            this.Address = address ?? throw new ArgumentNullException("address is a required property for ListZilliqaTransactionsByAddressRIRecipients and cannot be null");
            // to ensure "amount" is required (not null)
            this.Amount = amount ?? throw new ArgumentNullException("amount is a required property for ListZilliqaTransactionsByAddressRIRecipients and cannot be null");
        }
