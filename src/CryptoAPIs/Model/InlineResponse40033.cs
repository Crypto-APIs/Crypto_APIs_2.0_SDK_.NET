...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40033 : IEquatable<InlineResponse40033>, IValidatableObject
    {
        ...
        public InlineResponse40033(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetZilliqaBlockDetailsByBlockHashE400 error = default(GetZilliqaBlockDetailsByBlockHashE400))
        {
