...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40033
    /// </summary>
    [DataContract(Name = "inline_response_400_33")]
    public partial class InlineResponse40033 : IEquatable<InlineResponse40033>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40033" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40033() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40033" /> class.
        /// </summary>
        ...
        public InlineResponse40033(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetOmniTransactionDetailsByTransactionIDTxidE400 error = default(GetOmniTransactionDetailsByTransactionIDTxidE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40033 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40033 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40033 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40033 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40033);
        }

        /// <summary>
        /// Returns true if InlineResponse40033 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40033 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40033 input)
        {
            if (input == null)
            {
                return false;
