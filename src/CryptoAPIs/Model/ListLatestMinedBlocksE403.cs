...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(ListLatestMinedBlocksE403JsonConverter))]
    [DataContract(Name = "ListLatestMinedBlocksE403")]
    public partial class ListLatestMinedBlocksE403 : AbstractOpenAPISchema, IEquatable<ListLatestMinedBlocksE403>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListLatestMinedBlocksE403" /> class
        /// with the <see cref="BannedIpAddress" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BannedIpAddress.</param>
        public ListLatestMinedBlocksE403(BannedIpAddress actualInstance)
        {
        ...
        public ListLatestMinedBlocksE403(EndpointNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public ListLatestMinedBlocksE403(EndpointNotAllowedForApiKey actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public ListLatestMinedBlocksE403(FeatureMainnetsNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListLatestMinedBlocksE403 {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, ListLatestMinedBlocksE403.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of ListLatestMinedBlocksE403
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of ListLatestMinedBlocksE403</returns>
        public static ListLatestMinedBlocksE403 FromJson(string jsonString)
        {
            ListLatestMinedBlocksE403 newListLatestMinedBlocksE403 = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newListLatestMinedBlocksE403;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newListLatestMinedBlocksE403 = new ListLatestMinedBlocksE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, ListLatestMinedBlocksE403.SerializerSettings));
                }
                else
                {
                    newListLatestMinedBlocksE403 = new ListLatestMinedBlocksE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, ListLatestMinedBlocksE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newListLatestMinedBlocksE403 = new ListLatestMinedBlocksE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, ListLatestMinedBlocksE403.SerializerSettings));
                }
                else
                {
                    newListLatestMinedBlocksE403 = new ListLatestMinedBlocksE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, ListLatestMinedBlocksE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newListLatestMinedBlocksE403 = new ListLatestMinedBlocksE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, ListLatestMinedBlocksE403.SerializerSettings));
                }
                else
                {
                    newListLatestMinedBlocksE403 = new ListLatestMinedBlocksE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, ListLatestMinedBlocksE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newListLatestMinedBlocksE403 = new ListLatestMinedBlocksE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, ListLatestMinedBlocksE403.SerializerSettings));
                }
                else
                {
                    newListLatestMinedBlocksE403 = new ListLatestMinedBlocksE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, ListLatestMinedBlocksE403.AdditionalPropertiesSerializerSettings));
                }
        ...
        {
            return this.Equals(input as ListLatestMinedBlocksE403);
        }

        /// <summary>
        /// Returns true if ListLatestMinedBlocksE403 instances are equal
        /// </summary>
        /// <param name="input">Instance of ListLatestMinedBlocksE403 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListLatestMinedBlocksE403 input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for ListLatestMinedBlocksE403
    /// </summary>
    public class ListLatestMinedBlocksE403JsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(ListLatestMinedBlocksE403).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return ListLatestMinedBlocksE403.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
