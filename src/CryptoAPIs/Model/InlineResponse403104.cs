...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_403_104")]
    public partial class InlineResponse403104 : IEquatable<InlineResponse403104>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse403104" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse403104() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse403104" /> class.
        /// </summary>
        ...
        public InlineResponse403104(string apiVersion = default(string), string requestId = default(string), string context = default(string), EncodeXAddressE403 error = default(EncodeXAddressE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse403104 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse403104 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse403104 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse403104 {\n");
        ...
        {
            return this.Equals(input as InlineResponse403104);
        }

        /// <summary>
        /// Returns true if InlineResponse403104 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse403104 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse403104 input)
        {
            if (input == null)
            {
                return false;
