...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40181 : IEquatable<InlineResponse40181>, IValidatableObject
    {
        ...
        public InlineResponse40181(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetFeeAddressDetailsE401 error = default(GetFeeAddressDetailsE401))
        {
