...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40181
    /// </summary>
    [DataContract(Name = "inline_response_401_81")]
    public partial class InlineResponse40181 : IEquatable<InlineResponse40181>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40181" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40181() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40181" /> class.
        /// </summary>
        ...
        public InlineResponse40181(string apiVersion = default(string), string requestId = default(string), string context = default(string), ActivateBlockchainEventSubscriptionE401 error = default(ActivateBlockchainEventSubscriptionE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40181 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40181 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40181 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40181 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40181);
        }

        /// <summary>
        /// Returns true if InlineResponse40181 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40181 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40181 input)
        {
            if (input == null)
            {
                return false;
