...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40032
    /// </summary>
    [DataContract(Name = "inline_response_400_32")]
    public partial class InlineResponse40032 : IEquatable<InlineResponse40032>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40032" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40032() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40032" /> class.
        /// </summary>
        ...
        public InlineResponse40032(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetOmniTransactionDetailsByTransactionIDTxidE400 error = default(GetOmniTransactionDetailsByTransactionIDTxidE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40032 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40032 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40032 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40032 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40032);
        }

        /// <summary>
        /// Returns true if InlineResponse40032 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40032 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40032 input)
        {
            if (input == null)
            {
                return false;
