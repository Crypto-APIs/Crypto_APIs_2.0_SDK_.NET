...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40032 : IEquatable<InlineResponse40032>, IValidatableObject
    {
        ...
        public InlineResponse40032(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetXRPRippleBlockDetailsByBlockHashE400 error = default(GetXRPRippleBlockDetailsByBlockHashE400))
        {
