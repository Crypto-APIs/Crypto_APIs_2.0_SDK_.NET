...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40385
    /// </summary>
    [DataContract(Name = "inline_response_403_85")]
    public partial class InlineResponse40385 : IEquatable<InlineResponse40385>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40385" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40385() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40385" /> class.
        /// </summary>
        ...
        public InlineResponse40385(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetBlockDetailsByBlockHashFromCallbackE403 error = default(GetBlockDetailsByBlockHashFromCallbackE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40385 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40385 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40385 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40385 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40385);
        }

        /// <summary>
        /// Returns true if InlineResponse40385 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40385 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40385 input)
        {
            if (input == null)
            {
                return false;
