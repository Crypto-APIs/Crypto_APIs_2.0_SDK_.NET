...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40385 : IEquatable<InlineResponse40385>, IValidatableObject
    {
        ...
        public InlineResponse40385(string apiVersion = default(string), string requestId = default(string), string context = default(string), BroadcastLocallySignedTransactionE403 error = default(BroadcastLocallySignedTransactionE403))
        {
