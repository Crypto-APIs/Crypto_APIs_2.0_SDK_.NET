...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40131
    /// </summary>
    [DataContract(Name = "inline_response_401_31")]
    public partial class InlineResponse40131 : IEquatable<InlineResponse40131>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40131" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40131() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40131" /> class.
        /// </summary>
        ...
        public InlineResponse40131(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetXRPRippleBlockDetailsByBlockHashE401 error = default(GetXRPRippleBlockDetailsByBlockHashE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40131 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40131 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40131 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40131 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40131);
        }

        /// <summary>
        /// Returns true if InlineResponse40131 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40131 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40131 input)
        {
            if (input == null)
            {
                return false;
