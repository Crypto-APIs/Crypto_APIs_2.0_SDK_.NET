...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40131 : IEquatable<InlineResponse40131>, IValidatableObject
    {
        ...
        public InlineResponse40131(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetBlockDetailsByBlockHashE401 error = default(GetBlockDetailsByBlockHashE401))
        {
