...
namespace CryptoAPIs.Model
{
    ...
    /// NewBlock401Response
    /// </summary>
    [DataContract(Name = "New_Block_401_response")]
    public partial class NewBlock401Response : IEquatable<NewBlock401Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewBlock401Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewBlock401Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewBlock401Response" /> class.
        /// </summary>
        ...
        public NewBlock401Response(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewBlockE401 error = default(NewBlockE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for NewBlock401Response and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for NewBlock401Response and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for NewBlock401Response and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewBlock401Response {\n");
        ...
        {
            return this.Equals(input as NewBlock401Response);
        }

        /// <summary>
        /// Returns true if NewBlock401Response instances are equal
        /// </summary>
        /// <param name="input">Instance of NewBlock401Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewBlock401Response input)
        {
            if (input == null)
            {
                return false;
