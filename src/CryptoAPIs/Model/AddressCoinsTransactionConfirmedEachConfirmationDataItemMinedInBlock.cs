...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AddressCoinsTransactionConfirmedEachConfirmation_data_item_minedInBlock")]
    public partial class AddressCoinsTransactionConfirmedEachConfirmationDataItemMinedInBlock : IEquatable<AddressCoinsTransactionConfirmedEachConfirmationDataItemMinedInBlock>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressCoinsTransactionConfirmedEachConfirmationDataItemMinedInBlock" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AddressCoinsTransactionConfirmedEachConfirmationDataItemMinedInBlock() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressCoinsTransactionConfirmedEachConfirmationDataItemMinedInBlock" /> class.
        /// </summary>
        ...
        public AddressCoinsTransactionConfirmedEachConfirmationDataItemMinedInBlock(int height = default(int), string hash = default(string), int timestamp = default(int))
        {
            this.Height = height;
        ...
        {
            return this.Equals(input as AddressCoinsTransactionConfirmedEachConfirmationDataItemMinedInBlock);
        }

        /// <summary>
        /// Returns true if AddressCoinsTransactionConfirmedEachConfirmationDataItemMinedInBlock instances are equal
        /// </summary>
        /// <param name="input">Instance of AddressCoinsTransactionConfirmedEachConfirmationDataItemMinedInBlock to be compared</param>
        /// <returns>Boolean</returns>
