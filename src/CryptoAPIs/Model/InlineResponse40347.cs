...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40347 : IEquatable<InlineResponse40347>, IValidatableObject
    {
        ...
        public InlineResponse40347(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetHDWalletXPubYPubZPubDetailsE403 error = default(GetHDWalletXPubYPubZPubDetailsE403))
        {
