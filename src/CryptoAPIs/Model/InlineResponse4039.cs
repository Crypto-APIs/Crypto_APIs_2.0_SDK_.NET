...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4039
    /// </summary>
    [DataContract(Name = "inline_response_403_9")]
    public partial class InlineResponse4039 : IEquatable<InlineResponse4039>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4039" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse4039() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4039" /> class.
        /// </summary>
        ...
        public InlineResponse4039(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetZilliqaTransactionDetailsByTransactionIDE403 error = default(GetZilliqaTransactionDetailsByTransactionIDE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4039 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4039 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse4039 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse4039 {\n");
        ...
        {
            return this.Equals(input as InlineResponse4039);
        }

        /// <summary>
        /// Returns true if InlineResponse4039 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4039 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4039 input)
        {
            if (input == null)
            {
                return false;
