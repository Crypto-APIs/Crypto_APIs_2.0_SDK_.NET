...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DecodeRawTransactionHexRISZ_scriptPubKey")]
    public partial class DecodeRawTransactionHexRISZScriptPubKey : IEquatable<DecodeRawTransactionHexRISZScriptPubKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISZScriptPubKey" /> class.
        /// </summary>
        ...
        public DecodeRawTransactionHexRISZScriptPubKey(string address = default(string), string asm = default(string), string hex = default(string), string type = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DecodeRawTransactionHexRISZScriptPubKey {\n");
        ...
        {
            return this.Equals(input as DecodeRawTransactionHexRISZScriptPubKey);
        }

        /// <summary>
        /// Returns true if DecodeRawTransactionHexRISZScriptPubKey instances are equal
        /// </summary>
        /// <param name="input">Instance of DecodeRawTransactionHexRISZScriptPubKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecodeRawTransactionHexRISZScriptPubKey input)
        {
            if (input == null)
            {
                return false;
