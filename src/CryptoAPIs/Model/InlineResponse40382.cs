...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40382 : IEquatable<InlineResponse40382>, IValidatableObject
    {
        ...
        public InlineResponse40382(string apiVersion = default(string), string requestId = default(string), string context = default(string), DeleteAutomaticTokensForwardingE403 error = default(DeleteAutomaticTokensForwardingE403))
        {
