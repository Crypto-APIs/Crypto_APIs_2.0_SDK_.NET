...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40382
    /// </summary>
    [DataContract(Name = "inline_response_403_82")]
    public partial class InlineResponse40382 : IEquatable<InlineResponse40382>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40382" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40382() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40382" /> class.
        /// </summary>
        ...
        public InlineResponse40382(string apiVersion = default(string), string requestId = default(string), string context = default(string), DeleteBlockchainEventSubscriptionE403 error = default(DeleteBlockchainEventSubscriptionE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40382 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40382 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40382 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40382 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40382);
        }

        /// <summary>
        /// Returns true if InlineResponse40382 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40382 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40382 input)
        {
            if (input == null)
            {
                return false;
