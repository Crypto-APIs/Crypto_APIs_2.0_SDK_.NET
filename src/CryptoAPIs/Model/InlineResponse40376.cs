...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40376 : IEquatable<InlineResponse40376>, IValidatableObject
    {
        ...
        public InlineResponse40376(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateAutomaticCoinsForwardingE403 error = default(CreateAutomaticCoinsForwardingE403))
        {
