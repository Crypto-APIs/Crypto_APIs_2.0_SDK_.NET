...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40376
    /// </summary>
    [DataContract(Name = "inline_response_403_76")]
    public partial class InlineResponse40376 : IEquatable<InlineResponse40376>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40376" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40376() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40376" /> class.
        /// </summary>
        ...
        public InlineResponse40376(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedCoinsTransactionsAndEachConfirmationE403 error = default(NewConfirmedCoinsTransactionsAndEachConfirmationE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40376 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40376 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40376 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40376 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40376);
        }

        /// <summary>
        /// Returns true if InlineResponse40376 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40376 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40376 input)
        {
            if (input == null)
            {
                return false;
