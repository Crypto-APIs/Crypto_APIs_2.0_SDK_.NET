...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Encode_X_Address_403_response")]
    public partial class EncodeXAddress403Response : IEquatable<EncodeXAddress403Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EncodeXAddress403Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EncodeXAddress403Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EncodeXAddress403Response" /> class.
        /// </summary>
        ...
        public EncodeXAddress403Response(string apiVersion = default(string), string requestId = default(string), string context = default(string), EncodeXAddressE403 error = default(EncodeXAddressE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for EncodeXAddress403Response and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for EncodeXAddress403Response and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for EncodeXAddress403Response and cannot be null");
            }
            this.Error = error;
        ...
        public EncodeXAddressE403 Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EncodeXAddress403Response {\n");
        ...
        {
            return this.Equals(input as EncodeXAddress403Response);
        }

        /// <summary>
        /// Returns true if EncodeXAddress403Response instances are equal
        /// </summary>
        /// <param name="input">Instance of EncodeXAddress403Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EncodeXAddress403Response input)
        {
            if (input == null)
            {
                return false;
