...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40381 : IEquatable<InlineResponse40381>, IValidatableObject
    {
        ...
        public InlineResponse40381(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetFeeAddressDetailsE403 error = default(GetFeeAddressDetailsE403))
        {
