...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40381
    /// </summary>
    [DataContract(Name = "inline_response_403_81")]
    public partial class InlineResponse40381 : IEquatable<InlineResponse40381>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40381" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40381() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40381" /> class.
        /// </summary>
        ...
        public InlineResponse40381(string apiVersion = default(string), string requestId = default(string), string context = default(string), ActivateBlockchainEventSubscriptionE403 error = default(ActivateBlockchainEventSubscriptionE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40381 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40381 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40381 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40381 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40381);
        }

        /// <summary>
        /// Returns true if InlineResponse40381 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40381 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40381 input)
        {
            if (input == null)
            {
                return false;
