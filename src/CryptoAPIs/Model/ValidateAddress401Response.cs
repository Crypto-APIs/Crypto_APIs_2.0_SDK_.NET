...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Validate_Address_401_response")]
    public partial class ValidateAddress401Response : IEquatable<ValidateAddress401Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidateAddress401Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ValidateAddress401Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidateAddress401Response" /> class.
        /// </summary>
        ...
        public ValidateAddress401Response(string apiVersion = default(string), string requestId = default(string), string context = default(string), ValidateAddressE401 error = default(ValidateAddressE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for ValidateAddress401Response and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for ValidateAddress401Response and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for ValidateAddress401Response and cannot be null");
            }
            this.Error = error;
        ...
        public ValidateAddressE401 Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ValidateAddress401Response {\n");
        ...
        {
            return this.Equals(input as ValidateAddress401Response);
        }

        /// <summary>
        /// Returns true if ValidateAddress401Response instances are equal
        /// </summary>
        /// <param name="input">Instance of ValidateAddress401Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValidateAddress401Response input)
        {
            if (input == null)
            {
                return false;
