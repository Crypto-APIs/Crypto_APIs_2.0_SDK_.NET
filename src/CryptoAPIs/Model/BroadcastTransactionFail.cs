...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BroadcastTransactionFail")]
    public partial class BroadcastTransactionFail : IEquatable<BroadcastTransactionFail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BroadcastTransactionFail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BroadcastTransactionFail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BroadcastTransactionFail" /> class.
        /// </summary>
        ...
        public BroadcastTransactionFail(string apiVersion = default(string), string referenceId = default(string), string idempotencyKey = default(string), BroadcastTransactionFailData data = default(BroadcastTransactionFailData))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for BroadcastTransactionFail and cannot be null");
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for BroadcastTransactionFail and cannot be null");
            // to ensure "idempotencyKey" is required (not null)
            this.IdempotencyKey = idempotencyKey ?? throw new ArgumentNullException("idempotencyKey is a required property for BroadcastTransactionFail and cannot be null");
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for BroadcastTransactionFail and cannot be null");
        }
        ...
        public BroadcastTransactionFailData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BroadcastTransactionFail {\n");
        ...
        {
            return this.Equals(input as BroadcastTransactionFail);
        }

        /// <summary>
        /// Returns true if BroadcastTransactionFail instances are equal
        /// </summary>
        /// <param name="input">Instance of BroadcastTransactionFail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BroadcastTransactionFail input)
        {
            if (input == null)
                return false;
