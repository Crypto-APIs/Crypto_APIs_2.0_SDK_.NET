...
namespace CryptoAPIs.Model
{
    ...
    /// EncodeXAddressR
    /// </summary>
    [DataContract(Name = "EncodeX-AddressR")]
    public partial class EncodeXAddressR : IEquatable<EncodeXAddressR>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EncodeXAddressR" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EncodeXAddressR() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EncodeXAddressR" /> class.
        /// </summary>
        ...
        public EncodeXAddressR(string apiVersion = default(string), string requestId = default(string), string context = default(string), EncodeXAddressRData data = default(EncodeXAddressRData))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for EncodeXAddressR and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for EncodeXAddressR and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for EncodeXAddressR and cannot be null");
            }
            this.Data = data;
        ...
        public EncodeXAddressRData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EncodeXAddressR {\n");
        ...
        {
            return this.Equals(input as EncodeXAddressR);
        }

        /// <summary>
        /// Returns true if EncodeXAddressR instances are equal
        /// </summary>
        /// <param name="input">Instance of EncodeXAddressR to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EncodeXAddressR input)
        {
            if (input == null)
            {
                return false;
