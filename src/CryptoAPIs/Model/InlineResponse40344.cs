...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40344 : IEquatable<InlineResponse40344>, IValidatableObject
    {
        ...
        public InlineResponse40344(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetTransactionRequestDetailsE403 error = default(GetTransactionRequestDetailsE403))
        {
