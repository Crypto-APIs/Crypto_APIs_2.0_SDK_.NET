...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40344
    /// </summary>
    [DataContract(Name = "inline_response_403_44")]
    public partial class InlineResponse40344 : IEquatable<InlineResponse40344>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40344" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40344() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40344" /> class.
        /// </summary>
        ...
        public InlineResponse40344(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListOmniTransactionsByBlockHashE403 error = default(ListOmniTransactionsByBlockHashE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40344 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40344 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40344 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40344 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40344);
        }

        /// <summary>
        /// Returns true if InlineResponse40344 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40344 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40344 input)
        {
            if (input == null)
            {
                return false;
