...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetBlockDetailsByBlockHashFromCallbackRIBS : AbstractOpenAPISchema, IEquatable<GetBlockDetailsByBlockHashFromCallbackRIBS>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHashFromCallbackRIBS" /> class
        /// with the <see cref="GetBlockDetailsByBlockHashFromCallbackRIBST" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of GetBlockDetailsByBlockHashFromCallbackRIBST.</param>
        public GetBlockDetailsByBlockHashFromCallbackRIBS(GetBlockDetailsByBlockHashFromCallbackRIBST actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                ...
                else if (value.GetType() == typeof(GetBlockDetailsByBlockHashFromCallbackRIBST))
                {
                    this._actualInstance = value;
                }
        ...
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of GetBlockDetailsByBlockHashFromCallbackRIBST</returns>
        public GetBlockDetailsByBlockHashFromCallbackRIBST GetGetBlockDetailsByBlockHashFromCallbackRIBST()
        {
            return (GetBlockDetailsByBlockHashFromCallbackRIBST)this.ActualInstance;
        }
        ...
        public static GetBlockDetailsByBlockHashFromCallbackRIBS FromJson(string jsonString)
        {
            ...
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(GetBlockDetailsByBlockHashFromCallbackRIBST).GetProperty("AdditionalProperties") == null)
                {
                    newGetBlockDetailsByBlockHashFromCallbackRIBS = new GetBlockDetailsByBlockHashFromCallbackRIBS(JsonConvert.DeserializeObject<GetBlockDetailsByBlockHashFromCallbackRIBST>(jsonString, GetBlockDetailsByBlockHashFromCallbackRIBS.SerializerSettings));
                }
                else
                {
                    newGetBlockDetailsByBlockHashFromCallbackRIBS = new GetBlockDetailsByBlockHashFromCallbackRIBS(JsonConvert.DeserializeObject<GetBlockDetailsByBlockHashFromCallbackRIBST>(jsonString, GetBlockDetailsByBlockHashFromCallbackRIBS.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("GetBlockDetailsByBlockHashFromCallbackRIBST");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into GetBlockDetailsByBlockHashFromCallbackRIBST: {1}", jsonString, exception.ToString()));
            }
