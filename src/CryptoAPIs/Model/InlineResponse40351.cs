...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40351 : IEquatable<InlineResponse40351>, IValidatableObject
    {
        ...
        public InlineResponse40351(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetHDWalletXPubYPubZPubDetailsE403 error = default(GetHDWalletXPubYPubZPubDetailsE403))
        {
