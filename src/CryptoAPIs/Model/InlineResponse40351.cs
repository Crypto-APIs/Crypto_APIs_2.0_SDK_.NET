...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40351
    /// </summary>
    [DataContract(Name = "inline_response_403_51")]
    public partial class InlineResponse40351 : IEquatable<InlineResponse40351>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40351" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40351() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40351" /> class.
        /// </summary>
        ...
        public InlineResponse40351(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListInternalTransactionsByAddressE403 error = default(ListInternalTransactionsByAddressE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40351 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40351 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40351 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40351 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40351);
        }

        /// <summary>
        /// Returns true if InlineResponse40351 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40351 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40351 input)
        {
            if (input == null)
            {
                return false;
