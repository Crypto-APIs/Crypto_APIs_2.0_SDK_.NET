...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40173 : IEquatable<InlineResponse40173>, IValidatableObject
    {
        ...
        public InlineResponse40173(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedCoinsTransactionsE401 error = default(NewConfirmedCoinsTransactionsE401))
        {
