...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40173
    /// </summary>
    [DataContract(Name = "inline_response_401_73")]
    public partial class InlineResponse40173 : IEquatable<InlineResponse40173>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40173" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40173() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40173" /> class.
        /// </summary>
        ...
        public InlineResponse40173(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedInternalTransactionsE401 error = default(NewConfirmedInternalTransactionsE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40173 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40173 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40173 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40173 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40173);
        }

        /// <summary>
        /// Returns true if InlineResponse40173 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40173 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40173 input)
        {
            if (input == null)
            {
                return false;
