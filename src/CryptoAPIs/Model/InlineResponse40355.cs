...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40355
    /// </summary>
    [DataContract(Name = "inline_response_403_55")]
    public partial class InlineResponse40355 : IEquatable<InlineResponse40355>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40355" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40355() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40355" /> class.
        /// </summary>
        ...
        public InlineResponse40355(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListConfirmedTokensTransfersByAddressE403 error = default(ListConfirmedTokensTransfersByAddressE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40355 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40355 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40355 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40355 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40355);
        }

        /// <summary>
        /// Returns true if InlineResponse40355 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40355 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40355 input)
        {
            if (input == null)
            {
                return false;
