...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40355 : IEquatable<InlineResponse40355>, IValidatableObject
    {
        ...
        public InlineResponse40355(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListHDWalletXPubYPubZPubUTXOsE403 error = default(ListHDWalletXPubYPubZPubUTXOsE403))
        {
