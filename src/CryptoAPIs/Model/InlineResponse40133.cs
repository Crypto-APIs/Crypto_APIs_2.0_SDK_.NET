...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40133 : IEquatable<InlineResponse40133>, IValidatableObject
    {
        ...
        public InlineResponse40133(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetZilliqaBlockDetailsByBlockHashE401 error = default(GetZilliqaBlockDetailsByBlockHashE401))
        {
