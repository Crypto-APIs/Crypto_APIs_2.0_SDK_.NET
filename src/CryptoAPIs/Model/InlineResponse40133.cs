...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40133
    /// </summary>
    [DataContract(Name = "inline_response_401_33")]
    public partial class InlineResponse40133 : IEquatable<InlineResponse40133>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40133" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40133() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40133" /> class.
        /// </summary>
        ...
        public InlineResponse40133(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetOmniTransactionDetailsByTransactionIDTxidE401 error = default(GetOmniTransactionDetailsByTransactionIDTxidE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40133 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40133 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40133 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40133 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40133);
        }

        /// <summary>
        /// Returns true if InlineResponse40133 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40133 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40133 input)
        {
            if (input == null)
            {
                return false;
