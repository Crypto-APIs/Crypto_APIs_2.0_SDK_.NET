...
namespace CryptoAPIs.Model
{
    ...
    /// TransactionMined
    /// </summary>
    [DataContract(Name = "TransactionMined")]
    public partial class TransactionMined : IEquatable<TransactionMined>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionMined" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionMined() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionMined" /> class.
        /// </summary>
        ...
        public TransactionMined(string apiVersion = default(string), string referenceId = default(string), string idempotencyKey = default(string), TransactionMinedData data = default(TransactionMinedData))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for TransactionMined and cannot be null");
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for TransactionMined and cannot be null");
            // to ensure "idempotencyKey" is required (not null)
            this.IdempotencyKey = idempotencyKey ?? throw new ArgumentNullException("idempotencyKey is a required property for TransactionMined and cannot be null");
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for TransactionMined and cannot be null");
        }
        ...
        public TransactionMinedData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionMined {\n");
        ...
        {
            return this.Equals(input as TransactionMined);
        }

        /// <summary>
        /// Returns true if TransactionMined instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionMined to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionMined input)
        {
            if (input == null)
                return false;
