...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40178
    /// </summary>
    [DataContract(Name = "inline_response_401_78")]
    public partial class InlineResponse40178 : IEquatable<InlineResponse40178>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40178" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40178() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40178" /> class.
        /// </summary>
        ...
        public InlineResponse40178(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTokensForwardingAutomationsE401 error = default(ListTokensForwardingAutomationsE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40178 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40178 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40178 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40178 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40178);
        }

        /// <summary>
        /// Returns true if InlineResponse40178 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40178 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40178 input)
        {
            if (input == null)
            {
                return false;
