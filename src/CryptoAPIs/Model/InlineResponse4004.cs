...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4004
    /// </summary>
    [DataContract(Name = "inline_response_400_4")]
    public partial class InlineResponse4004 : IEquatable<InlineResponse4004>, IValidatableObject
    {
        ...
        public InlineResponse4004(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetTransactionDetailsByTransactionIDE400 error = default(GetTransactionDetailsByTransactionIDE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4004 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4004 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse4004 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse4004);
        }

        /// <summary>
        /// Returns true if InlineResponse4004 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4004 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4004 input)
        {
            if (input == null)
            {
                return false;
