...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListOmniTransactionsByBlockHeightRData : IEquatable<ListOmniTransactionsByBlockHeightRData>, IValidatableObject
    {
        ...
        public ListOmniTransactionsByBlockHeightRData(int limit = default(int), int offset = default(int), int total = default(int), List<ListOmniTransactionsByBlockHeightRI> items = default(List<ListOmniTransactionsByBlockHeightRI>))
        {
            this.Limit = limit;
            this.Offset = offset;
            this.Total = total;
