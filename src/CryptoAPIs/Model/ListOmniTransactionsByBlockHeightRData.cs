...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListOmniTransactionsByBlockHeightR_data")]
    public partial class ListOmniTransactionsByBlockHeightRData : IEquatable<ListOmniTransactionsByBlockHeightRData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListOmniTransactionsByBlockHeightRData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListOmniTransactionsByBlockHeightRData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListOmniTransactionsByBlockHeightRData" /> class.
        /// </summary>
        ...
        public ListOmniTransactionsByBlockHeightRData(int offset = default(int), int limit = default(int), int total = default(int), List<ListOmniTransactionsByBlockHeightRI> items = default(List<ListOmniTransactionsByBlockHeightRI>))
        {
            this.Offset = offset;
            this.Limit = limit;
            this.Total = total;
            // to ensure "items" is required (not null)
            this.Items = items ?? throw new ArgumentNullException("items is a required property for ListOmniTransactionsByBlockHeightRData and cannot be null");
        }
        ...
        public List<ListOmniTransactionsByBlockHeightRI> Items { get; set; }
        ...
        {
            return this.Equals(input as ListOmniTransactionsByBlockHeightRData);
        }

        /// <summary>
        /// Returns true if ListOmniTransactionsByBlockHeightRData instances are equal
        /// </summary>
        /// <param name="input">Instance of ListOmniTransactionsByBlockHeightRData to be compared</param>
        /// <returns>Boolean</returns>
