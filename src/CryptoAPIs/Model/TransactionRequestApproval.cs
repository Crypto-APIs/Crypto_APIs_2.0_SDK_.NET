...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransactionRequestApproval")]
    public partial class TransactionRequestApproval : IEquatable<TransactionRequestApproval>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionRequestApproval" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionRequestApproval() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionRequestApproval" /> class.
        /// </summary>
        ...
        public TransactionRequestApproval(string apiVersion = default(string), string referenceId = default(string), string idempotencyKey = default(string), TransactionRequestApprovalData data = default(TransactionRequestApprovalData))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for TransactionRequestApproval and cannot be null");
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for TransactionRequestApproval and cannot be null");
            // to ensure "idempotencyKey" is required (not null)
            this.IdempotencyKey = idempotencyKey ?? throw new ArgumentNullException("idempotencyKey is a required property for TransactionRequestApproval and cannot be null");
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for TransactionRequestApproval and cannot be null");
        }
        ...
        public TransactionRequestApprovalData Data { get; set; }
        ...
        {
            return this.Equals(input as TransactionRequestApproval);
        }

        /// <summary>
        /// Returns true if TransactionRequestApproval instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionRequestApproval to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionRequestApproval input)
        {
            if (input == null)
                return false;
