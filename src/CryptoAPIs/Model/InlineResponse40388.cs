...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40388 : IEquatable<InlineResponse40388>, IValidatableObject
    {
        ...
        public InlineResponse40388(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetExchangeRateByAssetsIDsE403 error = default(GetExchangeRateByAssetsIDsE403))
        {
