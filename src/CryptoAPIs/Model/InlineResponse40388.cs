...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40388
    /// </summary>
    [DataContract(Name = "inline_response_403_88")]
    public partial class InlineResponse40388 : IEquatable<InlineResponse40388>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40388" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40388() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40388" /> class.
        /// </summary>
        ...
        public InlineResponse40388(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedInternalTransactionsAndEachConfirmationE403 error = default(NewConfirmedInternalTransactionsAndEachConfirmationE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40388 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40388 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40388 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40388 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40388);
        }

        /// <summary>
        /// Returns true if InlineResponse40388 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40388 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40388 input)
        {
            if (input == null)
            {
                return false;
