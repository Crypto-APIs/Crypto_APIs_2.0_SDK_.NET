...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40128 : IEquatable<InlineResponse40128>, IValidatableObject
    {
        ...
        public InlineResponse40128(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetXRPRippleBlockDetailsByBlockHeightE401 error = default(GetXRPRippleBlockDetailsByBlockHeightE401))
        {
