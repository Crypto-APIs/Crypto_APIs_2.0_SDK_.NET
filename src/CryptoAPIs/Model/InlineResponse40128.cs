...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40128
    /// </summary>
    [DataContract(Name = "inline_response_401_28")]
    public partial class InlineResponse40128 : IEquatable<InlineResponse40128>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40128" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40128() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40128" /> class.
        /// </summary>
        ...
        public InlineResponse40128(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListUnconfirmedOmniTransactionsByPropertyIDE401 error = default(ListUnconfirmedOmniTransactionsByPropertyIDE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40128 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40128 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40128 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40128 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40128);
        }

        /// <summary>
        /// Returns true if InlineResponse40128 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40128 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40128 input)
        {
            if (input == null)
            {
                return false;
