...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40122 : IEquatable<InlineResponse40122>, IValidatableObject
    {
        ...
        public InlineResponse40122(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListZilliqaTransactionsByBlockHashE401 error = default(ListZilliqaTransactionsByBlockHashE401))
        {
