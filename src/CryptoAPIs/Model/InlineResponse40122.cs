...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40122
    /// </summary>
    [DataContract(Name = "inline_response_401_22")]
    public partial class InlineResponse40122 : IEquatable<InlineResponse40122>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40122" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40122() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40122" /> class.
        /// </summary>
        ...
        public InlineResponse40122(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListZilliqaTransactionsByBlockHeightE401 error = default(ListZilliqaTransactionsByBlockHeightE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40122 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40122 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40122 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40122 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40122);
        }

        /// <summary>
        /// Returns true if InlineResponse40122 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40122 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40122 input)
        {
            if (input == null)
            {
                return false;
