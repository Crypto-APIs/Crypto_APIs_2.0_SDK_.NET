...
namespace CryptoAPIs.Model
{
    ...
    /// Dogecoin
    /// </summary>
    [DataContract(Name = "GetTransactionDetailsByTransactionIDRIBSD")]
    public partial class GetTransactionDetailsByTransactionIDRIBSD : IEquatable<GetTransactionDetailsByTransactionIDRIBSD>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDRIBSD" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetTransactionDetailsByTransactionIDRIBSD() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDRIBSD" /> class.
        /// </summary>
        ...
        public GetTransactionDetailsByTransactionIDRIBSD(long locktime = default(long), int size = default(int), int version = default(int), List<GetTransactionDetailsByTransactionIDRIBSDVinInner> vin = default(List<GetTransactionDetailsByTransactionIDRIBSDVinInner>), List<GetTransactionDetailsByTransactionIDRIBSDVoutInner> vout = default(List<GetTransactionDetailsByTransactionIDRIBSDVoutInner>))
        {
            ...
            if (vin == null)
            {
                throw new ArgumentNullException("vin is a required property for GetTransactionDetailsByTransactionIDRIBSD and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null)
            {
                throw new ArgumentNullException("vout is a required property for GetTransactionDetailsByTransactionIDRIBSD and cannot be null");
            }
            this.Vout = vout;
        }
        ...
        public List<GetTransactionDetailsByTransactionIDRIBSDVinInner> Vin { get; set; }
        ...
        {
            return this.Equals(input as GetTransactionDetailsByTransactionIDRIBSD);
        }

        /// <summary>
        /// Returns true if GetTransactionDetailsByTransactionIDRIBSD instances are equal
        /// </summary>
        /// <param name="input">Instance of GetTransactionDetailsByTransactionIDRIBSD to be compared</param>
        /// <returns>Boolean</returns>
