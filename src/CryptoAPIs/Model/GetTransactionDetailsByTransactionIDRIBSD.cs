...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetTransactionDetailsByTransactionIDRIBSD : IEquatable<GetTransactionDetailsByTransactionIDRIBSD>, IValidatableObject
    {
        ...
        public GetTransactionDetailsByTransactionIDRIBSD(int locktime = default(int), int size = default(int), int version = default(int), List<GetTransactionDetailsByTransactionIDRIBSDVin> vin = default(List<GetTransactionDetailsByTransactionIDRIBSDVin>), List<GetTransactionDetailsByTransactionIDRIBSDVout> vout = default(List<GetTransactionDetailsByTransactionIDRIBSDVout>))
        {
            this.Locktime = locktime;
            this.Size = size;
            this.Version = version;
            // to ensure "vin" is required (not null)
            this.Vin = vin ?? throw new ArgumentNullException("vin is a required property for GetTransactionDetailsByTransactionIDRIBSD and cannot be null");
            // to ensure "vout" is required (not null)
            this.Vout = vout ?? throw new ArgumentNullException("vout is a required property for GetTransactionDetailsByTransactionIDRIBSD and cannot be null");
        }
        ...
        public List<GetTransactionDetailsByTransactionIDRIBSDVin> Vin { get; set; }
