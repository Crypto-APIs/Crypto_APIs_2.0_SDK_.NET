...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConfirmedInternalTransactionForCertainAmountOrHigher_data_item")]
    public partial class ConfirmedInternalTransactionForCertainAmountOrHigherDataItem : IEquatable<ConfirmedInternalTransactionForCertainAmountOrHigherDataItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfirmedInternalTransactionForCertainAmountOrHigherDataItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConfirmedInternalTransactionForCertainAmountOrHigherDataItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfirmedInternalTransactionForCertainAmountOrHigherDataItem" /> class.
        /// </summary>
        /// <param name="blockchain">Represents the specific blockchain protocol name, e.g. Ethereum, Bitcoin, etc. (required).</param>
        /// <param name="network">Represents the name of the blockchain network used; blockchain networks are usually identical as technology and software, but they differ in data, e.g. - \&quot;mainnet\&quot; is the live network with actual data while networks like \&quot;testnet\&quot;, \&quot;ropsten\&quot;,\&quot;mordor\&quot; are test networks. (required).</param>
        ...
        public ConfirmedInternalTransactionForCertainAmountOrHigherDataItem(string blockchain = default(string), string network = default(string), string address = default(string), AddressInternalTransactionConfirmedDataItemMinedInBlock minedInBlock = default(AddressInternalTransactionConfirmedDataItemMinedInBlock), string parentTransactionId = default(string), string operationId = default(string), string amount = default(string), string unit = default(string))
        {
            // to ensure "blockchain" is required (not null)
            if (blockchain == null)
            {
                throw new ArgumentNullException("blockchain is a required property for ConfirmedInternalTransactionForCertainAmountOrHigherDataItem and cannot be null");
            }
            this.Blockchain = blockchain;
            // to ensure "network" is required (not null)
            if (network == null)
            {
                throw new ArgumentNullException("network is a required property for ConfirmedInternalTransactionForCertainAmountOrHigherDataItem and cannot be null");
            }
            this.Network = network;
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for ConfirmedInternalTransactionForCertainAmountOrHigherDataItem and cannot be null");
            }
            this.Address = address;
            // to ensure "minedInBlock" is required (not null)
            if (minedInBlock == null)
            {
                throw new ArgumentNullException("minedInBlock is a required property for ConfirmedInternalTransactionForCertainAmountOrHigherDataItem and cannot be null");
            }
            this.MinedInBlock = minedInBlock;
            // to ensure "parentTransactionId" is required (not null)
            if (parentTransactionId == null)
            {
                throw new ArgumentNullException("parentTransactionId is a required property for ConfirmedInternalTransactionForCertainAmountOrHigherDataItem and cannot be null");
            }
            this.ParentTransactionId = parentTransactionId;
            // to ensure "operationId" is required (not null)
            if (operationId == null)
            {
                throw new ArgumentNullException("operationId is a required property for ConfirmedInternalTransactionForCertainAmountOrHigherDataItem and cannot be null");
            }
            this.OperationId = operationId;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for ConfirmedInternalTransactionForCertainAmountOrHigherDataItem and cannot be null");
            }
            this.Amount = amount;
            // to ensure "unit" is required (not null)
            if (unit == null)
            {
                throw new ArgumentNullException("unit is a required property for ConfirmedInternalTransactionForCertainAmountOrHigherDataItem and cannot be null");
            }
            this.Unit = unit;
        }
        ...
        /// </summary>
        /// <value>Represents the name of the blockchain network used; blockchain networks are usually identical as technology and software, but they differ in data, e.g. - \&quot;mainnet\&quot; is the live network with actual data while networks like \&quot;testnet\&quot;, \&quot;ropsten\&quot;,\&quot;mordor\&quot; are test networks.</value>
        ...
        {
            return this.Equals(input as ConfirmedInternalTransactionForCertainAmountOrHigherDataItem);
        }

        /// <summary>
        /// Returns true if ConfirmedInternalTransactionForCertainAmountOrHigherDataItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ConfirmedInternalTransactionForCertainAmountOrHigherDataItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConfirmedInternalTransactionForCertainAmountOrHigherDataItem input)
        {
            if (input == null)
            {
                return false;
