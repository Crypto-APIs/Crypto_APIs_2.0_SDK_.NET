...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4033
    /// </summary>
    [DataContract(Name = "inline_response_403_3")]
    public partial class InlineResponse4033 : IEquatable<InlineResponse4033>, IValidatableObject
    {
        ...
        public InlineResponse4033(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetZilliqaAddressDetailsE403 error = default(GetZilliqaAddressDetailsE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4033 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4033 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse4033 and cannot be null");
            }
            this.Error = error;
