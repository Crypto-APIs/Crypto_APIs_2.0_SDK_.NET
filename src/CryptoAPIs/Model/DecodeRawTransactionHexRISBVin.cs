...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DecodeRawTransactionHexRISB_vin")]
    public partial class DecodeRawTransactionHexRISBVin : IEquatable<DecodeRawTransactionHexRISBVin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISBVin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DecodeRawTransactionHexRISBVin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISBVin" /> class.
        /// </summary>
        ...
        public DecodeRawTransactionHexRISBVin(string address = default(string), string inputHash = default(string), int outputIndex = default(int), DecodeRawTransactionHexRISBScriptSig scriptSig = default(DecodeRawTransactionHexRISBScriptSig), string sequence = default(string), List<string> txinwitness = default(List<string>))
        {
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null)
            {
                throw new ArgumentNullException("scriptSig is a required property for DecodeRawTransactionHexRISBVin and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DecodeRawTransactionHexRISBVin {\n");
        ...
        {
            return this.Equals(input as DecodeRawTransactionHexRISBVin);
        }

        /// <summary>
        /// Returns true if DecodeRawTransactionHexRISBVin instances are equal
        /// </summary>
        /// <param name="input">Instance of DecodeRawTransactionHexRISBVin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecodeRawTransactionHexRISBVin input)
        {
            if (input == null)
            {
                return false;
