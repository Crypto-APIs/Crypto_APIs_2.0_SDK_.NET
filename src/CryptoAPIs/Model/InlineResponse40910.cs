...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40910
    /// </summary>
    [DataContract(Name = "inline_response_409_10")]
    public partial class InlineResponse40910 : IEquatable<InlineResponse40910>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40910" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40910() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40910" /> class.
        /// </summary>
        ...
        public InlineResponse40910(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedTokensTransactionsAndEachConfirmationE409 error = default(NewConfirmedTokensTransactionsAndEachConfirmationE409))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40910 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40910 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40910 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse40910);
        }

        /// <summary>
        /// Returns true if InlineResponse40910 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40910 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40910 input)
        {
            if (input == null)
            {
                return false;
