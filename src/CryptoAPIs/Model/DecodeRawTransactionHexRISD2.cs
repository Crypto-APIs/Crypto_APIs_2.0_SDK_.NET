...
namespace CryptoAPIs.Model
{
    ...
    public partial class DecodeRawTransactionHexRISD2 : IEquatable<DecodeRawTransactionHexRISD2>, IValidatableObject
    {
        ...
        public DecodeRawTransactionHexRISD2(int locktime = default(int), string transactionHash = default(string), int vSize = default(int), int version = default(int), List<DecodeRawTransactionHexRISD2Vin> vin = default(List<DecodeRawTransactionHexRISD2Vin>), List<DecodeRawTransactionHexRISD2Vout> vout = default(List<DecodeRawTransactionHexRISD2Vout>), int weight = default(int))
        {
        ...
        public List<DecodeRawTransactionHexRISD2Vin> Vin { get; set; }
        ...
        public List<DecodeRawTransactionHexRISD2Vout> Vout { get; set; }
