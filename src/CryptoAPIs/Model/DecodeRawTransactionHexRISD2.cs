...
namespace CryptoAPIs.Model
{
    ...
    /// Dogecoin
    /// </summary>
    [DataContract(Name = "DecodeRawTransactionHexRISD2")]
    public partial class DecodeRawTransactionHexRISD2 : IEquatable<DecodeRawTransactionHexRISD2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISD2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DecodeRawTransactionHexRISD2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISD2" /> class.
        /// </summary>
        ...
        public DecodeRawTransactionHexRISD2(int locktime = default(int), string transactionHash = default(string), int vSize = default(int), int version = default(int), List<DecodeRawTransactionHexRISD2VinInner> vin = default(List<DecodeRawTransactionHexRISD2VinInner>), List<DecodeRawTransactionHexRISD2VoutInner> vout = default(List<DecodeRawTransactionHexRISD2VoutInner>), int weight = default(int))
        {
            this.Locktime = locktime;
            // to ensure "transactionHash" is required (not null)
            if (transactionHash == null)
            {
                throw new ArgumentNullException("transactionHash is a required property for DecodeRawTransactionHexRISD2 and cannot be null");
            }
            ...
            if (vin == null)
            {
                throw new ArgumentNullException("vin is a required property for DecodeRawTransactionHexRISD2 and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null)
            {
                throw new ArgumentNullException("vout is a required property for DecodeRawTransactionHexRISD2 and cannot be null");
            }
            this.Vout = vout;
            this.Weight = weight;
        }
        ...
        public List<DecodeRawTransactionHexRISD2VinInner> Vin { get; set; }
        ...
        public List<DecodeRawTransactionHexRISD2VoutInner> Vout { get; set; }
        ...
        {
            return this.Equals(input as DecodeRawTransactionHexRISD2);
        }

        /// <summary>
        /// Returns true if DecodeRawTransactionHexRISD2 instances are equal
        /// </summary>
        /// <param name="input">Instance of DecodeRawTransactionHexRISD2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecodeRawTransactionHexRISD2 input)
        {
            if (input == null)
            {
                return false;
