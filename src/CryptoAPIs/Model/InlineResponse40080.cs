...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40080 : IEquatable<InlineResponse40080>, IValidatableObject
    {
        ...
        public InlineResponse40080(string apiVersion = default(string), string requestId = default(string), string context = default(string), AddTokensToExistingFromAddressE400 error = default(AddTokensToExistingFromAddressE400))
        {
