...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40080
    /// </summary>
    [DataContract(Name = "inline_response_400_80")]
    public partial class InlineResponse40080 : IEquatable<InlineResponse40080>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40080" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40080() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40080" /> class.
        /// </summary>
        ...
        public InlineResponse40080(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetBlockchainEventSubscriptionDetailsByReferenceIDE400 error = default(GetBlockchainEventSubscriptionDetailsByReferenceIDE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40080 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40080 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40080 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40080 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40080);
        }

        /// <summary>
        /// Returns true if InlineResponse40080 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40080 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40080 input)
        {
            if (input == null)
            {
                return false;
