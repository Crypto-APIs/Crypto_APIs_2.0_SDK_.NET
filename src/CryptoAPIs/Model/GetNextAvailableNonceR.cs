...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetNextAvailableNonceR")]
    public partial class GetNextAvailableNonceR : IEquatable<GetNextAvailableNonceR>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetNextAvailableNonceR" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetNextAvailableNonceR() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetNextAvailableNonceR" /> class.
        /// </summary>
        ...
        public GetNextAvailableNonceR(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetNextAvailableNonceRData data = default(GetNextAvailableNonceRData))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for GetNextAvailableNonceR and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for GetNextAvailableNonceR and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for GetNextAvailableNonceR and cannot be null");
            }
            this.Data = data;
        ...
        public GetNextAvailableNonceRData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetNextAvailableNonceR {\n");
        ...
        {
            return this.Equals(input as GetNextAvailableNonceR);
        }

        /// <summary>
        /// Returns true if GetNextAvailableNonceR instances are equal
        /// </summary>
        /// <param name="input">Instance of GetNextAvailableNonceR to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetNextAvailableNonceR input)
        {
            if (input == null)
            {
                return false;
