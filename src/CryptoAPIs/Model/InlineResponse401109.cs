...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_401_109")]
    public partial class InlineResponse401109 : IEquatable<InlineResponse401109>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse401109" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse401109() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse401109" /> class.
        /// </summary>
        ...
        public InlineResponse401109(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetAssetDetailsByAssetIDE401 error = default(GetAssetDetailsByAssetIDE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse401109 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse401109 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse401109 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse401109 {\n");
        ...
        {
            return this.Equals(input as InlineResponse401109);
        }

        /// <summary>
        /// Returns true if InlineResponse401109 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse401109 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse401109 input)
        {
            if (input == null)
            {
                return false;
