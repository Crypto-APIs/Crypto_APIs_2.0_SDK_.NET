...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_401_103")]
    public partial class InlineResponse401103 : IEquatable<InlineResponse401103>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse401103" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse401103() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse401103" /> class.
        /// </summary>
        ...
        public InlineResponse401103(string apiVersion = default(string), string requestId = default(string), string context = default(string), DecodeXAddressE401 error = default(DecodeXAddressE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse401103 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse401103 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse401103 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse401103 {\n");
        ...
        {
            return this.Equals(input as InlineResponse401103);
        }

        /// <summary>
        /// Returns true if InlineResponse401103 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse401103 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse401103 input)
        {
            if (input == null)
            {
                return false;
