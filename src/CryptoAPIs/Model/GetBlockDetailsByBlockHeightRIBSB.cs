...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetBlockDetailsByBlockHeightRIBSB : IEquatable<GetBlockDetailsByBlockHeightRIBSB>, IValidatableObject
    {
        ...
        public GetBlockDetailsByBlockHeightRIBSB(string difficulty = default(string), string bits = default(string), string chainwork = default(string), string merkleRoot = default(string), long nonce = default(long), int size = default(int), int strippedSize = default(int), int version = default(int), string versionHex = default(string), int weight = default(int))
        {
