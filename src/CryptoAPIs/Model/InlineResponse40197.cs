...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40197
    /// </summary>
    [DataContract(Name = "inline_response_401_97")]
    public partial class InlineResponse40197 : IEquatable<InlineResponse40197>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40197" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40197() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40197" /> class.
        /// </summary>
        ...
        public InlineResponse40197(string apiVersion = default(string), string requestId = default(string), string context = default(string), ValidateAddressE401 error = default(ValidateAddressE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40197 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40197 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40197 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40197 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40197);
        }

        /// <summary>
        /// Returns true if InlineResponse40197 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40197 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40197 input)
        {
            if (input == null)
            {
                return false;
