...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DecodeRawTransactionHexRISD_vin_inner")]
    public partial class DecodeRawTransactionHexRISDVinInner : IEquatable<DecodeRawTransactionHexRISDVinInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISDVinInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DecodeRawTransactionHexRISDVinInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISDVinInner" /> class.
        /// </summary>
        ...
        public DecodeRawTransactionHexRISDVinInner(string address = default(string), string inputHash = default(string), string outputIndex = default(string), DecodeRawTransactionHexRISDVinInnerScriptSig scriptSig = default(DecodeRawTransactionHexRISDVinInnerScriptSig), string sequence = default(string), List<string> txinwitness = default(List<string>))
        {
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null)
            {
                throw new ArgumentNullException("scriptSig is a required property for DecodeRawTransactionHexRISDVinInner and cannot be null");
            }
        ...
        public DecodeRawTransactionHexRISDVinInnerScriptSig ScriptSig { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DecodeRawTransactionHexRISDVinInner {\n");
        ...
        {
            return this.Equals(input as DecodeRawTransactionHexRISDVinInner);
        }

        /// <summary>
        /// Returns true if DecodeRawTransactionHexRISDVinInner instances are equal
        /// </summary>
        /// <param name="input">Instance of DecodeRawTransactionHexRISDVinInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecodeRawTransactionHexRISDVinInner input)
        {
            if (input == null)
            {
                return false;
