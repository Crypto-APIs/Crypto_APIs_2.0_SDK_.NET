...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40159
    /// </summary>
    [DataContract(Name = "inline_response_401_59")]
    public partial class InlineResponse40159 : IEquatable<InlineResponse40159>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40159" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40159() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40159" /> class.
        /// </summary>
        ...
        public InlineResponse40159(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListUnspentTransactionOutputsByAddressE401 error = default(ListUnspentTransactionOutputsByAddressE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40159 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40159 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40159 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40159 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40159);
        }

        /// <summary>
        /// Returns true if InlineResponse40159 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40159 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40159 input)
        {
            if (input == null)
            {
                return false;
