...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40159 : IEquatable<InlineResponse40159>, IValidatableObject
    {
        ...
        public InlineResponse40159(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewUnconfirmedTokensTransactionsE401 error = default(NewUnconfirmedTokensTransactionsE401))
        {
