...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetTransactionDetailsByTransactionIDRIBSL_vin_inner")]
    public partial class GetTransactionDetailsByTransactionIDRIBSLVinInner : IEquatable<GetTransactionDetailsByTransactionIDRIBSLVinInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDRIBSLVinInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetTransactionDetailsByTransactionIDRIBSLVinInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDRIBSLVinInner" /> class.
        /// </summary>
        ...
        public GetTransactionDetailsByTransactionIDRIBSLVinInner(List<string> addresses = default(List<string>), string coinbase = default(string), GetTransactionDetailsByTransactionIDRIBSLVinInnerScriptSig scriptSig = default(GetTransactionDetailsByTransactionIDRIBSLVinInnerScriptSig), long sequence = default(long), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            if (addresses == null)
            {
                throw new ArgumentNullException("addresses is a required property for GetTransactionDetailsByTransactionIDRIBSLVinInner and cannot be null");
            }
            this.Addresses = addresses;
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null)
            {
                throw new ArgumentNullException("scriptSig is a required property for GetTransactionDetailsByTransactionIDRIBSLVinInner and cannot be null");
            }
            ...
            if (txinwitness == null)
            {
                throw new ArgumentNullException("txinwitness is a required property for GetTransactionDetailsByTransactionIDRIBSLVinInner and cannot be null");
            }
        ...
        public GetTransactionDetailsByTransactionIDRIBSLVinInnerScriptSig ScriptSig { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetTransactionDetailsByTransactionIDRIBSLVinInner {\n");
        ...
        {
            return this.Equals(input as GetTransactionDetailsByTransactionIDRIBSLVinInner);
        }

        /// <summary>
        /// Returns true if GetTransactionDetailsByTransactionIDRIBSLVinInner instances are equal
        /// </summary>
        /// <param name="input">Instance of GetTransactionDetailsByTransactionIDRIBSLVinInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetTransactionDetailsByTransactionIDRIBSLVinInner input)
        {
            if (input == null)
            {
                return false;
