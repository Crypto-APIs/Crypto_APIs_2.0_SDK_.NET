...
namespace CryptoAPIs.Model
{
    ...
    /// Binance Smart Chain
    /// </summary>
    [DataContract(Name = "GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC")]
    public partial class GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC : IEquatable<GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC" /> class.
        /// </summary>
        ...
        public GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC(string contract = default(string), string gasLimit = default(string), GetTransactionDetailsByTransactionIDRIBSBSCGasPrice gasPrice = default(GetTransactionDetailsByTransactionIDRIBSBSCGasPrice), string gasUsed = default(string), string inputData = default(string), int nonce = default(int))
        {
            // to ensure "contract" is required (not null)
            if (contract == null)
            {
                throw new ArgumentNullException("contract is a required property for GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC and cannot be null");
            }
            this.Contract = contract;
            // to ensure "gasLimit" is required (not null)
            if (gasLimit == null)
            {
                throw new ArgumentNullException("gasLimit is a required property for GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC and cannot be null");
            }
            this.GasLimit = gasLimit;
            // to ensure "gasPrice" is required (not null)
            if (gasPrice == null)
            {
                throw new ArgumentNullException("gasPrice is a required property for GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC and cannot be null");
            }
            this.GasPrice = gasPrice;
            // to ensure "gasUsed" is required (not null)
            if (gasUsed == null)
            {
                throw new ArgumentNullException("gasUsed is a required property for GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC and cannot be null");
            }
            this.GasUsed = gasUsed;
            // to ensure "inputData" is required (not null)
            if (inputData == null)
            {
                throw new ArgumentNullException("inputData is a required property for GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC and cannot be null");
            }
        ...
        {
            return this.Equals(input as GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC);
        }

        /// <summary>
        /// Returns true if GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC instances are equal
        /// </summary>
        /// <param name="input">Instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC input)
        {
            if (input == null)
            {
                return false;
