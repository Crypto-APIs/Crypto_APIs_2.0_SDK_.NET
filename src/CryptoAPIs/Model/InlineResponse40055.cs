...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40055 : IEquatable<InlineResponse40055>, IValidatableObject
    {
        ...
        public InlineResponse40055(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListHDWalletXPubYPubZPubUTXOsE400 error = default(ListHDWalletXPubYPubZPubUTXOsE400))
        {
