...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40055
    /// </summary>
    [DataContract(Name = "inline_response_400_55")]
    public partial class InlineResponse40055 : IEquatable<InlineResponse40055>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40055" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40055() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40055" /> class.
        /// </summary>
        ...
        public InlineResponse40055(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListConfirmedTokensTransfersByAddressE400 error = default(ListConfirmedTokensTransfersByAddressE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40055 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40055 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40055 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40055 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40055);
        }

        /// <summary>
        /// Returns true if InlineResponse40055 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40055 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40055 input)
        {
            if (input == null)
            {
                return false;
