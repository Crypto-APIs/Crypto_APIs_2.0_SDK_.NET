...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40115
    /// </summary>
    [DataContract(Name = "inline_response_401_15")]
    public partial class InlineResponse40115 : IEquatable<InlineResponse40115>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40115" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40115() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40115" /> class.
        /// </summary>
        ...
        public InlineResponse40115(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListUnconfirmedTransactionsByAddressE401 error = default(ListUnconfirmedTransactionsByAddressE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40115 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40115 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40115 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40115 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40115);
        }

        /// <summary>
        /// Returns true if InlineResponse40115 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40115 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40115 input)
        {
            if (input == null)
            {
                return false;
