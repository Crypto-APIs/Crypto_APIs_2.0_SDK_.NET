...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(ListSyncedAddressesE403JsonConverter))]
    [DataContract(Name = "ListSyncedAddressesE403")]
    public partial class ListSyncedAddressesE403 : AbstractOpenAPISchema, IEquatable<ListSyncedAddressesE403>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListSyncedAddressesE403" /> class
        /// with the <see cref="BannedIpAddress" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BannedIpAddress.</param>
        public ListSyncedAddressesE403(BannedIpAddress actualInstance)
        {
        ...
        public ListSyncedAddressesE403(EndpointNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public ListSyncedAddressesE403(EndpointNotAllowedForApiKey actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public ListSyncedAddressesE403(FeatureMainnetsNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListSyncedAddressesE403 {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, ListSyncedAddressesE403.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of ListSyncedAddressesE403
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of ListSyncedAddressesE403</returns>
        public static ListSyncedAddressesE403 FromJson(string jsonString)
        {
            ListSyncedAddressesE403 newListSyncedAddressesE403 = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newListSyncedAddressesE403;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newListSyncedAddressesE403 = new ListSyncedAddressesE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, ListSyncedAddressesE403.SerializerSettings));
                }
                else
                {
                    newListSyncedAddressesE403 = new ListSyncedAddressesE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, ListSyncedAddressesE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newListSyncedAddressesE403 = new ListSyncedAddressesE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, ListSyncedAddressesE403.SerializerSettings));
                }
                else
                {
                    newListSyncedAddressesE403 = new ListSyncedAddressesE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, ListSyncedAddressesE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newListSyncedAddressesE403 = new ListSyncedAddressesE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, ListSyncedAddressesE403.SerializerSettings));
                }
                else
                {
                    newListSyncedAddressesE403 = new ListSyncedAddressesE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, ListSyncedAddressesE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newListSyncedAddressesE403 = new ListSyncedAddressesE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, ListSyncedAddressesE403.SerializerSettings));
                }
                else
                {
                    newListSyncedAddressesE403 = new ListSyncedAddressesE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, ListSyncedAddressesE403.AdditionalPropertiesSerializerSettings));
                }
        ...
        {
            return this.Equals(input as ListSyncedAddressesE403);
        }

        /// <summary>
        /// Returns true if ListSyncedAddressesE403 instances are equal
        /// </summary>
        /// <param name="input">Instance of ListSyncedAddressesE403 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListSyncedAddressesE403 input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for ListSyncedAddressesE403
    /// </summary>
    public class ListSyncedAddressesE403JsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(ListSyncedAddressesE403).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return ListSyncedAddressesE403.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
