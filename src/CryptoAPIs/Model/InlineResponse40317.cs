...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40317
    /// </summary>
    [DataContract(Name = "inline_response_403_17")]
    public partial class InlineResponse40317 : IEquatable<InlineResponse40317>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40317" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40317() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40317" /> class.
        /// </summary>
        ...
        public InlineResponse40317(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListAllUnconfirmedTransactionsE403 error = default(ListAllUnconfirmedTransactionsE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40317 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40317 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40317 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40317 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40317);
        }

        /// <summary>
        /// Returns true if InlineResponse40317 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40317 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40317 input)
        {
            if (input == null)
            {
                return false;
