...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40317 : IEquatable<InlineResponse40317>, IValidatableObject
    {
        ...
        public InlineResponse40317(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTransactionsByBlockHashE403 error = default(ListTransactionsByBlockHashE403))
        {
