...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40073 : IEquatable<InlineResponse40073>, IValidatableObject
    {
        ...
        public InlineResponse40073(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedCoinsTransactionsE400 error = default(NewConfirmedCoinsTransactionsE400))
        {
