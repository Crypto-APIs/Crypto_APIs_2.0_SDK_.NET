...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40073
    /// </summary>
    [DataContract(Name = "inline_response_400_73")]
    public partial class InlineResponse40073 : IEquatable<InlineResponse40073>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40073" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40073() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40073" /> class.
        /// </summary>
        ...
        public InlineResponse40073(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedInternalTransactionsE400 error = default(NewConfirmedInternalTransactionsE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40073 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40073 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40073 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40073 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40073);
        }

        /// <summary>
        /// Returns true if InlineResponse40073 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40073 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40073 input)
        {
            if (input == null)
            {
                return false;
