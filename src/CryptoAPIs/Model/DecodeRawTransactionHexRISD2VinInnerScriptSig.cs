...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DecodeRawTransactionHexRISD2_vin_inner_scriptSig")]
    public partial class DecodeRawTransactionHexRISD2VinInnerScriptSig : IEquatable<DecodeRawTransactionHexRISD2VinInnerScriptSig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISD2VinInnerScriptSig" /> class.
        /// </summary>
        ...
        public DecodeRawTransactionHexRISD2VinInnerScriptSig(string asm = default(string), string hex = default(string), string type = default(string))
        {
            this.Asm = asm;
            this.Hex = hex;
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DecodeRawTransactionHexRISD2VinInnerScriptSig {\n");
        ...
        {
            return this.Equals(input as DecodeRawTransactionHexRISD2VinInnerScriptSig);
        }

        /// <summary>
        /// Returns true if DecodeRawTransactionHexRISD2VinInnerScriptSig instances are equal
        /// </summary>
        /// <param name="input">Instance of DecodeRawTransactionHexRISD2VinInnerScriptSig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecodeRawTransactionHexRISD2VinInnerScriptSig input)
        {
            if (input == null)
            {
                return false;
