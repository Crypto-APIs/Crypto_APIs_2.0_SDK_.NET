...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40072
    /// </summary>
    [DataContract(Name = "inline_response_400_72")]
    public partial class InlineResponse40072 : IEquatable<InlineResponse40072>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40072" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40072() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40072" /> class.
        /// </summary>
        ...
        public InlineResponse40072(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetBlockDetailsByBlockHeightFromCallbackE400 error = default(GetBlockDetailsByBlockHeightFromCallbackE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40072 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40072 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40072 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40072 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40072);
        }

        /// <summary>
        /// Returns true if InlineResponse40072 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40072 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40072 input)
        {
            if (input == null)
            {
                return false;
