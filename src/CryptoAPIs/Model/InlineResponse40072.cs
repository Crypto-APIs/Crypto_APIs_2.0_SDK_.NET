...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40072 : IEquatable<InlineResponse40072>, IValidatableObject
    {
        ...
        public InlineResponse40072(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewUnconfirmedTokensTransactionsE400 error = default(NewUnconfirmedTokensTransactionsE400))
        {
