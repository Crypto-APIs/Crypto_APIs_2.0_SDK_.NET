...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40175 : IEquatable<InlineResponse40175>, IValidatableObject
    {
        ...
        public InlineResponse40175(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListCoinsForwardingAutomationsE401 error = default(ListCoinsForwardingAutomationsE401))
        {
