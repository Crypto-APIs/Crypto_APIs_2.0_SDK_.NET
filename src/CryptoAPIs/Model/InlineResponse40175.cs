...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40175
    /// </summary>
    [DataContract(Name = "inline_response_401_75")]
    public partial class InlineResponse40175 : IEquatable<InlineResponse40175>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40175" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40175() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40175" /> class.
        /// </summary>
        ...
        public InlineResponse40175(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedTokensTransactionsAndEachConfirmationE401 error = default(NewConfirmedTokensTransactionsAndEachConfirmationE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40175 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40175 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40175 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40175 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40175);
        }

        /// <summary>
        /// Returns true if InlineResponse40175 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40175 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40175 input)
        {
            if (input == null)
            {
                return false;
