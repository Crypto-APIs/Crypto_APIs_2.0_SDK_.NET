...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListTransactionsByBlockHeightRIBSD_vin")]
    public partial class ListTransactionsByBlockHeightRIBSDVin : IEquatable<ListTransactionsByBlockHeightRIBSDVin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHeightRIBSDVin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByBlockHeightRIBSDVin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHeightRIBSDVin" /> class.
        /// </summary>
        ...
        public ListTransactionsByBlockHeightRIBSDVin(List<string> addresses = default(List<string>), string coinbase = default(string), ListTransactionsByBlockHeightRIBSDScriptSig scriptSig = default(ListTransactionsByBlockHeightRIBSDScriptSig), string sequence = default(string), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            this.Addresses = addresses ?? throw new ArgumentNullException("addresses is a required property for ListTransactionsByBlockHeightRIBSDVin and cannot be null");
            // to ensure "coinbase" is required (not null)
            this.Coinbase = coinbase ?? throw new ArgumentNullException("coinbase is a required property for ListTransactionsByBlockHeightRIBSDVin and cannot be null");
            // to ensure "scriptSig" is required (not null)
            this.ScriptSig = scriptSig ?? throw new ArgumentNullException("scriptSig is a required property for ListTransactionsByBlockHeightRIBSDVin and cannot be null");
            // to ensure "sequence" is required (not null)
            this.Sequence = sequence ?? throw new ArgumentNullException("sequence is a required property for ListTransactionsByBlockHeightRIBSDVin and cannot be null");
            // to ensure "txinwitness" is required (not null)
            this.Txinwitness = txinwitness ?? throw new ArgumentNullException("txinwitness is a required property for ListTransactionsByBlockHeightRIBSDVin and cannot be null");
            this.Vout = vout;
            this.Txid = txid;
            this.Value = value;
        }
        ...
        public ListTransactionsByBlockHeightRIBSDScriptSig ScriptSig { get; set; }
        ...
        {
            return this.Equals(input as ListTransactionsByBlockHeightRIBSDVin);
        }

        /// <summary>
        /// Returns true if ListTransactionsByBlockHeightRIBSDVin instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByBlockHeightRIBSDVin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByBlockHeightRIBSDVin input)
        {
            if (input == null)
                return false;
