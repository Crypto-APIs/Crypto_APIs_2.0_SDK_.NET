...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetWalletTransactionDetailsByTransactionIDRIBSZ_vin")]
    public partial class GetWalletTransactionDetailsByTransactionIDRIBSZVin : IEquatable<GetWalletTransactionDetailsByTransactionIDRIBSZVin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWalletTransactionDetailsByTransactionIDRIBSZVin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetWalletTransactionDetailsByTransactionIDRIBSZVin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWalletTransactionDetailsByTransactionIDRIBSZVin" /> class.
        /// </summary>
        ...
        public GetWalletTransactionDetailsByTransactionIDRIBSZVin(List<string> addresses = default(List<string>), GetTransactionDetailsByTransactionIDRIBSZScriptSig scriptSig = default(GetTransactionDetailsByTransactionIDRIBSZScriptSig), long sequence = default(long), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            if (addresses == null)
            {
                throw new ArgumentNullException("addresses is a required property for GetWalletTransactionDetailsByTransactionIDRIBSZVin and cannot be null");
            }
            this.Addresses = addresses;
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null)
            {
                throw new ArgumentNullException("scriptSig is a required property for GetWalletTransactionDetailsByTransactionIDRIBSZVin and cannot be null");
            }
            ...
            if (txid == null)
            {
                throw new ArgumentNullException("txid is a required property for GetWalletTransactionDetailsByTransactionIDRIBSZVin and cannot be null");
            }
            this.Txid = txid;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for GetWalletTransactionDetailsByTransactionIDRIBSZVin and cannot be null");
            }
            this.Value = value;
            this.Vout = vout;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetWalletTransactionDetailsByTransactionIDRIBSZVin {\n");
        ...
        {
            return this.Equals(input as GetWalletTransactionDetailsByTransactionIDRIBSZVin);
        }

        /// <summary>
        /// Returns true if GetWalletTransactionDetailsByTransactionIDRIBSZVin instances are equal
        /// </summary>
        /// <param name="input">Instance of GetWalletTransactionDetailsByTransactionIDRIBSZVin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetWalletTransactionDetailsByTransactionIDRIBSZVin input)
        {
            if (input == null)
            {
                return false;
