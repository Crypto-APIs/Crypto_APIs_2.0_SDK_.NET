...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40132 : IEquatable<InlineResponse40132>, IValidatableObject
    {
        ...
        public InlineResponse40132(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetXRPRippleBlockDetailsByBlockHashE401 error = default(GetXRPRippleBlockDetailsByBlockHashE401))
        {
