...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40132
    /// </summary>
    [DataContract(Name = "inline_response_401_32")]
    public partial class InlineResponse40132 : IEquatable<InlineResponse40132>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40132" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40132() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40132" /> class.
        /// </summary>
        ...
        public InlineResponse40132(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetOmniTransactionDetailsByTransactionIDTxidE401 error = default(GetOmniTransactionDetailsByTransactionIDTxidE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40132 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40132 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40132 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40132 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40132);
        }

        /// <summary>
        /// Returns true if InlineResponse40132 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40132 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40132 input)
        {
            if (input == null)
            {
                return false;
