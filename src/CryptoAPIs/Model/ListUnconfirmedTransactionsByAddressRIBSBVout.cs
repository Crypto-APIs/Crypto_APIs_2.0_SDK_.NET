...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListUnconfirmedTransactionsByAddressRIBSB_vout")]
    public partial class ListUnconfirmedTransactionsByAddressRIBSBVout : IEquatable<ListUnconfirmedTransactionsByAddressRIBSBVout>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnconfirmedTransactionsByAddressRIBSBVout" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListUnconfirmedTransactionsByAddressRIBSBVout() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnconfirmedTransactionsByAddressRIBSBVout" /> class.
        /// </summary>
        ...
        public ListUnconfirmedTransactionsByAddressRIBSBVout(bool isSpent = default(bool), ListUnconfirmedTransactionsByAddressRIBSBScriptPubKey scriptPubKey = default(ListUnconfirmedTransactionsByAddressRIBSBScriptPubKey), string value = default(string))
        {
        ...
        public ListUnconfirmedTransactionsByAddressRIBSBScriptPubKey ScriptPubKey { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListUnconfirmedTransactionsByAddressRIBSBVout {\n");
        ...
        {
            return this.Equals(input as ListUnconfirmedTransactionsByAddressRIBSBVout);
        }

        /// <summary>
        /// Returns true if ListUnconfirmedTransactionsByAddressRIBSBVout instances are equal
        /// </summary>
        /// <param name="input">Instance of ListUnconfirmedTransactionsByAddressRIBSBVout to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListUnconfirmedTransactionsByAddressRIBSBVout input)
        {
            if (input == null)
                return false;
