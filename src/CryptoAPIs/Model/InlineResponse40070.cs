...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40070
    /// </summary>
    [DataContract(Name = "inline_response_400_70")]
    public partial class InlineResponse40070 : IEquatable<InlineResponse40070>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40070" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40070() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40070" /> class.
        /// </summary>
        ...
        public InlineResponse40070(string apiVersion = default(string), string requestId = default(string), string context = default(string), DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400 error = default(DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40070 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40070 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40070 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40070 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40070);
        }

        /// <summary>
        /// Returns true if InlineResponse40070 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40070 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40070 input)
        {
            if (input == null)
            {
                return false;
