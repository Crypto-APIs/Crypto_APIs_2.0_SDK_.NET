...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40070 : IEquatable<InlineResponse40070>, IValidatableObject
    {
        ...
        public InlineResponse40070(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetTransactionDetailsByTransactionIDFromCallbackE400 error = default(GetTransactionDetailsByTransactionIDFromCallbackE400))
        {
