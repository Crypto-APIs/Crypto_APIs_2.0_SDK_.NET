...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40011
    /// </summary>
    [DataContract(Name = "inline_response_400_11")]
    public partial class InlineResponse40011 : IEquatable<InlineResponse40011>, IValidatableObject
    {
        ...
        public InlineResponse40011(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListXRPRippleTransactionsByAddressE400 error = default(ListXRPRippleTransactionsByAddressE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40011 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40011 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40011 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse40011);
        }

        /// <summary>
        /// Returns true if InlineResponse40011 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40011 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40011 input)
        {
            if (input == null)
            {
                return false;
