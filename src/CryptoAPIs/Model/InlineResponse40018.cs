...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40018
    /// </summary>
    [DataContract(Name = "inline_response_400_18")]
    public partial class InlineResponse40018 : IEquatable<InlineResponse40018>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40018" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40018() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40018" /> class.
        /// </summary>
        ...
        public InlineResponse40018(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListXRPRippleTransactionsByBlockHashE400 error = default(ListXRPRippleTransactionsByBlockHashE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40018 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40018 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40018 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40018 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40018);
        }

        /// <summary>
        /// Returns true if InlineResponse40018 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40018 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40018 input)
        {
            if (input == null)
            {
                return false;
