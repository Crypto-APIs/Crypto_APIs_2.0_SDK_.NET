...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40018 : IEquatable<InlineResponse40018>, IValidatableObject
    {
        ...
        public InlineResponse40018(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTransactionsByBlockHashE400 error = default(ListTransactionsByBlockHashE400))
        {
