...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListAllUnconfirmedTransactionsRIBSB_vin_inner")]
    public partial class ListAllUnconfirmedTransactionsRIBSBVinInner : IEquatable<ListAllUnconfirmedTransactionsRIBSBVinInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllUnconfirmedTransactionsRIBSBVinInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListAllUnconfirmedTransactionsRIBSBVinInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllUnconfirmedTransactionsRIBSBVinInner" /> class.
        /// </summary>
        ...
        public ListAllUnconfirmedTransactionsRIBSBVinInner(List<string> addresses = default(List<string>), ListAllUnconfirmedTransactionsRIBSBVinInnerScriptSig scriptSig = default(ListAllUnconfirmedTransactionsRIBSBVinInnerScriptSig), string sequence = default(string), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            if (addresses == null)
            {
                throw new ArgumentNullException("addresses is a required property for ListAllUnconfirmedTransactionsRIBSBVinInner and cannot be null");
            }
            this.Addresses = addresses;
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null)
            {
                throw new ArgumentNullException("scriptSig is a required property for ListAllUnconfirmedTransactionsRIBSBVinInner and cannot be null");
            }
            this.ScriptSig = scriptSig;
            // to ensure "sequence" is required (not null)
            if (sequence == null)
            {
                throw new ArgumentNullException("sequence is a required property for ListAllUnconfirmedTransactionsRIBSBVinInner and cannot be null");
            }
        ...
        public ListAllUnconfirmedTransactionsRIBSBVinInnerScriptSig ScriptSig { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListAllUnconfirmedTransactionsRIBSBVinInner {\n");
        ...
        {
            return this.Equals(input as ListAllUnconfirmedTransactionsRIBSBVinInner);
        }

        /// <summary>
        /// Returns true if ListAllUnconfirmedTransactionsRIBSBVinInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ListAllUnconfirmedTransactionsRIBSBVinInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListAllUnconfirmedTransactionsRIBSBVinInner input)
        {
            if (input == null)
            {
                return false;
