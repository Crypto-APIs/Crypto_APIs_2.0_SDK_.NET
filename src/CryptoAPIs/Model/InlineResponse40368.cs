...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40368 : IEquatable<InlineResponse40368>, IValidatableObject
    {
        ...
        public InlineResponse40368(string apiVersion = default(string), string requestId = default(string), string context = default(string), EstimateTransactionSmartFeeE403 error = default(EstimateTransactionSmartFeeE403))
        {
