...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40368
    /// </summary>
    [DataContract(Name = "inline_response_403_68")]
    public partial class InlineResponse40368 : IEquatable<InlineResponse40368>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40368" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40368() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40368" /> class.
        /// </summary>
        ...
        public InlineResponse40368(string apiVersion = default(string), string requestId = default(string), string context = default(string), DeleteBlockchainEventSubscriptionE403 error = default(DeleteBlockchainEventSubscriptionE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40368 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40368 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40368 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40368 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40368);
        }

        /// <summary>
        /// Returns true if InlineResponse40368 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40368 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40368 input)
        {
            if (input == null)
            {
                return false;
