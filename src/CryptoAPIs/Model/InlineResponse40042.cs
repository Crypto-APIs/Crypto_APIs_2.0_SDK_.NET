...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40042 : IEquatable<InlineResponse40042>, IValidatableObject
    {
        ...
        public InlineResponse40042(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListLatestMinedBlocksE400 error = default(ListLatestMinedBlocksE400))
        {
