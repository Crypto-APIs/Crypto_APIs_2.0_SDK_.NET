...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40042
    /// </summary>
    [DataContract(Name = "inline_response_400_42")]
    public partial class InlineResponse40042 : IEquatable<InlineResponse40042>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40042" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40042() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40042" /> class.
        /// </summary>
        ...
        public InlineResponse40042(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetLatestMinedXRPRippleBlockE400 error = default(GetLatestMinedXRPRippleBlockE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40042 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40042 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40042 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40042 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40042);
        }

        /// <summary>
        /// Returns true if InlineResponse40042 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40042 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40042 input)
        {
            if (input == null)
            {
                return false;
