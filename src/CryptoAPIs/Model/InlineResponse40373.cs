...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40373 : IEquatable<InlineResponse40373>, IValidatableObject
    {
        ...
        public InlineResponse40373(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedCoinsTransactionsE403 error = default(NewConfirmedCoinsTransactionsE403))
        {
