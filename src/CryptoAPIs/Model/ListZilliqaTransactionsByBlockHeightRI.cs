...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListZilliqaTransactionsByBlockHeightRI : IEquatable<ListZilliqaTransactionsByBlockHeightRI>, IValidatableObject
    {
        ...
        public ListZilliqaTransactionsByBlockHeightRI(GetZilliqaTransactionDetailsByTransactionIDRIFee fee = default(GetZilliqaTransactionDetailsByTransactionIDRIFee), int gasLimit = default(int), int gasPrice = default(int), int gasUsed = default(int), string minedInBlockHash = default(string), int nonce = default(int), List<ListZilliqaTransactionsByAddressRIRecipientsInner> recipients = default(List<ListZilliqaTransactionsByAddressRIRecipientsInner>), List<ListZilliqaTransactionsByAddressRISendersInner> senders = default(List<ListZilliqaTransactionsByAddressRISendersInner>), int timestamp = default(int), string transactionHash = default(string), int transactionIndex = default(int), string transactionStatus = default(string))
        {
