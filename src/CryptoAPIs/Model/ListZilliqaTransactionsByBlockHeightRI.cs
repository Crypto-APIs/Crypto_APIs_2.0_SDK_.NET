...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListZilliqaTransactionsByBlockHeightRI")]
    public partial class ListZilliqaTransactionsByBlockHeightRI : IEquatable<ListZilliqaTransactionsByBlockHeightRI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListZilliqaTransactionsByBlockHeightRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListZilliqaTransactionsByBlockHeightRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListZilliqaTransactionsByBlockHeightRI" /> class.
        /// </summary>
        ...
        /// <param name="recipients">Defines an object array of the transaction recipients. (required).</param>
        ...
        public ListZilliqaTransactionsByBlockHeightRI(GetZilliqaTransactionDetailsByTransactionIDRIFee fee = default(GetZilliqaTransactionDetailsByTransactionIDRIFee), int gasLimit = default(int), int gasPrice = default(int), int gasUsed = default(int), string minedInBlockHash = default(string), int nonce = default(int), List<ListZilliqaTransactionsByAddressRIRecipients> recipients = default(List<ListZilliqaTransactionsByAddressRIRecipients>), List<ListZilliqaTransactionsByAddressRISenders> senders = default(List<ListZilliqaTransactionsByAddressRISenders>), int timestamp = default(int), string transactionHash = default(string), int transactionIndex = default(int), string transactionStatus = default(string))
        {
            ...
            this.Fee = fee ?? throw new ArgumentNullException("fee is a required property for ListZilliqaTransactionsByBlockHeightRI and cannot be null");
            this.GasLimit = gasLimit;
            this.GasPrice = gasPrice;
            this.GasUsed = gasUsed;
            // to ensure "minedInBlockHash" is required (not null)
            this.MinedInBlockHash = minedInBlockHash ?? throw new ArgumentNullException("minedInBlockHash is a required property for ListZilliqaTransactionsByBlockHeightRI and cannot be null");
            this.Nonce = nonce;
            // to ensure "recipients" is required (not null)
            this.Recipients = recipients ?? throw new ArgumentNullException("recipients is a required property for ListZilliqaTransactionsByBlockHeightRI and cannot be null");
            // to ensure "senders" is required (not null)
            this.Senders = senders ?? throw new ArgumentNullException("senders is a required property for ListZilliqaTransactionsByBlockHeightRI and cannot be null");
            this.Timestamp = timestamp;
            // to ensure "transactionHash" is required (not null)
            this.TransactionHash = transactionHash ?? throw new ArgumentNullException("transactionHash is a required property for ListZilliqaTransactionsByBlockHeightRI and cannot be null");
            this.TransactionIndex = transactionIndex;
            // to ensure "transactionStatus" is required (not null)
            this.TransactionStatus = transactionStatus ?? throw new ArgumentNullException("transactionStatus is a required property for ListZilliqaTransactionsByBlockHeightRI and cannot be null");
        }
        ...
        /// </summary>
        /// <value>Represents the hash of the transaction, which is its unique identifier.</value>
        ...
        {
            return this.Equals(input as ListZilliqaTransactionsByBlockHeightRI);
        }

        /// <summary>
        /// Returns true if ListZilliqaTransactionsByBlockHeightRI instances are equal
        /// </summary>
        /// <param name="input">Instance of ListZilliqaTransactionsByBlockHeightRI to be compared</param>
        /// <returns>Boolean</returns>
