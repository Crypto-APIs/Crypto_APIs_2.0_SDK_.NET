...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40143 : IEquatable<InlineResponse40143>, IValidatableObject
    {
        ...
        public InlineResponse40143(string apiVersion = default(string), string requestId = default(string), string context = default(string), SyncHDWalletXPubYPubZPubE401 error = default(SyncHDWalletXPubYPubZPubE401))
        {
