...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40143
    /// </summary>
    [DataContract(Name = "inline_response_401_43")]
    public partial class InlineResponse40143 : IEquatable<InlineResponse40143>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40143" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40143() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40143" /> class.
        /// </summary>
        ...
        public InlineResponse40143(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetLatestMinedZilliqaBlockE401 error = default(GetLatestMinedZilliqaBlockE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40143 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40143 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40143 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40143 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40143);
        }

        /// <summary>
        /// Returns true if InlineResponse40143 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40143 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40143 input)
        {
            if (input == null)
            {
                return false;
