...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40014
    /// </summary>
    [DataContract(Name = "inline_response_400_14")]
    public partial class InlineResponse40014 : IEquatable<InlineResponse40014>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40014" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40014() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40014" /> class.
        /// </summary>
        ...
        public InlineResponse40014(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListZilliqaTransactionsByAddressE400 error = default(ListZilliqaTransactionsByAddressE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40014 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40014 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40014 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40014 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40014);
        }

        /// <summary>
        /// Returns true if InlineResponse40014 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40014 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40014 input)
        {
            if (input == null)
            {
                return false;
