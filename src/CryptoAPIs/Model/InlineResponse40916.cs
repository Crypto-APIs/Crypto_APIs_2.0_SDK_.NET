...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40916
    /// </summary>
    [DataContract(Name = "inline_response_409_16")]
    public partial class InlineResponse40916 : IEquatable<InlineResponse40916>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40916" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40916() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40916" /> class.
        /// </summary>
        ...
        public InlineResponse40916(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateAutomaticCoinsForwardingE409 error = default(CreateAutomaticCoinsForwardingE409))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40916 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40916 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40916 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse40916);
        }

        /// <summary>
        /// Returns true if InlineResponse40916 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40916 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40916 input)
        {
            if (input == null)
            {
                return false;
