...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AddressInternalTransactionConfirmed")]
    public partial class AddressInternalTransactionConfirmed : IEquatable<AddressInternalTransactionConfirmed>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressInternalTransactionConfirmed" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AddressInternalTransactionConfirmed() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressInternalTransactionConfirmed" /> class.
        /// </summary>
        ...
        public AddressInternalTransactionConfirmed(string apiVersion = default(string), string referenceId = default(string), string idempotencyKey = default(string), AddressInternalTransactionConfirmedData data = default(AddressInternalTransactionConfirmedData))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for AddressInternalTransactionConfirmed and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "referenceId" is required (not null)
            if (referenceId == null) {
                throw new ArgumentNullException("referenceId is a required property for AddressInternalTransactionConfirmed and cannot be null");
            }
            this.ReferenceId = referenceId;
            // to ensure "idempotencyKey" is required (not null)
            if (idempotencyKey == null) {
                throw new ArgumentNullException("idempotencyKey is a required property for AddressInternalTransactionConfirmed and cannot be null");
            }
            this.IdempotencyKey = idempotencyKey;
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for AddressInternalTransactionConfirmed and cannot be null");
            }
            this.Data = data;
        }
        ...
        public AddressInternalTransactionConfirmedData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddressInternalTransactionConfirmed {\n");
        ...
        {
            return this.Equals(input as AddressInternalTransactionConfirmed);
        }

        /// <summary>
        /// Returns true if AddressInternalTransactionConfirmed instances are equal
        /// </summary>
        /// <param name="input">Instance of AddressInternalTransactionConfirmed to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddressInternalTransactionConfirmed input)
        {
            if (input == null)
            {
                return false;
