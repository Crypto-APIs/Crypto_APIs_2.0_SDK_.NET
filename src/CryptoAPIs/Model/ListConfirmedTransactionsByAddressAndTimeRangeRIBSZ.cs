...
namespace CryptoAPIs.Model
{
    ...
    /// Zcash
    /// </summary>
    [DataContract(Name = "ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ")]
    public partial class ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ : IEquatable<ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ" /> class.
        /// </summary>
        ...
        public ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ(string bindingSig = default(string), int expiryHeight = default(int), string joinSplitPubKey = default(string), string joinSplitSig = default(string), long locktime = default(long), bool overwintered = default(bool), int size = default(int), List<ListConfirmedTransactionsByAddressRIBSZVJoinSplit> vJoinSplit = default(List<ListConfirmedTransactionsByAddressRIBSZVJoinSplit>), List<GetTransactionDetailsByTransactionIDRIBSZVShieldedOutput> vShieldedOutput = default(List<GetTransactionDetailsByTransactionIDRIBSZVShieldedOutput>), List<GetTransactionDetailsByTransactionIDRIBSZVShieldedSpend> vShieldedSpend = default(List<GetTransactionDetailsByTransactionIDRIBSZVShieldedSpend>), string valueBalance = default(string), int version = default(int), string versionGroupId = default(string), List<ListConfirmedTransactionsByAddressRIBSZVin> vin = default(List<ListConfirmedTransactionsByAddressRIBSZVin>), List<GetTransactionDetailsByTransactionIDRIBSZVout> vout = default(List<GetTransactionDetailsByTransactionIDRIBSZVout>))
        {
            // to ensure "bindingSig" is required (not null)
            if (bindingSig == null)
            {
                throw new ArgumentNullException("bindingSig is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("joinSplitPubKey is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ and cannot be null");
            }
            this.JoinSplitPubKey = joinSplitPubKey;
            // to ensure "joinSplitSig" is required (not null)
            if (joinSplitSig == null)
            {
                throw new ArgumentNullException("joinSplitSig is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ and cannot be null");
            }
            ...
            if (vJoinSplit == null)
            {
                throw new ArgumentNullException("vJoinSplit is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ and cannot be null");
            }
            this.VJoinSplit = vJoinSplit;
            // to ensure "vShieldedOutput" is required (not null)
            if (vShieldedOutput == null)
            {
                throw new ArgumentNullException("vShieldedOutput is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ and cannot be null");
            }
            this.VShieldedOutput = vShieldedOutput;
            // to ensure "vShieldedSpend" is required (not null)
            if (vShieldedSpend == null)
            {
                throw new ArgumentNullException("vShieldedSpend is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ and cannot be null");
            }
            this.VShieldedSpend = vShieldedSpend;
            // to ensure "valueBalance" is required (not null)
            if (valueBalance == null)
            {
                throw new ArgumentNullException("valueBalance is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("versionGroupId is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ and cannot be null");
            }
            this.VersionGroupId = versionGroupId;
            // to ensure "vin" is required (not null)
            if (vin == null)
            {
                throw new ArgumentNullException("vin is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null)
            {
                throw new ArgumentNullException("vout is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ and cannot be null");
            }
            this.Vout = vout;
        }
        ...
        public List<ListConfirmedTransactionsByAddressRIBSZVJoinSplit> VJoinSplit { get; set; }
        ...
        public List<ListConfirmedTransactionsByAddressRIBSZVin> Vin { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ {\n");
        ...
        {
            return this.Equals(input as ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ);
        }

        /// <summary>
        /// Returns true if ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ instances are equal
        /// </summary>
        /// <param name="input">Instance of ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ input)
        {
            if (input == null)
            {
                return false;
