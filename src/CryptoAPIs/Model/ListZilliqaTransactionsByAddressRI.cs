...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListZilliqaTransactionsByAddressRI")]
    public partial class ListZilliqaTransactionsByAddressRI : IEquatable<ListZilliqaTransactionsByAddressRI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListZilliqaTransactionsByAddressRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListZilliqaTransactionsByAddressRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListZilliqaTransactionsByAddressRI" /> class.
        /// </summary>
        ...
        public ListZilliqaTransactionsByAddressRI(GetZilliqaTransactionDetailsByTransactionIDRIFee fee = default(GetZilliqaTransactionDetailsByTransactionIDRIFee), int gasLimit = default(int), int gasPrice = default(int), int gasUsed = default(int), string minedInBlockHash = default(string), int minedInBlockHeight = default(int), int nonce = default(int), List<ListZilliqaTransactionsByAddressRIRecipientsInner> recipients = default(List<ListZilliqaTransactionsByAddressRIRecipientsInner>), List<ListZilliqaTransactionsByAddressRISendersInner> senders = default(List<ListZilliqaTransactionsByAddressRISendersInner>), int timestamp = default(int), string transactionHash = default(string), int transactionIndex = default(int), string transactionStatus = default(string))
        {
        ...
        {
            return this.Equals(input as ListZilliqaTransactionsByAddressRI);
        }

        /// <summary>
        /// Returns true if ListZilliqaTransactionsByAddressRI instances are equal
        /// </summary>
        /// <param name="input">Instance of ListZilliqaTransactionsByAddressRI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListZilliqaTransactionsByAddressRI input)
        {
            if (input == null)
            {
                return false;
