...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(ListSupportedAssetsE403JsonConverter))]
    [DataContract(Name = "ListSupportedAssetsE403")]
    public partial class ListSupportedAssetsE403 : AbstractOpenAPISchema, IEquatable<ListSupportedAssetsE403>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListSupportedAssetsE403" /> class
        /// with the <see cref="BannedIpAddress" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BannedIpAddress.</param>
        public ListSupportedAssetsE403(BannedIpAddress actualInstance)
        {
        ...
        public ListSupportedAssetsE403(EndpointNotAllowedForApiKey actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public ListSupportedAssetsE403(EndpointNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public ListSupportedAssetsE403(FeatureMainnetsNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListSupportedAssetsE403 {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, ListSupportedAssetsE403.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of ListSupportedAssetsE403
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of ListSupportedAssetsE403</returns>
        public static ListSupportedAssetsE403 FromJson(string jsonString)
        {
            ListSupportedAssetsE403 newListSupportedAssetsE403 = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newListSupportedAssetsE403;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newListSupportedAssetsE403 = new ListSupportedAssetsE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, ListSupportedAssetsE403.SerializerSettings));
                }
                else
                {
                    newListSupportedAssetsE403 = new ListSupportedAssetsE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, ListSupportedAssetsE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newListSupportedAssetsE403 = new ListSupportedAssetsE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, ListSupportedAssetsE403.SerializerSettings));
                }
                else
                {
                    newListSupportedAssetsE403 = new ListSupportedAssetsE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, ListSupportedAssetsE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newListSupportedAssetsE403 = new ListSupportedAssetsE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, ListSupportedAssetsE403.SerializerSettings));
                }
                else
                {
                    newListSupportedAssetsE403 = new ListSupportedAssetsE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, ListSupportedAssetsE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newListSupportedAssetsE403 = new ListSupportedAssetsE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, ListSupportedAssetsE403.SerializerSettings));
                }
                else
                {
                    newListSupportedAssetsE403 = new ListSupportedAssetsE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, ListSupportedAssetsE403.AdditionalPropertiesSerializerSettings));
                }
        ...
        {
            return this.Equals(input as ListSupportedAssetsE403);
        }

        /// <summary>
        /// Returns true if ListSupportedAssetsE403 instances are equal
        /// </summary>
        /// <param name="input">Instance of ListSupportedAssetsE403 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListSupportedAssetsE403 input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for ListSupportedAssetsE403
    /// </summary>
    public class ListSupportedAssetsE403JsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(ListSupportedAssetsE403).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return ListSupportedAssetsE403.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
