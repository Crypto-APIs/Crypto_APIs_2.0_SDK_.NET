...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40079
    /// </summary>
    [DataContract(Name = "inline_response_400_79")]
    public partial class InlineResponse40079 : IEquatable<InlineResponse40079>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40079" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40079() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40079" /> class.
        /// </summary>
        ...
        public InlineResponse40079(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListBlockchainEventsSubscriptionsE400 error = default(ListBlockchainEventsSubscriptionsE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40079 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40079 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40079 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40079 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40079);
        }

        /// <summary>
        /// Returns true if InlineResponse40079 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40079 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40079 input)
        {
            if (input == null)
            {
                return false;
