...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40079 : IEquatable<InlineResponse40079>, IValidatableObject
    {
        ...
        public InlineResponse40079(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateAutomaticTokensForwardingE400 error = default(CreateAutomaticTokensForwardingE400))
        {
