...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40051
    /// </summary>
    [DataContract(Name = "inline_response_400_51")]
    public partial class InlineResponse40051 : IEquatable<InlineResponse40051>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40051" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40051() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40051" /> class.
        /// </summary>
        ...
        public InlineResponse40051(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListInternalTransactionsByAddressE400 error = default(ListInternalTransactionsByAddressE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40051 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40051 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40051 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40051 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40051);
        }

        /// <summary>
        /// Returns true if InlineResponse40051 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40051 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40051 input)
        {
            if (input == null)
            {
                return false;
