...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40051 : IEquatable<InlineResponse40051>, IValidatableObject
    {
        ...
        public InlineResponse40051(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetHDWalletXPubYPubZPubDetailsE400 error = default(GetHDWalletXPubYPubZPubDetailsE400))
        {
