...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetWalletTransactionDetailsByTransactionIDRIBSBC : IEquatable<GetWalletTransactionDetailsByTransactionIDRIBSBC>, IValidatableObject
    {
        ...
        public GetWalletTransactionDetailsByTransactionIDRIBSBC(int locktime = default(int), int size = default(int), int version = default(int), List<GetWalletTransactionDetailsByTransactionIDRIBSBCVin> vin = default(List<GetWalletTransactionDetailsByTransactionIDRIBSBCVin>), List<GetWalletTransactionDetailsByTransactionIDRIBSBCVout> vout = default(List<GetWalletTransactionDetailsByTransactionIDRIBSBCVout>))
        {
