...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40380
    /// </summary>
    [DataContract(Name = "inline_response_403_80")]
    public partial class InlineResponse40380 : IEquatable<InlineResponse40380>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40380" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40380() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40380" /> class.
        /// </summary>
        ...
        public InlineResponse40380(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetBlockchainEventSubscriptionDetailsByReferenceIDE403 error = default(GetBlockchainEventSubscriptionDetailsByReferenceIDE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40380 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40380 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40380 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40380 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40380);
        }

        /// <summary>
        /// Returns true if InlineResponse40380 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40380 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40380 input)
        {
            if (input == null)
            {
                return false;
