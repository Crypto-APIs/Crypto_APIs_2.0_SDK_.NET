...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40380 : IEquatable<InlineResponse40380>, IValidatableObject
    {
        ...
        public InlineResponse40380(string apiVersion = default(string), string requestId = default(string), string context = default(string), AddTokensToExistingFromAddressE403 error = default(AddTokensToExistingFromAddressE403))
        {
