...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewConfirmedCoinsTransactionsForSpecificAmountRI")]
    public partial class NewConfirmedCoinsTransactionsForSpecificAmountRI : IEquatable<NewConfirmedCoinsTransactionsForSpecificAmountRI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewConfirmedCoinsTransactionsForSpecificAmountRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewConfirmedCoinsTransactionsForSpecificAmountRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewConfirmedCoinsTransactionsForSpecificAmountRI" /> class.
        /// </summary>
        ...
        public NewConfirmedCoinsTransactionsForSpecificAmountRI(long amountHigherThan = default(long), string callbackSecretKey = default(string), string callbackUrl = default(string), int createdTimestamp = default(int), string eventType = default(string), bool isActive = default(bool), string referenceId = default(string))
        {
            this.AmountHigherThan = amountHigherThan;
            // to ensure "callbackUrl" is required (not null)
            if (callbackUrl == null)
            {
                throw new ArgumentNullException("callbackUrl is a required property for NewConfirmedCoinsTransactionsForSpecificAmountRI and cannot be null");
            }
            ...
            if (eventType == null)
            {
                throw new ArgumentNullException("eventType is a required property for NewConfirmedCoinsTransactionsForSpecificAmountRI and cannot be null");
            }
            ...
            if (referenceId == null)
            {
                throw new ArgumentNullException("referenceId is a required property for NewConfirmedCoinsTransactionsForSpecificAmountRI and cannot be null");
            }
        ...
        {
            return this.Equals(input as NewConfirmedCoinsTransactionsForSpecificAmountRI);
        }

        /// <summary>
        /// Returns true if NewConfirmedCoinsTransactionsForSpecificAmountRI instances are equal
        /// </summary>
        /// <param name="input">Instance of NewConfirmedCoinsTransactionsForSpecificAmountRI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewConfirmedCoinsTransactionsForSpecificAmountRI input)
        {
            if (input == null)
            {
                return false;
