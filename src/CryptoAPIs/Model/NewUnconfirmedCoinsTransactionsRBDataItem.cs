...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewUnconfirmedCoinsTransactionsRB_data_item")]
    public partial class NewUnconfirmedCoinsTransactionsRBDataItem : IEquatable<NewUnconfirmedCoinsTransactionsRBDataItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewUnconfirmedCoinsTransactionsRBDataItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewUnconfirmedCoinsTransactionsRBDataItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewUnconfirmedCoinsTransactionsRBDataItem" /> class.
        /// </summary>
        ...
        public NewUnconfirmedCoinsTransactionsRBDataItem(string address = default(string), bool allowDuplicates = false, string callbackSecretKey = default(string), string callbackUrl = default(string))
        {
            // to ensure "address" is required (not null)
            this.Address = address ?? throw new ArgumentNullException("address is a required property for NewUnconfirmedCoinsTransactionsRBDataItem and cannot be null");
            // to ensure "callbackUrl" is required (not null)
            this.CallbackUrl = callbackUrl ?? throw new ArgumentNullException("callbackUrl is a required property for NewUnconfirmedCoinsTransactionsRBDataItem and cannot be null");
        ...
        {
            return this.Equals(input as NewUnconfirmedCoinsTransactionsRBDataItem);
        }

        /// <summary>
        /// Returns true if NewUnconfirmedCoinsTransactionsRBDataItem instances are equal
        /// </summary>
        /// <param name="input">Instance of NewUnconfirmedCoinsTransactionsRBDataItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewUnconfirmedCoinsTransactionsRBDataItem input)
        {
            if (input == null)
                return false;
