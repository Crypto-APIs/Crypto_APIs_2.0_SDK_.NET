...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40338
    /// </summary>
    [DataContract(Name = "inline_response_403_38")]
    public partial class InlineResponse40338 : IEquatable<InlineResponse40338>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40338" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40338() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40338" /> class.
        /// </summary>
        ...
        public InlineResponse40338(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListOmniTransactionsByBlockHeightE403 error = default(ListOmniTransactionsByBlockHeightE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40338 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40338 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40338 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40338 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40338);
        }

        /// <summary>
        /// Returns true if InlineResponse40338 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40338 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40338 input)
        {
            if (input == null)
            {
                return false;
