...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40338 : IEquatable<InlineResponse40338>, IValidatableObject
    {
        ...
        public InlineResponse40338(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListAllAssetsFromAllWalletsE403 error = default(ListAllAssetsFromAllWalletsE403))
        {
