...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4098
    /// </summary>
    [DataContract(Name = "inline_response_409_8")]
    public partial class InlineResponse4098 : IEquatable<InlineResponse4098>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4098" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse4098() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4098" /> class.
        /// </summary>
        ...
        public InlineResponse4098(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedCoinsTransactionsE409 error = default(NewConfirmedCoinsTransactionsE409))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4098 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4098 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse4098 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse4098);
        }

        /// <summary>
        /// Returns true if InlineResponse4098 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4098 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4098 input)
        {
            if (input == null)
            {
                return false;
