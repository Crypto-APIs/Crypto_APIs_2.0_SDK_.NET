...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_403_101")]
    public partial class InlineResponse403101 : IEquatable<InlineResponse403101>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse403101" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse403101() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse403101" /> class.
        /// </summary>
        ...
        public InlineResponse403101(string apiVersion = default(string), string requestId = default(string), string context = default(string), EstimateTokenGasLimitE403 error = default(EstimateTokenGasLimitE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse403101 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse403101 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse403101 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse403101 {\n");
        ...
        {
            return this.Equals(input as InlineResponse403101);
        }

        /// <summary>
        /// Returns true if InlineResponse403101 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse403101 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse403101 input)
        {
            if (input == null)
            {
                return false;
