...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40150 : IEquatable<InlineResponse40150>, IValidatableObject
    {
        ...
        public InlineResponse40150(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetHDWalletXPubYPubZPubAssetsE401 error = default(GetHDWalletXPubYPubZPubAssetsE401))
        {
