...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListZilliqaTransactionsByBlockHashRI : IEquatable<ListZilliqaTransactionsByBlockHashRI>, IValidatableObject
    {
        ...
        public ListZilliqaTransactionsByBlockHashRI(GetZilliqaTransactionDetailsByTransactionIDRIFee fee = default(GetZilliqaTransactionDetailsByTransactionIDRIFee), int gasLimit = default(int), int gasPrice = default(int), int gasUsed = default(int), int minedInBlockHeight = default(int), int nonce = default(int), List<ListZilliqaTransactionsByAddressRIRecipientsInner> recipients = default(List<ListZilliqaTransactionsByAddressRIRecipientsInner>), List<ListZilliqaTransactionsByAddressRISendersInner> senders = default(List<ListZilliqaTransactionsByAddressRISendersInner>), int timestamp = default(int), string transactionHash = default(string), int transactionIndex = default(int), string transactionStatus = default(string))
        {
            ...
            if (fee == null)
            {
                throw new ArgumentNullException("fee is a required property for ListZilliqaTransactionsByBlockHashRI and cannot be null");
            }
            this.Fee = fee;
            ...
            if (recipients == null)
            {
                throw new ArgumentNullException("recipients is a required property for ListZilliqaTransactionsByBlockHashRI and cannot be null");
            }
            this.Recipients = recipients;
            // to ensure "senders" is required (not null)
            if (senders == null)
            {
                throw new ArgumentNullException("senders is a required property for ListZilliqaTransactionsByBlockHashRI and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("transactionHash is a required property for ListZilliqaTransactionsByBlockHashRI and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("transactionStatus is a required property for ListZilliqaTransactionsByBlockHashRI and cannot be null");
            }
