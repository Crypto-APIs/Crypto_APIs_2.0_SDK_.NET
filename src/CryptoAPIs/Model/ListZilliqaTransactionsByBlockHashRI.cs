...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListZilliqaTransactionsByBlockHashRI")]
    public partial class ListZilliqaTransactionsByBlockHashRI : IEquatable<ListZilliqaTransactionsByBlockHashRI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListZilliqaTransactionsByBlockHashRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListZilliqaTransactionsByBlockHashRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListZilliqaTransactionsByBlockHashRI" /> class.
        /// </summary>
        ...
        public ListZilliqaTransactionsByBlockHashRI(GetZilliqaTransactionDetailsByTransactionIDRIFee fee = default(GetZilliqaTransactionDetailsByTransactionIDRIFee), int gasLimit = default(int), int gasPrice = default(int), int gasUsed = default(int), int minedInBlockHeight = default(int), int nonce = default(int), List<ListZilliqaTransactionsByAddressRIRecipients> recipients = default(List<ListZilliqaTransactionsByAddressRIRecipients>), List<ListZilliqaTransactionsByAddressRISenders> senders = default(List<ListZilliqaTransactionsByAddressRISenders>), int timestamp = default(int), string transactionHash = default(string), int transactionIndex = default(int), string transactionStatus = default(string))
        {
            ...
            this.Fee = fee ?? throw new ArgumentNullException("fee is a required property for ListZilliqaTransactionsByBlockHashRI and cannot be null");
            ...
            this.Recipients = recipients ?? throw new ArgumentNullException("recipients is a required property for ListZilliqaTransactionsByBlockHashRI and cannot be null");
            // to ensure "senders" is required (not null)
            this.Senders = senders ?? throw new ArgumentNullException("senders is a required property for ListZilliqaTransactionsByBlockHashRI and cannot be null");
            this.Timestamp = timestamp;
            // to ensure "transactionHash" is required (not null)
            this.TransactionHash = transactionHash ?? throw new ArgumentNullException("transactionHash is a required property for ListZilliqaTransactionsByBlockHashRI and cannot be null");
            this.TransactionIndex = transactionIndex;
            // to ensure "transactionStatus" is required (not null)
            this.TransactionStatus = transactionStatus ?? throw new ArgumentNullException("transactionStatus is a required property for ListZilliqaTransactionsByBlockHashRI and cannot be null");
        }
        ...
        {
            return this.Equals(input as ListZilliqaTransactionsByBlockHashRI);
        }

        /// <summary>
        /// Returns true if ListZilliqaTransactionsByBlockHashRI instances are equal
        /// </summary>
        /// <param name="input">Instance of ListZilliqaTransactionsByBlockHashRI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListZilliqaTransactionsByBlockHashRI input)
        {
            if (input == null)
                return false;
