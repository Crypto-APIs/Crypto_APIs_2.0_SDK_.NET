...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListAllAssetsFromAllWalletsRI_nonFungibleTokens_inner")]
    public partial class ListAllAssetsFromAllWalletsRINonFungibleTokensInner : IEquatable<ListAllAssetsFromAllWalletsRINonFungibleTokensInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllAssetsFromAllWalletsRINonFungibleTokensInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListAllAssetsFromAllWalletsRINonFungibleTokensInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllAssetsFromAllWalletsRINonFungibleTokensInner" /> class.
        /// </summary>
        ...
        public ListAllAssetsFromAllWalletsRINonFungibleTokensInner(string blockchain = default(string), string identifier = default(string), string network = default(string), string symbol = default(string), string tokenId = default(string), string type = default(string))
        {
            // to ensure "blockchain" is required (not null)
            if (blockchain == null)
            {
                throw new ArgumentNullException("blockchain is a required property for ListAllAssetsFromAllWalletsRINonFungibleTokensInner and cannot be null");
            }
            this.Blockchain = blockchain;
            // to ensure "identifier" is required (not null)
            if (identifier == null)
            {
                throw new ArgumentNullException("identifier is a required property for ListAllAssetsFromAllWalletsRINonFungibleTokensInner and cannot be null");
            }
            this.Identifier = identifier;
            // to ensure "network" is required (not null)
            if (network == null)
            {
                throw new ArgumentNullException("network is a required property for ListAllAssetsFromAllWalletsRINonFungibleTokensInner and cannot be null");
            }
            this.Network = network;
            // to ensure "symbol" is required (not null)
            if (symbol == null)
            {
                throw new ArgumentNullException("symbol is a required property for ListAllAssetsFromAllWalletsRINonFungibleTokensInner and cannot be null");
            }
            this.Symbol = symbol;
            // to ensure "tokenId" is required (not null)
            if (tokenId == null)
            {
                throw new ArgumentNullException("tokenId is a required property for ListAllAssetsFromAllWalletsRINonFungibleTokensInner and cannot be null");
            }
            this.TokenId = tokenId;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for ListAllAssetsFromAllWalletsRINonFungibleTokensInner and cannot be null");
            }
            this.Type = type;
        }
        ...
        {
            return this.Equals(input as ListAllAssetsFromAllWalletsRINonFungibleTokensInner);
        }

        /// <summary>
        /// Returns true if ListAllAssetsFromAllWalletsRINonFungibleTokensInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ListAllAssetsFromAllWalletsRINonFungibleTokensInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListAllAssetsFromAllWalletsRINonFungibleTokensInner input)
        {
            if (input == null)
            {
                return false;
