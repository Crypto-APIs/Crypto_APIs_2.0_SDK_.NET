...
namespace CryptoAPIs.Model
{
    ...
    /// CoinsForwardingFail
    /// </summary>
    [DataContract(Name = "CoinsForwardingFail")]
    public partial class CoinsForwardingFail : IEquatable<CoinsForwardingFail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoinsForwardingFail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoinsForwardingFail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoinsForwardingFail" /> class.
        /// </summary>
        ...
        public CoinsForwardingFail(string apiVersion = default(string), string referenceId = default(string), string idempotencyKey = default(string), CoinsForwardingFailData data = default(CoinsForwardingFailData))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for CoinsForwardingFail and cannot be null");
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for CoinsForwardingFail and cannot be null");
            // to ensure "idempotencyKey" is required (not null)
            this.IdempotencyKey = idempotencyKey ?? throw new ArgumentNullException("idempotencyKey is a required property for CoinsForwardingFail and cannot be null");
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for CoinsForwardingFail and cannot be null");
        }
        ...
        public CoinsForwardingFailData Data { get; set; }
        ...
        {
            return this.Equals(input as CoinsForwardingFail);
        }

        /// <summary>
        /// Returns true if CoinsForwardingFail instances are equal
        /// </summary>
        /// <param name="input">Instance of CoinsForwardingFail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CoinsForwardingFail input)
        {
            if (input == null)
                return false;
