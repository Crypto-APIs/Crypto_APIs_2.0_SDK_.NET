...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetWalletTransactionDetailsByTransactionIDRIBSD_vin_inner")]
    public partial class GetWalletTransactionDetailsByTransactionIDRIBSDVinInner : IEquatable<GetWalletTransactionDetailsByTransactionIDRIBSDVinInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWalletTransactionDetailsByTransactionIDRIBSDVinInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetWalletTransactionDetailsByTransactionIDRIBSDVinInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWalletTransactionDetailsByTransactionIDRIBSDVinInner" /> class.
        /// </summary>
        ...
        public GetWalletTransactionDetailsByTransactionIDRIBSDVinInner(List<string> addresses = default(List<string>), string coinbase = default(string), GetWalletTransactionDetailsByTransactionIDRIBSDVinInnerScriptSig scriptSig = default(GetWalletTransactionDetailsByTransactionIDRIBSDVinInnerScriptSig), long sequence = default(long), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            if (addresses == null)
            {
                throw new ArgumentNullException("addresses is a required property for GetWalletTransactionDetailsByTransactionIDRIBSDVinInner and cannot be null");
            }
            this.Addresses = addresses;
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null)
            {
                throw new ArgumentNullException("scriptSig is a required property for GetWalletTransactionDetailsByTransactionIDRIBSDVinInner and cannot be null");
            }
            ...
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for GetWalletTransactionDetailsByTransactionIDRIBSDVinInner and cannot be null");
            }
            this.Value = value;
        ...
        public GetWalletTransactionDetailsByTransactionIDRIBSDVinInnerScriptSig ScriptSig { get; set; }
        ...
        {
            return this.Equals(input as GetWalletTransactionDetailsByTransactionIDRIBSDVinInner);
        }

        /// <summary>
        /// Returns true if GetWalletTransactionDetailsByTransactionIDRIBSDVinInner instances are equal
        /// </summary>
        /// <param name="input">Instance of GetWalletTransactionDetailsByTransactionIDRIBSDVinInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetWalletTransactionDetailsByTransactionIDRIBSDVinInner input)
        {
            if (input == null)
            {
                return false;
