...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_403_109")]
    public partial class InlineResponse403109 : IEquatable<InlineResponse403109>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse403109" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse403109() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse403109" /> class.
        /// </summary>
        ...
        public InlineResponse403109(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetAssetDetailsByAssetIDE403 error = default(GetAssetDetailsByAssetIDE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse403109 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse403109 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse403109 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse403109 {\n");
        ...
        {
            return this.Equals(input as InlineResponse403109);
        }

        /// <summary>
        /// Returns true if InlineResponse403109 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse403109 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse403109 input)
        {
            if (input == null)
            {
                return false;
