...
namespace CryptoAPIs.Model
{
    ...
    /// BlockHeightReachedR
    /// </summary>
    [DataContract(Name = "BlockHeightReachedR")]
    public partial class BlockHeightReachedR : IEquatable<BlockHeightReachedR>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BlockHeightReachedR" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BlockHeightReachedR() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BlockHeightReachedR" /> class.
        /// </summary>
        ...
        public BlockHeightReachedR(string apiVersion = default(string), string requestId = default(string), string context = default(string), BlockHeightReachedRData data = default(BlockHeightReachedRData))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for BlockHeightReachedR and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for BlockHeightReachedR and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for BlockHeightReachedR and cannot be null");
            }
            this.Data = data;
        ...
        public BlockHeightReachedRData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BlockHeightReachedR {\n");
        ...
        {
            return this.Equals(input as BlockHeightReachedR);
        }

        /// <summary>
        /// Returns true if BlockHeightReachedR instances are equal
        /// </summary>
        /// <param name="input">Instance of BlockHeightReachedR to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BlockHeightReachedR input)
        {
            if (input == null)
            {
                return false;
