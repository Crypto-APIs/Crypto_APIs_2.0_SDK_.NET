...
namespace CryptoAPIs.Model
{
    ...
    /// Ethereum
    /// </summary>
    [DataContract(Name = "GetLatestMinedBlockRIBSE")]
    public partial class GetLatestMinedBlockRIBSE : IEquatable<GetLatestMinedBlockRIBSE>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLatestMinedBlockRIBSE" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetLatestMinedBlockRIBSE() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLatestMinedBlockRIBSE" /> class.
        /// </summary>
        ...
        public GetLatestMinedBlockRIBSE(string difficulty = default(string), string nonce = default(string), int size = default(int), string extraData = default(string), string gasLimit = default(string), string gasUsed = default(string), int minedInSeconds = default(int), string sha3Uncles = default(string), string totalDifficulty = default(string))
        {
            ...
            this.GasLimit = gasLimit ?? throw new ArgumentNullException("gasLimit is a required property for GetLatestMinedBlockRIBSE and cannot be null");
            // to ensure "gasUsed" is required (not null)
            this.GasUsed = gasUsed ?? throw new ArgumentNullException("gasUsed is a required property for GetLatestMinedBlockRIBSE and cannot be null");
            this.MinedInSeconds = minedInSeconds;
            // to ensure "sha3Uncles" is required (not null)
            this.Sha3Uncles = sha3Uncles ?? throw new ArgumentNullException("sha3Uncles is a required property for GetLatestMinedBlockRIBSE and cannot be null");
            // to ensure "totalDifficulty" is required (not null)
            this.TotalDifficulty = totalDifficulty ?? throw new ArgumentNullException("totalDifficulty is a required property for GetLatestMinedBlockRIBSE and cannot be null");
        }
        ...
        {
            return this.Equals(input as GetLatestMinedBlockRIBSE);
        }

        /// <summary>
        /// Returns true if GetLatestMinedBlockRIBSE instances are equal
        /// </summary>
        /// <param name="input">Instance of GetLatestMinedBlockRIBSE to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetLatestMinedBlockRIBSE input)
        {
            if (input == null)
                return false;
