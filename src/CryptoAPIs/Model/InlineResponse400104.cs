...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_400_104")]
    public partial class InlineResponse400104 : IEquatable<InlineResponse400104>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse400104" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse400104() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse400104" /> class.
        /// </summary>
        ...
        public InlineResponse400104(string apiVersion = default(string), string requestId = default(string), string context = default(string), EncodeXAddressE400 error = default(EncodeXAddressE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse400104 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse400104 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse400104 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse400104 {\n");
        ...
        {
            return this.Equals(input as InlineResponse400104);
        }

        /// <summary>
        /// Returns true if InlineResponse400104 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse400104 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse400104 input)
        {
            if (input == null)
            {
                return false;
