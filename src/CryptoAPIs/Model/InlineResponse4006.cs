...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4006
    /// </summary>
    [DataContract(Name = "inline_response_400_6")]
    public partial class InlineResponse4006 : IEquatable<InlineResponse4006>, IValidatableObject
    {
        ...
        public InlineResponse4006(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetXRPRippleTransactionDetailsByTransactionIDE400 error = default(GetXRPRippleTransactionDetailsByTransactionIDE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4006 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4006 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse4006 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse4006);
        }

        /// <summary>
        /// Returns true if InlineResponse4006 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4006 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4006 input)
        {
            if (input == null)
            {
                return false;
