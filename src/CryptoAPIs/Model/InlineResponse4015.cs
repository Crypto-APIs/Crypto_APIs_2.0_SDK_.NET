...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4015
    /// </summary>
    [DataContract(Name = "inline_response_401_5")]
    public partial class InlineResponse4015 : IEquatable<InlineResponse4015>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4015" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse4015() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4015" /> class.
        /// </summary>
        ...
        public InlineResponse4015(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListOmniTransactionsByAddressE401 error = default(ListOmniTransactionsByAddressE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4015 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4015 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse4015 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse4015 {\n");
        ...
        {
            return this.Equals(input as InlineResponse4015);
        }

        /// <summary>
        /// Returns true if InlineResponse4015 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4015 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4015 input)
        {
            if (input == null)
            {
                return false;
