...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40084
    /// </summary>
    [DataContract(Name = "inline_response_400_84")]
    public partial class InlineResponse40084 : IEquatable<InlineResponse40084>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40084" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40084() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40084" /> class.
        /// </summary>
        ...
        public InlineResponse40084(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetTransactionDetailsByTransactionIDFromCallbackE400 error = default(GetTransactionDetailsByTransactionIDFromCallbackE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40084 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40084 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40084 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40084 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40084);
        }

        /// <summary>
        /// Returns true if InlineResponse40084 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40084 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40084 input)
        {
            if (input == null)
            {
                return false;
