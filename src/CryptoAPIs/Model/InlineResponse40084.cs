...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40084 : IEquatable<InlineResponse40084>, IValidatableObject
    {
        ...
        public InlineResponse40084(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetEIP1559FeeRecommendationsE400 error = default(GetEIP1559FeeRecommendationsE400))
        {
