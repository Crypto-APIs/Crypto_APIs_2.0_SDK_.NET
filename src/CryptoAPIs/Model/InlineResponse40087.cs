...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40087 : IEquatable<InlineResponse40087>, IValidatableObject
    {
        ...
        public InlineResponse40087(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetExchangeRateByAssetSymbolsE400 error = default(GetExchangeRateByAssetSymbolsE400))
        {
