...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40087
    /// </summary>
    [DataContract(Name = "inline_response_400_87")]
    public partial class InlineResponse40087 : IEquatable<InlineResponse40087>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40087" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40087() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40087" /> class.
        /// </summary>
        ...
        public InlineResponse40087(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedInternalTransactionsE400 error = default(NewConfirmedInternalTransactionsE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40087 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40087 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40087 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40087 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40087);
        }

        /// <summary>
        /// Returns true if InlineResponse40087 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40087 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40087 input)
        {
            if (input == null)
            {
                return false;
