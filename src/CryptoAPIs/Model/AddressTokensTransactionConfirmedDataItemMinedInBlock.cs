...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AddressTokensTransactionConfirmed_data_item_minedInBlock")]
    public partial class AddressTokensTransactionConfirmedDataItemMinedInBlock : IEquatable<AddressTokensTransactionConfirmedDataItemMinedInBlock>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressTokensTransactionConfirmedDataItemMinedInBlock" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AddressTokensTransactionConfirmedDataItemMinedInBlock() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressTokensTransactionConfirmedDataItemMinedInBlock" /> class.
        /// </summary>
        ...
        public AddressTokensTransactionConfirmedDataItemMinedInBlock(int height = default(int), string hash = default(string), int timestamp = default(int))
        {
            this.Height = height;
            // to ensure "hash" is required (not null)
            this.Hash = hash ?? throw new ArgumentNullException("hash is a required property for AddressTokensTransactionConfirmedDataItemMinedInBlock and cannot be null");
        ...
        {
            return this.Equals(input as AddressTokensTransactionConfirmedDataItemMinedInBlock);
        }

        /// <summary>
        /// Returns true if AddressTokensTransactionConfirmedDataItemMinedInBlock instances are equal
        /// </summary>
        /// <param name="input">Instance of AddressTokensTransactionConfirmedDataItemMinedInBlock to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddressTokensTransactionConfirmedDataItemMinedInBlock input)
        {
            if (input == null)
                return false;
