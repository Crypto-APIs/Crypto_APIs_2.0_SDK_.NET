...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40161
    /// </summary>
    [DataContract(Name = "inline_response_401_61")]
    public partial class InlineResponse40161 : IEquatable<InlineResponse40161>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40161" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40161() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40161" /> class.
        /// </summary>
        ...
        public InlineResponse40161(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListConfirmedTransactionsByAddressAndTimeRangeE401 error = default(ListConfirmedTransactionsByAddressAndTimeRangeE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40161 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40161 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40161 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40161 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40161);
        }

        /// <summary>
        /// Returns true if InlineResponse40161 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40161 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40161 input)
        {
            if (input == null)
            {
                return false;
