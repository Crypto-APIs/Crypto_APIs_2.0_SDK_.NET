...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40161 : IEquatable<InlineResponse40161>, IValidatableObject
    {
        ...
        public InlineResponse40161(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedTokensTransactionsE401 error = default(NewConfirmedTokensTransactionsE401))
        {
