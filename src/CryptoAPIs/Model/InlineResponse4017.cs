...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4017
    /// </summary>
    [DataContract(Name = "inline_response_401_7")]
    public partial class InlineResponse4017 : IEquatable<InlineResponse4017>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4017" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse4017() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4017" /> class.
        /// </summary>
        ...
        public InlineResponse4017(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListDepositAddressesE401 error = default(ListDepositAddressesE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4017 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4017 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse4017 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse4017 {\n");
        ...
        {
            return this.Equals(input as InlineResponse4017);
        }

        /// <summary>
        /// Returns true if InlineResponse4017 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4017 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4017 input)
        {
            if (input == null)
            {
                return false;
