...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40067
    /// </summary>
    [DataContract(Name = "inline_response_400_67")]
    public partial class InlineResponse40067 : IEquatable<InlineResponse40067>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40067" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40067() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40067" /> class.
        /// </summary>
        ...
        public InlineResponse40067(string apiVersion = default(string), string requestId = default(string), string context = default(string), ActivateBlockchainEventSubscriptionE400 error = default(ActivateBlockchainEventSubscriptionE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40067 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40067 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40067 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40067 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40067);
        }

        /// <summary>
        /// Returns true if InlineResponse40067 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40067 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40067 input)
        {
            if (input == null)
            {
                return false;
