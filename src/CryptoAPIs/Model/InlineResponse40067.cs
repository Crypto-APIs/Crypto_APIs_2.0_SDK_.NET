...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40067 : IEquatable<InlineResponse40067>, IValidatableObject
    {
        ...
        public InlineResponse40067(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTokensByAddressE400 error = default(ListTokensByAddressE400))
        {
