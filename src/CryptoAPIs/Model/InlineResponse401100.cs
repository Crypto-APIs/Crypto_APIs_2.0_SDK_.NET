...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_401_100")]
    public partial class InlineResponse401100 : IEquatable<InlineResponse401100>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse401100" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse401100() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse401100" /> class.
        /// </summary>
        ...
        public InlineResponse401100(string apiVersion = default(string), string requestId = default(string), string context = default(string), EstimateGasLimitE401 error = default(EstimateGasLimitE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse401100 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse401100 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse401100 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse401100 {\n");
        ...
        {
            return this.Equals(input as InlineResponse401100);
        }

        /// <summary>
        /// Returns true if InlineResponse401100 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse401100 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse401100 input)
        {
            if (input == null)
            {
                return false;
