...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40391 : IEquatable<InlineResponse40391>, IValidatableObject
    {
        ...
        public InlineResponse40391(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetAssetDetailsByAssetSymbolE403 error = default(GetAssetDetailsByAssetSymbolE403))
        {
