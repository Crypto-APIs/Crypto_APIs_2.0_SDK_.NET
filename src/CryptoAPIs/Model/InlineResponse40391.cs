...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40391
    /// </summary>
    [DataContract(Name = "inline_response_403_91")]
    public partial class InlineResponse40391 : IEquatable<InlineResponse40391>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40391" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40391() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40391" /> class.
        /// </summary>
        ...
        public InlineResponse40391(string apiVersion = default(string), string requestId = default(string), string context = default(string), DeleteAutomaticCoinsForwardingE403 error = default(DeleteAutomaticCoinsForwardingE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40391 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40391 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40391 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40391 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40391);
        }

        /// <summary>
        /// Returns true if InlineResponse40391 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40391 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40391 input)
        {
            if (input == null)
            {
                return false;
