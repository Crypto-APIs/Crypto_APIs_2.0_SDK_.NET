...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_400_108")]
    public partial class InlineResponse400108 : IEquatable<InlineResponse400108>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse400108" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse400108() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse400108" /> class.
        /// </summary>
        ...
        public InlineResponse400108(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListAssetsDetailsE400 error = default(ListAssetsDetailsE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse400108 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse400108 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse400108 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse400108 {\n");
        ...
        {
            return this.Equals(input as InlineResponse400108);
        }

        /// <summary>
        /// Returns true if InlineResponse400108 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse400108 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse400108 input)
        {
            if (input == null)
            {
                return false;
