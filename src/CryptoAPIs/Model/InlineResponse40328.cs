...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40328
    /// </summary>
    [DataContract(Name = "inline_response_403_28")]
    public partial class InlineResponse40328 : IEquatable<InlineResponse40328>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40328" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40328() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40328" /> class.
        /// </summary>
        ...
        public InlineResponse40328(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListUnconfirmedOmniTransactionsByPropertyIDE403 error = default(ListUnconfirmedOmniTransactionsByPropertyIDE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40328 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40328 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40328 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40328 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40328);
        }

        /// <summary>
        /// Returns true if InlineResponse40328 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40328 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40328 input)
        {
            if (input == null)
            {
                return false;
