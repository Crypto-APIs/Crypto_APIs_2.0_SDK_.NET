...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40328 : IEquatable<InlineResponse40328>, IValidatableObject
    {
        ...
        public InlineResponse40328(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetXRPRippleBlockDetailsByBlockHeightE403 error = default(GetXRPRippleBlockDetailsByBlockHeightE403))
        {
