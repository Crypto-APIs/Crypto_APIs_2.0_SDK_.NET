...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewConfirmedCoinsTransactionsAndEachConfirmationRI")]
    public partial class NewConfirmedCoinsTransactionsAndEachConfirmationRI : IEquatable<NewConfirmedCoinsTransactionsAndEachConfirmationRI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewConfirmedCoinsTransactionsAndEachConfirmationRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewConfirmedCoinsTransactionsAndEachConfirmationRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewConfirmedCoinsTransactionsAndEachConfirmationRI" /> class.
        /// </summary>
        ...
        public NewConfirmedCoinsTransactionsAndEachConfirmationRI(string address = default(string), string callbackSecretKey = default(string), string callbackUrl = default(string), int confirmationsCount = default(int), int createdTimestamp = default(int), string eventType = default(string), bool isActive = default(bool), string referenceId = default(string), string transactionId = default(string))
        {
            ...
            this.Address = address ?? throw new ArgumentNullException("address is a required property for NewConfirmedCoinsTransactionsAndEachConfirmationRI and cannot be null");
            // to ensure "callbackSecretKey" is required (not null)
            this.CallbackSecretKey = callbackSecretKey ?? throw new ArgumentNullException("callbackSecretKey is a required property for NewConfirmedCoinsTransactionsAndEachConfirmationRI and cannot be null");
            // to ensure "callbackUrl" is required (not null)
            this.CallbackUrl = callbackUrl ?? throw new ArgumentNullException("callbackUrl is a required property for NewConfirmedCoinsTransactionsAndEachConfirmationRI and cannot be null");
            this.ConfirmationsCount = confirmationsCount;
            this.CreatedTimestamp = createdTimestamp;
            // to ensure "eventType" is required (not null)
            this.EventType = eventType ?? throw new ArgumentNullException("eventType is a required property for NewConfirmedCoinsTransactionsAndEachConfirmationRI and cannot be null");
            this.IsActive = isActive;
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for NewConfirmedCoinsTransactionsAndEachConfirmationRI and cannot be null");
            // to ensure "transactionId" is required (not null)
            this.TransactionId = transactionId ?? throw new ArgumentNullException("transactionId is a required property for NewConfirmedCoinsTransactionsAndEachConfirmationRI and cannot be null");
        }
        ...
        {
            return this.Equals(input as NewConfirmedCoinsTransactionsAndEachConfirmationRI);
        }

        /// <summary>
        /// Returns true if NewConfirmedCoinsTransactionsAndEachConfirmationRI instances are equal
        /// </summary>
        /// <param name="input">Instance of NewConfirmedCoinsTransactionsAndEachConfirmationRI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewConfirmedCoinsTransactionsAndEachConfirmationRI input)
        {
            if (input == null)
                return false;
