...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Get_Address_Details_401_response")]
    public partial class GetAddressDetails401Response : IEquatable<GetAddressDetails401Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressDetails401Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetAddressDetails401Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressDetails401Response" /> class.
        /// </summary>
        ...
        public GetAddressDetails401Response(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetAddressDetailsE401 error = default(GetAddressDetailsE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for GetAddressDetails401Response and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for GetAddressDetails401Response and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for GetAddressDetails401Response and cannot be null");
            }
            this.Error = error;
        ...
        public GetAddressDetailsE401 Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAddressDetails401Response {\n");
        ...
        {
            return this.Equals(input as GetAddressDetails401Response);
        }

        /// <summary>
        /// Returns true if GetAddressDetails401Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAddressDetails401Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAddressDetails401Response input)
        {
            if (input == null)
            {
                return false;
