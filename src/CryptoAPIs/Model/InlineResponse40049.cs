...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40049 : IEquatable<InlineResponse40049>, IValidatableObject
    {
        ...
        public InlineResponse40049(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListHDWalletXPubYPubZPubTransactionsE400 error = default(ListHDWalletXPubYPubZPubTransactionsE400))
        {
