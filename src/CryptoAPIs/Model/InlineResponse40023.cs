...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40023
    /// </summary>
    [DataContract(Name = "inline_response_400_23")]
    public partial class InlineResponse40023 : IEquatable<InlineResponse40023>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40023" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40023() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40023" /> class.
        /// </summary>
        ...
        public InlineResponse40023(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListXRPRippleTransactionsByBlockHeightE400 error = default(ListXRPRippleTransactionsByBlockHeightE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40023 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40023 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40023 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40023 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40023);
        }

        /// <summary>
        /// Returns true if InlineResponse40023 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40023 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40023 input)
        {
            if (input == null)
            {
                return false;
