...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40023 : IEquatable<InlineResponse40023>, IValidatableObject
    {
        ...
        public InlineResponse40023(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListZilliqaTransactionsByBlockHeightE400 error = default(ListZilliqaTransactionsByBlockHeightE400))
        {
