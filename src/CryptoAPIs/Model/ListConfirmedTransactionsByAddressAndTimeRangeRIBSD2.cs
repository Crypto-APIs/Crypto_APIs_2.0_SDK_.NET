...
namespace CryptoAPIs.Model
{
    ...
    /// Dash
    /// </summary>
    [DataContract(Name = "ListConfirmedTransactionsByAddressAndTimeRangeRIBSD2")]
    public partial class ListConfirmedTransactionsByAddressAndTimeRangeRIBSD2 : IEquatable<ListConfirmedTransactionsByAddressAndTimeRangeRIBSD2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressAndTimeRangeRIBSD2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListConfirmedTransactionsByAddressAndTimeRangeRIBSD2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressAndTimeRangeRIBSD2" /> class.
        /// </summary>
        ...
        public ListConfirmedTransactionsByAddressAndTimeRangeRIBSD2(long locktime = default(long), int size = default(int), int version = default(int), List<ListConfirmedTransactionsByAddressRIBSD2VinInner> vin = default(List<ListConfirmedTransactionsByAddressRIBSD2VinInner>), List<ListConfirmedTransactionsByAddressRIBSD2VoutInner> vout = default(List<ListConfirmedTransactionsByAddressRIBSD2VoutInner>))
        {
            ...
            if (vin == null)
            {
                throw new ArgumentNullException("vin is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRIBSD2 and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null)
            {
                throw new ArgumentNullException("vout is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRIBSD2 and cannot be null");
            }
            this.Vout = vout;
        }
        ...
        public List<ListConfirmedTransactionsByAddressRIBSD2VinInner> Vin { get; set; }
        ...
        public List<ListConfirmedTransactionsByAddressRIBSD2VoutInner> Vout { get; set; }
        ...
        {
            return this.Equals(input as ListConfirmedTransactionsByAddressAndTimeRangeRIBSD2);
        }

        /// <summary>
        /// Returns true if ListConfirmedTransactionsByAddressAndTimeRangeRIBSD2 instances are equal
        /// </summary>
        /// <param name="input">Instance of ListConfirmedTransactionsByAddressAndTimeRangeRIBSD2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListConfirmedTransactionsByAddressAndTimeRangeRIBSD2 input)
        {
            if (input == null)
            {
                return false;
