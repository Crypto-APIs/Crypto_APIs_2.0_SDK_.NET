...
namespace CryptoAPIs.Model
{
    ...
    /// Dash
    /// </summary>
    [DataContract(Name = "ListTransactionsByAddressRIBSD2")]
    public partial class ListTransactionsByAddressRIBSD2 : IEquatable<ListTransactionsByAddressRIBSD2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressRIBSD2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByAddressRIBSD2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressRIBSD2" /> class.
        /// </summary>
        ...
        public ListTransactionsByAddressRIBSD2(int locktime = default(int), int size = default(int), int version = default(int), List<ListTransactionsByAddressRIBSD2Vin> vin = default(List<ListTransactionsByAddressRIBSD2Vin>), List<ListTransactionsByAddressRIBSD2Vout> vout = default(List<ListTransactionsByAddressRIBSD2Vout>))
        {
            this.Locktime = locktime;
            this.Size = size;
            this.Version = version;
            // to ensure "vin" is required (not null)
            this.Vin = vin ?? throw new ArgumentNullException("vin is a required property for ListTransactionsByAddressRIBSD2 and cannot be null");
            // to ensure "vout" is required (not null)
            this.Vout = vout ?? throw new ArgumentNullException("vout is a required property for ListTransactionsByAddressRIBSD2 and cannot be null");
        }
        ...
        public List<ListTransactionsByAddressRIBSD2Vin> Vin { get; set; }
        ...
        public List<ListTransactionsByAddressRIBSD2Vout> Vout { get; set; }
        ...
        {
            return this.Equals(input as ListTransactionsByAddressRIBSD2);
        }

        /// <summary>
        /// Returns true if ListTransactionsByAddressRIBSD2 instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByAddressRIBSD2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByAddressRIBSD2 input)
        {
            if (input == null)
                return false;
