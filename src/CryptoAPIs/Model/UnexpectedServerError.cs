...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UnexpectedServerError")]
    public partial class UnexpectedServerError : IEquatable<UnexpectedServerError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnexpectedServerError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UnexpectedServerError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UnexpectedServerError" /> class.
        /// </summary>
        ...
        public UnexpectedServerError(string apiVersion = default(string), string requestId = default(string), string context = default(string), UnexpectedServerErrorError error = default(UnexpectedServerErrorError))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for UnexpectedServerError and cannot be null");
            // to ensure "requestId" is required (not null)
            this.RequestId = requestId ?? throw new ArgumentNullException("requestId is a required property for UnexpectedServerError and cannot be null");
            // to ensure "error" is required (not null)
            this.Error = error ?? throw new ArgumentNullException("error is a required property for UnexpectedServerError and cannot be null");
        ...
        public UnexpectedServerErrorError Error { get; set; }
        ...
        {
            return this.Equals(input as UnexpectedServerError);
        }

        /// <summary>
        /// Returns true if UnexpectedServerError instances are equal
        /// </summary>
        /// <param name="input">Instance of UnexpectedServerError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnexpectedServerError input)
        {
            if (input == null)
                return false;
