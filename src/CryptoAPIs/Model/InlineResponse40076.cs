...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40076
    /// </summary>
    [DataContract(Name = "inline_response_400_76")]
    public partial class InlineResponse40076 : IEquatable<InlineResponse40076>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40076" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40076() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40076" /> class.
        /// </summary>
        ...
        public InlineResponse40076(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedCoinsTransactionsAndEachConfirmationE400 error = default(NewConfirmedCoinsTransactionsAndEachConfirmationE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40076 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40076 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40076 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40076 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40076);
        }

        /// <summary>
        /// Returns true if InlineResponse40076 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40076 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40076 input)
        {
            if (input == null)
            {
                return false;
