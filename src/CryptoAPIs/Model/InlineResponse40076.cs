...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40076 : IEquatable<InlineResponse40076>, IValidatableObject
    {
        ...
        public InlineResponse40076(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateAutomaticCoinsForwardingE400 error = default(CreateAutomaticCoinsForwardingE400))
        {
