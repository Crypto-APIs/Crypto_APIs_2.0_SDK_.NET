...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40027 : IEquatable<InlineResponse40027>, IValidatableObject
    {
        ...
        public InlineResponse40027(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetBlockDetailsByBlockHeightE400 error = default(GetBlockDetailsByBlockHeightE400))
        {
