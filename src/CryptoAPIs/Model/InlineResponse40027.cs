...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40027
    /// </summary>
    [DataContract(Name = "inline_response_400_27")]
    public partial class InlineResponse40027 : IEquatable<InlineResponse40027>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40027" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40027() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40027" /> class.
        /// </summary>
        ...
        public InlineResponse40027(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetXRPRippleBlockDetailsByBlockHeightE400 error = default(GetXRPRippleBlockDetailsByBlockHeightE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40027 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40027 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40027 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40027 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40027);
        }

        /// <summary>
        /// Returns true if InlineResponse40027 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40027 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40027 input)
        {
            if (input == null)
            {
                return false;
