...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListTransactionsByBlockHashRIRecipients : IEquatable<ListTransactionsByBlockHashRIRecipients>, IValidatableObject
    {
        ...
        public ListTransactionsByBlockHashRIRecipients(string address = default(string), string amount = default(string))
        {
            ...
            if (address == null) {
                throw new ArgumentNullException("address is a required property for ListTransactionsByBlockHashRIRecipients and cannot be null");
            }
            this.Address = address;
            // to ensure "amount" is required (not null)
            if (amount == null) {
                throw new ArgumentNullException("amount is a required property for ListTransactionsByBlockHashRIRecipients and cannot be null");
            }
            this.Amount = amount;
        }
