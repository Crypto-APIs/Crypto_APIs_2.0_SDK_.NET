...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(GetAddressDetailsE403JsonConverter))]
    [DataContract(Name = "GetAddressDetailsE403")]
    public partial class GetAddressDetailsE403 : AbstractOpenAPISchema, IEquatable<GetAddressDetailsE403>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressDetailsE403" /> class
        /// with the <see cref="BannedIpAddress" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BannedIpAddress.</param>
        public GetAddressDetailsE403(BannedIpAddress actualInstance)
        {
        ...
        public GetAddressDetailsE403(EndpointNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public GetAddressDetailsE403(EndpointNotAllowedForApiKey actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public GetAddressDetailsE403(FeatureMainnetsNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAddressDetailsE403 {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, GetAddressDetailsE403.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of GetAddressDetailsE403
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of GetAddressDetailsE403</returns>
        public static GetAddressDetailsE403 FromJson(string jsonString)
        {
            GetAddressDetailsE403 newGetAddressDetailsE403 = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newGetAddressDetailsE403;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newGetAddressDetailsE403 = new GetAddressDetailsE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, GetAddressDetailsE403.SerializerSettings));
                }
                else
                {
                    newGetAddressDetailsE403 = new GetAddressDetailsE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, GetAddressDetailsE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newGetAddressDetailsE403 = new GetAddressDetailsE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, GetAddressDetailsE403.SerializerSettings));
                }
                else
                {
                    newGetAddressDetailsE403 = new GetAddressDetailsE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, GetAddressDetailsE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newGetAddressDetailsE403 = new GetAddressDetailsE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, GetAddressDetailsE403.SerializerSettings));
                }
                else
                {
                    newGetAddressDetailsE403 = new GetAddressDetailsE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, GetAddressDetailsE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newGetAddressDetailsE403 = new GetAddressDetailsE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, GetAddressDetailsE403.SerializerSettings));
                }
                else
                {
                    newGetAddressDetailsE403 = new GetAddressDetailsE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, GetAddressDetailsE403.AdditionalPropertiesSerializerSettings));
                }
        ...
        {
            return this.Equals(input as GetAddressDetailsE403);
        }

        /// <summary>
        /// Returns true if GetAddressDetailsE403 instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAddressDetailsE403 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAddressDetailsE403 input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for GetAddressDetailsE403
    /// </summary>
    public class GetAddressDetailsE403JsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(GetAddressDetailsE403).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return GetAddressDetailsE403.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
