...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40336
    /// </summary>
    [DataContract(Name = "inline_response_403_36")]
    public partial class InlineResponse40336 : IEquatable<InlineResponse40336>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40336" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40336() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40336" /> class.
        /// </summary>
        ...
        public InlineResponse40336(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateFungibleTokensTransactionRequestFromAddressE403 error = default(CreateFungibleTokensTransactionRequestFromAddressE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40336 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40336 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40336 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40336 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40336);
        }

        /// <summary>
        /// Returns true if InlineResponse40336 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40336 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40336 input)
        {
            if (input == null)
            {
                return false;
