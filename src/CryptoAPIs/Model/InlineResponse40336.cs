...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40336 : IEquatable<InlineResponse40336>, IValidatableObject
    {
        ...
        public InlineResponse40336(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetWalletAssetDetailsE403 error = default(GetWalletAssetDetailsE403))
        {
