...
namespace CryptoAPIs.Model
{
    ...
    /// Zilliqa
    /// </summary>
    [DataContract(Name = "GetBlockDetailsByBlockHeightRIBSZ2")]
    public partial class GetBlockDetailsByBlockHeightRIBSZ2 : IEquatable<GetBlockDetailsByBlockHeightRIBSZ2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHeightRIBSZ2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetBlockDetailsByBlockHeightRIBSZ2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHeightRIBSZ2" /> class.
        /// </summary>
        ...
        public GetBlockDetailsByBlockHeightRIBSZ2(string difficulty = default(string), int dsBlock = default(int), string dsDifficulty = default(string), string dsLeader = default(string), int gasLimit = default(int), int gasUsed = default(int), List<string> microBlocks = default(List<string>))
        {
            // to ensure "difficulty" is required (not null)
            if (difficulty == null)
            {
                throw new ArgumentNullException("difficulty is a required property for GetBlockDetailsByBlockHeightRIBSZ2 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("dsDifficulty is a required property for GetBlockDetailsByBlockHeightRIBSZ2 and cannot be null");
            }
            this.DsDifficulty = dsDifficulty;
            // to ensure "dsLeader" is required (not null)
            if (dsLeader == null)
            {
                throw new ArgumentNullException("dsLeader is a required property for GetBlockDetailsByBlockHeightRIBSZ2 and cannot be null");
            }
            ...
            if (microBlocks == null)
            {
                throw new ArgumentNullException("microBlocks is a required property for GetBlockDetailsByBlockHeightRIBSZ2 and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetBlockDetailsByBlockHeightRIBSZ2 {\n");
        ...
        {
            return this.Equals(input as GetBlockDetailsByBlockHeightRIBSZ2);
        }

        /// <summary>
        /// Returns true if GetBlockDetailsByBlockHeightRIBSZ2 instances are equal
        /// </summary>
        /// <param name="input">Instance of GetBlockDetailsByBlockHeightRIBSZ2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetBlockDetailsByBlockHeightRIBSZ2 input)
        {
            if (input == null)
            {
                return false;
