...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40019 : IEquatable<InlineResponse40019>, IValidatableObject
    {
        ...
        public InlineResponse40019(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListXRPRippleTransactionsByBlockHashE400 error = default(ListXRPRippleTransactionsByBlockHashE400))
        {
