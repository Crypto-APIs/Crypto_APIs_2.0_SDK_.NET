...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40019
    /// </summary>
    [DataContract(Name = "inline_response_400_19")]
    public partial class InlineResponse40019 : IEquatable<InlineResponse40019>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40019" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40019() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40019" /> class.
        /// </summary>
        ...
        public InlineResponse40019(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetUnconfirmedOmniTransactionByTransactionIDTxidE400 error = default(GetUnconfirmedOmniTransactionByTransactionIDTxidE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40019 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40019 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40019 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40019 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40019);
        }

        /// <summary>
        /// Returns true if InlineResponse40019 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40019 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40019 input)
        {
            if (input == null)
            {
                return false;
