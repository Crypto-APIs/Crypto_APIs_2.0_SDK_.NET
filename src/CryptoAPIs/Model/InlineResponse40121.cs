...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40121
    /// </summary>
    [DataContract(Name = "inline_response_401_21")]
    public partial class InlineResponse40121 : IEquatable<InlineResponse40121>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40121" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40121() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40121" /> class.
        /// </summary>
        ...
        public InlineResponse40121(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateCoinsTransactionRequestFromAddressE401 error = default(CreateCoinsTransactionRequestFromAddressE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40121 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40121 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40121 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40121 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40121);
        }

        /// <summary>
        /// Returns true if InlineResponse40121 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40121 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40121 input)
        {
            if (input == null)
            {
                return false;
