...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40121 : IEquatable<InlineResponse40121>, IValidatableObject
    {
        ...
        public InlineResponse40121(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListZilliqaTransactionsByBlockHashE401 error = default(ListZilliqaTransactionsByBlockHashE401))
        {
