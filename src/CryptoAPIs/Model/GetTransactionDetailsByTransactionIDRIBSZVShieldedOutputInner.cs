...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetTransactionDetailsByTransactionIDRIBSZ_vShieldedOutput_inner")]
    public partial class GetTransactionDetailsByTransactionIDRIBSZVShieldedOutputInner : IEquatable<GetTransactionDetailsByTransactionIDRIBSZVShieldedOutputInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDRIBSZVShieldedOutputInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetTransactionDetailsByTransactionIDRIBSZVShieldedOutputInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDRIBSZVShieldedOutputInner" /> class.
        /// </summary>
        ...
        public GetTransactionDetailsByTransactionIDRIBSZVShieldedOutputInner(string cmu = default(string), string cv = default(string), string encCipherText = default(string), string ephemeralKey = default(string), string outCipherText = default(string), string proof = default(string))
        {
            // to ensure "cmu" is required (not null)
            if (cmu == null)
            {
                throw new ArgumentNullException("cmu is a required property for GetTransactionDetailsByTransactionIDRIBSZVShieldedOutputInner and cannot be null");
            }
            this.Cmu = cmu;
            // to ensure "cv" is required (not null)
            if (cv == null)
            {
                throw new ArgumentNullException("cv is a required property for GetTransactionDetailsByTransactionIDRIBSZVShieldedOutputInner and cannot be null");
            }
            this.Cv = cv;
            // to ensure "encCipherText" is required (not null)
            if (encCipherText == null)
            {
                throw new ArgumentNullException("encCipherText is a required property for GetTransactionDetailsByTransactionIDRIBSZVShieldedOutputInner and cannot be null");
            }
            this.EncCipherText = encCipherText;
            // to ensure "ephemeralKey" is required (not null)
            if (ephemeralKey == null)
            {
                throw new ArgumentNullException("ephemeralKey is a required property for GetTransactionDetailsByTransactionIDRIBSZVShieldedOutputInner and cannot be null");
            }
            this.EphemeralKey = ephemeralKey;
            // to ensure "outCipherText" is required (not null)
            if (outCipherText == null)
            {
                throw new ArgumentNullException("outCipherText is a required property for GetTransactionDetailsByTransactionIDRIBSZVShieldedOutputInner and cannot be null");
            }
            this.OutCipherText = outCipherText;
            // to ensure "proof" is required (not null)
            if (proof == null)
            {
                throw new ArgumentNullException("proof is a required property for GetTransactionDetailsByTransactionIDRIBSZVShieldedOutputInner and cannot be null");
            }
            this.Proof = proof;
        }
        ...
        {
            return this.Equals(input as GetTransactionDetailsByTransactionIDRIBSZVShieldedOutputInner);
        }

        /// <summary>
        /// Returns true if GetTransactionDetailsByTransactionIDRIBSZVShieldedOutputInner instances are equal
        /// </summary>
        /// <param name="input">Instance of GetTransactionDetailsByTransactionIDRIBSZVShieldedOutputInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetTransactionDetailsByTransactionIDRIBSZVShieldedOutputInner input)
        {
            if (input == null)
            {
                return false;
