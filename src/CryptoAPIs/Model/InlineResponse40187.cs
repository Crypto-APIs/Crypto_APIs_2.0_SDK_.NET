...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40187 : IEquatable<InlineResponse40187>, IValidatableObject
    {
        ...
        public InlineResponse40187(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetExchangeRateByAssetSymbolsE401 error = default(GetExchangeRateByAssetSymbolsE401))
        {
