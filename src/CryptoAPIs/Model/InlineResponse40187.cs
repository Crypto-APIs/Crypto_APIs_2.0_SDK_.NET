...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40187
    /// </summary>
    [DataContract(Name = "inline_response_401_87")]
    public partial class InlineResponse40187 : IEquatable<InlineResponse40187>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40187" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40187() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40187" /> class.
        /// </summary>
        ...
        public InlineResponse40187(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedInternalTransactionsE401 error = default(NewConfirmedInternalTransactionsE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40187 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40187 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40187 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40187 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40187);
        }

        /// <summary>
        /// Returns true if InlineResponse40187 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40187 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40187 input)
        {
            if (input == null)
            {
                return false;
