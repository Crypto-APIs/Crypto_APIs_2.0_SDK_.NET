...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40350 : IEquatable<InlineResponse40350>, IValidatableObject
    {
        ...
        public InlineResponse40350(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetHDWalletXPubYPubZPubAssetsE403 error = default(GetHDWalletXPubYPubZPubAssetsE403))
        {
