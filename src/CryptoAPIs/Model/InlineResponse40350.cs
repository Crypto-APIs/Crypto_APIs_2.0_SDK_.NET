...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40350
    /// </summary>
    [DataContract(Name = "inline_response_403_50")]
    public partial class InlineResponse40350 : IEquatable<InlineResponse40350>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40350" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40350() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40350" /> class.
        /// </summary>
        ...
        public InlineResponse40350(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetInternalTransactionByTransactionHashAndOperationIdE403 error = default(GetInternalTransactionByTransactionHashAndOperationIdE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40350 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40350 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40350 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40350 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40350);
        }

        /// <summary>
        /// Returns true if InlineResponse40350 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40350 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40350 input)
        {
            if (input == null)
            {
                return false;
