...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetLastMinedBlockRIBSE : IEquatable<GetLastMinedBlockRIBSE>, IValidatableObject
    {
        ...
        public GetLastMinedBlockRIBSE(string difficulty = default(string), string nonce = default(string), int size = default(int), string extraData = default(string), string gasLimit = default(string), string gasUsed = default(string), int minedInSeconds = default(int), string sha3Uncles = default(string), string totalDifficulty = default(string), List<string> uncles = default(List<string>))
        {
