...
namespace CryptoAPIs.Model
{
    ...
    /// Ethereum
    /// </summary>
    [DataContract(Name = "GetLastMinedBlockRIBSE")]
    public partial class GetLastMinedBlockRIBSE : IEquatable<GetLastMinedBlockRIBSE>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLastMinedBlockRIBSE" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetLastMinedBlockRIBSE() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLastMinedBlockRIBSE" /> class.
        /// </summary>
        ...
        public GetLastMinedBlockRIBSE(string difficulty = default(string), string extraData = default(string), string gasLimit = default(string), string gasUsed = default(string), int minedInSeconds = default(int), string nonce = default(string), string sha3Uncles = default(string), int size = default(int), string totalDifficulty = default(string), List<string> uncles = default(List<string>))
        {
            // to ensure "difficulty" is required (not null)
            if (difficulty == null)
            {
                throw new ArgumentNullException("difficulty is a required property for GetLastMinedBlockRIBSE and cannot be null");
            }
            this.Difficulty = difficulty;
            // to ensure "extraData" is required (not null)
            if (extraData == null)
            {
                throw new ArgumentNullException("extraData is a required property for GetLastMinedBlockRIBSE and cannot be null");
            }
            this.ExtraData = extraData;
            // to ensure "gasLimit" is required (not null)
            if (gasLimit == null)
            {
                throw new ArgumentNullException("gasLimit is a required property for GetLastMinedBlockRIBSE and cannot be null");
            }
            this.GasLimit = gasLimit;
            // to ensure "gasUsed" is required (not null)
            if (gasUsed == null)
            {
                throw new ArgumentNullException("gasUsed is a required property for GetLastMinedBlockRIBSE and cannot be null");
            }
            ...
            if (nonce == null)
            {
                throw new ArgumentNullException("nonce is a required property for GetLastMinedBlockRIBSE and cannot be null");
            }
            this.Nonce = nonce;
            // to ensure "sha3Uncles" is required (not null)
            if (sha3Uncles == null)
            {
                throw new ArgumentNullException("sha3Uncles is a required property for GetLastMinedBlockRIBSE and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("totalDifficulty is a required property for GetLastMinedBlockRIBSE and cannot be null");
            }
            this.TotalDifficulty = totalDifficulty;
            // to ensure "uncles" is required (not null)
            if (uncles == null)
            {
                throw new ArgumentNullException("uncles is a required property for GetLastMinedBlockRIBSE and cannot be null");
            }
            this.Uncles = uncles;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetLastMinedBlockRIBSE {\n");
        ...
        {
            return this.Equals(input as GetLastMinedBlockRIBSE);
        }

        /// <summary>
        /// Returns true if GetLastMinedBlockRIBSE instances are equal
        /// </summary>
        /// <param name="input">Instance of GetLastMinedBlockRIBSE to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetLastMinedBlockRIBSE input)
        {
            if (input == null)
            {
                return false;
