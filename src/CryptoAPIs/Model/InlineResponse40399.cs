...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40399
    /// </summary>
    [DataContract(Name = "inline_response_403_99")]
    public partial class InlineResponse40399 : IEquatable<InlineResponse40399>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40399" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40399() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40399" /> class.
        /// </summary>
        ...
        public InlineResponse40399(string apiVersion = default(string), string requestId = default(string), string context = default(string), BroadcastLocallySignedTransactionE403 error = default(BroadcastLocallySignedTransactionE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40399 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40399 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40399 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40399 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40399);
        }

        /// <summary>
        /// Returns true if InlineResponse40399 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40399 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40399 input)
        {
            if (input == null)
            {
                return false;
