...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4096
    /// </summary>
    [DataContract(Name = "inline_response_409_6")]
    public partial class InlineResponse4096 : IEquatable<InlineResponse4096>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4096" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse4096() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4096" /> class.
        /// </summary>
        ...
        public InlineResponse4096(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewUnconfirmedCoinsTransactionsE409 error = default(NewUnconfirmedCoinsTransactionsE409))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4096 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4096 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse4096 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse4096);
        }

        /// <summary>
        /// Returns true if InlineResponse4096 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4096 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4096 input)
        {
            if (input == null)
            {
                return false;
