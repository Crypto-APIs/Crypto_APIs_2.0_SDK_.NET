...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40038 : IEquatable<InlineResponse40038>, IValidatableObject
    {
        ...
        public InlineResponse40038(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListAllAssetsFromAllWalletsE400 error = default(ListAllAssetsFromAllWalletsE400))
        {
