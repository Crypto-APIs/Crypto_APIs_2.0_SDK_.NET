...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40038
    /// </summary>
    [DataContract(Name = "inline_response_400_38")]
    public partial class InlineResponse40038 : IEquatable<InlineResponse40038>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40038" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40038() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40038" /> class.
        /// </summary>
        ...
        public InlineResponse40038(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListOmniTransactionsByBlockHeightE400 error = default(ListOmniTransactionsByBlockHeightE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40038 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40038 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40038 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40038 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40038);
        }

        /// <summary>
        /// Returns true if InlineResponse40038 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40038 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40038 input)
        {
            if (input == null)
            {
                return false;
