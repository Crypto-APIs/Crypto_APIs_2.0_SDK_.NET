...
namespace CryptoAPIs.Model
{
    ...
    /// Dash
    /// </summary>
    [DataContract(Name = "ListTransactionsByBlockHeightRIBSD")]
    public partial class ListTransactionsByBlockHeightRIBSD : IEquatable<ListTransactionsByBlockHeightRIBSD>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHeightRIBSD" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByBlockHeightRIBSD() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHeightRIBSD" /> class.
        /// </summary>
        ...
        public ListTransactionsByBlockHeightRIBSD(int locktime = default(int), int size = default(int), int version = default(int), List<ListTransactionsByBlockHeightRIBSDVin> vin = default(List<ListTransactionsByBlockHeightRIBSDVin>), List<ListTransactionsByBlockHeightRIBSDVout> vout = default(List<ListTransactionsByBlockHeightRIBSDVout>))
        {
            this.Locktime = locktime;
            this.Size = size;
            this.Version = version;
            // to ensure "vin" is required (not null)
            this.Vin = vin ?? throw new ArgumentNullException("vin is a required property for ListTransactionsByBlockHeightRIBSD and cannot be null");
            // to ensure "vout" is required (not null)
            this.Vout = vout ?? throw new ArgumentNullException("vout is a required property for ListTransactionsByBlockHeightRIBSD and cannot be null");
        }
        ...
        {
            return this.Equals(input as ListTransactionsByBlockHeightRIBSD);
        }

        /// <summary>
        /// Returns true if ListTransactionsByBlockHeightRIBSD instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByBlockHeightRIBSD to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByBlockHeightRIBSD input)
        {
            if (input == null)
                return false;
