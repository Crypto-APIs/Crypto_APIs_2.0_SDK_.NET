...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40164 : IEquatable<InlineResponse40164>, IValidatableObject
    {
        ...
        public InlineResponse40164(string apiVersion = default(string), string requestId = default(string), string context = default(string), MinedTransactionE401 error = default(MinedTransactionE401))
        {
