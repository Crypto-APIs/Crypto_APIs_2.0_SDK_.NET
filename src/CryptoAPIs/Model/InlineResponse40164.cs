...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40164
    /// </summary>
    [DataContract(Name = "inline_response_401_64")]
    public partial class InlineResponse40164 : IEquatable<InlineResponse40164>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40164" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40164() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40164" /> class.
        /// </summary>
        ...
        public InlineResponse40164(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListConfirmedTokensTransfersByAddressE401 error = default(ListConfirmedTokensTransfersByAddressE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40164 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40164 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40164 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40164 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40164);
        }

        /// <summary>
        /// Returns true if InlineResponse40164 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40164 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40164 input)
        {
            if (input == null)
            {
                return false;
