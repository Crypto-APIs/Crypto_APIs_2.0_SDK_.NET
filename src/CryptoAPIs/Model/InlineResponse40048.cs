...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40048
    /// </summary>
    [DataContract(Name = "inline_response_400_48")]
    public partial class InlineResponse40048 : IEquatable<InlineResponse40048>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40048" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40048() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40048" /> class.
        /// </summary>
        ...
        public InlineResponse40048(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListInternalTransactionDetailsByTransactionHashE400 error = default(ListInternalTransactionDetailsByTransactionHashE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40048 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40048 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40048 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40048 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40048);
        }

        /// <summary>
        /// Returns true if InlineResponse40048 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40048 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40048 input)
        {
            if (input == null)
            {
                return false;
