...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40048 : IEquatable<InlineResponse40048>, IValidatableObject
    {
        ...
        public InlineResponse40048(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListWalletTransactionsE400 error = default(ListWalletTransactionsE400))
        {
