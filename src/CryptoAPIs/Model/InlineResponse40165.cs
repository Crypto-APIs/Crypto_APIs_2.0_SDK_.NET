...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40165
    /// </summary>
    [DataContract(Name = "inline_response_401_65")]
    public partial class InlineResponse40165 : IEquatable<InlineResponse40165>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40165" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40165() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40165" /> class.
        /// </summary>
        ...
        public InlineResponse40165(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetRawTransactionDataE401 error = default(GetRawTransactionDataE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40165 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40165 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40165 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40165 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40165);
        }

        /// <summary>
        /// Returns true if InlineResponse40165 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40165 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40165 input)
        {
            if (input == null)
            {
                return false;
