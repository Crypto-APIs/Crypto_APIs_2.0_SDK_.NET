...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40165 : IEquatable<InlineResponse40165>, IValidatableObject
    {
        ...
        public InlineResponse40165(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewBlockE401 error = default(NewBlockE401))
        {
