...
namespace CryptoAPIs.Model
{
    ...
    /// NewBlockR
    /// </summary>
    [DataContract(Name = "NewBlockR")]
    public partial class NewBlockR : IEquatable<NewBlockR>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewBlockR" /> class.
        /// </summary>
        ...
        public NewBlockR(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewBlockRData data = default(NewBlockRData))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for NewBlockR and cannot be null");
            // to ensure "requestId" is required (not null)
            this.RequestId = requestId ?? throw new ArgumentNullException("requestId is a required property for NewBlockR and cannot be null");
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for NewBlockR and cannot be null");
        ...
        public NewBlockRData Data { get; set; }
        ...
        {
            return this.Equals(input as NewBlockR);
        }

        /// <summary>
        /// Returns true if NewBlockR instances are equal
        /// </summary>
        /// <param name="input">Instance of NewBlockR to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewBlockR input)
        {
            if (input == null)
                return false;
