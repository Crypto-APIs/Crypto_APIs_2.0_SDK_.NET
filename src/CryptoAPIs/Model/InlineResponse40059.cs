...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40059 : IEquatable<InlineResponse40059>, IValidatableObject
    {
        ...
        public InlineResponse40059(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewUnconfirmedTokensTransactionsE400 error = default(NewUnconfirmedTokensTransactionsE400))
        {
