...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40059
    /// </summary>
    [DataContract(Name = "inline_response_400_59")]
    public partial class InlineResponse40059 : IEquatable<InlineResponse40059>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40059" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40059() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40059" /> class.
        /// </summary>
        ...
        public InlineResponse40059(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListUnspentTransactionOutputsByAddressE400 error = default(ListUnspentTransactionOutputsByAddressE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40059 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40059 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40059 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40059 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40059);
        }

        /// <summary>
        /// Returns true if InlineResponse40059 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40059 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40059 input)
        {
            if (input == null)
            {
                return false;
