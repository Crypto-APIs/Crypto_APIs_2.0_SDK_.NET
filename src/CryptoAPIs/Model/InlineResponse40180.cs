...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40180 : IEquatable<InlineResponse40180>, IValidatableObject
    {
        ...
        public InlineResponse40180(string apiVersion = default(string), string requestId = default(string), string context = default(string), AddTokensToExistingFromAddressE401 error = default(AddTokensToExistingFromAddressE401))
        {
