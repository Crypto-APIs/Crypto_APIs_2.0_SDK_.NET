...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40180
    /// </summary>
    [DataContract(Name = "inline_response_401_80")]
    public partial class InlineResponse40180 : IEquatable<InlineResponse40180>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40180" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40180() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40180" /> class.
        /// </summary>
        ...
        public InlineResponse40180(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetBlockchainEventSubscriptionDetailsByReferenceIDE401 error = default(GetBlockchainEventSubscriptionDetailsByReferenceIDE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40180 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40180 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40180 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40180 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40180);
        }

        /// <summary>
        /// Returns true if InlineResponse40180 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40180 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40180 input)
        {
            if (input == null)
            {
                return false;
