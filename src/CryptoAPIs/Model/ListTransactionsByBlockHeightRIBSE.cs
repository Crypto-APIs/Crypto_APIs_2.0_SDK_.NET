...
namespace CryptoAPIs.Model
{
    ...
    /// Ethereum
    /// </summary>
    [DataContract(Name = "ListTransactionsByBlockHeightRIBSE")]
    public partial class ListTransactionsByBlockHeightRIBSE : IEquatable<ListTransactionsByBlockHeightRIBSE>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHeightRIBSE" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByBlockHeightRIBSE() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHeightRIBSE" /> class.
        /// </summary>
        ...
        public ListTransactionsByBlockHeightRIBSE(string contract = default(string), string gasLimit = default(string), GetTransactionDetailsByTransactionIDRIBSEGasPrice gasPrice = default(GetTransactionDetailsByTransactionIDRIBSEGasPrice), string gasUsed = default(string), string inputData = default(string), int nonce = default(int), string transactionStatus = default(string))
        {
            // to ensure "contract" is required (not null)
            this.Contract = contract ?? throw new ArgumentNullException("contract is a required property for ListTransactionsByBlockHeightRIBSE and cannot be null");
            // to ensure "gasLimit" is required (not null)
            this.GasLimit = gasLimit ?? throw new ArgumentNullException("gasLimit is a required property for ListTransactionsByBlockHeightRIBSE and cannot be null");
            // to ensure "gasPrice" is required (not null)
            this.GasPrice = gasPrice ?? throw new ArgumentNullException("gasPrice is a required property for ListTransactionsByBlockHeightRIBSE and cannot be null");
            // to ensure "gasUsed" is required (not null)
            this.GasUsed = gasUsed ?? throw new ArgumentNullException("gasUsed is a required property for ListTransactionsByBlockHeightRIBSE and cannot be null");
            // to ensure "inputData" is required (not null)
            this.InputData = inputData ?? throw new ArgumentNullException("inputData is a required property for ListTransactionsByBlockHeightRIBSE and cannot be null");
            this.Nonce = nonce;
            // to ensure "transactionStatus" is required (not null)
            this.TransactionStatus = transactionStatus ?? throw new ArgumentNullException("transactionStatus is a required property for ListTransactionsByBlockHeightRIBSE and cannot be null");
        }
        ...
        {
            return this.Equals(input as ListTransactionsByBlockHeightRIBSE);
        }

        /// <summary>
        /// Returns true if ListTransactionsByBlockHeightRIBSE instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByBlockHeightRIBSE to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByBlockHeightRIBSE input)
        {
            if (input == null)
                return false;
