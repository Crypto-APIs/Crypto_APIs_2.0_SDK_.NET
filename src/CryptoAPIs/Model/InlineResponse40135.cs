...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40135
    /// </summary>
    [DataContract(Name = "inline_response_401_35")]
    public partial class InlineResponse40135 : IEquatable<InlineResponse40135>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40135" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40135() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40135" /> class.
        /// </summary>
        ...
        public InlineResponse40135(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetWalletAssetDetailsE401 error = default(GetWalletAssetDetailsE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40135 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40135 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40135 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40135 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40135);
        }

        /// <summary>
        /// Returns true if InlineResponse40135 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40135 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40135 input)
        {
            if (input == null)
            {
                return false;
