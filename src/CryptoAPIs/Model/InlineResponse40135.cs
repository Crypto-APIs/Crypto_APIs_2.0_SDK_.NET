...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40135 : IEquatable<InlineResponse40135>, IValidatableObject
    {
        ...
        public InlineResponse40135(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListSupportedTokensE401 error = default(ListSupportedTokensE401))
        {
