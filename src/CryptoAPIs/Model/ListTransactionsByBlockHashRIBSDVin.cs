...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListTransactionsByBlockHashRIBSD_vin")]
    public partial class ListTransactionsByBlockHashRIBSDVin : IEquatable<ListTransactionsByBlockHashRIBSDVin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashRIBSDVin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByBlockHashRIBSDVin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashRIBSDVin" /> class.
        /// </summary>
        ...
        public ListTransactionsByBlockHashRIBSDVin(List<string> addresses = default(List<string>), string coinbase = default(string), GetTransactionDetailsByTransactionIDRIBSDScriptSig scriptSig = default(GetTransactionDetailsByTransactionIDRIBSDScriptSig), string sequence = default(string), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            this.Addresses = addresses ?? throw new ArgumentNullException("addresses is a required property for ListTransactionsByBlockHashRIBSDVin and cannot be null");
            // to ensure "scriptSig" is required (not null)
            this.ScriptSig = scriptSig ?? throw new ArgumentNullException("scriptSig is a required property for ListTransactionsByBlockHashRIBSDVin and cannot be null");
            // to ensure "sequence" is required (not null)
            this.Sequence = sequence ?? throw new ArgumentNullException("sequence is a required property for ListTransactionsByBlockHashRIBSDVin and cannot be null");
            // to ensure "txinwitness" is required (not null)
            this.Txinwitness = txinwitness ?? throw new ArgumentNullException("txinwitness is a required property for ListTransactionsByBlockHashRIBSDVin and cannot be null");
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for ListTransactionsByBlockHashRIBSDVin and cannot be null");
        ...
        {
            return this.Equals(input as ListTransactionsByBlockHashRIBSDVin);
        }

        /// <summary>
        /// Returns true if ListTransactionsByBlockHashRIBSDVin instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByBlockHashRIBSDVin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByBlockHashRIBSDVin input)
        {
            if (input == null)
                return false;
