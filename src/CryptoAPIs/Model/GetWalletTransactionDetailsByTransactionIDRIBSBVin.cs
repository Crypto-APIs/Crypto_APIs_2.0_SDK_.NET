...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetWalletTransactionDetailsByTransactionIDRIBSB_vin")]
    public partial class GetWalletTransactionDetailsByTransactionIDRIBSBVin : IEquatable<GetWalletTransactionDetailsByTransactionIDRIBSBVin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWalletTransactionDetailsByTransactionIDRIBSBVin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetWalletTransactionDetailsByTransactionIDRIBSBVin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWalletTransactionDetailsByTransactionIDRIBSBVin" /> class.
        /// </summary>
        ...
        public GetWalletTransactionDetailsByTransactionIDRIBSBVin(List<string> addresses = default(List<string>), string coinbase = default(string), GetWalletTransactionDetailsByTransactionIDRIBSBScriptSig scriptSig = default(GetWalletTransactionDetailsByTransactionIDRIBSBScriptSig), int sequence = default(int), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            if (addresses == null) {
                throw new ArgumentNullException("addresses is a required property for GetWalletTransactionDetailsByTransactionIDRIBSBVin and cannot be null");
            }
            this.Addresses = addresses;
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null) {
                throw new ArgumentNullException("scriptSig is a required property for GetWalletTransactionDetailsByTransactionIDRIBSBVin and cannot be null");
            }
            this.ScriptSig = scriptSig;
            this.Sequence = sequence;
            // to ensure "txid" is required (not null)
            if (txid == null) {
                throw new ArgumentNullException("txid is a required property for GetWalletTransactionDetailsByTransactionIDRIBSBVin and cannot be null");
            }
            this.Txid = txid;
            this.Vout = vout;
        ...
        public GetWalletTransactionDetailsByTransactionIDRIBSBScriptSig ScriptSig { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetWalletTransactionDetailsByTransactionIDRIBSBVin {\n");
        ...
        {
            return this.Equals(input as GetWalletTransactionDetailsByTransactionIDRIBSBVin);
        }

        /// <summary>
        /// Returns true if GetWalletTransactionDetailsByTransactionIDRIBSBVin instances are equal
        /// </summary>
        /// <param name="input">Instance of GetWalletTransactionDetailsByTransactionIDRIBSBVin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetWalletTransactionDetailsByTransactionIDRIBSBVin input)
        {
            if (input == null)
            {
                return false;
