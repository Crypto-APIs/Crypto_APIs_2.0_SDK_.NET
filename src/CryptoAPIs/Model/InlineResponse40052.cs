...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40052
    /// </summary>
    [DataContract(Name = "inline_response_400_52")]
    public partial class InlineResponse40052 : IEquatable<InlineResponse40052>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40052" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40052() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40052" /> class.
        /// </summary>
        ...
        public InlineResponse40052(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListInternalTransactionDetailsByTransactionHashE400 error = default(ListInternalTransactionDetailsByTransactionHashE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40052 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40052 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40052 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40052 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40052);
        }

        /// <summary>
        /// Returns true if InlineResponse40052 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40052 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40052 input)
        {
            if (input == null)
            {
                return false;
