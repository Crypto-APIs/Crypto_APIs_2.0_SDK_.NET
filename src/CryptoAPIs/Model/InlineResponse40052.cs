...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40052 : IEquatable<InlineResponse40052>, IValidatableObject
    {
        ...
        public InlineResponse40052(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListUnspentTransactionOutputsByAddressE400 error = default(ListUnspentTransactionOutputsByAddressE400))
        {
