...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40118 : IEquatable<InlineResponse40118>, IValidatableObject
    {
        ...
        public InlineResponse40118(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTransactionsByBlockHashE401 error = default(ListTransactionsByBlockHashE401))
        {
