...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40118
    /// </summary>
    [DataContract(Name = "inline_response_401_18")]
    public partial class InlineResponse40118 : IEquatable<InlineResponse40118>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40118" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40118() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40118" /> class.
        /// </summary>
        ...
        public InlineResponse40118(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListXRPRippleTransactionsByBlockHashE401 error = default(ListXRPRippleTransactionsByBlockHashE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40118 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40118 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40118 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40118 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40118);
        }

        /// <summary>
        /// Returns true if InlineResponse40118 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40118 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40118 input)
        {
            if (input == null)
            {
                return false;
