...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BlockHeightReachedRB_data_item")]
    public partial class BlockHeightReachedRBDataItem : IEquatable<BlockHeightReachedRBDataItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BlockHeightReachedRBDataItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BlockHeightReachedRBDataItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BlockHeightReachedRBDataItem" /> class.
        /// </summary>
        ...
        public BlockHeightReachedRBDataItem(bool allowDuplicates = false, long blockHeightReached = default(long), string callbackSecretKey = default(string), string callbackUrl = default(string))
        {
            this.BlockHeightReached = blockHeightReached;
            // to ensure "callbackUrl" is required (not null)
            if (callbackUrl == null)
            {
                throw new ArgumentNullException("callbackUrl is a required property for BlockHeightReachedRBDataItem and cannot be null");
            }
        ...
        {
            return this.Equals(input as BlockHeightReachedRBDataItem);
        }

        /// <summary>
        /// Returns true if BlockHeightReachedRBDataItem instances are equal
        /// </summary>
        /// <param name="input">Instance of BlockHeightReachedRBDataItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BlockHeightReachedRBDataItem input)
        {
            if (input == null)
            {
                return false;
