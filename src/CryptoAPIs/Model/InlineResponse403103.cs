...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_403_103")]
    public partial class InlineResponse403103 : IEquatable<InlineResponse403103>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse403103" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse403103() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse403103" /> class.
        /// </summary>
        ...
        public InlineResponse403103(string apiVersion = default(string), string requestId = default(string), string context = default(string), DecodeXAddressE403 error = default(DecodeXAddressE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse403103 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse403103 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse403103 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse403103 {\n");
        ...
        {
            return this.Equals(input as InlineResponse403103);
        }

        /// <summary>
        /// Returns true if InlineResponse403103 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse403103 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse403103 input)
        {
            if (input == null)
            {
                return false;
