...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListAllAssetsFromAllWalletsRI_fungibleTokens_inner")]
    public partial class ListAllAssetsFromAllWalletsRIFungibleTokensInner : IEquatable<ListAllAssetsFromAllWalletsRIFungibleTokensInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllAssetsFromAllWalletsRIFungibleTokensInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListAllAssetsFromAllWalletsRIFungibleTokensInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllAssetsFromAllWalletsRIFungibleTokensInner" /> class.
        /// </summary>
        ...
        public ListAllAssetsFromAllWalletsRIFungibleTokensInner(string amount = default(string), string blockchain = default(string), string identifier = default(string), string network = default(string), string symbol = default(string), string type = default(string))
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for ListAllAssetsFromAllWalletsRIFungibleTokensInner and cannot be null");
            }
            this.Amount = amount;
            // to ensure "blockchain" is required (not null)
            if (blockchain == null)
            {
                throw new ArgumentNullException("blockchain is a required property for ListAllAssetsFromAllWalletsRIFungibleTokensInner and cannot be null");
            }
            this.Blockchain = blockchain;
            // to ensure "identifier" is required (not null)
            if (identifier == null)
            {
                throw new ArgumentNullException("identifier is a required property for ListAllAssetsFromAllWalletsRIFungibleTokensInner and cannot be null");
            }
            this.Identifier = identifier;
            // to ensure "network" is required (not null)
            if (network == null)
            {
                throw new ArgumentNullException("network is a required property for ListAllAssetsFromAllWalletsRIFungibleTokensInner and cannot be null");
            }
            this.Network = network;
            // to ensure "symbol" is required (not null)
            if (symbol == null)
            {
                throw new ArgumentNullException("symbol is a required property for ListAllAssetsFromAllWalletsRIFungibleTokensInner and cannot be null");
            }
            this.Symbol = symbol;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for ListAllAssetsFromAllWalletsRIFungibleTokensInner and cannot be null");
            }
            this.Type = type;
        }
        ...
        {
            return this.Equals(input as ListAllAssetsFromAllWalletsRIFungibleTokensInner);
        }

        /// <summary>
        /// Returns true if ListAllAssetsFromAllWalletsRIFungibleTokensInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ListAllAssetsFromAllWalletsRIFungibleTokensInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListAllAssetsFromAllWalletsRIFungibleTokensInner input)
        {
            if (input == null)
            {
                return false;
