...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4099
    /// </summary>
    [DataContract(Name = "inline_response_409_9")]
    public partial class InlineResponse4099 : IEquatable<InlineResponse4099>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4099" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse4099() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4099" /> class.
        /// </summary>
        ...
        public InlineResponse4099(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedTokensTransactionsE409 error = default(NewConfirmedTokensTransactionsE409))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4099 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4099 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse4099 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse4099);
        }

        /// <summary>
        /// Returns true if InlineResponse4099 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4099 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4099 input)
        {
            if (input == null)
            {
                return false;
