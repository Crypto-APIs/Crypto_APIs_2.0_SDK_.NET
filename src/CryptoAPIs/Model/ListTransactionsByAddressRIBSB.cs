...
namespace CryptoAPIs.Model
{
    ...
    /// Bitcoin
    /// </summary>
    [DataContract(Name = "ListTransactionsByAddressRIBSB")]
    public partial class ListTransactionsByAddressRIBSB : IEquatable<ListTransactionsByAddressRIBSB>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressRIBSB" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByAddressRIBSB() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressRIBSB" /> class.
        /// </summary>
        ...
        public ListTransactionsByAddressRIBSB(int locktime = default(int), int size = default(int), int vSize = default(int), int version = default(int), List<ListTransactionsByAddressRIBSBVin> vin = default(List<ListTransactionsByAddressRIBSBVin>), List<ListTransactionsByAddressRIBSBVout> vout = default(List<ListTransactionsByAddressRIBSBVout>))
        {
            ...
            this.Vin = vin ?? throw new ArgumentNullException("vin is a required property for ListTransactionsByAddressRIBSB and cannot be null");
            // to ensure "vout" is required (not null)
            this.Vout = vout ?? throw new ArgumentNullException("vout is a required property for ListTransactionsByAddressRIBSB and cannot be null");
        }
        ...
        public List<ListTransactionsByAddressRIBSBVin> Vin { get; set; }
        ...
        public List<ListTransactionsByAddressRIBSBVout> Vout { get; set; }
        ...
        {
            return this.Equals(input as ListTransactionsByAddressRIBSB);
        }

        /// <summary>
        /// Returns true if ListTransactionsByAddressRIBSB instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByAddressRIBSB to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByAddressRIBSB input)
        {
            if (input == null)
                return false;
