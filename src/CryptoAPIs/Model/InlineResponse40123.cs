...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40123 : IEquatable<InlineResponse40123>, IValidatableObject
    {
        ...
        public InlineResponse40123(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListZilliqaTransactionsByBlockHeightE401 error = default(ListZilliqaTransactionsByBlockHeightE401))
        {
