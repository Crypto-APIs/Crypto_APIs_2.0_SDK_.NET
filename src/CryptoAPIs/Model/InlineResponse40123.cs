...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40123
    /// </summary>
    [DataContract(Name = "inline_response_401_23")]
    public partial class InlineResponse40123 : IEquatable<InlineResponse40123>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40123" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40123() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40123" /> class.
        /// </summary>
        ...
        public InlineResponse40123(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListXRPRippleTransactionsByBlockHeightE401 error = default(ListXRPRippleTransactionsByBlockHeightE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40123 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40123 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40123 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40123 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40123);
        }

        /// <summary>
        /// Returns true if InlineResponse40123 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40123 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40123 input)
        {
            if (input == null)
            {
                return false;
