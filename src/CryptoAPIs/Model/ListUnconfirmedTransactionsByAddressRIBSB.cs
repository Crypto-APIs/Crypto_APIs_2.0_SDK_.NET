...
namespace CryptoAPIs.Model
{
    ...
    /// Bitcoin
    /// </summary>
    [DataContract(Name = "ListUnconfirmedTransactionsByAddressRIBSB")]
    public partial class ListUnconfirmedTransactionsByAddressRIBSB : IEquatable<ListUnconfirmedTransactionsByAddressRIBSB>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnconfirmedTransactionsByAddressRIBSB" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListUnconfirmedTransactionsByAddressRIBSB() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnconfirmedTransactionsByAddressRIBSB" /> class.
        /// </summary>
        ...
        public ListUnconfirmedTransactionsByAddressRIBSB(long locktime = default(long), int size = default(int), int vSize = default(int), int version = default(int), List<ListUnconfirmedTransactionsByAddressRIBSBVinInner> vin = default(List<ListUnconfirmedTransactionsByAddressRIBSBVinInner>), List<ListUnconfirmedTransactionsByAddressRIBSBVoutInner> vout = default(List<ListUnconfirmedTransactionsByAddressRIBSBVoutInner>))
        {
            ...
            if (vin == null)
            {
                throw new ArgumentNullException("vin is a required property for ListUnconfirmedTransactionsByAddressRIBSB and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null)
            {
                throw new ArgumentNullException("vout is a required property for ListUnconfirmedTransactionsByAddressRIBSB and cannot be null");
            }
            this.Vout = vout;
        }
        ...
        public List<ListUnconfirmedTransactionsByAddressRIBSBVinInner> Vin { get; set; }
        ...
        public List<ListUnconfirmedTransactionsByAddressRIBSBVoutInner> Vout { get; set; }
        ...
        {
            return this.Equals(input as ListUnconfirmedTransactionsByAddressRIBSB);
        }

        /// <summary>
        /// Returns true if ListUnconfirmedTransactionsByAddressRIBSB instances are equal
        /// </summary>
        /// <param name="input">Instance of ListUnconfirmedTransactionsByAddressRIBSB to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListUnconfirmedTransactionsByAddressRIBSB input)
        {
            if (input == null)
            {
                return false;
