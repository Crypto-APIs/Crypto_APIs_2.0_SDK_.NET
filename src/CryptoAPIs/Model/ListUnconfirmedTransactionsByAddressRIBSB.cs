...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListUnconfirmedTransactionsByAddressRIBSB : IEquatable<ListUnconfirmedTransactionsByAddressRIBSB>, IValidatableObject
    {
        ...
        public ListUnconfirmedTransactionsByAddressRIBSB(int locktime = default(int), int size = default(int), int vSize = default(int), int version = default(int), List<ListUnconfirmedTransactionsByAddressRIBSBVin> vin = default(List<ListUnconfirmedTransactionsByAddressRIBSBVin>), List<ListUnconfirmedTransactionsByAddressRIBSBVout> vout = default(List<ListUnconfirmedTransactionsByAddressRIBSBVout>))
        {
