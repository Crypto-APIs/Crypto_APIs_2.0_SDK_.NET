...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40367 : IEquatable<InlineResponse40367>, IValidatableObject
    {
        ...
        public InlineResponse40367(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTokensByAddressE403 error = default(ListTokensByAddressE403))
        {
