...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40367
    /// </summary>
    [DataContract(Name = "inline_response_403_67")]
    public partial class InlineResponse40367 : IEquatable<InlineResponse40367>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40367" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40367() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40367" /> class.
        /// </summary>
        ...
        public InlineResponse40367(string apiVersion = default(string), string requestId = default(string), string context = default(string), ActivateBlockchainEventSubscriptionE403 error = default(ActivateBlockchainEventSubscriptionE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40367 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40367 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40367 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40367 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40367);
        }

        /// <summary>
        /// Returns true if InlineResponse40367 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40367 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40367 input)
        {
            if (input == null)
            {
                return false;
