...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse501
    /// </summary>
    [DataContract(Name = "inline_response_501")]
    public partial class InlineResponse501 : IEquatable<InlineResponse501>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse501" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse501() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse501" /> class.
        /// </summary>
        ...
        public InlineResponse501(string apiVersion = default(string), string requestId = default(string), string context = default(string), Unimplemented error = default(Unimplemented))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse501 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse501 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse501 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse501);
        }

        /// <summary>
        /// Returns true if InlineResponse501 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse501 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse501 input)
        {
            if (input == null)
            {
                return false;
