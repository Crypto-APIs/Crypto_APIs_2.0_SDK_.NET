...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DecodeRawTransactionHexRISD2_vin")]
    public partial class DecodeRawTransactionHexRISD2Vin : IEquatable<DecodeRawTransactionHexRISD2Vin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISD2Vin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DecodeRawTransactionHexRISD2Vin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISD2Vin" /> class.
        /// </summary>
        ...
        public DecodeRawTransactionHexRISD2Vin(string address = default(string), string inputHash = default(string), string outputIndex = default(string), DecodeRawTransactionHexRISD2ScriptSig scriptSig = default(DecodeRawTransactionHexRISD2ScriptSig), string sequence = default(string), List<string> txinwitness = default(List<string>))
        {
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null)
            {
                throw new ArgumentNullException("scriptSig is a required property for DecodeRawTransactionHexRISD2Vin and cannot be null");
            }
        ...
        public DecodeRawTransactionHexRISD2ScriptSig ScriptSig { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DecodeRawTransactionHexRISD2Vin {\n");
        ...
        {
            return this.Equals(input as DecodeRawTransactionHexRISD2Vin);
        }

        /// <summary>
        /// Returns true if DecodeRawTransactionHexRISD2Vin instances are equal
        /// </summary>
        /// <param name="input">Instance of DecodeRawTransactionHexRISD2Vin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecodeRawTransactionHexRISD2Vin input)
        {
            if (input == null)
            {
                return false;
