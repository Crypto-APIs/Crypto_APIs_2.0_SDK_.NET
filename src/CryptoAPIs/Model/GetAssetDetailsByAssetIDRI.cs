...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetAssetDetailsByAssetIDRI")]
    public partial class GetAssetDetailsByAssetIDRI : IEquatable<GetAssetDetailsByAssetIDRI>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAssetDetailsByAssetIDRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetAssetDetailsByAssetIDRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAssetDetailsByAssetIDRI" /> class.
        /// </summary>
        ...
        public GetAssetDetailsByAssetIDRI(string assetId = default(string), GetAssetDetailsByAssetIDRIAssetLogo assetLogo = default(GetAssetDetailsByAssetIDRIAssetLogo), string assetName = default(string), string assetOriginalSymbol = default(string), string assetSymbol = default(string), AssetTypeEnum assetType = default(AssetTypeEnum), GetAssetDetailsByAssetIDRILatestRate latestRate = default(GetAssetDetailsByAssetIDRILatestRate), string slug = default(string), GetAssetDetailsByAssetIDRIS specificData = default(GetAssetDetailsByAssetIDRIS))
        {
            // to ensure "assetId" is required (not null)
            if (assetId == null)
            {
                throw new ArgumentNullException("assetId is a required property for GetAssetDetailsByAssetIDRI and cannot be null");
            }
            this.AssetId = assetId;
            // to ensure "assetLogo" is required (not null)
            if (assetLogo == null)
            {
                throw new ArgumentNullException("assetLogo is a required property for GetAssetDetailsByAssetIDRI and cannot be null");
            }
            this.AssetLogo = assetLogo;
            // to ensure "assetName" is required (not null)
            if (assetName == null)
            {
                throw new ArgumentNullException("assetName is a required property for GetAssetDetailsByAssetIDRI and cannot be null");
            }
            this.AssetName = assetName;
            // to ensure "assetOriginalSymbol" is required (not null)
            if (assetOriginalSymbol == null)
            {
                throw new ArgumentNullException("assetOriginalSymbol is a required property for GetAssetDetailsByAssetIDRI and cannot be null");
            }
            this.AssetOriginalSymbol = assetOriginalSymbol;
            // to ensure "assetSymbol" is required (not null)
            if (assetSymbol == null)
            {
                throw new ArgumentNullException("assetSymbol is a required property for GetAssetDetailsByAssetIDRI and cannot be null");
            }
            ...
            if (latestRate == null)
            {
                throw new ArgumentNullException("latestRate is a required property for GetAssetDetailsByAssetIDRI and cannot be null");
            }
            this.LatestRate = latestRate;
            // to ensure "specificData" is required (not null)
            if (specificData == null)
            {
                throw new ArgumentNullException("specificData is a required property for GetAssetDetailsByAssetIDRI and cannot be null");
            }
        ...
        public GetAssetDetailsByAssetIDRIS SpecificData { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAssetDetailsByAssetIDRI {\n");
        ...
        {
            return this.Equals(input as GetAssetDetailsByAssetIDRI);
        }

        /// <summary>
        /// Returns true if GetAssetDetailsByAssetIDRI instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAssetDetailsByAssetIDRI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAssetDetailsByAssetIDRI input)
        {
            if (input == null)
            {
                return false;
