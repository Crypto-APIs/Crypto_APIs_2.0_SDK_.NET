...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40045 : IEquatable<InlineResponse40045>, IValidatableObject
    {
        ...
        public InlineResponse40045(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListLatestMinedBlocksE400 error = default(ListLatestMinedBlocksE400))
        {
