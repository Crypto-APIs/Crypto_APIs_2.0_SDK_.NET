...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40045
    /// </summary>
    [DataContract(Name = "inline_response_400_45")]
    public partial class InlineResponse40045 : IEquatable<InlineResponse40045>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40045" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40045() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40045" /> class.
        /// </summary>
        ...
        public InlineResponse40045(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListWalletTransactionsE400 error = default(ListWalletTransactionsE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40045 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40045 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40045 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40045 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40045);
        }

        /// <summary>
        /// Returns true if InlineResponse40045 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40045 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40045 input)
        {
            if (input == null)
            {
                return false;
