...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40099
    /// </summary>
    [DataContract(Name = "inline_response_400_99")]
    public partial class InlineResponse40099 : IEquatable<InlineResponse40099>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40099" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40099() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40099" /> class.
        /// </summary>
        ...
        public InlineResponse40099(string apiVersion = default(string), string requestId = default(string), string context = default(string), BroadcastLocallySignedTransactionE400 error = default(BroadcastLocallySignedTransactionE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40099 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40099 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40099 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40099 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40099);
        }

        /// <summary>
        /// Returns true if InlineResponse40099 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40099 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40099 input)
        {
            if (input == null)
            {
                return false;
