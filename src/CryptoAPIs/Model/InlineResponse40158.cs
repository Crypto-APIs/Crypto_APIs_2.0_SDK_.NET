...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40158 : IEquatable<InlineResponse40158>, IValidatableObject
    {
        ...
        public InlineResponse40158(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetNextAvailableNonceE401 error = default(GetNextAvailableNonceE401))
        {
