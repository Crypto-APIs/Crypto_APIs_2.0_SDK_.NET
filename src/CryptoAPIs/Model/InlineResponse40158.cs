...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40158
    /// </summary>
    [DataContract(Name = "inline_response_401_58")]
    public partial class InlineResponse40158 : IEquatable<InlineResponse40158>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40158" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40158() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40158" /> class.
        /// </summary>
        ...
        public InlineResponse40158(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewUnconfirmedCoinsTransactionsE401 error = default(NewUnconfirmedCoinsTransactionsE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40158 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40158 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40158 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40158 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40158);
        }

        /// <summary>
        /// Returns true if InlineResponse40158 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40158 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40158 input)
        {
            if (input == null)
            {
                return false;
