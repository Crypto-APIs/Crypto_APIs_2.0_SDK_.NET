...
namespace CryptoAPIs.Model
{
    ...
    /// Zcash
    /// </summary>
    [DataContract(Name = "ListTransactionsByBlockHeightRIBSZ")]
    public partial class ListTransactionsByBlockHeightRIBSZ : IEquatable<ListTransactionsByBlockHeightRIBSZ>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHeightRIBSZ" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByBlockHeightRIBSZ() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHeightRIBSZ" /> class.
        /// </summary>
        ...
        public ListTransactionsByBlockHeightRIBSZ(string bindingSig = default(string), int expiryHeight = default(int), string joinSplitPubKey = default(string), string joinSplitSig = default(string), long locktime = default(long), bool overwintered = default(bool), int size = default(int), List<ListTransactionsByBlockHeightRIBSZVJoinSplitInner> vJoinSplit = default(List<ListTransactionsByBlockHeightRIBSZVJoinSplitInner>), List<ListTransactionsByBlockHeightRIBSZVShieldedOutputInner> vShieldedOutput = default(List<ListTransactionsByBlockHeightRIBSZVShieldedOutputInner>), List<GetTransactionDetailsByTransactionIDRIBSZVShieldedSpendInner> vShieldedSpend = default(List<GetTransactionDetailsByTransactionIDRIBSZVShieldedSpendInner>), string valueBalance = default(string), int version = default(int), string versionGroupId = default(string), List<ListTransactionsByBlockHeightRIBSZVinInner> vin = default(List<ListTransactionsByBlockHeightRIBSZVinInner>), List<ListTransactionsByBlockHeightRIBSZVoutInner> vout = default(List<ListTransactionsByBlockHeightRIBSZVoutInner>))
        {
            // to ensure "bindingSig" is required (not null)
            if (bindingSig == null)
            {
                throw new ArgumentNullException("bindingSig is a required property for ListTransactionsByBlockHeightRIBSZ and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("joinSplitPubKey is a required property for ListTransactionsByBlockHeightRIBSZ and cannot be null");
            }
            this.JoinSplitPubKey = joinSplitPubKey;
            // to ensure "joinSplitSig" is required (not null)
            if (joinSplitSig == null)
            {
                throw new ArgumentNullException("joinSplitSig is a required property for ListTransactionsByBlockHeightRIBSZ and cannot be null");
            }
            ...
            if (vJoinSplit == null)
            {
                throw new ArgumentNullException("vJoinSplit is a required property for ListTransactionsByBlockHeightRIBSZ and cannot be null");
            }
            this.VJoinSplit = vJoinSplit;
            // to ensure "vShieldedOutput" is required (not null)
            if (vShieldedOutput == null)
            {
                throw new ArgumentNullException("vShieldedOutput is a required property for ListTransactionsByBlockHeightRIBSZ and cannot be null");
            }
            this.VShieldedOutput = vShieldedOutput;
            // to ensure "vShieldedSpend" is required (not null)
            if (vShieldedSpend == null)
            {
                throw new ArgumentNullException("vShieldedSpend is a required property for ListTransactionsByBlockHeightRIBSZ and cannot be null");
            }
            this.VShieldedSpend = vShieldedSpend;
            // to ensure "valueBalance" is required (not null)
            if (valueBalance == null)
            {
                throw new ArgumentNullException("valueBalance is a required property for ListTransactionsByBlockHeightRIBSZ and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("versionGroupId is a required property for ListTransactionsByBlockHeightRIBSZ and cannot be null");
            }
            this.VersionGroupId = versionGroupId;
            // to ensure "vin" is required (not null)
            if (vin == null)
            {
                throw new ArgumentNullException("vin is a required property for ListTransactionsByBlockHeightRIBSZ and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null)
            {
                throw new ArgumentNullException("vout is a required property for ListTransactionsByBlockHeightRIBSZ and cannot be null");
            }
            this.Vout = vout;
        }
        ...
        public List<ListTransactionsByBlockHeightRIBSZVJoinSplitInner> VJoinSplit { get; set; }
        ...
        public List<ListTransactionsByBlockHeightRIBSZVShieldedOutputInner> VShieldedOutput { get; set; }
        ...
        public List<ListTransactionsByBlockHeightRIBSZVinInner> Vin { get; set; }
        ...
        public List<ListTransactionsByBlockHeightRIBSZVoutInner> Vout { get; set; }
        ...
        {
            return this.Equals(input as ListTransactionsByBlockHeightRIBSZ);
        }

        /// <summary>
        /// Returns true if ListTransactionsByBlockHeightRIBSZ instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByBlockHeightRIBSZ to be compared</param>
        /// <returns>Boolean</returns>
