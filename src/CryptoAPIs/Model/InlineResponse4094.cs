...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4094
    /// </summary>
    [DataContract(Name = "inline_response_409_4")]
    public partial class InlineResponse4094 : IEquatable<InlineResponse4094>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4094" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse4094() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4094" /> class.
        /// </summary>
        ...
        public InlineResponse4094(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateFungibleTokensTransactionRequestFromAddressE409 error = default(CreateFungibleTokensTransactionRequestFromAddressE409))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4094 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4094 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse4094 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse4094);
        }

        /// <summary>
        /// Returns true if InlineResponse4094 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4094 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4094 input)
        {
            if (input == null)
            {
                return false;
