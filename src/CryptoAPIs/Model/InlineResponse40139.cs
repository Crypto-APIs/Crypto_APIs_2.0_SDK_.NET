...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40139
    /// </summary>
    [DataContract(Name = "inline_response_401_39")]
    public partial class InlineResponse40139 : IEquatable<InlineResponse40139>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40139" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40139() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40139" /> class.
        /// </summary>
        ...
        public InlineResponse40139(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetLatestMinedXRPRippleBlockE401 error = default(GetLatestMinedXRPRippleBlockE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40139 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40139 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40139 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40139 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40139);
        }

        /// <summary>
        /// Returns true if InlineResponse40139 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40139 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40139 input)
        {
            if (input == null)
            {
                return false;
