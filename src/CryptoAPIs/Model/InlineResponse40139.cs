...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40139 : IEquatable<InlineResponse40139>, IValidatableObject
    {
        ...
        public InlineResponse40139(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListAllAssetsByWalletIDE401 error = default(ListAllAssetsByWalletIDE401))
        {
