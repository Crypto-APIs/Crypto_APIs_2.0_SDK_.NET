...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40191
    /// </summary>
    [DataContract(Name = "inline_response_401_91")]
    public partial class InlineResponse40191 : IEquatable<InlineResponse40191>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40191" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40191() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40191" /> class.
        /// </summary>
        ...
        public InlineResponse40191(string apiVersion = default(string), string requestId = default(string), string context = default(string), DeleteAutomaticCoinsForwardingE401 error = default(DeleteAutomaticCoinsForwardingE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40191 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40191 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40191 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40191 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40191);
        }

        /// <summary>
        /// Returns true if InlineResponse40191 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40191 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40191 input)
        {
            if (input == null)
            {
                return false;
