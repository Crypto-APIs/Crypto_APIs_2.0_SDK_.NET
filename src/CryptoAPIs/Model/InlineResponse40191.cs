...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40191 : IEquatable<InlineResponse40191>, IValidatableObject
    {
        ...
        public InlineResponse40191(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetAssetDetailsByAssetSymbolE401 error = default(GetAssetDetailsByAssetSymbolE401))
        {
