...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListLatestMinedBlocksRIBSBC : IEquatable<ListLatestMinedBlocksRIBSBC>, IValidatableObject
    {
        ...
        public ListLatestMinedBlocksRIBSBC(string bits = default(string), string chainwork = default(string), string difficulty = default(string), string merkleRoot = default(string), int nonce = default(int), int size = default(int), int version = default(int), string versionHex = default(string))
        {
