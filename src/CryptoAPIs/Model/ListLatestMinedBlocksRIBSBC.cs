...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListLatestMinedBlocksRIBSBC : IEquatable<ListLatestMinedBlocksRIBSBC>, IValidatableObject
    {
        ...
        public ListLatestMinedBlocksRIBSBC(string bits = default(string), string chainwork = default(string), string difficulty = default(string), string merkleRoot = default(string), long nonce = default(long), int size = default(int), int version = default(int), string versionHex = default(string))
        {
            ...
            if (difficulty == null)
            {
                throw new ArgumentNullException("difficulty is a required property for ListLatestMinedBlocksRIBSBC and cannot be null");
            }
