...
namespace CryptoAPIs.Model
{
    ...
    /// Binance Smart Chain
    /// </summary>
    [DataContract(Name = "ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC")]
    public partial class ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC : IEquatable<ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC" /> class.
        /// </summary>
        ...
        public ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC(string contract = default(string), string gasLimit = default(string), ListConfirmedTransactionsByAddressRIBSBSCGasPrice gasPrice = default(ListConfirmedTransactionsByAddressRIBSBSCGasPrice), string gasUsed = default(string), string inputData = default(string), int nonce = default(int), string transactionStatus = default(string))
        {
            ...
            if (gasLimit == null)
            {
                throw new ArgumentNullException("gasLimit is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC and cannot be null");
            }
            this.GasLimit = gasLimit;
            // to ensure "gasPrice" is required (not null)
            if (gasPrice == null)
            {
                throw new ArgumentNullException("gasPrice is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC and cannot be null");
            }
            this.GasPrice = gasPrice;
            // to ensure "gasUsed" is required (not null)
            if (gasUsed == null)
            {
                throw new ArgumentNullException("gasUsed is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC and cannot be null");
            }
            this.GasUsed = gasUsed;
            // to ensure "inputData" is required (not null)
            if (inputData == null)
            {
                throw new ArgumentNullException("inputData is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("transactionStatus is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC and cannot be null");
            }
        ...
        {
            return this.Equals(input as ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC);
        }

        /// <summary>
        /// Returns true if ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC instances are equal
        /// </summary>
        /// <param name="input">Instance of ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC input)
        {
            if (input == null)
            {
                return false;
