...
namespace CryptoAPIs.Model
{
    ...
    /// NewBlockRB
    /// </summary>
    [DataContract(Name = "NewBlockRB")]
    public partial class NewBlockRB : IEquatable<NewBlockRB>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewBlockRB" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewBlockRB() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewBlockRB" /> class.
        /// </summary>
        ...
        public NewBlockRB(string context = default(string), NewBlockRBData data = default(NewBlockRBData))
        {
            ...
            this.Data = data ?? throw new ArgumentNullException("data is a required property for NewBlockRB and cannot be null");
        ...
        public NewBlockRBData Data { get; set; }
        ...
        {
            return this.Equals(input as NewBlockRB);
        }

        /// <summary>
        /// Returns true if NewBlockRB instances are equal
        /// </summary>
        /// <param name="input">Instance of NewBlockRB to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewBlockRB input)
        {
            if (input == null)
                return false;
