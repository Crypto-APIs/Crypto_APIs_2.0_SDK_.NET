...
namespace CryptoAPIs.Model
{
    ...
    /// Zilliqa
    /// </summary>
    [DataContract(Name = "GetLastMinedBlockRIBSZ2")]
    public partial class GetLastMinedBlockRIBSZ2 : IEquatable<GetLastMinedBlockRIBSZ2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLastMinedBlockRIBSZ2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetLastMinedBlockRIBSZ2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLastMinedBlockRIBSZ2" /> class.
        /// </summary>
        ...
        public GetLastMinedBlockRIBSZ2(string difficulty = default(string), int dsBlock = default(int), string dsDifficulty = default(string), string dsLeader = default(string), int gasLimit = default(int), int gasUsed = default(int), List<string> microBlocks = default(List<string>))
        {
            // to ensure "difficulty" is required (not null)
            if (difficulty == null)
            {
                throw new ArgumentNullException("difficulty is a required property for GetLastMinedBlockRIBSZ2 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("dsDifficulty is a required property for GetLastMinedBlockRIBSZ2 and cannot be null");
            }
            this.DsDifficulty = dsDifficulty;
            // to ensure "dsLeader" is required (not null)
            if (dsLeader == null)
            {
                throw new ArgumentNullException("dsLeader is a required property for GetLastMinedBlockRIBSZ2 and cannot be null");
            }
            ...
            if (microBlocks == null)
            {
                throw new ArgumentNullException("microBlocks is a required property for GetLastMinedBlockRIBSZ2 and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetLastMinedBlockRIBSZ2 {\n");
        ...
        {
            return this.Equals(input as GetLastMinedBlockRIBSZ2);
        }

        /// <summary>
        /// Returns true if GetLastMinedBlockRIBSZ2 instances are equal
        /// </summary>
        /// <param name="input">Instance of GetLastMinedBlockRIBSZ2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetLastMinedBlockRIBSZ2 input)
        {
            if (input == null)
            {
                return false;
