...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4019
    /// </summary>
    [DataContract(Name = "inline_response_401_9")]
    public partial class InlineResponse4019 : IEquatable<InlineResponse4019>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4019" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse4019() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4019" /> class.
        /// </summary>
        ...
        public InlineResponse4019(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetZilliqaTransactionDetailsByTransactionIDE401 error = default(GetZilliqaTransactionDetailsByTransactionIDE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4019 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4019 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse4019 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse4019 {\n");
        ...
        {
            return this.Equals(input as InlineResponse4019);
        }

        /// <summary>
        /// Returns true if InlineResponse4019 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4019 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4019 input)
        {
            if (input == null)
            {
                return false;
