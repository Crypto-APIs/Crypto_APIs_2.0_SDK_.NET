...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40312
    /// </summary>
    [DataContract(Name = "inline_response_403_12")]
    public partial class InlineResponse40312 : IEquatable<InlineResponse40312>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40312" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40312() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40312" /> class.
        /// </summary>
        ...
        public InlineResponse40312(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListUnconfirmedOmniTransactionsByAddressE403 error = default(ListUnconfirmedOmniTransactionsByAddressE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40312 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40312 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40312 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40312 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40312);
        }

        /// <summary>
        /// Returns true if InlineResponse40312 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40312 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40312 input)
        {
            if (input == null)
            {
                return false;
