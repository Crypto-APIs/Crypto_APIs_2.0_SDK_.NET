...
namespace CryptoAPIs.Model
{
    ...
    public partial class GenerateDepositAddressRI : IEquatable<GenerateDepositAddressRI>, IValidatableObject
    {
        ...
        public GenerateDepositAddressRI(string address = default(string), int createdTimestamp = default(int), string label = default(string))
        {
            ...
            this.Address = address ?? throw new ArgumentNullException("address is a required property for GenerateDepositAddressRI and cannot be null");
            this.CreatedTimestamp = createdTimestamp;
            // to ensure "label" is required (not null)
            this.Label = label ?? throw new ArgumentNullException("label is a required property for GenerateDepositAddressRI and cannot be null");
        }
