...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4095
    /// </summary>
    [DataContract(Name = "inline_response_409_5")]
    public partial class InlineResponse4095 : IEquatable<InlineResponse4095>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4095" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse4095() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4095" /> class.
        /// </summary>
        ...
        public InlineResponse4095(string apiVersion = default(string), string requestId = default(string), string context = default(string), SyncHDWalletXPubYPubZPubE409 error = default(SyncHDWalletXPubYPubZPubE409))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4095 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4095 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse4095 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse4095);
        }

        /// <summary>
        /// Returns true if InlineResponse4095 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4095 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4095 input)
        {
            if (input == null)
            {
                return false;
