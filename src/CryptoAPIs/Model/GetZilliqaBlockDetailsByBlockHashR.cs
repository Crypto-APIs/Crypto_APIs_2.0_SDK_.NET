...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetZilliqaBlockDetailsByBlockHashR")]
    public partial class GetZilliqaBlockDetailsByBlockHashR : IEquatable<GetZilliqaBlockDetailsByBlockHashR>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetZilliqaBlockDetailsByBlockHashR" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetZilliqaBlockDetailsByBlockHashR() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetZilliqaBlockDetailsByBlockHashR" /> class.
        /// </summary>
        ...
        public GetZilliqaBlockDetailsByBlockHashR(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetZilliqaBlockDetailsByBlockHashRData data = default(GetZilliqaBlockDetailsByBlockHashRData))
        {
            ...
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for GetZilliqaBlockDetailsByBlockHashR and cannot be null");
            // to ensure "requestId" is required (not null)
            this.RequestId = requestId ?? throw new ArgumentNullException("requestId is a required property for GetZilliqaBlockDetailsByBlockHashR and cannot be null");
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for GetZilliqaBlockDetailsByBlockHashR and cannot be null");
        ...
        public GetZilliqaBlockDetailsByBlockHashRData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetZilliqaBlockDetailsByBlockHashR {\n");
        ...
        {
            return this.Equals(input as GetZilliqaBlockDetailsByBlockHashR);
        }

        /// <summary>
        /// Returns true if GetZilliqaBlockDetailsByBlockHashR instances are equal
        /// </summary>
        /// <param name="input">Instance of GetZilliqaBlockDetailsByBlockHashR to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetZilliqaBlockDetailsByBlockHashR input)
        {
            if (input == null)
                return false;
