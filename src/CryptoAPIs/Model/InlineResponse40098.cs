...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40098
    /// </summary>
    [DataContract(Name = "inline_response_400_98")]
    public partial class InlineResponse40098 : IEquatable<InlineResponse40098>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40098" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40098() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40098" /> class.
        /// </summary>
        ...
        public InlineResponse40098(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetEIP1559FeeRecommendationsE400 error = default(GetEIP1559FeeRecommendationsE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40098 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40098 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40098 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40098 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40098);
        }

        /// <summary>
        /// Returns true if InlineResponse40098 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40098 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40098 input)
        {
            if (input == null)
            {
                return false;
