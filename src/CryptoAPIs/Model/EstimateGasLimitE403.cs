...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(EstimateGasLimitE403JsonConverter))]
    [DataContract(Name = "EstimateGasLimitE403")]
    public partial class EstimateGasLimitE403 : AbstractOpenAPISchema, IEquatable<EstimateGasLimitE403>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EstimateGasLimitE403" /> class
        /// with the <see cref="BannedIpAddress" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BannedIpAddress.</param>
        public EstimateGasLimitE403(BannedIpAddress actualInstance)
        {
        ...
        public EstimateGasLimitE403(EndpointNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public EstimateGasLimitE403(EndpointNotAllowedForApiKey actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public EstimateGasLimitE403(FeatureMainnetsNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EstimateGasLimitE403 {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, EstimateGasLimitE403.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of EstimateGasLimitE403
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of EstimateGasLimitE403</returns>
        public static EstimateGasLimitE403 FromJson(string jsonString)
        {
            EstimateGasLimitE403 newEstimateGasLimitE403 = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newEstimateGasLimitE403;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newEstimateGasLimitE403 = new EstimateGasLimitE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, EstimateGasLimitE403.SerializerSettings));
                }
                else
                {
                    newEstimateGasLimitE403 = new EstimateGasLimitE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, EstimateGasLimitE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newEstimateGasLimitE403 = new EstimateGasLimitE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, EstimateGasLimitE403.SerializerSettings));
                }
                else
                {
                    newEstimateGasLimitE403 = new EstimateGasLimitE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, EstimateGasLimitE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newEstimateGasLimitE403 = new EstimateGasLimitE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, EstimateGasLimitE403.SerializerSettings));
                }
                else
                {
                    newEstimateGasLimitE403 = new EstimateGasLimitE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, EstimateGasLimitE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newEstimateGasLimitE403 = new EstimateGasLimitE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, EstimateGasLimitE403.SerializerSettings));
                }
                else
                {
                    newEstimateGasLimitE403 = new EstimateGasLimitE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, EstimateGasLimitE403.AdditionalPropertiesSerializerSettings));
                }
        ...
        {
            return this.Equals(input as EstimateGasLimitE403);
        }

        /// <summary>
        /// Returns true if EstimateGasLimitE403 instances are equal
        /// </summary>
        /// <param name="input">Instance of EstimateGasLimitE403 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EstimateGasLimitE403 input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for EstimateGasLimitE403
    /// </summary>
    public class EstimateGasLimitE403JsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(EstimateGasLimitE403).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return EstimateGasLimitE403.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
