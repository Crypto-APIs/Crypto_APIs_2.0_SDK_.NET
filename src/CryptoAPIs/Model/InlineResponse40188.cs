...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40188 : IEquatable<InlineResponse40188>, IValidatableObject
    {
        ...
        public InlineResponse40188(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetExchangeRateByAssetsIDsE401 error = default(GetExchangeRateByAssetsIDsE401))
        {
