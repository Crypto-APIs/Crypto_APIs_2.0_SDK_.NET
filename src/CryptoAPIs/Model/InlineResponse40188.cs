...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40188
    /// </summary>
    [DataContract(Name = "inline_response_401_88")]
    public partial class InlineResponse40188 : IEquatable<InlineResponse40188>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40188" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40188() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40188" /> class.
        /// </summary>
        ...
        public InlineResponse40188(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedInternalTransactionsAndEachConfirmationE401 error = default(NewConfirmedInternalTransactionsAndEachConfirmationE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40188 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40188 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40188 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40188 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40188);
        }

        /// <summary>
        /// Returns true if InlineResponse40188 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40188 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40188 input)
        {
            if (input == null)
            {
                return false;
