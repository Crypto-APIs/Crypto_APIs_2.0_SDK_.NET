...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40021 : IEquatable<InlineResponse40021>, IValidatableObject
    {
        ...
        public InlineResponse40021(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListZilliqaTransactionsByBlockHashE400 error = default(ListZilliqaTransactionsByBlockHashE400))
        {
