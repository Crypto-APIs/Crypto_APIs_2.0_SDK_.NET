...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40021
    /// </summary>
    [DataContract(Name = "inline_response_400_21")]
    public partial class InlineResponse40021 : IEquatable<InlineResponse40021>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40021" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40021() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40021" /> class.
        /// </summary>
        ...
        public InlineResponse40021(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateCoinsTransactionRequestFromAddressE400 error = default(CreateCoinsTransactionRequestFromAddressE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40021 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40021 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40021 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40021 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40021);
        }

        /// <summary>
        /// Returns true if InlineResponse40021 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40021 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40021 input)
        {
            if (input == null)
            {
                return false;
