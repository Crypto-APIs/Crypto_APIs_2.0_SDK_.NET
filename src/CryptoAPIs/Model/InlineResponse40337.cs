...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40337
    /// </summary>
    [DataContract(Name = "inline_response_403_37")]
    public partial class InlineResponse40337 : IEquatable<InlineResponse40337>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40337" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40337() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40337" /> class.
        /// </summary>
        ...
        public InlineResponse40337(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateFungibleTokensTransactionRequestFromAddressE403 error = default(CreateFungibleTokensTransactionRequestFromAddressE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40337 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40337 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40337 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40337 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40337);
        }

        /// <summary>
        /// Returns true if InlineResponse40337 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40337 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40337 input)
        {
            if (input == null)
            {
                return false;
