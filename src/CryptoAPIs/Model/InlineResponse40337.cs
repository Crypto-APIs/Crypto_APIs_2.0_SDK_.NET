...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40337 : IEquatable<InlineResponse40337>, IValidatableObject
    {
        ...
        public InlineResponse40337(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetLastMinedBlockE403 error = default(GetLastMinedBlockE403))
        {
