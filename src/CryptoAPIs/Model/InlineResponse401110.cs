...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_401_110")]
    public partial class InlineResponse401110 : IEquatable<InlineResponse401110>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse401110" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse401110() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse401110" /> class.
        /// </summary>
        ...
        public InlineResponse401110(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetAssetDetailsByAssetSymbolE401 error = default(GetAssetDetailsByAssetSymbolE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse401110 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse401110 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse401110 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse401110 {\n");
        ...
        {
            return this.Equals(input as InlineResponse401110);
        }

        /// <summary>
        /// Returns true if InlineResponse401110 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse401110 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse401110 input)
        {
            if (input == null)
            {
                return false;
