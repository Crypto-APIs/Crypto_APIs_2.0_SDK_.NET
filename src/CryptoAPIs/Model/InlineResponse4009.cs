...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4009
    /// </summary>
    [DataContract(Name = "inline_response_400_9")]
    public partial class InlineResponse4009 : IEquatable<InlineResponse4009>, IValidatableObject
    {
        ...
        public InlineResponse4009(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetZilliqaTransactionDetailsByTransactionIDE400 error = default(GetZilliqaTransactionDetailsByTransactionIDE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4009 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4009 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse4009 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse4009);
        }

        /// <summary>
        /// Returns true if InlineResponse4009 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4009 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4009 input)
        {
            if (input == null)
            {
                return false;
