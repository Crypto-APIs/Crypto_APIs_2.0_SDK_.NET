...
namespace CryptoAPIs.Model
{
    ...
    /// Litecoin
    /// </summary>
    [DataContract(Name = "DecodeRawTransactionHexRISL")]
    public partial class DecodeRawTransactionHexRISL : IEquatable<DecodeRawTransactionHexRISL>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISL" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DecodeRawTransactionHexRISL() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISL" /> class.
        /// </summary>
        ...
        public DecodeRawTransactionHexRISL(int locktime = default(int), string transactionHash = default(string), int vSize = default(int), int version = default(int), List<DecodeRawTransactionHexRISLVinInner> vin = default(List<DecodeRawTransactionHexRISLVinInner>), List<DecodeRawTransactionHexRISLVoutInner> vout = default(List<DecodeRawTransactionHexRISLVoutInner>), int weight = default(int))
        {
            ...
            {
                throw new ArgumentNullException("transactionHash is a required property for DecodeRawTransactionHexRISL and cannot be null");
            }
            ...
            if (vin == null)
            {
                throw new ArgumentNullException("vin is a required property for DecodeRawTransactionHexRISL and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null)
            {
                throw new ArgumentNullException("vout is a required property for DecodeRawTransactionHexRISL and cannot be null");
            }
            this.Vout = vout;
            this.Weight = weight;
        }
        ...
        {
            return this.Equals(input as DecodeRawTransactionHexRISL);
        }

        /// <summary>
        /// Returns true if DecodeRawTransactionHexRISL instances are equal
        /// </summary>
        /// <param name="input">Instance of DecodeRawTransactionHexRISL to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecodeRawTransactionHexRISL input)
        {
            if (input == null)
            {
                return false;
