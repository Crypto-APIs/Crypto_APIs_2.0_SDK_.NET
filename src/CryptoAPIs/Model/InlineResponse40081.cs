...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40081 : IEquatable<InlineResponse40081>, IValidatableObject
    {
        ...
        public InlineResponse40081(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetFeeAddressDetailsE400 error = default(GetFeeAddressDetailsE400))
        {
