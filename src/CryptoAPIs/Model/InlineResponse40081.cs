...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40081
    /// </summary>
    [DataContract(Name = "inline_response_400_81")]
    public partial class InlineResponse40081 : IEquatable<InlineResponse40081>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40081" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40081() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40081" /> class.
        /// </summary>
        ...
        public InlineResponse40081(string apiVersion = default(string), string requestId = default(string), string context = default(string), ActivateBlockchainEventSubscriptionE400 error = default(ActivateBlockchainEventSubscriptionE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40081 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40081 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40081 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40081 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40081);
        }

        /// <summary>
        /// Returns true if InlineResponse40081 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40081 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40081 input)
        {
            if (input == null)
            {
                return false;
