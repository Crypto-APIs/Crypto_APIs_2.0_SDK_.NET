...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SyncHDWalletXPubYPubZPubRI")]
    public partial class SyncHDWalletXPubYPubZPubRI : IEquatable<SyncHDWalletXPubYPubZPubRI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SyncHDWalletXPubYPubZPubRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SyncHDWalletXPubYPubZPubRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SyncHDWalletXPubYPubZPubRI" /> class.
        /// </summary>
        ...
        public SyncHDWalletXPubYPubZPubRI(string extendedPublicKey = default(string))
        {
            ...
            this.ExtendedPublicKey = extendedPublicKey ?? throw new ArgumentNullException("extendedPublicKey is a required property for SyncHDWalletXPubYPubZPubRI and cannot be null");
        }
        ...
        {
            return this.Equals(input as SyncHDWalletXPubYPubZPubRI);
        }

        /// <summary>
        /// Returns true if SyncHDWalletXPubYPubZPubRI instances are equal
        /// </summary>
        /// <param name="input">Instance of SyncHDWalletXPubYPubZPubRI to be compared</param>
        /// <returns>Boolean</returns>
