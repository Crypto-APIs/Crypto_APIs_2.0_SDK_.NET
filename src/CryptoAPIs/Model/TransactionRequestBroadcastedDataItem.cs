...
namespace CryptoAPIs.Model
{
    ...
    public partial class TransactionRequestBroadcastedDataItem : IEquatable<TransactionRequestBroadcastedDataItem>, IValidatableObject
    {
        ...
        protected TransactionRequestBroadcastedDataItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionRequestBroadcastedDataItem" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TransactionRequestBroadcastedDataItem);
        }

        /// <summary>
        /// Returns true if TransactionRequestBroadcastedDataItem instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionRequestBroadcastedDataItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionRequestBroadcastedDataItem input)
        {
            if (input == null)
                return false;
