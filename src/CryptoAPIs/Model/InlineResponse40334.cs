...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40334 : IEquatable<InlineResponse40334>, IValidatableObject
    {
        ...
        public InlineResponse40334(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListSupportedTokensE403 error = default(ListSupportedTokensE403))
        {
