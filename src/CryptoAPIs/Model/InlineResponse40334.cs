...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40334
    /// </summary>
    [DataContract(Name = "inline_response_403_34")]
    public partial class InlineResponse40334 : IEquatable<InlineResponse40334>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40334" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40334() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40334" /> class.
        /// </summary>
        ...
        public InlineResponse40334(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetZilliqaBlockDetailsByBlockHashE403 error = default(GetZilliqaBlockDetailsByBlockHashE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40334 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40334 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40334 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40334 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40334);
        }

        /// <summary>
        /// Returns true if InlineResponse40334 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40334 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40334 input)
        {
            if (input == null)
            {
                return false;
