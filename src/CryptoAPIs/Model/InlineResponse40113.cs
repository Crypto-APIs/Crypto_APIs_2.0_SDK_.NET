...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40113
    /// </summary>
    [DataContract(Name = "inline_response_401_13")]
    public partial class InlineResponse40113 : IEquatable<InlineResponse40113>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40113" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40113() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40113" /> class.
        /// </summary>
        ...
        public InlineResponse40113(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateCoinsTransactionRequestFromWalletE401 error = default(CreateCoinsTransactionRequestFromWalletE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40113 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40113 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40113 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40113 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40113);
        }

        /// <summary>
        /// Returns true if InlineResponse40113 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40113 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40113 input)
        {
            if (input == null)
            {
                return false;
