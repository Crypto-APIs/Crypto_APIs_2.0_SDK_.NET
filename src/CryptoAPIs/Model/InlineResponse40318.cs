...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40318
    /// </summary>
    [DataContract(Name = "inline_response_403_18")]
    public partial class InlineResponse40318 : IEquatable<InlineResponse40318>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40318" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40318() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40318" /> class.
        /// </summary>
        ...
        public InlineResponse40318(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListXRPRippleTransactionsByBlockHashE403 error = default(ListXRPRippleTransactionsByBlockHashE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40318 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40318 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40318 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40318 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40318);
        }

        /// <summary>
        /// Returns true if InlineResponse40318 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40318 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40318 input)
        {
            if (input == null)
            {
                return false;
