...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40318 : IEquatable<InlineResponse40318>, IValidatableObject
    {
        ...
        public InlineResponse40318(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTransactionsByBlockHashE403 error = default(ListTransactionsByBlockHashE403))
        {
