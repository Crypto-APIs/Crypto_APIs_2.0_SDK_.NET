...
namespace CryptoAPIs.Model
{
    ...
    /// Ethereum Classic
    /// </summary>
    [DataContract(Name = "ListTransactionsByAddressRIBSEC")]
    public partial class ListTransactionsByAddressRIBSEC : IEquatable<ListTransactionsByAddressRIBSEC>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressRIBSEC" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByAddressRIBSEC() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressRIBSEC" /> class.
        /// </summary>
        ...
        public ListTransactionsByAddressRIBSEC(string contract = default(string), string gasLimit = default(string), ListTransactionsByAddressRIBSECGasPrice gasPrice = default(ListTransactionsByAddressRIBSECGasPrice), string gasUsed = default(string), string inputData = default(string), int nonce = default(int), string transactionStatus = default(string))
        {
            // to ensure "contract" is required (not null)
            this.Contract = contract ?? throw new ArgumentNullException("contract is a required property for ListTransactionsByAddressRIBSEC and cannot be null");
            // to ensure "gasLimit" is required (not null)
            this.GasLimit = gasLimit ?? throw new ArgumentNullException("gasLimit is a required property for ListTransactionsByAddressRIBSEC and cannot be null");
            // to ensure "gasPrice" is required (not null)
            this.GasPrice = gasPrice ?? throw new ArgumentNullException("gasPrice is a required property for ListTransactionsByAddressRIBSEC and cannot be null");
            // to ensure "gasUsed" is required (not null)
            this.GasUsed = gasUsed ?? throw new ArgumentNullException("gasUsed is a required property for ListTransactionsByAddressRIBSEC and cannot be null");
            // to ensure "inputData" is required (not null)
            this.InputData = inputData ?? throw new ArgumentNullException("inputData is a required property for ListTransactionsByAddressRIBSEC and cannot be null");
            this.Nonce = nonce;
            // to ensure "transactionStatus" is required (not null)
            this.TransactionStatus = transactionStatus ?? throw new ArgumentNullException("transactionStatus is a required property for ListTransactionsByAddressRIBSEC and cannot be null");
        }
        ...
        public ListTransactionsByAddressRIBSECGasPrice GasPrice { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListTransactionsByAddressRIBSEC {\n");
        ...
        {
            return this.Equals(input as ListTransactionsByAddressRIBSEC);
        }

        /// <summary>
        /// Returns true if ListTransactionsByAddressRIBSEC instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByAddressRIBSEC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByAddressRIBSEC input)
        {
            if (input == null)
                return false;
