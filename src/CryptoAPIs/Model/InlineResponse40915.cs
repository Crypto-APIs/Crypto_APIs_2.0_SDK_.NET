...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40915
    /// </summary>
    [DataContract(Name = "inline_response_409_15")]
    public partial class InlineResponse40915 : IEquatable<InlineResponse40915>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40915" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40915() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40915" /> class.
        /// </summary>
        ...
        public InlineResponse40915(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedInternalTransactionsAndEachConfirmationE409 error = default(NewConfirmedInternalTransactionsAndEachConfirmationE409))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40915 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40915 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40915 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse40915);
        }

        /// <summary>
        /// Returns true if InlineResponse40915 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40915 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40915 input)
        {
            if (input == null)
            {
                return false;
