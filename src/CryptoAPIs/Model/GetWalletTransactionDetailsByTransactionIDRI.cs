...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetWalletTransactionDetailsByTransactionIDRI : IEquatable<GetWalletTransactionDetailsByTransactionIDRI>, IValidatableObject
    {
        ...
        /// <param name="recipients">String representation of the transaction to address (required).</param>
        /// <param name="senders">String representation of the transaction from address (required).</param>
        ...
        public GetWalletTransactionDetailsByTransactionIDRI(int index = default(int), bool isConfirmed = default(bool), string minedInBlockHash = default(string), int minedInBlockHeight = default(int), string recipients = default(string), string senders = default(string), int timestamp = default(int), string transactionHash = default(string), string transactionId = default(string), GetWalletTransactionDetailsByTransactionIDRIFee fee = default(GetWalletTransactionDetailsByTransactionIDRIFee), GetWalletTransactionDetailsByTransactionIDRIBS blockchainSpecific = default(GetWalletTransactionDetailsByTransactionIDRIBS))
        {
            this.Index = index;
        ...
        /// </summary>
        /// <value>String representation of the transaction to address</value>
        ...
        /// </summary>
        /// <value>String representation of the transaction from address</value>
