...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40056 : IEquatable<InlineResponse40056>, IValidatableObject
    {
        ...
        public InlineResponse40056(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTokensByAddressE400 error = default(ListTokensByAddressE400))
        {
