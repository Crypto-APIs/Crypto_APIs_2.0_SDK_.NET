...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40056
    /// </summary>
    [DataContract(Name = "inline_response_400_56")]
    public partial class InlineResponse40056 : IEquatable<InlineResponse40056>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40056" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40056() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40056" /> class.
        /// </summary>
        ...
        public InlineResponse40056(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListInternalTransactionsByAddressE400 error = default(ListInternalTransactionsByAddressE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40056 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40056 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40056 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40056 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40056);
        }

        /// <summary>
        /// Returns true if InlineResponse40056 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40056 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40056 input)
        {
            if (input == null)
            {
                return false;
