...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(GetFeeAddressDetailsE403JsonConverter))]
    [DataContract(Name = "GetFeeAddressDetailsE403")]
    public partial class GetFeeAddressDetailsE403 : AbstractOpenAPISchema, IEquatable<GetFeeAddressDetailsE403>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetFeeAddressDetailsE403" /> class
        /// with the <see cref="BannedIpAddress" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BannedIpAddress.</param>
        public GetFeeAddressDetailsE403(BannedIpAddress actualInstance)
        {
        ...
        public GetFeeAddressDetailsE403(EndpointNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public GetFeeAddressDetailsE403(EndpointNotAllowedForApiKey actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public GetFeeAddressDetailsE403(FeatureMainnetsNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetFeeAddressDetailsE403 {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, GetFeeAddressDetailsE403.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of GetFeeAddressDetailsE403
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of GetFeeAddressDetailsE403</returns>
        public static GetFeeAddressDetailsE403 FromJson(string jsonString)
        {
            GetFeeAddressDetailsE403 newGetFeeAddressDetailsE403 = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newGetFeeAddressDetailsE403;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newGetFeeAddressDetailsE403 = new GetFeeAddressDetailsE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, GetFeeAddressDetailsE403.SerializerSettings));
                }
                else
                {
                    newGetFeeAddressDetailsE403 = new GetFeeAddressDetailsE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, GetFeeAddressDetailsE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newGetFeeAddressDetailsE403 = new GetFeeAddressDetailsE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, GetFeeAddressDetailsE403.SerializerSettings));
                }
                else
                {
                    newGetFeeAddressDetailsE403 = new GetFeeAddressDetailsE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, GetFeeAddressDetailsE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newGetFeeAddressDetailsE403 = new GetFeeAddressDetailsE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, GetFeeAddressDetailsE403.SerializerSettings));
                }
                else
                {
                    newGetFeeAddressDetailsE403 = new GetFeeAddressDetailsE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, GetFeeAddressDetailsE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newGetFeeAddressDetailsE403 = new GetFeeAddressDetailsE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, GetFeeAddressDetailsE403.SerializerSettings));
                }
                else
                {
                    newGetFeeAddressDetailsE403 = new GetFeeAddressDetailsE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, GetFeeAddressDetailsE403.AdditionalPropertiesSerializerSettings));
                }
        ...
        {
            return this.Equals(input as GetFeeAddressDetailsE403);
        }

        /// <summary>
        /// Returns true if GetFeeAddressDetailsE403 instances are equal
        /// </summary>
        /// <param name="input">Instance of GetFeeAddressDetailsE403 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetFeeAddressDetailsE403 input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for GetFeeAddressDetailsE403
    /// </summary>
    public class GetFeeAddressDetailsE403JsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(GetFeeAddressDetailsE403).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return GetFeeAddressDetailsE403.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
