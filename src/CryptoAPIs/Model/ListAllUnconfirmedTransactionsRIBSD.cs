...
namespace CryptoAPIs.Model
{
    ...
    /// Dogecoin
    /// </summary>
    [DataContract(Name = "ListAllUnconfirmedTransactionsRIBSD")]
    public partial class ListAllUnconfirmedTransactionsRIBSD : IEquatable<ListAllUnconfirmedTransactionsRIBSD>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllUnconfirmedTransactionsRIBSD" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListAllUnconfirmedTransactionsRIBSD() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllUnconfirmedTransactionsRIBSD" /> class.
        /// </summary>
        ...
        public ListAllUnconfirmedTransactionsRIBSD(long locktime = default(long), int size = default(int), int version = default(int), List<ListAllUnconfirmedTransactionsRIBSDVinInner> vin = default(List<ListAllUnconfirmedTransactionsRIBSDVinInner>), List<GetTransactionDetailsByTransactionIDRIBSDVoutInner> vout = default(List<GetTransactionDetailsByTransactionIDRIBSDVoutInner>))
        {
            ...
            if (vin == null)
            {
                throw new ArgumentNullException("vin is a required property for ListAllUnconfirmedTransactionsRIBSD and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null)
            {
                throw new ArgumentNullException("vout is a required property for ListAllUnconfirmedTransactionsRIBSD and cannot be null");
            }
            this.Vout = vout;
        }
        ...
        public List<ListAllUnconfirmedTransactionsRIBSDVinInner> Vin { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListAllUnconfirmedTransactionsRIBSD {\n");
        ...
        {
            return this.Equals(input as ListAllUnconfirmedTransactionsRIBSD);
        }

        /// <summary>
        /// Returns true if ListAllUnconfirmedTransactionsRIBSD instances are equal
        /// </summary>
        /// <param name="input">Instance of ListAllUnconfirmedTransactionsRIBSD to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListAllUnconfirmedTransactionsRIBSD input)
        {
            if (input == null)
            {
                return false;
