...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40119 : IEquatable<InlineResponse40119>, IValidatableObject
    {
        ...
        public InlineResponse40119(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListXRPRippleTransactionsByBlockHashE401 error = default(ListXRPRippleTransactionsByBlockHashE401))
        {
