...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40119
    /// </summary>
    [DataContract(Name = "inline_response_401_19")]
    public partial class InlineResponse40119 : IEquatable<InlineResponse40119>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40119" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40119() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40119" /> class.
        /// </summary>
        ...
        public InlineResponse40119(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetUnconfirmedOmniTransactionByTransactionIDTxidE401 error = default(GetUnconfirmedOmniTransactionByTransactionIDTxidE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40119 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40119 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40119 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40119 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40119);
        }

        /// <summary>
        /// Returns true if InlineResponse40119 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40119 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40119 input)
        {
            if (input == null)
            {
                return false;
