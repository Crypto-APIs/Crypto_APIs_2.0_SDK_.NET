...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4014
    /// </summary>
    [DataContract(Name = "inline_response_401_4")]
    public partial class InlineResponse4014 : IEquatable<InlineResponse4014>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4014" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse4014() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4014" /> class.
        /// </summary>
        ...
        public InlineResponse4014(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetTransactionDetailsByTransactionIDE401 error = default(GetTransactionDetailsByTransactionIDE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4014 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4014 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse4014 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse4014 {\n");
        ...
        {
            return this.Equals(input as InlineResponse4014);
        }

        /// <summary>
        /// Returns true if InlineResponse4014 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4014 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4014 input)
        {
            if (input == null)
            {
                return false;
