...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40340 : IEquatable<InlineResponse40340>, IValidatableObject
    {
        ...
        public InlineResponse40340(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetLastMinedBlockE403 error = default(GetLastMinedBlockE403))
        {
