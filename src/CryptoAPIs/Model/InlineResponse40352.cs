...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40352 : IEquatable<InlineResponse40352>, IValidatableObject
    {
        ...
        public InlineResponse40352(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListUnspentTransactionOutputsByAddressE403 error = default(ListUnspentTransactionOutputsByAddressE403))
        {
