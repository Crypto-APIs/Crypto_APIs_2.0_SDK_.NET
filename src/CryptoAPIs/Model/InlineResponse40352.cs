...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40352
    /// </summary>
    [DataContract(Name = "inline_response_403_52")]
    public partial class InlineResponse40352 : IEquatable<InlineResponse40352>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40352" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40352() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40352" /> class.
        /// </summary>
        ...
        public InlineResponse40352(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListInternalTransactionDetailsByTransactionHashE403 error = default(ListInternalTransactionDetailsByTransactionHashE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40352 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40352 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40352 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40352 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40352);
        }

        /// <summary>
        /// Returns true if InlineResponse40352 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40352 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40352 input)
        {
            if (input == null)
            {
                return false;
