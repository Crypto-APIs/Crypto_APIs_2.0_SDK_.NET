...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListTransactionsByAddressRIBSD2_vin")]
    public partial class ListTransactionsByAddressRIBSD2Vin : IEquatable<ListTransactionsByAddressRIBSD2Vin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressRIBSD2Vin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByAddressRIBSD2Vin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressRIBSD2Vin" /> class.
        /// </summary>
        ...
        public ListTransactionsByAddressRIBSD2Vin(List<string> addresses = default(List<string>), string coinbase = default(string), ListTransactionsByAddressRIBSD2ScriptSig scriptSig = default(ListTransactionsByAddressRIBSD2ScriptSig), string sequence = default(string), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            this.Addresses = addresses ?? throw new ArgumentNullException("addresses is a required property for ListTransactionsByAddressRIBSD2Vin and cannot be null");
            // to ensure "scriptSig" is required (not null)
            this.ScriptSig = scriptSig ?? throw new ArgumentNullException("scriptSig is a required property for ListTransactionsByAddressRIBSD2Vin and cannot be null");
            // to ensure "sequence" is required (not null)
            this.Sequence = sequence ?? throw new ArgumentNullException("sequence is a required property for ListTransactionsByAddressRIBSD2Vin and cannot be null");
            // to ensure "txinwitness" is required (not null)
            this.Txinwitness = txinwitness ?? throw new ArgumentNullException("txinwitness is a required property for ListTransactionsByAddressRIBSD2Vin and cannot be null");
            this.Vout = vout;
        ...
        public ListTransactionsByAddressRIBSD2ScriptSig ScriptSig { get; set; }
        ...
        {
            return this.Equals(input as ListTransactionsByAddressRIBSD2Vin);
        }

        /// <summary>
        /// Returns true if ListTransactionsByAddressRIBSD2Vin instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByAddressRIBSD2Vin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByAddressRIBSD2Vin input)
        {
            if (input == null)
                return false;
