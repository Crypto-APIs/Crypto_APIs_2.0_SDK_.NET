...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40189 : IEquatable<InlineResponse40189>, IValidatableObject
    {
        ...
        public InlineResponse40189(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListAssetsDetailsE401 error = default(ListAssetsDetailsE401))
        {
