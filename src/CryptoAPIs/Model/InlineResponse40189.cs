...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40189
    /// </summary>
    [DataContract(Name = "inline_response_401_89")]
    public partial class InlineResponse40189 : IEquatable<InlineResponse40189>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40189" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40189() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40189" /> class.
        /// </summary>
        ...
        public InlineResponse40189(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListCoinsForwardingAutomationsE401 error = default(ListCoinsForwardingAutomationsE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40189 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40189 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40189 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40189 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40189);
        }

        /// <summary>
        /// Returns true if InlineResponse40189 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40189 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40189 input)
        {
            if (input == null)
            {
                return false;
