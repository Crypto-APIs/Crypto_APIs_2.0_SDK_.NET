...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40068 : IEquatable<InlineResponse40068>, IValidatableObject
    {
        ...
        public InlineResponse40068(string apiVersion = default(string), string requestId = default(string), string context = default(string), EstimateTransactionSmartFeeE400 error = default(EstimateTransactionSmartFeeE400))
        {
