...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DecodeRawTransactionHexRISD_vin")]
    public partial class DecodeRawTransactionHexRISDVin : IEquatable<DecodeRawTransactionHexRISDVin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISDVin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DecodeRawTransactionHexRISDVin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISDVin" /> class.
        /// </summary>
        ...
        public DecodeRawTransactionHexRISDVin(string address = default(string), string inputHash = default(string), string outputIndex = default(string), DecodeRawTransactionHexRISDScriptSig scriptSig = default(DecodeRawTransactionHexRISDScriptSig), string sequence = default(string), List<string> txinwitness = default(List<string>))
        {
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null)
            {
                throw new ArgumentNullException("scriptSig is a required property for DecodeRawTransactionHexRISDVin and cannot be null");
            }
        ...
        public DecodeRawTransactionHexRISDScriptSig ScriptSig { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DecodeRawTransactionHexRISDVin {\n");
        ...
        {
            return this.Equals(input as DecodeRawTransactionHexRISDVin);
        }

        /// <summary>
        /// Returns true if DecodeRawTransactionHexRISDVin instances are equal
        /// </summary>
        /// <param name="input">Instance of DecodeRawTransactionHexRISDVin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecodeRawTransactionHexRISDVin input)
        {
            if (input == null)
            {
                return false;
