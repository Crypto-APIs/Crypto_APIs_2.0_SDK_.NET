...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(GetFeeRecommendationsE403JsonConverter))]
    [DataContract(Name = "GetFeeRecommendationsE403")]
    public partial class GetFeeRecommendationsE403 : AbstractOpenAPISchema, IEquatable<GetFeeRecommendationsE403>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetFeeRecommendationsE403" /> class
        /// with the <see cref="BannedIpAddress" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BannedIpAddress.</param>
        public GetFeeRecommendationsE403(BannedIpAddress actualInstance)
        {
        ...
        public GetFeeRecommendationsE403(EndpointNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public GetFeeRecommendationsE403(EndpointNotAllowedForApiKey actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public GetFeeRecommendationsE403(FeatureMainnetsNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetFeeRecommendationsE403 {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, GetFeeRecommendationsE403.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of GetFeeRecommendationsE403
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of GetFeeRecommendationsE403</returns>
        public static GetFeeRecommendationsE403 FromJson(string jsonString)
        {
            GetFeeRecommendationsE403 newGetFeeRecommendationsE403 = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newGetFeeRecommendationsE403;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newGetFeeRecommendationsE403 = new GetFeeRecommendationsE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, GetFeeRecommendationsE403.SerializerSettings));
                }
                else
                {
                    newGetFeeRecommendationsE403 = new GetFeeRecommendationsE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, GetFeeRecommendationsE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newGetFeeRecommendationsE403 = new GetFeeRecommendationsE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, GetFeeRecommendationsE403.SerializerSettings));
                }
                else
                {
                    newGetFeeRecommendationsE403 = new GetFeeRecommendationsE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, GetFeeRecommendationsE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newGetFeeRecommendationsE403 = new GetFeeRecommendationsE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, GetFeeRecommendationsE403.SerializerSettings));
                }
                else
                {
                    newGetFeeRecommendationsE403 = new GetFeeRecommendationsE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, GetFeeRecommendationsE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newGetFeeRecommendationsE403 = new GetFeeRecommendationsE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, GetFeeRecommendationsE403.SerializerSettings));
                }
                else
                {
                    newGetFeeRecommendationsE403 = new GetFeeRecommendationsE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, GetFeeRecommendationsE403.AdditionalPropertiesSerializerSettings));
                }
        ...
        {
            return this.Equals(input as GetFeeRecommendationsE403);
        }

        /// <summary>
        /// Returns true if GetFeeRecommendationsE403 instances are equal
        /// </summary>
        /// <param name="input">Instance of GetFeeRecommendationsE403 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetFeeRecommendationsE403 input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for GetFeeRecommendationsE403
    /// </summary>
    public class GetFeeRecommendationsE403JsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(GetFeeRecommendationsE403).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return GetFeeRecommendationsE403.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
