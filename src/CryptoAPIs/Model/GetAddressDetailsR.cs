...
namespace CryptoAPIs.Model
{
    ...
    /// GetAddressDetailsR
    /// </summary>
    [DataContract(Name = "GetAddressDetailsR")]
    public partial class GetAddressDetailsR : IEquatable<GetAddressDetailsR>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressDetailsR" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetAddressDetailsR() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressDetailsR" /> class.
        /// </summary>
        ...
        public GetAddressDetailsR(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetAddressDetailsRData data = default(GetAddressDetailsRData))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for GetAddressDetailsR and cannot be null");
            // to ensure "requestId" is required (not null)
            this.RequestId = requestId ?? throw new ArgumentNullException("requestId is a required property for GetAddressDetailsR and cannot be null");
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for GetAddressDetailsR and cannot be null");
        ...
        public GetAddressDetailsRData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAddressDetailsR {\n");
        ...
        {
            return this.Equals(input as GetAddressDetailsR);
        }

        /// <summary>
        /// Returns true if GetAddressDetailsR instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAddressDetailsR to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAddressDetailsR input)
        {
            if (input == null)
                return false;
