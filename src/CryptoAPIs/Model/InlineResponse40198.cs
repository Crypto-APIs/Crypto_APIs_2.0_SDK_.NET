...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40198
    /// </summary>
    [DataContract(Name = "inline_response_401_98")]
    public partial class InlineResponse40198 : IEquatable<InlineResponse40198>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40198" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40198() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40198" /> class.
        /// </summary>
        ...
        public InlineResponse40198(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetEIP1559FeeRecommendationsE401 error = default(GetEIP1559FeeRecommendationsE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40198 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40198 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40198 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40198 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40198);
        }

        /// <summary>
        /// Returns true if InlineResponse40198 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40198 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40198 input)
        {
            if (input == null)
            {
                return false;
