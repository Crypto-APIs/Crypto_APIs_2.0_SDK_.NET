...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4221
    /// </summary>
    [DataContract(Name = "inline_response_422_1")]
    public partial class InlineResponse4221 : IEquatable<InlineResponse4221>, IValidatableObject
    {
        ...
        public InlineResponse4221(string apiVersion = default(string), string requestId = default(string), string context = default(string), SyncHDWalletXPubYPubZPubE422 error = default(SyncHDWalletXPubYPubZPubE422))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4221 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4221 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse4221 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse4221);
        }

        /// <summary>
        /// Returns true if InlineResponse4221 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4221 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4221 input)
        {
            if (input == null)
            {
                return false;
