...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40374
    /// </summary>
    [DataContract(Name = "inline_response_403_74")]
    public partial class InlineResponse40374 : IEquatable<InlineResponse40374>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40374" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40374() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40374" /> class.
        /// </summary>
        ...
        public InlineResponse40374(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedInternalTransactionsAndEachConfirmationE403 error = default(NewConfirmedInternalTransactionsAndEachConfirmationE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40374 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40374 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40374 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40374 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40374);
        }

        /// <summary>
        /// Returns true if InlineResponse40374 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40374 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40374 input)
        {
            if (input == null)
            {
                return false;
