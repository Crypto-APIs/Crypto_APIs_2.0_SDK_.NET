...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40374 : IEquatable<InlineResponse40374>, IValidatableObject
    {
        ...
        public InlineResponse40374(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedTokensTransactionsE403 error = default(NewConfirmedTokensTransactionsE403))
        {
