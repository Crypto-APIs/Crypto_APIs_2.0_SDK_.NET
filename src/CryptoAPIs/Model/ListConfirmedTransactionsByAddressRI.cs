...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListConfirmedTransactionsByAddressRI")]
    public partial class ListConfirmedTransactionsByAddressRI : IEquatable<ListConfirmedTransactionsByAddressRI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListConfirmedTransactionsByAddressRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressRI" /> class.
        /// </summary>
        ...
        public ListConfirmedTransactionsByAddressRI(int index = default(int), string minedInBlockHash = default(string), int minedInBlockHeight = default(int), List<GetTransactionDetailsByTransactionIDRIRecipientsInner> recipients = default(List<GetTransactionDetailsByTransactionIDRIRecipientsInner>), List<GetTransactionDetailsByTransactionIDRISendersInner> senders = default(List<GetTransactionDetailsByTransactionIDRISendersInner>), int timestamp = default(int), string transactionHash = default(string), string transactionId = default(string), ListConfirmedTransactionsByAddressRIFee fee = default(ListConfirmedTransactionsByAddressRIFee), ListConfirmedTransactionsByAddressRIBS blockchainSpecific = default(ListConfirmedTransactionsByAddressRIBS))
        {
            this.Index = index;
            // to ensure "recipients" is required (not null)
            if (recipients == null)
            {
                throw new ArgumentNullException("recipients is a required property for ListConfirmedTransactionsByAddressRI and cannot be null");
            }
            this.Recipients = recipients;
            // to ensure "senders" is required (not null)
            if (senders == null)
            {
                throw new ArgumentNullException("senders is a required property for ListConfirmedTransactionsByAddressRI and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("transactionHash is a required property for ListConfirmedTransactionsByAddressRI and cannot be null");
            }
            this.TransactionHash = transactionHash;
            // to ensure "transactionId" is required (not null)
            if (transactionId == null)
            {
                throw new ArgumentNullException("transactionId is a required property for ListConfirmedTransactionsByAddressRI and cannot be null");
            }
            this.TransactionId = transactionId;
            // to ensure "fee" is required (not null)
            if (fee == null)
            {
                throw new ArgumentNullException("fee is a required property for ListConfirmedTransactionsByAddressRI and cannot be null");
            }
            this.Fee = fee;
            // to ensure "blockchainSpecific" is required (not null)
            if (blockchainSpecific == null)
            {
                throw new ArgumentNullException("blockchainSpecific is a required property for ListConfirmedTransactionsByAddressRI and cannot be null");
            }
        ...
        public ListConfirmedTransactionsByAddressRIBS BlockchainSpecific { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListConfirmedTransactionsByAddressRI {\n");
        ...
        {
            return this.Equals(input as ListConfirmedTransactionsByAddressRI);
        }

        /// <summary>
        /// Returns true if ListConfirmedTransactionsByAddressRI instances are equal
        /// </summary>
        /// <param name="input">Instance of ListConfirmedTransactionsByAddressRI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListConfirmedTransactionsByAddressRI input)
        {
            if (input == null)
            {
                return false;
