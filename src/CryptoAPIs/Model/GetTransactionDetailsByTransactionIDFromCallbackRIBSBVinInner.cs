...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetTransactionDetailsByTransactionIDFromCallbackRIBSB_vin_inner")]
    public partial class GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner : IEquatable<GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner" /> class.
        /// </summary>
        ...
        public GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner(List<string> addresses = default(List<string>), string coinbase = default(string), GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInnerScriptSig scriptSig = default(GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInnerScriptSig), long sequence = default(long), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            if (addresses == null)
            {
                throw new ArgumentNullException("addresses is a required property for GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner and cannot be null");
            }
            this.Addresses = addresses;
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null)
            {
                throw new ArgumentNullException("scriptSig is a required property for GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner and cannot be null");
            }
            ...
            if (txinwitness == null)
            {
                throw new ArgumentNullException("txinwitness is a required property for GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner and cannot be null");
            }
        ...
        public GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInnerScriptSig ScriptSig { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner {\n");
        ...
        {
            return this.Equals(input as GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner);
        }

        /// <summary>
        /// Returns true if GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner instances are equal
        /// </summary>
        /// <param name="input">Instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner input)
        {
            if (input == null)
            {
                return false;
