...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40316
    /// </summary>
    [DataContract(Name = "inline_response_403_16")]
    public partial class InlineResponse40316 : IEquatable<InlineResponse40316>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40316" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40316() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40316" /> class.
        /// </summary>
        ...
        public InlineResponse40316(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListXRPRippleTransactionsByAddressAndTimeRangeE403 error = default(ListXRPRippleTransactionsByAddressAndTimeRangeE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40316 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40316 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40316 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40316 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40316);
        }

        /// <summary>
        /// Returns true if InlineResponse40316 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40316 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40316 input)
        {
            if (input == null)
            {
                return false;
