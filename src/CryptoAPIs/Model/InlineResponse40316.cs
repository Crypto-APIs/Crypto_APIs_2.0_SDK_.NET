...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40316 : IEquatable<InlineResponse40316>, IValidatableObject
    {
        ...
        public InlineResponse40316(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListAllUnconfirmedTransactionsE403 error = default(ListAllUnconfirmedTransactionsE403))
        {
