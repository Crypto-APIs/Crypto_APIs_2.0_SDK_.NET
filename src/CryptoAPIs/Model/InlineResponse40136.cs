...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40136 : IEquatable<InlineResponse40136>, IValidatableObject
    {
        ...
        public InlineResponse40136(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetWalletAssetDetailsE401 error = default(GetWalletAssetDetailsE401))
        {
