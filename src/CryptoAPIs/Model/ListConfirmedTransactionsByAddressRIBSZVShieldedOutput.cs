...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListConfirmedTransactionsByAddressRIBSZ_vShieldedOutput")]
    public partial class ListConfirmedTransactionsByAddressRIBSZVShieldedOutput : IEquatable<ListConfirmedTransactionsByAddressRIBSZVShieldedOutput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressRIBSZVShieldedOutput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListConfirmedTransactionsByAddressRIBSZVShieldedOutput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressRIBSZVShieldedOutput" /> class.
        /// </summary>
        ...
        public ListConfirmedTransactionsByAddressRIBSZVShieldedOutput(string cmu = default(string), string cv = default(string), string encCipherText = default(string), string ephemeralKey = default(string), string outCipherText = default(string), string proof = default(string))
        {
            // to ensure "cmu" is required (not null)
            if (cmu == null) {
                throw new ArgumentNullException("cmu is a required property for ListConfirmedTransactionsByAddressRIBSZVShieldedOutput and cannot be null");
            }
            this.Cmu = cmu;
            // to ensure "cv" is required (not null)
            if (cv == null) {
                throw new ArgumentNullException("cv is a required property for ListConfirmedTransactionsByAddressRIBSZVShieldedOutput and cannot be null");
            }
            this.Cv = cv;
            // to ensure "encCipherText" is required (not null)
            if (encCipherText == null) {
                throw new ArgumentNullException("encCipherText is a required property for ListConfirmedTransactionsByAddressRIBSZVShieldedOutput and cannot be null");
            }
            this.EncCipherText = encCipherText;
            // to ensure "ephemeralKey" is required (not null)
            if (ephemeralKey == null) {
                throw new ArgumentNullException("ephemeralKey is a required property for ListConfirmedTransactionsByAddressRIBSZVShieldedOutput and cannot be null");
            }
            this.EphemeralKey = ephemeralKey;
            // to ensure "outCipherText" is required (not null)
            if (outCipherText == null) {
                throw new ArgumentNullException("outCipherText is a required property for ListConfirmedTransactionsByAddressRIBSZVShieldedOutput and cannot be null");
            }
            this.OutCipherText = outCipherText;
            // to ensure "proof" is required (not null)
            if (proof == null) {
                throw new ArgumentNullException("proof is a required property for ListConfirmedTransactionsByAddressRIBSZVShieldedOutput and cannot be null");
            }
            this.Proof = proof;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListConfirmedTransactionsByAddressRIBSZVShieldedOutput {\n");
        ...
        {
            return this.Equals(input as ListConfirmedTransactionsByAddressRIBSZVShieldedOutput);
        }

        /// <summary>
        /// Returns true if ListConfirmedTransactionsByAddressRIBSZVShieldedOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of ListConfirmedTransactionsByAddressRIBSZVShieldedOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListConfirmedTransactionsByAddressRIBSZVShieldedOutput input)
        {
            if (input == null)
                return false;
