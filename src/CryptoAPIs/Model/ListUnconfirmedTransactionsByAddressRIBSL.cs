...
namespace CryptoAPIs.Model
{
    ...
    /// Litecoin
    /// </summary>
    [DataContract(Name = "ListUnconfirmedTransactionsByAddressRIBSL")]
    public partial class ListUnconfirmedTransactionsByAddressRIBSL : IEquatable<ListUnconfirmedTransactionsByAddressRIBSL>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnconfirmedTransactionsByAddressRIBSL" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListUnconfirmedTransactionsByAddressRIBSL() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnconfirmedTransactionsByAddressRIBSL" /> class.
        /// </summary>
        ...
        public ListUnconfirmedTransactionsByAddressRIBSL(int locktime = default(int), int size = default(int), int vSize = default(int), int version = default(int), List<ListUnconfirmedTransactionsByAddressRIBSLVin> vin = default(List<ListUnconfirmedTransactionsByAddressRIBSLVin>), List<ListUnconfirmedTransactionsByAddressRIBSLVout> vout = default(List<ListUnconfirmedTransactionsByAddressRIBSLVout>))
        {
            ...
            if (vin == null) {
                throw new ArgumentNullException("vin is a required property for ListUnconfirmedTransactionsByAddressRIBSL and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null) {
                throw new ArgumentNullException("vout is a required property for ListUnconfirmedTransactionsByAddressRIBSL and cannot be null");
            }
            this.Vout = vout;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListUnconfirmedTransactionsByAddressRIBSL {\n");
        ...
        {
            return this.Equals(input as ListUnconfirmedTransactionsByAddressRIBSL);
        }

        /// <summary>
        /// Returns true if ListUnconfirmedTransactionsByAddressRIBSL instances are equal
        /// </summary>
        /// <param name="input">Instance of ListUnconfirmedTransactionsByAddressRIBSL to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListUnconfirmedTransactionsByAddressRIBSL input)
        {
            if (input == null)
            {
                return false;
