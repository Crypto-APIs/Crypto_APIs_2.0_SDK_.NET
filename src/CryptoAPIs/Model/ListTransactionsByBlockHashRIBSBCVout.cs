...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListTransactionsByBlockHashRIBSBC_vout")]
    public partial class ListTransactionsByBlockHashRIBSBCVout : IEquatable<ListTransactionsByBlockHashRIBSBCVout>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashRIBSBCVout" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByBlockHashRIBSBCVout() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashRIBSBCVout" /> class.
        /// </summary>
        ...
        public ListTransactionsByBlockHashRIBSBCVout(bool isSpent = default(bool), ListTransactionsByBlockHashRIBSBCScriptPubKey scriptPubKey = default(ListTransactionsByBlockHashRIBSBCScriptPubKey), string value = default(string))
        {
        ...
        public ListTransactionsByBlockHashRIBSBCScriptPubKey ScriptPubKey { get; set; }
        ...
        {
            return this.Equals(input as ListTransactionsByBlockHashRIBSBCVout);
        }

        /// <summary>
        /// Returns true if ListTransactionsByBlockHashRIBSBCVout instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByBlockHashRIBSBCVout to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByBlockHashRIBSBCVout input)
        {
            if (input == null)
            {
                return false;
