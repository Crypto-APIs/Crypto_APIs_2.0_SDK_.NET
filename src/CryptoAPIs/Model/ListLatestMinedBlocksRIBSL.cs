...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListLatestMinedBlocksRIBSL : IEquatable<ListLatestMinedBlocksRIBSL>, IValidatableObject
    {
        ...
        public ListLatestMinedBlocksRIBSL(string bits = default(string), string chainwork = default(string), string difficulty = default(string), string merkleRoot = default(string), long nonce = default(long), int size = default(int), int strippedSize = default(int), int version = default(int), string versionHex = default(string), int weight = default(int))
        {
