...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40095
    /// </summary>
    [DataContract(Name = "inline_response_400_95")]
    public partial class InlineResponse40095 : IEquatable<InlineResponse40095>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40095" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40095() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40095" /> class.
        /// </summary>
        ...
        public InlineResponse40095(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetFeeAddressDetailsE400 error = default(GetFeeAddressDetailsE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40095 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40095 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40095 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40095 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40095);
        }

        /// <summary>
        /// Returns true if InlineResponse40095 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40095 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40095 input)
        {
            if (input == null)
            {
                return false;
