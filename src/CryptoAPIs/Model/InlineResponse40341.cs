...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40341
    /// </summary>
    [DataContract(Name = "inline_response_403_41")]
    public partial class InlineResponse40341 : IEquatable<InlineResponse40341>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40341" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40341() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40341" /> class.
        /// </summary>
        ...
        public InlineResponse40341(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListOmniTransactionsByBlockHeightE403 error = default(ListOmniTransactionsByBlockHeightE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40341 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40341 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40341 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40341 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40341);
        }

        /// <summary>
        /// Returns true if InlineResponse40341 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40341 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40341 input)
        {
            if (input == null)
            {
                return false;
