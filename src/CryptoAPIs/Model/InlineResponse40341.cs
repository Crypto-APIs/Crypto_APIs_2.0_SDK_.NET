...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40341 : IEquatable<InlineResponse40341>, IValidatableObject
    {
        ...
        public InlineResponse40341(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetTransactionRequestDetailsE403 error = default(GetTransactionRequestDetailsE403))
        {
