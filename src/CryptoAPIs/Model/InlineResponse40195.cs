...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40195
    /// </summary>
    [DataContract(Name = "inline_response_401_95")]
    public partial class InlineResponse40195 : IEquatable<InlineResponse40195>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40195" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40195() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40195" /> class.
        /// </summary>
        ...
        public InlineResponse40195(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetFeeAddressDetailsE401 error = default(GetFeeAddressDetailsE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40195 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40195 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40195 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40195 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40195);
        }

        /// <summary>
        /// Returns true if InlineResponse40195 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40195 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40195 input)
        {
            if (input == null)
            {
                return false;
