...
namespace CryptoAPIs.Model
{
    ...
    /// Binance Smart Chain
    /// </summary>
    [DataContract(Name = "GetBlockDetailsByBlockHashRIBSBSC")]
    public partial class GetBlockDetailsByBlockHashRIBSBSC : IEquatable<GetBlockDetailsByBlockHashRIBSBSC>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHashRIBSBSC" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetBlockDetailsByBlockHashRIBSBSC() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHashRIBSBSC" /> class.
        /// </summary>
        ...
        /// <param name="sha3Uncles">Defines the combined hash of all uncles for a given paren (required).</param>
        ...
        public GetBlockDetailsByBlockHashRIBSBSC(string difficulty = default(string), string nonce = default(string), int size = default(int), string extraData = default(string), string gasLimit = default(string), string gasUsed = default(string), int minedInSeconds = default(int), string sha3Uncles = default(string), string totalDifficulty = default(string))
        {
            ...
            if (difficulty == null) {
                throw new ArgumentNullException("difficulty is a required property for GetBlockDetailsByBlockHashRIBSBSC and cannot be null");
            }
            this.Difficulty = difficulty;
            // to ensure "nonce" is required (not null)
            if (nonce == null) {
                throw new ArgumentNullException("nonce is a required property for GetBlockDetailsByBlockHashRIBSBSC and cannot be null");
            }
            this.Nonce = nonce;
            this.Size = size;
            // to ensure "extraData" is required (not null)
            if (extraData == null) {
                throw new ArgumentNullException("extraData is a required property for GetBlockDetailsByBlockHashRIBSBSC and cannot be null");
            }
            this.ExtraData = extraData;
            // to ensure "gasLimit" is required (not null)
            if (gasLimit == null) {
                throw new ArgumentNullException("gasLimit is a required property for GetBlockDetailsByBlockHashRIBSBSC and cannot be null");
            }
            this.GasLimit = gasLimit;
            // to ensure "gasUsed" is required (not null)
            if (gasUsed == null) {
                throw new ArgumentNullException("gasUsed is a required property for GetBlockDetailsByBlockHashRIBSBSC and cannot be null");
            }
            this.GasUsed = gasUsed;
            this.MinedInSeconds = minedInSeconds;
            // to ensure "sha3Uncles" is required (not null)
            if (sha3Uncles == null) {
                throw new ArgumentNullException("sha3Uncles is a required property for GetBlockDetailsByBlockHashRIBSBSC and cannot be null");
            }
            this.Sha3Uncles = sha3Uncles;
            // to ensure "totalDifficulty" is required (not null)
            if (totalDifficulty == null) {
                throw new ArgumentNullException("totalDifficulty is a required property for GetBlockDetailsByBlockHashRIBSBSC and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Defines the combined hash of all uncles for a given paren</value>
        ...
        {
            return this.Equals(input as GetBlockDetailsByBlockHashRIBSBSC);
        }

        /// <summary>
        /// Returns true if GetBlockDetailsByBlockHashRIBSBSC instances are equal
        /// </summary>
        /// <param name="input">Instance of GetBlockDetailsByBlockHashRIBSBSC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetBlockDetailsByBlockHashRIBSBSC input)
        {
            if (input == null)
                return false;
