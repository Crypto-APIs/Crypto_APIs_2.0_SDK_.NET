...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40911
    /// </summary>
    [DataContract(Name = "inline_response_409_11")]
    public partial class InlineResponse40911 : IEquatable<InlineResponse40911>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40911" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40911() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40911" /> class.
        /// </summary>
        ...
        public InlineResponse40911(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedCoinsTransactionsAndEachConfirmationE409 error = default(NewConfirmedCoinsTransactionsAndEachConfirmationE409))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40911 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40911 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40911 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse40911);
        }

        /// <summary>
        /// Returns true if InlineResponse40911 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40911 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40911 input)
        {
            if (input == null)
            {
                return false;
