...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40096
    /// </summary>
    [DataContract(Name = "inline_response_400_96")]
    public partial class InlineResponse40096 : IEquatable<InlineResponse40096>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40096" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40096() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40096" /> class.
        /// </summary>
        ...
        public InlineResponse40096(string apiVersion = default(string), string requestId = default(string), string context = default(string), DeleteAutomaticTokensForwardingE400 error = default(DeleteAutomaticTokensForwardingE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40096 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40096 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40096 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40096 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40096);
        }

        /// <summary>
        /// Returns true if InlineResponse40096 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40096 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40096 input)
        {
            if (input == null)
            {
                return false;
