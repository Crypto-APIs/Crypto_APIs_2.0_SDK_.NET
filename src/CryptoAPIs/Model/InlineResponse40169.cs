...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40169 : IEquatable<InlineResponse40169>, IValidatableObject
    {
        ...
        public InlineResponse40169(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetAddressDetailsFromCallbackE401 error = default(GetAddressDetailsFromCallbackE401))
        {
