...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40169
    /// </summary>
    [DataContract(Name = "inline_response_401_69")]
    public partial class InlineResponse40169 : IEquatable<InlineResponse40169>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40169" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40169() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40169" /> class.
        /// </summary>
        ...
        public InlineResponse40169(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetTokenDetailsByContractAddressE401 error = default(GetTokenDetailsByContractAddressE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40169 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40169 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40169 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40169 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40169);
        }

        /// <summary>
        /// Returns true if InlineResponse40169 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40169 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40169 input)
        {
            if (input == null)
            {
                return false;
