...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListXRPRippleTransactionsByAddressAndTimeRangeRI")]
    public partial class ListXRPRippleTransactionsByAddressAndTimeRangeRI : IEquatable<ListXRPRippleTransactionsByAddressAndTimeRangeRI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListXRPRippleTransactionsByAddressAndTimeRangeRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListXRPRippleTransactionsByAddressAndTimeRangeRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListXRPRippleTransactionsByAddressAndTimeRangeRI" /> class.
        /// </summary>
        /// <param name="destinationTag">A destination tag is a value used to discern the holder of the Ripple (XRP) being deposited or withdrawn..</param>
        ...
        public ListXRPRippleTransactionsByAddressAndTimeRangeRI(long destinationTag = default(long), int index = default(int), string minedInBlockHash = default(string), int minedInBlockHeight = default(int), List<GetXRPRippleTransactionDetailsByTransactionIDRIRecipientsInner> recipients = default(List<GetXRPRippleTransactionDetailsByTransactionIDRIRecipientsInner>), List<GetXRPRippleTransactionDetailsByTransactionIDRISendersInner> senders = default(List<GetXRPRippleTransactionDetailsByTransactionIDRISendersInner>), long sequence = default(long), string status = default(string), int timestamp = default(int), string transactionHash = default(string), string type = default(string), ListXRPRippleTransactionsByAddressRIFee fee = default(ListXRPRippleTransactionsByAddressRIFee), ListXRPRippleTransactionsByAddressRIOffer offer = default(ListXRPRippleTransactionsByAddressRIOffer), ListXRPRippleTransactionsByAddressRIReceive receive = default(ListXRPRippleTransactionsByAddressRIReceive), ListXRPRippleTransactionsByAddressRIValue value = default(ListXRPRippleTransactionsByAddressRIValue))
        {
            ...
            if (recipients == null)
            {
                throw new ArgumentNullException("recipients is a required property for ListXRPRippleTransactionsByAddressAndTimeRangeRI and cannot be null");
            }
            this.Recipients = recipients;
            // to ensure "senders" is required (not null)
            if (senders == null)
            {
                throw new ArgumentNullException("senders is a required property for ListXRPRippleTransactionsByAddressAndTimeRangeRI and cannot be null");
            }
            ...
            if (status == null)
            {
                throw new ArgumentNullException("status is a required property for ListXRPRippleTransactionsByAddressAndTimeRangeRI and cannot be null");
            }
            this.Status = status;
            ...
            {
                throw new ArgumentNullException("transactionHash is a required property for ListXRPRippleTransactionsByAddressAndTimeRangeRI and cannot be null");
            }
            this.TransactionHash = transactionHash;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for ListXRPRippleTransactionsByAddressAndTimeRangeRI and cannot be null");
            }
            this.Type = type;
            // to ensure "fee" is required (not null)
            if (fee == null)
            {
                throw new ArgumentNullException("fee is a required property for ListXRPRippleTransactionsByAddressAndTimeRangeRI and cannot be null");
            }
            this.Fee = fee;
            // to ensure "offer" is required (not null)
            if (offer == null)
            {
                throw new ArgumentNullException("offer is a required property for ListXRPRippleTransactionsByAddressAndTimeRangeRI and cannot be null");
            }
            this.Offer = offer;
            // to ensure "receive" is required (not null)
            if (receive == null)
            {
                throw new ArgumentNullException("receive is a required property for ListXRPRippleTransactionsByAddressAndTimeRangeRI and cannot be null");
            }
            this.Receive = receive;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for ListXRPRippleTransactionsByAddressAndTimeRangeRI and cannot be null");
            }
            this.Value = value;
        ...
        /// </summary>
        /// <value>A destination tag is a value used to discern the holder of the Ripple (XRP) being deposited or withdrawn.</value>
        ...
        {
            return this.Equals(input as ListXRPRippleTransactionsByAddressAndTimeRangeRI);
        }

        /// <summary>
        /// Returns true if ListXRPRippleTransactionsByAddressAndTimeRangeRI instances are equal
        /// </summary>
        /// <param name="input">Instance of ListXRPRippleTransactionsByAddressAndTimeRangeRI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListXRPRippleTransactionsByAddressAndTimeRangeRI input)
        {
            if (input == null)
            {
                return false;
