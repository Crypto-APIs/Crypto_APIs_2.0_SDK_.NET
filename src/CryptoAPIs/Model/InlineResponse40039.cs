...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40039
    /// </summary>
    [DataContract(Name = "inline_response_400_39")]
    public partial class InlineResponse40039 : IEquatable<InlineResponse40039>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40039" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40039() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40039" /> class.
        /// </summary>
        ...
        public InlineResponse40039(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetLatestMinedXRPRippleBlockE400 error = default(GetLatestMinedXRPRippleBlockE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40039 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40039 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40039 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40039 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40039);
        }

        /// <summary>
        /// Returns true if InlineResponse40039 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40039 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40039 input)
        {
            if (input == null)
            {
                return false;
