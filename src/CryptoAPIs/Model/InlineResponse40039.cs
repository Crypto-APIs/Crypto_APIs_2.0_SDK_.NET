...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40039 : IEquatable<InlineResponse40039>, IValidatableObject
    {
        ...
        public InlineResponse40039(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListAllAssetsByWalletIDE400 error = default(ListAllAssetsByWalletIDE400))
        {
