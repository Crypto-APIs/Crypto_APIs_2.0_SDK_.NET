...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40369 : IEquatable<InlineResponse40369>, IValidatableObject
    {
        ...
        public InlineResponse40369(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetAddressDetailsFromCallbackE403 error = default(GetAddressDetailsFromCallbackE403))
        {
