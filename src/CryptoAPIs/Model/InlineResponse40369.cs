...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40369
    /// </summary>
    [DataContract(Name = "inline_response_403_69")]
    public partial class InlineResponse40369 : IEquatable<InlineResponse40369>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40369" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40369() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40369" /> class.
        /// </summary>
        ...
        public InlineResponse40369(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetTokenDetailsByContractAddressE403 error = default(GetTokenDetailsByContractAddressE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40369 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40369 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40369 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40369 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40369);
        }

        /// <summary>
        /// Returns true if InlineResponse40369 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40369 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40369 input)
        {
            if (input == null)
            {
                return false;
