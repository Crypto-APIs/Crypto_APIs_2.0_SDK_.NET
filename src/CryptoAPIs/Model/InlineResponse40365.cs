...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40365 : IEquatable<InlineResponse40365>, IValidatableObject
    {
        ...
        public InlineResponse40365(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewBlockE403 error = default(NewBlockE403))
        {
        ...
        public NewBlockE403 Error { get; set; }
