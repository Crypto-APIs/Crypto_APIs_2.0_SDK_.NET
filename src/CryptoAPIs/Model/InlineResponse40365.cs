...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40365
    /// </summary>
    [DataContract(Name = "inline_response_403_65")]
    public partial class InlineResponse40365 : IEquatable<InlineResponse40365>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40365" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40365() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40365" /> class.
        /// </summary>
        ...
        public InlineResponse40365(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetRawTransactionDataE403 error = default(GetRawTransactionDataE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40365 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40365 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40365 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40365 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40365);
        }

        /// <summary>
        /// Returns true if InlineResponse40365 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40365 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40365 input)
        {
            if (input == null)
            {
                return false;
