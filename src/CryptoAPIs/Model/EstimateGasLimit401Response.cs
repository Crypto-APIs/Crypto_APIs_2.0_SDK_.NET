...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Estimate_Gas_Limit_401_response")]
    public partial class EstimateGasLimit401Response : IEquatable<EstimateGasLimit401Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EstimateGasLimit401Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EstimateGasLimit401Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EstimateGasLimit401Response" /> class.
        /// </summary>
        ...
        public EstimateGasLimit401Response(string apiVersion = default(string), string requestId = default(string), string context = default(string), EstimateGasLimitE401 error = default(EstimateGasLimitE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for EstimateGasLimit401Response and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for EstimateGasLimit401Response and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for EstimateGasLimit401Response and cannot be null");
            }
            this.Error = error;
        ...
        public EstimateGasLimitE401 Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EstimateGasLimit401Response {\n");
        ...
        {
            return this.Equals(input as EstimateGasLimit401Response);
        }

        /// <summary>
        /// Returns true if EstimateGasLimit401Response instances are equal
        /// </summary>
        /// <param name="input">Instance of EstimateGasLimit401Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EstimateGasLimit401Response input)
        {
            if (input == null)
            {
                return false;
