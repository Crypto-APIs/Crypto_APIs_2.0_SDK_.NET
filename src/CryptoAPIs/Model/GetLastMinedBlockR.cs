...
namespace CryptoAPIs.Model
{
    ...
    /// GetLastMinedBlockR
    /// </summary>
    [DataContract(Name = "GetLastMinedBlockR")]
    public partial class GetLastMinedBlockR : IEquatable<GetLastMinedBlockR>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLastMinedBlockR" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetLastMinedBlockR() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLastMinedBlockR" /> class.
        /// </summary>
        ...
        public GetLastMinedBlockR(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetLastMinedBlockRData data = default(GetLastMinedBlockRData))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for GetLastMinedBlockR and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for GetLastMinedBlockR and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for GetLastMinedBlockR and cannot be null");
            }
            this.Data = data;
        ...
        public GetLastMinedBlockRData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetLastMinedBlockR {\n");
        ...
        {
            return this.Equals(input as GetLastMinedBlockR);
        }

        /// <summary>
        /// Returns true if GetLastMinedBlockR instances are equal
        /// </summary>
        /// <param name="input">Instance of GetLastMinedBlockR to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetLastMinedBlockR input)
        {
            if (input == null)
            {
                return false;
