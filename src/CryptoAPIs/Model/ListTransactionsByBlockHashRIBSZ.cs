...
namespace CryptoAPIs.Model
{
    ...
    /// Zcash
    /// </summary>
    [DataContract(Name = "ListTransactionsByBlockHashRIBSZ")]
    public partial class ListTransactionsByBlockHashRIBSZ : IEquatable<ListTransactionsByBlockHashRIBSZ>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashRIBSZ" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByBlockHashRIBSZ() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashRIBSZ" /> class.
        /// </summary>
        ...
        /// <param name="version">Numeric representation of the transaction Represents the transaction version number. (required).</param>
        ...
        public ListTransactionsByBlockHashRIBSZ(string bindingSig = default(string), int expiryHeight = default(int), string joinSplitPubKey = default(string), string joinSplitSig = default(string), int locktime = default(int), bool overwintered = default(bool), int size = default(int), List<ListTransactionsByBlockHashRIBSZVJoinSplit> vJoinSplit = default(List<ListTransactionsByBlockHashRIBSZVJoinSplit>), List<ListConfirmedTransactionsByAddressRIBSZVShieldedOutput> vShieldedOutput = default(List<ListConfirmedTransactionsByAddressRIBSZVShieldedOutput>), List<ListConfirmedTransactionsByAddressRIBSZVShieldedSpend> vShieldedSpend = default(List<ListConfirmedTransactionsByAddressRIBSZVShieldedSpend>), string valueBalance = default(string), int version = default(int), string versionGroupId = default(string), List<ListTransactionsByBlockHashRIBSZVin> vin = default(List<ListTransactionsByBlockHashRIBSZVin>), List<ListConfirmedTransactionsByAddressRIBSZVout> vout = default(List<ListConfirmedTransactionsByAddressRIBSZVout>))
        {
            // to ensure "bindingSig" is required (not null)
            if (bindingSig == null) {
                throw new ArgumentNullException("bindingSig is a required property for ListTransactionsByBlockHashRIBSZ and cannot be null");
            }
            this.BindingSig = bindingSig;
            this.ExpiryHeight = expiryHeight;
            // to ensure "joinSplitPubKey" is required (not null)
            if (joinSplitPubKey == null) {
                throw new ArgumentNullException("joinSplitPubKey is a required property for ListTransactionsByBlockHashRIBSZ and cannot be null");
            }
            this.JoinSplitPubKey = joinSplitPubKey;
            // to ensure "joinSplitSig" is required (not null)
            if (joinSplitSig == null) {
                throw new ArgumentNullException("joinSplitSig is a required property for ListTransactionsByBlockHashRIBSZ and cannot be null");
            }
            ...
            if (vJoinSplit == null) {
                throw new ArgumentNullException("vJoinSplit is a required property for ListTransactionsByBlockHashRIBSZ and cannot be null");
            }
            this.VJoinSplit = vJoinSplit;
            // to ensure "vShieldedOutput" is required (not null)
            if (vShieldedOutput == null) {
                throw new ArgumentNullException("vShieldedOutput is a required property for ListTransactionsByBlockHashRIBSZ and cannot be null");
            }
            this.VShieldedOutput = vShieldedOutput;
            // to ensure "vShieldedSpend" is required (not null)
            if (vShieldedSpend == null) {
                throw new ArgumentNullException("vShieldedSpend is a required property for ListTransactionsByBlockHashRIBSZ and cannot be null");
            }
            this.VShieldedSpend = vShieldedSpend;
            // to ensure "valueBalance" is required (not null)
            if (valueBalance == null) {
                throw new ArgumentNullException("valueBalance is a required property for ListTransactionsByBlockHashRIBSZ and cannot be null");
            }
            this.ValueBalance = valueBalance;
            this._Version = version;
            // to ensure "versionGroupId" is required (not null)
            if (versionGroupId == null) {
                throw new ArgumentNullException("versionGroupId is a required property for ListTransactionsByBlockHashRIBSZ and cannot be null");
            }
            this.VersionGroupId = versionGroupId;
            // to ensure "vin" is required (not null)
            if (vin == null) {
                throw new ArgumentNullException("vin is a required property for ListTransactionsByBlockHashRIBSZ and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null) {
                throw new ArgumentNullException("vout is a required property for ListTransactionsByBlockHashRIBSZ and cannot be null");
            }
            this.Vout = vout;
        }
        ...
        public List<ListTransactionsByBlockHashRIBSZVJoinSplit> VJoinSplit { get; set; }
        ...
        /// </summary>
        /// <value>Numeric representation of the transaction Represents the transaction version number.</value>
        ...
        public List<ListTransactionsByBlockHashRIBSZVin> Vin { get; set; }
        ...
        {
            return this.Equals(input as ListTransactionsByBlockHashRIBSZ);
        }

        /// <summary>
        /// Returns true if ListTransactionsByBlockHashRIBSZ instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByBlockHashRIBSZ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByBlockHashRIBSZ input)
        {
            if (input == null)
                return false;
