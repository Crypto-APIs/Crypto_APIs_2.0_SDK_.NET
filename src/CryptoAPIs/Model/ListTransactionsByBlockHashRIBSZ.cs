...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListTransactionsByBlockHashRIBSZ : IEquatable<ListTransactionsByBlockHashRIBSZ>, IValidatableObject
    {
        ...
        public ListTransactionsByBlockHashRIBSZ(string bindingSig = default(string), int expiryHeight = default(int), string joinSplitPubKey = default(string), string joinSplitSig = default(string), int locktime = default(int), bool overwintered = default(bool), int size = default(int), List<ListTransactionsByBlockHashRIBSZVJoinSplit> vJoinSplit = default(List<ListTransactionsByBlockHashRIBSZVJoinSplit>), List<GetTransactionDetailsByTransactionIDRIBSZVShieldedOutput> vShieldedOutput = default(List<GetTransactionDetailsByTransactionIDRIBSZVShieldedOutput>), List<GetTransactionDetailsByTransactionIDRIBSZVShieldedSpend> vShieldedSpend = default(List<GetTransactionDetailsByTransactionIDRIBSZVShieldedSpend>), string valueBalance = default(string), int version = default(int), string versionGroupId = default(string), List<ListTransactionsByBlockHashRIBSZVin> vin = default(List<ListTransactionsByBlockHashRIBSZVin>), List<GetTransactionDetailsByTransactionIDRIBSZVout> vout = default(List<GetTransactionDetailsByTransactionIDRIBSZVout>))
        {
