...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40034 : IEquatable<InlineResponse40034>, IValidatableObject
    {
        ...
        public InlineResponse40034(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListSupportedTokensE400 error = default(ListSupportedTokensE400))
        {
