...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40034
    /// </summary>
    [DataContract(Name = "inline_response_400_34")]
    public partial class InlineResponse40034 : IEquatable<InlineResponse40034>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40034" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40034() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40034" /> class.
        /// </summary>
        ...
        public InlineResponse40034(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetZilliqaBlockDetailsByBlockHashE400 error = default(GetZilliqaBlockDetailsByBlockHashE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40034 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40034 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40034 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40034 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40034);
        }

        /// <summary>
        /// Returns true if InlineResponse40034 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40034 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40034 input)
        {
            if (input == null)
            {
                return false;
