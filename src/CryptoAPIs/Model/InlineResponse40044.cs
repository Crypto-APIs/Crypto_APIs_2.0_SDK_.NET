...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40044 : IEquatable<InlineResponse40044>, IValidatableObject
    {
        ...
        public InlineResponse40044(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetTransactionRequestDetailsE400 error = default(GetTransactionRequestDetailsE400))
        {
