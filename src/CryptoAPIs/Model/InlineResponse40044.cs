...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40044
    /// </summary>
    [DataContract(Name = "inline_response_400_44")]
    public partial class InlineResponse40044 : IEquatable<InlineResponse40044>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40044" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40044() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40044" /> class.
        /// </summary>
        ...
        public InlineResponse40044(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListOmniTransactionsByBlockHashE400 error = default(ListOmniTransactionsByBlockHashE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40044 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40044 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40044 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40044 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40044);
        }

        /// <summary>
        /// Returns true if InlineResponse40044 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40044 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40044 input)
        {
            if (input == null)
            {
                return false;
