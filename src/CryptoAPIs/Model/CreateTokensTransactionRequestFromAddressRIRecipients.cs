...
namespace CryptoAPIs.Model
{
    ...
    public partial class CreateTokensTransactionRequestFromAddressRIRecipients : IEquatable<CreateTokensTransactionRequestFromAddressRIRecipients>, IValidatableObject
    {
        ...
        public CreateTokensTransactionRequestFromAddressRIRecipients(string address = default(string), string amount = default(string))
        {
            ...
            if (address == null) {
                throw new ArgumentNullException("address is a required property for CreateTokensTransactionRequestFromAddressRIRecipients and cannot be null");
            }
            this.Address = address;
            // to ensure "amount" is required (not null)
            if (amount == null) {
                throw new ArgumentNullException("amount is a required property for CreateTokensTransactionRequestFromAddressRIRecipients and cannot be null");
            }
            this.Amount = amount;
        }
