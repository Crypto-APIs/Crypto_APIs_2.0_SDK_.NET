...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40093
    /// </summary>
    [DataContract(Name = "inline_response_400_93")]
    public partial class InlineResponse40093 : IEquatable<InlineResponse40093>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40093" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40093() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40093" /> class.
        /// </summary>
        ...
        public InlineResponse40093(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateAutomaticTokensForwardingE400 error = default(CreateAutomaticTokensForwardingE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40093 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40093 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40093 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40093 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40093);
        }

        /// <summary>
        /// Returns true if InlineResponse40093 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40093 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40093 input)
        {
            if (input == null)
            {
                return false;
