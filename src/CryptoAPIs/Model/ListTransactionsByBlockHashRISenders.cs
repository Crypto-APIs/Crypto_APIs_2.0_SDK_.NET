...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListTransactionsByBlockHashRISenders : IEquatable<ListTransactionsByBlockHashRISenders>, IValidatableObject
    {
        ...
        public ListTransactionsByBlockHashRISenders(string address = default(string), string amount = default(string))
        {
            ...
            if (address == null) {
                throw new ArgumentNullException("address is a required property for ListTransactionsByBlockHashRISenders and cannot be null");
            }
            this.Address = address;
            // to ensure "amount" is required (not null)
            if (amount == null) {
                throw new ArgumentNullException("amount is a required property for ListTransactionsByBlockHashRISenders and cannot be null");
            }
            this.Amount = amount;
        }
