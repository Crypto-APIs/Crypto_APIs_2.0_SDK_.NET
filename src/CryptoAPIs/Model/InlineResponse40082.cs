...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40082 : IEquatable<InlineResponse40082>, IValidatableObject
    {
        ...
        public InlineResponse40082(string apiVersion = default(string), string requestId = default(string), string context = default(string), DeleteAutomaticTokensForwardingE400 error = default(DeleteAutomaticTokensForwardingE400))
        {
