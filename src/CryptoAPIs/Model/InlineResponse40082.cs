...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40082
    /// </summary>
    [DataContract(Name = "inline_response_400_82")]
    public partial class InlineResponse40082 : IEquatable<InlineResponse40082>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40082" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40082() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40082" /> class.
        /// </summary>
        ...
        public InlineResponse40082(string apiVersion = default(string), string requestId = default(string), string context = default(string), DeleteBlockchainEventSubscriptionE400 error = default(DeleteBlockchainEventSubscriptionE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40082 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40082 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40082 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40082 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40082);
        }

        /// <summary>
        /// Returns true if InlineResponse40082 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40082 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40082 input)
        {
            if (input == null)
            {
                return false;
