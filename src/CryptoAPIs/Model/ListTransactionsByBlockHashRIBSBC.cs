...
namespace CryptoAPIs.Model
{
    ...
    /// Bitcoin Cash
    /// </summary>
    [DataContract(Name = "ListTransactionsByBlockHashRIBSBC")]
    public partial class ListTransactionsByBlockHashRIBSBC : IEquatable<ListTransactionsByBlockHashRIBSBC>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashRIBSBC" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByBlockHashRIBSBC() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashRIBSBC" /> class.
        /// </summary>
        ...
        public ListTransactionsByBlockHashRIBSBC(long locktime = default(long), int size = default(int), int version = default(int), List<ListTransactionsByBlockHashRIBSBCVinInner> vin = default(List<ListTransactionsByBlockHashRIBSBCVinInner>), List<ListTransactionsByBlockHashRIBSBCVoutInner> vout = default(List<ListTransactionsByBlockHashRIBSBCVoutInner>))
        {
            ...
            if (vin == null)
            {
                throw new ArgumentNullException("vin is a required property for ListTransactionsByBlockHashRIBSBC and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null)
            {
                throw new ArgumentNullException("vout is a required property for ListTransactionsByBlockHashRIBSBC and cannot be null");
            }
            this.Vout = vout;
        }
        ...
        {
            return this.Equals(input as ListTransactionsByBlockHashRIBSBC);
        }

        /// <summary>
        /// Returns true if ListTransactionsByBlockHashRIBSBC instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByBlockHashRIBSBC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByBlockHashRIBSBC input)
        {
            if (input == null)
            {
                return false;
