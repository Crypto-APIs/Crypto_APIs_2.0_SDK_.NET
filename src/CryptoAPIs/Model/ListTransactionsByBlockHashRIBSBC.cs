...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListTransactionsByBlockHashRIBSBC : IEquatable<ListTransactionsByBlockHashRIBSBC>, IValidatableObject
    {
        ...
        public ListTransactionsByBlockHashRIBSBC(int locktime = default(int), int size = default(int), int version = default(int), List<ListTransactionsByBlockHashRIBSBCVin> vin = default(List<ListTransactionsByBlockHashRIBSBCVin>), List<ListTransactionsByBlockHashRIBSBCVout> vout = default(List<ListTransactionsByBlockHashRIBSBCVout>))
        {
            this.Locktime = locktime;
            this.Size = size;
            this.Version = version;
            // to ensure "vin" is required (not null)
            this.Vin = vin ?? throw new ArgumentNullException("vin is a required property for ListTransactionsByBlockHashRIBSBC and cannot be null");
            // to ensure "vout" is required (not null)
            this.Vout = vout ?? throw new ArgumentNullException("vout is a required property for ListTransactionsByBlockHashRIBSBC and cannot be null");
        }
