...
namespace CryptoAPIs.Model
{
    ...
    /// Litecoin
    /// </summary>
    [DataContract(Name = "GetTransactionDetailsByTransactionIDRIBSL")]
    public partial class GetTransactionDetailsByTransactionIDRIBSL : IEquatable<GetTransactionDetailsByTransactionIDRIBSL>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDRIBSL" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetTransactionDetailsByTransactionIDRIBSL() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDRIBSL" /> class.
        /// </summary>
        ...
        public GetTransactionDetailsByTransactionIDRIBSL(int locktime = default(int), int size = default(int), int version = default(int), List<GetTransactionDetailsByTransactionIDRIBSLVin> vin = default(List<GetTransactionDetailsByTransactionIDRIBSLVin>), List<GetTransactionDetailsByTransactionIDRIBSLVout> vout = default(List<GetTransactionDetailsByTransactionIDRIBSLVout>), int vsize = default(int))
        {
            this.Locktime = locktime;
            this.Size = size;
            this.Version = version;
            // to ensure "vin" is required (not null)
            this.Vin = vin ?? throw new ArgumentNullException("vin is a required property for GetTransactionDetailsByTransactionIDRIBSL and cannot be null");
            // to ensure "vout" is required (not null)
            this.Vout = vout ?? throw new ArgumentNullException("vout is a required property for GetTransactionDetailsByTransactionIDRIBSL and cannot be null");
            this.Vsize = vsize;
        }
        ...
        {
            return this.Equals(input as GetTransactionDetailsByTransactionIDRIBSL);
        }

        /// <summary>
        /// Returns true if GetTransactionDetailsByTransactionIDRIBSL instances are equal
        /// </summary>
        /// <param name="input">Instance of GetTransactionDetailsByTransactionIDRIBSL to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetTransactionDetailsByTransactionIDRIBSL input)
        {
            if (input == null)
                return false;
