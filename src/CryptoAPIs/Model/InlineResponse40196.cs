...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40196
    /// </summary>
    [DataContract(Name = "inline_response_401_96")]
    public partial class InlineResponse40196 : IEquatable<InlineResponse40196>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40196" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40196() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40196" /> class.
        /// </summary>
        ...
        public InlineResponse40196(string apiVersion = default(string), string requestId = default(string), string context = default(string), DeleteAutomaticTokensForwardingE401 error = default(DeleteAutomaticTokensForwardingE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40196 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40196 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40196 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40196 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40196);
        }

        /// <summary>
        /// Returns true if InlineResponse40196 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40196 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40196 input)
        {
            if (input == null)
            {
                return false;
