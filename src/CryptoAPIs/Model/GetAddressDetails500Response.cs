...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Get_Address_Details_500_response")]
    public partial class GetAddressDetails500Response : IEquatable<GetAddressDetails500Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressDetails500Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetAddressDetails500Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressDetails500Response" /> class.
        /// </summary>
        ...
        public GetAddressDetails500Response(string apiVersion = default(string), string requestId = default(string), string context = default(string), UnexpectedServerError error = default(UnexpectedServerError))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for GetAddressDetails500Response and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for GetAddressDetails500Response and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for GetAddressDetails500Response and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAddressDetails500Response {\n");
        ...
        {
            return this.Equals(input as GetAddressDetails500Response);
        }

        /// <summary>
        /// Returns true if GetAddressDetails500Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAddressDetails500Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAddressDetails500Response input)
        {
            if (input == null)
            {
                return false;
