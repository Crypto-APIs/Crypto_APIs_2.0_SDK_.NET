...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_401_104")]
    public partial class InlineResponse401104 : IEquatable<InlineResponse401104>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse401104" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse401104() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse401104" /> class.
        /// </summary>
        ...
        public InlineResponse401104(string apiVersion = default(string), string requestId = default(string), string context = default(string), EncodeXAddressE401 error = default(EncodeXAddressE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse401104 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse401104 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse401104 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse401104 {\n");
        ...
        {
            return this.Equals(input as InlineResponse401104);
        }

        /// <summary>
        /// Returns true if InlineResponse401104 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse401104 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse401104 input)
        {
            if (input == null)
            {
                return false;
