...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_400_103")]
    public partial class InlineResponse400103 : IEquatable<InlineResponse400103>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse400103" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse400103() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse400103" /> class.
        /// </summary>
        ...
        public InlineResponse400103(string apiVersion = default(string), string requestId = default(string), string context = default(string), DecodeXAddressE400 error = default(DecodeXAddressE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse400103 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse400103 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse400103 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse400103);
        }

        /// <summary>
        /// Returns true if InlineResponse400103 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse400103 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse400103 input)
        {
            if (input == null)
            {
                return false;
