...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40047 : IEquatable<InlineResponse40047>, IValidatableObject
    {
        ...
        public InlineResponse40047(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetHDWalletXPubYPubZPubDetailsE400 error = default(GetHDWalletXPubYPubZPubDetailsE400))
        {
