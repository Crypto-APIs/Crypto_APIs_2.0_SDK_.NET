...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListAllAssetsByWalletIDRI")]
    public partial class ListAllAssetsByWalletIDRI : IEquatable<ListAllAssetsByWalletIDRI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllAssetsByWalletIDRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListAllAssetsByWalletIDRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllAssetsByWalletIDRI" /> class.
        /// </summary>
        ...
        public ListAllAssetsByWalletIDRI(List<ListAllAssetsFromAllWalletsRICoins> coins = default(List<ListAllAssetsFromAllWalletsRICoins>), List<ListAllAssetsFromAllWalletsRIFungibleTokens> fungibleTokens = default(List<ListAllAssetsFromAllWalletsRIFungibleTokens>), List<ListAllAssetsFromAllWalletsRINonFungibleTokens> nonFungibleTokens = default(List<ListAllAssetsFromAllWalletsRINonFungibleTokens>), string walletId = default(string), string walletName = default(string))
        {
            // to ensure "coins" is required (not null)
            if (coins == null)
            {
                throw new ArgumentNullException("coins is a required property for ListAllAssetsByWalletIDRI and cannot be null");
            }
            this.Coins = coins;
            // to ensure "fungibleTokens" is required (not null)
            if (fungibleTokens == null)
            {
                throw new ArgumentNullException("fungibleTokens is a required property for ListAllAssetsByWalletIDRI and cannot be null");
            }
            this.FungibleTokens = fungibleTokens;
            // to ensure "nonFungibleTokens" is required (not null)
            if (nonFungibleTokens == null)
            {
                throw new ArgumentNullException("nonFungibleTokens is a required property for ListAllAssetsByWalletIDRI and cannot be null");
            }
            this.NonFungibleTokens = nonFungibleTokens;
            // to ensure "walletId" is required (not null)
            if (walletId == null)
            {
                throw new ArgumentNullException("walletId is a required property for ListAllAssetsByWalletIDRI and cannot be null");
            }
            this.WalletId = walletId;
            // to ensure "walletName" is required (not null)
            if (walletName == null)
            {
                throw new ArgumentNullException("walletName is a required property for ListAllAssetsByWalletIDRI and cannot be null");
            }
        ...
        {
            return this.Equals(input as ListAllAssetsByWalletIDRI);
        }

        /// <summary>
        /// Returns true if ListAllAssetsByWalletIDRI instances are equal
        /// </summary>
        /// <param name="input">Instance of ListAllAssetsByWalletIDRI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListAllAssetsByWalletIDRI input)
        {
            if (input == null)
            {
                return false;
