...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetOmniTransactionDetailsByTransactionIDTxidRI")]
    public partial class GetOmniTransactionDetailsByTransactionIDTxidRI : IEquatable<GetOmniTransactionDetailsByTransactionIDTxidRI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetOmniTransactionDetailsByTransactionIDTxidRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetOmniTransactionDetailsByTransactionIDTxidRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetOmniTransactionDetailsByTransactionIDTxidRI" /> class.
        /// </summary>
        ...
        public GetOmniTransactionDetailsByTransactionIDTxidRI(string amount = default(string), bool divisible = default(bool), string minedInBlockHash = default(string), int minedInBlockHeight = default(int), int propertyId = default(int), List<ListOmniTransactionsByAddressRIRecipients> recipients = default(List<ListOmniTransactionsByAddressRIRecipients>), List<GetOmniTransactionDetailsByTransactionIDTxidRISenders> senders = default(List<GetOmniTransactionDetailsByTransactionIDTxidRISenders>), int timestamp = default(int), string transactionId = default(string), string type = default(string), int typeInt = default(int), bool valid = default(bool), int version = default(int), ListUnconfirmedOmniTransactionsByAddressRIFee fee = default(ListUnconfirmedOmniTransactionsByAddressRIFee))
        {
            ...
            this.Amount = amount ?? throw new ArgumentNullException("amount is a required property for GetOmniTransactionDetailsByTransactionIDTxidRI and cannot be null");
            this.Divisible = divisible;
            // to ensure "minedInBlockHash" is required (not null)
            this.MinedInBlockHash = minedInBlockHash ?? throw new ArgumentNullException("minedInBlockHash is a required property for GetOmniTransactionDetailsByTransactionIDTxidRI and cannot be null");
            this.MinedInBlockHeight = minedInBlockHeight;
            this.PropertyId = propertyId;
            // to ensure "recipients" is required (not null)
            this.Recipients = recipients ?? throw new ArgumentNullException("recipients is a required property for GetOmniTransactionDetailsByTransactionIDTxidRI and cannot be null");
            // to ensure "senders" is required (not null)
            this.Senders = senders ?? throw new ArgumentNullException("senders is a required property for GetOmniTransactionDetailsByTransactionIDTxidRI and cannot be null");
            this.Timestamp = timestamp;
            // to ensure "transactionId" is required (not null)
            this.TransactionId = transactionId ?? throw new ArgumentNullException("transactionId is a required property for GetOmniTransactionDetailsByTransactionIDTxidRI and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for GetOmniTransactionDetailsByTransactionIDTxidRI and cannot be null");
            this.TypeInt = typeInt;
            this.Valid = valid;
            this.Version = version;
            // to ensure "fee" is required (not null)
            this.Fee = fee ?? throw new ArgumentNullException("fee is a required property for GetOmniTransactionDetailsByTransactionIDTxidRI and cannot be null");
        }
        ...
        {
            return this.Equals(input as GetOmniTransactionDetailsByTransactionIDTxidRI);
        }

        /// <summary>
        /// Returns true if GetOmniTransactionDetailsByTransactionIDTxidRI instances are equal
        /// </summary>
        /// <param name="input">Instance of GetOmniTransactionDetailsByTransactionIDTxidRI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetOmniTransactionDetailsByTransactionIDTxidRI input)
        {
            if (input == null)
                return false;
