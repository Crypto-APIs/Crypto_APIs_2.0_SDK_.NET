...
namespace CryptoAPIs.Model
{
    ...
    /// Ethereum
    /// </summary>
    [DataContract(Name = "GetTransactionDetailsByTransactionIDRIBSE")]
    public partial class GetTransactionDetailsByTransactionIDRIBSE : IEquatable<GetTransactionDetailsByTransactionIDRIBSE>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDRIBSE" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetTransactionDetailsByTransactionIDRIBSE() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDRIBSE" /> class.
        /// </summary>
        ...
        public GetTransactionDetailsByTransactionIDRIBSE(string contract = default(string), string gasLimit = default(string), GetTransactionDetailsByTransactionIDRIBSEGasPrice gasPrice = default(GetTransactionDetailsByTransactionIDRIBSEGasPrice), string gasUsed = default(string), string inputData = default(string), int nonce = default(int), string transactionStatus = default(string))
        {
            // to ensure "contract" is required (not null)
            this.Contract = contract ?? throw new ArgumentNullException("contract is a required property for GetTransactionDetailsByTransactionIDRIBSE and cannot be null");
            // to ensure "gasLimit" is required (not null)
            this.GasLimit = gasLimit ?? throw new ArgumentNullException("gasLimit is a required property for GetTransactionDetailsByTransactionIDRIBSE and cannot be null");
            // to ensure "gasPrice" is required (not null)
            this.GasPrice = gasPrice ?? throw new ArgumentNullException("gasPrice is a required property for GetTransactionDetailsByTransactionIDRIBSE and cannot be null");
            // to ensure "gasUsed" is required (not null)
            this.GasUsed = gasUsed ?? throw new ArgumentNullException("gasUsed is a required property for GetTransactionDetailsByTransactionIDRIBSE and cannot be null");
            // to ensure "inputData" is required (not null)
            this.InputData = inputData ?? throw new ArgumentNullException("inputData is a required property for GetTransactionDetailsByTransactionIDRIBSE and cannot be null");
            this.Nonce = nonce;
            // to ensure "transactionStatus" is required (not null)
            this.TransactionStatus = transactionStatus ?? throw new ArgumentNullException("transactionStatus is a required property for GetTransactionDetailsByTransactionIDRIBSE and cannot be null");
        }
        ...
        {
            return this.Equals(input as GetTransactionDetailsByTransactionIDRIBSE);
        }

        /// <summary>
        /// Returns true if GetTransactionDetailsByTransactionIDRIBSE instances are equal
        /// </summary>
        /// <param name="input">Instance of GetTransactionDetailsByTransactionIDRIBSE to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetTransactionDetailsByTransactionIDRIBSE input)
        {
            if (input == null)
                return false;
