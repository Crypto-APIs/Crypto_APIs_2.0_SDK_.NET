...
namespace CryptoAPIs.Model
{
    ...
    /// Bitcoin
    /// </summary>
    [DataContract(Name = "GetTransactionDetailsByTransactionIDRIBSB")]
    public partial class GetTransactionDetailsByTransactionIDRIBSB : IEquatable<GetTransactionDetailsByTransactionIDRIBSB>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDRIBSB" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetTransactionDetailsByTransactionIDRIBSB() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDRIBSB" /> class.
        /// </summary>
        ...
        public GetTransactionDetailsByTransactionIDRIBSB(int locktime = default(int), int size = default(int), int vSize = default(int), int version = default(int), List<GetTransactionDetailsByTransactionIDRIBSBVin> vin = default(List<GetTransactionDetailsByTransactionIDRIBSBVin>), List<GetTransactionDetailsByTransactionIDRIBSBVout> vout = default(List<GetTransactionDetailsByTransactionIDRIBSBVout>))
        {
            ...
            this.Vin = vin ?? throw new ArgumentNullException("vin is a required property for GetTransactionDetailsByTransactionIDRIBSB and cannot be null");
            // to ensure "vout" is required (not null)
            this.Vout = vout ?? throw new ArgumentNullException("vout is a required property for GetTransactionDetailsByTransactionIDRIBSB and cannot be null");
        }
        ...
        public List<GetTransactionDetailsByTransactionIDRIBSBVin> Vin { get; set; }
        ...
        {
            return this.Equals(input as GetTransactionDetailsByTransactionIDRIBSB);
        }

        /// <summary>
        /// Returns true if GetTransactionDetailsByTransactionIDRIBSB instances are equal
        /// </summary>
        /// <param name="input">Instance of GetTransactionDetailsByTransactionIDRIBSB to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetTransactionDetailsByTransactionIDRIBSB input)
        {
            if (input == null)
                return false;
