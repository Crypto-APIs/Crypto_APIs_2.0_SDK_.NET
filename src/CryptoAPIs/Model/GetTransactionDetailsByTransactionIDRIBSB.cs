...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetTransactionDetailsByTransactionIDRIBSB : IEquatable<GetTransactionDetailsByTransactionIDRIBSB>, IValidatableObject
    {
        ...
        public GetTransactionDetailsByTransactionIDRIBSB(long locktime = default(long), int size = default(int), int vSize = default(int), int version = default(int), List<GetTransactionDetailsByTransactionIDRIBSBVinInner> vin = default(List<GetTransactionDetailsByTransactionIDRIBSBVinInner>), List<GetTransactionDetailsByTransactionIDRIBSBVoutInner> vout = default(List<GetTransactionDetailsByTransactionIDRIBSBVoutInner>))
        {
            ...
            if (vin == null)
            {
                throw new ArgumentNullException("vin is a required property for GetTransactionDetailsByTransactionIDRIBSB and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null)
            {
                throw new ArgumentNullException("vout is a required property for GetTransactionDetailsByTransactionIDRIBSB and cannot be null");
            }
            this.Vout = vout;
        }
        ...
        public List<GetTransactionDetailsByTransactionIDRIBSBVinInner> Vin { get; set; }
