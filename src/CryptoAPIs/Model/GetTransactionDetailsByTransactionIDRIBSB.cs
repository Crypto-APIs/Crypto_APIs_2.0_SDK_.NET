...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetTransactionDetailsByTransactionIDRIBSB : IEquatable<GetTransactionDetailsByTransactionIDRIBSB>, IValidatableObject
    {
        ...
        public GetTransactionDetailsByTransactionIDRIBSB(long locktime = default(long), int size = default(int), int vSize = default(int), int version = default(int), List<GetTransactionDetailsByTransactionIDRIBSBVin> vin = default(List<GetTransactionDetailsByTransactionIDRIBSBVin>), List<GetTransactionDetailsByTransactionIDRIBSBVout> vout = default(List<GetTransactionDetailsByTransactionIDRIBSBVout>))
        {
