...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListConfirmedTransactionsByAddressRIBSL_vin")]
    public partial class ListConfirmedTransactionsByAddressRIBSLVin : IEquatable<ListConfirmedTransactionsByAddressRIBSLVin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressRIBSLVin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListConfirmedTransactionsByAddressRIBSLVin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressRIBSLVin" /> class.
        /// </summary>
        ...
        public ListConfirmedTransactionsByAddressRIBSLVin(List<string> addresses = default(List<string>), string coinbase = default(string), ListConfirmedTransactionsByAddressRIBSLScriptSig scriptSig = default(ListConfirmedTransactionsByAddressRIBSLScriptSig), string sequence = default(string), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            if (addresses == null) {
                throw new ArgumentNullException("addresses is a required property for ListConfirmedTransactionsByAddressRIBSLVin and cannot be null");
            }
            this.Addresses = addresses;
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null) {
                throw new ArgumentNullException("scriptSig is a required property for ListConfirmedTransactionsByAddressRIBSLVin and cannot be null");
            }
            this.ScriptSig = scriptSig;
            // to ensure "sequence" is required (not null)
            if (sequence == null) {
                throw new ArgumentNullException("sequence is a required property for ListConfirmedTransactionsByAddressRIBSLVin and cannot be null");
            }
            this.Sequence = sequence;
            // to ensure "txid" is required (not null)
            if (txid == null) {
                throw new ArgumentNullException("txid is a required property for ListConfirmedTransactionsByAddressRIBSLVin and cannot be null");
            }
            this.Txid = txid;
            // to ensure "txinwitness" is required (not null)
            if (txinwitness == null) {
                throw new ArgumentNullException("txinwitness is a required property for ListConfirmedTransactionsByAddressRIBSLVin and cannot be null");
            }
        ...
        {
            return this.Equals(input as ListConfirmedTransactionsByAddressRIBSLVin);
        }

        /// <summary>
        /// Returns true if ListConfirmedTransactionsByAddressRIBSLVin instances are equal
        /// </summary>
        /// <param name="input">Instance of ListConfirmedTransactionsByAddressRIBSLVin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListConfirmedTransactionsByAddressRIBSLVin input)
        {
            if (input == null)
            {
                return false;
