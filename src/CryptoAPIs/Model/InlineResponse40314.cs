...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40314
    /// </summary>
    [DataContract(Name = "inline_response_403_14")]
    public partial class InlineResponse40314 : IEquatable<InlineResponse40314>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40314" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40314() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40314" /> class.
        /// </summary>
        ...
        public InlineResponse40314(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListZilliqaTransactionsByAddressE403 error = default(ListZilliqaTransactionsByAddressE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40314 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40314 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40314 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40314 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40314);
        }

        /// <summary>
        /// Returns true if InlineResponse40314 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40314 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40314 input)
        {
            if (input == null)
            {
                return false;
