...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40917
    /// </summary>
    [DataContract(Name = "inline_response_409_17")]
    public partial class InlineResponse40917 : IEquatable<InlineResponse40917>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40917" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40917() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40917" /> class.
        /// </summary>
        ...
        public InlineResponse40917(string apiVersion = default(string), string requestId = default(string), string context = default(string), BroadcastLocallySignedTransactionE409 error = default(BroadcastLocallySignedTransactionE409))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40917 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40917 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40917 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse40917);
        }

        /// <summary>
        /// Returns true if InlineResponse40917 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40917 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40917 input)
        {
            if (input == null)
            {
                return false;
