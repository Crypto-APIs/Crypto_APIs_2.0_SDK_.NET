...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Get_Address_Balance_403_response")]
    public partial class GetAddressBalance403Response : IEquatable<GetAddressBalance403Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressBalance403Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetAddressBalance403Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressBalance403Response" /> class.
        /// </summary>
        ...
        public GetAddressBalance403Response(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetAddressBalanceE403 error = default(GetAddressBalanceE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for GetAddressBalance403Response and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for GetAddressBalance403Response and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for GetAddressBalance403Response and cannot be null");
            }
            this.Error = error;
        ...
        public GetAddressBalanceE403 Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAddressBalance403Response {\n");
        ...
        {
            return this.Equals(input as GetAddressBalance403Response);
        }

        /// <summary>
        /// Returns true if GetAddressBalance403Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAddressBalance403Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAddressBalance403Response input)
        {
            if (input == null)
            {
                return false;
