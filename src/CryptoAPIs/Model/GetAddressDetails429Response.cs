...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Get_Address_Details_429_response")]
    public partial class GetAddressDetails429Response : IEquatable<GetAddressDetails429Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressDetails429Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetAddressDetails429Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressDetails429Response" /> class.
        /// </summary>
        ...
        public GetAddressDetails429Response(string apiVersion = default(string), string requestId = default(string), string context = default(string), RequestLimitReached error = default(RequestLimitReached))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for GetAddressDetails429Response and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for GetAddressDetails429Response and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for GetAddressDetails429Response and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAddressDetails429Response {\n");
        ...
        {
            return this.Equals(input as GetAddressDetails429Response);
        }

        /// <summary>
        /// Returns true if GetAddressDetails429Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAddressDetails429Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAddressDetails429Response input)
        {
            if (input == null)
            {
                return false;
