...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_403_102")]
    public partial class InlineResponse403102 : IEquatable<InlineResponse403102>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse403102" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse403102() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse403102" /> class.
        /// </summary>
        ...
        public InlineResponse403102(string apiVersion = default(string), string requestId = default(string), string context = default(string), DecodeRawTransactionHexE403 error = default(DecodeRawTransactionHexE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse403102 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse403102 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse403102 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse403102 {\n");
        ...
        {
            return this.Equals(input as InlineResponse403102);
        }

        /// <summary>
        /// Returns true if InlineResponse403102 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse403102 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse403102 input)
        {
            if (input == null)
            {
                return false;
