...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40333 : IEquatable<InlineResponse40333>, IValidatableObject
    {
        ...
        public InlineResponse40333(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetZilliqaBlockDetailsByBlockHashE403 error = default(GetZilliqaBlockDetailsByBlockHashE403))
        {
