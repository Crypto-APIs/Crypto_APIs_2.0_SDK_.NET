...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40333
    /// </summary>
    [DataContract(Name = "inline_response_403_33")]
    public partial class InlineResponse40333 : IEquatable<InlineResponse40333>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40333" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40333() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40333" /> class.
        /// </summary>
        ...
        public InlineResponse40333(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetOmniTransactionDetailsByTransactionIDTxidE403 error = default(GetOmniTransactionDetailsByTransactionIDTxidE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40333 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40333 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40333 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40333 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40333);
        }

        /// <summary>
        /// Returns true if InlineResponse40333 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40333 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40333 input)
        {
            if (input == null)
            {
                return false;
