...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40167
    /// </summary>
    [DataContract(Name = "inline_response_401_67")]
    public partial class InlineResponse40167 : IEquatable<InlineResponse40167>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40167" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40167() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40167" /> class.
        /// </summary>
        ...
        public InlineResponse40167(string apiVersion = default(string), string requestId = default(string), string context = default(string), ActivateBlockchainEventSubscriptionE401 error = default(ActivateBlockchainEventSubscriptionE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40167 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40167 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40167 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40167 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40167);
        }

        /// <summary>
        /// Returns true if InlineResponse40167 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40167 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40167 input)
        {
            if (input == null)
            {
                return false;
