...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40167 : IEquatable<InlineResponse40167>, IValidatableObject
    {
        ...
        public InlineResponse40167(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTokensByAddressE401 error = default(ListTokensByAddressE401))
        {
