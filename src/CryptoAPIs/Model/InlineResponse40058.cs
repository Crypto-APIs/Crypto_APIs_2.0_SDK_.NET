...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40058
    /// </summary>
    [DataContract(Name = "inline_response_400_58")]
    public partial class InlineResponse40058 : IEquatable<InlineResponse40058>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40058" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40058() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40058" /> class.
        /// </summary>
        ...
        public InlineResponse40058(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewUnconfirmedCoinsTransactionsE400 error = default(NewUnconfirmedCoinsTransactionsE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40058 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40058 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40058 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40058 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40058);
        }

        /// <summary>
        /// Returns true if InlineResponse40058 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40058 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40058 input)
        {
            if (input == null)
            {
                return false;
