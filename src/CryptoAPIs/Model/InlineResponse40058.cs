...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40058 : IEquatable<InlineResponse40058>, IValidatableObject
    {
        ...
        public InlineResponse40058(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetNextAvailableNonceE400 error = default(GetNextAvailableNonceE400))
        {
