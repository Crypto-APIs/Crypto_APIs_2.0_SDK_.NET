...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransactionRequestReject_data_item")]
    public partial class TransactionRequestRejectDataItem : IEquatable<TransactionRequestRejectDataItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionRequestRejectDataItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionRequestRejectDataItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionRequestRejectDataItem" /> class.
        /// </summary>
        ...
        public TransactionRequestRejectDataItem(string blockchain = default(string), string network = default(string), int requiredApproves = default(int), int requiredRejects = default(int), int currentApproves = default(int), int currentRejects = default(int))
        {
            // to ensure "blockchain" is required (not null)
            this.Blockchain = blockchain ?? throw new ArgumentNullException("blockchain is a required property for TransactionRequestRejectDataItem and cannot be null");
            // to ensure "network" is required (not null)
            this.Network = network ?? throw new ArgumentNullException("network is a required property for TransactionRequestRejectDataItem and cannot be null");
        ...
        {
            return this.Equals(input as TransactionRequestRejectDataItem);
        }

        /// <summary>
        /// Returns true if TransactionRequestRejectDataItem instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionRequestRejectDataItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionRequestRejectDataItem input)
        {
            if (input == null)
                return false;
