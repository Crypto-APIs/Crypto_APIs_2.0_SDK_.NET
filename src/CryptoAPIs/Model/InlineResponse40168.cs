...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40168
    /// </summary>
    [DataContract(Name = "inline_response_401_68")]
    public partial class InlineResponse40168 : IEquatable<InlineResponse40168>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40168" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40168() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40168" /> class.
        /// </summary>
        ...
        public InlineResponse40168(string apiVersion = default(string), string requestId = default(string), string context = default(string), DeleteBlockchainEventSubscriptionE401 error = default(DeleteBlockchainEventSubscriptionE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40168 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40168 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40168 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40168 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40168);
        }

        /// <summary>
        /// Returns true if InlineResponse40168 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40168 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40168 input)
        {
            if (input == null)
            {
                return false;
