...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40168 : IEquatable<InlineResponse40168>, IValidatableObject
    {
        ...
        public InlineResponse40168(string apiVersion = default(string), string requestId = default(string), string context = default(string), EstimateTransactionSmartFeeE401 error = default(EstimateTransactionSmartFeeE401))
        {
