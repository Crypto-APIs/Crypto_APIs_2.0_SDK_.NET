...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_401_105")]
    public partial class InlineResponse401105 : IEquatable<InlineResponse401105>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse401105" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse401105() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse401105" /> class.
        /// </summary>
        ...
        public InlineResponse401105(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListSupportedAssetsE401 error = default(ListSupportedAssetsE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse401105 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse401105 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse401105 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse401105 {\n");
        ...
        {
            return this.Equals(input as InlineResponse401105);
        }

        /// <summary>
        /// Returns true if InlineResponse401105 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse401105 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse401105 input)
        {
            if (input == null)
            {
                return false;
