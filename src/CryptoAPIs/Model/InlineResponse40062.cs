...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40062
    /// </summary>
    [DataContract(Name = "inline_response_400_62")]
    public partial class InlineResponse40062 : IEquatable<InlineResponse40062>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40062" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40062() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40062" /> class.
        /// </summary>
        ...
        public InlineResponse40062(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedTokensTransactionsAndEachConfirmationE400 error = default(NewConfirmedTokensTransactionsAndEachConfirmationE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40062 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40062 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40062 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40062 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40062);
        }

        /// <summary>
        /// Returns true if InlineResponse40062 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40062 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40062 input)
        {
            if (input == null)
            {
                return false;
