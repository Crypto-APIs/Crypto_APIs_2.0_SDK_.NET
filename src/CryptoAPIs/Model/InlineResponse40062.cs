...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40062 : IEquatable<InlineResponse40062>, IValidatableObject
    {
        ...
        public InlineResponse40062(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListConfirmedTokensTransfersByAddressAndTimeRangeE400 error = default(ListConfirmedTokensTransfersByAddressAndTimeRangeE400))
        {
