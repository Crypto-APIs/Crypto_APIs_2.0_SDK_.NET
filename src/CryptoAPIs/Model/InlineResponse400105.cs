...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_400_105")]
    public partial class InlineResponse400105 : IEquatable<InlineResponse400105>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse400105" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse400105() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse400105" /> class.
        /// </summary>
        ...
        public InlineResponse400105(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListSupportedAssetsE400 error = default(ListSupportedAssetsE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse400105 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse400105 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse400105 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse400105 {\n");
        ...
        {
            return this.Equals(input as InlineResponse400105);
        }

        /// <summary>
        /// Returns true if InlineResponse400105 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse400105 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse400105 input)
        {
            if (input == null)
            {
                return false;
