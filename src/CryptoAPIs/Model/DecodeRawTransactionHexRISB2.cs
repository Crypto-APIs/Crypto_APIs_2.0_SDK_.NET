...
namespace CryptoAPIs.Model
{
    ...
    /// Bitcoin Cash
    /// </summary>
    [DataContract(Name = "DecodeRawTransactionHexRISB2")]
    public partial class DecodeRawTransactionHexRISB2 : IEquatable<DecodeRawTransactionHexRISB2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISB2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DecodeRawTransactionHexRISB2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISB2" /> class.
        /// </summary>
        ...
        public DecodeRawTransactionHexRISB2(int locktime = default(int), string transactionHash = default(string), int vSize = default(int), int version = default(int), List<DecodeRawTransactionHexRISB2VinInner> vin = default(List<DecodeRawTransactionHexRISB2VinInner>), List<DecodeRawTransactionHexRISB2VoutInner> vout = default(List<DecodeRawTransactionHexRISB2VoutInner>), int weight = default(int))
        {
            this.Locktime = locktime;
            // to ensure "transactionHash" is required (not null)
            if (transactionHash == null)
            {
                throw new ArgumentNullException("transactionHash is a required property for DecodeRawTransactionHexRISB2 and cannot be null");
            }
            ...
            if (vin == null)
            {
                throw new ArgumentNullException("vin is a required property for DecodeRawTransactionHexRISB2 and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null)
            {
                throw new ArgumentNullException("vout is a required property for DecodeRawTransactionHexRISB2 and cannot be null");
            }
            this.Vout = vout;
            this.Weight = weight;
        }
        ...
        public List<DecodeRawTransactionHexRISB2VinInner> Vin { get; set; }
        ...
        public List<DecodeRawTransactionHexRISB2VoutInner> Vout { get; set; }
        ...
        {
            return this.Equals(input as DecodeRawTransactionHexRISB2);
        }

        /// <summary>
        /// Returns true if DecodeRawTransactionHexRISB2 instances are equal
        /// </summary>
        /// <param name="input">Instance of DecodeRawTransactionHexRISB2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecodeRawTransactionHexRISB2 input)
        {
            if (input == null)
            {
                return false;
