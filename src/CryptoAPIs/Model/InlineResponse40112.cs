...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40112
    /// </summary>
    [DataContract(Name = "inline_response_401_12")]
    public partial class InlineResponse40112 : IEquatable<InlineResponse40112>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40112" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40112() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40112" /> class.
        /// </summary>
        ...
        public InlineResponse40112(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListUnconfirmedOmniTransactionsByAddressE401 error = default(ListUnconfirmedOmniTransactionsByAddressE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40112 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40112 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40112 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40112 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40112);
        }

        /// <summary>
        /// Returns true if InlineResponse40112 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40112 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40112 input)
        {
            if (input == null)
            {
                return false;
