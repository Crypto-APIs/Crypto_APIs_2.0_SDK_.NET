...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListSyncedAddressesR")]
    public partial class ListSyncedAddressesR : IEquatable<ListSyncedAddressesR>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListSyncedAddressesR" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListSyncedAddressesR() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListSyncedAddressesR" /> class.
        /// </summary>
        ...
        public ListSyncedAddressesR(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListSyncedAddressesRData data = default(ListSyncedAddressesRData))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for ListSyncedAddressesR and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for ListSyncedAddressesR and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ListSyncedAddressesR and cannot be null");
            }
            this.Data = data;
        ...
        public ListSyncedAddressesRData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListSyncedAddressesR {\n");
        ...
        {
            return this.Equals(input as ListSyncedAddressesR);
        }

        /// <summary>
        /// Returns true if ListSyncedAddressesR instances are equal
        /// </summary>
        /// <param name="input">Instance of ListSyncedAddressesR to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListSyncedAddressesR input)
        {
            if (input == null)
            {
                return false;
