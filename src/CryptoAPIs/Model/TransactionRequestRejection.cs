...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransactionRequestRejection")]
    public partial class TransactionRequestRejection : IEquatable<TransactionRequestRejection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionRequestRejection" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionRequestRejection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionRequestRejection" /> class.
        /// </summary>
        ...
        public TransactionRequestRejection(string apiVersion = default(string), string referenceId = default(string), string idempotencyKey = default(string), TransactionRequestRejectionData data = default(TransactionRequestRejectionData))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for TransactionRequestRejection and cannot be null");
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for TransactionRequestRejection and cannot be null");
            // to ensure "idempotencyKey" is required (not null)
            this.IdempotencyKey = idempotencyKey ?? throw new ArgumentNullException("idempotencyKey is a required property for TransactionRequestRejection and cannot be null");
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for TransactionRequestRejection and cannot be null");
        }
        ...
        public TransactionRequestRejectionData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionRequestRejection {\n");
        ...
        {
            return this.Equals(input as TransactionRequestRejection);
        }

        /// <summary>
        /// Returns true if TransactionRequestRejection instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionRequestRejection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionRequestRejection input)
        {
            if (input == null)
                return false;
