...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListHDWalletXPubYPubZPubTransactionsRISenders : IEquatable<ListHDWalletXPubYPubZPubTransactionsRISenders>, IValidatableObject
    {
        ...
        public ListHDWalletXPubYPubZPubTransactionsRISenders(string address = default(string), string amount = default(string), bool isMember = default(bool))
        {
            ...
            if (address == null) {
                throw new ArgumentNullException("address is a required property for ListHDWalletXPubYPubZPubTransactionsRISenders and cannot be null");
            }
            this.Address = address;
            // to ensure "amount" is required (not null)
            if (amount == null) {
                throw new ArgumentNullException("amount is a required property for ListHDWalletXPubYPubZPubTransactionsRISenders and cannot be null");
            }
            this.Amount = amount;
