...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40362 : IEquatable<InlineResponse40362>, IValidatableObject
    {
        ...
        public InlineResponse40362(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedTokensTransactionsAndEachConfirmationE403 error = default(NewConfirmedTokensTransactionsAndEachConfirmationE403))
        {
