...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40362
    /// </summary>
    [DataContract(Name = "inline_response_403_62")]
    public partial class InlineResponse40362 : IEquatable<InlineResponse40362>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40362" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40362() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40362" /> class.
        /// </summary>
        ...
        public InlineResponse40362(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListConfirmedTokensTransfersByAddressAndTimeRangeE403 error = default(ListConfirmedTokensTransfersByAddressAndTimeRangeE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40362 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40362 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40362 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40362 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40362);
        }

        /// <summary>
        /// Returns true if InlineResponse40362 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40362 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40362 input)
        {
            if (input == null)
            {
                return false;
