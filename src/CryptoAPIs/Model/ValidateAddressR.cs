...
namespace CryptoAPIs.Model
{
    ...
    /// ValidateAddressR
    /// </summary>
    [DataContract(Name = "ValidateAddressR")]
    public partial class ValidateAddressR : IEquatable<ValidateAddressR>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidateAddressR" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ValidateAddressR() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidateAddressR" /> class.
        /// </summary>
        ...
        public ValidateAddressR(string apiVersion = default(string), string requestId = default(string), string context = default(string), ValidateAddressRData data = default(ValidateAddressRData))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for ValidateAddressR and cannot be null");
            // to ensure "requestId" is required (not null)
            this.RequestId = requestId ?? throw new ArgumentNullException("requestId is a required property for ValidateAddressR and cannot be null");
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for ValidateAddressR and cannot be null");
        ...
        public ValidateAddressRData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ValidateAddressR {\n");
        ...
        {
            return this.Equals(input as ValidateAddressR);
        }

        /// <summary>
        /// Returns true if ValidateAddressR instances are equal
        /// </summary>
        /// <param name="input">Instance of ValidateAddressR to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValidateAddressR input)
        {
            if (input == null)
                return false;
