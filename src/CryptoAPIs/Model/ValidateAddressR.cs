...
namespace CryptoAPIs.Model
{
    ...
    public partial class ValidateAddressR : IEquatable<ValidateAddressR>, IValidatableObject
    {
        ...
        public ValidateAddressR(string apiVersion = default(string), string requestId = default(string), string context = default(string), ValidateAddressRData data = default(ValidateAddressRData))
        {
            ...
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for ValidateAddressR and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for ValidateAddressR and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for ValidateAddressR and cannot be null");
            }
            this.Data = data;
