...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40394
    /// </summary>
    [DataContract(Name = "inline_response_403_94")]
    public partial class InlineResponse40394 : IEquatable<InlineResponse40394>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40394" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40394() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40394" /> class.
        /// </summary>
        ...
        public InlineResponse40394(string apiVersion = default(string), string requestId = default(string), string context = default(string), AddTokensToExistingFromAddressE403 error = default(AddTokensToExistingFromAddressE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40394 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40394 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40394 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40394 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40394);
        }

        /// <summary>
        /// Returns true if InlineResponse40394 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40394 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40394 input)
        {
            if (input == null)
            {
                return false;
