...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListAllUnconfirmedTransactionsRIBSD_vin")]
    public partial class ListAllUnconfirmedTransactionsRIBSDVin : IEquatable<ListAllUnconfirmedTransactionsRIBSDVin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllUnconfirmedTransactionsRIBSDVin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListAllUnconfirmedTransactionsRIBSDVin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllUnconfirmedTransactionsRIBSDVin" /> class.
        /// </summary>
        ...
        public ListAllUnconfirmedTransactionsRIBSDVin(List<string> addresses = default(List<string>), ListConfirmedTransactionsByAddressRIBSDScriptSig scriptSig = default(ListConfirmedTransactionsByAddressRIBSDScriptSig), int sequence = default(int), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            if (addresses == null) {
                throw new ArgumentNullException("addresses is a required property for ListAllUnconfirmedTransactionsRIBSDVin and cannot be null");
            }
            this.Addresses = addresses;
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null) {
                throw new ArgumentNullException("scriptSig is a required property for ListAllUnconfirmedTransactionsRIBSDVin and cannot be null");
            }
            this.ScriptSig = scriptSig;
            this.Sequence = sequence;
            // to ensure "txid" is required (not null)
            if (txid == null) {
                throw new ArgumentNullException("txid is a required property for ListAllUnconfirmedTransactionsRIBSDVin and cannot be null");
            }
            this.Txid = txid;
            // to ensure "txinwitness" is required (not null)
            if (txinwitness == null) {
                throw new ArgumentNullException("txinwitness is a required property for ListAllUnconfirmedTransactionsRIBSDVin and cannot be null");
            }
            this.Txinwitness = txinwitness;
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for ListAllUnconfirmedTransactionsRIBSDVin and cannot be null");
            }
            this.Value = value;
            this.Vout = vout;
        }
        ...
        public ListConfirmedTransactionsByAddressRIBSDScriptSig ScriptSig { get; set; }
        ...
        {
            return this.Equals(input as ListAllUnconfirmedTransactionsRIBSDVin);
        }

        /// <summary>
        /// Returns true if ListAllUnconfirmedTransactionsRIBSDVin instances are equal
        /// </summary>
        /// <param name="input">Instance of ListAllUnconfirmedTransactionsRIBSDVin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListAllUnconfirmedTransactionsRIBSDVin input)
        {
            if (input == null)
                return false;
