...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Get_Address_Details_402_response")]
    public partial class GetAddressDetails402Response : IEquatable<GetAddressDetails402Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressDetails402Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetAddressDetails402Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressDetails402Response" /> class.
        /// </summary>
        ...
        public GetAddressDetails402Response(string apiVersion = default(string), string requestId = default(string), string context = default(string), InsufficientCredits error = default(InsufficientCredits))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for GetAddressDetails402Response and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for GetAddressDetails402Response and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for GetAddressDetails402Response and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAddressDetails402Response {\n");
        ...
        {
            return this.Equals(input as GetAddressDetails402Response);
        }

        /// <summary>
        /// Returns true if GetAddressDetails402Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAddressDetails402Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAddressDetails402Response input)
        {
            if (input == null)
            {
                return false;
