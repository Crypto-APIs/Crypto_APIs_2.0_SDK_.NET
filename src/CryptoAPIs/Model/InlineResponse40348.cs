...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40348 : IEquatable<InlineResponse40348>, IValidatableObject
    {
        ...
        public InlineResponse40348(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListWalletTransactionsE403 error = default(ListWalletTransactionsE403))
        {
