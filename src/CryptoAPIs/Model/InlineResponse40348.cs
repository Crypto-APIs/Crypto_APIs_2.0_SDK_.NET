...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40348
    /// </summary>
    [DataContract(Name = "inline_response_403_48")]
    public partial class InlineResponse40348 : IEquatable<InlineResponse40348>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40348" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40348() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40348" /> class.
        /// </summary>
        ...
        public InlineResponse40348(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListInternalTransactionDetailsByTransactionHashE403 error = default(ListInternalTransactionDetailsByTransactionHashE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40348 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40348 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40348 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40348 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40348);
        }

        /// <summary>
        /// Returns true if InlineResponse40348 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40348 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40348 input)
        {
            if (input == null)
            {
                return false;
