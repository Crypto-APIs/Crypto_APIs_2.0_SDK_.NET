...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetLastMinedBlockRIBSD2 : IEquatable<GetLastMinedBlockRIBSD2>, IValidatableObject
    {
        ...
        public GetLastMinedBlockRIBSD2(string difficulty = default(string), string nonce = default(string), int size = default(int), string bits = default(string), string chainwork = default(string), string merkleRoot = default(string), int version = default(int), string versionHex = default(string))
        {
            ...
            if (nonce == null)
            {
                throw new ArgumentNullException("nonce is a required property for GetLastMinedBlockRIBSD2 and cannot be null");
            }
            this.Nonce = nonce;
            this.Size = size;
