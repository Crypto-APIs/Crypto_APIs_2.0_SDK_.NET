...
namespace CryptoAPIs.Model
{
    ...
    /// Dash
    /// </summary>
    [DataContract(Name = "GetLastMinedBlockRIBSD2")]
    public partial class GetLastMinedBlockRIBSD2 : IEquatable<GetLastMinedBlockRIBSD2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLastMinedBlockRIBSD2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetLastMinedBlockRIBSD2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLastMinedBlockRIBSD2" /> class.
        /// </summary>
        ...
        public GetLastMinedBlockRIBSD2(string difficulty = default(string), string bits = default(string), string chainwork = default(string), string merkleRoot = default(string), long nonce = default(long), int size = default(int), int version = default(int), string versionHex = default(string))
        {
            // to ensure "difficulty" is required (not null)
            if (difficulty == null)
            {
                throw new ArgumentNullException("difficulty is a required property for GetLastMinedBlockRIBSD2 and cannot be null");
            }
            this.Difficulty = difficulty;
            // to ensure "bits" is required (not null)
            if (bits == null)
            {
                throw new ArgumentNullException("bits is a required property for GetLastMinedBlockRIBSD2 and cannot be null");
            }
            this.Bits = bits;
            // to ensure "chainwork" is required (not null)
            if (chainwork == null)
            {
                throw new ArgumentNullException("chainwork is a required property for GetLastMinedBlockRIBSD2 and cannot be null");
            }
            this.Chainwork = chainwork;
            // to ensure "merkleRoot" is required (not null)
            if (merkleRoot == null)
            {
                throw new ArgumentNullException("merkleRoot is a required property for GetLastMinedBlockRIBSD2 and cannot be null");
            }
            ...
            if (versionHex == null)
            {
                throw new ArgumentNullException("versionHex is a required property for GetLastMinedBlockRIBSD2 and cannot be null");
            }
        ...
        {
            return this.Equals(input as GetLastMinedBlockRIBSD2);
        }

        /// <summary>
        /// Returns true if GetLastMinedBlockRIBSD2 instances are equal
        /// </summary>
        /// <param name="input">Instance of GetLastMinedBlockRIBSD2 to be compared</param>
        /// <returns>Boolean</returns>
