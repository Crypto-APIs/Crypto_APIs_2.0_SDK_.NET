...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40390 : IEquatable<InlineResponse40390>, IValidatableObject
    {
        ...
        public InlineResponse40390(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetAssetDetailsByAssetIDE403 error = default(GetAssetDetailsByAssetIDE403))
        {
