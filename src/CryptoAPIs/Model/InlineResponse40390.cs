...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40390
    /// </summary>
    [DataContract(Name = "inline_response_403_90")]
    public partial class InlineResponse40390 : IEquatable<InlineResponse40390>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40390" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40390() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40390" /> class.
        /// </summary>
        ...
        public InlineResponse40390(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateAutomaticCoinsForwardingE403 error = default(CreateAutomaticCoinsForwardingE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40390 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40390 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40390 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40390 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40390);
        }

        /// <summary>
        /// Returns true if InlineResponse40390 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40390 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40390 input)
        {
            if (input == null)
            {
                return false;
