...
namespace CryptoAPIs.Model
{
    ...
    /// Bitcoin
    /// </summary>
    [DataContract(Name = "ListLatestMinedBlocksRIBSB")]
    public partial class ListLatestMinedBlocksRIBSB : IEquatable<ListLatestMinedBlocksRIBSB>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListLatestMinedBlocksRIBSB" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListLatestMinedBlocksRIBSB() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListLatestMinedBlocksRIBSB" /> class.
        /// </summary>
        ...
        /// <param name="difficulty">Represents a mathematical value of how hard it is to find a valid hash for this block..</param>
        ...
        /// <param name="nonce">Represents a random value that can be adjusted to satisfy the proof of work.</param>
        /// <param name="size">Represents the block size.</param>
        ...
        public ListLatestMinedBlocksRIBSB(string bits = default(string), string chainwork = default(string), string difficulty = default(string), string merkleRoot = default(string), long nonce = default(long), int size = default(int), int strippedSize = default(int), int version = default(int), string versionHex = default(string), int weight = default(int))
        {
            // to ensure "bits" is required (not null)
            if (bits == null)
            {
                throw new ArgumentNullException("bits is a required property for ListLatestMinedBlocksRIBSB and cannot be null");
            }
            this.Bits = bits;
            // to ensure "chainwork" is required (not null)
            if (chainwork == null)
            {
                throw new ArgumentNullException("chainwork is a required property for ListLatestMinedBlocksRIBSB and cannot be null");
            }
            this.Chainwork = chainwork;
            // to ensure "merkleRoot" is required (not null)
            if (merkleRoot == null)
            {
                throw new ArgumentNullException("merkleRoot is a required property for ListLatestMinedBlocksRIBSB and cannot be null");
            }
            ...
            if (versionHex == null)
            {
                throw new ArgumentNullException("versionHex is a required property for ListLatestMinedBlocksRIBSB and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Represents the block size</value>
        ...
        {
            return this.Equals(input as ListLatestMinedBlocksRIBSB);
        }

        /// <summary>
        /// Returns true if ListLatestMinedBlocksRIBSB instances are equal
        /// </summary>
        /// <param name="input">Instance of ListLatestMinedBlocksRIBSB to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListLatestMinedBlocksRIBSB input)
        {
            if (input == null)
            {
                return false;
