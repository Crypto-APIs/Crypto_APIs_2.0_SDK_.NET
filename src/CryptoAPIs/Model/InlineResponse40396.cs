...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40396
    /// </summary>
    [DataContract(Name = "inline_response_403_96")]
    public partial class InlineResponse40396 : IEquatable<InlineResponse40396>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40396" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40396() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40396" /> class.
        /// </summary>
        ...
        public InlineResponse40396(string apiVersion = default(string), string requestId = default(string), string context = default(string), DeleteAutomaticTokensForwardingE403 error = default(DeleteAutomaticTokensForwardingE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40396 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40396 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40396 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40396 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40396);
        }

        /// <summary>
        /// Returns true if InlineResponse40396 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40396 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40396 input)
        {
            if (input == null)
            {
                return false;
