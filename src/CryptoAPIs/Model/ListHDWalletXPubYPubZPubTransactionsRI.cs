...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListHDWalletXPubYPubZPubTransactionsRI")]
    public partial class ListHDWalletXPubYPubZPubTransactionsRI : IEquatable<ListHDWalletXPubYPubZPubTransactionsRI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListHDWalletXPubYPubZPubTransactionsRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListHDWalletXPubYPubZPubTransactionsRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListHDWalletXPubYPubZPubTransactionsRI" /> class.
        /// </summary>
        ...
        public ListHDWalletXPubYPubZPubTransactionsRI(int index = default(int), string minedInBlockHash = default(string), long minedInBlockHeight = default(long), List<ListHDWalletXPubYPubZPubTransactionsRIRecipientsInner> recipients = default(List<ListHDWalletXPubYPubZPubTransactionsRIRecipientsInner>), List<ListHDWalletXPubYPubZPubTransactionsRISendersInner> senders = default(List<ListHDWalletXPubYPubZPubTransactionsRISendersInner>), int timestamp = default(int), string transactionHash = default(string), string transactionId = default(string), ListHDWalletXPubYPubZPubTransactionsRIFee fee = default(ListHDWalletXPubYPubZPubTransactionsRIFee))
        {
            this.Index = index;
        ...
        public ListHDWalletXPubYPubZPubTransactionsRIFee Fee { get; set; }
        ...
        {
            return this.Equals(input as ListHDWalletXPubYPubZPubTransactionsRI);
        }

        /// <summary>
        /// Returns true if ListHDWalletXPubYPubZPubTransactionsRI instances are equal
        /// </summary>
        /// <param name="input">Instance of ListHDWalletXPubYPubZPubTransactionsRI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListHDWalletXPubYPubZPubTransactionsRI input)
        {
            if (input == null)
            {
                return false;
