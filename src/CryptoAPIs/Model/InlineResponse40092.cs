...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40092
    /// </summary>
    [DataContract(Name = "inline_response_400_92")]
    public partial class InlineResponse40092 : IEquatable<InlineResponse40092>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40092" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40092() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40092" /> class.
        /// </summary>
        ...
        public InlineResponse40092(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTokensForwardingAutomationsE400 error = default(ListTokensForwardingAutomationsE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40092 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40092 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40092 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40092 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40092);
        }

        /// <summary>
        /// Returns true if InlineResponse40092 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40092 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40092 input)
        {
            if (input == null)
            {
                return false;
