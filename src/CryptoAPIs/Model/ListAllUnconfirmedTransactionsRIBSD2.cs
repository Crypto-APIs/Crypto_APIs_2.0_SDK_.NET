...
namespace CryptoAPIs.Model
{
    ...
    /// Dash
    /// </summary>
    [DataContract(Name = "ListAllUnconfirmedTransactionsRIBSD2")]
    public partial class ListAllUnconfirmedTransactionsRIBSD2 : IEquatable<ListAllUnconfirmedTransactionsRIBSD2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllUnconfirmedTransactionsRIBSD2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListAllUnconfirmedTransactionsRIBSD2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllUnconfirmedTransactionsRIBSD2" /> class.
        /// </summary>
        ...
        public ListAllUnconfirmedTransactionsRIBSD2(long locktime = default(long), int size = default(int), int version = default(int), List<ListAllUnconfirmedTransactionsRIBSD2VinInner> vin = default(List<ListAllUnconfirmedTransactionsRIBSD2VinInner>), List<ListConfirmedTransactionsByAddressRIBSD2VoutInner> vout = default(List<ListConfirmedTransactionsByAddressRIBSD2VoutInner>))
        {
            ...
            if (vin == null)
            {
                throw new ArgumentNullException("vin is a required property for ListAllUnconfirmedTransactionsRIBSD2 and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null)
            {
                throw new ArgumentNullException("vout is a required property for ListAllUnconfirmedTransactionsRIBSD2 and cannot be null");
            }
            this.Vout = vout;
        }
        ...
        public List<ListAllUnconfirmedTransactionsRIBSD2VinInner> Vin { get; set; }
        ...
        {
            return this.Equals(input as ListAllUnconfirmedTransactionsRIBSD2);
        }

        /// <summary>
        /// Returns true if ListAllUnconfirmedTransactionsRIBSD2 instances are equal
        /// </summary>
        /// <param name="input">Instance of ListAllUnconfirmedTransactionsRIBSD2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListAllUnconfirmedTransactionsRIBSD2 input)
        {
            if (input == null)
            {
                return false;
