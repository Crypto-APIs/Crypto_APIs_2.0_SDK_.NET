...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40912
    /// </summary>
    [DataContract(Name = "inline_response_409_12")]
    public partial class InlineResponse40912 : IEquatable<InlineResponse40912>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40912" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40912() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40912" /> class.
        /// </summary>
        ...
        public InlineResponse40912(string apiVersion = default(string), string requestId = default(string), string context = default(string), MinedTransactionE409 error = default(MinedTransactionE409))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40912 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40912 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40912 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse40912);
        }

        /// <summary>
        /// Returns true if InlineResponse40912 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40912 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40912 input)
        {
            if (input == null)
            {
                return false;
