...
namespace CryptoAPIs.Model
{
    ...
    /// Bitcoin
    /// </summary>
    [DataContract(Name = "GetWalletTransactionDetailsByTransactionIDRIBSB")]
    public partial class GetWalletTransactionDetailsByTransactionIDRIBSB : IEquatable<GetWalletTransactionDetailsByTransactionIDRIBSB>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWalletTransactionDetailsByTransactionIDRIBSB" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetWalletTransactionDetailsByTransactionIDRIBSB() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWalletTransactionDetailsByTransactionIDRIBSB" /> class.
        /// </summary>
        ...
        public GetWalletTransactionDetailsByTransactionIDRIBSB(long locktime = default(long), int size = default(int), int vSize = default(int), int version = default(int), List<GetWalletTransactionDetailsByTransactionIDRIBSBVinInner> vin = default(List<GetWalletTransactionDetailsByTransactionIDRIBSBVinInner>), List<GetWalletTransactionDetailsByTransactionIDRIBSBVoutInner> vout = default(List<GetWalletTransactionDetailsByTransactionIDRIBSBVoutInner>))
        {
            ...
            if (vin == null)
            {
                throw new ArgumentNullException("vin is a required property for GetWalletTransactionDetailsByTransactionIDRIBSB and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null)
            {
                throw new ArgumentNullException("vout is a required property for GetWalletTransactionDetailsByTransactionIDRIBSB and cannot be null");
            }
            this.Vout = vout;
        }
        ...
        public List<GetWalletTransactionDetailsByTransactionIDRIBSBVinInner> Vin { get; set; }
        ...
        public List<GetWalletTransactionDetailsByTransactionIDRIBSBVoutInner> Vout { get; set; }
        ...
        {
            return this.Equals(input as GetWalletTransactionDetailsByTransactionIDRIBSB);
        }

        /// <summary>
        /// Returns true if GetWalletTransactionDetailsByTransactionIDRIBSB instances are equal
        /// </summary>
        /// <param name="input">Instance of GetWalletTransactionDetailsByTransactionIDRIBSB to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetWalletTransactionDetailsByTransactionIDRIBSB input)
        {
            if (input == null)
            {
                return false;
