...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DecodeRawTransactionHexRISD_scriptSig")]
    public partial class DecodeRawTransactionHexRISDScriptSig : IEquatable<DecodeRawTransactionHexRISDScriptSig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISDScriptSig" /> class.
        /// </summary>
        ...
        public DecodeRawTransactionHexRISDScriptSig(string asm = default(string), string hex = default(string), string type = default(string))
        {
            this.Asm = asm;
            this.Hex = hex;
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DecodeRawTransactionHexRISDScriptSig {\n");
        ...
        {
            return this.Equals(input as DecodeRawTransactionHexRISDScriptSig);
        }

        /// <summary>
        /// Returns true if DecodeRawTransactionHexRISDScriptSig instances are equal
        /// </summary>
        /// <param name="input">Instance of DecodeRawTransactionHexRISDScriptSig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecodeRawTransactionHexRISDScriptSig input)
        {
            if (input == null)
            {
                return false;
