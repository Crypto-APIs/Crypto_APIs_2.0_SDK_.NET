...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListUnconfirmedTransactionsByAddressRIBSBC_vin")]
    public partial class ListUnconfirmedTransactionsByAddressRIBSBCVin : IEquatable<ListUnconfirmedTransactionsByAddressRIBSBCVin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnconfirmedTransactionsByAddressRIBSBCVin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListUnconfirmedTransactionsByAddressRIBSBCVin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnconfirmedTransactionsByAddressRIBSBCVin" /> class.
        /// </summary>
        ...
        public ListUnconfirmedTransactionsByAddressRIBSBCVin(List<string> addresses = default(List<string>), GetTransactionDetailsByTransactionIDRIBSBScriptSig scriptSig = default(GetTransactionDetailsByTransactionIDRIBSBScriptSig), string sequence = default(string), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            if (addresses == null)
            {
                throw new ArgumentNullException("addresses is a required property for ListUnconfirmedTransactionsByAddressRIBSBCVin and cannot be null");
            }
            this.Addresses = addresses;
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null)
            {
                throw new ArgumentNullException("scriptSig is a required property for ListUnconfirmedTransactionsByAddressRIBSBCVin and cannot be null");
            }
            this.ScriptSig = scriptSig;
            // to ensure "sequence" is required (not null)
            if (sequence == null)
            {
                throw new ArgumentNullException("sequence is a required property for ListUnconfirmedTransactionsByAddressRIBSBCVin and cannot be null");
            }
            this.Sequence = sequence;
            // to ensure "txid" is required (not null)
            if (txid == null)
            {
                throw new ArgumentNullException("txid is a required property for ListUnconfirmedTransactionsByAddressRIBSBCVin and cannot be null");
            }
            this.Txid = txid;
            // to ensure "txinwitness" is required (not null)
            if (txinwitness == null)
            {
                throw new ArgumentNullException("txinwitness is a required property for ListUnconfirmedTransactionsByAddressRIBSBCVin and cannot be null");
            }
            this.Txinwitness = txinwitness;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for ListUnconfirmedTransactionsByAddressRIBSBCVin and cannot be null");
            }
            this.Value = value;
            this.Vout = vout;
        }
        ...
        public GetTransactionDetailsByTransactionIDRIBSBScriptSig ScriptSig { get; set; }
        ...
        {
            return this.Equals(input as ListUnconfirmedTransactionsByAddressRIBSBCVin);
        }

        /// <summary>
        /// Returns true if ListUnconfirmedTransactionsByAddressRIBSBCVin instances are equal
        /// </summary>
        /// <param name="input">Instance of ListUnconfirmedTransactionsByAddressRIBSBCVin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListUnconfirmedTransactionsByAddressRIBSBCVin input)
        {
            if (input == null)
            {
                return false;
