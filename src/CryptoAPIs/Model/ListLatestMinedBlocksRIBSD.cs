...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListLatestMinedBlocksRIBSD : IEquatable<ListLatestMinedBlocksRIBSD>, IValidatableObject
    {
        ...
        public ListLatestMinedBlocksRIBSD(string bits = default(string), string chainwork = default(string), string merkleRoot = default(string), int version = default(int), string versionHex = default(string))
        {
