...
namespace CryptoAPIs.Model
{
    ...
    /// Bitcoin
    /// </summary>
    [DataContract(Name = "GetBlockDetailsByBlockHeightFromCallbackRIBSB")]
    public partial class GetBlockDetailsByBlockHeightFromCallbackRIBSB : IEquatable<GetBlockDetailsByBlockHeightFromCallbackRIBSB>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHeightFromCallbackRIBSB" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetBlockDetailsByBlockHeightFromCallbackRIBSB() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHeightFromCallbackRIBSB" /> class.
        /// </summary>
        ...
        public GetBlockDetailsByBlockHeightFromCallbackRIBSB(string bits = default(string), string chainwork = default(string), string difficulty = default(string), string merkleRoot = default(string), long nonce = default(long), int size = default(int), int strippedSize = default(int), int version = default(int), string versionHex = default(string), int weight = default(int))
        {
            // to ensure "bits" is required (not null)
            if (bits == null)
            {
                throw new ArgumentNullException("bits is a required property for GetBlockDetailsByBlockHeightFromCallbackRIBSB and cannot be null");
            }
            this.Bits = bits;
            // to ensure "chainwork" is required (not null)
            if (chainwork == null)
            {
                throw new ArgumentNullException("chainwork is a required property for GetBlockDetailsByBlockHeightFromCallbackRIBSB and cannot be null");
            }
            this.Chainwork = chainwork;
            // to ensure "difficulty" is required (not null)
            if (difficulty == null)
            {
                throw new ArgumentNullException("difficulty is a required property for GetBlockDetailsByBlockHeightFromCallbackRIBSB and cannot be null");
            }
            this.Difficulty = difficulty;
            // to ensure "merkleRoot" is required (not null)
            if (merkleRoot == null)
            {
                throw new ArgumentNullException("merkleRoot is a required property for GetBlockDetailsByBlockHeightFromCallbackRIBSB and cannot be null");
            }
            ...
            if (versionHex == null)
            {
                throw new ArgumentNullException("versionHex is a required property for GetBlockDetailsByBlockHeightFromCallbackRIBSB and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetBlockDetailsByBlockHeightFromCallbackRIBSB {\n");
        ...
        {
            return this.Equals(input as GetBlockDetailsByBlockHeightFromCallbackRIBSB);
        }

        /// <summary>
        /// Returns true if GetBlockDetailsByBlockHeightFromCallbackRIBSB instances are equal
        /// </summary>
        /// <param name="input">Instance of GetBlockDetailsByBlockHeightFromCallbackRIBSB to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetBlockDetailsByBlockHeightFromCallbackRIBSB input)
        {
            if (input == null)
            {
                return false;
