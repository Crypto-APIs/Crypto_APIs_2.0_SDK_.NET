...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_400_109")]
    public partial class InlineResponse400109 : IEquatable<InlineResponse400109>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse400109" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse400109() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse400109" /> class.
        /// </summary>
        ...
        public InlineResponse400109(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetAssetDetailsByAssetIDE400 error = default(GetAssetDetailsByAssetIDE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse400109 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse400109 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse400109 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse400109 {\n");
        ...
        {
            return this.Equals(input as InlineResponse400109);
        }

        /// <summary>
        /// Returns true if InlineResponse400109 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse400109 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse400109 input)
        {
            if (input == null)
            {
                return false;
