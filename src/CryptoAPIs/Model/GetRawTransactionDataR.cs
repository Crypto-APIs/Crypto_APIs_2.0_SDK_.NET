...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetRawTransactionDataR")]
    public partial class GetRawTransactionDataR : IEquatable<GetRawTransactionDataR>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetRawTransactionDataR" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetRawTransactionDataR() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetRawTransactionDataR" /> class.
        /// </summary>
        ...
        public GetRawTransactionDataR(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetRawTransactionDataRData data = default(GetRawTransactionDataRData))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for GetRawTransactionDataR and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for GetRawTransactionDataR and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for GetRawTransactionDataR and cannot be null");
            }
            this.Data = data;
        ...
        public GetRawTransactionDataRData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetRawTransactionDataR {\n");
        ...
        {
            return this.Equals(input as GetRawTransactionDataR);
        }

        /// <summary>
        /// Returns true if GetRawTransactionDataR instances are equal
        /// </summary>
        /// <param name="input">Instance of GetRawTransactionDataR to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetRawTransactionDataR input)
        {
            if (input == null)
            {
                return false;
