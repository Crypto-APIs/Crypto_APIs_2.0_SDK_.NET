...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40046
    /// </summary>
    [DataContract(Name = "inline_response_400_46")]
    public partial class InlineResponse40046 : IEquatable<InlineResponse40046>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40046" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40046() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40046" /> class.
        /// </summary>
        ...
        public InlineResponse40046(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetWalletTransactionDetailsByTransactionIDE400 error = default(GetWalletTransactionDetailsByTransactionIDE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40046 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40046 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40046 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40046 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40046);
        }

        /// <summary>
        /// Returns true if InlineResponse40046 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40046 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40046 input)
        {
            if (input == null)
            {
                return false;
