...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40046 : IEquatable<InlineResponse40046>, IValidatableObject
    {
        ...
        public InlineResponse40046(string apiVersion = default(string), string requestId = default(string), string context = default(string), SyncHDWalletXPubYPubZPubE400 error = default(SyncHDWalletXPubYPubZPubE400))
        {
