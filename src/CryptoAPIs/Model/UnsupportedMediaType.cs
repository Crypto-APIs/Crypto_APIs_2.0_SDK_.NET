...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UnsupportedMediaType")]
    public partial class UnsupportedMediaType : IEquatable<UnsupportedMediaType>, IValidatableObject
    {
        ...
        public UnsupportedMediaType(string apiVersion = default(string), string requestId = default(string), string context = default(string), UnsupportedMediaTypeError error = default(UnsupportedMediaTypeError))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for UnsupportedMediaType and cannot be null");
            // to ensure "requestId" is required (not null)
            this.RequestId = requestId ?? throw new ArgumentNullException("requestId is a required property for UnsupportedMediaType and cannot be null");
            // to ensure "error" is required (not null)
            this.Error = error ?? throw new ArgumentNullException("error is a required property for UnsupportedMediaType and cannot be null");
        ...
        public UnsupportedMediaTypeError Error { get; set; }
