...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40353
    /// </summary>
    [DataContract(Name = "inline_response_403_53")]
    public partial class InlineResponse40353 : IEquatable<InlineResponse40353>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40353" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40353() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40353" /> class.
        /// </summary>
        ...
        public InlineResponse40353(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListHDWalletXPubYPubZPubTransactionsE403 error = default(ListHDWalletXPubYPubZPubTransactionsE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40353 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40353 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40353 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40353 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40353);
        }

        /// <summary>
        /// Returns true if InlineResponse40353 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40353 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40353 input)
        {
            if (input == null)
            {
                return false;
