...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40353 : IEquatable<InlineResponse40353>, IValidatableObject
    {
        ...
        public InlineResponse40353(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetFeeRecommendationsE403 error = default(GetFeeRecommendationsE403))
        {
