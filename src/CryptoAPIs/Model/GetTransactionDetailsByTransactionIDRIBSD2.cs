...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetTransactionDetailsByTransactionIDRIBSD2 : IEquatable<GetTransactionDetailsByTransactionIDRIBSD2>, IValidatableObject
    {
        ...
        public GetTransactionDetailsByTransactionIDRIBSD2(long locktime = default(long), int size = default(int), int version = default(int), List<GetTransactionDetailsByTransactionIDRIBSD2VinInner> vin = default(List<GetTransactionDetailsByTransactionIDRIBSD2VinInner>), List<GetTransactionDetailsByTransactionIDRIBSD2VoutInner> vout = default(List<GetTransactionDetailsByTransactionIDRIBSD2VoutInner>))
        {
            ...
            if (vin == null)
            {
                throw new ArgumentNullException("vin is a required property for GetTransactionDetailsByTransactionIDRIBSD2 and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null)
            {
                throw new ArgumentNullException("vout is a required property for GetTransactionDetailsByTransactionIDRIBSD2 and cannot be null");
            }
            this.Vout = vout;
        }
        ...
        public List<GetTransactionDetailsByTransactionIDRIBSD2VinInner> Vin { get; set; }
