...
namespace CryptoAPIs.Model
{
    ...
    /// Dash
    /// </summary>
    [DataContract(Name = "GetTransactionDetailsByTransactionIDRIBSD2")]
    public partial class GetTransactionDetailsByTransactionIDRIBSD2 : IEquatable<GetTransactionDetailsByTransactionIDRIBSD2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDRIBSD2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetTransactionDetailsByTransactionIDRIBSD2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDRIBSD2" /> class.
        /// </summary>
        ...
        public GetTransactionDetailsByTransactionIDRIBSD2(int locktime = default(int), int size = default(int), int version = default(int), List<GetTransactionDetailsByTransactionIDRIBSD2Vin> vin = default(List<GetTransactionDetailsByTransactionIDRIBSD2Vin>), List<GetTransactionDetailsByTransactionIDRIBSD2Vout> vout = default(List<GetTransactionDetailsByTransactionIDRIBSD2Vout>))
        {
            this.Locktime = locktime;
            this.Size = size;
            this.Version = version;
            // to ensure "vin" is required (not null)
            this.Vin = vin ?? throw new ArgumentNullException("vin is a required property for GetTransactionDetailsByTransactionIDRIBSD2 and cannot be null");
            // to ensure "vout" is required (not null)
            this.Vout = vout ?? throw new ArgumentNullException("vout is a required property for GetTransactionDetailsByTransactionIDRIBSD2 and cannot be null");
        }
        ...
        public List<GetTransactionDetailsByTransactionIDRIBSD2Vin> Vin { get; set; }
        ...
        {
            return this.Equals(input as GetTransactionDetailsByTransactionIDRIBSD2);
        }

        /// <summary>
        /// Returns true if GetTransactionDetailsByTransactionIDRIBSD2 instances are equal
        /// </summary>
        /// <param name="input">Instance of GetTransactionDetailsByTransactionIDRIBSD2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetTransactionDetailsByTransactionIDRIBSD2 input)
        {
            if (input == null)
                return false;
