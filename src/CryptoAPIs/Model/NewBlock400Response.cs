...
namespace CryptoAPIs.Model
{
    ...
    /// NewBlock400Response
    /// </summary>
    [DataContract(Name = "New_Block_400_response")]
    public partial class NewBlock400Response : IEquatable<NewBlock400Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewBlock400Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewBlock400Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewBlock400Response" /> class.
        /// </summary>
        ...
        public NewBlock400Response(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewBlockE400 error = default(NewBlockE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for NewBlock400Response and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for NewBlock400Response and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for NewBlock400Response and cannot be null");
            }
            this.Error = error;
        ...
        public NewBlockE400 Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewBlock400Response {\n");
        ...
        {
            return this.Equals(input as NewBlock400Response);
        }

        /// <summary>
        /// Returns true if NewBlock400Response instances are equal
        /// </summary>
        /// <param name="input">Instance of NewBlock400Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewBlock400Response input)
        {
            if (input == null)
            {
                return false;
