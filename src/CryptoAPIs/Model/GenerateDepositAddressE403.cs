...
namespace CryptoAPIs.Model
{
    ...
    public partial class GenerateDepositAddressE403 : AbstractOpenAPISchema, IEquatable<GenerateDepositAddressE403>, IValidatableObject
    {
        ...
        public GenerateDepositAddressE403(WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan, WalletAsAServiceDepositAddressesLimitReached, WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType");
                }
            }
        }
        ...
        public static GenerateDepositAddressE403 FromJson(string jsonString)
        {
            ...
            try
            {
                ...
                {
                    newGenerateDepositAddressE403 = new GenerateDepositAddressE403(JsonConvert.DeserializeObject<WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType>(jsonString, GenerateDepositAddressE403.SerializerSettings));
                }
                else
                {
                    newGenerateDepositAddressE403 = new GenerateDepositAddressE403(JsonConvert.DeserializeObject<WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType>(jsonString, GenerateDepositAddressE403.AdditionalPropertiesSerializerSettings));
                }
