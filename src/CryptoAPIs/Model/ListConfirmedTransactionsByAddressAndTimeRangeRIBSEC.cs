...
namespace CryptoAPIs.Model
{
    ...
    /// Ethereum Classic
    /// </summary>
    [DataContract(Name = "ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC")]
    public partial class ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC : IEquatable<ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC" /> class.
        /// </summary>
        ...
        public ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC(string contract = default(string), string gasLimit = default(string), ListConfirmedTransactionsByAddressRIBSECGasPrice gasPrice = default(ListConfirmedTransactionsByAddressRIBSECGasPrice), string gasUsed = default(string), string inputData = default(string), int nonce = default(int), string transactionStatus = default(string))
        {
            // to ensure "contract" is required (not null)
            if (contract == null)
            {
                throw new ArgumentNullException("contract is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC and cannot be null");
            }
            this.Contract = contract;
            // to ensure "gasLimit" is required (not null)
            if (gasLimit == null)
            {
                throw new ArgumentNullException("gasLimit is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC and cannot be null");
            }
            this.GasLimit = gasLimit;
            // to ensure "gasPrice" is required (not null)
            if (gasPrice == null)
            {
                throw new ArgumentNullException("gasPrice is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC and cannot be null");
            }
            this.GasPrice = gasPrice;
            // to ensure "gasUsed" is required (not null)
            if (gasUsed == null)
            {
                throw new ArgumentNullException("gasUsed is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC and cannot be null");
            }
            this.GasUsed = gasUsed;
            // to ensure "inputData" is required (not null)
            if (inputData == null)
            {
                throw new ArgumentNullException("inputData is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("transactionStatus is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC and cannot be null");
            }
        ...
        {
            return this.Equals(input as ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC);
        }

        /// <summary>
        /// Returns true if ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC instances are equal
        /// </summary>
        /// <param name="input">Instance of ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC input)
        {
            if (input == null)
            {
                return false;
