...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListTransactionsByBlockHashRIBSD2_vin")]
    public partial class ListTransactionsByBlockHashRIBSD2Vin : IEquatable<ListTransactionsByBlockHashRIBSD2Vin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashRIBSD2Vin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByBlockHashRIBSD2Vin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashRIBSD2Vin" /> class.
        /// </summary>
        ...
        public ListTransactionsByBlockHashRIBSD2Vin(List<string> addresses = default(List<string>), string coinbase = default(string), ListTransactionsByBlockHashRIBSD2ScriptSig scriptSig = default(ListTransactionsByBlockHashRIBSD2ScriptSig), string sequence = default(string), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            this.Addresses = addresses ?? throw new ArgumentNullException("addresses is a required property for ListTransactionsByBlockHashRIBSD2Vin and cannot be null");
            // to ensure "scriptSig" is required (not null)
            this.ScriptSig = scriptSig ?? throw new ArgumentNullException("scriptSig is a required property for ListTransactionsByBlockHashRIBSD2Vin and cannot be null");
            // to ensure "sequence" is required (not null)
            this.Sequence = sequence ?? throw new ArgumentNullException("sequence is a required property for ListTransactionsByBlockHashRIBSD2Vin and cannot be null");
            // to ensure "txinwitness" is required (not null)
            this.Txinwitness = txinwitness ?? throw new ArgumentNullException("txinwitness is a required property for ListTransactionsByBlockHashRIBSD2Vin and cannot be null");
            this.Vout = vout;
        ...
        public ListTransactionsByBlockHashRIBSD2ScriptSig ScriptSig { get; set; }
        ...
        {
            return this.Equals(input as ListTransactionsByBlockHashRIBSD2Vin);
        }

        /// <summary>
        /// Returns true if ListTransactionsByBlockHashRIBSD2Vin instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByBlockHashRIBSD2Vin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByBlockHashRIBSD2Vin input)
        {
            if (input == null)
                return false;
