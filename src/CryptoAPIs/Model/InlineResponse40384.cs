...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40384 : IEquatable<InlineResponse40384>, IValidatableObject
    {
        ...
        public InlineResponse40384(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetEIP1559FeeRecommendationsE403 error = default(GetEIP1559FeeRecommendationsE403))
        {
