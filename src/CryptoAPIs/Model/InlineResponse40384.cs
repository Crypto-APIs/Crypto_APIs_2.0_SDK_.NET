...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40384
    /// </summary>
    [DataContract(Name = "inline_response_403_84")]
    public partial class InlineResponse40384 : IEquatable<InlineResponse40384>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40384" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40384() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40384" /> class.
        /// </summary>
        ...
        public InlineResponse40384(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetTransactionDetailsByTransactionIDFromCallbackE403 error = default(GetTransactionDetailsByTransactionIDFromCallbackE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40384 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40384 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40384 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40384 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40384);
        }

        /// <summary>
        /// Returns true if InlineResponse40384 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40384 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40384 input)
        {
            if (input == null)
            {
                return false;
