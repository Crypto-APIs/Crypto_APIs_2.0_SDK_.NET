...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransactionRequestMined")]
    public partial class TransactionRequestMined : IEquatable<TransactionRequestMined>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionRequestMined" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionRequestMined() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionRequestMined" /> class.
        /// </summary>
        ...
        public TransactionRequestMined(string apiVersion = default(string), string referenceId = default(string), string idempotencyKey = default(string), TransactionRequestMinedData data = default(TransactionRequestMinedData))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for TransactionRequestMined and cannot be null");
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for TransactionRequestMined and cannot be null");
            // to ensure "idempotencyKey" is required (not null)
            this.IdempotencyKey = idempotencyKey ?? throw new ArgumentNullException("idempotencyKey is a required property for TransactionRequestMined and cannot be null");
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for TransactionRequestMined and cannot be null");
        }
        ...
        public TransactionRequestMinedData Data { get; set; }
        ...
        {
            return this.Equals(input as TransactionRequestMined);
        }

        /// <summary>
        /// Returns true if TransactionRequestMined instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionRequestMined to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionRequestMined input)
        {
            if (input == null)
                return false;
