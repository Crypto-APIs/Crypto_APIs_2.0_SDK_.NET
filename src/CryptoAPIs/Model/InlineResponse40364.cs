...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40364
    /// </summary>
    [DataContract(Name = "inline_response_403_64")]
    public partial class InlineResponse40364 : IEquatable<InlineResponse40364>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40364" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40364() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40364" /> class.
        /// </summary>
        ...
        public InlineResponse40364(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListConfirmedTokensTransfersByAddressE403 error = default(ListConfirmedTokensTransfersByAddressE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40364 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40364 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40364 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40364 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40364);
        }

        /// <summary>
        /// Returns true if InlineResponse40364 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40364 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40364 input)
        {
            if (input == null)
            {
                return false;
