...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40364 : IEquatable<InlineResponse40364>, IValidatableObject
    {
        ...
        public InlineResponse40364(string apiVersion = default(string), string requestId = default(string), string context = default(string), MinedTransactionE403 error = default(MinedTransactionE403))
        {
