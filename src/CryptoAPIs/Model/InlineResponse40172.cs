...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40172
    /// </summary>
    [DataContract(Name = "inline_response_401_72")]
    public partial class InlineResponse40172 : IEquatable<InlineResponse40172>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40172" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40172() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40172" /> class.
        /// </summary>
        ...
        public InlineResponse40172(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetBlockDetailsByBlockHeightFromCallbackE401 error = default(GetBlockDetailsByBlockHeightFromCallbackE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40172 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40172 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40172 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40172 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40172);
        }

        /// <summary>
        /// Returns true if InlineResponse40172 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40172 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40172 input)
        {
            if (input == null)
            {
                return false;
