...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40172 : IEquatable<InlineResponse40172>, IValidatableObject
    {
        ...
        public InlineResponse40172(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewUnconfirmedTokensTransactionsE401 error = default(NewUnconfirmedTokensTransactionsE401))
        {
