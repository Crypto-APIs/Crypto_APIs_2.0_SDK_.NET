...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40124 : IEquatable<InlineResponse40124>, IValidatableObject
    {
        ...
        public InlineResponse40124(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTransactionsByBlockHeightE401 error = default(ListTransactionsByBlockHeightE401))
        {
