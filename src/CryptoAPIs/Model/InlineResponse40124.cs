...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40124
    /// </summary>
    [DataContract(Name = "inline_response_401_24")]
    public partial class InlineResponse40124 : IEquatable<InlineResponse40124>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40124" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40124() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40124" /> class.
        /// </summary>
        ...
        public InlineResponse40124(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListXRPRippleTransactionsByBlockHeightE401 error = default(ListXRPRippleTransactionsByBlockHeightE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40124 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40124 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40124 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40124 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40124);
        }

        /// <summary>
        /// Returns true if InlineResponse40124 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40124 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40124 input)
        {
            if (input == null)
            {
                return false;
