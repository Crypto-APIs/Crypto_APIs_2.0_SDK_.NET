...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40090
    /// </summary>
    [DataContract(Name = "inline_response_400_90")]
    public partial class InlineResponse40090 : IEquatable<InlineResponse40090>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40090" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40090() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40090" /> class.
        /// </summary>
        ...
        public InlineResponse40090(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateAutomaticCoinsForwardingE400 error = default(CreateAutomaticCoinsForwardingE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40090 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40090 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40090 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40090 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40090);
        }

        /// <summary>
        /// Returns true if InlineResponse40090 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40090 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40090 input)
        {
            if (input == null)
            {
                return false;
