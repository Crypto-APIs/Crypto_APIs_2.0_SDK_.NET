...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40090 : IEquatable<InlineResponse40090>, IValidatableObject
    {
        ...
        public InlineResponse40090(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetAssetDetailsByAssetIDE400 error = default(GetAssetDetailsByAssetIDE400))
        {
