...
namespace CryptoAPIs.Model
{
    ...
    public partial class NewConfirmedTokensTransactionsAndEachConfirmationRBDataItem : IEquatable<NewConfirmedTokensTransactionsAndEachConfirmationRBDataItem>, IValidatableObject
    {
        ...
        public NewConfirmedTokensTransactionsAndEachConfirmationRBDataItem(string address = default(string), bool allowDuplicates = false, string callbackSecretKey = default(string), string callbackUrl = default(string), int confirmationsCount = default(int))
        {
            ...
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for NewConfirmedTokensTransactionsAndEachConfirmationRBDataItem and cannot be null");
            }
            this.Address = address;
            // to ensure "callbackUrl" is required (not null)
            if (callbackUrl == null)
            {
                throw new ArgumentNullException("callbackUrl is a required property for NewConfirmedTokensTransactionsAndEachConfirmationRBDataItem and cannot be null");
            }
