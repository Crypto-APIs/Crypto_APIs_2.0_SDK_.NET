...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewConfirmedTokensTransactionsAndEachConfirmationRB_data_item")]
    public partial class NewConfirmedTokensTransactionsAndEachConfirmationRBDataItem : IEquatable<NewConfirmedTokensTransactionsAndEachConfirmationRBDataItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewConfirmedTokensTransactionsAndEachConfirmationRBDataItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewConfirmedTokensTransactionsAndEachConfirmationRBDataItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewConfirmedTokensTransactionsAndEachConfirmationRBDataItem" /> class.
        /// </summary>
        ...
        public NewConfirmedTokensTransactionsAndEachConfirmationRBDataItem(string address = default(string), bool allowDuplicates = false, string callbackSecretKey = default(string), string callbackUrl = default(string), int confirmationsCount = default(int))
        {
            // to ensure "address" is required (not null)
            this.Address = address ?? throw new ArgumentNullException("address is a required property for NewConfirmedTokensTransactionsAndEachConfirmationRBDataItem and cannot be null");
            // to ensure "callbackUrl" is required (not null)
            this.CallbackUrl = callbackUrl ?? throw new ArgumentNullException("callbackUrl is a required property for NewConfirmedTokensTransactionsAndEachConfirmationRBDataItem and cannot be null");
        ...
        {
            return this.Equals(input as NewConfirmedTokensTransactionsAndEachConfirmationRBDataItem);
        }

        /// <summary>
        /// Returns true if NewConfirmedTokensTransactionsAndEachConfirmationRBDataItem instances are equal
        /// </summary>
        /// <param name="input">Instance of NewConfirmedTokensTransactionsAndEachConfirmationRBDataItem to be compared</param>
        /// <returns>Boolean</returns>
