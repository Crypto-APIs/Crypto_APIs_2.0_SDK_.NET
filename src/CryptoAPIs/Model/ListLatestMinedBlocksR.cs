...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListLatestMinedBlocksR")]
    public partial class ListLatestMinedBlocksR : IEquatable<ListLatestMinedBlocksR>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListLatestMinedBlocksR" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListLatestMinedBlocksR() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListLatestMinedBlocksR" /> class.
        /// </summary>
        ...
        public ListLatestMinedBlocksR(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListLatestMinedBlocksRData data = default(ListLatestMinedBlocksRData))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for ListLatestMinedBlocksR and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for ListLatestMinedBlocksR and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for ListLatestMinedBlocksR and cannot be null");
            }
            this.Data = data;
        ...
        public ListLatestMinedBlocksRData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListLatestMinedBlocksR {\n");
        ...
        {
            return this.Equals(input as ListLatestMinedBlocksR);
        }

        /// <summary>
        /// Returns true if ListLatestMinedBlocksR instances are equal
        /// </summary>
        /// <param name="input">Instance of ListLatestMinedBlocksR to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListLatestMinedBlocksR input)
        {
            if (input == null)
            {
                return false;
