...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(ListAssetsDetailsE403JsonConverter))]
    [DataContract(Name = "ListAssetsDetailsE403")]
    public partial class ListAssetsDetailsE403 : AbstractOpenAPISchema, IEquatable<ListAssetsDetailsE403>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAssetsDetailsE403" /> class
        /// with the <see cref="BannedIpAddress" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BannedIpAddress.</param>
        public ListAssetsDetailsE403(BannedIpAddress actualInstance)
        {
        ...
        public ListAssetsDetailsE403(EndpointNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public ListAssetsDetailsE403(EndpointNotAllowedForApiKey actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public ListAssetsDetailsE403(FeatureMainnetsNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListAssetsDetailsE403 {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, ListAssetsDetailsE403.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of ListAssetsDetailsE403
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of ListAssetsDetailsE403</returns>
        public static ListAssetsDetailsE403 FromJson(string jsonString)
        {
            ListAssetsDetailsE403 newListAssetsDetailsE403 = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newListAssetsDetailsE403;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newListAssetsDetailsE403 = new ListAssetsDetailsE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, ListAssetsDetailsE403.SerializerSettings));
                }
                else
                {
                    newListAssetsDetailsE403 = new ListAssetsDetailsE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, ListAssetsDetailsE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newListAssetsDetailsE403 = new ListAssetsDetailsE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, ListAssetsDetailsE403.SerializerSettings));
                }
                else
                {
                    newListAssetsDetailsE403 = new ListAssetsDetailsE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, ListAssetsDetailsE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newListAssetsDetailsE403 = new ListAssetsDetailsE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, ListAssetsDetailsE403.SerializerSettings));
                }
                else
                {
                    newListAssetsDetailsE403 = new ListAssetsDetailsE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, ListAssetsDetailsE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newListAssetsDetailsE403 = new ListAssetsDetailsE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, ListAssetsDetailsE403.SerializerSettings));
                }
                else
                {
                    newListAssetsDetailsE403 = new ListAssetsDetailsE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, ListAssetsDetailsE403.AdditionalPropertiesSerializerSettings));
                }
        ...
        {
            return this.Equals(input as ListAssetsDetailsE403);
        }

        /// <summary>
        /// Returns true if ListAssetsDetailsE403 instances are equal
        /// </summary>
        /// <param name="input">Instance of ListAssetsDetailsE403 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListAssetsDetailsE403 input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for ListAssetsDetailsE403
    /// </summary>
    public class ListAssetsDetailsE403JsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(ListAssetsDetailsE403).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return ListAssetsDetailsE403.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
