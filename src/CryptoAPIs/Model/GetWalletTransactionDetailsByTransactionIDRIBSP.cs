...
namespace CryptoAPIs.Model
{
    ...
    /// Polygon
    /// </summary>
    [DataContract(Name = "GetWalletTransactionDetailsByTransactionIDRIBSP")]
    public partial class GetWalletTransactionDetailsByTransactionIDRIBSP : IEquatable<GetWalletTransactionDetailsByTransactionIDRIBSP>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWalletTransactionDetailsByTransactionIDRIBSP" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetWalletTransactionDetailsByTransactionIDRIBSP() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWalletTransactionDetailsByTransactionIDRIBSP" /> class.
        /// </summary>
        ...
        public GetWalletTransactionDetailsByTransactionIDRIBSP(string contract = default(string), string gasLimit = default(string), GetWalletTransactionDetailsByTransactionIDRIBSPGasPrice gasPrice = default(GetWalletTransactionDetailsByTransactionIDRIBSPGasPrice), string gasUsed = default(string), string inputData = default(string), int nonce = default(int))
        {
            // to ensure "contract" is required (not null)
            if (contract == null)
            {
                throw new ArgumentNullException("contract is a required property for GetWalletTransactionDetailsByTransactionIDRIBSP and cannot be null");
            }
            this.Contract = contract;
            // to ensure "gasLimit" is required (not null)
            if (gasLimit == null)
            {
                throw new ArgumentNullException("gasLimit is a required property for GetWalletTransactionDetailsByTransactionIDRIBSP and cannot be null");
            }
            this.GasLimit = gasLimit;
            // to ensure "gasPrice" is required (not null)
            if (gasPrice == null)
            {
                throw new ArgumentNullException("gasPrice is a required property for GetWalletTransactionDetailsByTransactionIDRIBSP and cannot be null");
            }
            this.GasPrice = gasPrice;
            // to ensure "gasUsed" is required (not null)
            if (gasUsed == null)
            {
                throw new ArgumentNullException("gasUsed is a required property for GetWalletTransactionDetailsByTransactionIDRIBSP and cannot be null");
            }
            this.GasUsed = gasUsed;
            // to ensure "inputData" is required (not null)
            if (inputData == null)
            {
                throw new ArgumentNullException("inputData is a required property for GetWalletTransactionDetailsByTransactionIDRIBSP and cannot be null");
            }
        ...
        public GetWalletTransactionDetailsByTransactionIDRIBSPGasPrice GasPrice { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetWalletTransactionDetailsByTransactionIDRIBSP {\n");
        ...
        {
            return this.Equals(input as GetWalletTransactionDetailsByTransactionIDRIBSP);
        }

        /// <summary>
        /// Returns true if GetWalletTransactionDetailsByTransactionIDRIBSP instances are equal
        /// </summary>
        /// <param name="input">Instance of GetWalletTransactionDetailsByTransactionIDRIBSP to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetWalletTransactionDetailsByTransactionIDRIBSP input)
        {
            if (input == null)
            {
                return false;
