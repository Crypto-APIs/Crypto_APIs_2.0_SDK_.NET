...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40375
    /// </summary>
    [DataContract(Name = "inline_response_403_75")]
    public partial class InlineResponse40375 : IEquatable<InlineResponse40375>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40375" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40375() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40375" /> class.
        /// </summary>
        ...
        public InlineResponse40375(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedTokensTransactionsAndEachConfirmationE403 error = default(NewConfirmedTokensTransactionsAndEachConfirmationE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40375 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40375 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40375 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40375 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40375);
        }

        /// <summary>
        /// Returns true if InlineResponse40375 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40375 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40375 input)
        {
            if (input == null)
            {
                return false;
