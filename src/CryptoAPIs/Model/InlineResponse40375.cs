...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40375 : IEquatable<InlineResponse40375>, IValidatableObject
    {
        ...
        public InlineResponse40375(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListCoinsForwardingAutomationsE403 error = default(ListCoinsForwardingAutomationsE403))
        {
