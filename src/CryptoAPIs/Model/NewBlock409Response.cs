...
namespace CryptoAPIs.Model
{
    ...
    /// NewBlock409Response
    /// </summary>
    [DataContract(Name = "New_Block_409_response")]
    public partial class NewBlock409Response : IEquatable<NewBlock409Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewBlock409Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewBlock409Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewBlock409Response" /> class.
        /// </summary>
        ...
        public NewBlock409Response(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewBlockE409 error = default(NewBlockE409))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for NewBlock409Response and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for NewBlock409Response and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for NewBlock409Response and cannot be null");
            }
            this.Error = error;
        ...
        public NewBlockE409 Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewBlock409Response {\n");
        ...
        {
            return this.Equals(input as NewBlock409Response);
        }

        /// <summary>
        /// Returns true if NewBlock409Response instances are equal
        /// </summary>
        /// <param name="input">Instance of NewBlock409Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewBlock409Response input)
        {
            if (input == null)
            {
                return false;
