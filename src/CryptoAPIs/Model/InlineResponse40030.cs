...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40030 : IEquatable<InlineResponse40030>, IValidatableObject
    {
        ...
        public InlineResponse40030(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetBlockDetailsByBlockHashE400 error = default(GetBlockDetailsByBlockHashE400))
        {
