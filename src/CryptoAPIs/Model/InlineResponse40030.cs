...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40030
    /// </summary>
    [DataContract(Name = "inline_response_400_30")]
    public partial class InlineResponse40030 : IEquatable<InlineResponse40030>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40030" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40030() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40030" /> class.
        /// </summary>
        ...
        public InlineResponse40030(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetZilliqaBlockDetailsByBlockHeightE400 error = default(GetZilliqaBlockDetailsByBlockHeightE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40030 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40030 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40030 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40030 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40030);
        }

        /// <summary>
        /// Returns true if InlineResponse40030 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40030 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40030 input)
        {
            if (input == null)
            {
                return false;
