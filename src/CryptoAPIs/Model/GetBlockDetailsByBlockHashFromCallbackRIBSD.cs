...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetBlockDetailsByBlockHashFromCallbackRIBSD : IEquatable<GetBlockDetailsByBlockHashFromCallbackRIBSD>, IValidatableObject
    {
        ...
        public GetBlockDetailsByBlockHashFromCallbackRIBSD(string bits = default(string), string chainwork = default(string), string difficulty = default(string), string merkleRoot = default(string), int nonce = default(int), int size = default(int), int version = default(int), string versionHex = default(string))
        {
