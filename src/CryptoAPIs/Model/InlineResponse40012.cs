...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40012
    /// </summary>
    [DataContract(Name = "inline_response_400_12")]
    public partial class InlineResponse40012 : IEquatable<InlineResponse40012>, IValidatableObject
    {
        ...
        public InlineResponse40012(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListUnconfirmedOmniTransactionsByAddressE400 error = default(ListUnconfirmedOmniTransactionsByAddressE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40012 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40012 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40012 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse40012);
        }

        /// <summary>
        /// Returns true if InlineResponse40012 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40012 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40012 input)
        {
            if (input == null)
            {
                return false;
