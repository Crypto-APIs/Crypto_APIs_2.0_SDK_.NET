...
namespace CryptoAPIs.Model
{
    ...
    /// Zcash
    /// </summary>
    [DataContract(Name = "GetLastMinedBlockRIBSZ")]
    public partial class GetLastMinedBlockRIBSZ : IEquatable<GetLastMinedBlockRIBSZ>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLastMinedBlockRIBSZ" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetLastMinedBlockRIBSZ() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLastMinedBlockRIBSZ" /> class.
        /// </summary>
        ...
        public GetLastMinedBlockRIBSZ(string difficulty = default(string), string nonce = default(string), int size = default(int), string bits = default(string), string chainwork = default(string), string merkleRoot = default(string), int version = default(int))
        {
            // to ensure "difficulty" is required (not null)
            if (difficulty == null)
            {
                throw new ArgumentNullException("difficulty is a required property for GetLastMinedBlockRIBSZ and cannot be null");
            }
            this.Difficulty = difficulty;
            // to ensure "nonce" is required (not null)
            if (nonce == null)
            {
                throw new ArgumentNullException("nonce is a required property for GetLastMinedBlockRIBSZ and cannot be null");
            }
            this.Nonce = nonce;
            this.Size = size;
            ...
            if (bits == null)
            {
                throw new ArgumentNullException("bits is a required property for GetLastMinedBlockRIBSZ and cannot be null");
            }
            this.Bits = bits;
            // to ensure "chainwork" is required (not null)
            if (chainwork == null)
            {
                throw new ArgumentNullException("chainwork is a required property for GetLastMinedBlockRIBSZ and cannot be null");
            }
            this.Chainwork = chainwork;
            // to ensure "merkleRoot" is required (not null)
            if (merkleRoot == null)
            {
                throw new ArgumentNullException("merkleRoot is a required property for GetLastMinedBlockRIBSZ and cannot be null");
            }
        ...
        {
            return this.Equals(input as GetLastMinedBlockRIBSZ);
        }

        /// <summary>
        /// Returns true if GetLastMinedBlockRIBSZ instances are equal
        /// </summary>
        /// <param name="input">Instance of GetLastMinedBlockRIBSZ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetLastMinedBlockRIBSZ input)
        {
            if (input == null)
            {
                return false;
