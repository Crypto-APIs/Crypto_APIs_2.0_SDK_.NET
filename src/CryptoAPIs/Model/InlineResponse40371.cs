...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40371
    /// </summary>
    [DataContract(Name = "inline_response_403_71")]
    public partial class InlineResponse40371 : IEquatable<InlineResponse40371>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40371" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40371() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40371" /> class.
        /// </summary>
        ...
        public InlineResponse40371(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetBlockDetailsByBlockHashFromCallbackE403 error = default(GetBlockDetailsByBlockHashFromCallbackE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40371 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40371 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40371 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40371 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40371);
        }

        /// <summary>
        /// Returns true if InlineResponse40371 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40371 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40371 input)
        {
            if (input == null)
            {
                return false;
