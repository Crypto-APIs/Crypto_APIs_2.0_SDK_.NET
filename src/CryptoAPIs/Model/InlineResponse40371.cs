...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40371 : IEquatable<InlineResponse40371>, IValidatableObject
    {
        ...
        public InlineResponse40371(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewUnconfirmedCoinsTransactionsE403 error = default(NewUnconfirmedCoinsTransactionsE403))
        {
