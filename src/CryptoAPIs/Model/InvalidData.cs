...
namespace CryptoAPIs.Model
{
    ...
    /// InvalidData
    /// </summary>
    [DataContract(Name = "InvalidData")]
    public partial class InvalidData : IEquatable<InvalidData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidData" /> class.
        /// </summary>
        ...
        public InvalidData(string apiVersion = default(string), string requestId = default(string), string context = default(string), InvalidDataError error = default(InvalidDataError))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for InvalidData and cannot be null");
            // to ensure "requestId" is required (not null)
            this.RequestId = requestId ?? throw new ArgumentNullException("requestId is a required property for InvalidData and cannot be null");
            // to ensure "error" is required (not null)
            this.Error = error ?? throw new ArgumentNullException("error is a required property for InvalidData and cannot be null");
        ...
        public InvalidDataError Error { get; set; }
        ...
        {
            return this.Equals(input as InvalidData);
        }

        /// <summary>
        /// Returns true if InvalidData instances are equal
        /// </summary>
        /// <param name="input">Instance of InvalidData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvalidData input)
        {
            if (input == null)
                return false;
