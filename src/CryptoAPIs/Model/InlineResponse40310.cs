...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40310
    /// </summary>
    [DataContract(Name = "inline_response_403_10")]
    public partial class InlineResponse40310 : IEquatable<InlineResponse40310>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40310" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40310() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40310" /> class.
        /// </summary>
        ...
        public InlineResponse40310(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListConfirmedTransactionsByAddressE403 error = default(ListConfirmedTransactionsByAddressE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40310 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40310 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40310 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40310 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40310);
        }

        /// <summary>
        /// Returns true if InlineResponse40310 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40310 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40310 input)
        {
            if (input == null)
            {
                return false;
