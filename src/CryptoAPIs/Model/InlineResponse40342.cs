...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40342
    /// </summary>
    [DataContract(Name = "inline_response_403_42")]
    public partial class InlineResponse40342 : IEquatable<InlineResponse40342>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40342" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40342() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40342" /> class.
        /// </summary>
        ...
        public InlineResponse40342(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetLatestMinedXRPRippleBlockE403 error = default(GetLatestMinedXRPRippleBlockE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40342 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40342 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40342 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40342 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40342);
        }

        /// <summary>
        /// Returns true if InlineResponse40342 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40342 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40342 input)
        {
            if (input == null)
            {
                return false;
