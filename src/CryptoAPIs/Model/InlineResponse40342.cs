...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40342 : IEquatable<InlineResponse40342>, IValidatableObject
    {
        ...
        public InlineResponse40342(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListLatestMinedBlocksE403 error = default(ListLatestMinedBlocksE403))
        {
