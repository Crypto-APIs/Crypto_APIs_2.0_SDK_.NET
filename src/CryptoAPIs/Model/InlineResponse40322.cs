...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40322 : IEquatable<InlineResponse40322>, IValidatableObject
    {
        ...
        public InlineResponse40322(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListZilliqaTransactionsByBlockHashE403 error = default(ListZilliqaTransactionsByBlockHashE403))
        {
