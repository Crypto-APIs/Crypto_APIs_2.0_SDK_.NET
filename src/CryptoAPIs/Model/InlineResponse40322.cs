...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40322
    /// </summary>
    [DataContract(Name = "inline_response_403_22")]
    public partial class InlineResponse40322 : IEquatable<InlineResponse40322>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40322" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40322() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40322" /> class.
        /// </summary>
        ...
        public InlineResponse40322(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListZilliqaTransactionsByBlockHeightE403 error = default(ListZilliqaTransactionsByBlockHeightE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40322 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40322 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40322 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40322 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40322);
        }

        /// <summary>
        /// Returns true if InlineResponse40322 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40322 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40322 input)
        {
            if (input == null)
            {
                return false;
