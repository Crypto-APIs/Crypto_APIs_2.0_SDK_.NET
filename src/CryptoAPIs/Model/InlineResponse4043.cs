...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4043
    /// </summary>
    [DataContract(Name = "inline_response_404_3")]
    public partial class InlineResponse4043 : IEquatable<InlineResponse4043>, IValidatableObject
    {
        ...
        public InlineResponse4043(string apiVersion = default(string), string requestId = default(string), string context = default(string), BlockchainDataInternalTransactionNotFound error = default(BlockchainDataInternalTransactionNotFound))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4043 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4043 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse4043 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse4043);
        }

        /// <summary>
        /// Returns true if InlineResponse4043 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4043 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4043 input)
        {
            if (input == null)
            {
                return false;
