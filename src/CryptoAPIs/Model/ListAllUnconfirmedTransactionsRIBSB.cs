...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListAllUnconfirmedTransactionsRIBSB : IEquatable<ListAllUnconfirmedTransactionsRIBSB>, IValidatableObject
    {
        ...
        public ListAllUnconfirmedTransactionsRIBSB(int locktime = default(int), int size = default(int), int vSize = default(int), int version = default(int), List<ListAllUnconfirmedTransactionsRIBSBVin> vin = default(List<ListAllUnconfirmedTransactionsRIBSBVin>), List<ListUnconfirmedTransactionsByAddressRIBSBVout> vout = default(List<ListUnconfirmedTransactionsByAddressRIBSBVout>))
        {
