...
namespace CryptoAPIs.Model
{
    ...
    /// Bitcoin
    /// </summary>
    [DataContract(Name = "ListAllUnconfirmedTransactionsRIBSB")]
    public partial class ListAllUnconfirmedTransactionsRIBSB : IEquatable<ListAllUnconfirmedTransactionsRIBSB>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllUnconfirmedTransactionsRIBSB" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListAllUnconfirmedTransactionsRIBSB() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllUnconfirmedTransactionsRIBSB" /> class.
        /// </summary>
        ...
        public ListAllUnconfirmedTransactionsRIBSB(long locktime = default(long), int size = default(int), int vSize = default(int), int version = default(int), List<ListAllUnconfirmedTransactionsRIBSBVinInner> vin = default(List<ListAllUnconfirmedTransactionsRIBSBVinInner>), List<ListUnconfirmedTransactionsByAddressRIBSBVoutInner> vout = default(List<ListUnconfirmedTransactionsByAddressRIBSBVoutInner>))
        {
            ...
            if (vin == null)
            {
                throw new ArgumentNullException("vin is a required property for ListAllUnconfirmedTransactionsRIBSB and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null)
            {
                throw new ArgumentNullException("vout is a required property for ListAllUnconfirmedTransactionsRIBSB and cannot be null");
            }
            this.Vout = vout;
        }
        ...
        public List<ListAllUnconfirmedTransactionsRIBSBVinInner> Vin { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListAllUnconfirmedTransactionsRIBSB {\n");
        ...
        {
            return this.Equals(input as ListAllUnconfirmedTransactionsRIBSB);
        }

        /// <summary>
        /// Returns true if ListAllUnconfirmedTransactionsRIBSB instances are equal
        /// </summary>
        /// <param name="input">Instance of ListAllUnconfirmedTransactionsRIBSB to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListAllUnconfirmedTransactionsRIBSB input)
        {
            if (input == null)
            {
                return false;
