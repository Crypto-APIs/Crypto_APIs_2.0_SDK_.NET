...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListAllUnconfirmedTransactionsRIBSB : IEquatable<ListAllUnconfirmedTransactionsRIBSB>, IValidatableObject
    {
        ...
        public ListAllUnconfirmedTransactionsRIBSB(long locktime = default(long), int size = default(int), int vSize = default(int), int version = default(int), List<ListAllUnconfirmedTransactionsRIBSBVin> vin = default(List<ListAllUnconfirmedTransactionsRIBSBVin>), List<ListUnconfirmedTransactionsByAddressRIBSBVout> vout = default(List<ListUnconfirmedTransactionsByAddressRIBSBVout>))
        {
        ...
        public List<ListAllUnconfirmedTransactionsRIBSBVin> Vin { get; set; }
