...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40343
    /// </summary>
    [DataContract(Name = "inline_response_403_43")]
    public partial class InlineResponse40343 : IEquatable<InlineResponse40343>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40343" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40343() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40343" /> class.
        /// </summary>
        ...
        public InlineResponse40343(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetLatestMinedZilliqaBlockE403 error = default(GetLatestMinedZilliqaBlockE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40343 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40343 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40343 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40343 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40343);
        }

        /// <summary>
        /// Returns true if InlineResponse40343 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40343 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40343 input)
        {
            if (input == null)
            {
                return false;
