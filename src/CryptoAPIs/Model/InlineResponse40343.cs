...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40343 : IEquatable<InlineResponse40343>, IValidatableObject
    {
        ...
        public InlineResponse40343(string apiVersion = default(string), string requestId = default(string), string context = default(string), SyncHDWalletXPubYPubZPubE403 error = default(SyncHDWalletXPubYPubZPubE403))
        {
