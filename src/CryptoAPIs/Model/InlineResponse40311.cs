...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40311
    /// </summary>
    [DataContract(Name = "inline_response_403_11")]
    public partial class InlineResponse40311 : IEquatable<InlineResponse40311>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40311" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40311() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40311" /> class.
        /// </summary>
        ...
        public InlineResponse40311(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListXRPRippleTransactionsByAddressE403 error = default(ListXRPRippleTransactionsByAddressE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40311 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40311 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40311 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40311 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40311);
        }

        /// <summary>
        /// Returns true if InlineResponse40311 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40311 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40311 input)
        {
            if (input == null)
            {
                return false;
