...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40078 : IEquatable<InlineResponse40078>, IValidatableObject
    {
        ...
        public InlineResponse40078(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewBlockE400 error = default(NewBlockE400))
        {
