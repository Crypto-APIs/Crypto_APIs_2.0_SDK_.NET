...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_403_100")]
    public partial class InlineResponse403100 : IEquatable<InlineResponse403100>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse403100" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse403100() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse403100" /> class.
        /// </summary>
        ...
        public InlineResponse403100(string apiVersion = default(string), string requestId = default(string), string context = default(string), EstimateGasLimitE403 error = default(EstimateGasLimitE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse403100 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse403100 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse403100 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse403100 {\n");
        ...
        {
            return this.Equals(input as InlineResponse403100);
        }

        /// <summary>
        /// Returns true if InlineResponse403100 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse403100 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse403100 input)
        {
            if (input == null)
            {
                return false;
