...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40377 : IEquatable<InlineResponse40377>, IValidatableObject
    {
        ...
        public InlineResponse40377(string apiVersion = default(string), string requestId = default(string), string context = default(string), MinedTransactionE403 error = default(MinedTransactionE403))
        {
