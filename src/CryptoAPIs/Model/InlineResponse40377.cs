...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40377
    /// </summary>
    [DataContract(Name = "inline_response_403_77")]
    public partial class InlineResponse40377 : IEquatable<InlineResponse40377>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40377" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40377() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40377" /> class.
        /// </summary>
        ...
        public InlineResponse40377(string apiVersion = default(string), string requestId = default(string), string context = default(string), DeleteAutomaticCoinsForwardingE403 error = default(DeleteAutomaticCoinsForwardingE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40377 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40377 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40377 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40377 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40377);
        }

        /// <summary>
        /// Returns true if InlineResponse40377 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40377 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40377 input)
        {
            if (input == null)
            {
                return false;
