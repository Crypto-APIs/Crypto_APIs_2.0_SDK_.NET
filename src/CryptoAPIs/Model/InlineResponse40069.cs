...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40069 : IEquatable<InlineResponse40069>, IValidatableObject
    {
        ...
        public InlineResponse40069(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetAddressDetailsFromCallbackE400 error = default(GetAddressDetailsFromCallbackE400))
        {
