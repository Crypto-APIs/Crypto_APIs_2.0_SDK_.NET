...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40069
    /// </summary>
    [DataContract(Name = "inline_response_400_69")]
    public partial class InlineResponse40069 : IEquatable<InlineResponse40069>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40069" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40069() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40069" /> class.
        /// </summary>
        ...
        public InlineResponse40069(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetTokenDetailsByContractAddressE400 error = default(GetTokenDetailsByContractAddressE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40069 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40069 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40069 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40069 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40069);
        }

        /// <summary>
        /// Returns true if InlineResponse40069 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40069 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40069 input)
        {
            if (input == null)
            {
                return false;
