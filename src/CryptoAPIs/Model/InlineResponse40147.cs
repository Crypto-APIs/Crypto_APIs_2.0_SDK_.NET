...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40147
    /// </summary>
    [DataContract(Name = "inline_response_401_47")]
    public partial class InlineResponse40147 : IEquatable<InlineResponse40147>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40147" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40147() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40147" /> class.
        /// </summary>
        ...
        public InlineResponse40147(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListOmniTransactionsByBlockHashE401 error = default(ListOmniTransactionsByBlockHashE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40147 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40147 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40147 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40147 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40147);
        }

        /// <summary>
        /// Returns true if InlineResponse40147 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40147 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40147 input)
        {
            if (input == null)
            {
                return false;
