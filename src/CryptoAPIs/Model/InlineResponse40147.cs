...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40147 : IEquatable<InlineResponse40147>, IValidatableObject
    {
        ...
        public InlineResponse40147(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetHDWalletXPubYPubZPubDetailsE401 error = default(GetHDWalletXPubYPubZPubDetailsE401))
        {
