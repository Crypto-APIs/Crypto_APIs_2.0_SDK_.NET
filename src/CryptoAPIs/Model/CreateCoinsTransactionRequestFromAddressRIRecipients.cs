...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateCoinsTransactionRequestFromAddressRI_recipients")]
    public partial class CreateCoinsTransactionRequestFromAddressRIRecipients : IEquatable<CreateCoinsTransactionRequestFromAddressRIRecipients>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCoinsTransactionRequestFromAddressRIRecipients" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateCoinsTransactionRequestFromAddressRIRecipients() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCoinsTransactionRequestFromAddressRIRecipients" /> class.
        /// </summary>
        ...
        public CreateCoinsTransactionRequestFromAddressRIRecipients(string address = default(string), int addressTag = default(int), string amount = default(string), string classicAddress = default(string))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for CreateCoinsTransactionRequestFromAddressRIRecipients and cannot be null");
            }
            this.Address = address;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for CreateCoinsTransactionRequestFromAddressRIRecipients and cannot be null");
            }
            this.Amount = amount;
        ...
        {
            return this.Equals(input as CreateCoinsTransactionRequestFromAddressRIRecipients);
        }

        /// <summary>
        /// Returns true if CreateCoinsTransactionRequestFromAddressRIRecipients instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateCoinsTransactionRequestFromAddressRIRecipients to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateCoinsTransactionRequestFromAddressRIRecipients input)
        {
            if (input == null)
            {
                return false;
