...
namespace CryptoAPIs.Model
{
    ...
    public partial class NewConfirmedCoinsTransactionsRI : IEquatable<NewConfirmedCoinsTransactionsRI>, IValidatableObject
    {
        ...
        public NewConfirmedCoinsTransactionsRI(string address = default(string), string callbackSecretKey = default(string), string callbackUrl = default(string), int createdTimestamp = default(int), string eventType = default(string), bool isActive = default(bool), int receiveCallbackOn = default(int), string referenceId = default(string))
        {
