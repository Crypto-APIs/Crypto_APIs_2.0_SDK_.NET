...
namespace CryptoAPIs.Model
{
    ...
    public partial class NewConfirmedCoinsTransactionsRI : IEquatable<NewConfirmedCoinsTransactionsRI>, IValidatableObject
    {
        ...
        public NewConfirmedCoinsTransactionsRI(string address = default(string), string callbackSecretKey = default(string), string callbackUrl = default(string), int confirmationsCount = default(int), int createdTimestamp = default(int), string eventType = default(string), bool isActive = default(bool), string referenceId = default(string), string transactionId = default(string))
        {
            ...
            if (address == null) {
                throw new ArgumentNullException("address is a required property for NewConfirmedCoinsTransactionsRI and cannot be null");
            }
            this.Address = address;
            // to ensure "callbackSecretKey" is required (not null)
            if (callbackSecretKey == null) {
                throw new ArgumentNullException("callbackSecretKey is a required property for NewConfirmedCoinsTransactionsRI and cannot be null");
            }
            this.CallbackSecretKey = callbackSecretKey;
            // to ensure "callbackUrl" is required (not null)
            if (callbackUrl == null) {
                throw new ArgumentNullException("callbackUrl is a required property for NewConfirmedCoinsTransactionsRI and cannot be null");
            }
            ...
            if (eventType == null) {
                throw new ArgumentNullException("eventType is a required property for NewConfirmedCoinsTransactionsRI and cannot be null");
            }
            this.EventType = eventType;
            this.IsActive = isActive;
            // to ensure "referenceId" is required (not null)
            if (referenceId == null) {
                throw new ArgumentNullException("referenceId is a required property for NewConfirmedCoinsTransactionsRI and cannot be null");
            }
            this.ReferenceId = referenceId;
            // to ensure "transactionId" is required (not null)
            if (transactionId == null) {
                throw new ArgumentNullException("transactionId is a required property for NewConfirmedCoinsTransactionsRI and cannot be null");
            }
