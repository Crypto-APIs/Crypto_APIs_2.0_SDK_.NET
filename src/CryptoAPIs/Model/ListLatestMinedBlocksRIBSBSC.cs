...
namespace CryptoAPIs.Model
{
    ...
    /// Binance Smart Chain
    /// </summary>
    [DataContract(Name = "ListLatestMinedBlocksRIBSBSC")]
    public partial class ListLatestMinedBlocksRIBSBSC : IEquatable<ListLatestMinedBlocksRIBSBSC>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListLatestMinedBlocksRIBSBSC" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListLatestMinedBlocksRIBSBSC() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListLatestMinedBlocksRIBSBSC" /> class.
        /// </summary>
        ...
        public ListLatestMinedBlocksRIBSBSC(string extraData = default(string), string gasLimit = default(string), string gasUsed = default(string), int minedInSeconds = default(int), string sha3Uncles = default(string), string totalDifficulty = default(string), List<string> uncles = default(List<string>))
        {
            // to ensure "extraData" is required (not null)
            if (extraData == null) {
                throw new ArgumentNullException("extraData is a required property for ListLatestMinedBlocksRIBSBSC and cannot be null");
            }
            this.ExtraData = extraData;
            // to ensure "gasLimit" is required (not null)
            if (gasLimit == null) {
                throw new ArgumentNullException("gasLimit is a required property for ListLatestMinedBlocksRIBSBSC and cannot be null");
            }
            this.GasLimit = gasLimit;
            // to ensure "gasUsed" is required (not null)
            if (gasUsed == null) {
                throw new ArgumentNullException("gasUsed is a required property for ListLatestMinedBlocksRIBSBSC and cannot be null");
            }
            this.GasUsed = gasUsed;
            this.MinedInSeconds = minedInSeconds;
            // to ensure "sha3Uncles" is required (not null)
            if (sha3Uncles == null) {
                throw new ArgumentNullException("sha3Uncles is a required property for ListLatestMinedBlocksRIBSBSC and cannot be null");
            }
            this.Sha3Uncles = sha3Uncles;
            // to ensure "totalDifficulty" is required (not null)
            if (totalDifficulty == null) {
                throw new ArgumentNullException("totalDifficulty is a required property for ListLatestMinedBlocksRIBSBSC and cannot be null");
            }
            this.TotalDifficulty = totalDifficulty;
            // to ensure "uncles" is required (not null)
            if (uncles == null) {
                throw new ArgumentNullException("uncles is a required property for ListLatestMinedBlocksRIBSBSC and cannot be null");
            }
            this.Uncles = uncles;
        }
        ...
        {
            return this.Equals(input as ListLatestMinedBlocksRIBSBSC);
        }

        /// <summary>
        /// Returns true if ListLatestMinedBlocksRIBSBSC instances are equal
        /// </summary>
        /// <param name="input">Instance of ListLatestMinedBlocksRIBSBSC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListLatestMinedBlocksRIBSBSC input)
        {
            if (input == null)
                return false;
