...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_400_100")]
    public partial class InlineResponse400100 : IEquatable<InlineResponse400100>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse400100" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse400100() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse400100" /> class.
        /// </summary>
        ...
        public InlineResponse400100(string apiVersion = default(string), string requestId = default(string), string context = default(string), EstimateGasLimitE400 error = default(EstimateGasLimitE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse400100 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse400100 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse400100 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse400100 {\n");
        ...
        {
            return this.Equals(input as InlineResponse400100);
        }

        /// <summary>
        /// Returns true if InlineResponse400100 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse400100 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse400100 input)
        {
            if (input == null)
            {
                return false;
