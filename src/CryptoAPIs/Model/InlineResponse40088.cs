...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40088 : IEquatable<InlineResponse40088>, IValidatableObject
    {
        ...
        public InlineResponse40088(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetExchangeRateByAssetsIDsE400 error = default(GetExchangeRateByAssetsIDsE400))
        {
