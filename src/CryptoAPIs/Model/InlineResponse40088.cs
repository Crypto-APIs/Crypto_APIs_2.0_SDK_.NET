...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40088
    /// </summary>
    [DataContract(Name = "inline_response_400_88")]
    public partial class InlineResponse40088 : IEquatable<InlineResponse40088>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40088" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40088() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40088" /> class.
        /// </summary>
        ...
        public InlineResponse40088(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedInternalTransactionsAndEachConfirmationE400 error = default(NewConfirmedInternalTransactionsAndEachConfirmationE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40088 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40088 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40088 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40088 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40088);
        }

        /// <summary>
        /// Returns true if InlineResponse40088 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40088 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40088 input)
        {
            if (input == null)
            {
                return false;
