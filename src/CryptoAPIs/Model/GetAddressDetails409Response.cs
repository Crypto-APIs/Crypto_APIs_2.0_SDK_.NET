...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Get_Address_Details_409_response")]
    public partial class GetAddressDetails409Response : IEquatable<GetAddressDetails409Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressDetails409Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetAddressDetails409Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressDetails409Response" /> class.
        /// </summary>
        ...
        public GetAddressDetails409Response(string apiVersion = default(string), string requestId = default(string), string context = default(string), InvalidData error = default(InvalidData))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for GetAddressDetails409Response and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for GetAddressDetails409Response and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for GetAddressDetails409Response and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAddressDetails409Response {\n");
        ...
        {
            return this.Equals(input as GetAddressDetails409Response);
        }

        /// <summary>
        /// Returns true if GetAddressDetails409Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAddressDetails409Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAddressDetails409Response input)
        {
            if (input == null)
            {
                return false;
