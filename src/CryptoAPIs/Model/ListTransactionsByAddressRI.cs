...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListTransactionsByAddressRI")]
    public partial class ListTransactionsByAddressRI : IEquatable<ListTransactionsByAddressRI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByAddressRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressRI" /> class.
        /// </summary>
        ...
        public ListTransactionsByAddressRI(int index = default(int), string minedInBlockHash = default(string), int minedInBlockHeight = default(int), List<GetTransactionDetailsByTransactionIDRIRecipients> recipients = default(List<GetTransactionDetailsByTransactionIDRIRecipients>), List<GetTransactionDetailsByTransactionIDRISenders> senders = default(List<GetTransactionDetailsByTransactionIDRISenders>), int timestamp = default(int), string transactionHash = default(string), string transactionId = default(string), GetTransactionDetailsByTransactionIDRIFee fee = default(GetTransactionDetailsByTransactionIDRIFee), ListTransactionsByAddressRIBS blockchainSpecific = default(ListTransactionsByAddressRIBS))
        {
            this.Index = index;
            // to ensure "recipients" is required (not null)
            this.Recipients = recipients ?? throw new ArgumentNullException("recipients is a required property for ListTransactionsByAddressRI and cannot be null");
            // to ensure "senders" is required (not null)
            this.Senders = senders ?? throw new ArgumentNullException("senders is a required property for ListTransactionsByAddressRI and cannot be null");
            this.Timestamp = timestamp;
            // to ensure "transactionHash" is required (not null)
            this.TransactionHash = transactionHash ?? throw new ArgumentNullException("transactionHash is a required property for ListTransactionsByAddressRI and cannot be null");
            // to ensure "transactionId" is required (not null)
            this.TransactionId = transactionId ?? throw new ArgumentNullException("transactionId is a required property for ListTransactionsByAddressRI and cannot be null");
            // to ensure "fee" is required (not null)
            this.Fee = fee ?? throw new ArgumentNullException("fee is a required property for ListTransactionsByAddressRI and cannot be null");
            // to ensure "blockchainSpecific" is required (not null)
            this.BlockchainSpecific = blockchainSpecific ?? throw new ArgumentNullException("blockchainSpecific is a required property for ListTransactionsByAddressRI and cannot be null");
        ...
        public ListTransactionsByAddressRIBS BlockchainSpecific { get; set; }
        ...
        {
            return this.Equals(input as ListTransactionsByAddressRI);
        }

        /// <summary>
        /// Returns true if ListTransactionsByAddressRI instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByAddressRI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByAddressRI input)
        {
            if (input == null)
                return false;
