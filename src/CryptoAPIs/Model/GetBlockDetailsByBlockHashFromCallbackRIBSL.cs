...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetBlockDetailsByBlockHashFromCallbackRIBSL : IEquatable<GetBlockDetailsByBlockHashFromCallbackRIBSL>, IValidatableObject
    {
        ...
        public GetBlockDetailsByBlockHashFromCallbackRIBSL(string bits = default(string), string chainwork = default(string), string difficulty = default(string), string merkleRoot = default(string), int nonce = default(int), int size = default(int), int strippedsize = default(int), int version = default(int), string versionHex = default(string), int weight = default(int))
        {
