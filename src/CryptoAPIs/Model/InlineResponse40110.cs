...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40110
    /// </summary>
    [DataContract(Name = "inline_response_401_10")]
    public partial class InlineResponse40110 : IEquatable<InlineResponse40110>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40110" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40110() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40110" /> class.
        /// </summary>
        ...
        public InlineResponse40110(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListConfirmedTransactionsByAddressE401 error = default(ListConfirmedTransactionsByAddressE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40110 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40110 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40110 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40110 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40110);
        }

        /// <summary>
        /// Returns true if InlineResponse40110 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40110 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40110 input)
        {
            if (input == null)
            {
                return false;
