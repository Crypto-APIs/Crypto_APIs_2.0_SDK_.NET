...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(GetNextAvailableNonceE403JsonConverter))]
    [DataContract(Name = "GetNextAvailableNonceE403")]
    public partial class GetNextAvailableNonceE403 : AbstractOpenAPISchema, IEquatable<GetNextAvailableNonceE403>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetNextAvailableNonceE403" /> class
        /// with the <see cref="BannedIpAddress" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BannedIpAddress.</param>
        public GetNextAvailableNonceE403(BannedIpAddress actualInstance)
        {
        ...
        public GetNextAvailableNonceE403(EndpointNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public GetNextAvailableNonceE403(EndpointNotAllowedForApiKey actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public GetNextAvailableNonceE403(FeatureMainnetsNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetNextAvailableNonceE403 {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, GetNextAvailableNonceE403.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of GetNextAvailableNonceE403
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of GetNextAvailableNonceE403</returns>
        public static GetNextAvailableNonceE403 FromJson(string jsonString)
        {
            GetNextAvailableNonceE403 newGetNextAvailableNonceE403 = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newGetNextAvailableNonceE403;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newGetNextAvailableNonceE403 = new GetNextAvailableNonceE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, GetNextAvailableNonceE403.SerializerSettings));
                }
                else
                {
                    newGetNextAvailableNonceE403 = new GetNextAvailableNonceE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, GetNextAvailableNonceE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newGetNextAvailableNonceE403 = new GetNextAvailableNonceE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, GetNextAvailableNonceE403.SerializerSettings));
                }
                else
                {
                    newGetNextAvailableNonceE403 = new GetNextAvailableNonceE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, GetNextAvailableNonceE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newGetNextAvailableNonceE403 = new GetNextAvailableNonceE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, GetNextAvailableNonceE403.SerializerSettings));
                }
                else
                {
                    newGetNextAvailableNonceE403 = new GetNextAvailableNonceE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, GetNextAvailableNonceE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newGetNextAvailableNonceE403 = new GetNextAvailableNonceE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, GetNextAvailableNonceE403.SerializerSettings));
                }
                else
                {
                    newGetNextAvailableNonceE403 = new GetNextAvailableNonceE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, GetNextAvailableNonceE403.AdditionalPropertiesSerializerSettings));
                }
        ...
        {
            return this.Equals(input as GetNextAvailableNonceE403);
        }

        /// <summary>
        /// Returns true if GetNextAvailableNonceE403 instances are equal
        /// </summary>
        /// <param name="input">Instance of GetNextAvailableNonceE403 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetNextAvailableNonceE403 input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for GetNextAvailableNonceE403
    /// </summary>
    public class GetNextAvailableNonceE403JsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(GetNextAvailableNonceE403).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return GetNextAvailableNonceE403.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
