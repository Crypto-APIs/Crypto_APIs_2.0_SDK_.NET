...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40183 : IEquatable<InlineResponse40183>, IValidatableObject
    {
        ...
        public InlineResponse40183(string apiVersion = default(string), string requestId = default(string), string context = default(string), ValidateAddressE401 error = default(ValidateAddressE401))
        {
