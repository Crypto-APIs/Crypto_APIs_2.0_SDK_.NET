...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40183
    /// </summary>
    [DataContract(Name = "inline_response_401_83")]
    public partial class InlineResponse40183 : IEquatable<InlineResponse40183>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40183" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40183() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40183" /> class.
        /// </summary>
        ...
        public InlineResponse40183(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetAddressDetailsFromCallbackE401 error = default(GetAddressDetailsFromCallbackE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40183 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40183 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40183 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40183 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40183);
        }

        /// <summary>
        /// Returns true if InlineResponse40183 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40183 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40183 input)
        {
            if (input == null)
            {
                return false;
