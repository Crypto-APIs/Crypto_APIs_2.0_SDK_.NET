...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetWalletTransactionDetailsByTransactionIDRIBSB_vin_inner")]
    public partial class GetWalletTransactionDetailsByTransactionIDRIBSBVinInner : IEquatable<GetWalletTransactionDetailsByTransactionIDRIBSBVinInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWalletTransactionDetailsByTransactionIDRIBSBVinInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetWalletTransactionDetailsByTransactionIDRIBSBVinInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWalletTransactionDetailsByTransactionIDRIBSBVinInner" /> class.
        /// </summary>
        ...
        public GetWalletTransactionDetailsByTransactionIDRIBSBVinInner(List<string> addresses = default(List<string>), string coinbase = default(string), GetWalletTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig scriptSig = default(GetWalletTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig), long sequence = default(long), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            if (addresses == null)
            {
                throw new ArgumentNullException("addresses is a required property for GetWalletTransactionDetailsByTransactionIDRIBSBVinInner and cannot be null");
            }
            this.Addresses = addresses;
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null)
            {
                throw new ArgumentNullException("scriptSig is a required property for GetWalletTransactionDetailsByTransactionIDRIBSBVinInner and cannot be null");
            }
            ...
            if (txid == null)
            {
                throw new ArgumentNullException("txid is a required property for GetWalletTransactionDetailsByTransactionIDRIBSBVinInner and cannot be null");
            }
            this.Txid = txid;
            this.Vout = vout;
        ...
        public GetWalletTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig ScriptSig { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetWalletTransactionDetailsByTransactionIDRIBSBVinInner {\n");
        ...
        {
            return this.Equals(input as GetWalletTransactionDetailsByTransactionIDRIBSBVinInner);
        }

        /// <summary>
        /// Returns true if GetWalletTransactionDetailsByTransactionIDRIBSBVinInner instances are equal
        /// </summary>
        /// <param name="input">Instance of GetWalletTransactionDetailsByTransactionIDRIBSBVinInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetWalletTransactionDetailsByTransactionIDRIBSBVinInner input)
        {
            if (input == null)
            {
                return false;
