...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Decode_X_Address_400_response")]
    public partial class DecodeXAddress400Response : IEquatable<DecodeXAddress400Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeXAddress400Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DecodeXAddress400Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeXAddress400Response" /> class.
        /// </summary>
        ...
        public DecodeXAddress400Response(string apiVersion = default(string), string requestId = default(string), string context = default(string), DecodeXAddressE400 error = default(DecodeXAddressE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for DecodeXAddress400Response and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for DecodeXAddress400Response and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for DecodeXAddress400Response and cannot be null");
            }
            this.Error = error;
        ...
        public DecodeXAddressE400 Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DecodeXAddress400Response {\n");
        ...
        {
            return this.Equals(input as DecodeXAddress400Response);
        }

        /// <summary>
        /// Returns true if DecodeXAddress400Response instances are equal
        /// </summary>
        /// <param name="input">Instance of DecodeXAddress400Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecodeXAddress400Response input)
        {
            if (input == null)
            {
                return false;
