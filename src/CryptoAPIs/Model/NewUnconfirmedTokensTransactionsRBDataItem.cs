...
namespace CryptoAPIs.Model
{
    ...
    public partial class NewUnconfirmedTokensTransactionsRBDataItem : IEquatable<NewUnconfirmedTokensTransactionsRBDataItem>, IValidatableObject
    {
        ...
        public NewUnconfirmedTokensTransactionsRBDataItem(string address = default(string), bool allowDuplicates = false, string callbackSecretKey = default(string), string callbackUrl = default(string))
        {
            ...
            this.Address = address ?? throw new ArgumentNullException("address is a required property for NewUnconfirmedTokensTransactionsRBDataItem and cannot be null");
            // to ensure "callbackUrl" is required (not null)
            this.CallbackUrl = callbackUrl ?? throw new ArgumentNullException("callbackUrl is a required property for NewUnconfirmedTokensTransactionsRBDataItem and cannot be null");
