...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListTransactionsByBlockHashRIBSBC_vin_inner")]
    public partial class ListTransactionsByBlockHashRIBSBCVinInner : IEquatable<ListTransactionsByBlockHashRIBSBCVinInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashRIBSBCVinInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByBlockHashRIBSBCVinInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashRIBSBCVinInner" /> class.
        /// </summary>
        ...
        public ListTransactionsByBlockHashRIBSBCVinInner(List<string> addresses = default(List<string>), string coinbase = default(string), GetTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig scriptSig = default(GetTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig), string sequence = default(string), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            if (addresses == null)
            {
                throw new ArgumentNullException("addresses is a required property for ListTransactionsByBlockHashRIBSBCVinInner and cannot be null");
            }
            this.Addresses = addresses;
            // to ensure "coinbase" is required (not null)
            if (coinbase == null)
            {
                throw new ArgumentNullException("coinbase is a required property for ListTransactionsByBlockHashRIBSBCVinInner and cannot be null");
            }
            this.Coinbase = coinbase;
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null)
            {
                throw new ArgumentNullException("scriptSig is a required property for ListTransactionsByBlockHashRIBSBCVinInner and cannot be null");
            }
            this.ScriptSig = scriptSig;
            // to ensure "sequence" is required (not null)
            if (sequence == null)
            {
                throw new ArgumentNullException("sequence is a required property for ListTransactionsByBlockHashRIBSBCVinInner and cannot be null");
            }
            this.Sequence = sequence;
            // to ensure "txid" is required (not null)
            if (txid == null)
            {
                throw new ArgumentNullException("txid is a required property for ListTransactionsByBlockHashRIBSBCVinInner and cannot be null");
            }
            this.Txid = txid;
            // to ensure "txinwitness" is required (not null)
            if (txinwitness == null)
            {
                throw new ArgumentNullException("txinwitness is a required property for ListTransactionsByBlockHashRIBSBCVinInner and cannot be null");
            }
            this.Txinwitness = txinwitness;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for ListTransactionsByBlockHashRIBSBCVinInner and cannot be null");
            }
            this.Value = value;
            this.Vout = vout;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListTransactionsByBlockHashRIBSBCVinInner {\n");
        ...
        {
            return this.Equals(input as ListTransactionsByBlockHashRIBSBCVinInner);
        }

        /// <summary>
        /// Returns true if ListTransactionsByBlockHashRIBSBCVinInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByBlockHashRIBSBCVinInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByBlockHashRIBSBCVinInner input)
        {
            if (input == null)
            {
                return false;
