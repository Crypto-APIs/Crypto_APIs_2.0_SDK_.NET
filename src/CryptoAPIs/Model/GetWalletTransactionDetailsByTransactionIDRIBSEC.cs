...
namespace CryptoAPIs.Model
{
    ...
    /// Ethereum Classic
    /// </summary>
    [DataContract(Name = "GetWalletTransactionDetailsByTransactionIDRIBSEC")]
    public partial class GetWalletTransactionDetailsByTransactionIDRIBSEC : IEquatable<GetWalletTransactionDetailsByTransactionIDRIBSEC>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWalletTransactionDetailsByTransactionIDRIBSEC" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetWalletTransactionDetailsByTransactionIDRIBSEC() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWalletTransactionDetailsByTransactionIDRIBSEC" /> class.
        /// </summary>
        ...
        public GetWalletTransactionDetailsByTransactionIDRIBSEC(string contract = default(string), string gasLimit = default(string), GetTransactionDetailsByTransactionIDRIBSECGasPrice gasPrice = default(GetTransactionDetailsByTransactionIDRIBSECGasPrice), string gasUsed = default(string), string inputData = default(string), int nonce = default(int))
        {
            // to ensure "contract" is required (not null)
            if (contract == null)
            {
                throw new ArgumentNullException("contract is a required property for GetWalletTransactionDetailsByTransactionIDRIBSEC and cannot be null");
            }
            this.Contract = contract;
            // to ensure "gasLimit" is required (not null)
            if (gasLimit == null)
            {
                throw new ArgumentNullException("gasLimit is a required property for GetWalletTransactionDetailsByTransactionIDRIBSEC and cannot be null");
            }
            this.GasLimit = gasLimit;
            // to ensure "gasPrice" is required (not null)
            if (gasPrice == null)
            {
                throw new ArgumentNullException("gasPrice is a required property for GetWalletTransactionDetailsByTransactionIDRIBSEC and cannot be null");
            }
            this.GasPrice = gasPrice;
            // to ensure "gasUsed" is required (not null)
            if (gasUsed == null)
            {
                throw new ArgumentNullException("gasUsed is a required property for GetWalletTransactionDetailsByTransactionIDRIBSEC and cannot be null");
            }
            this.GasUsed = gasUsed;
            // to ensure "inputData" is required (not null)
            if (inputData == null)
            {
                throw new ArgumentNullException("inputData is a required property for GetWalletTransactionDetailsByTransactionIDRIBSEC and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetWalletTransactionDetailsByTransactionIDRIBSEC {\n");
        ...
        {
            return this.Equals(input as GetWalletTransactionDetailsByTransactionIDRIBSEC);
        }

        /// <summary>
        /// Returns true if GetWalletTransactionDetailsByTransactionIDRIBSEC instances are equal
        /// </summary>
        /// <param name="input">Instance of GetWalletTransactionDetailsByTransactionIDRIBSEC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetWalletTransactionDetailsByTransactionIDRIBSEC input)
        {
            if (input == null)
            {
                return false;
