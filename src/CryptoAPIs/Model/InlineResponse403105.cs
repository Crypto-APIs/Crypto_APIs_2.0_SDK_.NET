...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_403_105")]
    public partial class InlineResponse403105 : IEquatable<InlineResponse403105>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse403105" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse403105() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse403105" /> class.
        /// </summary>
        ...
        public InlineResponse403105(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListSupportedAssetsE403 error = default(ListSupportedAssetsE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse403105 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse403105 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse403105 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse403105 {\n");
        ...
        {
            return this.Equals(input as InlineResponse403105);
        }

        /// <summary>
        /// Returns true if InlineResponse403105 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse403105 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse403105 input)
        {
            if (input == null)
            {
                return false;
