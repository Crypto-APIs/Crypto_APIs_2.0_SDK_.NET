...
namespace CryptoAPIs.Model
{
    ...
    /// Litecoin
    /// </summary>
    [DataContract(Name = "ListTransactionsByBlockHashRIBSL")]
    public partial class ListTransactionsByBlockHashRIBSL : IEquatable<ListTransactionsByBlockHashRIBSL>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashRIBSL" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByBlockHashRIBSL() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashRIBSL" /> class.
        /// </summary>
        ...
        public ListTransactionsByBlockHashRIBSL(long locktime = default(long), int size = default(int), int vSize = default(int), int version = default(int), List<ListTransactionsByBlockHashRIBSLVinInner> vin = default(List<ListTransactionsByBlockHashRIBSLVinInner>), List<ListTransactionsByBlockHashRIBSLVoutInner> vout = default(List<ListTransactionsByBlockHashRIBSLVoutInner>))
        {
        ...
        public List<ListTransactionsByBlockHashRIBSLVinInner> Vin { get; set; }
        ...
        public List<ListTransactionsByBlockHashRIBSLVoutInner> Vout { get; set; }
        ...
        {
            return this.Equals(input as ListTransactionsByBlockHashRIBSL);
        }

        /// <summary>
        /// Returns true if ListTransactionsByBlockHashRIBSL instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByBlockHashRIBSL to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByBlockHashRIBSL input)
        {
            if (input == null)
            {
                return false;
