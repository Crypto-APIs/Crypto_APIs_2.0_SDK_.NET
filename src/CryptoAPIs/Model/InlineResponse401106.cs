...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_401_106")]
    public partial class InlineResponse401106 : IEquatable<InlineResponse401106>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse401106" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse401106() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse401106" /> class.
        /// </summary>
        ...
        public InlineResponse401106(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetExchangeRateByAssetSymbolsE401 error = default(GetExchangeRateByAssetSymbolsE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse401106 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse401106 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse401106 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse401106 {\n");
        ...
        {
            return this.Equals(input as InlineResponse401106);
        }

        /// <summary>
        /// Returns true if InlineResponse401106 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse401106 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse401106 input)
        {
            if (input == null)
            {
                return false;
