...
namespace CryptoAPIs.Model
{
    ...
    /// Ethereum
    /// </summary>
    [DataContract(Name = "ListLatestMinedBlocksRIBSE")]
    public partial class ListLatestMinedBlocksRIBSE : IEquatable<ListLatestMinedBlocksRIBSE>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListLatestMinedBlocksRIBSE" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListLatestMinedBlocksRIBSE() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListLatestMinedBlocksRIBSE" /> class.
        /// </summary>
        ...
        public ListLatestMinedBlocksRIBSE(string difficulty = default(string), string extraData = default(string), string gasLimit = default(string), string gasUsed = default(string), int minedInSeconds = default(int), string sha3Uncles = default(string), List<string> uncles = default(List<string>))
        {
            ...
            if (difficulty == null) {
                throw new ArgumentNullException("difficulty is a required property for ListLatestMinedBlocksRIBSE and cannot be null");
            }
            this.Difficulty = difficulty;
            // to ensure "extraData" is required (not null)
            if (extraData == null) {
                throw new ArgumentNullException("extraData is a required property for ListLatestMinedBlocksRIBSE and cannot be null");
            }
            this.ExtraData = extraData;
            // to ensure "gasLimit" is required (not null)
            if (gasLimit == null) {
                throw new ArgumentNullException("gasLimit is a required property for ListLatestMinedBlocksRIBSE and cannot be null");
            }
            this.GasLimit = gasLimit;
            // to ensure "gasUsed" is required (not null)
            if (gasUsed == null) {
                throw new ArgumentNullException("gasUsed is a required property for ListLatestMinedBlocksRIBSE and cannot be null");
            }
        ...
        {
            return this.Equals(input as ListLatestMinedBlocksRIBSE);
        }

        /// <summary>
        /// Returns true if ListLatestMinedBlocksRIBSE instances are equal
        /// </summary>
        /// <param name="input">Instance of ListLatestMinedBlocksRIBSE to be compared</param>
        /// <returns>Boolean</returns>
