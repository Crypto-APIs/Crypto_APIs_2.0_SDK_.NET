...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_400_110")]
    public partial class InlineResponse400110 : IEquatable<InlineResponse400110>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse400110" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse400110() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse400110" /> class.
        /// </summary>
        ...
        public InlineResponse400110(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetAssetDetailsByAssetSymbolE400 error = default(GetAssetDetailsByAssetSymbolE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse400110 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse400110 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse400110 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse400110 {\n");
        ...
        {
            return this.Equals(input as InlineResponse400110);
        }

        /// <summary>
        /// Returns true if InlineResponse400110 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse400110 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse400110 input)
        {
            if (input == null)
            {
                return false;
