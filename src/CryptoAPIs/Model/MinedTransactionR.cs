...
namespace CryptoAPIs.Model
{
    ...
    /// MinedTransactionR
    /// </summary>
    [DataContract(Name = "MinedTransactionR")]
    public partial class MinedTransactionR : IEquatable<MinedTransactionR>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MinedTransactionR" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MinedTransactionR() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MinedTransactionR" /> class.
        /// </summary>
        ...
        public MinedTransactionR(string apiVersion = default(string), string requestId = default(string), string context = default(string), MinedTransactionRData data = default(MinedTransactionRData))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for MinedTransactionR and cannot be null");
            // to ensure "requestId" is required (not null)
            this.RequestId = requestId ?? throw new ArgumentNullException("requestId is a required property for MinedTransactionR and cannot be null");
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for MinedTransactionR and cannot be null");
        ...
        public MinedTransactionRData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MinedTransactionR {\n");
        ...
        {
            return this.Equals(input as MinedTransactionR);
        }

        /// <summary>
        /// Returns true if MinedTransactionR instances are equal
        /// </summary>
        /// <param name="input">Instance of MinedTransactionR to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MinedTransactionR input)
        {
            if (input == null)
                return false;
