...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40036 : IEquatable<InlineResponse40036>, IValidatableObject
    {
        ...
        public InlineResponse40036(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetWalletAssetDetailsE400 error = default(GetWalletAssetDetailsE400))
        {
