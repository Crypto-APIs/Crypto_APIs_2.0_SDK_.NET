...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40036
    /// </summary>
    [DataContract(Name = "inline_response_400_36")]
    public partial class InlineResponse40036 : IEquatable<InlineResponse40036>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40036" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40036() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40036" /> class.
        /// </summary>
        ...
        public InlineResponse40036(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateFungibleTokensTransactionRequestFromAddressE400 error = default(CreateFungibleTokensTransactionRequestFromAddressE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40036 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40036 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40036 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40036 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40036);
        }

        /// <summary>
        /// Returns true if InlineResponse40036 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40036 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40036 input)
        {
            if (input == null)
            {
                return false;
