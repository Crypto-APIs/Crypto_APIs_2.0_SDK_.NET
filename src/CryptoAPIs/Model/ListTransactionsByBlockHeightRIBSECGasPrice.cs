...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListTransactionsByBlockHeightRIBSECGasPrice : IEquatable<ListTransactionsByBlockHeightRIBSECGasPrice>, IValidatableObject
    {
        ...
        public ListTransactionsByBlockHeightRIBSECGasPrice(string amount = default(string), string unit = default(string))
        {
            ...
            if (amount == null) {
                throw new ArgumentNullException("amount is a required property for ListTransactionsByBlockHeightRIBSECGasPrice and cannot be null");
            }
            this.Amount = amount;
            // to ensure "unit" is required (not null)
            if (unit == null) {
                throw new ArgumentNullException("unit is a required property for ListTransactionsByBlockHeightRIBSECGasPrice and cannot be null");
            }
            this.Unit = unit;
        }
