...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4007
    /// </summary>
    [DataContract(Name = "inline_response_400_7")]
    public partial class InlineResponse4007 : IEquatable<InlineResponse4007>, IValidatableObject
    {
        ...
        public InlineResponse4007(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListDepositAddressesE400 error = default(ListDepositAddressesE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4007 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4007 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse4007 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse4007);
        }

        /// <summary>
        /// Returns true if InlineResponse4007 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4007 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4007 input)
        {
            if (input == null)
            {
                return false;
