...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40089
    /// </summary>
    [DataContract(Name = "inline_response_400_89")]
    public partial class InlineResponse40089 : IEquatable<InlineResponse40089>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40089" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40089() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40089" /> class.
        /// </summary>
        ...
        public InlineResponse40089(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListCoinsForwardingAutomationsE400 error = default(ListCoinsForwardingAutomationsE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40089 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40089 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40089 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40089 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40089);
        }

        /// <summary>
        /// Returns true if InlineResponse40089 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40089 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40089 input)
        {
            if (input == null)
            {
                return false;
