...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40089 : IEquatable<InlineResponse40089>, IValidatableObject
    {
        ...
        public InlineResponse40089(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListAssetsDetailsE400 error = default(ListAssetsDetailsE400))
        {
