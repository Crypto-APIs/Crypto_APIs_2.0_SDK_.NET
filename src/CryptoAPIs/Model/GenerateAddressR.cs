...
namespace CryptoAPIs.Model
{
    ...
    /// GenerateAddressR
    /// </summary>
    [DataContract(Name = "GenerateAddressR")]
    public partial class GenerateAddressR : IEquatable<GenerateAddressR>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateAddressR" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GenerateAddressR() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateAddressR" /> class.
        /// </summary>
        ...
        public GenerateAddressR(string apiVersion = default(string), string requestId = default(string), string context = default(string), GenerateAddressRData data = default(GenerateAddressRData))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for GenerateAddressR and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for GenerateAddressR and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for GenerateAddressR and cannot be null");
            }
            this.Data = data;
        ...
        public GenerateAddressRData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GenerateAddressR {\n");
        ...
        {
            return this.Equals(input as GenerateAddressR);
        }

        /// <summary>
        /// Returns true if GenerateAddressR instances are equal
        /// </summary>
        /// <param name="input">Instance of GenerateAddressR to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenerateAddressR input)
        {
            if (input == null)
                return false;
