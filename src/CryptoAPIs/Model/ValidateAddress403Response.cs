...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Validate_Address_403_response")]
    public partial class ValidateAddress403Response : IEquatable<ValidateAddress403Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidateAddress403Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ValidateAddress403Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidateAddress403Response" /> class.
        /// </summary>
        ...
        public ValidateAddress403Response(string apiVersion = default(string), string requestId = default(string), string context = default(string), ValidateAddressE403 error = default(ValidateAddressE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for ValidateAddress403Response and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for ValidateAddress403Response and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for ValidateAddress403Response and cannot be null");
            }
            this.Error = error;
        ...
        public ValidateAddressE403 Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ValidateAddress403Response {\n");
        ...
        {
            return this.Equals(input as ValidateAddress403Response);
        }

        /// <summary>
        /// Returns true if ValidateAddress403Response instances are equal
        /// </summary>
        /// <param name="input">Instance of ValidateAddress403Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValidateAddress403Response input)
        {
            if (input == null)
            {
                return false;
