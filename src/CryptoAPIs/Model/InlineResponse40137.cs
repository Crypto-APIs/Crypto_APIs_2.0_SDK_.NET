...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40137
    /// </summary>
    [DataContract(Name = "inline_response_401_37")]
    public partial class InlineResponse40137 : IEquatable<InlineResponse40137>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40137" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40137() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40137" /> class.
        /// </summary>
        ...
        public InlineResponse40137(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateFungibleTokensTransactionRequestFromAddressE401 error = default(CreateFungibleTokensTransactionRequestFromAddressE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40137 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40137 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40137 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40137 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40137);
        }

        /// <summary>
        /// Returns true if InlineResponse40137 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40137 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40137 input)
        {
            if (input == null)
            {
                return false;
