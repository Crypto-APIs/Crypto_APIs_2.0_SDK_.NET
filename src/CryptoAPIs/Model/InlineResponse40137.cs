...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40137 : IEquatable<InlineResponse40137>, IValidatableObject
    {
        ...
        public InlineResponse40137(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetLastMinedBlockE401 error = default(GetLastMinedBlockE401))
        {
