...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListLatestMinedBlocksRIBS : AbstractOpenAPISchema, IEquatable<ListLatestMinedBlocksRIBS>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListLatestMinedBlocksRIBS" /> class
        /// with the <see cref="ListLatestMinedBlocksRIBSX" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of ListLatestMinedBlocksRIBSX.</param>
        public ListLatestMinedBlocksRIBS(ListLatestMinedBlocksRIBSX actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                ...
                else if (value.GetType() == typeof(ListLatestMinedBlocksRIBSX))
                {
                    this._actualInstance = value;
                }
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: ListLatestMinedBlocksRIBSB, ListLatestMinedBlocksRIBSBC, ListLatestMinedBlocksRIBSBSC, ListLatestMinedBlocksRIBSD, ListLatestMinedBlocksRIBSD2, ListLatestMinedBlocksRIBSEC, ListLatestMinedBlocksRIBSL, ListLatestMinedBlocksRIBSX, ListLatestMinedBlocksRIBSZ, ListLatestMinedBlocksRIBSZ2");
                }
            }
        }
        ...
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of ListLatestMinedBlocksRIBSX</returns>
        public ListLatestMinedBlocksRIBSX GetListLatestMinedBlocksRIBSX()
        {
            return (ListLatestMinedBlocksRIBSX)this.ActualInstance;
        }
        ...
        public static ListLatestMinedBlocksRIBS FromJson(string jsonString)
        {
            ...
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(ListLatestMinedBlocksRIBSX).GetProperty("AdditionalProperties") == null)
                {
                    newListLatestMinedBlocksRIBS = new ListLatestMinedBlocksRIBS(JsonConvert.DeserializeObject<ListLatestMinedBlocksRIBSX>(jsonString, ListLatestMinedBlocksRIBS.SerializerSettings));
                }
                else
                {
                    newListLatestMinedBlocksRIBS = new ListLatestMinedBlocksRIBS(JsonConvert.DeserializeObject<ListLatestMinedBlocksRIBSX>(jsonString, ListLatestMinedBlocksRIBS.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("ListLatestMinedBlocksRIBSX");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into ListLatestMinedBlocksRIBSX: {1}", jsonString, exception.ToString()));
            }
