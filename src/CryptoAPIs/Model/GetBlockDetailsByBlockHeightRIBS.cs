...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetBlockDetailsByBlockHeightRIBS : AbstractOpenAPISchema, IEquatable<GetBlockDetailsByBlockHeightRIBS>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHeightRIBS" /> class
        /// with the <see cref="GetBlockDetailsByBlockHeightRIBSZ2" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of GetBlockDetailsByBlockHeightRIBSZ2.</param>
        public GetBlockDetailsByBlockHeightRIBS(GetBlockDetailsByBlockHeightRIBSZ2 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                ...
                else if (value.GetType() == typeof(GetBlockDetailsByBlockHeightRIBSZ2))
                {
                    this._actualInstance = value;
                }
                else
        ...
        /// <summary>
        /// Get the actual instance of `GetBlockDetailsByBlockHeightRIBSZ2`. If the actual instance is not `GetBlockDetailsByBlockHeightRIBSZ2`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of GetBlockDetailsByBlockHeightRIBSZ2</returns>
        public GetBlockDetailsByBlockHeightRIBSZ2 GetGetBlockDetailsByBlockHeightRIBSZ2()
        {
            return (GetBlockDetailsByBlockHeightRIBSZ2)this.ActualInstance;
        }
        ...
        public static GetBlockDetailsByBlockHeightRIBS FromJson(string jsonString)
        {
            ...
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(GetBlockDetailsByBlockHeightRIBSZ2).GetProperty("AdditionalProperties") == null)
                {
                    newGetBlockDetailsByBlockHeightRIBS = new GetBlockDetailsByBlockHeightRIBS(JsonConvert.DeserializeObject<GetBlockDetailsByBlockHeightRIBSZ2>(jsonString, GetBlockDetailsByBlockHeightRIBS.SerializerSettings));
                }
                else
                {
                    newGetBlockDetailsByBlockHeightRIBS = new GetBlockDetailsByBlockHeightRIBS(JsonConvert.DeserializeObject<GetBlockDetailsByBlockHeightRIBSZ2>(jsonString, GetBlockDetailsByBlockHeightRIBS.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("GetBlockDetailsByBlockHeightRIBSZ2");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into GetBlockDetailsByBlockHeightRIBSZ2: {1}", jsonString, exception.ToString()));
            }
