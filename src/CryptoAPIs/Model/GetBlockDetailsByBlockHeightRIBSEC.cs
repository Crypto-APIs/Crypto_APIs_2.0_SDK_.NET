...
namespace CryptoAPIs.Model
{
    ...
    /// Ethereum Classic
    /// </summary>
    [DataContract(Name = "GetBlockDetailsByBlockHeightRIBSEC")]
    public partial class GetBlockDetailsByBlockHeightRIBSEC : IEquatable<GetBlockDetailsByBlockHeightRIBSEC>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHeightRIBSEC" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetBlockDetailsByBlockHeightRIBSEC() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHeightRIBSEC" /> class.
        /// </summary>
        ...
        public GetBlockDetailsByBlockHeightRIBSEC(string difficulty = default(string), string extraData = default(string), string gasLimit = default(string), string gasUsed = default(string), int minedInSeconds = default(int), string nonce = default(string), string sha3Uncles = default(string), int size = default(int), string totalDifficulty = default(string))
        {
        ...
        {
            return this.Equals(input as GetBlockDetailsByBlockHeightRIBSEC);
        }

        /// <summary>
        /// Returns true if GetBlockDetailsByBlockHeightRIBSEC instances are equal
        /// </summary>
        /// <param name="input">Instance of GetBlockDetailsByBlockHeightRIBSEC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetBlockDetailsByBlockHeightRIBSEC input)
        {
            if (input == null)
            {
                return false;
