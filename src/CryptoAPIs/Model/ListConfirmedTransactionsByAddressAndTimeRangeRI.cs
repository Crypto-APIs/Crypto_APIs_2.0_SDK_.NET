...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListConfirmedTransactionsByAddressAndTimeRangeRI")]
    public partial class ListConfirmedTransactionsByAddressAndTimeRangeRI : IEquatable<ListConfirmedTransactionsByAddressAndTimeRangeRI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressAndTimeRangeRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListConfirmedTransactionsByAddressAndTimeRangeRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressAndTimeRangeRI" /> class.
        /// </summary>
        ...
        public ListConfirmedTransactionsByAddressAndTimeRangeRI(int index = default(int), string minedInBlockHash = default(string), int minedInBlockHeight = default(int), List<GetTransactionDetailsByTransactionIDRIRecipientsInner> recipients = default(List<GetTransactionDetailsByTransactionIDRIRecipientsInner>), List<GetTransactionDetailsByTransactionIDRISendersInner> senders = default(List<GetTransactionDetailsByTransactionIDRISendersInner>), int timestamp = default(int), string transactionHash = default(string), string transactionId = default(string), ListConfirmedTransactionsByAddressRIFee fee = default(ListConfirmedTransactionsByAddressRIFee), ListConfirmedTransactionsByAddressAndTimeRangeRIBS blockchainSpecific = default(ListConfirmedTransactionsByAddressAndTimeRangeRIBS))
        {
            this.Index = index;
            // to ensure "recipients" is required (not null)
            if (recipients == null)
            {
                throw new ArgumentNullException("recipients is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRI and cannot be null");
            }
            this.Recipients = recipients;
            // to ensure "senders" is required (not null)
            if (senders == null)
            {
                throw new ArgumentNullException("senders is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRI and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("transactionHash is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRI and cannot be null");
            }
            this.TransactionHash = transactionHash;
            // to ensure "transactionId" is required (not null)
            if (transactionId == null)
            {
                throw new ArgumentNullException("transactionId is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRI and cannot be null");
            }
            this.TransactionId = transactionId;
            // to ensure "fee" is required (not null)
            if (fee == null)
            {
                throw new ArgumentNullException("fee is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRI and cannot be null");
            }
            this.Fee = fee;
            // to ensure "blockchainSpecific" is required (not null)
            if (blockchainSpecific == null)
            {
                throw new ArgumentNullException("blockchainSpecific is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRI and cannot be null");
            }
        ...
        public ListConfirmedTransactionsByAddressRIFee Fee { get; set; }

        /// <summary>
        /// Gets or Sets BlockchainSpecific
        /// </summary>
        [DataMember(Name = "blockchainSpecific", IsRequired = true, EmitDefaultValue = false)]
        public ListConfirmedTransactionsByAddressAndTimeRangeRIBS BlockchainSpecific { get; set; }
        ...
        {
            return this.Equals(input as ListConfirmedTransactionsByAddressAndTimeRangeRI);
        }

        /// <summary>
        /// Returns true if ListConfirmedTransactionsByAddressAndTimeRangeRI instances are equal
        /// </summary>
        /// <param name="input">Instance of ListConfirmedTransactionsByAddressAndTimeRangeRI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListConfirmedTransactionsByAddressAndTimeRangeRI input)
        {
            if (input == null)
            {
                return false;
