...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListConfirmedTransactionsByAddressAndTimeRangeRI : IEquatable<ListConfirmedTransactionsByAddressAndTimeRangeRI>, IValidatableObject
    {
        ...
        public ListConfirmedTransactionsByAddressAndTimeRangeRI(int index = default(int), string minedInBlockHash = default(string), int minedInBlockHeight = default(int), List<GetTransactionDetailsByTransactionIDRIRecipients> recipients = default(List<GetTransactionDetailsByTransactionIDRIRecipients>), List<GetTransactionDetailsByTransactionIDRISenders> senders = default(List<GetTransactionDetailsByTransactionIDRISenders>), int timestamp = default(int), string transactionHash = default(string), string transactionId = default(string), ListConfirmedTransactionsByAddressRIFee fee = default(ListConfirmedTransactionsByAddressRIFee), ListConfirmedTransactionsByAddressAndTimeRangeRIBS blockchainSpecific = default(ListConfirmedTransactionsByAddressAndTimeRangeRIBS))
        {
            this.Index = index;
