...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetTransactionDetailsByTransactionIDRIBSBScriptPubKey : IEquatable<GetTransactionDetailsByTransactionIDRIBSBScriptPubKey>, IValidatableObject
    {
        ...
        public GetTransactionDetailsByTransactionIDRIBSBScriptPubKey(List<string> addresses = default(List<string>), string asm = default(string), string hex = default(string), int reqSigs = default(int), string type = default(string))
        {
            ...
            this.Addresses = addresses ?? throw new ArgumentNullException("addresses is a required property for GetTransactionDetailsByTransactionIDRIBSBScriptPubKey and cannot be null");
            // to ensure "asm" is required (not null)
            this.Asm = asm ?? throw new ArgumentNullException("asm is a required property for GetTransactionDetailsByTransactionIDRIBSBScriptPubKey and cannot be null");
            // to ensure "hex" is required (not null)
            this.Hex = hex ?? throw new ArgumentNullException("hex is a required property for GetTransactionDetailsByTransactionIDRIBSBScriptPubKey and cannot be null");
            this.ReqSigs = reqSigs;
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for GetTransactionDetailsByTransactionIDRIBSBScriptPubKey and cannot be null");
        }
