...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetBlockDetailsByBlockHeightRIBSD2 : IEquatable<GetBlockDetailsByBlockHeightRIBSD2>, IValidatableObject
    {
        ...
        public GetBlockDetailsByBlockHeightRIBSD2(string difficulty = default(string), int nonce = default(int), int size = default(int), string bits = default(string), string chainwork = default(string), string merkleRoot = default(string), int version = default(int), string versionHex = default(string))
        {
