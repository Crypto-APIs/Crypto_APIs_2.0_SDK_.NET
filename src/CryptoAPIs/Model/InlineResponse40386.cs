...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40386 : IEquatable<InlineResponse40386>, IValidatableObject
    {
        ...
        public InlineResponse40386(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListSupportedAssetsE403 error = default(ListSupportedAssetsE403))
        {
