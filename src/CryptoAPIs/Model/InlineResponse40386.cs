...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40386
    /// </summary>
    [DataContract(Name = "inline_response_403_86")]
    public partial class InlineResponse40386 : IEquatable<InlineResponse40386>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40386" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40386() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40386" /> class.
        /// </summary>
        ...
        public InlineResponse40386(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetBlockDetailsByBlockHeightFromCallbackE403 error = default(GetBlockDetailsByBlockHeightFromCallbackE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40386 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40386 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40386 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40386 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40386);
        }

        /// <summary>
        /// Returns true if InlineResponse40386 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40386 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40386 input)
        {
            if (input == null)
            {
                return false;
