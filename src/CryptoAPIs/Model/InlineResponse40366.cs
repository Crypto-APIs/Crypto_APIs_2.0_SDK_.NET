...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40366 : IEquatable<InlineResponse40366>, IValidatableObject
    {
        ...
        public InlineResponse40366(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListBlockchainEventsSubscriptionsE403 error = default(ListBlockchainEventsSubscriptionsE403))
        {
