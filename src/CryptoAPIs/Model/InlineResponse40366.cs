...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40366
    /// </summary>
    [DataContract(Name = "inline_response_403_66")]
    public partial class InlineResponse40366 : IEquatable<InlineResponse40366>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40366" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40366() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40366" /> class.
        /// </summary>
        ...
        public InlineResponse40366(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListUnconfirmedTokensTransfersByAddressE403 error = default(ListUnconfirmedTokensTransfersByAddressE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40366 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40366 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40366 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40366 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40366);
        }

        /// <summary>
        /// Returns true if InlineResponse40366 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40366 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40366 input)
        {
            if (input == null)
            {
                return false;
