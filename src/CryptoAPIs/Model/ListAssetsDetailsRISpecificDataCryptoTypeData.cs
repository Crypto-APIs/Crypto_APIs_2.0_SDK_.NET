...
namespace CryptoAPIs.Model
{
    ...
    /// Crypto Type Data
    /// </summary>
    [DataContract(Name = "ListAssetsDetailsRISpecificDataCryptoTypeData")]
    public partial class ListAssetsDetailsRISpecificDataCryptoTypeData : IEquatable<ListAssetsDetailsRISpecificDataCryptoTypeData>, IValidatableObject
    {
        ...
        protected ListAssetsDetailsRISpecificDataCryptoTypeData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAssetsDetailsRISpecificDataCryptoTypeData" /> class.
        /// </summary>
        ...
        public ListAssetsDetailsRISpecificDataCryptoTypeData(string _1hourPriceChangeInPercentage = default(string), string _1weekPriceChangeInPercentage = default(string), string _24hoursPriceChangeInPercentage = default(string), string _24hoursTradingVolume = default(string), AssetTypeEnum assetType = default(AssetTypeEnum), string circulatingSupply = default(string), string marketCapInUSD = default(string), string maxSupply = default(string))
        {
            ...
            this._1WeekPriceChangeInPercentage = _1weekPriceChangeInPercentage ?? throw new ArgumentNullException("_1weekPriceChangeInPercentage is a required property for ListAssetsDetailsRISpecificDataCryptoTypeData and cannot be null");
            ...
            this.MarketCapInUSD = marketCapInUSD ?? throw new ArgumentNullException("marketCapInUSD is a required property for ListAssetsDetailsRISpecificDataCryptoTypeData and cannot be null");
            // to ensure "maxSupply" is required (not null)
            this.MaxSupply = maxSupply ?? throw new ArgumentNullException("maxSupply is a required property for ListAssetsDetailsRISpecificDataCryptoTypeData and cannot be null");
        }
        ...
        {
            return this.Equals(input as ListAssetsDetailsRISpecificDataCryptoTypeData);
        }

        /// <summary>
        /// Returns true if ListAssetsDetailsRISpecificDataCryptoTypeData instances are equal
        /// </summary>
        /// <param name="input">Instance of ListAssetsDetailsRISpecificDataCryptoTypeData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListAssetsDetailsRISpecificDataCryptoTypeData input)
        {
            if (input == null)
                return false;
