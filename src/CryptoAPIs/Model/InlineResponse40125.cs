...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40125
    /// </summary>
    [DataContract(Name = "inline_response_401_25")]
    public partial class InlineResponse40125 : IEquatable<InlineResponse40125>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40125" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40125() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40125" /> class.
        /// </summary>
        ...
        public InlineResponse40125(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateCoinsTransactionFromAddressForWholeAmountE401 error = default(CreateCoinsTransactionFromAddressForWholeAmountE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40125 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40125 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40125 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40125 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40125);
        }

        /// <summary>
        /// Returns true if InlineResponse40125 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40125 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40125 input)
        {
            if (input == null)
            {
                return false;
