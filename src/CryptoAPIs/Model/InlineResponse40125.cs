...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40125 : IEquatable<InlineResponse40125>, IValidatableObject
    {
        ...
        public InlineResponse40125(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTransactionsByBlockHeightE401 error = default(ListTransactionsByBlockHeightE401))
        {
