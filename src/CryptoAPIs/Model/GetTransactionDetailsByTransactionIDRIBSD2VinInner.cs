...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetTransactionDetailsByTransactionIDRIBSD2_vin_inner")]
    public partial class GetTransactionDetailsByTransactionIDRIBSD2VinInner : IEquatable<GetTransactionDetailsByTransactionIDRIBSD2VinInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDRIBSD2VinInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetTransactionDetailsByTransactionIDRIBSD2VinInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDRIBSD2VinInner" /> class.
        /// </summary>
        ...
        public GetTransactionDetailsByTransactionIDRIBSD2VinInner(List<string> addresses = default(List<string>), string coinbase = default(string), GetTransactionDetailsByTransactionIDRIBSD2VinInnerScriptSig scriptSig = default(GetTransactionDetailsByTransactionIDRIBSD2VinInnerScriptSig), long sequence = default(long), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            ...
            if (txinwitness == null)
            {
                throw new ArgumentNullException("txinwitness is a required property for GetTransactionDetailsByTransactionIDRIBSD2VinInner and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetTransactionDetailsByTransactionIDRIBSD2VinInner {\n");
        ...
        {
            return this.Equals(input as GetTransactionDetailsByTransactionIDRIBSD2VinInner);
        }

        /// <summary>
        /// Returns true if GetTransactionDetailsByTransactionIDRIBSD2VinInner instances are equal
        /// </summary>
        /// <param name="input">Instance of GetTransactionDetailsByTransactionIDRIBSD2VinInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetTransactionDetailsByTransactionIDRIBSD2VinInner input)
        {
            if (input == null)
            {
                return false;
