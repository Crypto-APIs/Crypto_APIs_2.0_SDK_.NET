...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DecodeRawTransactionHexRISL_vin")]
    public partial class DecodeRawTransactionHexRISLVin : IEquatable<DecodeRawTransactionHexRISLVin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISLVin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DecodeRawTransactionHexRISLVin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISLVin" /> class.
        /// </summary>
        ...
        public DecodeRawTransactionHexRISLVin(string address = default(string), string inputHash = default(string), string outputIndex = default(string), DecodeRawTransactionHexRISLScriptSig scriptSig = default(DecodeRawTransactionHexRISLScriptSig), string sequence = default(string), List<string> txinwitness = default(List<string>))
        {
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null)
            {
                throw new ArgumentNullException("scriptSig is a required property for DecodeRawTransactionHexRISLVin and cannot be null");
            }
        ...
        public DecodeRawTransactionHexRISLScriptSig ScriptSig { get; set; }
        ...
        {
            return this.Equals(input as DecodeRawTransactionHexRISLVin);
        }

        /// <summary>
        /// Returns true if DecodeRawTransactionHexRISLVin instances are equal
        /// </summary>
        /// <param name="input">Instance of DecodeRawTransactionHexRISLVin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecodeRawTransactionHexRISLVin input)
        {
            if (input == null)
            {
                return false;
