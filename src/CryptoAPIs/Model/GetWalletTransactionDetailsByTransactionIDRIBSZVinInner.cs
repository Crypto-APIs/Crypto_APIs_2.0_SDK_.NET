...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetWalletTransactionDetailsByTransactionIDRIBSZ_vin_inner")]
    public partial class GetWalletTransactionDetailsByTransactionIDRIBSZVinInner : IEquatable<GetWalletTransactionDetailsByTransactionIDRIBSZVinInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWalletTransactionDetailsByTransactionIDRIBSZVinInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetWalletTransactionDetailsByTransactionIDRIBSZVinInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWalletTransactionDetailsByTransactionIDRIBSZVinInner" /> class.
        /// </summary>
        ...
        public GetWalletTransactionDetailsByTransactionIDRIBSZVinInner(List<string> addresses = default(List<string>), GetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig scriptSig = default(GetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig), long sequence = default(long), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            if (addresses == null)
            {
                throw new ArgumentNullException("addresses is a required property for GetWalletTransactionDetailsByTransactionIDRIBSZVinInner and cannot be null");
            }
            this.Addresses = addresses;
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null)
            {
                throw new ArgumentNullException("scriptSig is a required property for GetWalletTransactionDetailsByTransactionIDRIBSZVinInner and cannot be null");
            }
            ...
            if (txid == null)
            {
                throw new ArgumentNullException("txid is a required property for GetWalletTransactionDetailsByTransactionIDRIBSZVinInner and cannot be null");
            }
            this.Txid = txid;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for GetWalletTransactionDetailsByTransactionIDRIBSZVinInner and cannot be null");
            }
            this.Value = value;
            this.Vout = vout;
        ...
        {
            return this.Equals(input as GetWalletTransactionDetailsByTransactionIDRIBSZVinInner);
        }

        /// <summary>
        /// Returns true if GetWalletTransactionDetailsByTransactionIDRIBSZVinInner instances are equal
        /// </summary>
        /// <param name="input">Instance of GetWalletTransactionDetailsByTransactionIDRIBSZVinInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetWalletTransactionDetailsByTransactionIDRIBSZVinInner input)
        {
            if (input == null)
            {
                return false;
