...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListAllUnconfirmedTransactionsRIBSD_vin_inner")]
    public partial class ListAllUnconfirmedTransactionsRIBSDVinInner : IEquatable<ListAllUnconfirmedTransactionsRIBSDVinInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllUnconfirmedTransactionsRIBSDVinInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListAllUnconfirmedTransactionsRIBSDVinInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllUnconfirmedTransactionsRIBSDVinInner" /> class.
        /// </summary>
        ...
        public ListAllUnconfirmedTransactionsRIBSDVinInner(List<string> addresses = default(List<string>), ListConfirmedTransactionsByAddressRIBSDVinInnerScriptSig scriptSig = default(ListConfirmedTransactionsByAddressRIBSDVinInnerScriptSig), long sequence = default(long), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            if (addresses == null)
            {
                throw new ArgumentNullException("addresses is a required property for ListAllUnconfirmedTransactionsRIBSDVinInner and cannot be null");
            }
            this.Addresses = addresses;
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null)
            {
                throw new ArgumentNullException("scriptSig is a required property for ListAllUnconfirmedTransactionsRIBSDVinInner and cannot be null");
            }
            ...
            if (txid == null)
            {
                throw new ArgumentNullException("txid is a required property for ListAllUnconfirmedTransactionsRIBSDVinInner and cannot be null");
            }
            this.Txid = txid;
            // to ensure "txinwitness" is required (not null)
            if (txinwitness == null)
            {
                throw new ArgumentNullException("txinwitness is a required property for ListAllUnconfirmedTransactionsRIBSDVinInner and cannot be null");
            }
            this.Txinwitness = txinwitness;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for ListAllUnconfirmedTransactionsRIBSDVinInner and cannot be null");
            }
            this.Value = value;
            this.Vout = vout;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListAllUnconfirmedTransactionsRIBSDVinInner {\n");
        ...
        {
            return this.Equals(input as ListAllUnconfirmedTransactionsRIBSDVinInner);
        }

        /// <summary>
        /// Returns true if ListAllUnconfirmedTransactionsRIBSDVinInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ListAllUnconfirmedTransactionsRIBSDVinInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListAllUnconfirmedTransactionsRIBSDVinInner input)
        {
            if (input == null)
            {
                return false;
