...
namespace CryptoAPIs.Model
{
    ...
    /// Ethereum
    /// </summary>
    [DataContract(Name = "ListTransactionsByBlockHashRIBSE")]
    public partial class ListTransactionsByBlockHashRIBSE : IEquatable<ListTransactionsByBlockHashRIBSE>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashRIBSE" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByBlockHashRIBSE() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashRIBSE" /> class.
        /// </summary>
        ...
        public ListTransactionsByBlockHashRIBSE(string contract = default(string), string gasLimit = default(string), ListTransactionsByBlockHashRIBSEGasPrice gasPrice = default(ListTransactionsByBlockHashRIBSEGasPrice), string gasUsed = default(string), string inputData = default(string), int nonce = default(int), string transactionStatus = default(string))
        {
            // to ensure "contract" is required (not null)
            this.Contract = contract ?? throw new ArgumentNullException("contract is a required property for ListTransactionsByBlockHashRIBSE and cannot be null");
            // to ensure "gasLimit" is required (not null)
            this.GasLimit = gasLimit ?? throw new ArgumentNullException("gasLimit is a required property for ListTransactionsByBlockHashRIBSE and cannot be null");
            // to ensure "gasPrice" is required (not null)
            this.GasPrice = gasPrice ?? throw new ArgumentNullException("gasPrice is a required property for ListTransactionsByBlockHashRIBSE and cannot be null");
            // to ensure "gasUsed" is required (not null)
            this.GasUsed = gasUsed ?? throw new ArgumentNullException("gasUsed is a required property for ListTransactionsByBlockHashRIBSE and cannot be null");
            // to ensure "inputData" is required (not null)
            this.InputData = inputData ?? throw new ArgumentNullException("inputData is a required property for ListTransactionsByBlockHashRIBSE and cannot be null");
            this.Nonce = nonce;
            // to ensure "transactionStatus" is required (not null)
            this.TransactionStatus = transactionStatus ?? throw new ArgumentNullException("transactionStatus is a required property for ListTransactionsByBlockHashRIBSE and cannot be null");
        }
        ...
        public ListTransactionsByBlockHashRIBSEGasPrice GasPrice { get; set; }
        ...
        {
            return this.Equals(input as ListTransactionsByBlockHashRIBSE);
        }

        /// <summary>
        /// Returns true if ListTransactionsByBlockHashRIBSE instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByBlockHashRIBSE to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByBlockHashRIBSE input)
        {
            if (input == null)
                return false;
