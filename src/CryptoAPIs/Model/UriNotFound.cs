...
namespace CryptoAPIs.Model
{
    ...
    /// UriNotFound
    /// </summary>
    [DataContract(Name = "UriNotFound")]
    public partial class UriNotFound : IEquatable<UriNotFound>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UriNotFound" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UriNotFound() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UriNotFound" /> class.
        /// </summary>
        ...
        public UriNotFound(string apiVersion = default(string), string requestId = default(string), string context = default(string), UriNotFoundError error = default(UriNotFoundError))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for UriNotFound and cannot be null");
            // to ensure "requestId" is required (not null)
            this.RequestId = requestId ?? throw new ArgumentNullException("requestId is a required property for UriNotFound and cannot be null");
            // to ensure "error" is required (not null)
            this.Error = error ?? throw new ArgumentNullException("error is a required property for UriNotFound and cannot be null");
        ...
        public UriNotFoundError Error { get; set; }
        ...
        {
            return this.Equals(input as UriNotFound);
        }

        /// <summary>
        /// Returns true if UriNotFound instances are equal
        /// </summary>
        /// <param name="input">Instance of UriNotFound to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UriNotFound input)
        {
            if (input == null)
                return false;
