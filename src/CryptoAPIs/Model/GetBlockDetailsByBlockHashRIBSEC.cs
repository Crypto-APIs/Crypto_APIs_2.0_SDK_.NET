...
namespace CryptoAPIs.Model
{
    ...
    /// Ethereum Classic
    /// </summary>
    [DataContract(Name = "GetBlockDetailsByBlockHashRIBSEC")]
    public partial class GetBlockDetailsByBlockHashRIBSEC : IEquatable<GetBlockDetailsByBlockHashRIBSEC>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHashRIBSEC" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetBlockDetailsByBlockHashRIBSEC() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHashRIBSEC" /> class.
        /// </summary>
        ...
        public GetBlockDetailsByBlockHashRIBSEC(string difficulty = default(string), string nonce = default(string), int size = default(int), string extraData = default(string), string gasLimit = default(string), string gasUsed = default(string), int minedInSeconds = default(int), string sha3Uncles = default(string), string totalDifficulty = default(string), List<string> uncles = default(List<string>))
        {
            // to ensure "difficulty" is required (not null)
            this.Difficulty = difficulty ?? throw new ArgumentNullException("difficulty is a required property for GetBlockDetailsByBlockHashRIBSEC and cannot be null");
            // to ensure "nonce" is required (not null)
            this.Nonce = nonce ?? throw new ArgumentNullException("nonce is a required property for GetBlockDetailsByBlockHashRIBSEC and cannot be null");
            this.Size = size;
            // to ensure "extraData" is required (not null)
            this.ExtraData = extraData ?? throw new ArgumentNullException("extraData is a required property for GetBlockDetailsByBlockHashRIBSEC and cannot be null");
            // to ensure "gasLimit" is required (not null)
            this.GasLimit = gasLimit ?? throw new ArgumentNullException("gasLimit is a required property for GetBlockDetailsByBlockHashRIBSEC and cannot be null");
            // to ensure "gasUsed" is required (not null)
            this.GasUsed = gasUsed ?? throw new ArgumentNullException("gasUsed is a required property for GetBlockDetailsByBlockHashRIBSEC and cannot be null");
            this.MinedInSeconds = minedInSeconds;
            // to ensure "sha3Uncles" is required (not null)
            this.Sha3Uncles = sha3Uncles ?? throw new ArgumentNullException("sha3Uncles is a required property for GetBlockDetailsByBlockHashRIBSEC and cannot be null");
            // to ensure "totalDifficulty" is required (not null)
            this.TotalDifficulty = totalDifficulty ?? throw new ArgumentNullException("totalDifficulty is a required property for GetBlockDetailsByBlockHashRIBSEC and cannot be null");
            // to ensure "uncles" is required (not null)
            this.Uncles = uncles ?? throw new ArgumentNullException("uncles is a required property for GetBlockDetailsByBlockHashRIBSEC and cannot be null");
        }
        ...
        {
            return this.Equals(input as GetBlockDetailsByBlockHashRIBSEC);
        }

        /// <summary>
        /// Returns true if GetBlockDetailsByBlockHashRIBSEC instances are equal
        /// </summary>
        /// <param name="input">Instance of GetBlockDetailsByBlockHashRIBSEC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetBlockDetailsByBlockHashRIBSEC input)
        {
            if (input == null)
                return false;
