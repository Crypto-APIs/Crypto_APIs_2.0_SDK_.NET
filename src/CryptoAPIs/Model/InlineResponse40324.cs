...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40324 : IEquatable<InlineResponse40324>, IValidatableObject
    {
        ...
        public InlineResponse40324(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTransactionsByBlockHeightE403 error = default(ListTransactionsByBlockHeightE403))
        {
