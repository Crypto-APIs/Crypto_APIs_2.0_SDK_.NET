...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40324
    /// </summary>
    [DataContract(Name = "inline_response_403_24")]
    public partial class InlineResponse40324 : IEquatable<InlineResponse40324>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40324" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40324() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40324" /> class.
        /// </summary>
        ...
        public InlineResponse40324(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListXRPRippleTransactionsByBlockHeightE403 error = default(ListXRPRippleTransactionsByBlockHeightE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40324 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40324 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40324 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40324 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40324);
        }

        /// <summary>
        /// Returns true if InlineResponse40324 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40324 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40324 input)
        {
            if (input == null)
            {
                return false;
