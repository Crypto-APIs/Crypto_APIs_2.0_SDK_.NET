...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetLatestMinedBlockRIBSD : IEquatable<GetLatestMinedBlockRIBSD>, IValidatableObject
    {
        ...
        public GetLatestMinedBlockRIBSD(string difficulty = default(string), int nonce = default(int), int size = default(int), string bits = default(string), string chainwork = default(string), string merkleRoot = default(string), int strippedSize = default(int), int version = default(int), int weight = default(int))
        {
