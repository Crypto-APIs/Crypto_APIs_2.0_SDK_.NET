...
namespace CryptoAPIs.Model
{
    ...
    /// Dogecoin
    /// </summary>
    [DataContract(Name = "GetLatestMinedBlockRIBSD")]
    public partial class GetLatestMinedBlockRIBSD : IEquatable<GetLatestMinedBlockRIBSD>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLatestMinedBlockRIBSD" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetLatestMinedBlockRIBSD() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLatestMinedBlockRIBSD" /> class.
        /// </summary>
        ...
        public GetLatestMinedBlockRIBSD(string difficulty = default(string), string nonce = default(string), int size = default(int), string bits = default(string), string chainwork = default(string), string merkleRoot = default(string), int strippedSize = default(int), int version = default(int), int weight = default(int))
        {
            // to ensure "difficulty" is required (not null)
            this.Difficulty = difficulty ?? throw new ArgumentNullException("difficulty is a required property for GetLatestMinedBlockRIBSD and cannot be null");
            // to ensure "nonce" is required (not null)
            this.Nonce = nonce ?? throw new ArgumentNullException("nonce is a required property for GetLatestMinedBlockRIBSD and cannot be null");
            this.Size = size;
            // to ensure "bits" is required (not null)
            this.Bits = bits ?? throw new ArgumentNullException("bits is a required property for GetLatestMinedBlockRIBSD and cannot be null");
            // to ensure "chainwork" is required (not null)
            this.Chainwork = chainwork ?? throw new ArgumentNullException("chainwork is a required property for GetLatestMinedBlockRIBSD and cannot be null");
            // to ensure "merkleRoot" is required (not null)
            this.MerkleRoot = merkleRoot ?? throw new ArgumentNullException("merkleRoot is a required property for GetLatestMinedBlockRIBSD and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetLatestMinedBlockRIBSD {\n");
        ...
        {
            return this.Equals(input as GetLatestMinedBlockRIBSD);
        }

        /// <summary>
        /// Returns true if GetLatestMinedBlockRIBSD instances are equal
        /// </summary>
        /// <param name="input">Instance of GetLatestMinedBlockRIBSD to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetLatestMinedBlockRIBSD input)
        {
            if (input == null)
                return false;
