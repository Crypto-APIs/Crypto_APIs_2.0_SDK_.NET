...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40914
    /// </summary>
    [DataContract(Name = "inline_response_409_14")]
    public partial class InlineResponse40914 : IEquatable<InlineResponse40914>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40914" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40914() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40914" /> class.
        /// </summary>
        ...
        public InlineResponse40914(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedInternalTransactionsE409 error = default(NewConfirmedInternalTransactionsE409))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40914 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40914 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40914 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse40914);
        }

        /// <summary>
        /// Returns true if InlineResponse40914 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40914 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40914 input)
        {
            if (input == null)
            {
                return false;
