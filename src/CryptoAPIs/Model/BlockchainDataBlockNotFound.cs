...
namespace CryptoAPIs.Model
{
    ...
    public partial class BlockchainDataBlockNotFound : IEquatable<BlockchainDataBlockNotFound>, IValidatableObject
    {
        ...
        public BlockchainDataBlockNotFound(string apiVersion = default(string), string requestId = default(string), string context = default(string), BlockchainDataBlockNotFoundError error = default(BlockchainDataBlockNotFoundError))
        {
            ...
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for BlockchainDataBlockNotFound and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for BlockchainDataBlockNotFound and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for BlockchainDataBlockNotFound and cannot be null");
            }
            this.Error = error;
