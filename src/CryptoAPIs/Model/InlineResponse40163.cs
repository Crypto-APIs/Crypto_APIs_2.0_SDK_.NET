...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40163
    /// </summary>
    [DataContract(Name = "inline_response_401_63")]
    public partial class InlineResponse40163 : IEquatable<InlineResponse40163>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40163" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40163() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40163" /> class.
        /// </summary>
        ...
        public InlineResponse40163(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedCoinsTransactionsAndEachConfirmationE401 error = default(NewConfirmedCoinsTransactionsAndEachConfirmationE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40163 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40163 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40163 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40163 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40163);
        }

        /// <summary>
        /// Returns true if InlineResponse40163 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40163 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40163 input)
        {
            if (input == null)
            {
                return false;
