...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40163 : IEquatable<InlineResponse40163>, IValidatableObject
    {
        ...
        public InlineResponse40163(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListInternalTransactionsByAddressAndTimeRangeE401 error = default(ListInternalTransactionsByAddressAndTimeRangeE401))
        {
