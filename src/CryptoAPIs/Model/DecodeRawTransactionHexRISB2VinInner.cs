...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DecodeRawTransactionHexRISB2_vin_inner")]
    public partial class DecodeRawTransactionHexRISB2VinInner : IEquatable<DecodeRawTransactionHexRISB2VinInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISB2VinInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DecodeRawTransactionHexRISB2VinInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISB2VinInner" /> class.
        /// </summary>
        ...
        public DecodeRawTransactionHexRISB2VinInner(string address = default(string), string inputHash = default(string), string outputIndex = default(string), DecodeRawTransactionHexRISBVinInnerScriptSig scriptSig = default(DecodeRawTransactionHexRISBVinInnerScriptSig), string sequence = default(string), List<string> txinwitness = default(List<string>))
        {
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null)
            {
                throw new ArgumentNullException("scriptSig is a required property for DecodeRawTransactionHexRISB2VinInner and cannot be null");
            }
        ...
        {
            return this.Equals(input as DecodeRawTransactionHexRISB2VinInner);
        }

        /// <summary>
        /// Returns true if DecodeRawTransactionHexRISB2VinInner instances are equal
        /// </summary>
        /// <param name="input">Instance of DecodeRawTransactionHexRISB2VinInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecodeRawTransactionHexRISB2VinInner input)
        {
            if (input == null)
            {
                return false;
