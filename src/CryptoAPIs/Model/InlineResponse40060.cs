...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40060
    /// </summary>
    [DataContract(Name = "inline_response_400_60")]
    public partial class InlineResponse40060 : IEquatable<InlineResponse40060>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40060" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40060() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40060" /> class.
        /// </summary>
        ...
        public InlineResponse40060(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTokensTransfersByTransactionHashE400 error = default(ListTokensTransfersByTransactionHashE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40060 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40060 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40060 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40060 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40060);
        }

        /// <summary>
        /// Returns true if InlineResponse40060 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40060 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40060 input)
        {
            if (input == null)
            {
                return false;
