...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40060 : IEquatable<InlineResponse40060>, IValidatableObject
    {
        ...
        public InlineResponse40060(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedCoinsTransactionsE400 error = default(NewConfirmedCoinsTransactionsE400))
        {
