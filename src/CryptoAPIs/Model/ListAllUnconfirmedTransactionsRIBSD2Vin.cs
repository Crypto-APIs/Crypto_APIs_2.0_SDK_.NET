...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListAllUnconfirmedTransactionsRIBSD2_vin")]
    public partial class ListAllUnconfirmedTransactionsRIBSD2Vin : IEquatable<ListAllUnconfirmedTransactionsRIBSD2Vin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllUnconfirmedTransactionsRIBSD2Vin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListAllUnconfirmedTransactionsRIBSD2Vin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllUnconfirmedTransactionsRIBSD2Vin" /> class.
        /// </summary>
        ...
        public ListAllUnconfirmedTransactionsRIBSD2Vin(List<string> addresses = default(List<string>), ListConfirmedTransactionsByAddressRIBSD2ScriptSig scriptSig = default(ListConfirmedTransactionsByAddressRIBSD2ScriptSig), string sequence = default(string), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            if (addresses == null)
            {
                throw new ArgumentNullException("addresses is a required property for ListAllUnconfirmedTransactionsRIBSD2Vin and cannot be null");
            }
            this.Addresses = addresses;
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null)
            {
                throw new ArgumentNullException("scriptSig is a required property for ListAllUnconfirmedTransactionsRIBSD2Vin and cannot be null");
            }
            this.ScriptSig = scriptSig;
            // to ensure "sequence" is required (not null)
            if (sequence == null)
            {
                throw new ArgumentNullException("sequence is a required property for ListAllUnconfirmedTransactionsRIBSD2Vin and cannot be null");
            }
            this.Sequence = sequence;
            // to ensure "txid" is required (not null)
            if (txid == null)
            {
                throw new ArgumentNullException("txid is a required property for ListAllUnconfirmedTransactionsRIBSD2Vin and cannot be null");
            }
            this.Txid = txid;
            // to ensure "txinwitness" is required (not null)
            if (txinwitness == null)
            {
                throw new ArgumentNullException("txinwitness is a required property for ListAllUnconfirmedTransactionsRIBSD2Vin and cannot be null");
            }
            this.Txinwitness = txinwitness;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for ListAllUnconfirmedTransactionsRIBSD2Vin and cannot be null");
            }
            this.Value = value;
            this.Vout = vout;
        }
        ...
        {
            return this.Equals(input as ListAllUnconfirmedTransactionsRIBSD2Vin);
        }

        /// <summary>
        /// Returns true if ListAllUnconfirmedTransactionsRIBSD2Vin instances are equal
        /// </summary>
        /// <param name="input">Instance of ListAllUnconfirmedTransactionsRIBSD2Vin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListAllUnconfirmedTransactionsRIBSD2Vin input)
        {
            if (input == null)
            {
                return false;
