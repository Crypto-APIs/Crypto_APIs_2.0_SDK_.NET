...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListCoinsForwardingAutomationsRI")]
    public partial class ListCoinsForwardingAutomationsRI : IEquatable<ListCoinsForwardingAutomationsRI>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListCoinsForwardingAutomationsRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListCoinsForwardingAutomationsRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListCoinsForwardingAutomationsRI" /> class.
        /// </summary>
        ...
        public ListCoinsForwardingAutomationsRI(string callbackUrl = default(string), int confirmationsCountTrigger = default(int), int createdTimestamp = default(int), FeePriorityEnum feePriority = default(FeePriorityEnum), string fromAddress = default(string), string minimumTransferAmount = default(string), string referenceId = default(string), string toAddress = default(string))
        {
            // to ensure "callbackUrl" is required (not null)
            this.CallbackUrl = callbackUrl ?? throw new ArgumentNullException("callbackUrl is a required property for ListCoinsForwardingAutomationsRI and cannot be null");
            this.ConfirmationsCountTrigger = confirmationsCountTrigger;
            this.CreatedTimestamp = createdTimestamp;
            this.FeePriority = feePriority;
            // to ensure "fromAddress" is required (not null)
            this.FromAddress = fromAddress ?? throw new ArgumentNullException("fromAddress is a required property for ListCoinsForwardingAutomationsRI and cannot be null");
            // to ensure "minimumTransferAmount" is required (not null)
            this.MinimumTransferAmount = minimumTransferAmount ?? throw new ArgumentNullException("minimumTransferAmount is a required property for ListCoinsForwardingAutomationsRI and cannot be null");
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for ListCoinsForwardingAutomationsRI and cannot be null");
            // to ensure "toAddress" is required (not null)
            this.ToAddress = toAddress ?? throw new ArgumentNullException("toAddress is a required property for ListCoinsForwardingAutomationsRI and cannot be null");
        }
        ...
        {
            return this.Equals(input as ListCoinsForwardingAutomationsRI);
        }

        /// <summary>
        /// Returns true if ListCoinsForwardingAutomationsRI instances are equal
        /// </summary>
        /// <param name="input">Instance of ListCoinsForwardingAutomationsRI to be compared</param>
        /// <returns>Boolean</returns>
