...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListCoinsForwardingAutomationsRI : IEquatable<ListCoinsForwardingAutomationsRI>, IValidatableObject
    {
        ...
        public ListCoinsForwardingAutomationsRI(string callbackUrl = default(string), int confirmationsCountTrigger = default(int), int createdTimestamp = default(int), FeePriorityEnum feePriority = default(FeePriorityEnum), string fromAddress = default(string), string minimumTransferAmount = default(string), string referenceId = default(string), string toAddress = default(string))
        {
            ...
            if (callbackUrl == null)
            {
                throw new ArgumentNullException("callbackUrl is a required property for ListCoinsForwardingAutomationsRI and cannot be null");
            }
            ...
            if (fromAddress == null)
            {
                throw new ArgumentNullException("fromAddress is a required property for ListCoinsForwardingAutomationsRI and cannot be null");
            }
            this.FromAddress = fromAddress;
            // to ensure "minimumTransferAmount" is required (not null)
            if (minimumTransferAmount == null)
            {
                throw new ArgumentNullException("minimumTransferAmount is a required property for ListCoinsForwardingAutomationsRI and cannot be null");
            }
            this.MinimumTransferAmount = minimumTransferAmount;
            // to ensure "referenceId" is required (not null)
            if (referenceId == null)
            {
                throw new ArgumentNullException("referenceId is a required property for ListCoinsForwardingAutomationsRI and cannot be null");
            }
            this.ReferenceId = referenceId;
            // to ensure "toAddress" is required (not null)
            if (toAddress == null)
            {
                throw new ArgumentNullException("toAddress is a required property for ListCoinsForwardingAutomationsRI and cannot be null");
            }
