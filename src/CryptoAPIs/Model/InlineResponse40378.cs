...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40378 : IEquatable<InlineResponse40378>, IValidatableObject
    {
        ...
        public InlineResponse40378(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewBlockE403 error = default(NewBlockE403))
        {
