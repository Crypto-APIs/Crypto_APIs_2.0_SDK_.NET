...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListConfirmedTokensTransfersByAddressAndTimeRangeRI")]
    public partial class ListConfirmedTokensTransfersByAddressAndTimeRangeRI : IEquatable<ListConfirmedTokensTransfersByAddressAndTimeRangeRI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTokensTransfersByAddressAndTimeRangeRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListConfirmedTokensTransfersByAddressAndTimeRangeRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTokensTransfersByAddressAndTimeRangeRI" /> class.
        /// </summary>
        ...
        public ListConfirmedTokensTransfersByAddressAndTimeRangeRI(string contractAddress = default(string), long minedInBlockHeight = default(long), string recipientAddress = default(string), string senderAddress = default(string), int tokenDecimals = default(int), string tokenId = default(string), string tokenName = default(string), string tokenSymbol = default(string), string tokenType = default(string), string tokensAmount = default(string), string transactionHash = default(string), int transactionTimestamp = default(int))
        {
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for ListConfirmedTokensTransfersByAddressAndTimeRangeRI and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("recipientAddress is a required property for ListConfirmedTokensTransfersByAddressAndTimeRangeRI and cannot be null");
            }
            this.RecipientAddress = recipientAddress;
            // to ensure "senderAddress" is required (not null)
            if (senderAddress == null)
            {
                throw new ArgumentNullException("senderAddress is a required property for ListConfirmedTokensTransfersByAddressAndTimeRangeRI and cannot be null");
            }
            ...
            if (tokenName == null)
            {
                throw new ArgumentNullException("tokenName is a required property for ListConfirmedTokensTransfersByAddressAndTimeRangeRI and cannot be null");
            }
            this.TokenName = tokenName;
            // to ensure "tokenSymbol" is required (not null)
            if (tokenSymbol == null)
            {
                throw new ArgumentNullException("tokenSymbol is a required property for ListConfirmedTokensTransfersByAddressAndTimeRangeRI and cannot be null");
            }
            this.TokenSymbol = tokenSymbol;
            // to ensure "tokenType" is required (not null)
            if (tokenType == null)
            {
                throw new ArgumentNullException("tokenType is a required property for ListConfirmedTokensTransfersByAddressAndTimeRangeRI and cannot be null");
            }
            this.TokenType = tokenType;
            // to ensure "transactionHash" is required (not null)
            if (transactionHash == null)
            {
                throw new ArgumentNullException("transactionHash is a required property for ListConfirmedTokensTransfersByAddressAndTimeRangeRI and cannot be null");
            }
        ...
        {
            return this.Equals(input as ListConfirmedTokensTransfersByAddressAndTimeRangeRI);
        }

        /// <summary>
        /// Returns true if ListConfirmedTokensTransfersByAddressAndTimeRangeRI instances are equal
        /// </summary>
        /// <param name="input">Instance of ListConfirmedTokensTransfersByAddressAndTimeRangeRI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListConfirmedTokensTransfersByAddressAndTimeRangeRI input)
        {
            if (input == null)
            {
                return false;
