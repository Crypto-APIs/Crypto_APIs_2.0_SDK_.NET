...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListConfirmedTokensTransfersByAddressAndTimeRangeRI : IEquatable<ListConfirmedTokensTransfersByAddressAndTimeRangeRI>, IValidatableObject
    {
        ...
        public ListConfirmedTokensTransfersByAddressAndTimeRangeRI(string contractAddress = default(string), int minedInBlockHeight = default(int), string recipientAddress = default(string), string senderAddress = default(string), int tokenDecimals = default(int), string tokenId = default(string), string tokenName = default(string), string tokenSymbol = default(string), string tokenType = default(string), string tokensAmount = default(string), string transactionHash = default(string), int transactionTimestamp = default(int))
        {
