...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40144 : IEquatable<InlineResponse40144>, IValidatableObject
    {
        ...
        public InlineResponse40144(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetTransactionRequestDetailsE401 error = default(GetTransactionRequestDetailsE401))
        {
