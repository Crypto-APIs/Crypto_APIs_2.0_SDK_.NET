...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40144
    /// </summary>
    [DataContract(Name = "inline_response_401_44")]
    public partial class InlineResponse40144 : IEquatable<InlineResponse40144>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40144" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40144() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40144" /> class.
        /// </summary>
        ...
        public InlineResponse40144(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListOmniTransactionsByBlockHashE401 error = default(ListOmniTransactionsByBlockHashE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40144 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40144 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40144 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40144 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40144);
        }

        /// <summary>
        /// Returns true if InlineResponse40144 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40144 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40144 input)
        {
            if (input == null)
            {
                return false;
