...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetLatestMinedBlockRI")]
    public partial class GetLatestMinedBlockRI : IEquatable<GetLatestMinedBlockRI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLatestMinedBlockRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetLatestMinedBlockRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLatestMinedBlockRI" /> class.
        /// </summary>
        ...
        public GetLatestMinedBlockRI(string hash = default(string), int height = default(int), string previousBlockHash = default(string), int timestamp = default(int), int transactionsCount = default(int), GetLatestMinedBlockRIBS blockchainSpecific = default(GetLatestMinedBlockRIBS))
        {
            // to ensure "hash" is required (not null)
            this.Hash = hash ?? throw new ArgumentNullException("hash is a required property for GetLatestMinedBlockRI and cannot be null");
            this.Height = height;
            // to ensure "previousBlockHash" is required (not null)
            this.PreviousBlockHash = previousBlockHash ?? throw new ArgumentNullException("previousBlockHash is a required property for GetLatestMinedBlockRI and cannot be null");
            this.Timestamp = timestamp;
            this.TransactionsCount = transactionsCount;
            // to ensure "blockchainSpecific" is required (not null)
            this.BlockchainSpecific = blockchainSpecific ?? throw new ArgumentNullException("blockchainSpecific is a required property for GetLatestMinedBlockRI and cannot be null");
        }
        ...
        public GetLatestMinedBlockRIBS BlockchainSpecific { get; set; }
        ...
        {
            return this.Equals(input as GetLatestMinedBlockRI);
        }

        /// <summary>
        /// Returns true if GetLatestMinedBlockRI instances are equal
        /// </summary>
        /// <param name="input">Instance of GetLatestMinedBlockRI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetLatestMinedBlockRI input)
        {
            if (input == null)
                return false;
