...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40031
    /// </summary>
    [DataContract(Name = "inline_response_400_31")]
    public partial class InlineResponse40031 : IEquatable<InlineResponse40031>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40031" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40031() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40031" /> class.
        /// </summary>
        ...
        public InlineResponse40031(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetXRPRippleBlockDetailsByBlockHashE400 error = default(GetXRPRippleBlockDetailsByBlockHashE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40031 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40031 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40031 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40031 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40031);
        }

        /// <summary>
        /// Returns true if InlineResponse40031 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40031 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40031 input)
        {
            if (input == null)
            {
                return false;
