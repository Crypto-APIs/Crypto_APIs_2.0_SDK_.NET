...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40031 : IEquatable<InlineResponse40031>, IValidatableObject
    {
        ...
        public InlineResponse40031(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetBlockDetailsByBlockHashE400 error = default(GetBlockDetailsByBlockHashE400))
        {
