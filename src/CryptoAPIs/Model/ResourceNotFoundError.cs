...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceNotFound_error")]
    public partial class ResourceNotFoundError : IEquatable<ResourceNotFoundError>, IValidatableObject
    {
        ...
        public ResourceNotFoundError(string code = default(string), string message = default(string), List<BannedIpAddressErrorDetails> details = default(List<BannedIpAddressErrorDetails>))
        {
            // to ensure "code" is required (not null)
            this.Code = code ?? throw new ArgumentNullException("code is a required property for ResourceNotFoundError and cannot be null");
            // to ensure "message" is required (not null)
            this.Message = message ?? throw new ArgumentNullException("message is a required property for ResourceNotFoundError and cannot be null");
