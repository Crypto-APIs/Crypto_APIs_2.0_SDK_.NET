...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewConfirmedCoinsTransactionsForSpecificAmountRB_data_item")]
    public partial class NewConfirmedCoinsTransactionsForSpecificAmountRBDataItem : IEquatable<NewConfirmedCoinsTransactionsForSpecificAmountRBDataItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewConfirmedCoinsTransactionsForSpecificAmountRBDataItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewConfirmedCoinsTransactionsForSpecificAmountRBDataItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewConfirmedCoinsTransactionsForSpecificAmountRBDataItem" /> class.
        /// </summary>
        ...
        public NewConfirmedCoinsTransactionsForSpecificAmountRBDataItem(bool allowDuplicates = false, long amountHigherThan = default(long), string callbackSecretKey = default(string), string callbackUrl = default(string))
        {
            this.AmountHigherThan = amountHigherThan;
            // to ensure "callbackUrl" is required (not null)
            if (callbackUrl == null)
            {
                throw new ArgumentNullException("callbackUrl is a required property for NewConfirmedCoinsTransactionsForSpecificAmountRBDataItem and cannot be null");
            }
        ...
        {
            return this.Equals(input as NewConfirmedCoinsTransactionsForSpecificAmountRBDataItem);
        }

        /// <summary>
        /// Returns true if NewConfirmedCoinsTransactionsForSpecificAmountRBDataItem instances are equal
        /// </summary>
        /// <param name="input">Instance of NewConfirmedCoinsTransactionsForSpecificAmountRBDataItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewConfirmedCoinsTransactionsForSpecificAmountRBDataItem input)
        {
            if (input == null)
            {
                return false;
