...
namespace CryptoAPIs.Model
{
    ...
    /// Bitcoin Cash
    /// </summary>
    [DataContract(Name = "ListConfirmedTransactionsByAddressRIBSBC")]
    public partial class ListConfirmedTransactionsByAddressRIBSBC : IEquatable<ListConfirmedTransactionsByAddressRIBSBC>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressRIBSBC" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListConfirmedTransactionsByAddressRIBSBC() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressRIBSBC" /> class.
        /// </summary>
        ...
        public ListConfirmedTransactionsByAddressRIBSBC(int locktime = default(int), int size = default(int), int version = default(int), List<ListConfirmedTransactionsByAddressRIBSBCVin> vin = default(List<ListConfirmedTransactionsByAddressRIBSBCVin>), List<GetTransactionDetailsByTransactionIDRIBSBCVout> vout = default(List<GetTransactionDetailsByTransactionIDRIBSBCVout>))
        {
            ...
            if (vin == null) {
                throw new ArgumentNullException("vin is a required property for ListConfirmedTransactionsByAddressRIBSBC and cannot be null");
            }
            this.Vin = vin;
            this.Vout = vout;
        }
        ...
        {
            return this.Equals(input as ListConfirmedTransactionsByAddressRIBSBC);
        }

        /// <summary>
        /// Returns true if ListConfirmedTransactionsByAddressRIBSBC instances are equal
        /// </summary>
        /// <param name="input">Instance of ListConfirmedTransactionsByAddressRIBSBC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListConfirmedTransactionsByAddressRIBSBC input)
        {
            if (input == null)
            {
                return false;
