...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListLatestMinedBlocksRIBSZ2 : IEquatable<ListLatestMinedBlocksRIBSZ2>, IValidatableObject
    {
        ...
        public ListLatestMinedBlocksRIBSZ2(string bits = default(string), string chainwork = default(string), string merkleroot = default(string), string nonce = default(string), int size = default(int), int version = default(int))
        {
