...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40185 : IEquatable<InlineResponse40185>, IValidatableObject
    {
        ...
        public InlineResponse40185(string apiVersion = default(string), string requestId = default(string), string context = default(string), BroadcastLocallySignedTransactionE401 error = default(BroadcastLocallySignedTransactionE401))
        {
