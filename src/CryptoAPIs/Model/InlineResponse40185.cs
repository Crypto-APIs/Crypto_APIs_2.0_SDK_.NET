...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40185
    /// </summary>
    [DataContract(Name = "inline_response_401_85")]
    public partial class InlineResponse40185 : IEquatable<InlineResponse40185>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40185" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40185() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40185" /> class.
        /// </summary>
        ...
        public InlineResponse40185(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetBlockDetailsByBlockHashFromCallbackE401 error = default(GetBlockDetailsByBlockHashFromCallbackE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40185 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40185 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40185 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40185 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40185);
        }

        /// <summary>
        /// Returns true if InlineResponse40185 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40185 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40185 input)
        {
            if (input == null)
            {
                return false;
