...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40184 : IEquatable<InlineResponse40184>, IValidatableObject
    {
        ...
        public InlineResponse40184(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetEIP1559FeeRecommendationsE401 error = default(GetEIP1559FeeRecommendationsE401))
        {
