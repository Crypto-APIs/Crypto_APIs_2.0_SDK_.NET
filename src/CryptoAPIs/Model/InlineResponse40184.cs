...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40184
    /// </summary>
    [DataContract(Name = "inline_response_401_84")]
    public partial class InlineResponse40184 : IEquatable<InlineResponse40184>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40184" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40184() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40184" /> class.
        /// </summary>
        ...
        public InlineResponse40184(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetTransactionDetailsByTransactionIDFromCallbackE401 error = default(GetTransactionDetailsByTransactionIDFromCallbackE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40184 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40184 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40184 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40184 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40184);
        }

        /// <summary>
        /// Returns true if InlineResponse40184 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40184 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40184 input)
        {
            if (input == null)
            {
                return false;
