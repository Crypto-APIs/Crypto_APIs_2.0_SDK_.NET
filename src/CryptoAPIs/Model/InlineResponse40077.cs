...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40077 : IEquatable<InlineResponse40077>, IValidatableObject
    {
        ...
        public InlineResponse40077(string apiVersion = default(string), string requestId = default(string), string context = default(string), MinedTransactionE400 error = default(MinedTransactionE400))
        {
