...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40077
    /// </summary>
    [DataContract(Name = "inline_response_400_77")]
    public partial class InlineResponse40077 : IEquatable<InlineResponse40077>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40077" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40077() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40077" /> class.
        /// </summary>
        ...
        public InlineResponse40077(string apiVersion = default(string), string requestId = default(string), string context = default(string), DeleteAutomaticCoinsForwardingE400 error = default(DeleteAutomaticCoinsForwardingE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40077 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40077 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40077 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40077 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40077);
        }

        /// <summary>
        /// Returns true if InlineResponse40077 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40077 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40077 input)
        {
            if (input == null)
            {
                return false;
