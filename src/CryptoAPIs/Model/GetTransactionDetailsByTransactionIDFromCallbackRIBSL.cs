...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetTransactionDetailsByTransactionIDFromCallbackRIBSL : IEquatable<GetTransactionDetailsByTransactionIDFromCallbackRIBSL>, IValidatableObject
    {
        ...
        public GetTransactionDetailsByTransactionIDFromCallbackRIBSL(int locktime = default(int), int size = default(int), int vSize = default(int), int version = default(int), List<GetTransactionDetailsByTransactionIDRIBSLVin> vin = default(List<GetTransactionDetailsByTransactionIDRIBSLVin>), List<GetTransactionDetailsByTransactionIDRIBSLVout> vout = default(List<GetTransactionDetailsByTransactionIDRIBSLVout>))
        {
