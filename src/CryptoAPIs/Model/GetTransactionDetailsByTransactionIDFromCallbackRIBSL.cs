...
namespace CryptoAPIs.Model
{
    ...
    /// Litecoin
    /// </summary>
    [DataContract(Name = "GetTransactionDetailsByTransactionIDFromCallbackRIBSL")]
    public partial class GetTransactionDetailsByTransactionIDFromCallbackRIBSL : IEquatable<GetTransactionDetailsByTransactionIDFromCallbackRIBSL>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDFromCallbackRIBSL" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetTransactionDetailsByTransactionIDFromCallbackRIBSL() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDFromCallbackRIBSL" /> class.
        /// </summary>
        ...
        public GetTransactionDetailsByTransactionIDFromCallbackRIBSL(long locktime = default(long), int size = default(int), int vSize = default(int), int version = default(int), List<GetTransactionDetailsByTransactionIDRIBSLVinInner> vin = default(List<GetTransactionDetailsByTransactionIDRIBSLVinInner>), List<GetTransactionDetailsByTransactionIDFromCallbackRIBSLVoutInner> vout = default(List<GetTransactionDetailsByTransactionIDFromCallbackRIBSLVoutInner>))
        {
            ...
            if (vin == null)
            {
                throw new ArgumentNullException("vin is a required property for GetTransactionDetailsByTransactionIDFromCallbackRIBSL and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null)
            {
                throw new ArgumentNullException("vout is a required property for GetTransactionDetailsByTransactionIDFromCallbackRIBSL and cannot be null");
            }
            this.Vout = vout;
        }
        ...
        public List<GetTransactionDetailsByTransactionIDFromCallbackRIBSLVoutInner> Vout { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetTransactionDetailsByTransactionIDFromCallbackRIBSL {\n");
        ...
        {
            return this.Equals(input as GetTransactionDetailsByTransactionIDFromCallbackRIBSL);
        }

        /// <summary>
        /// Returns true if GetTransactionDetailsByTransactionIDFromCallbackRIBSL instances are equal
        /// </summary>
        /// <param name="input">Instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSL to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetTransactionDetailsByTransactionIDFromCallbackRIBSL input)
        {
            if (input == null)
            {
                return false;
