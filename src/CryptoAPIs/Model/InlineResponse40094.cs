...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40094
    /// </summary>
    [DataContract(Name = "inline_response_400_94")]
    public partial class InlineResponse40094 : IEquatable<InlineResponse40094>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40094" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40094() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40094" /> class.
        /// </summary>
        ...
        public InlineResponse40094(string apiVersion = default(string), string requestId = default(string), string context = default(string), AddTokensToExistingFromAddressE400 error = default(AddTokensToExistingFromAddressE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40094 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40094 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40094 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40094 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40094);
        }

        /// <summary>
        /// Returns true if InlineResponse40094 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40094 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40094 input)
        {
            if (input == null)
            {
                return false;
