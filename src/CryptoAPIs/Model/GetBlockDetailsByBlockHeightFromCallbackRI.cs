...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetBlockDetailsByBlockHeightFromCallbackRI")]
    public partial class GetBlockDetailsByBlockHeightFromCallbackRI : IEquatable<GetBlockDetailsByBlockHeightFromCallbackRI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHeightFromCallbackRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetBlockDetailsByBlockHeightFromCallbackRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHeightFromCallbackRI" /> class.
        /// </summary>
        ...
        public GetBlockDetailsByBlockHeightFromCallbackRI(string hash = default(string), int height = default(int), string previousBlockHash = default(string), int timestamp = default(int), int transactionsCount = default(int), GetBlockDetailsByBlockHeightFromCallbackRIBS blockchainSpecific = default(GetBlockDetailsByBlockHeightFromCallbackRIBS))
        {
            // to ensure "hash" is required (not null)
            if (hash == null)
            {
                throw new ArgumentNullException("hash is a required property for GetBlockDetailsByBlockHeightFromCallbackRI and cannot be null");
            }
            this.Hash = hash;
            this.Height = height;
            ...
            {
                throw new ArgumentNullException("previousBlockHash is a required property for GetBlockDetailsByBlockHeightFromCallbackRI and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("blockchainSpecific is a required property for GetBlockDetailsByBlockHeightFromCallbackRI and cannot be null");
            }
        ...
        public GetBlockDetailsByBlockHeightFromCallbackRIBS BlockchainSpecific { get; set; }
        ...
        {
            return this.Equals(input as GetBlockDetailsByBlockHeightFromCallbackRI);
        }

        /// <summary>
        /// Returns true if GetBlockDetailsByBlockHeightFromCallbackRI instances are equal
        /// </summary>
        /// <param name="input">Instance of GetBlockDetailsByBlockHeightFromCallbackRI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetBlockDetailsByBlockHeightFromCallbackRI input)
        {
            if (input == null)
            {
                return false;
