...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransactionRequestApprove")]
    public partial class TransactionRequestApprove : IEquatable<TransactionRequestApprove>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionRequestApprove" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionRequestApprove() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionRequestApprove" /> class.
        /// </summary>
        ...
        public TransactionRequestApprove(string apiVersion = default(string), string referenceId = default(string), string idempotencyKey = default(string), TransactionRequestApproveData data = default(TransactionRequestApproveData))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for TransactionRequestApprove and cannot be null");
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for TransactionRequestApprove and cannot be null");
            // to ensure "idempotencyKey" is required (not null)
            this.IdempotencyKey = idempotencyKey ?? throw new ArgumentNullException("idempotencyKey is a required property for TransactionRequestApprove and cannot be null");
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for TransactionRequestApprove and cannot be null");
        }
        ...
        public TransactionRequestApproveData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionRequestApprove {\n");
        ...
        {
            return this.Equals(input as TransactionRequestApprove);
        }

        /// <summary>
        /// Returns true if TransactionRequestApprove instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionRequestApprove to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionRequestApprove input)
        {
            if (input == null)
                return false;
