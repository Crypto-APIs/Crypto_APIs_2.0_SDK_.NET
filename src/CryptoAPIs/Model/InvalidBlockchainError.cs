...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InvalidBlockchain_error")]
    public partial class InvalidBlockchainError : IEquatable<InvalidBlockchainError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidBlockchainError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvalidBlockchainError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidBlockchainError" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InvalidBlockchainError {\n");
        ...
        {
            return this.Equals(input as InvalidBlockchainError);
        }

        /// <summary>
        /// Returns true if InvalidBlockchainError instances are equal
        /// </summary>
        /// <param name="input">Instance of InvalidBlockchainError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvalidBlockchainError input)
        {
            if (input == null)
                return false;
