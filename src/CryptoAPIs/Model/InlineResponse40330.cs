...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40330 : IEquatable<InlineResponse40330>, IValidatableObject
    {
        ...
        public InlineResponse40330(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetBlockDetailsByBlockHashE403 error = default(GetBlockDetailsByBlockHashE403))
        {
