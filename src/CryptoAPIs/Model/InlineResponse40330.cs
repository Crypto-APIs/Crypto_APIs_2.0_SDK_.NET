...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40330
    /// </summary>
    [DataContract(Name = "inline_response_403_30")]
    public partial class InlineResponse40330 : IEquatable<InlineResponse40330>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40330" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40330() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40330" /> class.
        /// </summary>
        ...
        public InlineResponse40330(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetZilliqaBlockDetailsByBlockHeightE403 error = default(GetZilliqaBlockDetailsByBlockHeightE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40330 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40330 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40330 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40330 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40330);
        }

        /// <summary>
        /// Returns true if InlineResponse40330 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40330 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40330 input)
        {
            if (input == null)
            {
                return false;
