...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40075 : IEquatable<InlineResponse40075>, IValidatableObject
    {
        ...
        public InlineResponse40075(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListCoinsForwardingAutomationsE400 error = default(ListCoinsForwardingAutomationsE400))
        {
