...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40075
    /// </summary>
    [DataContract(Name = "inline_response_400_75")]
    public partial class InlineResponse40075 : IEquatable<InlineResponse40075>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40075" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40075() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40075" /> class.
        /// </summary>
        ...
        public InlineResponse40075(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedTokensTransactionsAndEachConfirmationE400 error = default(NewConfirmedTokensTransactionsAndEachConfirmationE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40075 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40075 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40075 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40075 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40075);
        }

        /// <summary>
        /// Returns true if InlineResponse40075 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40075 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40075 input)
        {
            if (input == null)
            {
                return false;
