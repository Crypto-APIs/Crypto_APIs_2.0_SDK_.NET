...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40192
    /// </summary>
    [DataContract(Name = "inline_response_401_92")]
    public partial class InlineResponse40192 : IEquatable<InlineResponse40192>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40192" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40192() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40192" /> class.
        /// </summary>
        ...
        public InlineResponse40192(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTokensForwardingAutomationsE401 error = default(ListTokensForwardingAutomationsE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40192 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40192 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40192 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40192 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40192);
        }

        /// <summary>
        /// Returns true if InlineResponse40192 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40192 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40192 input)
        {
            if (input == null)
            {
                return false;
