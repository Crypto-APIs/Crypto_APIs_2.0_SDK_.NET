...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40379
    /// </summary>
    [DataContract(Name = "inline_response_403_79")]
    public partial class InlineResponse40379 : IEquatable<InlineResponse40379>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40379" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40379() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40379" /> class.
        /// </summary>
        ...
        public InlineResponse40379(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListBlockchainEventsSubscriptionsE403 error = default(ListBlockchainEventsSubscriptionsE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40379 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40379 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40379 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40379 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40379);
        }

        /// <summary>
        /// Returns true if InlineResponse40379 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40379 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40379 input)
        {
            if (input == null)
            {
                return false;
