...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40379 : IEquatable<InlineResponse40379>, IValidatableObject
    {
        ...
        public InlineResponse40379(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateAutomaticTokensForwardingE403 error = default(CreateAutomaticTokensForwardingE403))
        {
