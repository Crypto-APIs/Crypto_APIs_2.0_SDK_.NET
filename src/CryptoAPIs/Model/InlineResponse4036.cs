...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse4036 : IEquatable<InlineResponse4036>, IValidatableObject
    {
        ...
        public InlineResponse4036(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetXRPRippleTransactionDetailsByTransactionIDE403 error = default(GetXRPRippleTransactionDetailsByTransactionIDE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4036 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4036 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse4036 and cannot be null");
            }
            this.Error = error;
