...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_400_107")]
    public partial class InlineResponse400107 : IEquatable<InlineResponse400107>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse400107" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse400107() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse400107" /> class.
        /// </summary>
        ...
        public InlineResponse400107(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetExchangeRateByAssetsIDsE400 error = default(GetExchangeRateByAssetsIDsE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse400107 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse400107 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse400107 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse400107 {\n");
        ...
        {
            return this.Equals(input as InlineResponse400107);
        }

        /// <summary>
        /// Returns true if InlineResponse400107 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse400107 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse400107 input)
        {
            if (input == null)
            {
                return false;
