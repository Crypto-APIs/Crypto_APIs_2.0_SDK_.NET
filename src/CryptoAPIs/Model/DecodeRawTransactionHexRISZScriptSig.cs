...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DecodeRawTransactionHexRISZ_scriptSig")]
    public partial class DecodeRawTransactionHexRISZScriptSig : IEquatable<DecodeRawTransactionHexRISZScriptSig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISZScriptSig" /> class.
        /// </summary>
        ...
        public DecodeRawTransactionHexRISZScriptSig(string asm = default(string), string hex = default(string), string type = default(string))
        {
            this.Asm = asm;
            this.Hex = hex;
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DecodeRawTransactionHexRISZScriptSig {\n");
        ...
        {
            return this.Equals(input as DecodeRawTransactionHexRISZScriptSig);
        }

        /// <summary>
        /// Returns true if DecodeRawTransactionHexRISZScriptSig instances are equal
        /// </summary>
        /// <param name="input">Instance of DecodeRawTransactionHexRISZScriptSig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecodeRawTransactionHexRISZScriptSig input)
        {
            if (input == null)
            {
                return false;
