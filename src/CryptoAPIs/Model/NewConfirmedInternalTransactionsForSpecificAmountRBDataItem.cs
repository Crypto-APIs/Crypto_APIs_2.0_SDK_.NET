...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewConfirmedInternalTransactionsForSpecificAmountRB_data_item")]
    public partial class NewConfirmedInternalTransactionsForSpecificAmountRBDataItem : IEquatable<NewConfirmedInternalTransactionsForSpecificAmountRBDataItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewConfirmedInternalTransactionsForSpecificAmountRBDataItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewConfirmedInternalTransactionsForSpecificAmountRBDataItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewConfirmedInternalTransactionsForSpecificAmountRBDataItem" /> class.
        /// </summary>
        ...
        public NewConfirmedInternalTransactionsForSpecificAmountRBDataItem(bool allowDuplicates = false, long amountHigherThan = default(long), string callbackSecretKey = default(string), string callbackUrl = default(string))
        {
            this.AmountHigherThan = amountHigherThan;
            // to ensure "callbackUrl" is required (not null)
            if (callbackUrl == null)
            {
                throw new ArgumentNullException("callbackUrl is a required property for NewConfirmedInternalTransactionsForSpecificAmountRBDataItem and cannot be null");
            }
        ...
        {
            return this.Equals(input as NewConfirmedInternalTransactionsForSpecificAmountRBDataItem);
        }

        /// <summary>
        /// Returns true if NewConfirmedInternalTransactionsForSpecificAmountRBDataItem instances are equal
        /// </summary>
        /// <param name="input">Instance of NewConfirmedInternalTransactionsForSpecificAmountRBDataItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewConfirmedInternalTransactionsForSpecificAmountRBDataItem input)
        {
            if (input == null)
            {
                return false;
