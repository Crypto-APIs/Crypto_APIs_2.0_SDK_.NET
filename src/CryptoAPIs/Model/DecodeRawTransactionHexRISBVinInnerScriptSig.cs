...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DecodeRawTransactionHexRISB_vin_inner_scriptSig")]
    public partial class DecodeRawTransactionHexRISBVinInnerScriptSig : IEquatable<DecodeRawTransactionHexRISBVinInnerScriptSig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecodeRawTransactionHexRISBVinInnerScriptSig" /> class.
        /// </summary>
        ...
        public DecodeRawTransactionHexRISBVinInnerScriptSig(string asm = default(string), string hex = default(string), string type = default(string))
        {
            this.Asm = asm;
            this.Hex = hex;
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DecodeRawTransactionHexRISBVinInnerScriptSig {\n");
        ...
        {
            return this.Equals(input as DecodeRawTransactionHexRISBVinInnerScriptSig);
        }

        /// <summary>
        /// Returns true if DecodeRawTransactionHexRISBVinInnerScriptSig instances are equal
        /// </summary>
        /// <param name="input">Instance of DecodeRawTransactionHexRISBVinInnerScriptSig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecodeRawTransactionHexRISBVinInnerScriptSig input)
        {
            if (input == null)
            {
                return false;
