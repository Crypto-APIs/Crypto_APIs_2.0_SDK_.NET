...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListConfirmedTransactionsByAddressRIBSB : IEquatable<ListConfirmedTransactionsByAddressRIBSB>, IValidatableObject
    {
        ...
        public ListConfirmedTransactionsByAddressRIBSB(int locktime = default(int), int size = default(int), int vSize = default(int), int version = default(int), List<ListConfirmedTransactionsByAddressRIBSBVin> vin = default(List<ListConfirmedTransactionsByAddressRIBSBVin>), List<ListConfirmedTransactionsByAddressRIBSBVout> vout = default(List<ListConfirmedTransactionsByAddressRIBSBVout>))
        {
