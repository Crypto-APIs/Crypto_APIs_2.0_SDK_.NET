...
namespace CryptoAPIs.Model
{
    ...
    /// Bitcoin
    /// </summary>
    [DataContract(Name = "ListConfirmedTransactionsByAddressRIBSB")]
    public partial class ListConfirmedTransactionsByAddressRIBSB : IEquatable<ListConfirmedTransactionsByAddressRIBSB>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressRIBSB" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListConfirmedTransactionsByAddressRIBSB() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressRIBSB" /> class.
        /// </summary>
        ...
        public ListConfirmedTransactionsByAddressRIBSB(long locktime = default(long), int size = default(int), int vSize = default(int), int version = default(int), List<ListConfirmedTransactionsByAddressRIBSBVinInner> vin = default(List<ListConfirmedTransactionsByAddressRIBSBVinInner>), List<ListConfirmedTransactionsByAddressRIBSBVoutInner> vout = default(List<ListConfirmedTransactionsByAddressRIBSBVoutInner>))
        {
            ...
            if (vin == null)
            {
                throw new ArgumentNullException("vin is a required property for ListConfirmedTransactionsByAddressRIBSB and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null)
            {
                throw new ArgumentNullException("vout is a required property for ListConfirmedTransactionsByAddressRIBSB and cannot be null");
            }
            this.Vout = vout;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListConfirmedTransactionsByAddressRIBSB {\n");
        ...
        {
            return this.Equals(input as ListConfirmedTransactionsByAddressRIBSB);
        }

        /// <summary>
        /// Returns true if ListConfirmedTransactionsByAddressRIBSB instances are equal
        /// </summary>
        /// <param name="input">Instance of ListConfirmedTransactionsByAddressRIBSB to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListConfirmedTransactionsByAddressRIBSB input)
        {
            if (input == null)
            {
                return false;
