...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40040
    /// </summary>
    [DataContract(Name = "inline_response_400_40")]
    public partial class InlineResponse40040 : IEquatable<InlineResponse40040>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40040" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40040() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40040" /> class.
        /// </summary>
        ...
        public InlineResponse40040(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetLatestMinedZilliqaBlockE400 error = default(GetLatestMinedZilliqaBlockE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40040 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40040 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40040 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40040 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40040);
        }

        /// <summary>
        /// Returns true if InlineResponse40040 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40040 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40040 input)
        {
            if (input == null)
            {
                return false;
