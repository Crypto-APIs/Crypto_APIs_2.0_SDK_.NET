...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40040 : IEquatable<InlineResponse40040>, IValidatableObject
    {
        ...
        public InlineResponse40040(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetLastMinedBlockE400 error = default(GetLastMinedBlockE400))
        {
