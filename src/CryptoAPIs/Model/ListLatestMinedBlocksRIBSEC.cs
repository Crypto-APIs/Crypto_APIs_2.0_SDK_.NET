...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListLatestMinedBlocksRIBSEC : IEquatable<ListLatestMinedBlocksRIBSEC>, IValidatableObject
    {
        ...
        public ListLatestMinedBlocksRIBSEC(string extraData = default(string), string gasLimit = default(string), string gasUsed = default(string), int minedInSeconds = default(int), string sha3Uncles = default(string), string totalDifficulty = default(string), List<string> uncles = default(List<string>))
        {
