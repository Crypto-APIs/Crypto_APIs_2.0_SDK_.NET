...
namespace CryptoAPIs.Model
{
    ...
    /// Zilliqa
    /// </summary>
    [DataContract(Name = "GetBlockDetailsByBlockHashFromCallbackRIBSZ")]
    public partial class GetBlockDetailsByBlockHashFromCallbackRIBSZ : IEquatable<GetBlockDetailsByBlockHashFromCallbackRIBSZ>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHashFromCallbackRIBSZ" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetBlockDetailsByBlockHashFromCallbackRIBSZ() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHashFromCallbackRIBSZ" /> class.
        /// </summary>
        ...
        public GetBlockDetailsByBlockHashFromCallbackRIBSZ(string difficulty = default(string), int dsBlock = default(int), string dsDifficulty = default(string), string dsLeader = default(string), int gasLimit = default(int), int gasUsed = default(int), List<string> microBlocks = default(List<string>))
        {
            // to ensure "difficulty" is required (not null)
            if (difficulty == null)
            {
                throw new ArgumentNullException("difficulty is a required property for GetBlockDetailsByBlockHashFromCallbackRIBSZ and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("dsDifficulty is a required property for GetBlockDetailsByBlockHashFromCallbackRIBSZ and cannot be null");
            }
            this.DsDifficulty = dsDifficulty;
            // to ensure "dsLeader" is required (not null)
            if (dsLeader == null)
            {
                throw new ArgumentNullException("dsLeader is a required property for GetBlockDetailsByBlockHashFromCallbackRIBSZ and cannot be null");
            }
            ...
            if (microBlocks == null)
            {
                throw new ArgumentNullException("microBlocks is a required property for GetBlockDetailsByBlockHashFromCallbackRIBSZ and cannot be null");
            }
        ...
        {
            return this.Equals(input as GetBlockDetailsByBlockHashFromCallbackRIBSZ);
        }

        /// <summary>
        /// Returns true if GetBlockDetailsByBlockHashFromCallbackRIBSZ instances are equal
        /// </summary>
        /// <param name="input">Instance of GetBlockDetailsByBlockHashFromCallbackRIBSZ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetBlockDetailsByBlockHashFromCallbackRIBSZ input)
        {
            if (input == null)
            {
                return false;
