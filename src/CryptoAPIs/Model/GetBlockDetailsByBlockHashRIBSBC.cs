...
namespace CryptoAPIs.Model
{
    ...
    /// Bitcoin Cash
    /// </summary>
    [DataContract(Name = "GetBlockDetailsByBlockHashRIBSBC")]
    public partial class GetBlockDetailsByBlockHashRIBSBC : IEquatable<GetBlockDetailsByBlockHashRIBSBC>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHashRIBSBC" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetBlockDetailsByBlockHashRIBSBC() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHashRIBSBC" /> class.
        /// </summary>
        ...
        public GetBlockDetailsByBlockHashRIBSBC(string difficulty = default(string), string bits = default(string), string chainwork = default(string), string merkleRoot = default(string), string nonce = default(string), int size = default(int), int version = default(int), string versionHex = default(string))
        {
        ...
        {
            return this.Equals(input as GetBlockDetailsByBlockHashRIBSBC);
        }

        /// <summary>
        /// Returns true if GetBlockDetailsByBlockHashRIBSBC instances are equal
        /// </summary>
        /// <param name="input">Instance of GetBlockDetailsByBlockHashRIBSBC to be compared</param>
        /// <returns>Boolean</returns>
