...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40325 : IEquatable<InlineResponse40325>, IValidatableObject
    {
        ...
        public InlineResponse40325(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTransactionsByBlockHeightE403 error = default(ListTransactionsByBlockHeightE403))
        {
