...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40325
    /// </summary>
    [DataContract(Name = "inline_response_403_25")]
    public partial class InlineResponse40325 : IEquatable<InlineResponse40325>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40325" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40325() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40325" /> class.
        /// </summary>
        ...
        public InlineResponse40325(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateCoinsTransactionFromAddressForWholeAmountE403 error = default(CreateCoinsTransactionFromAddressForWholeAmountE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40325 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40325 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40325 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40325 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40325);
        }

        /// <summary>
        /// Returns true if InlineResponse40325 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40325 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40325 input)
        {
            if (input == null)
            {
                return false;
