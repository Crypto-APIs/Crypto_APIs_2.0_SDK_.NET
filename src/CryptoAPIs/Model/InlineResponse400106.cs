...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_400_106")]
    public partial class InlineResponse400106 : IEquatable<InlineResponse400106>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse400106" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse400106() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse400106" /> class.
        /// </summary>
        ...
        public InlineResponse400106(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetExchangeRateByAssetSymbolsE400 error = default(GetExchangeRateByAssetSymbolsE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse400106 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse400106 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse400106 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse400106 {\n");
        ...
        {
            return this.Equals(input as InlineResponse400106);
        }

        /// <summary>
        /// Returns true if InlineResponse400106 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse400106 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse400106 input)
        {
            if (input == null)
            {
                return false;
