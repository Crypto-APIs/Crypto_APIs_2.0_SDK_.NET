...
namespace CryptoAPIs.Model
{
    ...
    /// OMNI
    /// </summary>
    [DataContract(Name = "AddressTokensTransactionConfirmedOmni")]
    public partial class AddressTokensTransactionConfirmedOmni : IEquatable<AddressTokensTransactionConfirmedOmni>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressTokensTransactionConfirmedOmni" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AddressTokensTransactionConfirmedOmni() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressTokensTransactionConfirmedOmni" /> class.
        /// </summary>
        ...
        public AddressTokensTransactionConfirmedOmni(string name = default(string), string propertyId = default(string), string transactionType = default(string), string createdByTransactionId = default(string), string amount = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for AddressTokensTransactionConfirmedOmni and cannot be null");
            }
            this.Name = name;
            // to ensure "propertyId" is required (not null)
            if (propertyId == null) {
                throw new ArgumentNullException("propertyId is a required property for AddressTokensTransactionConfirmedOmni and cannot be null");
            }
            this.PropertyId = propertyId;
            // to ensure "transactionType" is required (not null)
            if (transactionType == null) {
                throw new ArgumentNullException("transactionType is a required property for AddressTokensTransactionConfirmedOmni and cannot be null");
            }
            this.TransactionType = transactionType;
            // to ensure "createdByTransactionId" is required (not null)
            if (createdByTransactionId == null) {
                throw new ArgumentNullException("createdByTransactionId is a required property for AddressTokensTransactionConfirmedOmni and cannot be null");
            }
            this.CreatedByTransactionId = createdByTransactionId;
            // to ensure "amount" is required (not null)
            if (amount == null) {
                throw new ArgumentNullException("amount is a required property for AddressTokensTransactionConfirmedOmni and cannot be null");
            }
            this.Amount = amount;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddressTokensTransactionConfirmedOmni {\n");
        ...
        {
            return this.Equals(input as AddressTokensTransactionConfirmedOmni);
        }

        /// <summary>
        /// Returns true if AddressTokensTransactionConfirmedOmni instances are equal
        /// </summary>
        /// <param name="input">Instance of AddressTokensTransactionConfirmedOmni to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddressTokensTransactionConfirmedOmni input)
        {
            if (input == null)
                return false;
