...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40363 : IEquatable<InlineResponse40363>, IValidatableObject
    {
        ...
        public InlineResponse40363(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListInternalTransactionsByAddressAndTimeRangeE403 error = default(ListInternalTransactionsByAddressAndTimeRangeE403))
        {
