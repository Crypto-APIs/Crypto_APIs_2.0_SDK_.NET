...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListTransactionsByBlockHashRIBSL_vin")]
    public partial class ListTransactionsByBlockHashRIBSLVin : IEquatable<ListTransactionsByBlockHashRIBSLVin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashRIBSLVin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByBlockHashRIBSLVin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashRIBSLVin" /> class.
        /// </summary>
        ...
        public ListTransactionsByBlockHashRIBSLVin(List<string> addresses = default(List<string>), string coinbase = default(string), GetTransactionDetailsByTransactionIDRIBSLScriptSig scriptSig = default(GetTransactionDetailsByTransactionIDRIBSLScriptSig), string sequence = default(string), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            ...
            this.Addresses = addresses ?? throw new ArgumentNullException("addresses is a required property for ListTransactionsByBlockHashRIBSLVin and cannot be null");
            // to ensure "scriptSig" is required (not null)
            this.ScriptSig = scriptSig ?? throw new ArgumentNullException("scriptSig is a required property for ListTransactionsByBlockHashRIBSLVin and cannot be null");
            // to ensure "sequence" is required (not null)
            this.Sequence = sequence ?? throw new ArgumentNullException("sequence is a required property for ListTransactionsByBlockHashRIBSLVin and cannot be null");
            // to ensure "txid" is required (not null)
            this.Txid = txid ?? throw new ArgumentNullException("txid is a required property for ListTransactionsByBlockHashRIBSLVin and cannot be null");
            // to ensure "txinwitness" is required (not null)
            this.Txinwitness = txinwitness ?? throw new ArgumentNullException("txinwitness is a required property for ListTransactionsByBlockHashRIBSLVin and cannot be null");
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for ListTransactionsByBlockHashRIBSLVin and cannot be null");
            this.Vout = vout;
        ...
        {
            return this.Equals(input as ListTransactionsByBlockHashRIBSLVin);
        }

        /// <summary>
        /// Returns true if ListTransactionsByBlockHashRIBSLVin instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByBlockHashRIBSLVin to be compared</param>
        /// <returns>Boolean</returns>
