...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListConfirmedTokensTransfersByAddressRI")]
    public partial class ListConfirmedTokensTransfersByAddressRI : IEquatable<ListConfirmedTokensTransfersByAddressRI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTokensTransfersByAddressRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListConfirmedTokensTransfersByAddressRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTokensTransfersByAddressRI" /> class.
        /// </summary>
        ...
        public ListConfirmedTokensTransfersByAddressRI(string contractAddress = default(string), long minedInBlockHeight = default(long), string recipientAddress = default(string), string senderAddress = default(string), int tokenDecimals = default(int), string tokenId = default(string), string tokenName = default(string), string tokenSymbol = default(string), string tokenType = default(string), string tokensAmount = default(string), string transactionHash = default(string), int transactionTimestamp = default(int), ListTokensTransfersByTransactionHashRITransactionFee transactionFee = default(ListTokensTransfersByTransactionHashRITransactionFee))
        {
        ...
        {
            return this.Equals(input as ListConfirmedTokensTransfersByAddressRI);
        }

        /// <summary>
        /// Returns true if ListConfirmedTokensTransfersByAddressRI instances are equal
        /// </summary>
        /// <param name="input">Instance of ListConfirmedTokensTransfersByAddressRI to be compared</param>
        /// <returns>Boolean</returns>
