...
namespace CryptoAPIs.Model
{
    ...
    /// Binance Smart Chain
    /// </summary>
    [DataContract(Name = "ListUnconfirmedTransactionsByAddressRIBSBSC")]
    public partial class ListUnconfirmedTransactionsByAddressRIBSBSC : IEquatable<ListUnconfirmedTransactionsByAddressRIBSBSC>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnconfirmedTransactionsByAddressRIBSBSC" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListUnconfirmedTransactionsByAddressRIBSBSC() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnconfirmedTransactionsByAddressRIBSBSC" /> class.
        /// </summary>
        ...
        public ListUnconfirmedTransactionsByAddressRIBSBSC(string gasLimit = default(string), ListConfirmedTransactionsByAddressRIBSBSCGasPrice gasPrice = default(ListConfirmedTransactionsByAddressRIBSBSCGasPrice), string inputData = default(string), int nonce = default(int), string transactionStatus = default(string))
        {
            // to ensure "gasLimit" is required (not null)
            if (gasLimit == null)
            {
                throw new ArgumentNullException("gasLimit is a required property for ListUnconfirmedTransactionsByAddressRIBSBSC and cannot be null");
            }
            this.GasLimit = gasLimit;
            // to ensure "gasPrice" is required (not null)
            if (gasPrice == null)
            {
                throw new ArgumentNullException("gasPrice is a required property for ListUnconfirmedTransactionsByAddressRIBSBSC and cannot be null");
            }
            this.GasPrice = gasPrice;
            // to ensure "inputData" is required (not null)
            if (inputData == null)
            {
                throw new ArgumentNullException("inputData is a required property for ListUnconfirmedTransactionsByAddressRIBSBSC and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("transactionStatus is a required property for ListUnconfirmedTransactionsByAddressRIBSBSC and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListUnconfirmedTransactionsByAddressRIBSBSC {\n");
        ...
        {
            return this.Equals(input as ListUnconfirmedTransactionsByAddressRIBSBSC);
        }

        /// <summary>
        /// Returns true if ListUnconfirmedTransactionsByAddressRIBSBSC instances are equal
        /// </summary>
        /// <param name="input">Instance of ListUnconfirmedTransactionsByAddressRIBSBSC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListUnconfirmedTransactionsByAddressRIBSBSC input)
        {
            if (input == null)
            {
                return false;
