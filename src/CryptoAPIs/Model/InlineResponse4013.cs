...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4013
    /// </summary>
    [DataContract(Name = "inline_response_401_3")]
    public partial class InlineResponse4013 : IEquatable<InlineResponse4013>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4013" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse4013() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4013" /> class.
        /// </summary>
        ...
        public InlineResponse4013(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetZilliqaAddressDetailsE401 error = default(GetZilliqaAddressDetailsE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4013 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4013 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse4013 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse4013);
        }

        /// <summary>
        /// Returns true if InlineResponse4013 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4013 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4013 input)
        {
            if (input == null)
            {
                return false;
