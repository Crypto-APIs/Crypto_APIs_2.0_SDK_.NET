...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40086
    /// </summary>
    [DataContract(Name = "inline_response_400_86")]
    public partial class InlineResponse40086 : IEquatable<InlineResponse40086>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40086" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40086() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40086" /> class.
        /// </summary>
        ...
        public InlineResponse40086(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetBlockDetailsByBlockHeightFromCallbackE400 error = default(GetBlockDetailsByBlockHeightFromCallbackE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40086 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40086 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40086 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40086 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40086);
        }

        /// <summary>
        /// Returns true if InlineResponse40086 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40086 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40086 input)
        {
            if (input == null)
            {
                return false;
