...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40086 : IEquatable<InlineResponse40086>, IValidatableObject
    {
        ...
        public InlineResponse40086(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListSupportedAssetsE400 error = default(ListSupportedAssetsE400))
        {
