...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40157 : IEquatable<InlineResponse40157>, IValidatableObject
    {
        ...
        public InlineResponse40157(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetFeeRecommendationsE401 error = default(GetFeeRecommendationsE401))
        {
