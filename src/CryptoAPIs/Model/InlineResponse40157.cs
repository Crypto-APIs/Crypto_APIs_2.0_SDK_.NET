...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40157
    /// </summary>
    [DataContract(Name = "inline_response_401_57")]
    public partial class InlineResponse40157 : IEquatable<InlineResponse40157>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40157" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40157() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40157" /> class.
        /// </summary>
        ...
        public InlineResponse40157(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetTokenDetailsByContractAddressE401 error = default(GetTokenDetailsByContractAddressE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40157 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40157 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40157 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40157 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40157);
        }

        /// <summary>
        /// Returns true if InlineResponse40157 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40157 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40157 input)
        {
            if (input == null)
            {
                return false;
