...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40148
    /// </summary>
    [DataContract(Name = "inline_response_401_48")]
    public partial class InlineResponse40148 : IEquatable<InlineResponse40148>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40148" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40148() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40148" /> class.
        /// </summary>
        ...
        public InlineResponse40148(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListInternalTransactionDetailsByTransactionHashE401 error = default(ListInternalTransactionDetailsByTransactionHashE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40148 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40148 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40148 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40148 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40148);
        }

        /// <summary>
        /// Returns true if InlineResponse40148 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40148 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40148 input)
        {
            if (input == null)
            {
                return false;
