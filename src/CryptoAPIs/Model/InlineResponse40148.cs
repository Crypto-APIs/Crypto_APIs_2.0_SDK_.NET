...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40148 : IEquatable<InlineResponse40148>, IValidatableObject
    {
        ...
        public InlineResponse40148(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListWalletTransactionsE401 error = default(ListWalletTransactionsE401))
        {
