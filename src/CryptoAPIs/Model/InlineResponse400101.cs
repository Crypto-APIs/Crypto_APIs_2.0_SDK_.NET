...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_400_101")]
    public partial class InlineResponse400101 : IEquatable<InlineResponse400101>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse400101" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse400101() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse400101" /> class.
        /// </summary>
        ...
        public InlineResponse400101(string apiVersion = default(string), string requestId = default(string), string context = default(string), EstimateTokenGasLimitE400 error = default(EstimateTokenGasLimitE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse400101 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse400101 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse400101 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse400101 {\n");
        ...
        {
            return this.Equals(input as InlineResponse400101);
        }

        /// <summary>
        /// Returns true if InlineResponse400101 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse400101 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse400101 input)
        {
            if (input == null)
            {
                return false;
