...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_400_102")]
    public partial class InlineResponse400102 : IEquatable<InlineResponse400102>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse400102" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse400102() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse400102" /> class.
        /// </summary>
        ...
        public InlineResponse400102(string apiVersion = default(string), string requestId = default(string), string context = default(string), DecodeRawTransactionHexE400 error = default(DecodeRawTransactionHexE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse400102 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse400102 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse400102 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse400102 {\n");
        ...
        {
            return this.Equals(input as InlineResponse400102);
        }

        /// <summary>
        /// Returns true if InlineResponse400102 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse400102 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse400102 input)
        {
            if (input == null)
            {
                return false;
