...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40037
    /// </summary>
    [DataContract(Name = "inline_response_400_37")]
    public partial class InlineResponse40037 : IEquatable<InlineResponse40037>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40037" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40037() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40037" /> class.
        /// </summary>
        ...
        public InlineResponse40037(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateFungibleTokensTransactionRequestFromAddressE400 error = default(CreateFungibleTokensTransactionRequestFromAddressE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40037 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40037 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40037 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40037 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40037);
        }

        /// <summary>
        /// Returns true if InlineResponse40037 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40037 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40037 input)
        {
            if (input == null)
            {
                return false;
