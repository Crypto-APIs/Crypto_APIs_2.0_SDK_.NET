...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40037 : IEquatable<InlineResponse40037>, IValidatableObject
    {
        ...
        public InlineResponse40037(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetLastMinedBlockE400 error = default(GetLastMinedBlockE400))
        {
