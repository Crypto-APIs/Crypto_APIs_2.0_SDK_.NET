...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40354 : IEquatable<InlineResponse40354>, IValidatableObject
    {
        ...
        public InlineResponse40354(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTokensTransfersByTransactionHashE403 error = default(ListTokensTransfersByTransactionHashE403))
        {
