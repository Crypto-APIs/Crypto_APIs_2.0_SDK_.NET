...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40354
    /// </summary>
    [DataContract(Name = "inline_response_403_54")]
    public partial class InlineResponse40354 : IEquatable<InlineResponse40354>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40354" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40354() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40354" /> class.
        /// </summary>
        ...
        public InlineResponse40354(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetInternalTransactionByTransactionHashAndOperationIdE403 error = default(GetInternalTransactionByTransactionHashAndOperationIdE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40354 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40354 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40354 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40354 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40354);
        }

        /// <summary>
        /// Returns true if InlineResponse40354 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40354 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40354 input)
        {
            if (input == null)
            {
                return false;
