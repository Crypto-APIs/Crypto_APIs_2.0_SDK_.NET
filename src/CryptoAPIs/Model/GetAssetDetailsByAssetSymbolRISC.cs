...
namespace CryptoAPIs.Model
{
    ...
    /// Crypto Type Data
    /// </summary>
    [DataContract(Name = "GetAssetDetailsByAssetSymbolRISC")]
    public partial class GetAssetDetailsByAssetSymbolRISC : IEquatable<GetAssetDetailsByAssetSymbolRISC>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAssetDetailsByAssetSymbolRISC" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetAssetDetailsByAssetSymbolRISC() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAssetDetailsByAssetSymbolRISC" /> class.
        /// </summary>
        ...
        public GetAssetDetailsByAssetSymbolRISC(string _1hourPriceChangeInPercentage = default(string), string _1weekPriceChangeInPercentage = default(string), string _24hoursPriceChangeInPercentage = default(string), string _24hoursTradingVolume = default(string), AssetTypeEnum assetType = default(AssetTypeEnum), string circulatingSupply = default(string), string marketCapInUSD = default(string), string maxSupply = default(string))
        {
            // to ensure "_1hourPriceChangeInPercentage" is required (not null)
            if (_1hourPriceChangeInPercentage == null) {
                throw new ArgumentNullException("_1hourPriceChangeInPercentage is a required property for GetAssetDetailsByAssetSymbolRISC and cannot be null");
            }
            ...
            if (_1weekPriceChangeInPercentage == null) {
                throw new ArgumentNullException("_1weekPriceChangeInPercentage is a required property for GetAssetDetailsByAssetSymbolRISC and cannot be null");
            }
            ...
            if (_24hoursPriceChangeInPercentage == null) {
                throw new ArgumentNullException("_24hoursPriceChangeInPercentage is a required property for GetAssetDetailsByAssetSymbolRISC and cannot be null");
            }
            ...
            if (_24hoursTradingVolume == null) {
                throw new ArgumentNullException("_24hoursTradingVolume is a required property for GetAssetDetailsByAssetSymbolRISC and cannot be null");
            }
            this._24HoursTradingVolume = _24hoursTradingVolume;
            this.AssetType = assetType;
            // to ensure "circulatingSupply" is required (not null)
            if (circulatingSupply == null) {
                throw new ArgumentNullException("circulatingSupply is a required property for GetAssetDetailsByAssetSymbolRISC and cannot be null");
            }
            this.CirculatingSupply = circulatingSupply;
            // to ensure "marketCapInUSD" is required (not null)
            if (marketCapInUSD == null) {
                throw new ArgumentNullException("marketCapInUSD is a required property for GetAssetDetailsByAssetSymbolRISC and cannot be null");
            }
            this.MarketCapInUSD = marketCapInUSD;
            // to ensure "maxSupply" is required (not null)
            if (maxSupply == null) {
                throw new ArgumentNullException("maxSupply is a required property for GetAssetDetailsByAssetSymbolRISC and cannot be null");
            }
        ...
        {
            return this.Equals(input as GetAssetDetailsByAssetSymbolRISC);
        }

        /// <summary>
        /// Returns true if GetAssetDetailsByAssetSymbolRISC instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAssetDetailsByAssetSymbolRISC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAssetDetailsByAssetSymbolRISC input)
        {
            if (input == null)
            {
                return false;
