...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40041 : IEquatable<InlineResponse40041>, IValidatableObject
    {
        ...
        public InlineResponse40041(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetTransactionRequestDetailsE400 error = default(GetTransactionRequestDetailsE400))
        {
