...
namespace CryptoAPIs.Model
{
    ...
    /// ListAssetsDetailsR
    /// </summary>
    [DataContract(Name = "ListAssetsDetailsR")]
    public partial class ListAssetsDetailsR : IEquatable<ListAssetsDetailsR>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAssetsDetailsR" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListAssetsDetailsR() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAssetsDetailsR" /> class.
        /// </summary>
        ...
        public ListAssetsDetailsR(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListAssetsDetailsRData data = default(ListAssetsDetailsRData))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for ListAssetsDetailsR and cannot be null");
            // to ensure "requestId" is required (not null)
            this.RequestId = requestId ?? throw new ArgumentNullException("requestId is a required property for ListAssetsDetailsR and cannot be null");
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for ListAssetsDetailsR and cannot be null");
        ...
        public ListAssetsDetailsRData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListAssetsDetailsR {\n");
        ...
        {
            return this.Equals(input as ListAssetsDetailsR);
        }

        /// <summary>
        /// Returns true if ListAssetsDetailsR instances are equal
        /// </summary>
        /// <param name="input">Instance of ListAssetsDetailsR to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListAssetsDetailsR input)
        {
            if (input == null)
                return false;
