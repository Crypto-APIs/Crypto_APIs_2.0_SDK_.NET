...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40166 : IEquatable<InlineResponse40166>, IValidatableObject
    {
        ...
        public InlineResponse40166(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListBlockchainEventsSubscriptionsE401 error = default(ListBlockchainEventsSubscriptionsE401))
        {
