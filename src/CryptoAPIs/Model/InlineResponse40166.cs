...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40166
    /// </summary>
    [DataContract(Name = "inline_response_401_66")]
    public partial class InlineResponse40166 : IEquatable<InlineResponse40166>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40166" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40166() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40166" /> class.
        /// </summary>
        ...
        public InlineResponse40166(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListUnconfirmedTokensTransfersByAddressE401 error = default(ListUnconfirmedTokensTransfersByAddressE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40166 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40166 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40166 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40166 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40166);
        }

        /// <summary>
        /// Returns true if InlineResponse40166 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40166 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40166 input)
        {
            if (input == null)
            {
                return false;
