...
namespace CryptoAPIs.Model
{
    ...
    /// Bitcoin Cash
    /// </summary>
    [DataContract(Name = "ListConfirmedTransactionsByAddressAndTimeRangeRIBSBC")]
    public partial class ListConfirmedTransactionsByAddressAndTimeRangeRIBSBC : IEquatable<ListConfirmedTransactionsByAddressAndTimeRangeRIBSBC>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressAndTimeRangeRIBSBC" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListConfirmedTransactionsByAddressAndTimeRangeRIBSBC() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListConfirmedTransactionsByAddressAndTimeRangeRIBSBC" /> class.
        /// </summary>
        ...
        public ListConfirmedTransactionsByAddressAndTimeRangeRIBSBC(long locktime = default(long), int size = default(int), int version = default(int), List<ListConfirmedTransactionsByAddressRIBSBCVinInner> vin = default(List<ListConfirmedTransactionsByAddressRIBSBCVinInner>), List<GetTransactionDetailsByTransactionIDRIBSBCVoutInner> vout = default(List<GetTransactionDetailsByTransactionIDRIBSBCVoutInner>))
        {
            ...
            if (vin == null)
            {
                throw new ArgumentNullException("vin is a required property for ListConfirmedTransactionsByAddressAndTimeRangeRIBSBC and cannot be null");
            }
            this.Vin = vin;
            this.Vout = vout;
        }
        ...
        {
            return this.Equals(input as ListConfirmedTransactionsByAddressAndTimeRangeRIBSBC);
        }

        /// <summary>
        /// Returns true if ListConfirmedTransactionsByAddressAndTimeRangeRIBSBC instances are equal
        /// </summary>
        /// <param name="input">Instance of ListConfirmedTransactionsByAddressAndTimeRangeRIBSBC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListConfirmedTransactionsByAddressAndTimeRangeRIBSBC input)
        {
            if (input == null)
            {
                return false;
