...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40074 : IEquatable<InlineResponse40074>, IValidatableObject
    {
        ...
        public InlineResponse40074(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewConfirmedTokensTransactionsE400 error = default(NewConfirmedTokensTransactionsE400))
        {
