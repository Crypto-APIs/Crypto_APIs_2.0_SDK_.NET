...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4225
    /// </summary>
    [DataContract(Name = "inline_response_422_5")]
    public partial class InlineResponse4225 : IEquatable<InlineResponse4225>, IValidatableObject
    {
        ...
        public InlineResponse4225(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListHDWalletXPubYPubZPubUTXOsE422 error = default(ListHDWalletXPubYPubZPubUTXOsE422))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4225 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4225 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse4225 and cannot be null");
            }
            this.Error = error;
