...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse4225 : IEquatable<InlineResponse4225>, IValidatableObject
    {
        ...
        public InlineResponse4225(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetExchangeRateByAssetsIDsE422 error = default(GetExchangeRateByAssetsIDsE422))
        {
