...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetTransactionDetailsByTransactionIDFromCallbackRIBSD2_vin")]
    public partial class GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin : IEquatable<GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin" /> class.
        /// </summary>
        ...
        public GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin(List<string> addresses = default(List<string>), string coinbase = default(string), GetTransactionDetailsByTransactionIDRIBSDScriptSig scriptSig = default(GetTransactionDetailsByTransactionIDRIBSDScriptSig), int sequence = default(int), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            if (addresses == null) {
                throw new ArgumentNullException("addresses is a required property for GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin and cannot be null");
            }
            this.Addresses = addresses;
            // to ensure "scriptSig" is required (not null)
            if (scriptSig == null) {
                throw new ArgumentNullException("scriptSig is a required property for GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin and cannot be null");
            }
            this.ScriptSig = scriptSig;
            this.Sequence = sequence;
            // to ensure "txinwitness" is required (not null)
            if (txinwitness == null) {
                throw new ArgumentNullException("txinwitness is a required property for GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin and cannot be null");
            }
            this.Txinwitness = txinwitness;
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin and cannot be null");
            }
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin {\n");
        ...
        {
            return this.Equals(input as GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin);
        }

        /// <summary>
        /// Returns true if GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin instances are equal
        /// </summary>
        /// <param name="input">Instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin input)
        {
            if (input == null)
            {
                return false;
