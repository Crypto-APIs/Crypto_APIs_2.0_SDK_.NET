...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40372 : IEquatable<InlineResponse40372>, IValidatableObject
    {
        ...
        public InlineResponse40372(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewUnconfirmedTokensTransactionsE403 error = default(NewUnconfirmedTokensTransactionsE403))
        {
