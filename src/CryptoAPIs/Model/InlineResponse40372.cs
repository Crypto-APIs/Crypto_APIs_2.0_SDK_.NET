...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40372
    /// </summary>
    [DataContract(Name = "inline_response_403_72")]
    public partial class InlineResponse40372 : IEquatable<InlineResponse40372>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40372" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40372() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40372" /> class.
        /// </summary>
        ...
        public InlineResponse40372(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetBlockDetailsByBlockHeightFromCallbackE403 error = default(GetBlockDetailsByBlockHeightFromCallbackE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40372 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40372 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40372 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40372 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40372);
        }

        /// <summary>
        /// Returns true if InlineResponse40372 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40372 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40372 input)
        {
            if (input == null)
            {
                return false;
