...
namespace CryptoAPIs.Model
{
    ...
    /// ValidateAddressE403
    /// </summary>
    [JsonConverter(typeof(ValidateAddressE403JsonConverter))]
    [DataContract(Name = "ValidateAddressE403")]
    public partial class ValidateAddressE403 : AbstractOpenAPISchema, IEquatable<ValidateAddressE403>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidateAddressE403" /> class
        /// with the <see cref="BannedIpAddress" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BannedIpAddress.</param>
        public ValidateAddressE403(BannedIpAddress actualInstance)
        {
        ...
        public ValidateAddressE403(EndpointNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public ValidateAddressE403(EndpointNotAllowedForApiKey actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public ValidateAddressE403(FeatureMainnetsNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ValidateAddressE403 {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, ValidateAddressE403.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of ValidateAddressE403
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of ValidateAddressE403</returns>
        public static ValidateAddressE403 FromJson(string jsonString)
        {
            ValidateAddressE403 newValidateAddressE403 = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newValidateAddressE403;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newValidateAddressE403 = new ValidateAddressE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, ValidateAddressE403.SerializerSettings));
                }
                else
                {
                    newValidateAddressE403 = new ValidateAddressE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, ValidateAddressE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newValidateAddressE403 = new ValidateAddressE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, ValidateAddressE403.SerializerSettings));
                }
                else
                {
                    newValidateAddressE403 = new ValidateAddressE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, ValidateAddressE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newValidateAddressE403 = new ValidateAddressE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, ValidateAddressE403.SerializerSettings));
                }
                else
                {
                    newValidateAddressE403 = new ValidateAddressE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, ValidateAddressE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newValidateAddressE403 = new ValidateAddressE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, ValidateAddressE403.SerializerSettings));
                }
                else
                {
                    newValidateAddressE403 = new ValidateAddressE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, ValidateAddressE403.AdditionalPropertiesSerializerSettings));
                }
        ...
        {
            return this.Equals(input as ValidateAddressE403);
        }

        /// <summary>
        /// Returns true if ValidateAddressE403 instances are equal
        /// </summary>
        /// <param name="input">Instance of ValidateAddressE403 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValidateAddressE403 input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for ValidateAddressE403
    /// </summary>
    public class ValidateAddressE403JsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(ValidateAddressE403).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return ValidateAddressE403.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
