...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_401_108")]
    public partial class InlineResponse401108 : IEquatable<InlineResponse401108>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse401108" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse401108() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse401108" /> class.
        /// </summary>
        ...
        public InlineResponse401108(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListAssetsDetailsE401 error = default(ListAssetsDetailsE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse401108 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse401108 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse401108 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse401108 {\n");
        ...
        {
            return this.Equals(input as InlineResponse401108);
        }

        /// <summary>
        /// Returns true if InlineResponse401108 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse401108 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse401108 input)
        {
            if (input == null)
            {
                return false;
