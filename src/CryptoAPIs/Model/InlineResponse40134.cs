...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40134 : IEquatable<InlineResponse40134>, IValidatableObject
    {
        ...
        public InlineResponse40134(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListSupportedTokensE401 error = default(ListSupportedTokensE401))
        {
