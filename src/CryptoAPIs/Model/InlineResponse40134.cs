...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40134
    /// </summary>
    [DataContract(Name = "inline_response_401_34")]
    public partial class InlineResponse40134 : IEquatable<InlineResponse40134>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40134" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40134() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40134" /> class.
        /// </summary>
        ...
        public InlineResponse40134(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetZilliqaBlockDetailsByBlockHashE401 error = default(GetZilliqaBlockDetailsByBlockHashE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40134 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40134 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40134 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40134 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40134);
        }

        /// <summary>
        /// Returns true if InlineResponse40134 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40134 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40134 input)
        {
            if (input == null)
            {
                return false;
