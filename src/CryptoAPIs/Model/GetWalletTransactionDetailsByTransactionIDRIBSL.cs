...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetWalletTransactionDetailsByTransactionIDRIBSL : IEquatable<GetWalletTransactionDetailsByTransactionIDRIBSL>, IValidatableObject
    {
        ...
        public GetWalletTransactionDetailsByTransactionIDRIBSL(int locktime = default(int), int size = default(int), int vSize = default(int), int version = default(int), List<GetWalletTransactionDetailsByTransactionIDRIBSLVin> vin = default(List<GetWalletTransactionDetailsByTransactionIDRIBSLVin>), List<GetTransactionDetailsByTransactionIDRIBSLVout> vout = default(List<GetTransactionDetailsByTransactionIDRIBSLVout>))
        {
