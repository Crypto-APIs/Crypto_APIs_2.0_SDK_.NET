...
namespace CryptoAPIs.Model
{
    ...
    /// Litecoin
    /// </summary>
    [DataContract(Name = "GetWalletTransactionDetailsByTransactionIDRIBSL")]
    public partial class GetWalletTransactionDetailsByTransactionIDRIBSL : IEquatable<GetWalletTransactionDetailsByTransactionIDRIBSL>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWalletTransactionDetailsByTransactionIDRIBSL" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetWalletTransactionDetailsByTransactionIDRIBSL() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWalletTransactionDetailsByTransactionIDRIBSL" /> class.
        /// </summary>
        ...
        public GetWalletTransactionDetailsByTransactionIDRIBSL(long locktime = default(long), int size = default(int), int vSize = default(int), int version = default(int), List<GetWalletTransactionDetailsByTransactionIDRIBSLVinInner> vin = default(List<GetWalletTransactionDetailsByTransactionIDRIBSLVinInner>), List<GetTransactionDetailsByTransactionIDRIBSLVoutInner> vout = default(List<GetTransactionDetailsByTransactionIDRIBSLVoutInner>))
        {
            ...
            if (vin == null)
            {
                throw new ArgumentNullException("vin is a required property for GetWalletTransactionDetailsByTransactionIDRIBSL and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null)
            {
                throw new ArgumentNullException("vout is a required property for GetWalletTransactionDetailsByTransactionIDRIBSL and cannot be null");
            }
            this.Vout = vout;
        }
        ...
        public List<GetWalletTransactionDetailsByTransactionIDRIBSLVinInner> Vin { get; set; }
        ...
        {
            return this.Equals(input as GetWalletTransactionDetailsByTransactionIDRIBSL);
        }

        /// <summary>
        /// Returns true if GetWalletTransactionDetailsByTransactionIDRIBSL instances are equal
        /// </summary>
        /// <param name="input">Instance of GetWalletTransactionDetailsByTransactionIDRIBSL to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetWalletTransactionDetailsByTransactionIDRIBSL input)
        {
            if (input == null)
            {
                return false;
