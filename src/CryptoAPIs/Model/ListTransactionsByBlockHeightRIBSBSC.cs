...
namespace CryptoAPIs.Model
{
    ...
    /// Binance Smart Chain
    /// </summary>
    [DataContract(Name = "ListTransactionsByBlockHeightRIBSBSC")]
    public partial class ListTransactionsByBlockHeightRIBSBSC : IEquatable<ListTransactionsByBlockHeightRIBSBSC>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHeightRIBSBSC" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByBlockHeightRIBSBSC() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHeightRIBSBSC" /> class.
        /// </summary>
        ...
        public ListTransactionsByBlockHeightRIBSBSC(string contract = default(string), string gasLimit = default(string), ListTransactionsByBlockHeightRIBSBSCGasPrice gasPrice = default(ListTransactionsByBlockHeightRIBSBSCGasPrice), string gasUsed = default(string), string inputData = default(string), int nonce = default(int), string transactionStatus = default(string))
        {
            // to ensure "gasLimit" is required (not null)
            if (gasLimit == null) {
                throw new ArgumentNullException("gasLimit is a required property for ListTransactionsByBlockHeightRIBSBSC and cannot be null");
            }
            this.GasLimit = gasLimit;
            // to ensure "gasPrice" is required (not null)
            if (gasPrice == null) {
                throw new ArgumentNullException("gasPrice is a required property for ListTransactionsByBlockHeightRIBSBSC and cannot be null");
            }
            this.GasPrice = gasPrice;
            // to ensure "gasUsed" is required (not null)
            if (gasUsed == null) {
                throw new ArgumentNullException("gasUsed is a required property for ListTransactionsByBlockHeightRIBSBSC and cannot be null");
            }
            this.GasUsed = gasUsed;
            // to ensure "inputData" is required (not null)
            if (inputData == null) {
                throw new ArgumentNullException("inputData is a required property for ListTransactionsByBlockHeightRIBSBSC and cannot be null");
            }
            this.InputData = inputData;
            this.Nonce = nonce;
            // to ensure "transactionStatus" is required (not null)
            if (transactionStatus == null) {
                throw new ArgumentNullException("transactionStatus is a required property for ListTransactionsByBlockHeightRIBSBSC and cannot be null");
            }
        ...
        public ListTransactionsByBlockHeightRIBSBSCGasPrice GasPrice { get; set; }
        ...
        {
            return this.Equals(input as ListTransactionsByBlockHeightRIBSBSC);
        }

        /// <summary>
        /// Returns true if ListTransactionsByBlockHeightRIBSBSC instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByBlockHeightRIBSBSC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByBlockHeightRIBSBSC input)
        {
            if (input == null)
            {
                return false;
