...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_403_106")]
    public partial class InlineResponse403106 : IEquatable<InlineResponse403106>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse403106" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse403106() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse403106" /> class.
        /// </summary>
        ...
        public InlineResponse403106(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetExchangeRateByAssetSymbolsE403 error = default(GetExchangeRateByAssetSymbolsE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse403106 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse403106 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse403106 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse403106 {\n");
        ...
        {
            return this.Equals(input as InlineResponse403106);
        }

        /// <summary>
        /// Returns true if InlineResponse403106 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse403106 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse403106 input)
        {
            if (input == null)
            {
                return false;
