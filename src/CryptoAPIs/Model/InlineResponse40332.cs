...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40332 : IEquatable<InlineResponse40332>, IValidatableObject
    {
        ...
        public InlineResponse40332(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetXRPRippleBlockDetailsByBlockHashE403 error = default(GetXRPRippleBlockDetailsByBlockHashE403))
        {
