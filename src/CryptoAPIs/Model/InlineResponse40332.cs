...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40332
    /// </summary>
    [DataContract(Name = "inline_response_403_32")]
    public partial class InlineResponse40332 : IEquatable<InlineResponse40332>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40332" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40332() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40332" /> class.
        /// </summary>
        ...
        public InlineResponse40332(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetOmniTransactionDetailsByTransactionIDTxidE403 error = default(GetOmniTransactionDetailsByTransactionIDTxidE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40332 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40332 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40332 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40332 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40332);
        }

        /// <summary>
        /// Returns true if InlineResponse40332 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40332 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40332 input)
        {
            if (input == null)
            {
                return false;
