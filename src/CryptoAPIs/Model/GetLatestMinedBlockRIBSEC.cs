...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetLatestMinedBlockRIBSEC : IEquatable<GetLatestMinedBlockRIBSEC>, IValidatableObject
    {
        ...
        public GetLatestMinedBlockRIBSEC(string difficulty = default(string), int nonce = default(int), int size = default(int), string extraData = default(string), string gasLimit = default(string), string gasUsed = default(string), int minedInSeconds = default(int), string sha3Uncles = default(string), string totalDifficulty = default(string))
        {
