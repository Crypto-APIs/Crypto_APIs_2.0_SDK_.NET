...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40323
    /// </summary>
    [DataContract(Name = "inline_response_403_23")]
    public partial class InlineResponse40323 : IEquatable<InlineResponse40323>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40323" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40323() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40323" /> class.
        /// </summary>
        ...
        public InlineResponse40323(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListXRPRippleTransactionsByBlockHeightE403 error = default(ListXRPRippleTransactionsByBlockHeightE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40323 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40323 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40323 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40323 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40323);
        }

        /// <summary>
        /// Returns true if InlineResponse40323 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40323 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40323 input)
        {
            if (input == null)
            {
                return false;
