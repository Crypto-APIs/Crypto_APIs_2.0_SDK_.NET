...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40323 : IEquatable<InlineResponse40323>, IValidatableObject
    {
        ...
        public InlineResponse40323(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListZilliqaTransactionsByBlockHeightE403 error = default(ListZilliqaTransactionsByBlockHeightE403))
        {
