...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40370 : IEquatable<InlineResponse40370>, IValidatableObject
    {
        ...
        public InlineResponse40370(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetTransactionDetailsByTransactionIDFromCallbackE403 error = default(GetTransactionDetailsByTransactionIDFromCallbackE403))
        {
