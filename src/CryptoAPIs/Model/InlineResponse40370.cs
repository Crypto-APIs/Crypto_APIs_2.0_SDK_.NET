...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40370
    /// </summary>
    [DataContract(Name = "inline_response_403_70")]
    public partial class InlineResponse40370 : IEquatable<InlineResponse40370>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40370" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40370() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40370" /> class.
        /// </summary>
        ...
        public InlineResponse40370(string apiVersion = default(string), string requestId = default(string), string context = default(string), DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403 error = default(DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40370 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40370 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40370 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40370 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40370);
        }

        /// <summary>
        /// Returns true if InlineResponse40370 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40370 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40370 input)
        {
            if (input == null)
            {
                return false;
