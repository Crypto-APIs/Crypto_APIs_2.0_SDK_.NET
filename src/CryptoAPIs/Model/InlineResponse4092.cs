...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4092
    /// </summary>
    [DataContract(Name = "inline_response_409_2")]
    public partial class InlineResponse4092 : IEquatable<InlineResponse4092>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4092" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse4092() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse4092" /> class.
        /// </summary>
        ...
        public InlineResponse4092(string apiVersion = default(string), string requestId = default(string), string context = default(string), CreateCoinsTransactionRequestFromAddressE409 error = default(CreateCoinsTransactionRequestFromAddressE409))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4092 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4092 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse4092 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse4092);
        }

        /// <summary>
        /// Returns true if InlineResponse4092 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse4092 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse4092 input)
        {
            if (input == null)
            {
                return false;
