...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40913
    /// </summary>
    [DataContract(Name = "inline_response_409_13")]
    public partial class InlineResponse40913 : IEquatable<InlineResponse40913>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40913" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40913() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40913" /> class.
        /// </summary>
        ...
        public InlineResponse40913(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewBlockE409 error = default(NewBlockE409))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40913 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40913 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40913 and cannot be null");
            }
            this.Error = error;
        ...
        {
            return this.Equals(input as InlineResponse40913);
        }

        /// <summary>
        /// Returns true if InlineResponse40913 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40913 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40913 input)
        {
            if (input == null)
            {
                return false;
