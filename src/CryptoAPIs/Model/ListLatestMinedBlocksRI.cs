...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListLatestMinedBlocksRI")]
    public partial class ListLatestMinedBlocksRI : IEquatable<ListLatestMinedBlocksRI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListLatestMinedBlocksRI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListLatestMinedBlocksRI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListLatestMinedBlocksRI" /> class.
        /// </summary>
        ...
        public ListLatestMinedBlocksRI(string hash = default(string), int height = default(int), string previousBlockHash = default(string), int timestamp = default(int), int transactionsCount = default(int), ListLatestMinedBlocksRIBS blockchainSpecific = default(ListLatestMinedBlocksRIBS))
        {
        ...
        public ListLatestMinedBlocksRIBS BlockchainSpecific { get; set; }
        ...
        {
            return this.Equals(input as ListLatestMinedBlocksRI);
        }

        /// <summary>
        /// Returns true if ListLatestMinedBlocksRI instances are equal
        /// </summary>
        /// <param name="input">Instance of ListLatestMinedBlocksRI to be compared</param>
        /// <returns>Boolean</returns>
