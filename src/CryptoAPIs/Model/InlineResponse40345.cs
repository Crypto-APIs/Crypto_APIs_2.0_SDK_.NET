...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40345
    /// </summary>
    [DataContract(Name = "inline_response_403_45")]
    public partial class InlineResponse40345 : IEquatable<InlineResponse40345>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40345" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40345() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40345" /> class.
        /// </summary>
        ...
        public InlineResponse40345(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListWalletTransactionsE403 error = default(ListWalletTransactionsE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40345 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40345 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40345 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40345 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40345);
        }

        /// <summary>
        /// Returns true if InlineResponse40345 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40345 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40345 input)
        {
            if (input == null)
            {
                return false;
