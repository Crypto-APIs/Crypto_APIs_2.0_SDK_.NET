...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40345 : IEquatable<InlineResponse40345>, IValidatableObject
    {
        ...
        public InlineResponse40345(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListLatestMinedBlocksE403 error = default(ListLatestMinedBlocksE403))
        {
