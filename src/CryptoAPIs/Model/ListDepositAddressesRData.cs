...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListDepositAddressesRData : IEquatable<ListDepositAddressesRData>, IValidatableObject
    {
        ...
        public ListDepositAddressesRData(int limit = default(int), int offset = default(int), int total = default(int), List<ListDepositAddressesRI> items = default(List<ListDepositAddressesRI>))
        {
            this.Limit = limit;
            this.Offset = offset;
            this.Total = total;
