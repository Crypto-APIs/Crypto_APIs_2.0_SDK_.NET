...
namespace CryptoAPIs.Model
{
    ...
    /// BlockHeightReached
    /// </summary>
    [DataContract(Name = "BlockHeightReached")]
    public partial class BlockHeightReached : IEquatable<BlockHeightReached>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BlockHeightReached" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BlockHeightReached() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BlockHeightReached" /> class.
        /// </summary>
        ...
        public BlockHeightReached(string apiVersion = default(string), string referenceId = default(string), string idempotencyKey = default(string), BlockHeightReachedData data = default(BlockHeightReachedData))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for BlockHeightReached and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "referenceId" is required (not null)
            if (referenceId == null)
            {
                throw new ArgumentNullException("referenceId is a required property for BlockHeightReached and cannot be null");
            }
            this.ReferenceId = referenceId;
            // to ensure "idempotencyKey" is required (not null)
            if (idempotencyKey == null)
            {
                throw new ArgumentNullException("idempotencyKey is a required property for BlockHeightReached and cannot be null");
            }
            this.IdempotencyKey = idempotencyKey;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for BlockHeightReached and cannot be null");
            }
            this.Data = data;
        }
        ...
        public BlockHeightReachedData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BlockHeightReached {\n");
        ...
        {
            return this.Equals(input as BlockHeightReached);
        }

        /// <summary>
        /// Returns true if BlockHeightReached instances are equal
        /// </summary>
        /// <param name="input">Instance of BlockHeightReached to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BlockHeightReached input)
        {
            if (input == null)
            {
                return false;
