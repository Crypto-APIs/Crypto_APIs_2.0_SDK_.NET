...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40028
    /// </summary>
    [DataContract(Name = "inline_response_400_28")]
    public partial class InlineResponse40028 : IEquatable<InlineResponse40028>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40028" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40028() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40028" /> class.
        /// </summary>
        ...
        public InlineResponse40028(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListUnconfirmedOmniTransactionsByPropertyIDE400 error = default(ListUnconfirmedOmniTransactionsByPropertyIDE400))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40028 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40028 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40028 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40028 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40028);
        }

        /// <summary>
        /// Returns true if InlineResponse40028 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40028 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40028 input)
        {
            if (input == null)
            {
                return false;
