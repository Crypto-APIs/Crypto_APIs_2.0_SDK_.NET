...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40028 : IEquatable<InlineResponse40028>, IValidatableObject
    {
        ...
        public InlineResponse40028(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetXRPRippleBlockDetailsByBlockHeightE400 error = default(GetXRPRippleBlockDetailsByBlockHeightE400))
        {
