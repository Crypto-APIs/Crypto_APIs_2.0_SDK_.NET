...
namespace CryptoAPIs.Model
{
    ...
    public partial class CreateCoinsTransactionRequestFromWalletRI : IEquatable<CreateCoinsTransactionRequestFromWalletRI>, IValidatableObject
    {
        ...
        public CreateCoinsTransactionRequestFromWalletRI(string callbackSecretKey = default(string), string callbackUrl = default(string), FeePriorityEnum feePriority = default(FeePriorityEnum), string note = default(string), List<CreateCoinsTransactionRequestFromWalletRIRecipientsInner> recipients = default(List<CreateCoinsTransactionRequestFromWalletRIRecipientsInner>), string totalTransactionAmount = default(string), string transactionRequestId = default(string), TransactionRequestStatusEnum transactionRequestStatus = default(TransactionRequestStatusEnum))
        {
            this.FeePriority = feePriority;
            // to ensure "recipients" is required (not null)
            if (recipients == null)
            {
                throw new ArgumentNullException("recipients is a required property for CreateCoinsTransactionRequestFromWalletRI and cannot be null");
            }
            this.Recipients = recipients;
            // to ensure "totalTransactionAmount" is required (not null)
            if (totalTransactionAmount == null)
            {
                throw new ArgumentNullException("totalTransactionAmount is a required property for CreateCoinsTransactionRequestFromWalletRI and cannot be null");
            }
            this.TotalTransactionAmount = totalTransactionAmount;
            // to ensure "transactionRequestId" is required (not null)
            if (transactionRequestId == null)
            {
                throw new ArgumentNullException("transactionRequestId is a required property for CreateCoinsTransactionRequestFromWalletRI and cannot be null");
            }
        ...
        public List<CreateCoinsTransactionRequestFromWalletRIRecipientsInner> Recipients { get; set; }
