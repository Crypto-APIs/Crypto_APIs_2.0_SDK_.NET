...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40397
    /// </summary>
    [DataContract(Name = "inline_response_403_97")]
    public partial class InlineResponse40397 : IEquatable<InlineResponse40397>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40397" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40397() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40397" /> class.
        /// </summary>
        ...
        public InlineResponse40397(string apiVersion = default(string), string requestId = default(string), string context = default(string), ValidateAddressE403 error = default(ValidateAddressE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40397 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40397 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40397 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40397 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40397);
        }

        /// <summary>
        /// Returns true if InlineResponse40397 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40397 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40397 input)
        {
            if (input == null)
            {
                return false;
