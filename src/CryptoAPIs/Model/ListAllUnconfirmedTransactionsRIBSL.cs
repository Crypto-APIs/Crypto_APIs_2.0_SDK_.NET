...
namespace CryptoAPIs.Model
{
    ...
    /// Litecoin
    /// </summary>
    [DataContract(Name = "ListAllUnconfirmedTransactionsRIBSL")]
    public partial class ListAllUnconfirmedTransactionsRIBSL : IEquatable<ListAllUnconfirmedTransactionsRIBSL>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllUnconfirmedTransactionsRIBSL" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListAllUnconfirmedTransactionsRIBSL() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllUnconfirmedTransactionsRIBSL" /> class.
        /// </summary>
        ...
        public ListAllUnconfirmedTransactionsRIBSL(long locktime = default(long), int size = default(int), int vSize = default(int), int version = default(int), List<ListAllUnconfirmedTransactionsRIBSLVinInner> vin = default(List<ListAllUnconfirmedTransactionsRIBSLVinInner>), List<GetTransactionDetailsByTransactionIDRIBSLVoutInner> vout = default(List<GetTransactionDetailsByTransactionIDRIBSLVoutInner>))
        {
            ...
            if (vin == null)
            {
                throw new ArgumentNullException("vin is a required property for ListAllUnconfirmedTransactionsRIBSL and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null)
            {
                throw new ArgumentNullException("vout is a required property for ListAllUnconfirmedTransactionsRIBSL and cannot be null");
            }
            this.Vout = vout;
        }
        ...
        public List<ListAllUnconfirmedTransactionsRIBSLVinInner> Vin { get; set; }
        ...
        {
            return this.Equals(input as ListAllUnconfirmedTransactionsRIBSL);
        }

        /// <summary>
        /// Returns true if ListAllUnconfirmedTransactionsRIBSL instances are equal
        /// </summary>
        /// <param name="input">Instance of ListAllUnconfirmedTransactionsRIBSL to be compared</param>
        /// <returns>Boolean</returns>
