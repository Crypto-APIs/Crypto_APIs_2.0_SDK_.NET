...
namespace CryptoAPIs.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(GetRawTransactionDataE403JsonConverter))]
    [DataContract(Name = "GetRawTransactionDataE403")]
    public partial class GetRawTransactionDataE403 : AbstractOpenAPISchema, IEquatable<GetRawTransactionDataE403>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetRawTransactionDataE403" /> class
        /// with the <see cref="BannedIpAddress" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of BannedIpAddress.</param>
        public GetRawTransactionDataE403(BannedIpAddress actualInstance)
        {
        ...
        public GetRawTransactionDataE403(EndpointNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public GetRawTransactionDataE403(EndpointNotAllowedForApiKey actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public GetRawTransactionDataE403(FeatureMainnetsNotAllowedForPlan actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetRawTransactionDataE403 {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, GetRawTransactionDataE403.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of GetRawTransactionDataE403
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of GetRawTransactionDataE403</returns>
        public static GetRawTransactionDataE403 FromJson(string jsonString)
        {
            GetRawTransactionDataE403 newGetRawTransactionDataE403 = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newGetRawTransactionDataE403;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newGetRawTransactionDataE403 = new GetRawTransactionDataE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, GetRawTransactionDataE403.SerializerSettings));
                }
                else
                {
                    newGetRawTransactionDataE403 = new GetRawTransactionDataE403(JsonConvert.DeserializeObject<BannedIpAddress>(jsonString, GetRawTransactionDataE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newGetRawTransactionDataE403 = new GetRawTransactionDataE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, GetRawTransactionDataE403.SerializerSettings));
                }
                else
                {
                    newGetRawTransactionDataE403 = new GetRawTransactionDataE403(JsonConvert.DeserializeObject<EndpointNotAllowedForApiKey>(jsonString, GetRawTransactionDataE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newGetRawTransactionDataE403 = new GetRawTransactionDataE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, GetRawTransactionDataE403.SerializerSettings));
                }
                else
                {
                    newGetRawTransactionDataE403 = new GetRawTransactionDataE403(JsonConvert.DeserializeObject<EndpointNotAllowedForPlan>(jsonString, GetRawTransactionDataE403.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newGetRawTransactionDataE403 = new GetRawTransactionDataE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, GetRawTransactionDataE403.SerializerSettings));
                }
                else
                {
                    newGetRawTransactionDataE403 = new GetRawTransactionDataE403(JsonConvert.DeserializeObject<FeatureMainnetsNotAllowedForPlan>(jsonString, GetRawTransactionDataE403.AdditionalPropertiesSerializerSettings));
                }
        ...
        {
            return this.Equals(input as GetRawTransactionDataE403);
        }

        /// <summary>
        /// Returns true if GetRawTransactionDataE403 instances are equal
        /// </summary>
        /// <param name="input">Instance of GetRawTransactionDataE403 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetRawTransactionDataE403 input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for GetRawTransactionDataE403
    /// </summary>
    public class GetRawTransactionDataE403JsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(GetRawTransactionDataE403).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return GetRawTransactionDataE403.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
