...
namespace CryptoAPIs.Model
{
    ...
    public partial class ListConfirmedTransactionsByAddressRIBSEC : IEquatable<ListConfirmedTransactionsByAddressRIBSEC>, IValidatableObject
    {
        ...
        public ListConfirmedTransactionsByAddressRIBSEC(string contract = default(string), string gasLimit = default(string), ListConfirmedTransactionsByAddressRIBSECGasPrice gasPrice = default(ListConfirmedTransactionsByAddressRIBSECGasPrice), string gasUsed = default(string), string inputData = default(string), int nonce = default(int), string transactionStatus = default(string))
        {
