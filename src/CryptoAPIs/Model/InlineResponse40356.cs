...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40356
    /// </summary>
    [DataContract(Name = "inline_response_403_56")]
    public partial class InlineResponse40356 : IEquatable<InlineResponse40356>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40356" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40356() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40356" /> class.
        /// </summary>
        ...
        public InlineResponse40356(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListInternalTransactionsByAddressE403 error = default(ListInternalTransactionsByAddressE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40356 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40356 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40356 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40356 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40356);
        }

        /// <summary>
        /// Returns true if InlineResponse40356 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40356 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40356 input)
        {
            if (input == null)
            {
                return false;
