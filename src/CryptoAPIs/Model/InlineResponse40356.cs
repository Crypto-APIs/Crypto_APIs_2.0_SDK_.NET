...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40356 : IEquatable<InlineResponse40356>, IValidatableObject
    {
        ...
        public InlineResponse40356(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListTokensByAddressE403 error = default(ListTokensByAddressE403))
        {
