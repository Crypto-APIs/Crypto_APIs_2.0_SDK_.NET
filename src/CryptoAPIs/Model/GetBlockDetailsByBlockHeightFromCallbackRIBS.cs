...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetBlockDetailsByBlockHeightFromCallbackRIBS : AbstractOpenAPISchema, IEquatable<GetBlockDetailsByBlockHeightFromCallbackRIBS>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHeightFromCallbackRIBS" /> class
        /// with the <see cref="GetBlockDetailsByBlockHeightFromCallbackRIBST" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of GetBlockDetailsByBlockHeightFromCallbackRIBST.</param>
        public GetBlockDetailsByBlockHeightFromCallbackRIBS(GetBlockDetailsByBlockHeightFromCallbackRIBST actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHeightFromCallbackRIBS" /> class
        /// with the <see cref="GetBlockDetailsByBlockHeightFromCallbackRIBSP" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of GetBlockDetailsByBlockHeightFromCallbackRIBSP.</param>
        public GetBlockDetailsByBlockHeightFromCallbackRIBS(GetBlockDetailsByBlockHeightFromCallbackRIBSP actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                ...
                else if (value.GetType() == typeof(GetBlockDetailsByBlockHeightFromCallbackRIBSP))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(GetBlockDetailsByBlockHeightFromCallbackRIBST))
                {
                    this._actualInstance = value;
                }
        ...
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of GetBlockDetailsByBlockHeightFromCallbackRIBST</returns>
        public GetBlockDetailsByBlockHeightFromCallbackRIBST GetGetBlockDetailsByBlockHeightFromCallbackRIBST()
        {
            return (GetBlockDetailsByBlockHeightFromCallbackRIBST)this.ActualInstance;
        }
        ...
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of GetBlockDetailsByBlockHeightFromCallbackRIBSP</returns>
        public GetBlockDetailsByBlockHeightFromCallbackRIBSP GetGetBlockDetailsByBlockHeightFromCallbackRIBSP()
        {
            return (GetBlockDetailsByBlockHeightFromCallbackRIBSP)this.ActualInstance;
        }
        ...
        public static GetBlockDetailsByBlockHeightFromCallbackRIBS FromJson(string jsonString)
        {
            ...
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(GetBlockDetailsByBlockHeightFromCallbackRIBSP).GetProperty("AdditionalProperties") == null)
                {
                    newGetBlockDetailsByBlockHeightFromCallbackRIBS = new GetBlockDetailsByBlockHeightFromCallbackRIBS(JsonConvert.DeserializeObject<GetBlockDetailsByBlockHeightFromCallbackRIBSP>(jsonString, GetBlockDetailsByBlockHeightFromCallbackRIBS.SerializerSettings));
                }
                else
                {
                    newGetBlockDetailsByBlockHeightFromCallbackRIBS = new GetBlockDetailsByBlockHeightFromCallbackRIBS(JsonConvert.DeserializeObject<GetBlockDetailsByBlockHeightFromCallbackRIBSP>(jsonString, GetBlockDetailsByBlockHeightFromCallbackRIBS.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("GetBlockDetailsByBlockHeightFromCallbackRIBSP");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into GetBlockDetailsByBlockHeightFromCallbackRIBSP: {1}", jsonString, exception.ToString()));
            }

            try
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(GetBlockDetailsByBlockHeightFromCallbackRIBST).GetProperty("AdditionalProperties") == null)
                {
                    newGetBlockDetailsByBlockHeightFromCallbackRIBS = new GetBlockDetailsByBlockHeightFromCallbackRIBS(JsonConvert.DeserializeObject<GetBlockDetailsByBlockHeightFromCallbackRIBST>(jsonString, GetBlockDetailsByBlockHeightFromCallbackRIBS.SerializerSettings));
                }
                else
                {
                    newGetBlockDetailsByBlockHeightFromCallbackRIBS = new GetBlockDetailsByBlockHeightFromCallbackRIBS(JsonConvert.DeserializeObject<GetBlockDetailsByBlockHeightFromCallbackRIBST>(jsonString, GetBlockDetailsByBlockHeightFromCallbackRIBS.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("GetBlockDetailsByBlockHeightFromCallbackRIBST");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into GetBlockDetailsByBlockHeightFromCallbackRIBST: {1}", jsonString, exception.ToString()));
            }
