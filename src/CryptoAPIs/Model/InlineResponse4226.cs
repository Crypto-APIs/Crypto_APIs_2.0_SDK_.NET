...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse4226
    /// </summary>
    [DataContract(Name = "inline_response_422_6")]
    public partial class InlineResponse4226 : IEquatable<InlineResponse4226>, IValidatableObject
    {
        ...
        public InlineResponse4226(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetExchangeRateByAssetSymbolsE422 error = default(GetExchangeRateByAssetSymbolsE422))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse4226 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse4226 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse4226 and cannot be null");
            }
            this.Error = error;
