...
namespace CryptoAPIs.Model
{
    ...
    /// EstimateGasLimitR
    /// </summary>
    [DataContract(Name = "EstimateGasLimitR")]
    public partial class EstimateGasLimitR : IEquatable<EstimateGasLimitR>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EstimateGasLimitR" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EstimateGasLimitR() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EstimateGasLimitR" /> class.
        /// </summary>
        ...
        public EstimateGasLimitR(string apiVersion = default(string), string requestId = default(string), string context = default(string), EstimateGasLimitRData data = default(EstimateGasLimitRData))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for EstimateGasLimitR and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for EstimateGasLimitR and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for EstimateGasLimitR and cannot be null");
            }
            this.Data = data;
        ...
        public EstimateGasLimitRData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EstimateGasLimitR {\n");
        ...
        {
            return this.Equals(input as EstimateGasLimitR);
        }

        /// <summary>
        /// Returns true if EstimateGasLimitR instances are equal
        /// </summary>
        /// <param name="input">Instance of EstimateGasLimitR to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EstimateGasLimitR input)
        {
            if (input == null)
            {
                return false;
