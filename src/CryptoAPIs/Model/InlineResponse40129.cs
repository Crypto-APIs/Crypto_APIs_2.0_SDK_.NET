...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40129 : IEquatable<InlineResponse40129>, IValidatableObject
    {
        ...
        public InlineResponse40129(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetZilliqaBlockDetailsByBlockHeightE401 error = default(GetZilliqaBlockDetailsByBlockHeightE401))
        {
