...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40129
    /// </summary>
    [DataContract(Name = "inline_response_401_29")]
    public partial class InlineResponse40129 : IEquatable<InlineResponse40129>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40129" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40129() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40129" /> class.
        /// </summary>
        ...
        public InlineResponse40129(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListUnconfirmedOmniTransactionsByPropertyIDE401 error = default(ListUnconfirmedOmniTransactionsByPropertyIDE401))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40129 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40129 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for InlineResponse40129 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40129 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40129);
        }

        /// <summary>
        /// Returns true if InlineResponse40129 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40129 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40129 input)
        {
            if (input == null)
            {
                return false;
