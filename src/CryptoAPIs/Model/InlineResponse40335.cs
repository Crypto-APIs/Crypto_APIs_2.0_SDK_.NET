...
namespace CryptoAPIs.Model
{
    ...
    public partial class InlineResponse40335 : IEquatable<InlineResponse40335>, IValidatableObject
    {
        ...
        public InlineResponse40335(string apiVersion = default(string), string requestId = default(string), string context = default(string), ListSupportedTokensE403 error = default(ListSupportedTokensE403))
        {
