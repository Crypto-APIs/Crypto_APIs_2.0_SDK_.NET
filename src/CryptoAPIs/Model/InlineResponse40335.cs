...
namespace CryptoAPIs.Model
{
    ...
    /// InlineResponse40335
    /// </summary>
    [DataContract(Name = "inline_response_403_35")]
    public partial class InlineResponse40335 : IEquatable<InlineResponse40335>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40335" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse40335() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse40335" /> class.
        /// </summary>
        ...
        public InlineResponse40335(string apiVersion = default(string), string requestId = default(string), string context = default(string), GetWalletAssetDetailsE403 error = default(GetWalletAssetDetailsE403))
        {
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null) {
                throw new ArgumentNullException("apiVersion is a required property for InlineResponse40335 and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "requestId" is required (not null)
            if (requestId == null) {
                throw new ArgumentNullException("requestId is a required property for InlineResponse40335 and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "error" is required (not null)
            if (error == null) {
                throw new ArgumentNullException("error is a required property for InlineResponse40335 and cannot be null");
            }
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse40335 {\n");
        ...
        {
            return this.Equals(input as InlineResponse40335);
        }

        /// <summary>
        /// Returns true if InlineResponse40335 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse40335 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse40335 input)
        {
            if (input == null)
            {
                return false;
