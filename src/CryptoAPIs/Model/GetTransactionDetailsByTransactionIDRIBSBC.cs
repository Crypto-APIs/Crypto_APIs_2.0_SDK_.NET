...
namespace CryptoAPIs.Model
{
    ...
    public partial class GetTransactionDetailsByTransactionIDRIBSBC : IEquatable<GetTransactionDetailsByTransactionIDRIBSBC>, IValidatableObject
    {
        ...
        public GetTransactionDetailsByTransactionIDRIBSBC(int locktime = default(int), int size = default(int), int version = default(int), List<GetTransactionDetailsByTransactionIDRIBSBCVin> vin = default(List<GetTransactionDetailsByTransactionIDRIBSBCVin>), List<GetTransactionDetailsByTransactionIDRIBSBCVout> vout = default(List<GetTransactionDetailsByTransactionIDRIBSBCVout>))
        {
            ...
            if (vin == null) {
                throw new ArgumentNullException("vin is a required property for GetTransactionDetailsByTransactionIDRIBSBC and cannot be null");
            }
            this.Vin = vin;
            // to ensure "vout" is required (not null)
            if (vout == null) {
                throw new ArgumentNullException("vout is a required property for GetTransactionDetailsByTransactionIDRIBSBC and cannot be null");
            }
            this.Vout = vout;
        }
