...
namespace CryptoAPIs.Model
{
    ...
    /// Bitcoin Cash
    /// </summary>
    [DataContract(Name = "GetTransactionDetailsByTransactionIDRIBSBC")]
    public partial class GetTransactionDetailsByTransactionIDRIBSBC : IEquatable<GetTransactionDetailsByTransactionIDRIBSBC>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDRIBSBC" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetTransactionDetailsByTransactionIDRIBSBC() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDRIBSBC" /> class.
        /// </summary>
        ...
        public GetTransactionDetailsByTransactionIDRIBSBC(int locktime = default(int), int size = default(int), int version = default(int), List<GetTransactionDetailsByTransactionIDRIBSBCVin> vin = default(List<GetTransactionDetailsByTransactionIDRIBSBCVin>), List<GetTransactionDetailsByTransactionIDRIBSBCVout> vout = default(List<GetTransactionDetailsByTransactionIDRIBSBCVout>))
        {
            this.Locktime = locktime;
            this.Size = size;
            this.Version = version;
            // to ensure "vin" is required (not null)
            this.Vin = vin ?? throw new ArgumentNullException("vin is a required property for GetTransactionDetailsByTransactionIDRIBSBC and cannot be null");
            // to ensure "vout" is required (not null)
            this.Vout = vout ?? throw new ArgumentNullException("vout is a required property for GetTransactionDetailsByTransactionIDRIBSBC and cannot be null");
        }
        ...
        {
            return this.Equals(input as GetTransactionDetailsByTransactionIDRIBSBC);
        }

        /// <summary>
        /// Returns true if GetTransactionDetailsByTransactionIDRIBSBC instances are equal
        /// </summary>
        /// <param name="input">Instance of GetTransactionDetailsByTransactionIDRIBSBC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetTransactionDetailsByTransactionIDRIBSBC input)
        {
            if (input == null)
                return false;
