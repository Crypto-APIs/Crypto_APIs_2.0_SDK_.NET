...
namespace CryptoAPIs.Api
{
    ...
    public interface IExchangeRatesApiSync : IApiAccessor
    {
        ...
        /// <param name="calculationTimestamp">Defines the time of the market data used to calculate the exchange rate in UNIX Timestamp. Oldest possible timestamp is 30 days. (optional)</param>
