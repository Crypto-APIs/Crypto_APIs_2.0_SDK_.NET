...
namespace CryptoAPIs.Api
{
    ...
    public interface IAutomaticTokensForwardingApiSync : IApiAccessor
    {
        ...
        ListTokensForwardingAutomationsR ListTokensForwardingAutomations(string blockchain, string network, string context = default(string), long? limit = default(long?), long? offset = default(long?), int operationIndex = 0);
        ...
        ApiResponse<ListTokensForwardingAutomationsR> ListTokensForwardingAutomationsWithHttpInfo(string blockchain, string network, string context = default(string), long? limit = default(long?), long? offset = default(long?), int operationIndex = 0);
    ...
    public interface IAutomaticTokensForwardingApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ListTokensForwardingAutomationsR> ListTokensForwardingAutomationsAsync(string blockchain, string network, string context = default(string), long? limit = default(long?), long? offset = default(long?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ListTokensForwardingAutomationsR>> ListTokensForwardingAutomationsWithHttpInfoAsync(string blockchain, string network, string context = default(string), long? limit = default(long?), long? offset = default(long?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class AutomaticTokensForwardingApi : IAutomaticTokensForwardingApi
    {
        ...
        /// <summary>
        /// Get Fee Address Details Through this endpoint customers can obtain details about a fee address. Only one fee address per currency per network for a user&#39;s account can be set no matter how many tokens or subscriptions they have or want to automatically forward.    {warning}Currently we support fungible tokens (ERC-20) **only**, NFTs (ERC-721) are **not** supported.{/warning}
        /// </summary>
        /// <exception cref="CryptoAPIs.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="blockchain">Represents the specific blockchain protocol name, e.g. Ethereum, Bitcoin, etc.</param>
        /// <param name="network">Represents the name of the blockchain network used; blockchain networks are usually identical as technology and software, but they differ in data, e.g. - \&quot;mainnet\&quot; is the live network with actual data while networks like \&quot;testnet\&quot;, \&quot;ropsten\&quot; are test networks.</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ListTokensForwardingAutomationsR</returns>
        public ListTokensForwardingAutomationsR ListTokensForwardingAutomations(string blockchain, string network, string context = default(string), long? limit = default(long?), long? offset = default(long?), int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ListTokensForwardingAutomationsR</returns>
        public CryptoAPIs.Client.ApiResponse<ListTokensForwardingAutomationsR> ListTokensForwardingAutomationsWithHttpInfo(string blockchain, string network, string context = default(string), long? limit = default(long?), long? offset = default(long?), int operationIndex = 0)
        {
            // verify the required parameter 'blockchain' is set
            if (blockchain == null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ListTokensForwardingAutomationsR</returns>
        public async System.Threading.Tasks.Task<ListTokensForwardingAutomationsR> ListTokensForwardingAutomationsAsync(string blockchain, string network, string context = default(string), long? limit = default(long?), long? offset = default(long?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
