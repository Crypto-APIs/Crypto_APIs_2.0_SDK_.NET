...
namespace CryptoAPIs.Api
{
    ...
    public interface IManageSubscriptionsApiSync : IApiAccessor
    {
        ...
        ListBlockchainEventsSubscriptionsR ListBlockchainEventsSubscriptions(string blockchain, string network, string context = default(string), long? limit = default(long?), long? offset = default(long?), int operationIndex = 0);
        ...
        ApiResponse<ListBlockchainEventsSubscriptionsR> ListBlockchainEventsSubscriptionsWithHttpInfo(string blockchain, string network, string context = default(string), long? limit = default(long?), long? offset = default(long?), int operationIndex = 0);
    ...
    public interface IManageSubscriptionsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<ListBlockchainEventsSubscriptionsR>> ListBlockchainEventsSubscriptionsWithHttpInfoAsync(string blockchain, string network, string context = default(string), long? limit = default(long?), long? offset = default(long?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ManageSubscriptionsApi : IManageSubscriptionsApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ListBlockchainEventsSubscriptionsR</returns>
        public ListBlockchainEventsSubscriptionsR ListBlockchainEventsSubscriptions(string blockchain, string network, string context = default(string), long? limit = default(long?), long? offset = default(long?), int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ListBlockchainEventsSubscriptionsR</returns>
        public CryptoAPIs.Client.ApiResponse<ListBlockchainEventsSubscriptionsR> ListBlockchainEventsSubscriptionsWithHttpInfo(string blockchain, string network, string context = default(string), long? limit = default(long?), long? offset = default(long?), int operationIndex = 0)
        {
            // verify the required parameter 'blockchain' is set
            if (blockchain == null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ListBlockchainEventsSubscriptionsR)</returns>
        public async System.Threading.Tasks.Task<CryptoAPIs.Client.ApiResponse<ListBlockchainEventsSubscriptionsR>> ListBlockchainEventsSubscriptionsWithHttpInfoAsync(string blockchain, string network, string context = default(string), long? limit = default(long?), long? offset = default(long?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'blockchain' is set
            if (blockchain == null)
            {
