...
{
    /// <summary>
    ///  Class for testing GeneratingApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class GeneratingApiTests : IDisposable
    {
        private GeneratingApi instance;

        public GeneratingApiTests()
        {
            instance = new GeneratingApi();
        }
        ...
        /// <summary>
        /// Test an instance of GeneratingApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' GeneratingApi
            //Assert.IsType<GeneratingApi>(instance);
        }
