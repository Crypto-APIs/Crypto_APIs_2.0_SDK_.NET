...
namespace CryptoAPIs.Test.Api
{
    ...
    public class FeaturesApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test ConvertBitcoinCashAddress
        /// </summary>
        [Fact]
        public void ConvertBitcoinCashAddressTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string blockchain = null;
            //string network = null;
            //string context = null;
            //ConvertBitcoinCashAddressRB convertBitcoinCashAddressRB = null;
            //var response = instance.ConvertBitcoinCashAddress(blockchain, network, context, convertBitcoinCashAddressRB);
            //Assert.IsType<ConvertBitcoinCashAddressR>(response);
        }
