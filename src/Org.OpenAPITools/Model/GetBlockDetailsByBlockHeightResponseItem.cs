...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetBlockDetailsByBlockHeightResponseItem")]
    public partial class GetBlockDetailsByBlockHeightResponseItem : IEquatable<GetBlockDetailsByBlockHeightResponseItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHeightResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetBlockDetailsByBlockHeightResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHeightResponseItem" /> class.
        /// </summary>
        ...
        public GetBlockDetailsByBlockHeightResponseItem(string hash = default(string), int height = default(int), string nextBlockHash = default(string), string previousBlockHash = default(string), int timestamp = default(int), int transactionsCount = default(int), GetBlockDetailsByBlockHeightResponseItemBlockchainSpecific blockchainSpecific = default(GetBlockDetailsByBlockHeightResponseItemBlockchainSpecific))
        {
            // to ensure "hash" is required (not null)
            this.Hash = hash ?? throw new ArgumentNullException("hash is a required property for GetBlockDetailsByBlockHeightResponseItem and cannot be null");
            this.Height = height;
            // to ensure "nextBlockHash" is required (not null)
            this.NextBlockHash = nextBlockHash ?? throw new ArgumentNullException("nextBlockHash is a required property for GetBlockDetailsByBlockHeightResponseItem and cannot be null");
            // to ensure "previousBlockHash" is required (not null)
            this.PreviousBlockHash = previousBlockHash ?? throw new ArgumentNullException("previousBlockHash is a required property for GetBlockDetailsByBlockHeightResponseItem and cannot be null");
            this.Timestamp = timestamp;
            this.TransactionsCount = transactionsCount;
            // to ensure "blockchainSpecific" is required (not null)
            this.BlockchainSpecific = blockchainSpecific ?? throw new ArgumentNullException("blockchainSpecific is a required property for GetBlockDetailsByBlockHeightResponseItem and cannot be null");
        }
        ...
        public GetBlockDetailsByBlockHeightResponseItemBlockchainSpecific BlockchainSpecific { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetBlockDetailsByBlockHeightResponseItem {\n");
        ...
        {
            return this.Equals(input as GetBlockDetailsByBlockHeightResponseItem);
        }

        /// <summary>
        /// Returns true if GetBlockDetailsByBlockHeightResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of GetBlockDetailsByBlockHeightResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetBlockDetailsByBlockHeightResponseItem input)
        {
            if (input == null)
                return false;
