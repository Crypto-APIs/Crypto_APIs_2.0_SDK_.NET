...
namespace Org.OpenAPITools.Model
{
    ...
    /// NewBlockResponse
    /// </summary>
    [DataContract(Name = "NewBlockResponse")]
    public partial class NewBlockResponse : IEquatable<NewBlockResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewBlockResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewBlockResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewBlockResponse" /> class.
        /// </summary>
        ...
        public NewBlockResponse(string apiVersion = default(string), string requestId = default(string), string context = default(string), NewBlockResponseData data = default(NewBlockResponseData))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for NewBlockResponse and cannot be null");
            // to ensure "requestId" is required (not null)
            this.RequestId = requestId ?? throw new ArgumentNullException("requestId is a required property for NewBlockResponse and cannot be null");
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for NewBlockResponse and cannot be null");
        ...
        public NewBlockResponseData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewBlockResponse {\n");
        ...
        {
            return this.Equals(input as NewBlockResponse);
        }

        /// <summary>
        /// Returns true if NewBlockResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of NewBlockResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewBlockResponse input)
        {
            if (input == null)
                return false;
