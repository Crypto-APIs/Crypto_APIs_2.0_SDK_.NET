...
namespace Org.OpenAPITools.Model
{
    ...
    /// InvalidApiKeyError
    /// </summary>
    [DataContract(Name = "InvalidApiKey_error")]
    public partial class InvalidApiKeyError : IEquatable<InvalidApiKeyError>, IValidatableObject
    {
        ...
        public InvalidApiKeyError(string code = default(string), string message = default(string), List<BannedIpAddressErrorDetails> details = default(List<BannedIpAddressErrorDetails>))
        {
            // to ensure "code" is required (not null)
            this.Code = code ?? throw new ArgumentNullException("code is a required property for InvalidApiKeyError and cannot be null");
            // to ensure "message" is required (not null)
            this.Message = message ?? throw new ArgumentNullException("message is a required property for InvalidApiKeyError and cannot be null");
