...
namespace Org.OpenAPITools.Model
{
    ...
    /// Litecoin
    /// </summary>
    [DataContract(Name = "GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin")]
    public partial class GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin : IEquatable<GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin" /> class.
        /// </summary>
        ...
        public GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin(string difficulty = default(string), string nonce = default(string), int size = default(int), string bits = default(string), string chainwork = default(string), string merkleRoot = default(string), int strippedSize = default(int), int version = default(int), string versionHex = default(string), int weight = default(int))
        {
            // to ensure "difficulty" is required (not null)
            this.Difficulty = difficulty ?? throw new ArgumentNullException("difficulty is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin and cannot be null");
            // to ensure "nonce" is required (not null)
            this.Nonce = nonce ?? throw new ArgumentNullException("nonce is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin and cannot be null");
            this.Size = size;
            // to ensure "bits" is required (not null)
            this.Bits = bits ?? throw new ArgumentNullException("bits is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin and cannot be null");
            // to ensure "chainwork" is required (not null)
            this.Chainwork = chainwork ?? throw new ArgumentNullException("chainwork is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin and cannot be null");
            // to ensure "merkleRoot" is required (not null)
            this.MerkleRoot = merkleRoot ?? throw new ArgumentNullException("merkleRoot is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin and cannot be null");
            this.StrippedSize = strippedSize;
            this.Version = version;
            // to ensure "versionHex" is required (not null)
            this.VersionHex = versionHex ?? throw new ArgumentNullException("versionHex is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin and cannot be null");
            this.Weight = weight;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin {\n");
        ...
        {
            return this.Equals(input as GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin);
        }

        /// <summary>
        /// Returns true if GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin instances are equal
        /// </summary>
        /// <param name="input">Instance of GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin input)
        {
            if (input == null)
                return false;
