...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCash_vin")]
    public partial class ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin : IEquatable<ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin" /> class.
        /// </summary>
        ...
        public ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin(List<string> addresses = default(List<string>), string coinbase = default(string), GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig scriptSig = default(GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig), string sequence = default(string), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            this.Addresses = addresses ?? throw new ArgumentNullException("addresses is a required property for ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin and cannot be null");
            // to ensure "coinbase" is required (not null)
            this.Coinbase = coinbase ?? throw new ArgumentNullException("coinbase is a required property for ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin and cannot be null");
            // to ensure "scriptSig" is required (not null)
            this.ScriptSig = scriptSig ?? throw new ArgumentNullException("scriptSig is a required property for ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin and cannot be null");
            // to ensure "sequence" is required (not null)
            this.Sequence = sequence ?? throw new ArgumentNullException("sequence is a required property for ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin and cannot be null");
            // to ensure "txid" is required (not null)
            this.Txid = txid ?? throw new ArgumentNullException("txid is a required property for ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin and cannot be null");
            // to ensure "txinwitness" is required (not null)
            this.Txinwitness = txinwitness ?? throw new ArgumentNullException("txinwitness is a required property for ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin and cannot be null");
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin and cannot be null");
            this.Vout = vout;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin {\n");
        ...
        {
            return this.Equals(input as ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin);
        }

        /// <summary>
        /// Returns true if ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin input)
        {
            if (input == null)
                return false;
