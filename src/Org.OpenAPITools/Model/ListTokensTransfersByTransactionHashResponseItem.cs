...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListTokensTransfersByTransactionHashResponseItem")]
    public partial class ListTokensTransfersByTransactionHashResponseItem : IEquatable<ListTokensTransfersByTransactionHashResponseItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTokensTransfersByTransactionHashResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTokensTransfersByTransactionHashResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTokensTransfersByTransactionHashResponseItem" /> class.
        /// </summary>
        ...
        public ListTokensTransfersByTransactionHashResponseItem(string contractAddress = default(string), int minedInBlockHeight = default(int), string recipientAddress = default(string), string senderAddress = default(string), int tokenDecimals = default(int), string tokenName = default(string), string tokenSymbol = default(string), string tokenType = default(string), string tokensAmount = default(string), string transactionHash = default(string), int transactionTimestamp = default(int))
        {
            // to ensure "contractAddress" is required (not null)
            this.ContractAddress = contractAddress ?? throw new ArgumentNullException("contractAddress is a required property for ListTokensTransfersByTransactionHashResponseItem and cannot be null");
            this.MinedInBlockHeight = minedInBlockHeight;
            // to ensure "recipientAddress" is required (not null)
            this.RecipientAddress = recipientAddress ?? throw new ArgumentNullException("recipientAddress is a required property for ListTokensTransfersByTransactionHashResponseItem and cannot be null");
            // to ensure "senderAddress" is required (not null)
            this.SenderAddress = senderAddress ?? throw new ArgumentNullException("senderAddress is a required property for ListTokensTransfersByTransactionHashResponseItem and cannot be null");
            this.TokenDecimals = tokenDecimals;
            // to ensure "tokenName" is required (not null)
            this.TokenName = tokenName ?? throw new ArgumentNullException("tokenName is a required property for ListTokensTransfersByTransactionHashResponseItem and cannot be null");
            // to ensure "tokenSymbol" is required (not null)
            this.TokenSymbol = tokenSymbol ?? throw new ArgumentNullException("tokenSymbol is a required property for ListTokensTransfersByTransactionHashResponseItem and cannot be null");
            // to ensure "tokenType" is required (not null)
            this.TokenType = tokenType ?? throw new ArgumentNullException("tokenType is a required property for ListTokensTransfersByTransactionHashResponseItem and cannot be null");
            // to ensure "tokensAmount" is required (not null)
            this.TokensAmount = tokensAmount ?? throw new ArgumentNullException("tokensAmount is a required property for ListTokensTransfersByTransactionHashResponseItem and cannot be null");
            // to ensure "transactionHash" is required (not null)
            this.TransactionHash = transactionHash ?? throw new ArgumentNullException("transactionHash is a required property for ListTokensTransfersByTransactionHashResponseItem and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListTokensTransfersByTransactionHashResponseItem {\n");
        ...
        {
            return this.Equals(input as ListTokensTransfersByTransactionHashResponseItem);
        }

        /// <summary>
        /// Returns true if ListTokensTransfersByTransactionHashResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTokensTransfersByTransactionHashResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTokensTransfersByTransactionHashResponseItem input)
        {
            if (input == null)
                return false;
