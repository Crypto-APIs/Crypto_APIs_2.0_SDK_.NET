...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetHDWalletxPubYPubZPubDetailsResponseItem")]
    public partial class GetHDWalletxPubYPubZPubDetailsResponseItem : IEquatable<GetHDWalletxPubYPubZPubDetailsResponseItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetHDWalletxPubYPubZPubDetailsResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetHDWalletxPubYPubZPubDetailsResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetHDWalletxPubYPubZPubDetailsResponseItem" /> class.
        /// </summary>
        ...
        public GetHDWalletxPubYPubZPubDetailsResponseItem(string confirmedBalance = default(string), string totalReceived = default(string), string totalSpent = default(string))
        {
            // to ensure "confirmedBalance" is required (not null)
            this.ConfirmedBalance = confirmedBalance ?? throw new ArgumentNullException("confirmedBalance is a required property for GetHDWalletxPubYPubZPubDetailsResponseItem and cannot be null");
            // to ensure "totalReceived" is required (not null)
            this.TotalReceived = totalReceived ?? throw new ArgumentNullException("totalReceived is a required property for GetHDWalletxPubYPubZPubDetailsResponseItem and cannot be null");
            // to ensure "totalSpent" is required (not null)
            this.TotalSpent = totalSpent ?? throw new ArgumentNullException("totalSpent is a required property for GetHDWalletxPubYPubZPubDetailsResponseItem and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetHDWalletxPubYPubZPubDetailsResponseItem {\n");
        ...
        {
            return this.Equals(input as GetHDWalletxPubYPubZPubDetailsResponseItem);
        }

        /// <summary>
        /// Returns true if GetHDWalletxPubYPubZPubDetailsResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of GetHDWalletxPubYPubZPubDetailsResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetHDWalletxPubYPubZPubDetailsResponseItem input)
        {
            if (input == null)
                return false;
