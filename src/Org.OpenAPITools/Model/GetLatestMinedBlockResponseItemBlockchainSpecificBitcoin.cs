...
namespace Org.OpenAPITools.Model
{
    ...
    /// Bitcoin
    /// </summary>
    [DataContract(Name = "GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin")]
    public partial class GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin : IEquatable<GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin" /> class.
        /// </summary>
        ...
        public GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin(string difficulty = default(string), string nonce = default(string), int size = default(int), string bits = default(string), string chainwork = default(string), string merkleRoot = default(string), int strippedSize = default(int), int version = default(int), string versionHex = default(string), int weight = default(int))
        {
            // to ensure "difficulty" is required (not null)
            this.Difficulty = difficulty ?? throw new ArgumentNullException("difficulty is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin and cannot be null");
            // to ensure "nonce" is required (not null)
            this.Nonce = nonce ?? throw new ArgumentNullException("nonce is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin and cannot be null");
            this.Size = size;
            // to ensure "bits" is required (not null)
            this.Bits = bits ?? throw new ArgumentNullException("bits is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin and cannot be null");
            // to ensure "chainwork" is required (not null)
            this.Chainwork = chainwork ?? throw new ArgumentNullException("chainwork is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin and cannot be null");
            // to ensure "merkleRoot" is required (not null)
            this.MerkleRoot = merkleRoot ?? throw new ArgumentNullException("merkleRoot is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin and cannot be null");
            this.StrippedSize = strippedSize;
            this.Version = version;
            // to ensure "versionHex" is required (not null)
            this.VersionHex = versionHex ?? throw new ArgumentNullException("versionHex is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin and cannot be null");
            this.Weight = weight;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin {\n");
        ...
        {
            return this.Equals(input as GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin);
        }

        /// <summary>
        /// Returns true if GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin instances are equal
        /// </summary>
        /// <param name="input">Instance of GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin input)
        {
            if (input == null)
                return false;
