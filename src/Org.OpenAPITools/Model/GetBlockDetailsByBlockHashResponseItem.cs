...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetBlockDetailsByBlockHashResponseItem")]
    public partial class GetBlockDetailsByBlockHashResponseItem : IEquatable<GetBlockDetailsByBlockHashResponseItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHashResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetBlockDetailsByBlockHashResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHashResponseItem" /> class.
        /// </summary>
        ...
        public GetBlockDetailsByBlockHashResponseItem(string hash = default(string), int height = default(int), string nextBlockHash = default(string), string previousBlockHash = default(string), int timestamp = default(int), int transactionsCount = default(int), GetBlockDetailsByBlockHashResponseItemBlockchainSpecific blockchainSpecific = default(GetBlockDetailsByBlockHashResponseItemBlockchainSpecific))
        {
            // to ensure "hash" is required (not null)
            this.Hash = hash ?? throw new ArgumentNullException("hash is a required property for GetBlockDetailsByBlockHashResponseItem and cannot be null");
            this.Height = height;
            // to ensure "nextBlockHash" is required (not null)
            this.NextBlockHash = nextBlockHash ?? throw new ArgumentNullException("nextBlockHash is a required property for GetBlockDetailsByBlockHashResponseItem and cannot be null");
            // to ensure "previousBlockHash" is required (not null)
            this.PreviousBlockHash = previousBlockHash ?? throw new ArgumentNullException("previousBlockHash is a required property for GetBlockDetailsByBlockHashResponseItem and cannot be null");
            this.Timestamp = timestamp;
            this.TransactionsCount = transactionsCount;
            // to ensure "blockchainSpecific" is required (not null)
            this.BlockchainSpecific = blockchainSpecific ?? throw new ArgumentNullException("blockchainSpecific is a required property for GetBlockDetailsByBlockHashResponseItem and cannot be null");
        }
        ...
        public GetBlockDetailsByBlockHashResponseItemBlockchainSpecific BlockchainSpecific { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetBlockDetailsByBlockHashResponseItem {\n");
        ...
        {
            return this.Equals(input as GetBlockDetailsByBlockHashResponseItem);
        }

        /// <summary>
        /// Returns true if GetBlockDetailsByBlockHashResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of GetBlockDetailsByBlockHashResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetBlockDetailsByBlockHashResponseItem input)
        {
            if (input == null)
                return false;
