...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListTransactionsByAddressResponseItemBlockchainSpecificDogecoin_vin")]
    public partial class ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin : IEquatable<ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin" /> class.
        /// </summary>
        ...
        public ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin(List<string> addresses = default(List<string>), string coinbase = default(string), ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinScriptSig scriptSig = default(ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinScriptSig), string sequence = default(string), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            this.Addresses = addresses ?? throw new ArgumentNullException("addresses is a required property for ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin and cannot be null");
            // to ensure "coinbase" is required (not null)
            this.Coinbase = coinbase ?? throw new ArgumentNullException("coinbase is a required property for ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin and cannot be null");
            // to ensure "scriptSig" is required (not null)
            this.ScriptSig = scriptSig ?? throw new ArgumentNullException("scriptSig is a required property for ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin and cannot be null");
            // to ensure "sequence" is required (not null)
            this.Sequence = sequence ?? throw new ArgumentNullException("sequence is a required property for ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin and cannot be null");
            // to ensure "txinwitness" is required (not null)
            this.Txinwitness = txinwitness ?? throw new ArgumentNullException("txinwitness is a required property for ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin and cannot be null");
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin and cannot be null");
            this.Txid = txid;
            this.Vout = vout;
        }
        ...
        public ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinScriptSig ScriptSig { get; set; }
        ...
        {
            return this.Equals(input as ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin);
        }

        /// <summary>
        /// Returns true if ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin input)
        {
            if (input == null)
                return false;
