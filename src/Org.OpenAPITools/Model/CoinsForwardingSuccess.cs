...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CoinsForwardingSuccess")]
    public partial class CoinsForwardingSuccess : IEquatable<CoinsForwardingSuccess>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoinsForwardingSuccess" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoinsForwardingSuccess() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoinsForwardingSuccess" /> class.
        /// </summary>
        ...
        public CoinsForwardingSuccess(string apiVersion = default(string), string referenceId = default(string), string idempotencyKey = default(string), CoinsForwardingSuccessData data = default(CoinsForwardingSuccessData))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for CoinsForwardingSuccess and cannot be null");
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for CoinsForwardingSuccess and cannot be null");
            // to ensure "idempotencyKey" is required (not null)
            this.IdempotencyKey = idempotencyKey ?? throw new ArgumentNullException("idempotencyKey is a required property for CoinsForwardingSuccess and cannot be null");
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for CoinsForwardingSuccess and cannot be null");
        }
        ...
        public CoinsForwardingSuccessData Data { get; set; }
        ...
        {
            return this.Equals(input as CoinsForwardingSuccess);
        }

        /// <summary>
        /// Returns true if CoinsForwardingSuccess instances are equal
        /// </summary>
        /// <param name="input">Instance of CoinsForwardingSuccess to be compared</param>
        /// <returns>Boolean</returns>
