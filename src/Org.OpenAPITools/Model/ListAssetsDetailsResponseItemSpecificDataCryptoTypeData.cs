...
namespace Org.OpenAPITools.Model
{
    ...
    /// Crypto Type Data
    /// </summary>
    [DataContract(Name = "ListAssetsDetailsResponseItemSpecificDataCryptoTypeData")]
    public partial class ListAssetsDetailsResponseItemSpecificDataCryptoTypeData : IEquatable<ListAssetsDetailsResponseItemSpecificDataCryptoTypeData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAssetsDetailsResponseItemSpecificDataCryptoTypeData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListAssetsDetailsResponseItemSpecificDataCryptoTypeData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAssetsDetailsResponseItemSpecificDataCryptoTypeData" /> class.
        /// </summary>
        ...
        public ListAssetsDetailsResponseItemSpecificDataCryptoTypeData(string _1hourPriceChangeInPercentage = default(string), string _1weekPriceChangeInPercentage = default(string), string _24hoursPriceChangeInPercentage = default(string), string _24hoursTradingVolume = default(string), string circulatingSupply = default(string), string marketCapInUSD = default(string), string maxSupply = default(string))
        {
            // to ensure "_1hourPriceChangeInPercentage" is required (not null)
            this._1HourPriceChangeInPercentage = _1hourPriceChangeInPercentage ?? throw new ArgumentNullException("_1hourPriceChangeInPercentage is a required property for ListAssetsDetailsResponseItemSpecificDataCryptoTypeData and cannot be null");
            // to ensure "_1weekPriceChangeInPercentage" is required (not null)
            this._1WeekPriceChangeInPercentage = _1weekPriceChangeInPercentage ?? throw new ArgumentNullException("_1weekPriceChangeInPercentage is a required property for ListAssetsDetailsResponseItemSpecificDataCryptoTypeData and cannot be null");
            // to ensure "_24hoursPriceChangeInPercentage" is required (not null)
            this._24HoursPriceChangeInPercentage = _24hoursPriceChangeInPercentage ?? throw new ArgumentNullException("_24hoursPriceChangeInPercentage is a required property for ListAssetsDetailsResponseItemSpecificDataCryptoTypeData and cannot be null");
            // to ensure "_24hoursTradingVolume" is required (not null)
            this._24HoursTradingVolume = _24hoursTradingVolume ?? throw new ArgumentNullException("_24hoursTradingVolume is a required property for ListAssetsDetailsResponseItemSpecificDataCryptoTypeData and cannot be null");
            // to ensure "circulatingSupply" is required (not null)
            this.CirculatingSupply = circulatingSupply ?? throw new ArgumentNullException("circulatingSupply is a required property for ListAssetsDetailsResponseItemSpecificDataCryptoTypeData and cannot be null");
            // to ensure "marketCapInUSD" is required (not null)
            this.MarketCapInUSD = marketCapInUSD ?? throw new ArgumentNullException("marketCapInUSD is a required property for ListAssetsDetailsResponseItemSpecificDataCryptoTypeData and cannot be null");
            // to ensure "maxSupply" is required (not null)
            this.MaxSupply = maxSupply ?? throw new ArgumentNullException("maxSupply is a required property for ListAssetsDetailsResponseItemSpecificDataCryptoTypeData and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListAssetsDetailsResponseItemSpecificDataCryptoTypeData {\n");
        ...
        {
            return this.Equals(input as ListAssetsDetailsResponseItemSpecificDataCryptoTypeData);
        }

        /// <summary>
        /// Returns true if ListAssetsDetailsResponseItemSpecificDataCryptoTypeData instances are equal
        /// </summary>
        /// <param name="input">Instance of ListAssetsDetailsResponseItemSpecificDataCryptoTypeData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListAssetsDetailsResponseItemSpecificDataCryptoTypeData input)
        {
            if (input == null)
                return false;
