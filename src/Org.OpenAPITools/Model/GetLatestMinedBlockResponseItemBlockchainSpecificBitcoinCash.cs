...
namespace Org.OpenAPITools.Model
{
    ...
    /// Bitcoin Cash
    /// </summary>
    [DataContract(Name = "GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash")]
    public partial class GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash : IEquatable<GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash" /> class.
        /// </summary>
        ...
        public GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash(string difficulty = default(string), string nonce = default(string), int size = default(int), string bits = default(string), string chainwork = default(string), string merkleRoot = default(string), int version = default(int), string versionHex = default(string))
        {
            // to ensure "difficulty" is required (not null)
            this.Difficulty = difficulty ?? throw new ArgumentNullException("difficulty is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash and cannot be null");
            // to ensure "nonce" is required (not null)
            this.Nonce = nonce ?? throw new ArgumentNullException("nonce is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash and cannot be null");
            this.Size = size;
            // to ensure "bits" is required (not null)
            this.Bits = bits ?? throw new ArgumentNullException("bits is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash and cannot be null");
            // to ensure "chainwork" is required (not null)
            this.Chainwork = chainwork ?? throw new ArgumentNullException("chainwork is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash and cannot be null");
            // to ensure "merkleRoot" is required (not null)
            this.MerkleRoot = merkleRoot ?? throw new ArgumentNullException("merkleRoot is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash and cannot be null");
            this.Version = version;
            // to ensure "versionHex" is required (not null)
            this.VersionHex = versionHex ?? throw new ArgumentNullException("versionHex is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash {\n");
        ...
        {
            return this.Equals(input as GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash);
        }

        /// <summary>
        /// Returns true if GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash instances are equal
        /// </summary>
        /// <param name="input">Instance of GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash input)
        {
            if (input == null)
                return false;
