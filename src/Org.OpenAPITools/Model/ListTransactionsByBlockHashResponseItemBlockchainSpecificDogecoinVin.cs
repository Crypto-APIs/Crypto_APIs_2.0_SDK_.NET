...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoin_vin")]
    public partial class ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinVin : IEquatable<ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinVin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinVin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinVin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinVin" /> class.
        /// </summary>
        ...
        public ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinVin(List<string> addresses = default(List<string>), string coinbase = default(string), GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinScriptSig scriptSig = default(GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinScriptSig), string sequence = default(string), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            this.Addresses = addresses ?? throw new ArgumentNullException("addresses is a required property for ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinVin and cannot be null");
            // to ensure "scriptSig" is required (not null)
            this.ScriptSig = scriptSig ?? throw new ArgumentNullException("scriptSig is a required property for ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinVin and cannot be null");
            // to ensure "sequence" is required (not null)
            this.Sequence = sequence ?? throw new ArgumentNullException("sequence is a required property for ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinVin and cannot be null");
            // to ensure "txinwitness" is required (not null)
            this.Txinwitness = txinwitness ?? throw new ArgumentNullException("txinwitness is a required property for ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinVin and cannot be null");
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinVin and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinVin {\n");
        ...
        {
            return this.Equals(input as ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinVin);
        }

        /// <summary>
        /// Returns true if ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinVin instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinVin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinVin input)
        {
            if (input == null)
                return false;
