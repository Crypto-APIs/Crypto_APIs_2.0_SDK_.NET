...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetTransactionDetailsByTransactionIDResponseItem")]
    public partial class GetTransactionDetailsByTransactionIDResponseItem : IEquatable<GetTransactionDetailsByTransactionIDResponseItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetTransactionDetailsByTransactionIDResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDResponseItem" /> class.
        /// </summary>
        ...
        public GetTransactionDetailsByTransactionIDResponseItem(int index = default(int), string minedInBlockHash = default(string), int minedInBlockHeight = default(int), List<GetTransactionDetailsByTransactionIDResponseItemRecipients> recipients = default(List<GetTransactionDetailsByTransactionIDResponseItemRecipients>), List<GetTransactionDetailsByTransactionIDResponseItemSenders> senders = default(List<GetTransactionDetailsByTransactionIDResponseItemSenders>), int timestamp = default(int), string transactionHash = default(string), string transactionId = default(string), GetTransactionDetailsByTransactionIDResponseItemFee fee = default(GetTransactionDetailsByTransactionIDResponseItemFee), bool isConfirmed = default(bool), GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecific blockchainSpecific = default(GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecific))
        {
            this.Index = index;
            // to ensure "recipients" is required (not null)
            this.Recipients = recipients ?? throw new ArgumentNullException("recipients is a required property for GetTransactionDetailsByTransactionIDResponseItem and cannot be null");
            // to ensure "senders" is required (not null)
            this.Senders = senders ?? throw new ArgumentNullException("senders is a required property for GetTransactionDetailsByTransactionIDResponseItem and cannot be null");
            this.Timestamp = timestamp;
            // to ensure "transactionHash" is required (not null)
            this.TransactionHash = transactionHash ?? throw new ArgumentNullException("transactionHash is a required property for GetTransactionDetailsByTransactionIDResponseItem and cannot be null");
            // to ensure "transactionId" is required (not null)
            this.TransactionId = transactionId ?? throw new ArgumentNullException("transactionId is a required property for GetTransactionDetailsByTransactionIDResponseItem and cannot be null");
            // to ensure "fee" is required (not null)
            this.Fee = fee ?? throw new ArgumentNullException("fee is a required property for GetTransactionDetailsByTransactionIDResponseItem and cannot be null");
            this.IsConfirmed = isConfirmed;
            // to ensure "blockchainSpecific" is required (not null)
            this.BlockchainSpecific = blockchainSpecific ?? throw new ArgumentNullException("blockchainSpecific is a required property for GetTransactionDetailsByTransactionIDResponseItem and cannot be null");
        ...
        public List<GetTransactionDetailsByTransactionIDResponseItemRecipients> Recipients { get; set; }
        ...
        public List<GetTransactionDetailsByTransactionIDResponseItemSenders> Senders { get; set; }
        ...
        public GetTransactionDetailsByTransactionIDResponseItemFee Fee { get; set; }
        ...
        public GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecific BlockchainSpecific { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetTransactionDetailsByTransactionIDResponseItem {\n");
        ...
        {
            return this.Equals(input as GetTransactionDetailsByTransactionIDResponseItem);
        }

        /// <summary>
        /// Returns true if GetTransactionDetailsByTransactionIDResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of GetTransactionDetailsByTransactionIDResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetTransactionDetailsByTransactionIDResponseItem input)
        {
            if (input == null)
                return false;
