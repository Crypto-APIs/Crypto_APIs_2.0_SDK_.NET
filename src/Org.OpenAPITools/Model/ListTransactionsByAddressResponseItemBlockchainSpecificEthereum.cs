...
namespace Org.OpenAPITools.Model
{
    ...
    /// Ethereum
    /// </summary>
    [DataContract(Name = "ListTransactionsByAddressResponseItemBlockchainSpecificEthereum")]
    public partial class ListTransactionsByAddressResponseItemBlockchainSpecificEthereum : IEquatable<ListTransactionsByAddressResponseItemBlockchainSpecificEthereum>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressResponseItemBlockchainSpecificEthereum" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByAddressResponseItemBlockchainSpecificEthereum() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressResponseItemBlockchainSpecificEthereum" /> class.
        /// </summary>
        ...
        public ListTransactionsByAddressResponseItemBlockchainSpecificEthereum(string contract = default(string), string gasLimit = default(string), ListTransactionsByAddressResponseItemBlockchainSpecificEthereumGasPrice gasPrice = default(ListTransactionsByAddressResponseItemBlockchainSpecificEthereumGasPrice), string gasUsed = default(string), string inputData = default(string), int nonce = default(int))
        {
            // to ensure "contract" is required (not null)
            this.Contract = contract ?? throw new ArgumentNullException("contract is a required property for ListTransactionsByAddressResponseItemBlockchainSpecificEthereum and cannot be null");
            // to ensure "gasLimit" is required (not null)
            this.GasLimit = gasLimit ?? throw new ArgumentNullException("gasLimit is a required property for ListTransactionsByAddressResponseItemBlockchainSpecificEthereum and cannot be null");
            // to ensure "gasPrice" is required (not null)
            this.GasPrice = gasPrice ?? throw new ArgumentNullException("gasPrice is a required property for ListTransactionsByAddressResponseItemBlockchainSpecificEthereum and cannot be null");
            // to ensure "gasUsed" is required (not null)
            this.GasUsed = gasUsed ?? throw new ArgumentNullException("gasUsed is a required property for ListTransactionsByAddressResponseItemBlockchainSpecificEthereum and cannot be null");
            // to ensure "inputData" is required (not null)
            this.InputData = inputData ?? throw new ArgumentNullException("inputData is a required property for ListTransactionsByAddressResponseItemBlockchainSpecificEthereum and cannot be null");
            this.Nonce = nonce;
        }
        ...
        public ListTransactionsByAddressResponseItemBlockchainSpecificEthereumGasPrice GasPrice { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListTransactionsByAddressResponseItemBlockchainSpecificEthereum {\n");
        ...
        {
            return this.Equals(input as ListTransactionsByAddressResponseItemBlockchainSpecificEthereum);
        }

        /// <summary>
        /// Returns true if ListTransactionsByAddressResponseItemBlockchainSpecificEthereum instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByAddressResponseItemBlockchainSpecificEthereum to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByAddressResponseItemBlockchainSpecificEthereum input)
        {
            if (input == null)
                return false;
