...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CoinsForwardingFailData : IEquatable<CoinsForwardingFailData>, IValidatableObject
    {
        ...
        public CoinsForwardingFailData(string product = default(string), string _event = default(string), CoinsForwardingFailDataItem item = default(CoinsForwardingFailDataItem))
        {
            ...
            this.Product = product ?? throw new ArgumentNullException("product is a required property for CoinsForwardingFailData and cannot be null");
            // to ensure "_event" is required (not null)
            this.Event = _event ?? throw new ArgumentNullException("_event is a required property for CoinsForwardingFailData and cannot be null");
            // to ensure "item" is required (not null)
            this.Item = item ?? throw new ArgumentNullException("item is a required property for CoinsForwardingFailData and cannot be null");
        }
