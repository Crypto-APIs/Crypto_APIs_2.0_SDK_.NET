...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListXRPRippleTransactionsByAddressResponseItem")]
    public partial class ListXRPRippleTransactionsByAddressResponseItem : IEquatable<ListXRPRippleTransactionsByAddressResponseItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListXRPRippleTransactionsByAddressResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListXRPRippleTransactionsByAddressResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListXRPRippleTransactionsByAddressResponseItem" /> class.
        /// </summary>
        ...
        public ListXRPRippleTransactionsByAddressResponseItem(string additionalData = default(string), int index = default(int), string minedInBlockHash = default(string), int minedInBlockHeight = default(int), List<GetXRPRippleTransactionDetailsByTransactionIDResponseItemRecipients> recipients = default(List<GetXRPRippleTransactionDetailsByTransactionIDResponseItemRecipients>), List<GetXRPRippleTransactionDetailsByTransactionIDResponseItemSenders> senders = default(List<GetXRPRippleTransactionDetailsByTransactionIDResponseItemSenders>), int sequence = default(int), string status = default(string), int timestamp = default(int), string transactionHash = default(string), string type = default(string), ListXRPRippleTransactionsByAddressResponseItemFee fee = default(ListXRPRippleTransactionsByAddressResponseItemFee), ListXRPRippleTransactionsByAddressResponseItemOffer offer = default(ListXRPRippleTransactionsByAddressResponseItemOffer), ListXRPRippleTransactionsByAddressResponseItemReceive receive = default(ListXRPRippleTransactionsByAddressResponseItemReceive), ListXRPRippleTransactionsByAddressResponseItemValue value = default(ListXRPRippleTransactionsByAddressResponseItemValue))
        {
            // to ensure "additionalData" is required (not null)
            this.AdditionalData = additionalData ?? throw new ArgumentNullException("additionalData is a required property for ListXRPRippleTransactionsByAddressResponseItem and cannot be null");
            this.Index = index;
            // to ensure "minedInBlockHash" is required (not null)
            this.MinedInBlockHash = minedInBlockHash ?? throw new ArgumentNullException("minedInBlockHash is a required property for ListXRPRippleTransactionsByAddressResponseItem and cannot be null");
            this.MinedInBlockHeight = minedInBlockHeight;
            // to ensure "recipients" is required (not null)
            this.Recipients = recipients ?? throw new ArgumentNullException("recipients is a required property for ListXRPRippleTransactionsByAddressResponseItem and cannot be null");
            // to ensure "senders" is required (not null)
            this.Senders = senders ?? throw new ArgumentNullException("senders is a required property for ListXRPRippleTransactionsByAddressResponseItem and cannot be null");
            this.Sequence = sequence;
            // to ensure "status" is required (not null)
            this.Status = status ?? throw new ArgumentNullException("status is a required property for ListXRPRippleTransactionsByAddressResponseItem and cannot be null");
            this.Timestamp = timestamp;
            // to ensure "transactionHash" is required (not null)
            this.TransactionHash = transactionHash ?? throw new ArgumentNullException("transactionHash is a required property for ListXRPRippleTransactionsByAddressResponseItem and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for ListXRPRippleTransactionsByAddressResponseItem and cannot be null");
            // to ensure "fee" is required (not null)
            this.Fee = fee ?? throw new ArgumentNullException("fee is a required property for ListXRPRippleTransactionsByAddressResponseItem and cannot be null");
            // to ensure "offer" is required (not null)
            this.Offer = offer ?? throw new ArgumentNullException("offer is a required property for ListXRPRippleTransactionsByAddressResponseItem and cannot be null");
            // to ensure "receive" is required (not null)
            this.Receive = receive ?? throw new ArgumentNullException("receive is a required property for ListXRPRippleTransactionsByAddressResponseItem and cannot be null");
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for ListXRPRippleTransactionsByAddressResponseItem and cannot be null");
        }
        ...
        public ListXRPRippleTransactionsByAddressResponseItemFee Fee { get; set; }

        /// <summary>
        /// Gets or Sets Offer
        /// </summary>
        [DataMember(Name = "offer", IsRequired = true, EmitDefaultValue = false)]
        public ListXRPRippleTransactionsByAddressResponseItemOffer Offer { get; set; }

        /// <summary>
        /// Gets or Sets Receive
        /// </summary>
        [DataMember(Name = "receive", IsRequired = true, EmitDefaultValue = false)]
        public ListXRPRippleTransactionsByAddressResponseItemReceive Receive { get; set; }

        /// <summary>
        /// Gets or Sets Value
        /// </summary>
        [DataMember(Name = "value", IsRequired = true, EmitDefaultValue = false)]
        public ListXRPRippleTransactionsByAddressResponseItemValue Value { get; set; }
        ...
        {
            return this.Equals(input as ListXRPRippleTransactionsByAddressResponseItem);
        }

        /// <summary>
        /// Returns true if ListXRPRippleTransactionsByAddressResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ListXRPRippleTransactionsByAddressResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListXRPRippleTransactionsByAddressResponseItem input)
        {
            if (input == null)
                return false;
