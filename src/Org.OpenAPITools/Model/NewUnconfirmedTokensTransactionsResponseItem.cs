...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewUnconfirmedTokensTransactionsResponseItem")]
    public partial class NewUnconfirmedTokensTransactionsResponseItem : IEquatable<NewUnconfirmedTokensTransactionsResponseItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewUnconfirmedTokensTransactionsResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewUnconfirmedTokensTransactionsResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewUnconfirmedTokensTransactionsResponseItem" /> class.
        /// </summary>
        /// <param name="address">Defines the type of the specific event available for the customer to subscribe to for callback notification. (required).</param>
        ...
        public NewUnconfirmedTokensTransactionsResponseItem(string address = default(string), string callbackSecretKey = default(string), string callbackUrl = default(string), int createdTimestamp = default(int), string eventType = default(string), bool isActive = default(bool), string referenceId = default(string), string transactionId = default(string))
        {
            // to ensure "address" is required (not null)
            this.Address = address ?? throw new ArgumentNullException("address is a required property for NewUnconfirmedTokensTransactionsResponseItem and cannot be null");
            // to ensure "callbackSecretKey" is required (not null)
            this.CallbackSecretKey = callbackSecretKey ?? throw new ArgumentNullException("callbackSecretKey is a required property for NewUnconfirmedTokensTransactionsResponseItem and cannot be null");
            // to ensure "callbackUrl" is required (not null)
            this.CallbackUrl = callbackUrl ?? throw new ArgumentNullException("callbackUrl is a required property for NewUnconfirmedTokensTransactionsResponseItem and cannot be null");
            this.CreatedTimestamp = createdTimestamp;
            // to ensure "eventType" is required (not null)
            this.EventType = eventType ?? throw new ArgumentNullException("eventType is a required property for NewUnconfirmedTokensTransactionsResponseItem and cannot be null");
            this.IsActive = isActive;
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for NewUnconfirmedTokensTransactionsResponseItem and cannot be null");
            // to ensure "transactionId" is required (not null)
            this.TransactionId = transactionId ?? throw new ArgumentNullException("transactionId is a required property for NewUnconfirmedTokensTransactionsResponseItem and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewUnconfirmedTokensTransactionsResponseItem {\n");
        ...
        {
            return this.Equals(input as NewUnconfirmedTokensTransactionsResponseItem);
        }

        /// <summary>
        /// Returns true if NewUnconfirmedTokensTransactionsResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of NewUnconfirmedTokensTransactionsResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewUnconfirmedTokensTransactionsResponseItem input)
        {
            if (input == null)
                return false;
