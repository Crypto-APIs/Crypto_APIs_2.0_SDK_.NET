...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewConfirmedTokensTransactionsAndEachConfirmationRequestBody_data_item")]
    public partial class NewConfirmedTokensTransactionsAndEachConfirmationRequestBodyDataItem : IEquatable<NewConfirmedTokensTransactionsAndEachConfirmationRequestBodyDataItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewConfirmedTokensTransactionsAndEachConfirmationRequestBodyDataItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewConfirmedTokensTransactionsAndEachConfirmationRequestBodyDataItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewConfirmedTokensTransactionsAndEachConfirmationRequestBodyDataItem" /> class.
        /// </summary>
        ...
        public NewConfirmedTokensTransactionsAndEachConfirmationRequestBodyDataItem(string address = default(string), bool allowDuplicates = false, string callbackSecretKey = default(string), string callbackUrl = default(string), int confirmationsCount = default(int))
        {
            // to ensure "address" is required (not null)
            this.Address = address ?? throw new ArgumentNullException("address is a required property for NewConfirmedTokensTransactionsAndEachConfirmationRequestBodyDataItem and cannot be null");
            // to ensure "callbackUrl" is required (not null)
            this.CallbackUrl = callbackUrl ?? throw new ArgumentNullException("callbackUrl is a required property for NewConfirmedTokensTransactionsAndEachConfirmationRequestBodyDataItem and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewConfirmedTokensTransactionsAndEachConfirmationRequestBodyDataItem {\n");
        ...
        {
            return this.Equals(input as NewConfirmedTokensTransactionsAndEachConfirmationRequestBodyDataItem);
        }

        /// <summary>
        /// Returns true if NewConfirmedTokensTransactionsAndEachConfirmationRequestBodyDataItem instances are equal
        /// </summary>
        /// <param name="input">Instance of NewConfirmedTokensTransactionsAndEachConfirmationRequestBodyDataItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewConfirmedTokensTransactionsAndEachConfirmationRequestBodyDataItem input)
        {
            if (input == null)
                return false;
