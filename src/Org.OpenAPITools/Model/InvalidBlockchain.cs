...
namespace Org.OpenAPITools.Model
{
    ...
    /// InvalidBlockchain
    /// </summary>
    [DataContract(Name = "InvalidBlockchain")]
    public partial class InvalidBlockchain : IEquatable<InvalidBlockchain>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidBlockchain" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvalidBlockchain() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidBlockchain" /> class.
        /// </summary>
        ...
        public InvalidBlockchain(string apiVersion = default(string), string requestId = default(string), string context = default(string), InvalidBlockchainError error = default(InvalidBlockchainError))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for InvalidBlockchain and cannot be null");
            // to ensure "requestId" is required (not null)
            this.RequestId = requestId ?? throw new ArgumentNullException("requestId is a required property for InvalidBlockchain and cannot be null");
            // to ensure "error" is required (not null)
            this.Error = error ?? throw new ArgumentNullException("error is a required property for InvalidBlockchain and cannot be null");
        ...
        public InvalidBlockchainError Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InvalidBlockchain {\n");
        ...
        {
            return this.Equals(input as InvalidBlockchain);
        }

        /// <summary>
        /// Returns true if InvalidBlockchain instances are equal
        /// </summary>
        /// <param name="input">Instance of InvalidBlockchain to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvalidBlockchain input)
        {
            if (input == null)
                return false;
