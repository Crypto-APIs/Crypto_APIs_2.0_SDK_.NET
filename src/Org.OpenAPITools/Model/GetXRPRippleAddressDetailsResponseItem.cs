...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetXRPRippleAddressDetailsResponseItem")]
    public partial class GetXRPRippleAddressDetailsResponseItem : IEquatable<GetXRPRippleAddressDetailsResponseItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetXRPRippleAddressDetailsResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetXRPRippleAddressDetailsResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetXRPRippleAddressDetailsResponseItem" /> class.
        /// </summary>
        ...
        public GetXRPRippleAddressDetailsResponseItem(GetXRPRippleAddressDetailsResponseItemBalance balance = default(GetXRPRippleAddressDetailsResponseItemBalance), int incomingTransactionsCount = default(int), int outgoingTransactionsCount = default(int), int sequence = default(int), int transactionsCount = default(int))
        {
            // to ensure "balance" is required (not null)
            this.Balance = balance ?? throw new ArgumentNullException("balance is a required property for GetXRPRippleAddressDetailsResponseItem and cannot be null");
        ...
        public GetXRPRippleAddressDetailsResponseItemBalance Balance { get; set; }
        ...
        {
            return this.Equals(input as GetXRPRippleAddressDetailsResponseItem);
        }

        /// <summary>
        /// Returns true if GetXRPRippleAddressDetailsResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of GetXRPRippleAddressDetailsResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetXRPRippleAddressDetailsResponseItem input)
        {
            if (input == null)
                return false;
