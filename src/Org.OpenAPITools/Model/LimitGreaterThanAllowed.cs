...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LimitGreaterThanAllowed")]
    public partial class LimitGreaterThanAllowed : IEquatable<LimitGreaterThanAllowed>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LimitGreaterThanAllowed" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LimitGreaterThanAllowed() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LimitGreaterThanAllowed" /> class.
        /// </summary>
        ...
        public LimitGreaterThanAllowed(string apiVersion = default(string), string requestId = default(string), string context = default(string), LimitGreaterThanAllowedError error = default(LimitGreaterThanAllowedError))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for LimitGreaterThanAllowed and cannot be null");
            // to ensure "requestId" is required (not null)
            this.RequestId = requestId ?? throw new ArgumentNullException("requestId is a required property for LimitGreaterThanAllowed and cannot be null");
            // to ensure "error" is required (not null)
            this.Error = error ?? throw new ArgumentNullException("error is a required property for LimitGreaterThanAllowed and cannot be null");
        ...
        public LimitGreaterThanAllowedError Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LimitGreaterThanAllowed {\n");
        ...
        {
            return this.Equals(input as LimitGreaterThanAllowed);
        }

        /// <summary>
        /// Returns true if LimitGreaterThanAllowed instances are equal
        /// </summary>
        /// <param name="input">Instance of LimitGreaterThanAllowed to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LimitGreaterThanAllowed input)
        {
            if (input == null)
                return false;
