...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetXRPRippleBlockDetailsByBlockHeightResponseItem")]
    public partial class GetXRPRippleBlockDetailsByBlockHeightResponseItem : IEquatable<GetXRPRippleBlockDetailsByBlockHeightResponseItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetXRPRippleBlockDetailsByBlockHeightResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetXRPRippleBlockDetailsByBlockHeightResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetXRPRippleBlockDetailsByBlockHeightResponseItem" /> class.
        /// </summary>
        ...
        public GetXRPRippleBlockDetailsByBlockHeightResponseItem(string blockHash = default(string), int blockHeight = default(int), string nextBlockHash = default(string), string previousBlockHash = default(string), int timestamp = default(int), GetXRPRippleBlockDetailsByBlockHeightResponseItemTotalCoins totalCoins = default(GetXRPRippleBlockDetailsByBlockHeightResponseItemTotalCoins), GetXRPRippleBlockDetailsByBlockHeightResponseItemTotalFees totalFees = default(GetXRPRippleBlockDetailsByBlockHeightResponseItemTotalFees), int transactionsCount = default(int))
        {
            // to ensure "blockHash" is required (not null)
            this.BlockHash = blockHash ?? throw new ArgumentNullException("blockHash is a required property for GetXRPRippleBlockDetailsByBlockHeightResponseItem and cannot be null");
            this.BlockHeight = blockHeight;
            // to ensure "nextBlockHash" is required (not null)
            this.NextBlockHash = nextBlockHash ?? throw new ArgumentNullException("nextBlockHash is a required property for GetXRPRippleBlockDetailsByBlockHeightResponseItem and cannot be null");
            // to ensure "previousBlockHash" is required (not null)
            this.PreviousBlockHash = previousBlockHash ?? throw new ArgumentNullException("previousBlockHash is a required property for GetXRPRippleBlockDetailsByBlockHeightResponseItem and cannot be null");
            this.Timestamp = timestamp;
            // to ensure "totalCoins" is required (not null)
            this.TotalCoins = totalCoins ?? throw new ArgumentNullException("totalCoins is a required property for GetXRPRippleBlockDetailsByBlockHeightResponseItem and cannot be null");
            // to ensure "totalFees" is required (not null)
            this.TotalFees = totalFees ?? throw new ArgumentNullException("totalFees is a required property for GetXRPRippleBlockDetailsByBlockHeightResponseItem and cannot be null");
        ...
        public GetXRPRippleBlockDetailsByBlockHeightResponseItemTotalCoins TotalCoins { get; set; }
        ...
        {
            return this.Equals(input as GetXRPRippleBlockDetailsByBlockHeightResponseItem);
        }

        /// <summary>
        /// Returns true if GetXRPRippleBlockDetailsByBlockHeightResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of GetXRPRippleBlockDetailsByBlockHeightResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetXRPRippleBlockDetailsByBlockHeightResponseItem input)
        {
            if (input == null)
                return false;
