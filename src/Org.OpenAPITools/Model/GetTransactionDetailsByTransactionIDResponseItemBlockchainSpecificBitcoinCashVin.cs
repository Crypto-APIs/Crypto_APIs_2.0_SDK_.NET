...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinCash_vin")]
    public partial class GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinCashVin : IEquatable<GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinCashVin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinCashVin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinCashVin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinCashVin" /> class.
        /// </summary>
        ...
        public GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinCashVin(List<string> addresses = default(List<string>), string coinbase = default(string), GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig scriptSig = default(GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig), string sequence = default(string), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            this.Addresses = addresses ?? throw new ArgumentNullException("addresses is a required property for GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinCashVin and cannot be null");
            // to ensure "scriptSig" is required (not null)
            this.ScriptSig = scriptSig ?? throw new ArgumentNullException("scriptSig is a required property for GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinCashVin and cannot be null");
            // to ensure "sequence" is required (not null)
            this.Sequence = sequence ?? throw new ArgumentNullException("sequence is a required property for GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinCashVin and cannot be null");
            // to ensure "txinwitness" is required (not null)
            this.Txinwitness = txinwitness ?? throw new ArgumentNullException("txinwitness is a required property for GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinCashVin and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinCashVin {\n");
        ...
        {
            return this.Equals(input as GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinCashVin);
        }

        /// <summary>
        /// Returns true if GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinCashVin instances are equal
        /// </summary>
        /// <param name="input">Instance of GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinCashVin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinCashVin input)
        {
            if (input == null)
                return false;
