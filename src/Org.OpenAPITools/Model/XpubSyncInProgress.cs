...
namespace Org.OpenAPITools.Model
{
    ...
    /// XpubSyncInProgress
    /// </summary>
    [DataContract(Name = "XpubSyncInProgress")]
    public partial class XpubSyncInProgress : IEquatable<XpubSyncInProgress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XpubSyncInProgress" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected XpubSyncInProgress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="XpubSyncInProgress" /> class.
        /// </summary>
        ...
        public XpubSyncInProgress(string apiVersion = default(string), string requestId = default(string), string context = default(string), XpubSyncInProgressError error = default(XpubSyncInProgressError))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for XpubSyncInProgress and cannot be null");
            // to ensure "requestId" is required (not null)
            this.RequestId = requestId ?? throw new ArgumentNullException("requestId is a required property for XpubSyncInProgress and cannot be null");
            // to ensure "error" is required (not null)
            this.Error = error ?? throw new ArgumentNullException("error is a required property for XpubSyncInProgress and cannot be null");
        ...
        public XpubSyncInProgressError Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class XpubSyncInProgress {\n");
        ...
        {
            return this.Equals(input as XpubSyncInProgress);
        }

        /// <summary>
        /// Returns true if XpubSyncInProgress instances are equal
        /// </summary>
        /// <param name="input">Instance of XpubSyncInProgress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XpubSyncInProgress input)
        {
            if (input == null)
                return false;
