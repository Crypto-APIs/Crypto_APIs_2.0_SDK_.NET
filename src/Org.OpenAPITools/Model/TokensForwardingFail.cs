...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TokensForwardingFail")]
    public partial class TokensForwardingFail : IEquatable<TokensForwardingFail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokensForwardingFail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TokensForwardingFail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TokensForwardingFail" /> class.
        /// </summary>
        ...
        public TokensForwardingFail(string apiVersion = default(string), string referenceId = default(string), string idempotencyKey = default(string), TokensForwardingFailData data = default(TokensForwardingFailData))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for TokensForwardingFail and cannot be null");
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for TokensForwardingFail and cannot be null");
            // to ensure "idempotencyKey" is required (not null)
            this.IdempotencyKey = idempotencyKey ?? throw new ArgumentNullException("idempotencyKey is a required property for TokensForwardingFail and cannot be null");
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for TokensForwardingFail and cannot be null");
        }
        ...
        public TokensForwardingFailData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TokensForwardingFail {\n");
        ...
        {
            return this.Equals(input as TokensForwardingFail);
        }

        /// <summary>
        /// Returns true if TokensForwardingFail instances are equal
        /// </summary>
        /// <param name="input">Instance of TokensForwardingFail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokensForwardingFail input)
        {
            if (input == null)
                return false;
