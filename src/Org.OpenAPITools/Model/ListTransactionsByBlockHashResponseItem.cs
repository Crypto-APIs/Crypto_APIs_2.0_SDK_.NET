...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListTransactionsByBlockHashResponseItem")]
    public partial class ListTransactionsByBlockHashResponseItem : IEquatable<ListTransactionsByBlockHashResponseItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByBlockHashResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHashResponseItem" /> class.
        /// </summary>
        ...
        public ListTransactionsByBlockHashResponseItem(int index = default(int), string minedInBlockHash = default(string), int minedInBlockHeight = default(int), List<ListTransactionsByBlockHashResponseItemRecipients> recipients = default(List<ListTransactionsByBlockHashResponseItemRecipients>), List<ListTransactionsByBlockHashResponseItemSenders> senders = default(List<ListTransactionsByBlockHashResponseItemSenders>), int timestamp = default(int), string transactionHash = default(string), string transactionId = default(string), ListTransactionsByBlockHashResponseItemFee fee = default(ListTransactionsByBlockHashResponseItemFee), ListTransactionsByBlockHashResponseItemBlockchainSpecific blockchainSpecific = default(ListTransactionsByBlockHashResponseItemBlockchainSpecific))
        {
            this.Index = index;
            // to ensure "minedInBlockHash" is required (not null)
            this.MinedInBlockHash = minedInBlockHash ?? throw new ArgumentNullException("minedInBlockHash is a required property for ListTransactionsByBlockHashResponseItem and cannot be null");
            this.MinedInBlockHeight = minedInBlockHeight;
            // to ensure "recipients" is required (not null)
            this.Recipients = recipients ?? throw new ArgumentNullException("recipients is a required property for ListTransactionsByBlockHashResponseItem and cannot be null");
            // to ensure "senders" is required (not null)
            this.Senders = senders ?? throw new ArgumentNullException("senders is a required property for ListTransactionsByBlockHashResponseItem and cannot be null");
            this.Timestamp = timestamp;
            // to ensure "transactionHash" is required (not null)
            this.TransactionHash = transactionHash ?? throw new ArgumentNullException("transactionHash is a required property for ListTransactionsByBlockHashResponseItem and cannot be null");
            // to ensure "transactionId" is required (not null)
            this.TransactionId = transactionId ?? throw new ArgumentNullException("transactionId is a required property for ListTransactionsByBlockHashResponseItem and cannot be null");
            // to ensure "fee" is required (not null)
            this.Fee = fee ?? throw new ArgumentNullException("fee is a required property for ListTransactionsByBlockHashResponseItem and cannot be null");
            // to ensure "blockchainSpecific" is required (not null)
            this.BlockchainSpecific = blockchainSpecific ?? throw new ArgumentNullException("blockchainSpecific is a required property for ListTransactionsByBlockHashResponseItem and cannot be null");
        }
        ...
        public List<ListTransactionsByBlockHashResponseItemRecipients> Recipients { get; set; }
        ...
        public List<ListTransactionsByBlockHashResponseItemSenders> Senders { get; set; }
        ...
        public ListTransactionsByBlockHashResponseItemFee Fee { get; set; }

        /// <summary>
        /// Gets or Sets BlockchainSpecific
        /// </summary>
        [DataMember(Name = "blockchainSpecific", IsRequired = true, EmitDefaultValue = false)]
        public ListTransactionsByBlockHashResponseItemBlockchainSpecific BlockchainSpecific { get; set; }
        ...
        {
            return this.Equals(input as ListTransactionsByBlockHashResponseItem);
        }

        /// <summary>
        /// Returns true if ListTransactionsByBlockHashResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByBlockHashResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByBlockHashResponseItem input)
        {
            if (input == null)
                return false;
