...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListHDWalletxPubYPubZPubTransactionsResponseItem_senders")]
    public partial class ListHDWalletxPubYPubZPubTransactionsResponseItemSenders : IEquatable<ListHDWalletxPubYPubZPubTransactionsResponseItemSenders>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListHDWalletxPubYPubZPubTransactionsResponseItemSenders" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListHDWalletxPubYPubZPubTransactionsResponseItemSenders() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListHDWalletxPubYPubZPubTransactionsResponseItemSenders" /> class.
        /// </summary>
        ...
        public ListHDWalletxPubYPubZPubTransactionsResponseItemSenders(string address = default(string), string amount = default(string), bool isMember = default(bool))
        {
            // to ensure "address" is required (not null)
            this.Address = address ?? throw new ArgumentNullException("address is a required property for ListHDWalletxPubYPubZPubTransactionsResponseItemSenders and cannot be null");
            // to ensure "amount" is required (not null)
            this.Amount = amount ?? throw new ArgumentNullException("amount is a required property for ListHDWalletxPubYPubZPubTransactionsResponseItemSenders and cannot be null");
        ...
        {
            return this.Equals(input as ListHDWalletxPubYPubZPubTransactionsResponseItemSenders);
        }

        /// <summary>
        /// Returns true if ListHDWalletxPubYPubZPubTransactionsResponseItemSenders instances are equal
        /// </summary>
        /// <param name="input">Instance of ListHDWalletxPubYPubZPubTransactionsResponseItemSenders to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListHDWalletxPubYPubZPubTransactionsResponseItemSenders input)
        {
            if (input == null)
                return false;
