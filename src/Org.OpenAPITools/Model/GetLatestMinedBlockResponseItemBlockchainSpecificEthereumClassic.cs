...
namespace Org.OpenAPITools.Model
{
    ...
    /// Ethereum Classic
    /// </summary>
    [DataContract(Name = "GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic")]
    public partial class GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic : IEquatable<GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic" /> class.
        /// </summary>
        ...
        public GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic(string difficulty = default(string), string nonce = default(string), int size = default(int), string extraData = default(string), string gasLimit = default(string), string gasUsed = default(string), int minedInSeconds = default(int), string sha3Uncles = default(string), string totalDifficulty = default(string))
        {
            // to ensure "difficulty" is required (not null)
            this.Difficulty = difficulty ?? throw new ArgumentNullException("difficulty is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic and cannot be null");
            // to ensure "nonce" is required (not null)
            this.Nonce = nonce ?? throw new ArgumentNullException("nonce is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic and cannot be null");
            this.Size = size;
            // to ensure "extraData" is required (not null)
            this.ExtraData = extraData ?? throw new ArgumentNullException("extraData is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic and cannot be null");
            // to ensure "gasLimit" is required (not null)
            this.GasLimit = gasLimit ?? throw new ArgumentNullException("gasLimit is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic and cannot be null");
            // to ensure "gasUsed" is required (not null)
            this.GasUsed = gasUsed ?? throw new ArgumentNullException("gasUsed is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic and cannot be null");
            this.MinedInSeconds = minedInSeconds;
            // to ensure "sha3Uncles" is required (not null)
            this.Sha3Uncles = sha3Uncles ?? throw new ArgumentNullException("sha3Uncles is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic and cannot be null");
            // to ensure "totalDifficulty" is required (not null)
            this.TotalDifficulty = totalDifficulty ?? throw new ArgumentNullException("totalDifficulty is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic {\n");
        ...
        {
            return this.Equals(input as GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic);
        }

        /// <summary>
        /// Returns true if GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic instances are equal
        /// </summary>
        /// <param name="input">Instance of GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic input)
        {
            if (input == null)
                return false;
