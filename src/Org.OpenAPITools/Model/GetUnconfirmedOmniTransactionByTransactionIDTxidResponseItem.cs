...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem")]
    public partial class GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem : IEquatable<GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem" /> class.
        /// </summary>
        ...
        /// <param name="transactionId">String representation of the transaction identifier (txid) (required).</param>
        ...
        public GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem(string amount = default(string), bool divisible = default(bool), bool mined = default(bool), int propertyId = default(int), List<GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItemRecipients> recipients = default(List<GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItemRecipients>), List<GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItemSenders> senders = default(List<GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItemSenders>), bool sent = default(bool), int timestamp = default(int), string transactionId = default(string), string type = default(string), int typeInt = default(int), int version = default(int), ListUnconfirmedOmniTransactionsByAddressResponseItemFee fee = default(ListUnconfirmedOmniTransactionsByAddressResponseItemFee))
        {
            // to ensure "amount" is required (not null)
            this.Amount = amount ?? throw new ArgumentNullException("amount is a required property for GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem and cannot be null");
            this.Divisible = divisible;
            this.Mined = mined;
            this.PropertyId = propertyId;
            // to ensure "recipients" is required (not null)
            this.Recipients = recipients ?? throw new ArgumentNullException("recipients is a required property for GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem and cannot be null");
            // to ensure "senders" is required (not null)
            this.Senders = senders ?? throw new ArgumentNullException("senders is a required property for GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem and cannot be null");
            this.Sent = sent;
            this.Timestamp = timestamp;
            // to ensure "transactionId" is required (not null)
            this.TransactionId = transactionId ?? throw new ArgumentNullException("transactionId is a required property for GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem and cannot be null");
            this.TypeInt = typeInt;
            this.Version = version;
            // to ensure "fee" is required (not null)
            this.Fee = fee ?? throw new ArgumentNullException("fee is a required property for GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem and cannot be null");
        }
        ...
        public List<GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItemRecipients> Recipients { get; set; }
        ...
        public List<GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItemSenders> Senders { get; set; }
        ...
        /// </summary>
        /// <value>String representation of the transaction identifier (txid)</value>
        ...
        {
            return this.Equals(input as GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem);
        }

        /// <summary>
        /// Returns true if GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem input)
        {
            if (input == null)
                return false;
