...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetAddressDetailsResponseItem")]
    public partial class GetAddressDetailsResponseItem : IEquatable<GetAddressDetailsResponseItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressDetailsResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetAddressDetailsResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAddressDetailsResponseItem" /> class.
        /// </summary>
        ...
        public GetAddressDetailsResponseItem(int transactionsCount = default(int), GetAddressDetailsResponseItemConfirmedBalance confirmedBalance = default(GetAddressDetailsResponseItemConfirmedBalance), GetAddressDetailsResponseItemTotalReceived totalReceived = default(GetAddressDetailsResponseItemTotalReceived), GetAddressDetailsResponseItemTotalSpent totalSpent = default(GetAddressDetailsResponseItemTotalSpent), int incomingTransactionsCount = default(int), int outgoingTransactionsCount = default(int))
        {
            this.TransactionsCount = transactionsCount;
            // to ensure "confirmedBalance" is required (not null)
            this.ConfirmedBalance = confirmedBalance ?? throw new ArgumentNullException("confirmedBalance is a required property for GetAddressDetailsResponseItem and cannot be null");
            // to ensure "totalReceived" is required (not null)
            this.TotalReceived = totalReceived ?? throw new ArgumentNullException("totalReceived is a required property for GetAddressDetailsResponseItem and cannot be null");
            // to ensure "totalSpent" is required (not null)
            this.TotalSpent = totalSpent ?? throw new ArgumentNullException("totalSpent is a required property for GetAddressDetailsResponseItem and cannot be null");
        ...
        public GetAddressDetailsResponseItemConfirmedBalance ConfirmedBalance { get; set; }

        /// <summary>
        /// Gets or Sets TotalReceived
        /// </summary>
        [DataMember(Name = "totalReceived", IsRequired = true, EmitDefaultValue = false)]
        public GetAddressDetailsResponseItemTotalReceived TotalReceived { get; set; }

        /// <summary>
        /// Gets or Sets TotalSpent
        /// </summary>
        [DataMember(Name = "totalSpent", IsRequired = true, EmitDefaultValue = false)]
        public GetAddressDetailsResponseItemTotalSpent TotalSpent { get; set; }
        ...
        {
            return this.Equals(input as GetAddressDetailsResponseItem);
        }

        /// <summary>
        /// Returns true if GetAddressDetailsResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAddressDetailsResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAddressDetailsResponseItem input)
        {
            if (input == null)
                return false;
