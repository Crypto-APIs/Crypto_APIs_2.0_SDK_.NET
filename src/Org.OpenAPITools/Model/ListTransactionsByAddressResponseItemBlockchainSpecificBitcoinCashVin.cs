...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinCash_vin")]
    public partial class ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinCashVin : IEquatable<ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinCashVin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinCashVin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinCashVin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinCashVin" /> class.
        /// </summary>
        ...
        public ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinCashVin(List<string> addresses = default(List<string>), string coinbase = default(string), GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig scriptSig = default(GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig), string sequence = default(string), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            this.Addresses = addresses ?? throw new ArgumentNullException("addresses is a required property for ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinCashVin and cannot be null");
            // to ensure "scriptSig" is required (not null)
            this.ScriptSig = scriptSig ?? throw new ArgumentNullException("scriptSig is a required property for ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinCashVin and cannot be null");
            // to ensure "sequence" is required (not null)
            this.Sequence = sequence ?? throw new ArgumentNullException("sequence is a required property for ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinCashVin and cannot be null");
            // to ensure "txid" is required (not null)
            this.Txid = txid ?? throw new ArgumentNullException("txid is a required property for ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinCashVin and cannot be null");
            // to ensure "txinwitness" is required (not null)
            this.Txinwitness = txinwitness ?? throw new ArgumentNullException("txinwitness is a required property for ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinCashVin and cannot be null");
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinCashVin and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinCashVin {\n");
        ...
        {
            return this.Equals(input as ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinCashVin);
        }

        /// <summary>
        /// Returns true if ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinCashVin instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinCashVin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinCashVin input)
        {
            if (input == null)
                return false;
