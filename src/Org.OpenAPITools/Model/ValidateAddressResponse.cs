...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ValidateAddressResponse")]
    public partial class ValidateAddressResponse : IEquatable<ValidateAddressResponse>, IValidatableObject
    {
        ...
        public ValidateAddressResponse(string apiVersion = default(string), string requestId = default(string), string context = default(string), ValidateAddressResponseData data = default(ValidateAddressResponseData))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for ValidateAddressResponse and cannot be null");
            // to ensure "requestId" is required (not null)
            this.RequestId = requestId ?? throw new ArgumentNullException("requestId is a required property for ValidateAddressResponse and cannot be null");
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for ValidateAddressResponse and cannot be null");
        ...
        public ValidateAddressResponseData Data { get; set; }
