...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetXRPRippleBlockDetailsByBlockHashResponseItem")]
    public partial class GetXRPRippleBlockDetailsByBlockHashResponseItem : IEquatable<GetXRPRippleBlockDetailsByBlockHashResponseItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetXRPRippleBlockDetailsByBlockHashResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetXRPRippleBlockDetailsByBlockHashResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetXRPRippleBlockDetailsByBlockHashResponseItem" /> class.
        /// </summary>
        ...
        public GetXRPRippleBlockDetailsByBlockHashResponseItem(string blockHash = default(string), int blockHeight = default(int), string nextBlockHash = default(string), string previousBlockHash = default(string), int timestamp = default(int), GetXRPRippleBlockDetailsByBlockHashResponseItemTotalCoins totalCoins = default(GetXRPRippleBlockDetailsByBlockHashResponseItemTotalCoins), GetXRPRippleBlockDetailsByBlockHeightResponseItemTotalFees totalFees = default(GetXRPRippleBlockDetailsByBlockHeightResponseItemTotalFees), int transactionsCount = default(int))
        {
            // to ensure "blockHash" is required (not null)
            this.BlockHash = blockHash ?? throw new ArgumentNullException("blockHash is a required property for GetXRPRippleBlockDetailsByBlockHashResponseItem and cannot be null");
            this.BlockHeight = blockHeight;
            // to ensure "nextBlockHash" is required (not null)
            this.NextBlockHash = nextBlockHash ?? throw new ArgumentNullException("nextBlockHash is a required property for GetXRPRippleBlockDetailsByBlockHashResponseItem and cannot be null");
            // to ensure "previousBlockHash" is required (not null)
            this.PreviousBlockHash = previousBlockHash ?? throw new ArgumentNullException("previousBlockHash is a required property for GetXRPRippleBlockDetailsByBlockHashResponseItem and cannot be null");
            this.Timestamp = timestamp;
            // to ensure "totalCoins" is required (not null)
            this.TotalCoins = totalCoins ?? throw new ArgumentNullException("totalCoins is a required property for GetXRPRippleBlockDetailsByBlockHashResponseItem and cannot be null");
            // to ensure "totalFees" is required (not null)
            this.TotalFees = totalFees ?? throw new ArgumentNullException("totalFees is a required property for GetXRPRippleBlockDetailsByBlockHashResponseItem and cannot be null");
        ...
        public GetXRPRippleBlockDetailsByBlockHashResponseItemTotalCoins TotalCoins { get; set; }

        /// <summary>
        /// Gets or Sets TotalFees
        /// </summary>
        [DataMember(Name = "totalFees", IsRequired = true, EmitDefaultValue = false)]
        public GetXRPRippleBlockDetailsByBlockHeightResponseItemTotalFees TotalFees { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetXRPRippleBlockDetailsByBlockHashResponseItem {\n");
        ...
        {
            return this.Equals(input as GetXRPRippleBlockDetailsByBlockHashResponseItem);
        }

        /// <summary>
        /// Returns true if GetXRPRippleBlockDetailsByBlockHashResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of GetXRPRippleBlockDetailsByBlockHashResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetXRPRippleBlockDetailsByBlockHashResponseItem input)
        {
            if (input == null)
                return false;
