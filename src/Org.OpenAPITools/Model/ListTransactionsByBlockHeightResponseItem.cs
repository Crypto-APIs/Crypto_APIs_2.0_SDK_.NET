...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListTransactionsByBlockHeightResponseItem")]
    public partial class ListTransactionsByBlockHeightResponseItem : IEquatable<ListTransactionsByBlockHeightResponseItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHeightResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByBlockHeightResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByBlockHeightResponseItem" /> class.
        /// </summary>
        ...
        public ListTransactionsByBlockHeightResponseItem(int index = default(int), string minedInBlockHash = default(string), int minedInBlockHeight = default(int), List<GetTransactionDetailsByTransactionIDResponseItemRecipients> recipients = default(List<GetTransactionDetailsByTransactionIDResponseItemRecipients>), List<GetTransactionDetailsByTransactionIDResponseItemSenders> senders = default(List<GetTransactionDetailsByTransactionIDResponseItemSenders>), int timestamp = default(int), string transactionHash = default(string), string transactionId = default(string), ListTransactionsByBlockHeightResponseItemFee fee = default(ListTransactionsByBlockHeightResponseItemFee), ListTransactionsByBlockHeightResponseItemBlockchainSpecific blockchainSpecific = default(ListTransactionsByBlockHeightResponseItemBlockchainSpecific))
        {
            this.Index = index;
            // to ensure "minedInBlockHash" is required (not null)
            this.MinedInBlockHash = minedInBlockHash ?? throw new ArgumentNullException("minedInBlockHash is a required property for ListTransactionsByBlockHeightResponseItem and cannot be null");
            this.MinedInBlockHeight = minedInBlockHeight;
            // to ensure "recipients" is required (not null)
            this.Recipients = recipients ?? throw new ArgumentNullException("recipients is a required property for ListTransactionsByBlockHeightResponseItem and cannot be null");
            // to ensure "senders" is required (not null)
            this.Senders = senders ?? throw new ArgumentNullException("senders is a required property for ListTransactionsByBlockHeightResponseItem and cannot be null");
            this.Timestamp = timestamp;
            // to ensure "transactionHash" is required (not null)
            this.TransactionHash = transactionHash ?? throw new ArgumentNullException("transactionHash is a required property for ListTransactionsByBlockHeightResponseItem and cannot be null");
            // to ensure "transactionId" is required (not null)
            this.TransactionId = transactionId ?? throw new ArgumentNullException("transactionId is a required property for ListTransactionsByBlockHeightResponseItem and cannot be null");
            // to ensure "fee" is required (not null)
            this.Fee = fee ?? throw new ArgumentNullException("fee is a required property for ListTransactionsByBlockHeightResponseItem and cannot be null");
            // to ensure "blockchainSpecific" is required (not null)
            this.BlockchainSpecific = blockchainSpecific ?? throw new ArgumentNullException("blockchainSpecific is a required property for ListTransactionsByBlockHeightResponseItem and cannot be null");
        }
        ...
        public ListTransactionsByBlockHeightResponseItemFee Fee { get; set; }

        /// <summary>
        /// Gets or Sets BlockchainSpecific
        /// </summary>
        [DataMember(Name = "blockchainSpecific", IsRequired = true, EmitDefaultValue = false)]
        public ListTransactionsByBlockHeightResponseItemBlockchainSpecific BlockchainSpecific { get; set; }
        ...
        {
            return this.Equals(input as ListTransactionsByBlockHeightResponseItem);
        }

        /// <summary>
        /// Returns true if ListTransactionsByBlockHeightResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByBlockHeightResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByBlockHeightResponseItem input)
        {
            if (input == null)
                return false;
