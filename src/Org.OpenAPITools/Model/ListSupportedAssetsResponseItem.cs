...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListSupportedAssetsResponseItem")]
    public partial class ListSupportedAssetsResponseItem : IEquatable<ListSupportedAssetsResponseItem>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListSupportedAssetsResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListSupportedAssetsResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListSupportedAssetsResponseItem" /> class.
        /// </summary>
        ...
        public ListSupportedAssetsResponseItem(string assetId = default(string), string assetName = default(string), string assetSymbol = default(string), AssetTypeEnum assetType = default(AssetTypeEnum), string originalSymbol = default(string))
        {
            // to ensure "assetId" is required (not null)
            this.AssetId = assetId ?? throw new ArgumentNullException("assetId is a required property for ListSupportedAssetsResponseItem and cannot be null");
            // to ensure "assetName" is required (not null)
            this.AssetName = assetName ?? throw new ArgumentNullException("assetName is a required property for ListSupportedAssetsResponseItem and cannot be null");
            // to ensure "assetSymbol" is required (not null)
            this.AssetSymbol = assetSymbol ?? throw new ArgumentNullException("assetSymbol is a required property for ListSupportedAssetsResponseItem and cannot be null");
            this.AssetType = assetType;
            // to ensure "originalSymbol" is required (not null)
            this.OriginalSymbol = originalSymbol ?? throw new ArgumentNullException("originalSymbol is a required property for ListSupportedAssetsResponseItem and cannot be null");
        }
        ...
        {
            return this.Equals(input as ListSupportedAssetsResponseItem);
        }

        /// <summary>
        /// Returns true if ListSupportedAssetsResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ListSupportedAssetsResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListSupportedAssetsResponseItem input)
        {
            if (input == null)
                return false;
