...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewUnconfirmedCoinsTransactionsRequestBody_data_item")]
    public partial class NewUnconfirmedCoinsTransactionsRequestBodyDataItem : IEquatable<NewUnconfirmedCoinsTransactionsRequestBodyDataItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewUnconfirmedCoinsTransactionsRequestBodyDataItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewUnconfirmedCoinsTransactionsRequestBodyDataItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewUnconfirmedCoinsTransactionsRequestBodyDataItem" /> class.
        /// </summary>
        ...
        /// <param name="callbackSecretKey">Represents the Secret Key value provided by the customer. This field is used for security purposes during the callback notification, in order to prove the sender of the callback as Crypto APIs 2.0..</param>
        ...
        public NewUnconfirmedCoinsTransactionsRequestBodyDataItem(string address = default(string), bool allowDuplicates = false, string callbackSecretKey = default(string), string callbackUrl = default(string))
        {
            // to ensure "address" is required (not null)
            this.Address = address ?? throw new ArgumentNullException("address is a required property for NewUnconfirmedCoinsTransactionsRequestBodyDataItem and cannot be null");
            // to ensure "callbackUrl" is required (not null)
            this.CallbackUrl = callbackUrl ?? throw new ArgumentNullException("callbackUrl is a required property for NewUnconfirmedCoinsTransactionsRequestBodyDataItem and cannot be null");
        ...
        {
            return this.Equals(input as NewUnconfirmedCoinsTransactionsRequestBodyDataItem);
        }

        /// <summary>
        /// Returns true if NewUnconfirmedCoinsTransactionsRequestBodyDataItem instances are equal
        /// </summary>
        /// <param name="input">Instance of NewUnconfirmedCoinsTransactionsRequestBodyDataItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewUnconfirmedCoinsTransactionsRequestBodyDataItem input)
        {
            if (input == null)
                return false;
