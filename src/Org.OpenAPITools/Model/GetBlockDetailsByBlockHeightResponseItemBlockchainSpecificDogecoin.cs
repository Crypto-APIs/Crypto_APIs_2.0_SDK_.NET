...
namespace Org.OpenAPITools.Model
{
    ...
    /// Dogecoin
    /// </summary>
    [DataContract(Name = "GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin")]
    public partial class GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin : IEquatable<GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin" /> class.
        /// </summary>
        ...
        public GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin(string difficulty = default(string), string nonce = default(string), int size = default(int), string bits = default(string), string chainwork = default(string), string merkleRoot = default(string), int strippedSize = default(int), int version = default(int), int weight = default(int))
        {
            // to ensure "difficulty" is required (not null)
            this.Difficulty = difficulty ?? throw new ArgumentNullException("difficulty is a required property for GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin and cannot be null");
            // to ensure "nonce" is required (not null)
            this.Nonce = nonce ?? throw new ArgumentNullException("nonce is a required property for GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin and cannot be null");
            this.Size = size;
            // to ensure "bits" is required (not null)
            this.Bits = bits ?? throw new ArgumentNullException("bits is a required property for GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin and cannot be null");
            // to ensure "chainwork" is required (not null)
            this.Chainwork = chainwork ?? throw new ArgumentNullException("chainwork is a required property for GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin and cannot be null");
            // to ensure "merkleRoot" is required (not null)
            this.MerkleRoot = merkleRoot ?? throw new ArgumentNullException("merkleRoot is a required property for GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin {\n");
        ...
        {
            return this.Equals(input as GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin);
        }

        /// <summary>
        /// Returns true if GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin instances are equal
        /// </summary>
        /// <param name="input">Instance of GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin input)
        {
            if (input == null)
                return false;
