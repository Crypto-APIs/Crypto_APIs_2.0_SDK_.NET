...
namespace Org.OpenAPITools.Model
{
    ...
    /// XpubNotSynced
    /// </summary>
    [DataContract(Name = "XpubNotSynced")]
    public partial class XpubNotSynced : IEquatable<XpubNotSynced>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XpubNotSynced" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected XpubNotSynced() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="XpubNotSynced" /> class.
        /// </summary>
        ...
        public XpubNotSynced(string apiVersion = default(string), string requestId = default(string), string context = default(string), XpubNotSyncedError error = default(XpubNotSyncedError))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for XpubNotSynced and cannot be null");
            // to ensure "requestId" is required (not null)
            this.RequestId = requestId ?? throw new ArgumentNullException("requestId is a required property for XpubNotSynced and cannot be null");
            // to ensure "error" is required (not null)
            this.Error = error ?? throw new ArgumentNullException("error is a required property for XpubNotSynced and cannot be null");
        ...
        public XpubNotSyncedError Error { get; set; }
        ...
        {
            return this.Equals(input as XpubNotSynced);
        }

        /// <summary>
        /// Returns true if XpubNotSynced instances are equal
        /// </summary>
        /// <param name="input">Instance of XpubNotSynced to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XpubNotSynced input)
        {
            if (input == null)
                return false;
