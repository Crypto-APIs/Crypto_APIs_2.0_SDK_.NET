...
namespace Org.OpenAPITools.Model
{
    ...
    /// RequestLimitReached
    /// </summary>
    [DataContract(Name = "RequestLimitReached")]
    public partial class RequestLimitReached : IEquatable<RequestLimitReached>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestLimitReached" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RequestLimitReached() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestLimitReached" /> class.
        /// </summary>
        ...
        public RequestLimitReached(string apiVersion = default(string), string requestId = default(string), string context = default(string), RequestLimitReachedError error = default(RequestLimitReachedError))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for RequestLimitReached and cannot be null");
            // to ensure "requestId" is required (not null)
            this.RequestId = requestId ?? throw new ArgumentNullException("requestId is a required property for RequestLimitReached and cannot be null");
            // to ensure "error" is required (not null)
            this.Error = error ?? throw new ArgumentNullException("error is a required property for RequestLimitReached and cannot be null");
        ...
        public RequestLimitReachedError Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RequestLimitReached {\n");
        ...
        {
            return this.Equals(input as RequestLimitReached);
        }

        /// <summary>
        /// Returns true if RequestLimitReached instances are equal
        /// </summary>
        /// <param name="input">Instance of RequestLimitReached to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RequestLimitReached input)
        {
            if (input == null)
                return false;
