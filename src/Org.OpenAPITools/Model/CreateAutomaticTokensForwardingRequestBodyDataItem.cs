...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateAutomaticTokensForwardingRequestBody_data_item")]
    public partial class CreateAutomaticTokensForwardingRequestBodyDataItem : IEquatable<CreateAutomaticTokensForwardingRequestBodyDataItem>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAutomaticTokensForwardingRequestBodyDataItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateAutomaticTokensForwardingRequestBodyDataItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAutomaticTokensForwardingRequestBodyDataItem" /> class.
        /// </summary>
        ...
        public CreateAutomaticTokensForwardingRequestBodyDataItem(string callbackSecretKey = default(string), string callbackUrl = default(string), string confirmationsCount = default(string), FeePriorityEnum feePriority = default(FeePriorityEnum), string minimumTransferAmount = default(string), string toAddress = default(string), CreateAutomaticTokensForwardingRequestBodyTokenData tokenData = default(CreateAutomaticTokensForwardingRequestBodyTokenData))
        {
            // to ensure "callbackUrl" is required (not null)
            this.CallbackUrl = callbackUrl ?? throw new ArgumentNullException("callbackUrl is a required property for CreateAutomaticTokensForwardingRequestBodyDataItem and cannot be null");
            // to ensure "confirmationsCount" is required (not null)
            this.ConfirmationsCount = confirmationsCount ?? throw new ArgumentNullException("confirmationsCount is a required property for CreateAutomaticTokensForwardingRequestBodyDataItem and cannot be null");
            this.FeePriority = feePriority;
            // to ensure "minimumTransferAmount" is required (not null)
            this.MinimumTransferAmount = minimumTransferAmount ?? throw new ArgumentNullException("minimumTransferAmount is a required property for CreateAutomaticTokensForwardingRequestBodyDataItem and cannot be null");
            // to ensure "toAddress" is required (not null)
            this.ToAddress = toAddress ?? throw new ArgumentNullException("toAddress is a required property for CreateAutomaticTokensForwardingRequestBodyDataItem and cannot be null");
            // to ensure "tokenData" is required (not null)
            this.TokenData = tokenData ?? throw new ArgumentNullException("tokenData is a required property for CreateAutomaticTokensForwardingRequestBodyDataItem and cannot be null");
        ...
        public CreateAutomaticTokensForwardingRequestBodyTokenData TokenData { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateAutomaticTokensForwardingRequestBodyDataItem {\n");
        ...
        {
            return this.Equals(input as CreateAutomaticTokensForwardingRequestBodyDataItem);
        }

        /// <summary>
        /// Returns true if CreateAutomaticTokensForwardingRequestBodyDataItem instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateAutomaticTokensForwardingRequestBodyDataItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateAutomaticTokensForwardingRequestBodyDataItem input)
        {
            if (input == null)
                return false;
