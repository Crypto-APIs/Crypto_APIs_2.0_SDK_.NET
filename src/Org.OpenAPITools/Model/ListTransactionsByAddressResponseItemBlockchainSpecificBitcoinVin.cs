...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListTransactionsByAddressResponseItemBlockchainSpecificBitcoin_vin")]
    public partial class ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinVin : IEquatable<ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinVin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinVin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinVin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinVin" /> class.
        /// </summary>
        ...
        public ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinVin(List<string> addresses = default(List<string>), string coinbase = default(string), GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig scriptSig = default(GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinScriptSig), string sequence = default(string), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            this.Addresses = addresses ?? throw new ArgumentNullException("addresses is a required property for ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinVin and cannot be null");
            // to ensure "scriptSig" is required (not null)
            this.ScriptSig = scriptSig ?? throw new ArgumentNullException("scriptSig is a required property for ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinVin and cannot be null");
            // to ensure "sequence" is required (not null)
            this.Sequence = sequence ?? throw new ArgumentNullException("sequence is a required property for ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinVin and cannot be null");
            // to ensure "txinwitness" is required (not null)
            this.Txinwitness = txinwitness ?? throw new ArgumentNullException("txinwitness is a required property for ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinVin and cannot be null");
        ...
        {
            return this.Equals(input as ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinVin);
        }

        /// <summary>
        /// Returns true if ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinVin instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinVin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinVin input)
        {
            if (input == null)
                return false;
