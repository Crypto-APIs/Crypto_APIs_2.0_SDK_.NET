...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MinedTransactionRequestBody_data_item")]
    public partial class MinedTransactionRequestBodyDataItem : IEquatable<MinedTransactionRequestBodyDataItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MinedTransactionRequestBodyDataItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MinedTransactionRequestBodyDataItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MinedTransactionRequestBodyDataItem" /> class.
        /// </summary>
        ...
        public MinedTransactionRequestBodyDataItem(bool allowDuplicates = default(bool), string callbackSecretKey = default(string), string callbackUrl = default(string), string transactionId = default(string))
        {
            // to ensure "callbackUrl" is required (not null)
            this.CallbackUrl = callbackUrl ?? throw new ArgumentNullException("callbackUrl is a required property for MinedTransactionRequestBodyDataItem and cannot be null");
            // to ensure "transactionId" is required (not null)
            this.TransactionId = transactionId ?? throw new ArgumentNullException("transactionId is a required property for MinedTransactionRequestBodyDataItem and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MinedTransactionRequestBodyDataItem {\n");
        ...
        {
            return this.Equals(input as MinedTransactionRequestBodyDataItem);
        }

        /// <summary>
        /// Returns true if MinedTransactionRequestBodyDataItem instances are equal
        /// </summary>
        /// <param name="input">Instance of MinedTransactionRequestBodyDataItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MinedTransactionRequestBodyDataItem input)
        {
            if (input == null)
                return false;
