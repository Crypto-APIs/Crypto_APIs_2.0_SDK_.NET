...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListBlockchainEventsSubscriptionsResponseItem")]
    public partial class ListBlockchainEventsSubscriptionsResponseItem : IEquatable<ListBlockchainEventsSubscriptionsResponseItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListBlockchainEventsSubscriptionsResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListBlockchainEventsSubscriptionsResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListBlockchainEventsSubscriptionsResponseItem" /> class.
        /// </summary>
        ...
        public ListBlockchainEventsSubscriptionsResponseItem(string address = default(string), string callbackSecretKey = default(string), string callbackUrl = default(string), int confirmationsCount = default(int), int createdTimestamp = default(int), string eventType = default(string), bool isActive = default(bool), string referenceId = default(string), string transactionId = default(string))
        {
            // to ensure "address" is required (not null)
            this.Address = address ?? throw new ArgumentNullException("address is a required property for ListBlockchainEventsSubscriptionsResponseItem and cannot be null");
            // to ensure "callbackSecretKey" is required (not null)
            this.CallbackSecretKey = callbackSecretKey ?? throw new ArgumentNullException("callbackSecretKey is a required property for ListBlockchainEventsSubscriptionsResponseItem and cannot be null");
            // to ensure "callbackUrl" is required (not null)
            this.CallbackUrl = callbackUrl ?? throw new ArgumentNullException("callbackUrl is a required property for ListBlockchainEventsSubscriptionsResponseItem and cannot be null");
            this.ConfirmationsCount = confirmationsCount;
            this.CreatedTimestamp = createdTimestamp;
            // to ensure "eventType" is required (not null)
            this.EventType = eventType ?? throw new ArgumentNullException("eventType is a required property for ListBlockchainEventsSubscriptionsResponseItem and cannot be null");
            this.IsActive = isActive;
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for ListBlockchainEventsSubscriptionsResponseItem and cannot be null");
            // to ensure "transactionId" is required (not null)
            this.TransactionId = transactionId ?? throw new ArgumentNullException("transactionId is a required property for ListBlockchainEventsSubscriptionsResponseItem and cannot be null");
        }
        ...
        {
            return this.Equals(input as ListBlockchainEventsSubscriptionsResponseItem);
        }

        /// <summary>
        /// Returns true if ListBlockchainEventsSubscriptionsResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ListBlockchainEventsSubscriptionsResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListBlockchainEventsSubscriptionsResponseItem input)
        {
            if (input == null)
                return false;
