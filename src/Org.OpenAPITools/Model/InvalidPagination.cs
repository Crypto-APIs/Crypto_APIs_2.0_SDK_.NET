...
namespace Org.OpenAPITools.Model
{
    ...
    /// InvalidPagination
    /// </summary>
    [DataContract(Name = "InvalidPagination")]
    public partial class InvalidPagination : IEquatable<InvalidPagination>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidPagination" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvalidPagination() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidPagination" /> class.
        /// </summary>
        ...
        public InvalidPagination(string apiVersion = default(string), string requestId = default(string), string context = default(string), InvalidPaginationError error = default(InvalidPaginationError))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for InvalidPagination and cannot be null");
            // to ensure "requestId" is required (not null)
            this.RequestId = requestId ?? throw new ArgumentNullException("requestId is a required property for InvalidPagination and cannot be null");
            // to ensure "error" is required (not null)
            this.Error = error ?? throw new ArgumentNullException("error is a required property for InvalidPagination and cannot be null");
        ...
        public InvalidPaginationError Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InvalidPagination {\n");
        ...
        {
            return this.Equals(input as InvalidPagination);
        }

        /// <summary>
        /// Returns true if InvalidPagination instances are equal
        /// </summary>
        /// <param name="input">Instance of InvalidPagination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvalidPagination input)
        {
            if (input == null)
                return false;
