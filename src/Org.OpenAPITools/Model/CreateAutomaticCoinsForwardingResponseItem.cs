...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateAutomaticCoinsForwardingResponseItem")]
    public partial class CreateAutomaticCoinsForwardingResponseItem : IEquatable<CreateAutomaticCoinsForwardingResponseItem>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAutomaticCoinsForwardingResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateAutomaticCoinsForwardingResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAutomaticCoinsForwardingResponseItem" /> class.
        /// </summary>
        ...
        public CreateAutomaticCoinsForwardingResponseItem(string callbackUrl = default(string), int confirmationsCount = default(int), int createdTimestamp = default(int), FeePriorityEnum feePriority = default(FeePriorityEnum), string fromAddress = default(string), string minimumTransferAmount = default(string), string referenceId = default(string), string toAddress = default(string))
        {
            // to ensure "callbackUrl" is required (not null)
            this.CallbackUrl = callbackUrl ?? throw new ArgumentNullException("callbackUrl is a required property for CreateAutomaticCoinsForwardingResponseItem and cannot be null");
            this.ConfirmationsCount = confirmationsCount;
            this.CreatedTimestamp = createdTimestamp;
            this.FeePriority = feePriority;
            // to ensure "fromAddress" is required (not null)
            this.FromAddress = fromAddress ?? throw new ArgumentNullException("fromAddress is a required property for CreateAutomaticCoinsForwardingResponseItem and cannot be null");
            // to ensure "minimumTransferAmount" is required (not null)
            this.MinimumTransferAmount = minimumTransferAmount ?? throw new ArgumentNullException("minimumTransferAmount is a required property for CreateAutomaticCoinsForwardingResponseItem and cannot be null");
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for CreateAutomaticCoinsForwardingResponseItem and cannot be null");
            // to ensure "toAddress" is required (not null)
            this.ToAddress = toAddress ?? throw new ArgumentNullException("toAddress is a required property for CreateAutomaticCoinsForwardingResponseItem and cannot be null");
        }
        ...
        {
            return this.Equals(input as CreateAutomaticCoinsForwardingResponseItem);
        }

        /// <summary>
        /// Returns true if CreateAutomaticCoinsForwardingResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateAutomaticCoinsForwardingResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateAutomaticCoinsForwardingResponseItem input)
        {
            if (input == null)
                return false;
