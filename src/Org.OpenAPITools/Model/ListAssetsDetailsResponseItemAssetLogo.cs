...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListAssetsDetailsResponseItem_assetLogo")]
    public partial class ListAssetsDetailsResponseItemAssetLogo : IEquatable<ListAssetsDetailsResponseItemAssetLogo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAssetsDetailsResponseItemAssetLogo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListAssetsDetailsResponseItemAssetLogo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAssetsDetailsResponseItemAssetLogo" /> class.
        /// </summary>
        ...
        public ListAssetsDetailsResponseItemAssetLogo(string encoding = default(string), string imageData = default(string), string mimeType = default(string))
        {
            // to ensure "encoding" is required (not null)
            this.Encoding = encoding ?? throw new ArgumentNullException("encoding is a required property for ListAssetsDetailsResponseItemAssetLogo and cannot be null");
            // to ensure "imageData" is required (not null)
            this.ImageData = imageData ?? throw new ArgumentNullException("imageData is a required property for ListAssetsDetailsResponseItemAssetLogo and cannot be null");
            // to ensure "mimeType" is required (not null)
            this.MimeType = mimeType ?? throw new ArgumentNullException("mimeType is a required property for ListAssetsDetailsResponseItemAssetLogo and cannot be null");
        }
        ...
        {
            return this.Equals(input as ListAssetsDetailsResponseItemAssetLogo);
        }

        /// <summary>
        /// Returns true if ListAssetsDetailsResponseItemAssetLogo instances are equal
        /// </summary>
        /// <param name="input">Instance of ListAssetsDetailsResponseItemAssetLogo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListAssetsDetailsResponseItemAssetLogo input)
        {
            if (input == null)
                return false;
