...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AddTokensToExistingFromAddressRequestBody_data_item")]
    public partial class AddTokensToExistingFromAddressRequestBodyDataItem : IEquatable<AddTokensToExistingFromAddressRequestBodyDataItem>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AddTokensToExistingFromAddressRequestBodyDataItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AddTokensToExistingFromAddressRequestBodyDataItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddTokensToExistingFromAddressRequestBodyDataItem" /> class.
        /// </summary>
        ...
        public AddTokensToExistingFromAddressRequestBodyDataItem(string callbackSecretKey = default(string), string callbackUrl = default(string), int confirmationsCount = default(int), FeePriorityEnum feePriority = default(FeePriorityEnum), string fromAddress = default(string), string minimumTransferAmount = default(string), string toAddress = default(string), AddTokensToExistingFromAddressRequestBodyTokenData tokenData = default(AddTokensToExistingFromAddressRequestBodyTokenData))
        {
            // to ensure "callbackUrl" is required (not null)
            this.CallbackUrl = callbackUrl ?? throw new ArgumentNullException("callbackUrl is a required property for AddTokensToExistingFromAddressRequestBodyDataItem and cannot be null");
            this.ConfirmationsCount = confirmationsCount;
            this.FeePriority = feePriority;
            // to ensure "fromAddress" is required (not null)
            this.FromAddress = fromAddress ?? throw new ArgumentNullException("fromAddress is a required property for AddTokensToExistingFromAddressRequestBodyDataItem and cannot be null");
            // to ensure "minimumTransferAmount" is required (not null)
            this.MinimumTransferAmount = minimumTransferAmount ?? throw new ArgumentNullException("minimumTransferAmount is a required property for AddTokensToExistingFromAddressRequestBodyDataItem and cannot be null");
            // to ensure "toAddress" is required (not null)
            this.ToAddress = toAddress ?? throw new ArgumentNullException("toAddress is a required property for AddTokensToExistingFromAddressRequestBodyDataItem and cannot be null");
            // to ensure "tokenData" is required (not null)
            this.TokenData = tokenData ?? throw new ArgumentNullException("tokenData is a required property for AddTokensToExistingFromAddressRequestBodyDataItem and cannot be null");
        ...
        public AddTokensToExistingFromAddressRequestBodyTokenData TokenData { get; set; }
        ...
        {
            return this.Equals(input as AddTokensToExistingFromAddressRequestBodyDataItem);
        }

        /// <summary>
        /// Returns true if AddTokensToExistingFromAddressRequestBodyDataItem instances are equal
        /// </summary>
        /// <param name="input">Instance of AddTokensToExistingFromAddressRequestBodyDataItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddTokensToExistingFromAddressRequestBodyDataItem input)
        {
            if (input == null)
                return false;
