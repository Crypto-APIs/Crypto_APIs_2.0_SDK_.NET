...
namespace Org.OpenAPITools.Model
{
    ...
    /// Bitcoin Cash
    /// </summary>
    [DataContract(Name = "GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash")]
    public partial class GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash : IEquatable<GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash" /> class.
        /// </summary>
        ...
        public GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash(string difficulty = default(string), string nonce = default(string), int size = default(int), string bits = default(string), string chainwork = default(string), string merkleRoot = default(string), int version = default(int), string versionHex = default(string))
        {
            // to ensure "difficulty" is required (not null)
            this.Difficulty = difficulty ?? throw new ArgumentNullException("difficulty is a required property for GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash and cannot be null");
            // to ensure "nonce" is required (not null)
            this.Nonce = nonce ?? throw new ArgumentNullException("nonce is a required property for GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash and cannot be null");
            this.Size = size;
            // to ensure "bits" is required (not null)
            this.Bits = bits ?? throw new ArgumentNullException("bits is a required property for GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash and cannot be null");
            // to ensure "chainwork" is required (not null)
            this.Chainwork = chainwork ?? throw new ArgumentNullException("chainwork is a required property for GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash and cannot be null");
            // to ensure "merkleRoot" is required (not null)
            this.MerkleRoot = merkleRoot ?? throw new ArgumentNullException("merkleRoot is a required property for GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash and cannot be null");
            this.Version = version;
            // to ensure "versionHex" is required (not null)
            this.VersionHex = versionHex ?? throw new ArgumentNullException("versionHex is a required property for GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash and cannot be null");
        }
        ...
        /// </summary>
        /// <value>A sub-unit of BTC equal to 0.000001 BTC, or 100 Satoshi, and is the same as microbitcoin (μBTC). Bits have two-decimal precision.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash {\n");
        ...
        {
            return this.Equals(input as GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash);
        }

        /// <summary>
        /// Returns true if GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash instances are equal
        /// </summary>
        /// <param name="input">Instance of GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash input)
        {
            if (input == null)
                return false;
