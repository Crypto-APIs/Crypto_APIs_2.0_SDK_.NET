...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AlreadyExists : IEquatable<AlreadyExists>, IValidatableObject
    {
        /// <summary>
        ...
        public AlreadyExists(string apiVersion = default(string), string requestId = default(string), string context = default(string), AlreadyExistsError error = default(AlreadyExistsError))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for AlreadyExists and cannot be null");
            // to ensure "requestId" is required (not null)
            this.RequestId = requestId ?? throw new ArgumentNullException("requestId is a required property for AlreadyExists and cannot be null");
            // to ensure "error" is required (not null)
            this.Error = error ?? throw new ArgumentNullException("error is a required property for AlreadyExists and cannot be null");
        ...
        public AlreadyExistsError Error { get; set; }
        ...
        {
            return this.Equals(input as AlreadyExists);
        }

        /// <summary>
        /// Returns true if AlreadyExists instances are equal
        /// </summary>
        /// <param name="input">Instance of AlreadyExists to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlreadyExists input)
        {
            if (input == null)
                return false;
