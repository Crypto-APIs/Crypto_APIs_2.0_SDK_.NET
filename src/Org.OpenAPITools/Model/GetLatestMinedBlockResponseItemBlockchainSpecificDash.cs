...
namespace Org.OpenAPITools.Model
{
    ...
    /// Dash
    /// </summary>
    [DataContract(Name = "GetLatestMinedBlockResponseItemBlockchainSpecificDash")]
    public partial class GetLatestMinedBlockResponseItemBlockchainSpecificDash : IEquatable<GetLatestMinedBlockResponseItemBlockchainSpecificDash>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLatestMinedBlockResponseItemBlockchainSpecificDash" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetLatestMinedBlockResponseItemBlockchainSpecificDash() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLatestMinedBlockResponseItemBlockchainSpecificDash" /> class.
        /// </summary>
        ...
        public GetLatestMinedBlockResponseItemBlockchainSpecificDash(string difficulty = default(string), string nonce = default(string), int size = default(int), string bits = default(string), string chainwork = default(string), string merkleRoot = default(string), int version = default(int), string versionHex = default(string))
        {
            // to ensure "difficulty" is required (not null)
            this.Difficulty = difficulty ?? throw new ArgumentNullException("difficulty is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificDash and cannot be null");
            // to ensure "nonce" is required (not null)
            this.Nonce = nonce ?? throw new ArgumentNullException("nonce is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificDash and cannot be null");
            this.Size = size;
            // to ensure "bits" is required (not null)
            this.Bits = bits ?? throw new ArgumentNullException("bits is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificDash and cannot be null");
            // to ensure "chainwork" is required (not null)
            this.Chainwork = chainwork ?? throw new ArgumentNullException("chainwork is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificDash and cannot be null");
            // to ensure "merkleRoot" is required (not null)
            this.MerkleRoot = merkleRoot ?? throw new ArgumentNullException("merkleRoot is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificDash and cannot be null");
            this.Version = version;
            // to ensure "versionHex" is required (not null)
            this.VersionHex = versionHex ?? throw new ArgumentNullException("versionHex is a required property for GetLatestMinedBlockResponseItemBlockchainSpecificDash and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetLatestMinedBlockResponseItemBlockchainSpecificDash {\n");
        ...
        {
            return this.Equals(input as GetLatestMinedBlockResponseItemBlockchainSpecificDash);
        }

        /// <summary>
        /// Returns true if GetLatestMinedBlockResponseItemBlockchainSpecificDash instances are equal
        /// </summary>
        /// <param name="input">Instance of GetLatestMinedBlockResponseItemBlockchainSpecificDash to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetLatestMinedBlockResponseItemBlockchainSpecificDash input)
        {
            if (input == null)
                return false;
