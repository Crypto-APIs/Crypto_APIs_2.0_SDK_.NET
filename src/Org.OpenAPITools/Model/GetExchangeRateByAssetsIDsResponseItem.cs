...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetExchangeRateByAssetsIDsResponseItem")]
    public partial class GetExchangeRateByAssetsIDsResponseItem : IEquatable<GetExchangeRateByAssetsIDsResponseItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetExchangeRateByAssetsIDsResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetExchangeRateByAssetsIDsResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetExchangeRateByAssetsIDsResponseItem" /> class.
        /// </summary>
        ...
        public GetExchangeRateByAssetsIDsResponseItem(int calculationTimestamp = default(int), string fromAssetId = default(string), string fromAssetSymbol = default(string), string rate = default(string), string toAssetId = default(string), string toAssetSymbol = default(string))
        {
            this.CalculationTimestamp = calculationTimestamp;
            // to ensure "fromAssetId" is required (not null)
            this.FromAssetId = fromAssetId ?? throw new ArgumentNullException("fromAssetId is a required property for GetExchangeRateByAssetsIDsResponseItem and cannot be null");
            // to ensure "fromAssetSymbol" is required (not null)
            this.FromAssetSymbol = fromAssetSymbol ?? throw new ArgumentNullException("fromAssetSymbol is a required property for GetExchangeRateByAssetsIDsResponseItem and cannot be null");
            // to ensure "rate" is required (not null)
            this.Rate = rate ?? throw new ArgumentNullException("rate is a required property for GetExchangeRateByAssetsIDsResponseItem and cannot be null");
            // to ensure "toAssetId" is required (not null)
            this.ToAssetId = toAssetId ?? throw new ArgumentNullException("toAssetId is a required property for GetExchangeRateByAssetsIDsResponseItem and cannot be null");
            // to ensure "toAssetSymbol" is required (not null)
            this.ToAssetSymbol = toAssetSymbol ?? throw new ArgumentNullException("toAssetSymbol is a required property for GetExchangeRateByAssetsIDsResponseItem and cannot be null");
        }
        ...
        {
            return this.Equals(input as GetExchangeRateByAssetsIDsResponseItem);
        }

        /// <summary>
        /// Returns true if GetExchangeRateByAssetsIDsResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of GetExchangeRateByAssetsIDsResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetExchangeRateByAssetsIDsResponseItem input)
        {
            if (input == null)
                return false;
