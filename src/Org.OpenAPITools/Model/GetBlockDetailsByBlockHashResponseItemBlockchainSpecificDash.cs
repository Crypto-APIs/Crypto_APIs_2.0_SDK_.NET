...
namespace Org.OpenAPITools.Model
{
    ...
    /// Dash
    /// </summary>
    [DataContract(Name = "GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDash")]
    public partial class GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDash : IEquatable<GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDash>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDash" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDash() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDash" /> class.
        /// </summary>
        ...
        public GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDash(string difficulty = default(string), string nonce = default(string), int size = default(int), string bits = default(string), string chainwork = default(string), string merkleRoot = default(string), int version = default(int), string versionHex = default(string))
        {
            // to ensure "difficulty" is required (not null)
            this.Difficulty = difficulty ?? throw new ArgumentNullException("difficulty is a required property for GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDash and cannot be null");
            // to ensure "nonce" is required (not null)
            this.Nonce = nonce ?? throw new ArgumentNullException("nonce is a required property for GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDash and cannot be null");
            this.Size = size;
            // to ensure "bits" is required (not null)
            this.Bits = bits ?? throw new ArgumentNullException("bits is a required property for GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDash and cannot be null");
            // to ensure "chainwork" is required (not null)
            this.Chainwork = chainwork ?? throw new ArgumentNullException("chainwork is a required property for GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDash and cannot be null");
            // to ensure "merkleRoot" is required (not null)
            this.MerkleRoot = merkleRoot ?? throw new ArgumentNullException("merkleRoot is a required property for GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDash and cannot be null");
            this.Version = version;
            // to ensure "versionHex" is required (not null)
            this.VersionHex = versionHex ?? throw new ArgumentNullException("versionHex is a required property for GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDash and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDash {\n");
        ...
        {
            return this.Equals(input as GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDash);
        }

        /// <summary>
        /// Returns true if GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDash instances are equal
        /// </summary>
        /// <param name="input">Instance of GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDash to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDash input)
        {
            if (input == null)
                return false;
