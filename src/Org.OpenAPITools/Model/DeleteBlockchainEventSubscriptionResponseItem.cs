...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeleteBlockchainEventSubscriptionResponseItem")]
    public partial class DeleteBlockchainEventSubscriptionResponseItem : IEquatable<DeleteBlockchainEventSubscriptionResponseItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteBlockchainEventSubscriptionResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeleteBlockchainEventSubscriptionResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteBlockchainEventSubscriptionResponseItem" /> class.
        /// </summary>
        ...
        public DeleteBlockchainEventSubscriptionResponseItem(string callbackSecretKey = default(string), string callbackUrl = default(string), int createdTimestamp = default(int), string eventType = default(string), string referenceId = default(string))
        {
            // to ensure "callbackSecretKey" is required (not null)
            this.CallbackSecretKey = callbackSecretKey ?? throw new ArgumentNullException("callbackSecretKey is a required property for DeleteBlockchainEventSubscriptionResponseItem and cannot be null");
            // to ensure "callbackUrl" is required (not null)
            this.CallbackUrl = callbackUrl ?? throw new ArgumentNullException("callbackUrl is a required property for DeleteBlockchainEventSubscriptionResponseItem and cannot be null");
            this.CreatedTimestamp = createdTimestamp;
            // to ensure "eventType" is required (not null)
            this.EventType = eventType ?? throw new ArgumentNullException("eventType is a required property for DeleteBlockchainEventSubscriptionResponseItem and cannot be null");
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for DeleteBlockchainEventSubscriptionResponseItem and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteBlockchainEventSubscriptionResponseItem {\n");
        ...
        {
            return this.Equals(input as DeleteBlockchainEventSubscriptionResponseItem);
        }

        /// <summary>
        /// Returns true if DeleteBlockchainEventSubscriptionResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteBlockchainEventSubscriptionResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteBlockchainEventSubscriptionResponseItem input)
        {
            if (input == null)
                return false;
