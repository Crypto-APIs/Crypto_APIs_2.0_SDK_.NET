...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListTokensForwardingAutomationsResponseItem")]
    public partial class ListTokensForwardingAutomationsResponseItem : IEquatable<ListTokensForwardingAutomationsResponseItem>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTokensForwardingAutomationsResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTokensForwardingAutomationsResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTokensForwardingAutomationsResponseItem" /> class.
        /// </summary>
        ...
        public ListTokensForwardingAutomationsResponseItem(string callbackUrl = default(string), int confirmationsCount = default(int), int createdTimestamp = default(int), string feeAddress = default(string), FeePriorityEnum feePriority = default(FeePriorityEnum), string fromAddress = default(string), string minimumTransferAmount = default(string), string referenceId = default(string), string toAddress = default(string), ListTokensForwardingAutomationsResponseItemTokenData tokenData = default(ListTokensForwardingAutomationsResponseItemTokenData))
        {
            // to ensure "callbackUrl" is required (not null)
            this.CallbackUrl = callbackUrl ?? throw new ArgumentNullException("callbackUrl is a required property for ListTokensForwardingAutomationsResponseItem and cannot be null");
            this.CreatedTimestamp = createdTimestamp;
            // to ensure "feeAddress" is required (not null)
            this.FeeAddress = feeAddress ?? throw new ArgumentNullException("feeAddress is a required property for ListTokensForwardingAutomationsResponseItem and cannot be null");
            this.FeePriority = feePriority;
            // to ensure "fromAddress" is required (not null)
            this.FromAddress = fromAddress ?? throw new ArgumentNullException("fromAddress is a required property for ListTokensForwardingAutomationsResponseItem and cannot be null");
            // to ensure "minimumTransferAmount" is required (not null)
            this.MinimumTransferAmount = minimumTransferAmount ?? throw new ArgumentNullException("minimumTransferAmount is a required property for ListTokensForwardingAutomationsResponseItem and cannot be null");
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for ListTokensForwardingAutomationsResponseItem and cannot be null");
            // to ensure "toAddress" is required (not null)
            this.ToAddress = toAddress ?? throw new ArgumentNullException("toAddress is a required property for ListTokensForwardingAutomationsResponseItem and cannot be null");
            // to ensure "tokenData" is required (not null)
            this.TokenData = tokenData ?? throw new ArgumentNullException("tokenData is a required property for ListTokensForwardingAutomationsResponseItem and cannot be null");
        ...
        public ListTokensForwardingAutomationsResponseItemTokenData TokenData { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListTokensForwardingAutomationsResponseItem {\n");
        ...
        {
            return this.Equals(input as ListTokensForwardingAutomationsResponseItem);
        }

        /// <summary>
        /// Returns true if ListTokensForwardingAutomationsResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTokensForwardingAutomationsResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTokensForwardingAutomationsResponseItem input)
        {
            if (input == null)
                return false;
