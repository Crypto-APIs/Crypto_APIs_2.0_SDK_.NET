...
namespace Org.OpenAPITools.Model
{
    ...
    /// Bitcoin
    /// </summary>
    [DataContract(Name = "GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin")]
    public partial class GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin : IEquatable<GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin" /> class.
        /// </summary>
        ...
        public GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin(string difficulty = default(string), string nonce = default(string), int size = default(int), string bits = default(string), string chainwork = default(string), string merkleRoot = default(string), int strippedSize = default(int), int version = default(int), string versionHex = default(string), int weight = default(int))
        {
            // to ensure "difficulty" is required (not null)
            this.Difficulty = difficulty ?? throw new ArgumentNullException("difficulty is a required property for GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin and cannot be null");
            // to ensure "nonce" is required (not null)
            this.Nonce = nonce ?? throw new ArgumentNullException("nonce is a required property for GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin and cannot be null");
            this.Size = size;
            // to ensure "bits" is required (not null)
            this.Bits = bits ?? throw new ArgumentNullException("bits is a required property for GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin and cannot be null");
            // to ensure "chainwork" is required (not null)
            this.Chainwork = chainwork ?? throw new ArgumentNullException("chainwork is a required property for GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin and cannot be null");
            // to ensure "merkleRoot" is required (not null)
            this.MerkleRoot = merkleRoot ?? throw new ArgumentNullException("merkleRoot is a required property for GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin and cannot be null");
            this.StrippedSize = strippedSize;
            this.Version = version;
            // to ensure "versionHex" is required (not null)
            this.VersionHex = versionHex ?? throw new ArgumentNullException("versionHex is a required property for GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin and cannot be null");
            this.Weight = weight;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin {\n");
        ...
        {
            return this.Equals(input as GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin);
        }

        /// <summary>
        /// Returns true if GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin instances are equal
        /// </summary>
        /// <param name="input">Instance of GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin input)
        {
            if (input == null)
                return false;
