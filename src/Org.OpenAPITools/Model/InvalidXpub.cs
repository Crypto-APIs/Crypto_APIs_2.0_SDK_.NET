...
namespace Org.OpenAPITools.Model
{
    ...
    /// InvalidXpub
    /// </summary>
    [DataContract(Name = "InvalidXpub")]
    public partial class InvalidXpub : IEquatable<InvalidXpub>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidXpub" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvalidXpub() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvalidXpub" /> class.
        /// </summary>
        ...
        public InvalidXpub(string apiVersion = default(string), string requestId = default(string), string context = default(string), InvalidXpubError error = default(InvalidXpubError))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for InvalidXpub and cannot be null");
            // to ensure "requestId" is required (not null)
            this.RequestId = requestId ?? throw new ArgumentNullException("requestId is a required property for InvalidXpub and cannot be null");
            // to ensure "error" is required (not null)
            this.Error = error ?? throw new ArgumentNullException("error is a required property for InvalidXpub and cannot be null");
        ...
        public InvalidXpubError Error { get; set; }
        ...
        {
            return this.Equals(input as InvalidXpub);
        }

        /// <summary>
        /// Returns true if InvalidXpub instances are equal
        /// </summary>
        /// <param name="input">Instance of InvalidXpub to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvalidXpub input)
        {
            if (input == null)
                return false;
