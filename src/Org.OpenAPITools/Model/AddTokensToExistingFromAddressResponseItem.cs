...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AddTokensToExistingFromAddressResponseItem")]
    public partial class AddTokensToExistingFromAddressResponseItem : IEquatable<AddTokensToExistingFromAddressResponseItem>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AddTokensToExistingFromAddressResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AddTokensToExistingFromAddressResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddTokensToExistingFromAddressResponseItem" /> class.
        /// </summary>
        ...
        public AddTokensToExistingFromAddressResponseItem(string callbackUrl = default(string), int confirmationsCount = default(int), int createdTimestamp = default(int), string feeAddress = default(string), FeePriorityEnum feePriority = default(FeePriorityEnum), string fromAddress = default(string), string minimumTransferAmount = default(string), string referenceId = default(string), string toAddress = default(string), AddTokensToExistingFromAddressResponseItemTokenData tokenData = default(AddTokensToExistingFromAddressResponseItemTokenData))
        {
            // to ensure "callbackUrl" is required (not null)
            this.CallbackUrl = callbackUrl ?? throw new ArgumentNullException("callbackUrl is a required property for AddTokensToExistingFromAddressResponseItem and cannot be null");
            this.ConfirmationsCount = confirmationsCount;
            this.CreatedTimestamp = createdTimestamp;
            // to ensure "feeAddress" is required (not null)
            this.FeeAddress = feeAddress ?? throw new ArgumentNullException("feeAddress is a required property for AddTokensToExistingFromAddressResponseItem and cannot be null");
            this.FeePriority = feePriority;
            // to ensure "fromAddress" is required (not null)
            this.FromAddress = fromAddress ?? throw new ArgumentNullException("fromAddress is a required property for AddTokensToExistingFromAddressResponseItem and cannot be null");
            // to ensure "minimumTransferAmount" is required (not null)
            this.MinimumTransferAmount = minimumTransferAmount ?? throw new ArgumentNullException("minimumTransferAmount is a required property for AddTokensToExistingFromAddressResponseItem and cannot be null");
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for AddTokensToExistingFromAddressResponseItem and cannot be null");
            // to ensure "toAddress" is required (not null)
            this.ToAddress = toAddress ?? throw new ArgumentNullException("toAddress is a required property for AddTokensToExistingFromAddressResponseItem and cannot be null");
            // to ensure "tokenData" is required (not null)
            this.TokenData = tokenData ?? throw new ArgumentNullException("tokenData is a required property for AddTokensToExistingFromAddressResponseItem and cannot be null");
        }
        ...
        public AddTokensToExistingFromAddressResponseItemTokenData TokenData { get; set; }
        ...
        {
            return this.Equals(input as AddTokensToExistingFromAddressResponseItem);
        }

        /// <summary>
        /// Returns true if AddTokensToExistingFromAddressResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of AddTokensToExistingFromAddressResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddTokensToExistingFromAddressResponseItem input)
        {
            if (input == null)
                return false;
