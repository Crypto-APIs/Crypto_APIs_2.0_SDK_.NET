...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListTransactionsByAddressResponseItemBlockchainSpecificDash_vin")]
    public partial class ListTransactionsByAddressResponseItemBlockchainSpecificDashVin : IEquatable<ListTransactionsByAddressResponseItemBlockchainSpecificDashVin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressResponseItemBlockchainSpecificDashVin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByAddressResponseItemBlockchainSpecificDashVin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressResponseItemBlockchainSpecificDashVin" /> class.
        /// </summary>
        ...
        public ListTransactionsByAddressResponseItemBlockchainSpecificDashVin(List<string> addresses = default(List<string>), string coinbase = default(string), ListTransactionsByAddressResponseItemBlockchainSpecificDashScriptSig scriptSig = default(ListTransactionsByAddressResponseItemBlockchainSpecificDashScriptSig), string sequence = default(string), string txid = default(string), List<string> txinwitness = default(List<string>), string value = default(string), int vout = default(int))
        {
            // to ensure "addresses" is required (not null)
            this.Addresses = addresses ?? throw new ArgumentNullException("addresses is a required property for ListTransactionsByAddressResponseItemBlockchainSpecificDashVin and cannot be null");
            // to ensure "scriptSig" is required (not null)
            this.ScriptSig = scriptSig ?? throw new ArgumentNullException("scriptSig is a required property for ListTransactionsByAddressResponseItemBlockchainSpecificDashVin and cannot be null");
            // to ensure "sequence" is required (not null)
            this.Sequence = sequence ?? throw new ArgumentNullException("sequence is a required property for ListTransactionsByAddressResponseItemBlockchainSpecificDashVin and cannot be null");
            // to ensure "txinwitness" is required (not null)
            this.Txinwitness = txinwitness ?? throw new ArgumentNullException("txinwitness is a required property for ListTransactionsByAddressResponseItemBlockchainSpecificDashVin and cannot be null");
            this.Vout = vout;
        ...
        public ListTransactionsByAddressResponseItemBlockchainSpecificDashScriptSig ScriptSig { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListTransactionsByAddressResponseItemBlockchainSpecificDashVin {\n");
        ...
        {
            return this.Equals(input as ListTransactionsByAddressResponseItemBlockchainSpecificDashVin);
        }

        /// <summary>
        /// Returns true if ListTransactionsByAddressResponseItemBlockchainSpecificDashVin instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByAddressResponseItemBlockchainSpecificDashVin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByAddressResponseItemBlockchainSpecificDashVin input)
        {
            if (input == null)
                return false;
