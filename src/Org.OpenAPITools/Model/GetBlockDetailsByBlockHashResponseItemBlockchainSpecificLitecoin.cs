...
namespace Org.OpenAPITools.Model
{
    ...
    /// Litecoin
    /// </summary>
    [DataContract(Name = "GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin")]
    public partial class GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin : IEquatable<GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin" /> class.
        /// </summary>
        ...
        public GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin(string difficulty = default(string), string nonce = default(string), int size = default(int), string bits = default(string), string chainwork = default(string), string merkleRoot = default(string), int strippedSize = default(int), int version = default(int), string versionHex = default(string), int weight = default(int))
        {
            // to ensure "difficulty" is required (not null)
            this.Difficulty = difficulty ?? throw new ArgumentNullException("difficulty is a required property for GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin and cannot be null");
            // to ensure "nonce" is required (not null)
            this.Nonce = nonce ?? throw new ArgumentNullException("nonce is a required property for GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin and cannot be null");
            this.Size = size;
            // to ensure "bits" is required (not null)
            this.Bits = bits ?? throw new ArgumentNullException("bits is a required property for GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin and cannot be null");
            // to ensure "chainwork" is required (not null)
            this.Chainwork = chainwork ?? throw new ArgumentNullException("chainwork is a required property for GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin and cannot be null");
            // to ensure "merkleRoot" is required (not null)
            this.MerkleRoot = merkleRoot ?? throw new ArgumentNullException("merkleRoot is a required property for GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin and cannot be null");
            this.StrippedSize = strippedSize;
            this.Version = version;
            // to ensure "versionHex" is required (not null)
            this.VersionHex = versionHex ?? throw new ArgumentNullException("versionHex is a required property for GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin and cannot be null");
            this.Weight = weight;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin {\n");
        ...
        {
            return this.Equals(input as GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin);
        }

        /// <summary>
        /// Returns true if GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin instances are equal
        /// </summary>
        /// <param name="input">Instance of GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin input)
        {
            if (input == null)
                return false;
