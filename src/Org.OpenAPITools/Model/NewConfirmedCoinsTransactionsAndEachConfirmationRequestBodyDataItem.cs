...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewConfirmedCoinsTransactionsAndEachConfirmationRequestBody_data_item")]
    public partial class NewConfirmedCoinsTransactionsAndEachConfirmationRequestBodyDataItem : IEquatable<NewConfirmedCoinsTransactionsAndEachConfirmationRequestBodyDataItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewConfirmedCoinsTransactionsAndEachConfirmationRequestBodyDataItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewConfirmedCoinsTransactionsAndEachConfirmationRequestBodyDataItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewConfirmedCoinsTransactionsAndEachConfirmationRequestBodyDataItem" /> class.
        /// </summary>
        ...
        public NewConfirmedCoinsTransactionsAndEachConfirmationRequestBodyDataItem(string address = default(string), bool allowDuplicates = false, string callbackSecretKey = default(string), string callbackUrl = default(string), int confirmationsCount = default(int))
        {
            // to ensure "address" is required (not null)
            this.Address = address ?? throw new ArgumentNullException("address is a required property for NewConfirmedCoinsTransactionsAndEachConfirmationRequestBodyDataItem and cannot be null");
            // to ensure "callbackUrl" is required (not null)
            this.CallbackUrl = callbackUrl ?? throw new ArgumentNullException("callbackUrl is a required property for NewConfirmedCoinsTransactionsAndEachConfirmationRequestBodyDataItem and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewConfirmedCoinsTransactionsAndEachConfirmationRequestBodyDataItem {\n");
        ...
        {
            return this.Equals(input as NewConfirmedCoinsTransactionsAndEachConfirmationRequestBodyDataItem);
        }

        /// <summary>
        /// Returns true if NewConfirmedCoinsTransactionsAndEachConfirmationRequestBodyDataItem instances are equal
        /// </summary>
        /// <param name="input">Instance of NewConfirmedCoinsTransactionsAndEachConfirmationRequestBodyDataItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewConfirmedCoinsTransactionsAndEachConfirmationRequestBodyDataItem input)
        {
            if (input == null)
                return false;
