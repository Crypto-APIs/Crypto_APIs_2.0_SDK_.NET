...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListHDWalletxPubYPubZPubTransactionsResponseItem")]
    public partial class ListHDWalletxPubYPubZPubTransactionsResponseItem : IEquatable<ListHDWalletxPubYPubZPubTransactionsResponseItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListHDWalletxPubYPubZPubTransactionsResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListHDWalletxPubYPubZPubTransactionsResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListHDWalletxPubYPubZPubTransactionsResponseItem" /> class.
        /// </summary>
        ...
        public ListHDWalletxPubYPubZPubTransactionsResponseItem(int index = default(int), string minedInBlockHash = default(string), int minedInBlockHeight = default(int), List<ListHDWalletxPubYPubZPubTransactionsResponseItemRecipients> recipients = default(List<ListHDWalletxPubYPubZPubTransactionsResponseItemRecipients>), List<ListHDWalletxPubYPubZPubTransactionsResponseItemSenders> senders = default(List<ListHDWalletxPubYPubZPubTransactionsResponseItemSenders>), int timestamp = default(int), string transactionHash = default(string), string transactionId = default(string), ListHDWalletxPubYPubZPubTransactionsResponseItemFee fee = default(ListHDWalletxPubYPubZPubTransactionsResponseItemFee))
        {
            this.Index = index;
            // to ensure "minedInBlockHash" is required (not null)
            this.MinedInBlockHash = minedInBlockHash ?? throw new ArgumentNullException("minedInBlockHash is a required property for ListHDWalletxPubYPubZPubTransactionsResponseItem and cannot be null");
            this.MinedInBlockHeight = minedInBlockHeight;
            // to ensure "recipients" is required (not null)
            this.Recipients = recipients ?? throw new ArgumentNullException("recipients is a required property for ListHDWalletxPubYPubZPubTransactionsResponseItem and cannot be null");
            // to ensure "senders" is required (not null)
            this.Senders = senders ?? throw new ArgumentNullException("senders is a required property for ListHDWalletxPubYPubZPubTransactionsResponseItem and cannot be null");
            this.Timestamp = timestamp;
            // to ensure "transactionHash" is required (not null)
            this.TransactionHash = transactionHash ?? throw new ArgumentNullException("transactionHash is a required property for ListHDWalletxPubYPubZPubTransactionsResponseItem and cannot be null");
            // to ensure "transactionId" is required (not null)
            this.TransactionId = transactionId ?? throw new ArgumentNullException("transactionId is a required property for ListHDWalletxPubYPubZPubTransactionsResponseItem and cannot be null");
            // to ensure "fee" is required (not null)
            this.Fee = fee ?? throw new ArgumentNullException("fee is a required property for ListHDWalletxPubYPubZPubTransactionsResponseItem and cannot be null");
        }
        ...
        public List<ListHDWalletxPubYPubZPubTransactionsResponseItemRecipients> Recipients { get; set; }
        ...
        public List<ListHDWalletxPubYPubZPubTransactionsResponseItemSenders> Senders { get; set; }
        ...
        public ListHDWalletxPubYPubZPubTransactionsResponseItemFee Fee { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListHDWalletxPubYPubZPubTransactionsResponseItem {\n");
        ...
        {
            return this.Equals(input as ListHDWalletxPubYPubZPubTransactionsResponseItem);
        }

        /// <summary>
        /// Returns true if ListHDWalletxPubYPubZPubTransactionsResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ListHDWalletxPubYPubZPubTransactionsResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListHDWalletxPubYPubZPubTransactionsResponseItem input)
        {
            if (input == null)
                return false;
