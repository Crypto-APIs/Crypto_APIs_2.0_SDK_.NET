...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListOmniTransactionsByBlockHeightResponseItem")]
    public partial class ListOmniTransactionsByBlockHeightResponseItem : IEquatable<ListOmniTransactionsByBlockHeightResponseItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListOmniTransactionsByBlockHeightResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListOmniTransactionsByBlockHeightResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListOmniTransactionsByBlockHeightResponseItem" /> class.
        /// </summary>
        ...
        public ListOmniTransactionsByBlockHeightResponseItem(string amount = default(string), bool divisible = default(bool), string minedInBlockHash = default(string), int minedInBlockHeight = default(int), int positionInBlock = default(int), int propertyId = default(int), List<ListOmniTransactionsByBlockHeightResponseItemRecipients> recipients = default(List<ListOmniTransactionsByBlockHeightResponseItemRecipients>), List<ListOmniTransactionsByBlockHeightResponseItemSenders> senders = default(List<ListOmniTransactionsByBlockHeightResponseItemSenders>), int timestamp = default(int), string transactionId = default(string), string type = default(string), int typeInt = default(int), bool valid = default(bool), int version = default(int), ListOmniTransactionsByBlockHeightResponseItemFee fee = default(ListOmniTransactionsByBlockHeightResponseItemFee))
        {
            // to ensure "amount" is required (not null)
            this.Amount = amount ?? throw new ArgumentNullException("amount is a required property for ListOmniTransactionsByBlockHeightResponseItem and cannot be null");
            this.Divisible = divisible;
            // to ensure "minedInBlockHash" is required (not null)
            this.MinedInBlockHash = minedInBlockHash ?? throw new ArgumentNullException("minedInBlockHash is a required property for ListOmniTransactionsByBlockHeightResponseItem and cannot be null");
            this.MinedInBlockHeight = minedInBlockHeight;
            this.PositionInBlock = positionInBlock;
            this.PropertyId = propertyId;
            // to ensure "recipients" is required (not null)
            this.Recipients = recipients ?? throw new ArgumentNullException("recipients is a required property for ListOmniTransactionsByBlockHeightResponseItem and cannot be null");
            // to ensure "senders" is required (not null)
            this.Senders = senders ?? throw new ArgumentNullException("senders is a required property for ListOmniTransactionsByBlockHeightResponseItem and cannot be null");
            this.Timestamp = timestamp;
            // to ensure "transactionId" is required (not null)
            this.TransactionId = transactionId ?? throw new ArgumentNullException("transactionId is a required property for ListOmniTransactionsByBlockHeightResponseItem and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for ListOmniTransactionsByBlockHeightResponseItem and cannot be null");
            this.TypeInt = typeInt;
            this.Valid = valid;
            this.Version = version;
            // to ensure "fee" is required (not null)
            this.Fee = fee ?? throw new ArgumentNullException("fee is a required property for ListOmniTransactionsByBlockHeightResponseItem and cannot be null");
        }
        ...
        public List<ListOmniTransactionsByBlockHeightResponseItemRecipients> Recipients { get; set; }
        ...
        public List<ListOmniTransactionsByBlockHeightResponseItemSenders> Senders { get; set; }
        ...
        public ListOmniTransactionsByBlockHeightResponseItemFee Fee { get; set; }
        ...
        {
            return this.Equals(input as ListOmniTransactionsByBlockHeightResponseItem);
        }

        /// <summary>
        /// Returns true if ListOmniTransactionsByBlockHeightResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ListOmniTransactionsByBlockHeightResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListOmniTransactionsByBlockHeightResponseItem input)
        {
            if (input == null)
                return false;
