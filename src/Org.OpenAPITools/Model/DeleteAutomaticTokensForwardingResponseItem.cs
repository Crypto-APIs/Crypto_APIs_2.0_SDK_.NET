...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeleteAutomaticTokensForwardingResponseItem")]
    public partial class DeleteAutomaticTokensForwardingResponseItem : IEquatable<DeleteAutomaticTokensForwardingResponseItem>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteAutomaticTokensForwardingResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeleteAutomaticTokensForwardingResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteAutomaticTokensForwardingResponseItem" /> class.
        /// </summary>
        ...
        /// <param name="minimumTransferAmount">Represents the minimum transfer amount of the tokens in the &#x60;fromAddress&#x60; that can be allowed for an automatic forwarding. (required).</param>
        /// <param name="referenceId">Represents a unique ID used to reference the specific callback subscription. (required).</param>
        /// <param name="toAddress">Represents the hash of the address the tokens are forwarded to. (required).</param>
        /// <param name="tokenData">tokenData (required).</param>
        public DeleteAutomaticTokensForwardingResponseItem(string callbackUrl = default(string), int confirmationsCount = default(int), int createdTimestamp = default(int), string feeAddress = default(string), FeePriorityEnum feePriority = default(FeePriorityEnum), string fromAddress = default(string), string minimumTransferAmount = default(string), string referenceId = default(string), string toAddress = default(string), DeleteAutomaticTokensForwardingResponseItemTokenData tokenData = default(DeleteAutomaticTokensForwardingResponseItemTokenData))
        {
            // to ensure "callbackUrl" is required (not null)
            this.CallbackUrl = callbackUrl ?? throw new ArgumentNullException("callbackUrl is a required property for DeleteAutomaticTokensForwardingResponseItem and cannot be null");
            this.ConfirmationsCount = confirmationsCount;
            this.CreatedTimestamp = createdTimestamp;
            // to ensure "feeAddress" is required (not null)
            this.FeeAddress = feeAddress ?? throw new ArgumentNullException("feeAddress is a required property for DeleteAutomaticTokensForwardingResponseItem and cannot be null");
            this.FeePriority = feePriority;
            // to ensure "fromAddress" is required (not null)
            this.FromAddress = fromAddress ?? throw new ArgumentNullException("fromAddress is a required property for DeleteAutomaticTokensForwardingResponseItem and cannot be null");
            // to ensure "minimumTransferAmount" is required (not null)
            this.MinimumTransferAmount = minimumTransferAmount ?? throw new ArgumentNullException("minimumTransferAmount is a required property for DeleteAutomaticTokensForwardingResponseItem and cannot be null");
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for DeleteAutomaticTokensForwardingResponseItem and cannot be null");
            // to ensure "toAddress" is required (not null)
            this.ToAddress = toAddress ?? throw new ArgumentNullException("toAddress is a required property for DeleteAutomaticTokensForwardingResponseItem and cannot be null");
            // to ensure "tokenData" is required (not null)
            this.TokenData = tokenData ?? throw new ArgumentNullException("tokenData is a required property for DeleteAutomaticTokensForwardingResponseItem and cannot be null");
        }
        ...
        [DataMember(Name = "feeAddress", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Represents the minimum transfer amount of the tokens in the &#x60;fromAddress&#x60; that can be allowed for an automatic forwarding.</value>
        ...
        /// </summary>
        /// <value>Represents the hash of the address the tokens are forwarded to.</value>
        ...
        public DeleteAutomaticTokensForwardingResponseItemTokenData TokenData { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteAutomaticTokensForwardingResponseItem {\n");
            sb.Append("  CallbackUrl: ").Append(CallbackUrl).Append("\n");
            sb.Append("  ConfirmationsCount: ").Append(ConfirmationsCount).Append("\n");
            sb.Append("  CreatedTimestamp: ").Append(CreatedTimestamp).Append("\n");
            sb.Append("  FeeAddress: ").Append(FeeAddress).Append("\n");
        ...
        {
            return this.Equals(input as DeleteAutomaticTokensForwardingResponseItem);
        }

        /// <summary>
        /// Returns true if DeleteAutomaticTokensForwardingResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteAutomaticTokensForwardingResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteAutomaticTokensForwardingResponseItem input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.FeeAddress == input.FeeAddress ||
                    (this.FeeAddress != null &&
                    this.FeeAddress.Equals(input.FeeAddress))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.FeeAddress != null)
                    hashCode = hashCode * 59 + this.FeeAddress.GetHashCode();
