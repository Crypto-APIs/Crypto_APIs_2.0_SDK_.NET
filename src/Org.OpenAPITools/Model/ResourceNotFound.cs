...
namespace Org.OpenAPITools.Model
{
    ...
    /// ResourceNotFound
    /// </summary>
    [DataContract(Name = "ResourceNotFound")]
    public partial class ResourceNotFound : IEquatable<ResourceNotFound>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceNotFound" /> class.
        /// </summary>
        ...
        public ResourceNotFound(string apiVersion = default(string), string requestId = default(string), string context = default(string), ResourceNotFoundError error = default(ResourceNotFoundError))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for ResourceNotFound and cannot be null");
            // to ensure "requestId" is required (not null)
            this.RequestId = requestId ?? throw new ArgumentNullException("requestId is a required property for ResourceNotFound and cannot be null");
            // to ensure "error" is required (not null)
            this.Error = error ?? throw new ArgumentNullException("error is a required property for ResourceNotFound and cannot be null");
        ...
        public ResourceNotFoundError Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResourceNotFound {\n");
        ...
        {
            return this.Equals(input as ResourceNotFound);
        }

        /// <summary>
        /// Returns true if ResourceNotFound instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceNotFound to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceNotFound input)
        {
            if (input == null)
                return false;
