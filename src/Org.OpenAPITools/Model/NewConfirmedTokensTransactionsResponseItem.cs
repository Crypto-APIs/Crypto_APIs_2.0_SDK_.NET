...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewConfirmedTokensTransactionsResponseItem")]
    public partial class NewConfirmedTokensTransactionsResponseItem : IEquatable<NewConfirmedTokensTransactionsResponseItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewConfirmedTokensTransactionsResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewConfirmedTokensTransactionsResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewConfirmedTokensTransactionsResponseItem" /> class.
        /// </summary>
        ...
        public NewConfirmedTokensTransactionsResponseItem(string address = default(string), string callbackSecretKey = default(string), string callbackUrl = default(string), string confirmationsCount = default(string), int createdTimestamp = default(int), string eventType = default(string), bool isActive = default(bool), string referenceId = default(string), string transactionId = default(string))
        {
            // to ensure "address" is required (not null)
            this.Address = address ?? throw new ArgumentNullException("address is a required property for NewConfirmedTokensTransactionsResponseItem and cannot be null");
            // to ensure "callbackSecretKey" is required (not null)
            this.CallbackSecretKey = callbackSecretKey ?? throw new ArgumentNullException("callbackSecretKey is a required property for NewConfirmedTokensTransactionsResponseItem and cannot be null");
            // to ensure "callbackUrl" is required (not null)
            this.CallbackUrl = callbackUrl ?? throw new ArgumentNullException("callbackUrl is a required property for NewConfirmedTokensTransactionsResponseItem and cannot be null");
            // to ensure "confirmationsCount" is required (not null)
            this.ConfirmationsCount = confirmationsCount ?? throw new ArgumentNullException("confirmationsCount is a required property for NewConfirmedTokensTransactionsResponseItem and cannot be null");
            this.CreatedTimestamp = createdTimestamp;
            // to ensure "eventType" is required (not null)
            this.EventType = eventType ?? throw new ArgumentNullException("eventType is a required property for NewConfirmedTokensTransactionsResponseItem and cannot be null");
            this.IsActive = isActive;
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for NewConfirmedTokensTransactionsResponseItem and cannot be null");
            // to ensure "transactionId" is required (not null)
            this.TransactionId = transactionId ?? throw new ArgumentNullException("transactionId is a required property for NewConfirmedTokensTransactionsResponseItem and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewConfirmedTokensTransactionsResponseItem {\n");
        ...
        {
            return this.Equals(input as NewConfirmedTokensTransactionsResponseItem);
        }

        /// <summary>
        /// Returns true if NewConfirmedTokensTransactionsResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of NewConfirmedTokensTransactionsResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewConfirmedTokensTransactionsResponseItem input)
        {
            if (input == null)
                return false;
