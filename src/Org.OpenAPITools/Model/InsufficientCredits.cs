...
namespace Org.OpenAPITools.Model
{
    ...
    /// InsufficientCredits
    /// </summary>
    [DataContract(Name = "InsufficientCredits")]
    public partial class InsufficientCredits : IEquatable<InsufficientCredits>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsufficientCredits" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InsufficientCredits() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InsufficientCredits" /> class.
        /// </summary>
        ...
        public InsufficientCredits(string apiVersion = default(string), string requestId = default(string), string context = default(string), InsufficientCreditsError error = default(InsufficientCreditsError))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for InsufficientCredits and cannot be null");
            // to ensure "requestId" is required (not null)
            this.RequestId = requestId ?? throw new ArgumentNullException("requestId is a required property for InsufficientCredits and cannot be null");
            // to ensure "error" is required (not null)
            this.Error = error ?? throw new ArgumentNullException("error is a required property for InsufficientCredits and cannot be null");
        ...
        public InsufficientCreditsError Error { get; set; }
        ...
        {
            return this.Equals(input as InsufficientCredits);
        }

        /// <summary>
        /// Returns true if InsufficientCredits instances are equal
        /// </summary>
        /// <param name="input">Instance of InsufficientCredits to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsufficientCredits input)
        {
            if (input == null)
                return false;
