...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListTransactionsByAddressResponseItem")]
    public partial class ListTransactionsByAddressResponseItem : IEquatable<ListTransactionsByAddressResponseItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransactionsByAddressResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransactionsByAddressResponseItem" /> class.
        /// </summary>
        ...
        public ListTransactionsByAddressResponseItem(int index = default(int), string minedInBlockHash = default(string), int minedInBlockHeight = default(int), List<GetTransactionDetailsByTransactionIDResponseItemRecipients> recipients = default(List<GetTransactionDetailsByTransactionIDResponseItemRecipients>), List<GetTransactionDetailsByTransactionIDResponseItemSenders> senders = default(List<GetTransactionDetailsByTransactionIDResponseItemSenders>), int timestamp = default(int), string transactionHash = default(string), string transactionId = default(string), GetTransactionDetailsByTransactionIDResponseItemFee fee = default(GetTransactionDetailsByTransactionIDResponseItemFee), ListTransactionsByAddressResponseItemBlockchainSpecific blockchainSpecific = default(ListTransactionsByAddressResponseItemBlockchainSpecific))
        {
            this.Index = index;
            // to ensure "recipients" is required (not null)
            this.Recipients = recipients ?? throw new ArgumentNullException("recipients is a required property for ListTransactionsByAddressResponseItem and cannot be null");
            // to ensure "senders" is required (not null)
            this.Senders = senders ?? throw new ArgumentNullException("senders is a required property for ListTransactionsByAddressResponseItem and cannot be null");
            this.Timestamp = timestamp;
            // to ensure "transactionHash" is required (not null)
            this.TransactionHash = transactionHash ?? throw new ArgumentNullException("transactionHash is a required property for ListTransactionsByAddressResponseItem and cannot be null");
            // to ensure "transactionId" is required (not null)
            this.TransactionId = transactionId ?? throw new ArgumentNullException("transactionId is a required property for ListTransactionsByAddressResponseItem and cannot be null");
            // to ensure "fee" is required (not null)
            this.Fee = fee ?? throw new ArgumentNullException("fee is a required property for ListTransactionsByAddressResponseItem and cannot be null");
            // to ensure "blockchainSpecific" is required (not null)
            this.BlockchainSpecific = blockchainSpecific ?? throw new ArgumentNullException("blockchainSpecific is a required property for ListTransactionsByAddressResponseItem and cannot be null");
        ...
        public ListTransactionsByAddressResponseItemBlockchainSpecific BlockchainSpecific { get; set; }
        ...
        {
            return this.Equals(input as ListTransactionsByAddressResponseItem);
        }

        /// <summary>
        /// Returns true if ListTransactionsByAddressResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTransactionsByAddressResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTransactionsByAddressResponseItem input)
        {
            if (input == null)
                return false;
