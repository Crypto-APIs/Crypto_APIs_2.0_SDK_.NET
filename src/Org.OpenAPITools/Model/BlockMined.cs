...
namespace Org.OpenAPITools.Model
{
    ...
    /// BlockMined
    /// </summary>
    [DataContract(Name = "BlockMined")]
    public partial class BlockMined : IEquatable<BlockMined>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BlockMined" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BlockMined() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BlockMined" /> class.
        /// </summary>
        ...
        public BlockMined(string apiVersion = default(string), string referenceId = default(string), string idempotencyKey = default(string), BlockMinedData data = default(BlockMinedData))
        {
            // to ensure "apiVersion" is required (not null)
            this.ApiVersion = apiVersion ?? throw new ArgumentNullException("apiVersion is a required property for BlockMined and cannot be null");
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for BlockMined and cannot be null");
            // to ensure "idempotencyKey" is required (not null)
            this.IdempotencyKey = idempotencyKey ?? throw new ArgumentNullException("idempotencyKey is a required property for BlockMined and cannot be null");
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for BlockMined and cannot be null");
        }
        ...
        public BlockMinedData Data { get; set; }
        ...
        {
            return this.Equals(input as BlockMined);
        }

        /// <summary>
        /// Returns true if BlockMined instances are equal
        /// </summary>
        /// <param name="input">Instance of BlockMined to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BlockMined input)
        {
            if (input == null)
                return false;
