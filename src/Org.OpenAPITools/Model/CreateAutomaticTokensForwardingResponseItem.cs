...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateAutomaticTokensForwardingResponseItem")]
    public partial class CreateAutomaticTokensForwardingResponseItem : IEquatable<CreateAutomaticTokensForwardingResponseItem>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAutomaticTokensForwardingResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateAutomaticTokensForwardingResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAutomaticTokensForwardingResponseItem" /> class.
        /// </summary>
        ...
        public CreateAutomaticTokensForwardingResponseItem(string callbackUrl = default(string), int confirmationsCount = default(int), int createdTimestamp = default(int), string feeAddress = default(string), FeePriorityEnum feePriority = default(FeePriorityEnum), string fromAddress = default(string), string minimumTransferAmount = default(string), string referenceId = default(string), string toAddress = default(string), CreateAutomaticTokensForwardingResponseItemTokenData tokenData = default(CreateAutomaticTokensForwardingResponseItemTokenData))
        {
            // to ensure "callbackUrl" is required (not null)
            this.CallbackUrl = callbackUrl ?? throw new ArgumentNullException("callbackUrl is a required property for CreateAutomaticTokensForwardingResponseItem and cannot be null");
            this.ConfirmationsCount = confirmationsCount;
            this.CreatedTimestamp = createdTimestamp;
            // to ensure "feeAddress" is required (not null)
            this.FeeAddress = feeAddress ?? throw new ArgumentNullException("feeAddress is a required property for CreateAutomaticTokensForwardingResponseItem and cannot be null");
            this.FeePriority = feePriority;
            // to ensure "fromAddress" is required (not null)
            this.FromAddress = fromAddress ?? throw new ArgumentNullException("fromAddress is a required property for CreateAutomaticTokensForwardingResponseItem and cannot be null");
            // to ensure "minimumTransferAmount" is required (not null)
            this.MinimumTransferAmount = minimumTransferAmount ?? throw new ArgumentNullException("minimumTransferAmount is a required property for CreateAutomaticTokensForwardingResponseItem and cannot be null");
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for CreateAutomaticTokensForwardingResponseItem and cannot be null");
            // to ensure "toAddress" is required (not null)
            this.ToAddress = toAddress ?? throw new ArgumentNullException("toAddress is a required property for CreateAutomaticTokensForwardingResponseItem and cannot be null");
            // to ensure "tokenData" is required (not null)
            this.TokenData = tokenData ?? throw new ArgumentNullException("tokenData is a required property for CreateAutomaticTokensForwardingResponseItem and cannot be null");
        }
        ...
        public CreateAutomaticTokensForwardingResponseItemTokenData TokenData { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateAutomaticTokensForwardingResponseItem {\n");
        ...
        {
            return this.Equals(input as CreateAutomaticTokensForwardingResponseItem);
        }

        /// <summary>
        /// Returns true if CreateAutomaticTokensForwardingResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateAutomaticTokensForwardingResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateAutomaticTokensForwardingResponseItem input)
        {
            if (input == null)
                return false;
