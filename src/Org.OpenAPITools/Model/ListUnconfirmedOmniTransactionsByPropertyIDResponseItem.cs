...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListUnconfirmedOmniTransactionsByPropertyIDResponseItem")]
    public partial class ListUnconfirmedOmniTransactionsByPropertyIDResponseItem : IEquatable<ListUnconfirmedOmniTransactionsByPropertyIDResponseItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnconfirmedOmniTransactionsByPropertyIDResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListUnconfirmedOmniTransactionsByPropertyIDResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnconfirmedOmniTransactionsByPropertyIDResponseItem" /> class.
        /// </summary>
        ...
        public ListUnconfirmedOmniTransactionsByPropertyIDResponseItem(string amount = default(string), bool divisible = default(bool), bool mined = default(bool), int propertyId = default(int), List<ListOmniTransactionsByAddressResponseItemRecipients> recipients = default(List<ListOmniTransactionsByAddressResponseItemRecipients>), List<GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItemSenders> senders = default(List<GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItemSenders>), bool sent = default(bool), int timestamp = default(int), string transactionId = default(string), string type = default(string), int typeIint = default(int), int version = default(int), ListUnconfirmedOmniTransactionsByAddressResponseItemFee fee = default(ListUnconfirmedOmniTransactionsByAddressResponseItemFee))
        {
            // to ensure "amount" is required (not null)
            this.Amount = amount ?? throw new ArgumentNullException("amount is a required property for ListUnconfirmedOmniTransactionsByPropertyIDResponseItem and cannot be null");
            this.Divisible = divisible;
            this.Mined = mined;
            this.PropertyId = propertyId;
            // to ensure "recipients" is required (not null)
            this.Recipients = recipients ?? throw new ArgumentNullException("recipients is a required property for ListUnconfirmedOmniTransactionsByPropertyIDResponseItem and cannot be null");
            // to ensure "senders" is required (not null)
            this.Senders = senders ?? throw new ArgumentNullException("senders is a required property for ListUnconfirmedOmniTransactionsByPropertyIDResponseItem and cannot be null");
            this.Sent = sent;
            this.Timestamp = timestamp;
            // to ensure "transactionId" is required (not null)
            this.TransactionId = transactionId ?? throw new ArgumentNullException("transactionId is a required property for ListUnconfirmedOmniTransactionsByPropertyIDResponseItem and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for ListUnconfirmedOmniTransactionsByPropertyIDResponseItem and cannot be null");
            this.TypeIint = typeIint;
            this.Version = version;
            // to ensure "fee" is required (not null)
            this.Fee = fee ?? throw new ArgumentNullException("fee is a required property for ListUnconfirmedOmniTransactionsByPropertyIDResponseItem and cannot be null");
        }
        ...
        {
            return this.Equals(input as ListUnconfirmedOmniTransactionsByPropertyIDResponseItem);
        }

        /// <summary>
        /// Returns true if ListUnconfirmedOmniTransactionsByPropertyIDResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ListUnconfirmedOmniTransactionsByPropertyIDResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListUnconfirmedOmniTransactionsByPropertyIDResponseItem input)
        {
            if (input == null)
                return false;
