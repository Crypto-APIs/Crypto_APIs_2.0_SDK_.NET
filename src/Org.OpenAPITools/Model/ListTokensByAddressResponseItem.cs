...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListTokensByAddressResponseItem")]
    public partial class ListTokensByAddressResponseItem : IEquatable<ListTokensByAddressResponseItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTokensByAddressResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTokensByAddressResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTokensByAddressResponseItem" /> class.
        /// </summary>
        ...
        public ListTokensByAddressResponseItem(string confirmedBalance = default(string), string contractAddress = default(string), string name = default(string), string symbol = default(string), string type = default(string))
        {
            // to ensure "confirmedBalance" is required (not null)
            this.ConfirmedBalance = confirmedBalance ?? throw new ArgumentNullException("confirmedBalance is a required property for ListTokensByAddressResponseItem and cannot be null");
            // to ensure "contractAddress" is required (not null)
            this.ContractAddress = contractAddress ?? throw new ArgumentNullException("contractAddress is a required property for ListTokensByAddressResponseItem and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for ListTokensByAddressResponseItem and cannot be null");
            // to ensure "symbol" is required (not null)
            this.Symbol = symbol ?? throw new ArgumentNullException("symbol is a required property for ListTokensByAddressResponseItem and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for ListTokensByAddressResponseItem and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListTokensByAddressResponseItem {\n");
        ...
        {
            return this.Equals(input as ListTokensByAddressResponseItem);
        }

        /// <summary>
        /// Returns true if ListTokensByAddressResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ListTokensByAddressResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListTokensByAddressResponseItem input)
        {
            if (input == null)
                return false;
