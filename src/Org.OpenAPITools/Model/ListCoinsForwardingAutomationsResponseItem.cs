...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListCoinsForwardingAutomationsResponseItem")]
    public partial class ListCoinsForwardingAutomationsResponseItem : IEquatable<ListCoinsForwardingAutomationsResponseItem>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListCoinsForwardingAutomationsResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListCoinsForwardingAutomationsResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListCoinsForwardingAutomationsResponseItem" /> class.
        /// </summary>
        ...
        /// <param name="confirmationsCountTrigger">Represents the total count of the transaction confirmations before triggering the event. (required).</param>
        ...
        /// <param name="referenceId">Represents a unique ID used to reference the specific forwarding automation. (required).</param>
        /// <param name="toAddress">Represents the hash of the address the currency is forwarded to. (required).</param>
        public ListCoinsForwardingAutomationsResponseItem(string callbackUrl = default(string), int confirmationsCountTrigger = default(int), int createdTimestamp = default(int), FeePriorityEnum feePriority = default(FeePriorityEnum), string fromAddress = default(string), string minimumTransferAmount = default(string), string referenceId = default(string), string toAddress = default(string))
        {
            // to ensure "callbackUrl" is required (not null)
            this.CallbackUrl = callbackUrl ?? throw new ArgumentNullException("callbackUrl is a required property for ListCoinsForwardingAutomationsResponseItem and cannot be null");
            this.ConfirmationsCountTrigger = confirmationsCountTrigger;
            this.CreatedTimestamp = createdTimestamp;
            this.FeePriority = feePriority;
            // to ensure "fromAddress" is required (not null)
            this.FromAddress = fromAddress ?? throw new ArgumentNullException("fromAddress is a required property for ListCoinsForwardingAutomationsResponseItem and cannot be null");
            // to ensure "minimumTransferAmount" is required (not null)
            this.MinimumTransferAmount = minimumTransferAmount ?? throw new ArgumentNullException("minimumTransferAmount is a required property for ListCoinsForwardingAutomationsResponseItem and cannot be null");
            // to ensure "referenceId" is required (not null)
            this.ReferenceId = referenceId ?? throw new ArgumentNullException("referenceId is a required property for ListCoinsForwardingAutomationsResponseItem and cannot be null");
            // to ensure "toAddress" is required (not null)
            this.ToAddress = toAddress ?? throw new ArgumentNullException("toAddress is a required property for ListCoinsForwardingAutomationsResponseItem and cannot be null");
        }
        ...
        /// </summary>
        /// <value>Represents the total count of the transaction confirmations before triggering the event.</value>
        [DataMember(Name = "confirmationsCountTrigger", IsRequired = true, EmitDefaultValue = false)]
        public int ConfirmationsCountTrigger { get; set; }
        ...
        /// </summary>
        /// <value>Represents a unique ID used to reference the specific forwarding automation.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListCoinsForwardingAutomationsResponseItem {\n");
        ...
        {
            return this.Equals(input as ListCoinsForwardingAutomationsResponseItem);
        }

        /// <summary>
        /// Returns true if ListCoinsForwardingAutomationsResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ListCoinsForwardingAutomationsResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListCoinsForwardingAutomationsResponseItem input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ConfirmationsCountTrigger == input.ConfirmationsCountTrigger ||
                    this.ConfirmationsCountTrigger.Equals(input.ConfirmationsCountTrigger)
                ) && 
                (
