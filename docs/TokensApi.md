...
namespace Example
{
    public class GetContractDetailsByAddressExample
    {
        public static void Main()
        {
            ...
            var network = ropsten;  // string | Represents the name of the blockchain network used; blockchain networks are usually identical as technology and software, but they differ in data, e.g. - \"mainnet\" is the live network with actual data while networks like \"testnet\", \"ropsten\", \"rinkeby\" are test networks.
            ...
            {
                Debug.Print("Exception when calling TokensApi.GetContractDetailsByAddress: " + e.Message );
...
namespace Example
{
    public class ListTokensByAddressExample
    {
        public static void Main()
        {
            ...
            var network = ropsten;  // string | Represents the name of the blockchain network used; blockchain networks are usually identical as technology and software, but they differ in data, e.g. - \"mainnet\" is the live network with actual data while networks like \"ropsten\", \"rinkeby\" are test networks.
...
namespace Example
{
    public class ListTokensTransfersByAddressExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling TokensApi.ListTokensTransfersByAddress: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
